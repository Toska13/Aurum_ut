...
Процедура ЗаполнитьСписокРежимовОтбора()
	...
	Если РежимОтображенияДокументов = "ОтправленныеДокументы"
		ИЛИ РежимОтображенияДокументов = "ПеревозочныеДокументы" Тогда
		ПредставлениеПоДатеОтправкиИлиПолучения = "Дата отправки";
	Иначе
		ПредставлениеПоДатеОтправкиИлиПолучения = "Дата получения";
	КонецЕсли;
	
	СписокРежимовОтбора = Новый СписокЗначений;
	СписокРежимовОтбора.Добавить("ПоДатеОтправкиИлиПолучения", ПредставлениеПоДатеОтправкиИлиПолучения);
