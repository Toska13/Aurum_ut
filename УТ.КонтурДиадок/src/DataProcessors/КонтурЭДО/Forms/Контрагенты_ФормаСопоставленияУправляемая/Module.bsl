...
Процедура НастроитьФорму()
	...
	Если ДанныеКонтрагента.Тип = "Организация" Тогда
		
		Элементы.СправочникСписокНаименование.Заголовок = "Наименование участника ЭДО";
		Элементы.СправочникСписокПредставлениеСвязи.Заголовок = "Организация в 1С";
...
Процедура УстановитьЗаголовокФормы()
	...
	ШаблонЗаголовкаФормы = ШаблонЗаголовкаФормы();
...
&НаСервере
Функция ШаблонЗаголовкаФормы()
	
	Если ДанныеКонтрагента.Тип = "Организация" Тогда
		Результат = "Сопоставление организации: %1 %2";
	Иначе
		Результат = "Сопоставление контрагента: %1 %2";
	КонецЕсли;
...
Процедура ВыполнитьСопоставлениеКонтрагентаНаСервере(ДанныеКонтрагентаЭДО, ИННКонтрагентаЭДО)
	...
	Модуль_Ядро.Контрагенты_ОчиститьКЭШПослеСопоставленияКонтрагента();
...
Функция ПолучитьДанныеКонтрагента(СсылкаНаОбъект)
	...
	Результат.Тип = СокрЛП(ТипЗнч(СсылкаНаОбъект));
