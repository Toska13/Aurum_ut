...
Функция ЗначениеВВыражение(Значение, Язык = "ru") Экспорт
...
Функция ЗначениеПараметраВТекст(Данные, Имя) Экспорт
	...
	Если ТипЗнч(Значение) = Тип("СписокЗначений") Тогда
		...
		Для Каждого ОписаниеЗначения Из Значение Цикл 
			...
			ЗначениеТекст = ИТК_Запрос.ЗначениеВВыражение(ОписаниеЗначения.Значение, Язык);
	...
	Иначе
		...
		Результат = ИТК_Запрос.ЗначениеВВыражение(Значение, Язык);
...
Функция ВыражениеПустогоСсылочногоЗначения(Тип) Экспорт
	...
	Возврат ИТК_Запрос.ЗначениеВВыражение(ПустаяСсылка);
		...
		Если ВыводРезультата Тогда
			...
			Если ЗапросСОшибкой Тогда
				...
				Для ИндексРезультата = 0 По ПакетСПромежуточнымиДанными.ВГраница() Цикл 
					...
					ЭлементПакета = ПакетСПромежуточнымиДанными[ИндексРезультата];
					ДобавитьОписаниеТаблицыРезультатаВПакет(ПакетРезультатов, ОписаниеТаблиц, ЭлементПакета,
...
Процедура АнализПреобразованияЗначенияПараметраВЗначение(Значение, Потеряно, Преобразуется)
	...
	Результат = ИТК_Запрос.ЗначениеВВыражение(Значение);
...
Функция ДобавитьОписаниеТаблицыРезультатаВПакет(ПакетРезультатов, ОписаниеТаблиц, Результат, Индекс, ОбратныйПорядокЗапросовПакета, ТаблицаДляПомещения = Неопределено)
