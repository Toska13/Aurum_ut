...
Функция СтдКоллекции()
	...
	Если СтдКоллекцииЛок = Неопределено Тогда
		Если ЭтоВнешняяОбработка() Тогда
			СтдКоллекцииЛок = Новый("ExternalDataProcessorObject.КонтурЛогистика_СтдКоллекции");
		Иначе
			СтдКоллекцииЛок = Новый("DataProcessorObject.КонтурЛогистика_СтдКоллекции");
		КонецЕсли;
	КонецЕсли;
...
Функция СтдОС()
	...
	Если СтдСтрЛок = Неопределено Тогда
		Если ЭтоВнешняяОбработка() Тогда
			СтдСтрЛок = Новый("ExternalDataProcessorObject.КонтурЛогистика_СтдОС");
		Иначе
			СтдСтрЛок = Новый("DataProcessorObject.КонтурЛогистика_СтдОС");
		КонецЕсли;
	КонецЕсли;
