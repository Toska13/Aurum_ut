...
Процедура ОпределитьЭлементФормы(Форма,Элемент)
	...
	Если ТипЗнч(Элемент) = Тип("Строка") Тогда
		...
		Иерархия = КонтурЛогистика_ОбщегоНазначенияКлиентСервер.РазделитьСтроку(Элемент, ".");
...
Функция СоздатьЭлементФормы(Форма, ИмяЭлемента, ТипЭлемента, РодительЭлемента, ЭлементПеред = Неопределено)
	...
	ИмяЭлементаВалидное = ОчиститьОтЗапрещенныхСимволов(ИмяЭлемента);
	
	УжеСуществующий = Форма.Элементы.Найти(ИмяЭлементаВалидное);
	
	Если УжеСуществующий = Неопределено Тогда 
		Если ЭлементПеред = Неопределено Тогда
			НовыйЭлемент = Форма.Элементы.Добавить(ИмяЭлементаВалидное,ТипЭлемента, РодительЭлемента);
		Иначе
			НовыйЭлемент = Форма.Элементы.Вставить(ИмяЭлементаВалидное,ТипЭлемента, РодительЭлемента, ЭлементПеред);
		КонецЕсли;
	Иначе
		НовыйЭлемент = УжеСуществующий;
	КонецЕсли;
