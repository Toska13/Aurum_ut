...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Параметры.Свойство("Фильтр", Фильтр);
	Параметры.Свойство("КлючТаблицыУведомлений", КлючТаблицыУведомлений);
...
Процедура ЗаполнитьТабУведомлений()
	...
	Если КлючТаблицыУведомлений = "УведомленияОсновнойФормы" Тогда
		СписокУведомлений = Модуль_Ядро.УведомленияОсновнойФормы_Список();
	ИначеЕсли КлючТаблицыУведомлений = "УведомленияФормыПакета" Тогда
		СписокУведомлений = Модуль_Ядро.УведомленияФормыПакета_Список(Фильтр);
	Иначе
		СписокУведомлений = Новый ТаблицаЗначений;
	КонецЕсли;
...
Процедура СохранитьТаблицуУведомленийНаСервере()
	...
	Если КлючТаблицыУведомлений = "УведомленияОсновнойФормы" Тогда
		Модуль_Ядро.УведомленияОсновнойФормы_СохранитьТаблицуСостояний(СостоянияУведомлений);
	ИначеЕсли КлючТаблицыУведомлений = "УведомленияФормыПакета" Тогда
		Модуль_Ядро.УведомленияФормыпакета_СохранитьТаблицуСостояний(СостоянияУведомлений);
	Иначе
		Возврат;
	КонецЕсли;
