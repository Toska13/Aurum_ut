...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ИначеЕсли Режим = "ОшибкиГосключПриДействии" Тогда
		
		ИнициализироватьФормуОшибкиГосключПриВыполненииДействияЭДО();
		
	ИначеЕсли Режим = Режим_НоваяФормаАвторизации() Тогда
		
		ИнициализироватьФормуНоваяФормаАвторизации();
...
&НаСервере
Процедура ИнициализироватьФормуОшибкиГосключПриВыполненииДействияЭДО()
	
	Ядро = Модуль_ЯдроНаСервере();
	ТекстовыеДанныеФормы = Ядро.Госключ_HTMLТекст_ТекстОшибок(Параметры.СписокОшибокГосключ);
	
	// BSLLS:UnusedLocalVariable-off
	Заголовок = ЗаголовокОшибкиГосключПриВыполненииДействияЭДО();
	ТекстHTML = ТекстовыеДанныеФормы;
	// BSLLS:UnusedLocalVariable-on
...
&НаСервере
Процедура ИнициализироватьФормуНоваяФормаАвторизации()
	
	ТекстовыеДанныеФормы = Параметры.ТекстСообщения;
...
&НаКлиентеНаСервереБезКонтекста
Функция ЗаголовокОшибкиГосключПриВыполненииДействияЭДО()
	
	Возврат НСтр("ru = 'Ошибки проверки при подписании Госключом'");
...
&НаКлиентеНаСервереБезКонтекста
Функция Режим_НоваяФормаАвторизации()
	
	Возврат "НоваяФормаАвторизации";
...
Процедура СохранитьНастройку_БольшеНеПоказыватьНаСервере()
	...
	ИначеЕсли Режим = Режим_НоваяФормаАвторизации() Тогда
		...
		ОбработкаОбъект.НастройкиПользователяУстановить_НеПоказыватьОнбордингНоваяФормаАвторизации(БольшеНеПоказывать);
