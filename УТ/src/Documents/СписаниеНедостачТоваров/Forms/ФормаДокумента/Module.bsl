...
&НаСервере
Процедура ОчиститьКонтролируемуюПартию()
	
	ОчиститьПартию = СкладыСервер.ИспользоватьОрдернуюСхемуПриОтраженииИзлишковНедостач(Объект.Склад, Объект.Дата);
