...
Функция ДанныеДокументаДляПроведения(Документ, Регистры, ДопПараметры = Неопределено) Экспорт
	...
	Если Не ДопПараметры.ПолучитьТекстыЗапроса Тогда
		...
		ОтразитьВУчетеНДС(Запрос, ТекстыЗапроса, Регистры, ДокументСсылка);
...
Процедура ДобавитьКомандыСозданияНаОсновании(КомандыСозданияНаОсновании, Параметры) Экспорт
	...
	Если КомандаСоздания <> Неопределено Тогда
		...
		ПодключаемыеКоманды.ДобавитьУсловиеВидимостиКоманды(
			КомандаСоздания, 
			"ТипКорректировки", 
			Перечисления.ТипыКорректировки.ОбычнаяКорректировка,
...
// 		* Расхождения - см. НоменклатураКлиентСервер.ПараметрыУказанияСерий.
//
Функция ПараметрыУказанияСерий(Объект) Экспорт
	...
	ПараметрыУказанияСерийТовары.ПолноеИмяОбъекта = "Документ.КорректировкаРеализации";
	...
	РеализацияПоПереходуПраваСобственности = ДокументОснованиеХозяйственнаяОперация = Перечисления.ХозяйственныеОперации.ПереходПраваСобственности;
	
	Если РеализацияЧерезКомиссионера
		Или РеализацияПоПереходуПраваСобственности Тогда
		
		ПараметрыУказанияСерийТовары.УчитыватьСебестоимостьПоСериям = ПолучитьФункциональнуюОпцию("УчитыватьСебестоимостьПоСериямСклад",
																		Новый Структура());
		ПараметрыУказанияСерийТовары.ИспользоватьСерииНоменклатуры  = ПолучитьФункциональнуюОпцию("ИспользоватьСерииНоменклатурыСклад",
																		Новый Структура());
		
	Иначе
		ПараметрыСерийСклада = СкладыСервер.ИспользованиеСерийНаСкладе(Объект.Склад, Истина);
		ПараметрыУказанияСерийТовары.ИспользоватьСерииНоменклатуры  = ПараметрыСерийСклада.УчитыватьСебестоимостьПоСериям;
		ПараметрыУказанияСерийТовары.УчитыватьСебестоимостьПоСериям = ПараметрыСерийСклада.УчитыватьСебестоимостьПоСериям;
	КонецЕсли;
	
	ПараметрыУказанияСерийТовары.ТолькоСерииДляСебестоимости = Истина;
	
	ПараметрыУказанияСерийТовары.ИмяТЧСерии = ПараметрыУказанияСерийТовары.ИмяТЧТовары;
	
	ПараметрыУказанияСерийТовары.СкладскиеОперации.Добавить(Перечисления.СкладскиеОперации.ПустаяСсылка());
	
	ПараметрыУказанияСерийТовары.ИменаПолейДополнительные.Добавить("Склад");
	
	ПараметрыУказанияСерийТовары.ЭтоНакладная = Истина;
	ПараметрыУказанияСерийТовары.Дата = Объект.Дата;
	
	ПараметрыУказанияСерийТовары.ОперацияДокумента = ДокументОснованиеХозяйственнаяОперация;
	...
	#Область Расхождения
	ПараметрыУказанияСерийРасхождения = НоменклатураКлиентСервер.ПараметрыУказанияСерий();
	
	ПараметрыУказанияСерийРасхождения.ПолноеИмяОбъекта = ПараметрыУказанияСерийТовары.ПолноеИмяОбъекта;
	
	ПараметрыУказанияСерийРасхождения.УчитыватьСебестоимостьПоСериям = ПараметрыУказанияСерийТовары.УчитыватьСебестоимостьПоСериям;
	ПараметрыУказанияСерийРасхождения.ИспользоватьСерииНоменклатуры  = ПараметрыУказанияСерийТовары.ИспользоватьСерииНоменклатуры;
	
	ПараметрыУказанияСерийРасхождения.ТолькоСерииДляСебестоимости = Истина;
	
	ПараметрыУказанияСерийРасхождения.ИмяТЧТовары	= "Расхождения";
	ПараметрыУказанияСерийРасхождения.ИмяТЧСерии	= "Расхождения";
	
	ПараметрыУказанияСерийРасхождения.СкладскиеОперации.Добавить(Перечисления.СкладскиеОперации.ПустаяСсылка());
	
	ПараметрыУказанияСерийРасхождения.ИменаПолейДополнительные.Добавить("Склад");
	ПараметрыУказанияСерийРасхождения.ИменаПолейДополнительные.Добавить("ВариантОтражения");
	
	ПараметрыУказанияСерийРасхождения.ИменаПолейСтатусУказанияСерий.Добавить("СтатусУказанияСерий");
	ПараметрыУказанияСерийРасхождения.ИменаПолейСтатусУказанияСерий.Добавить("СтатусУказанияСерийНаСкладах");
	ПараметрыУказанияСерийРасхождения.ИменаПолейСтатусУказанияСерий.Добавить("СтатусУказанияСерийПереданныхТоваров");
	
	ПараметрыУказанияСерийРасхождения.ЭтоНакладная = Истина;
	ПараметрыУказанияСерийРасхождения.Дата = Объект.Дата;
	
	ПараметрыУказанияСерийРасхождения.ОперацияДокумента = ДокументОснованиеХозяйственнаяОперация;
	
	ПараметрыУказанияСерий.Вставить("Расхождения", ПараметрыУказанияСерийРасхождения);
...
Функция ТекстЗапросаЗаполненияСтатусовУказанияСерий(ПараметрыУказанияСерий) Экспорт
	...
	Если ПараметрыУказанияСерий.ИмяТЧТовары = "Расхождения" Тогда
		ТекстЗапроса = ТекстЗапросаЗаполненияСтатусовУказанияСерийРасхождения();
	Иначе
		ТекстЗапроса = ТекстЗапросаЗаполненияСтатусовУказанияСерийТовары();
	КонецЕсли;
...
Функция ПараметрыВзаиморасчеты(ДанныеЗаполнения = Неопределено) Экспорт
	...
	СтруктураПараметров.МожетЯвлятьсяОбъектомРасчетов = Ложь;
	#КонецОбласти
	...
	// Используется для определения объекта расчетов.
	ЕстьДокументыБезОбъектовРасчетов = Ложь;
	
	Если ДанныеЗаполнения <> Неопределено
		И ОбщегоНазначенияКлиентСервер.ЕстьРеквизитИлиСвойствоОбъекта(ДанныеЗаполнения, "ХозяйственнаяОперация")
		И ДанныеЗаполнения.ХозяйственнаяОперация = Перечисления.ХозяйственныеОперации.ПереходПраваСобственности
		И ОбщегоНазначенияКлиентСервер.ЕстьРеквизитИлиСвойствоОбъекта(ДанныеЗаполнения, "Расхождения") Тогда
		
		ДокументыОснования = ДанныеЗаполнения.Расхождения.Выгрузить(, "ЗаказКлиента").ВыгрузитьКолонку("ЗаказКлиента");
		
		ДокументыПоВидам = ПродажиСервер.ДокументыПоПризнакуНаличияОбъектовРасчетов(ДокументыОснования);
		ЕстьДокументыБезОбъектовРасчетов = ДокументыПоВидам.ДокументыБезОбъектовРасчетов.Количество() > 0;
		
	КонецЕсли;
	
	Если ЕстьДокументыБезОбъектовРасчетов Тогда
	...
	// Редактирование и пересчет суммы документа в форме валют и курсов недоступно,
	// так как сумма в валюте документа изменятся только при заполнении по расхождениям
	СтруктураПараметров.СуммаДокументаТолькоПросмотр           = Истина;
...
//
// Параметры:
//	 КорректировкаРеализации	- ДокументСсылка.КорректировкаРеализации - Документ,
...
//
Процедура ПроверитьВозможностьВводаНаОсновании(КорректировкаРеализации, Статус = Неопределено,
	...
	ОбщегоНазначенияУТ.ПроверитьВозможностьВводаНаОснованииСПараметрами(КорректировкаРеализации, ПараметрыПроверки);
...
Функция ТекстЗапросаДанныеДокументаШапка()
	...
	Возврат "ВЫБРАТЬ
		...
		|	ЕСТЬNULL(ДанныеДокумента.ДокументОснование.Дата, ДанныеДокумента.Дата) КАК ПериодКорректировки,
		...
		|	ДанныеДокумента.КорректироватьНалоговуюБазуПрошлогоПериода КАК КорректироватьНалоговуюБазуПрошлогоПериода,
		|	ДанныеДокумента.ОтразитьВПрибылиУбыткахПрошлыхЛет КАК ОтразитьВПрибылиУбыткахПрошлыхЛет,
		|	ДанныеДокумента.КорректировкаРеализации2_5 КАК КорректировкаРеализации2_5
...
Процедура ЗаполнитьПараметрыИнициализации(Запрос, ДокументСсылка)
	...
	КорректировкаПрошлогоПериодаГод = Ложь;
	Если ЗначениеЗаполнено(Реквизиты.ПериодКорректировки) Тогда 
		Если НачалоГода(Реквизиты.ПериодКорректировки) < НачалоГода(Реквизиты.Период) Тогда
			КорректировкаПрошлогоПериодаГод = Истина;
		КонецЕсли;
	КонецЕсли;
	Запрос.УстановитьПараметр("КорректировкаПрошлогоПериодаГод", КорректировкаПрошлогоПериодаГод);
...
Процедура ОформитьИзлишкиНедостачиНаСкладе(Запрос, ТекстыЗапроса, Регистры)
	...
	|	ВЫБОР
	|		КОГДА ТаблицаРасхождения.СтатусУказанияСерийНаСкладах = 0
	|			ТОГДА ЗНАЧЕНИЕ(Справочник.СерииНоменклатуры.ПустаяСсылка)
	|		ИНАЧЕ ТаблицаРасхождения.Серия
	|	КОНЕЦ                                  КАК Серия,
	|	-ТаблицаРасхождения.Количество         КАК Количество,
	|	ТаблицаРасхождения.СтатусУказанияСерийНаСкладах КАК СтатусУказанияСерий
	|ИЗ
...
Процедура ИнициализироватьКлючиАналитикиУчетаНоменклатуры(Запрос)
	...
	|					ТОГДА &Договор
	|					ИНАЧЕ Товары.АналитикаУчетаНоменклатуры.МестоХранения
	|			КОНЕЦ                                                  КАК Склад
	|		ИЗ
	...
	ЗапросАналитик.УстановитьПараметр("РеализацияЧерезКомиссионера",
										Запрос.Параметры.РеализацияЧерезКомиссионера);
...
Функция ТекстЗапросаВтТаблицаВидыЗапасовСписание(Запрос, ТекстыЗапроса) Экспорт
	...
	|	ВидыЗапасов.СуммаНДСРегл КАК СуммаНДСРегл,
	|	ВидыЗапасов.СуммаНДСУпр КАК СуммаНДСУпр,
	|
...
Функция ТекстЗапросаВтТаблицаРасхождения(Запрос, ТекстыЗапроса)
	...
	|			ИЛИ (&КорректировкаРеализации2_5 И Расхождения.СуммаСНДС < 0 И &КорректировкаПрошлогоПериодаГод И &ОтразитьВПрибылиУбыткахПрошлыхЛет)
	|		ТОГДА ИСТИНА
	|		ИНАЧЕ ЛОЖЬ
	|	КОНЕЦ КАК НаРасходы,
	...
	|			ИЛИ &КорректировкаРеализации2_5 И ((&ЭтоКорректировкаРеализацииУслугПрочихАктивов И НЕ &ОтразитьВПрибылиУбыткахПрошлыхЛет)
	|				ИЛИ(Расхождения.СуммаСНДС > 0 И &КорректировкаПрошлогоПериодаГод И &ОтразитьВПрибылиУбыткахПрошлыхЛет))
	|		ТОГДА ИСТИНА
	|		ИНАЧЕ ЛОЖЬ
	|	КОНЕЦ КАК НаДоходы,
	|
	...
	|	Расхождения.СуммаНДСРегл КАК СуммаНДСРегл,
	|	Расхождения.СуммаНДСУпр КАК СуммаНДСУпр,
...
Функция ТекстЗапросаВтТаблицаАналитикУчетаПартий(Запрос, ТекстыЗапроса)
	...
	|		ТОГДА НЕОПРЕДЕЛЕНО
	|		КОГДА ТаблицаДокумента.Ссылка.ДокументОснование ССЫЛКА Документ.РеализацияТоваровУслуг
	|			И ТаблицаДокумента.Ссылка.ДокументОснование.ХозяйственнаяОперация = ЗНАЧЕНИЕ(Перечисление.ХозяйственныеОперации.РеализацияКлиентуРеглУчет)
	|		ТОГДА НЕОПРЕДЕЛЕНО
...
Функция ТекстЗапросаВтТаблицаВидыЗапасовОприходование(Запрос, ТекстыЗапроса) Экспорт
	...
	|		КОГДА ВидыЗапасов.АналитикаУчетаНоменклатуры.ТипМестаХранения = ЗНАЧЕНИЕ(Перечисление.ТипыМестХранения.ДоговорКонтрагента)
	|		ТОГДА ВидыЗапасов.АналитикаУчетаНоменклатуры.МестоХранения
	|		КОГДА ВидыЗапасов.Склад = ЗНАЧЕНИЕ(Справочник.Склады.ПустаяСсылка) И ВидыЗапасов.АналитикаУчетаНоменклатуры.ТипМестаХранения = ЗНАЧЕНИЕ(Перечисление.ТипыМестХранения.Склад)
	|		ТОГДА ВидыЗапасов.АналитикаУчетаНоменклатуры.МестоХранения
	...
	//		Реализация без перехода права собственности имеет тип договора - реализация, но в аналитике указан договор
	|		КОГДА ВидыЗапасов.АналитикаУчетаНоменклатуры.ТипМестаХранения = ЗНАЧЕНИЕ(Перечисление.ТипыМестХранения.ДоговорКонтрагента)
	|		ТОГДА ЕСТЬNULL(ВидыЗапасов.КорАналитикаУчетаНоменклатуры.МестоХранения, ВидыЗапасов.АналитикаУчетаНоменклатуры.МестоХранения)
	|		ИНАЧЕ ВидыЗапасов.СкладОтгрузки
	...
	|	ВидыЗапасов.АналитикаУчетаНаборов                    КАК АналитикаУчетаНаборов,
	|	ВЫБОР
	|		КОГДА ВидыЗапасов.КорАналитикаУчетаНоменклатуры = ЗНАЧЕНИЕ(Справочник.КлючиАналитикиУчетаНоменклатуры.ПустаяСсылка)
	|			ТОГДА ВидыЗапасов.АналитикаУчетаНоменклатуры
	|		ИНАЧЕ ВидыЗапасов.КорАналитикаУчетаНоменклатуры
	|	КОНЕЦ                                                КАК АналитикаРеализации,
	|	ВЫБОР
	|		КОГДА ВидыЗапасов.КорАналитикаУчетаНоменклатуры = ЗНАЧЕНИЕ(Справочник.КлючиАналитикиУчетаНоменклатуры.ПустаяСсылка)
	|			ТОГДА АналитикаБезНазначения.КлючАналитики
	|		ИНАЧЕ АналитикаОтгрузкиБезНазначения.КлючАналитики
	|	КОНЕЦ                                                КАК АналитикаРеализацииБезНазначения,
	|	ВидыЗапасов.ВидЗапасов.РеализацияЗапасовДругойОрганизации        КАК РеализацияЗапасовДругойОрганизации,
	|	ВидыЗапасов.ВидЗапасов.ВидЗапасовВладельца                       КАК ВидЗапасовВладельца,
	|	ВидыЗапасов.ВидЗапасов.ВидЗапасовВладельца.ТипЗапасов            КАК ВидЗапасовВладельцаТипЗапасов,
	|	ВидыЗапасов.ВидЗапасов.ВидЗапасовВладельца.Организация           КАК ВидЗапасовВладельцаОрганизация,
	...
	|	ПО 
	|		ВидыЗапасов.КорАналитикаУчетаНоменклатуры.Номенклатура		= АналитикаОтгрузкиБезНазначения.Номенклатура
	|		И ВидыЗапасов.КорАналитикаУчетаНоменклатуры.Характеристика	= АналитикаОтгрузкиБезНазначения.Характеристика
	|		И ВидыЗапасов.КорАналитикаУчетаНоменклатуры.Серия			= АналитикаОтгрузкиБезНазначения.Серия
	|		И ЗНАЧЕНИЕ(Справочник.Назначения.ПустаяСсылка) = АналитикаОтгрузкиБезНазначения.Назначение
	|		И ВидыЗапасов.КорАналитикаУчетаНоменклатуры.МестоХранения = АналитикаОтгрузкиБезНазначения.МестоХранения
	|
	|	ЛЕВОЕ СОЕДИНЕНИЕ
	|		РегистрСведений.АналитикаУчетаНоменклатуры КАК КлючиКомитента
	|	ПО
...
Функция ТекстЗапросаВтРасхожденияРаботыУслуги(Запрос, ТекстыЗапроса)
	...
	|			ИЛИ (&КорректировкаРеализации2_5 И &КорректировкаПрошлогоПериодаГод И 
	|					(&ОтразитьВПрибылиУбыткахПрошлыхЛет ИЛИ НЕ &КорректироватьНалоговуюБазуПрошлогоПериода))
	|			ТОГДА ИСТИНА
	|		ИНАЧЕ ЛОЖЬ
	...
	|		ИНАЧЕ НЕОПРЕДЕЛЕНО
	|	КОНЕЦ) КАК АналитикаФинансовогоУчета,
	// Заполнение вида деятельности НДС должно совпадать с документом реализация товаров и услуг в ВТ ВтРаботыУслуги.
	|	(ВЫБОР
	|		КОГДА &ХозяйственнаяОперация = ЗНАЧЕНИЕ(Перечисление.ХозяйственныеОперации.РеализацияКлиентуРеглУчет)
	|			ТОГДА НЕОПРЕДЕЛЕНО
	|		КОГДА &НалогообложениеНДС = ЗНАЧЕНИЕ(Перечисление.ТипыНалогообложенияНДС.ПродажаНаЭкспорт) ТОГДА
	|			ВЫБОР ТаблицаРасхождения.СтавкаНДС
	|			КОГДА &СтавкаНДСНаЭкспорт ТОГДА 
...
Функция ТекстЗапросаТаблицаВыручкаИСебестоимостьПродаж(Запрос, ТекстыЗапроса, Регистры)
	...
	|	&Период КАК Период,
	|	ВЫБОР 
	|		КОГДА &КорректировкаРеализации2_5 ТОГДА
	|			ВЫБОР 
	|				КОГДА &КорректироватьНалоговуюБазуПрошлогоПериода ТОГДА
	|					&ПериодКорректировки
	|				ИНАЧЕ
	...
	|	ВЫБОР
	//		Реализация без перехода права собственности имеет тип договора - реализация, но в аналитике указан договор
	|		КОГДА ЕСТЬNULL(ТаблицаВидыЗапасов.АналитикаУчетаНоменклатуры.Договор.ТипДоговора, НЕОПРЕДЕЛЕНО) В (ЗНАЧЕНИЕ(Перечисление.ТипыДоговоров.СПокупателем),
	...
	|		КОГДА ЕСТЬNULL(ТаблицаВидыЗапасов.АналитикаУчетаНоменклатуры.Договор.ТипДоговора, НЕОПРЕДЕЛЕНО) = ЗНАЧЕНИЕ(Перечисление.ТипыДоговоров.РеализацияЧерезКомиссионера)
	...
	|		КОГДА ЕСТЬNULL(ТаблицаВидыЗапасов.АналитикаУчетаНоменклатуры.Договор.ТипДоговора, НЕОПРЕДЕЛЕНО) = ЗНАЧЕНИЕ(Перечисление.ТипыДоговоров.СПокупателем)
	|			И ТаблицаВидыЗапасов.ТипЗапасов = ЗНАЧЕНИЕ(Перечисление.ТипыЗапасов.Товар)
	...
	|	ТаблицаВидыЗапасов.Количество КАК Количество,
	|	ВЫБОР
	|		КОГДА НЕ &КорректировкаРеализации2_5 ИЛИ НЕ &ОтразитьВПрибылиУбыткахПрошлыхЛет
	|		ТОГДА ТаблицаВидыЗапасов.СуммаСНДСУпр
	|		ИНАЧЕ 0
	|	КОНЕЦ КАК СуммаВыручки,
	|	ВЫБОР
	...
	|		ИНАЧЕ 0
	|	КОНЕЦ КАК СуммаВыручкиСНДСРегл,
	|	ВЫБОР
	|		КОГДА &КорректировкаРеализации2_5 И &КорректировкаПрошлогоПериодаГод И &ОтразитьВПрибылиУбыткахПрошлыхЛет И &КорректироватьНалоговуюБазуПрошлогоПериода
	|		ТОГДА - ТаблицаВидыЗапасов.СуммаБезНДСРегл 
	|		КОГДА &КорректировкаРеализации2_5 И &КорректировкаПрошлогоПериодаГод И НЕ &ОтразитьВПрибылиУбыткахПрошлыхЛет И НЕ &КорректироватьНалоговуюБазуПрошлогоПериода
	|		ТОГДА ТаблицаВидыЗапасов.СуммаБезНДСРегл 
	|		ИНАЧЕ 0
	|	КОНЕЦ КАК ВыручкаПостояннаяРазница,
	...
	|	ВтТаблицаВидыЗапасовСписание КАК ТаблицаВидыЗапасов
	|ГДЕ
	|	(НЕ ТаблицаВидыЗапасов.НаДоходыРасходы И НЕ &КорректировкаРеализации2_5
	|	ИЛИ &КорректировкаРеализации2_5
	|		И (НЕ &ОтразитьВПрибылиУбыткахПрошлыхЛет ИЛИ &КорректироватьНалоговуюБазуПрошлогоПериода))
	|	И НЕ (ТИПЗНАЧЕНИЯ(&ДокументОснование) = ТИП(Документ.РеализацияУслугПрочихАктивов)
	|		ИЛИ &ТипКорректировки = ЗНАЧЕНИЕ(Перечисление.ТипыКорректировки.КорректировкаДоВводаОстатковУслугИПрочихАктивов))
	|	И (ЕСТЬNULL(ТаблицаВидыЗапасов.ТипНоменклатуры, НЕОПРЕДЕЛЕНО) <> ЗНАЧЕНИЕ(Перечисление.ТипыНоменклатуры.МногооборотнаяТара)
	...
	|ГДЕ
	|	(НЕ ТаблицаРасхождения.НаДоходыРасходы И НЕ &КорректировкаРеализации2_5
	|	ИЛИ &КорректировкаРеализации2_5
	|		И (НЕ &ОтразитьВПрибылиУбыткахПрошлыхЛет ИЛИ &КорректироватьНалоговуюБазуПрошлогоПериода))
	...
	|	(ВЫБОР
	//		Реализация без перехода права собственности имеет тип договора - реализация, но в аналитике указан договор
	|		КОГДА ЕСТЬNULL(ВидыЗапасов.АналитикаУчетаНоменклатуры.Договор.ТипДоговора, НЕОПРЕДЕЛЕНО) В (ЗНАЧЕНИЕ(Перечисление.ТипыДоговоров.СПокупателем),
	|				ЗНАЧЕНИЕ(Перечисление.ТипыДоговоров.РеализацияЧерезКомиссионера))
	|			И ВидыЗапасов.ТипЗапасов = ЗНАЧЕНИЕ(Перечисление.ТипыЗапасов.КомиссионныйТовар)
	|		ТОГДА ЗНАЧЕНИЕ(Перечисление.РазделыУчетаСебестоимостиТоваров.ТоварыПринятыеНаКомиссиюВПути)
	|		КОГДА ЕСТЬNULL(ВидыЗапасов.АналитикаУчетаНоменклатуры.Договор.ТипДоговора, НЕОПРЕДЕЛЕНО) = ЗНАЧЕНИЕ(Перечисление.ТипыДоговоров.РеализацияЧерезКомиссионера)
	|			И ВидыЗапасов.ТипЗапасов = ЗНАЧЕНИЕ(Перечисление.ТипыЗапасов.Товар)
	|		ТОГДА ЗНАЧЕНИЕ(Перечисление.РазделыУчетаСебестоимостиТоваров.ТоварыПереданныеНаКомиссиюВПути)
	|		КОГДА ЕСТЬNULL(ВидыЗапасов.АналитикаУчетаНоменклатуры.Договор.ТипДоговора, НЕОПРЕДЕЛЕНО) = ЗНАЧЕНИЕ(Перечисление.ТипыДоговоров.СПокупателем)
	|			И ВидыЗапасов.ТипЗапасов = ЗНАЧЕНИЕ(Перечисление.ТипыЗапасов.Товар)
	|		ТОГДА ЗНАЧЕНИЕ(Перечисление.РазделыУчетаСебестоимостиТоваров.ТоварыВПути)
	...
	// При использовании среднескользящей стоимости дата перехода права собственности должна относится к прошлому периоду.
	|		 И (&ДатаПереходаПраваСобственности < НАЧАЛОПЕРИОДА(&Период, МЕСЯЦ)
	|		 ИЛИ &ДатаПереходаПраваСобственности = ДАТАВРЕМЯ(1,1,1)
	|		 ИЛИ НЕ &СреднеСкользящая)
	|			ТОГДА ЗНАЧЕНИЕ(Перечисление.ХозяйственныеОперации.ВозвратТоваровОтКлиентаПрошлыхПериодов)
	...
	|		КОГДА ВидыЗапасов.Склад <> ВидыЗапасов.СкладОтгрузки
	...
	|
	|ГДЕ
	|	(НЕ ВидыЗапасов.НаДоходыРасходы И НЕ &КорректировкаРеализации2_5
	|	ИЛИ &КорректировкаРеализации2_5
	|		И (НЕ &ОтразитьВПрибылиУбыткахПрошлыхЛет ИЛИ &КорректироватьНалоговуюБазуПрошлогоПериода))
	|	И (ЕСТЬNULL(ВидыЗапасов.ТипНоменклатуры, НЕОПРЕДЕЛЕНО) <> ЗНАЧЕНИЕ(Перечисление.ТипыНоменклатуры.МногооборотнаяТара)
	|		ИЛИ НЕ &ВернутьМногооборотнуюТару)
	|	И НЕ (ТИПЗНАЧЕНИЯ(&ДокументОснование) = ТИП(Документ.РеализацияУслугПрочихАктивов)
	|		ИЛИ &ТипКорректировки = ЗНАЧЕНИЕ(Перечисление.ТипыКорректировки.КорректировкаДоВводаОстатковУслугИПрочихАктивов))
	|
...
Процедура ДобавитьТекстыОтраженияВзаиморасчетов(Запрос, ТекстыЗапроса, Регистры)
	...
	#Область ГруппировкаРасхождений
	
	Если ПроведениеДокументов.ТребуетсяТаблицаДляДвижений("РасчетыСКлиентами", Регистры) Тогда
		
		ТекстСгруппированныеРасхождения =
		"ВЫБРАТЬ
		|	ШапкаДокумента.Ссылка КАК Ссылка,
		|	ШапкаДокумента.Дата КАК ДатаРегистратора,
		|	ШапкаДокумента.Номер КАК НомерРегистратора,
		|	ШапкаДокумента.Организация КАК Организация,
		|	ШапкаДокумента.ДокументОснование КАК СвязанныйДокумент,
		|	ВЫБОР
		|		КОГДА &ХозОперацияОснования В (ЗНАЧЕНИЕ(Перечисление.ХозяйственныеОперации.РеализацияЧерезКомиссионера),
		|			ЗНАЧЕНИЕ(Перечисление.ХозяйственныеОперации.РеализацияЧерезКомиссионераБезПереходаПраваСобственности))
		|		И &ВестиРасчетыЧерезКонечныхПокупателей
		|			ТОГДА ШапкаДокумента.КлиентПартнер
		|		ИНАЧЕ ШапкаДокумента.Партнер
		|	КОНЕЦ КАК Партнер,
		|	ШапкаДокумента.ДатаПлатежа КАК ДатаПлатежа,
		|	ШапкаДокумента.ДокументОснование.Дата КАК ДатаКурса,
		|	ШапкаДокумента.ПродажаПоЗаказам КАК НакладнаяПоЗаказам,
		|	ШапкаДокумента.ПорядокРасчетов КАК ПорядокРасчетов,
		|	ШапкаДокумента.Валюта КАК ВалютаДокумента,
		...
		|	СУММА(Таблица.СуммаВзаиморасчетов) КАК СуммаВзаиморасчетов,
		|	СУММА(Таблица.СуммаСНДС) КАК СуммаСНДС
		|ПОМЕСТИТЬ ВтСгруппированныеРасхождения
		|ИЗ
		|	Документ.КорректировкаРеализации КАК ШапкаДокумента
		|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ Документ.КорректировкаРеализации.Расхождения КАК Таблица
		|		ПО ШапкаДокумента.Ссылка = Таблица.Ссылка
		|ГДЕ
		|	ШапкаДокумента.Ссылка В (&Ссылка)
		|	И ШапкаДокумента.ХозяйственнаяОперация = ЗНАЧЕНИЕ(Перечисление.ХозяйственныеОперации.ПереходПраваСобственности)
		|СГРУППИРОВАТЬ ПО
		|	ШапкаДокумента.Ссылка,
		|	ШапкаДокумента.ДатаПлатежа,
		...
		|		ИНАЧЕ ШапкаДокумента.Партнер
		|	КОНЕЦ,
		|	ШапкаДокумента.ПродажаПоЗаказам,
		|	ШапкаДокумента.ПорядокРасчетов,
		|	ШапкаДокумента.Дата,
		|	ШапкаДокумента.Номер,
		|	ШапкаДокумента.ВалютаВзаиморасчетов,
		|	ШапкаДокумента.ДокументОснование.Дата,
		|	ШапкаДокумента.Валюта,
		|	ШапкаДокумента.ДокументОснование,
		|	ШапкаДокумента.ФормаОплаты,
		...
		ТекстыЗапроса.Добавить(ТекстСгруппированныеРасхождения);
	...
	|	Таблица.ЗаказПродажи КАК ЗаказПродажи,
	|	Таблица.НакладнаяПоЗаказам КАК НакладнаяПоЗаказам,
	|	ВЫБОР КОГДА ТаблицаНоменклатуры.ТипНоменклатуры <> ЗНАЧЕНИЕ(Перечисление.ТипыНоменклатуры.МногооборотнаяТара)
	|		ИЛИ НЕ ВЫБОР КОГДА Таблица.СвязанныйДокумент ССЫЛКА Документ.РеализацияТоваровУслуг
	|					ТОГДА Таблица.СвязанныйДокумент.ВернутьМногооборотнуюТару
	|				ИНАЧЕ ИСТИНА
	|			КОНЕЦ
	|		ИЛИ ВЫБОР КОГДА Таблица.СвязанныйДокумент ССЫЛКА Документ.РеализацияТоваровУслуг
	|					ТОГДА Таблица.СвязанныйДокумент.ТребуетсяЗалогЗаТару
	|				ИНАЧЕ ИСТИНА
	|			КОНЕЦ
	...
	|	ВЫБОР КОГДА ТаблицаНоменклатуры.ТипНоменклатуры = ЗНАЧЕНИЕ(Перечисление.ТипыНоменклатуры.МногооборотнаяТара)
	|		И ВЫБОР КОГДА Таблица.СвязанныйДокумент ССЫЛКА Документ.РеализацияТоваровУслуг
	|					ТОГДА Таблица.СвязанныйДокумент.ТребуетсяЗалогЗаТару
	|				ИНАЧЕ ЛОЖЬ
	|			КОНЕЦ
	|			ТОГДА Таблица.СуммаВзаиморасчетов
	...
	|	Таблица.ДатаКурса КАК ДатаКурса,
	...
	|ИЗ
	|	ВтСгруппированныеРасхождения КАК Таблица
	...
	|		ИЛИ ТаблицаНоменклатуры.ТипНоменклатуры = ЗНАЧЕНИЕ(Перечисление.ТипыНоменклатуры.МногооборотнаяТара)
	|				И ВЫБОР КОГДА Таблица.СвязанныйДокумент ССЫЛКА Документ.РеализацияТоваровУслуг
	|						ТОГДА Таблица.СвязанныйДокумент.ТребуетсяЗалогЗаТару
	|					ИНАЧЕ ЛОЖЬ
	|				КОНЕЦ
	...
	|				ИНАЧЕ ЛОЖЬ
	|				КОНЕЦ
	|		ИЛИ ТаблицаНоменклатуры.ТипНоменклатуры ЕСТЬ NULL)
	|
	|ОБЪЕДИНИТЬ ВСЕ
	|
	|ВЫБРАТЬ
	...
	ВзаиморасчетыПроведениеКлиенты.ПроведениеПродажи(Запрос, ТекстыЗапроса, Регистры, ТекстПродажа, ТекстПланированиеОплат);
	...
	ВзаиморасчетыПроведениеКлиенты.ПроведениеОплатыОтКлиента(Запрос, ТекстыЗапроса, Регистры, ТекстОплата, "3");
...
Функция ТекстЗапросаТаблицаПрочиеДоходы(Запрос, ТекстыЗапроса, Регистры)
	...
	|	&Организация                           КАК Организация,
	|	ВЫБОР
	|		КОГДА &КорректировкаРеализации2_5
	|			ТОГДА &Подразделение
	|		ИНАЧЕ &ПодразделениеДоходы
	...
	|	ВЫБОР
	|		КОГДА &КорректировкаПрошлогоПериодаГод 
	|			И &КорректировкаРеализации2_5
	|			ТОГДА ЗНАЧЕНИЕ(ПланВидовХарактеристик.СтатьиДоходов.ПрибыльУбытокПрошлыхЛет)
	|			ИНАЧЕ &СтатьяДоходов
	|	КОНЕЦ                                  КАК СтатьяДоходов,
	|	&АналитикаДоходов                      КАК АналитикаДоходов,
	|	ВЫБОР
	|		КОГДА НЕ &КорректировкаРеализации2_5 ИЛИ &ОтразитьВПрибылиУбыткахПрошлыхЛет
	|			ТОГДА ТаблицаВидыЗапасов.СуммаСНДСУпр
	|		ИНАЧЕ 0 КОНЕЦ КАК Сумма,
	|	ВЫБОР
	|		КОГДА &УправленческийУчетОрганизаций
	|			И (НЕ &КорректировкаРеализации2_5 ИЛИ &ОтразитьВПрибылиУбыткахПрошлыхЛет)
	|			ТОГДА ТаблицаВидыЗапасов.СуммаСНДСУпр
	...
	|			ИЛИ НЕ &КорректировкаРеализации2_5
	|			ТОГДА 0
	|		КОГДА &КорректировкаРеализации2_5 И &КорректировкаПрошлогоПериодаГод И НЕ &ОтразитьВПрибылиУбыткахПрошлыхЛет И НЕ &КорректироватьНалоговуюБазуПрошлогоПериода
	|			ТОГДА - ТаблицаВидыЗапасов.СуммаСНДСРегл
	|		КОГДА &КорректировкаРеализации2_5 И &КорректировкаПрошлогоПериодаГод И &ОтразитьВПрибылиУбыткахПрошлыхЛет И &КорректироватьНалоговуюБазуПрошлогоПериода
	...
	|	ВтТаблицаВидыЗапасовСписание КАК ТаблицаВидыЗапасов
	|ГДЕ
	|	(ТаблицаВидыЗапасов.НаДоходыРасходы И НЕ &КорректировкаРеализации2_5
	|		ИЛИ &КорректировкаРеализации2_5 И &КорректировкаПрошлогоПериодаГод
	|			И (&ОтразитьВПрибылиУбыткахПрошлыхЛет
	|				ИЛИ НЕ &КорректироватьНалоговуюБазуПрошлогоПериода))
	...
	|	ЗНАЧЕНИЕ(ПланВидовХарактеристик.СтатьиДоходов.ПрибыльУбытокПрошлыхЛет) КАК СтатьяДоходов,
	|	&АналитикаДоходов                      КАК АналитикаДоходов,
	|	ВЫБОР
	|		КОГДА &ОтразитьВПрибылиУбыткахПрошлыхЛет
	|		ТОГДА - ТаблицаВидыЗапасов.СуммаСНДСУпр
	|		ИНАЧЕ 0 КОНЕЦ КАК Сумма,
	|	ВЫБОР
	|		КОГДА &УправленческийУчетОрганизаций
	...
	|	ВтТаблицаВидыЗапасовОприходование КАК ТаблицаВидыЗапасов
	|ГДЕ
	|	&КорректировкаРеализации2_5 И &КорректировкаПрошлогоПериодаГод
	|	И ТаблицаВидыЗапасов.СуммаСНДСУпр < 0 
	|	И (&ОтразитьВПрибылиУбыткахПрошлыхЛет ИЛИ НЕ &КорректироватьНалоговуюБазуПрошлогоПериода)
	|	И &ИспользоватьУчетПрочихДоходовРасходов
	|	И ТаблицаВидыЗапасов.Номенклатура.ТипНоменклатуры В (
	|		ЗНАЧЕНИЕ(Перечисление.ТипыНоменклатуры.Товар),
	|		ЗНАЧЕНИЕ(Перечисление.ТипыНоменклатуры.МногооборотнаяТара),
	...
	|	И (ТаблицаРасхождения.НаДоходы И НЕ &КорректировкаРеализации2_5
	|		И (ВЫБОР 
	|			КОГДА &ЭтоКорректировкаРеализацииУслугПрочихАктивов ТОГДА
	|				НЕ &КорректировкаПрошлогоПериодаГод
	|			ИНАЧЕ ИСТИНА КОНЕЦ)
	|		ИЛИ &КорректировкаРеализации2_5 И &КорректировкаПрошлогоПериодаГод
	|			И (&ОтразитьВПрибылиУбыткахПрошлыхЛет
	|				ИЛИ НЕ &КорректироватьНалоговуюБазуПрошлогоПериода))
	|	И ТаблицаРасхождения.СуммаСНДСУпр > 0
	...
	|	КорректировкаЗадолженности.НомерСтроки КАК НомерСтроки,
	|	&Период                                КАК Период,
	|	ДАТАВРЕМЯ(1,1,1,0,0,0) КАК ПериодКорректировки,
	|	&Организация                           КАК Организация,
...
Процедура ОтразитьПрочуюВыручку(Запрос, ТекстыЗапроса, Регистры)
	...
	|	&Организация КАК Организация,
	|	ВЫБОР
	|		КОГДА &КорректировкаРеализации2_5 И &КорректироватьНалоговуюБазуПрошлогоПериода
	...
	|	ВЫБОР
	|		КОГДА НЕ &КорректировкаРеализации2_5 ИЛИ НЕ &ОтразитьВПрибылиУбыткахПрошлыхЛет
	|			ТОГДА ТаблицаДоходы.СуммаБезНДСУпр
	|		ИНАЧЕ 0 
	|	КОНЕЦ КАК ВыручкаБезНДСУпр,
	|	ВЫБОР
	|		КОГДА НЕ &КорректировкаРеализации2_5 ИЛИ НЕ &ОтразитьВПрибылиУбыткахПрошлыхЛет
	|			ТОГДА ТаблицаДоходы.СуммаБезНДСРегл
	|		ИНАЧЕ 0 
	|	КОНЕЦ КАК ВыручкаБезНДСРегл,
	|	ВЫБОР
	|		КОГДА НЕ &КорректировкаРеализации2_5 ИЛИ НЕ &ОтразитьВПрибылиУбыткахПрошлыхЛет
	|			ТОГДА ТаблицаДоходы.СуммаСНДСУпр - ТаблицаДоходы.СуммаБезНДСУпр
	|		ИНАЧЕ 0
	|	КОНЕЦ КАК НДСУпр,
	|	ВЫБОР
	|		КОГДА НЕ &КорректировкаРеализации2_5 ИЛИ НЕ &ОтразитьВПрибылиУбыткахПрошлыхЛет
	|			ТОГДА ТаблицаДоходы.НДСРегл
	|		ИНАЧЕ 0
	|	КОНЕЦ КАК НДСРегл,
	|	ВЫБОР
	|		КОГДА &КорректировкаРеализации2_5 И &КорректировкаПрошлогоПериодаГод И &ОтразитьВПрибылиУбыткахПрошлыхЛет И &КорректироватьНалоговуюБазуПрошлогоПериода
	...
	|	И (ТаблицаДоходы.НаДоходы И НАЧАЛОПЕРИОДА(ДанныеДокумента.Дата, ГОД) = НАЧАЛОПЕРИОДА(ДанныеДокумента.ДокументОснование.Дата, ГОД) И НЕ &КорректировкаРеализации2_5
	|		ИЛИ &КорректировкаРеализации2_5 И (НЕ &ОтразитьВПрибылиУбыткахПрошлыхЛет ИЛИ &КорректироватьНалоговуюБазуПрошлогоПериода))
	|";
...
Функция ТекстЗапросаТаблицаВтИсходныеПрочиеРасходы(Запрос, ТекстыЗапроса)
	...
	ТекстЗапроса = РегистрыНакопления.ПрочиеРасходы.ТекстОписаниеВтИсходныеПрочиеРасходы("ИдентификаторСтроки,ПериодОтклонения");
	...
	|		КОГДА &КорректировкаРеализации2_5
	|			ТОГДА &Подразделение
	|		ИНАЧЕ &ПодразделениеРасходы
	|	КОНЕЦ                                  КАК Подразделение,
	|	ВЫБОР
	|		КОГДА &КорректировкаПрошлогоПериодаГод 
	|			И &КорректировкаРеализации2_5
	|			ТОГДА ЗНАЧЕНИЕ(ПланВидовХарактеристик.СтатьиРасходов.ПрибыльУбытокПрошлыхЛет)
	...
	|	ВЫБОР
	|		КОГДА НЕ &КорректировкаРеализации2_5 ИЛИ &ОтразитьВПрибылиУбыткахПрошлыхЛет
	|		ТОГДА ВидыЗапасов.СуммаБезНДСУпр +ВидыЗапасов.НДСУпр
	|	ИНАЧЕ 0 КОНЕЦ КАК СуммаБезНДСУпр,
	|	ВЫБОР
	|		КОГДА НЕ &КорректировкаРеализации2_5 ИЛИ &ОтразитьВПрибылиУбыткахПрошлыхЛет
	|		ТОГДА ВидыЗапасов.СуммаБезНДСРегл + ВидыЗапасов.НДСРегл
	|	ИНАЧЕ 0 КОНЕЦ КАК СуммаСНДСРегл,
	|	ВЫБОР
	|		КОГДА НЕ &КорректировкаРеализации2_5 ИЛИ &ОтразитьВПрибылиУбыткахПрошлыхЛет
	|		ТОГДА ВидыЗапасов.СуммаБезНДСРегл + ВидыЗапасов.НДСРегл
	...
	|ГДЕ 
	|	(ВидыЗапасов.НаДоходыРасходы И НЕ &КорректировкаРеализации2_5
	|		ИЛИ &КорректировкаРеализации2_5 И &КорректировкаПрошлогоПериодаГод
	|			И (&ОтразитьВПрибылиУбыткахПрошлыхЛет
	|				ИЛИ НЕ &КорректироватьНалоговуюБазуПрошлогоПериода))
	|	И ВидыЗапасов.СуммаСНДСУпр > 0
	|
	|ОБЪЕДИНИТЬ ВСЕ
	|
	|ВЫБРАТЬ
	...
	|	ВЫБОР
	|		КОГДА НЕ &КорректировкаРеализации2_5 ИЛИ &ОтразитьВПрибылиУбыткахПрошлыхЛет
	|		ТОГДА -РаботыУслуги.СуммаСНДСУпр
	|	ИНАЧЕ 0 КОНЕЦ КАК СуммаСНДС,
	|	ВЫБОР
	|		КОГДА НЕ &КорректировкаРеализации2_5 ИЛИ &ОтразитьВПрибылиУбыткахПрошлыхЛет
	|		ТОГДА -РаботыУслуги.СуммаБезНДСУпр
	|	ИНАЧЕ 0 КОНЕЦ КАК СуммаБезНДС,
	|	ВЫБОР
	|		КОГДА НЕ &КорректировкаРеализации2_5 ИЛИ &ОтразитьВПрибылиУбыткахПрошлыхЛет
	|		ТОГДА -(РаботыУслуги.СуммаБезНДСУпр + РаботыУслуги.НДСУпр)
	|	ИНАЧЕ 0 КОНЕЦ КАК СуммаБезНДСУпр,
	|	ВЫБОР
	|		КОГДА НЕ &КорректировкаРеализации2_5 ИЛИ &ОтразитьВПрибылиУбыткахПрошлыхЛет
	|		ТОГДА - (РаботыУслуги.СуммаБезНДСРегл + РаботыУслуги.НДСРегл)
	|	ИНАЧЕ 0 КОНЕЦ КАК СуммаСНДСРегл,
	|	ВЫБОР
	|		КОГДА НЕ &КорректировкаРеализации2_5 ИЛИ &ОтразитьВПрибылиУбыткахПрошлыхЛет
	|		ТОГДА - (РаботыУслуги.СуммаБезНДСРегл + РаботыУслуги.НДСРегл)
	...
	|	ВЫБОР
	|		КОГДА РаботыУслуги.СпособОпределенияСебестоимости В (
	|				ЗНАЧЕНИЕ(Перечисление.СпособыОпределенияСебестоимостиВозврата.Вручную),
	|				ЗНАЧЕНИЕ(Перечисление.СпособыОпределенияСебестоимостиВозврата.ИзТекущегоДокумента))
	|			ТОГДА ЗНАЧЕНИЕ(Справочник.НастройкиХозяйственныхОпераций.КорректировкаДоВводаОстатков)
	|		ИНАЧЕ &НастройкаХозяйственнойОперации
	|	КОНЕЦ КАК НастройкаХозяйственнойОперации,
	|	РаботыУслуги.ИдентификаторСтроки КАК ИдентификаторСтроки,
	|	ВЫБОР 
	|		КОГДА &КорректировкаРеализации2_5 ТОГДА
	|			ВЫБОР 
	|				КОГДА &КорректироватьНалоговуюБазуПрошлогоПериода ТОГДА
	...
	|		ПО СтатьиРасходов.Ссылка = &СтатьяРасходов
	|ГДЕ
	|	(РаботыУслуги.НаДоходыРасходы И НЕ &КорректировкаРеализации2_5
	|		ИЛИ &КорректировкаРеализации2_5 И &КорректировкаПрошлогоПериодаГод
	|			И (&ОтразитьВПрибылиУбыткахПрошлыхЛет
	|				ИЛИ НЕ &КорректироватьНалоговуюБазуПрошлогоПериода))
	...
	|	ВЫБОР
	|		КОГДА НЕ &КорректировкаРеализации2_5 ИЛИ &ОтразитьВПрибылиУбыткахПрошлыхЛет
	|		ТОГДА РаботыУслуги.НДСУпр
	|	ИНАЧЕ 0 КОНЕЦ КАК СуммаБезНДСУпр,
	|	ВЫБОР
	|		КОГДА НЕ &КорректировкаРеализации2_5 ИЛИ &ОтразитьВПрибылиУбыткахПрошлыхЛет
	|		ТОГДА РаботыУслуги.НДСРегл
	|	ИНАЧЕ 0 КОНЕЦ КАК СуммаСНДСРегл,
	|	ВЫБОР
	|		КОГДА НЕ &КорректировкаРеализации2_5 ИЛИ &ОтразитьВПрибылиУбыткахПрошлыхЛет
	|		ТОГДА РаботыУслуги.НДСРегл
	...
	|	&Организация                           КАК Организация,
	|	&Подразделение                         КАК Подразделение, 
	|	ЗНАЧЕНИЕ(ПланВидовХарактеристик.СтатьиРасходов.ПрибыльУбытокПрошлыхЛет) КАК СтатьяРасходов, 
	|	&АналитикаРасходов                     КАК АналитикаРасходов,
	|	&НаправлениеДеятельности               КАК НаправлениеДеятельности, 
	|	НЕОПРЕДЕЛЕНО КАК ВидДеятельностиНДС,
	|	ВЫБОР
	...
	|			ИЛИ НЕ &КорректировкаРеализации2_5
	|			ТОГДА 0
	|		КОГДА НЕ &ОтразитьВПрибылиУбыткахПрошлыхЛет И НЕ &КорректироватьНалоговуюБазуПрошлогоПериода
	|			ТОГДА ВидыЗапасов.СуммаБезНДСРегл + ВидыЗапасов.НДСРегл
	|		КОГДА &ОтразитьВПрибылиУбыткахПрошлыхЛет И &КорректироватьНалоговуюБазуПрошлогоПериода
	|			ТОГДА -(ВидыЗапасов.СуммаБезНДСРегл + ВидыЗапасов.НДСРегл)
	|		ИНАЧЕ 0
	|	КОНЕЦ КАК ПостояннаяРазница,
	|	0 КАК ВременнаяРазница,
	...
	|	
	|ИЗ
	|	ВтВидыЗапасовКорректировкаВыручки КАК ВидыЗапасов
	|ГДЕ
	|	&КорректировкаРеализации2_5 И &КорректировкаПрошлогоПериодаГод
	|	И (&ОтразитьВПрибылиУбыткахПрошлыхЛет
	|		ИЛИ НЕ &КорректироватьНалоговуюБазуПрошлогоПериода)
	...
	|	ВЫБОР
	|		КОГДА &ОтразитьВПрибылиУбыткахПрошлыхЛет
	|			ТОГДА ВидыЗапасов.СуммаСНДСУпр - ВидыЗапасов.СуммаБезНДСУпр
	|	ИНАЧЕ 0 КОНЕЦ КАК СуммаБезНДСУпр,
	|	ВЫБОР
	|		КОГДА &ОтразитьВПрибылиУбыткахПрошлыхЛет
	|			ТОГДА ВидыЗапасов.НДСРегл
	...
	|	ЗНАЧЕНИЕ(Справочник.НастройкиХозяйственныхОпераций.КорректировкаЗадолженности) КАК НастройкаХозяйственнойОперации,
	|	КорректировкаЗадолженности.ИдентификаторСтроки КАК ИдентификаторСтроки,
	|	ДАТАВРЕМЯ(1,1,1,0,0,0) КАК ПериодОтклонения
	|
	|ИЗ
	|	ВтТаблицаКорректировкаЗадолженности КАК КорректировкаЗадолженности
	|ГДЕ
...
Функция ТекстЗапросаТаблицаДвиженияПоПрочимАктивамПассивам(Запрос, ТекстыЗапроса, Регистры)
	...
	|	ТаблицаВидыЗапасов.НДСУпр КАК СуммаУпр,
	...
	|	ПО 
	|		Аналитика.Назначение = СпрНазначения.Ссылка
	|ГДЕ
	|	ТИПЗНАЧЕНИЯ(&ДокументОснование) = ТИП(Документ.РеализацияТоваровУслуг)
	|	И &ХозОперацияОснования = ЗНАЧЕНИЕ(Перечисление.ХозяйственныеОперации.ПереходПраваСобственности)
	...
	|	ТаблицаВидыЗапасов.ИдентификаторСтроки КАК ИдентификаторФинЗаписи,
	// Поля ИдентификаторФинЗаписи и НастройкаХозяйственнойОперации должны одинаково заполняться
	// в движениях по прочим АП и в выручке и себестоимости продаж. Функция ТекстЗапросаТаблицаВыручкаИСебестоимостьПродаж().
	|	(ВЫБОР
	|		КОГДА ТаблицаВидыЗапасов.СпособОпределенияСебестоимости В (
	|				ЗНАЧЕНИЕ(Перечисление.СпособыОпределенияСебестоимостиВозврата.Вручную),
	|				ЗНАЧЕНИЕ(Перечисление.СпособыОпределенияСебестоимостиВозврата.ИзТекущегоДокумента))
	|			ТОГДА ЗНАЧЕНИЕ(Справочник.НастройкиХозяйственныхОпераций.КорректировкаДоВводаОстатков)
	|		КОГДА &КорректировкаПрошлогоПериода
	|		ТОГДА &НастройкаХозяйственнойОперации
	|		КОГДА ТаблицаВидыЗапасов.Склад <> ТаблицаВидыЗапасов.СкладОтгрузки
	|		ТОГДА ЗНАЧЕНИЕ(Справочник.НастройкиХозяйственныхОпераций.СторноРеализацииВозвратНаДругойСклад)
	|		ИНАЧЕ &НастройкаХозяйственнойОперации КОНЕЦ) КАК НастройкаХозяйственнойОперации
	|ИЗ
	|	ВтТаблицаВидыЗапасовОприходование КАК ТаблицаВидыЗапасов
...
Процедура ИнициализироватьВтТоварыВозврата(Запрос, ТекстыЗапроса)
	
	Если Запрос.Параметры.Свойство("ВтТоварыВозврата") Тогда
		Возврат;
	КонецЕсли;
	
	ЗапросТоварыВозврата = Новый Запрос;
	ЗапросТоварыВозврата.МенеджерВременныхТаблиц = Запрос.МенеджерВременныхТаблиц;
	
	ЗапросТоварыВозврата.УстановитьПараметр("Ссылка",						Запрос.Параметры.Ссылка);
	ЗапросТоварыВозврата.УстановитьПараметр("РеализацияЧерезКомиссионера",	Запрос.Параметры.РеализацияЧерезКомиссионера);
	ЗапросТоварыВозврата.УстановитьПараметр("ПериодОтгрузки",				Запрос.Параметры.ПериодОтгрузки);
	
	ЗапросТоварыВозврата.Текст = 
	"ВЫБРАТЬ
	|	Расхождения.Ссылка.Дата КАК Период,
	|	&ПериодОтгрузки КАК ДатаРеализации,
	|	Расхождения.Ссылка КАК Ссылка,
	...
	|	Расхождения.СтавкаНДС КАК СтавкаНДС
	|ПОМЕСТИТЬ ВтТоварыВозврата
	|ИЗ
	|	Документ.КорректировкаРеализации.Расхождения КАК Расхождения
	|		ЛЕВОЕ СОЕДИНЕНИЕ Документ.КорректировкаРеализации.Товары КАК Товары
	|		ПО (Товары.Ссылка В (&Ссылка))
	|			И (Товары.НомерСтроки = 1)
	|ГДЕ
	|	Расхождения.Ссылка В (&Ссылка)
	|	И Товары.Ссылка ЕСТЬ NULL";
	
	ЗапросТоварыВозврата.Выполнить();
	
	Запрос.УстановитьПараметр("ВтТоварыВозврата", Истина);
	
КонецПроцедуры

Процедура ОтразитьВУчетеНДС(Запрос, ТекстыЗапроса, Регистры, ДокументСсылка)
	
	Если Не УчетНДСУП.ТребуетсяПроведениеПоРегистрамНДС(Регистры) Тогда
		Возврат;
	КонецЕсли;
	
	Если ОбщегоНазначения.ЗначениеРеквизитаОбъекта(ДокументСсылка, "ХозяйственнаяОперация") = Перечисления.ХозяйственныеОперации.ПереходПраваСобственности Тогда 
		Возврат;
	КонецЕсли;
	
	ИнициализироватьВтВидыЗапасовДокументаОснования(Запрос, ТекстыЗапроса);
	
	ИнициализироватьВтТоварыВозврата(Запрос, ТекстыЗапроса);
	...
	|	ВидыЗапасов.АналитикаУчетаНоменклатуры.Характеристика КАК Характеристика,
	|	ВЫБОР
	|		КОГДА Расхождения.ВариантОтражения ЕСТЬ NULL
	|			ТОГДА ВидыЗапасов.АналитикаУчетаНоменклатуры.Серия
	|		ИНАЧЕ ВидыЗапасов.КорАналитикаУчетаНоменклатуры.Серия
	|	КОНЕЦ КАК Серия,
	|	ВидыЗапасов.НоменклатураПартнера КАК НоменклатураПартнера,	
	|	ВидыЗапасов.АналитикаУчетаНаборов.НоменклатураНабора КАК НоменклатураНабора,
	|	ВидыЗапасов.АналитикаУчетаНаборов.ХарактеристикаНабора КАК ХарактеристикаНабора,
	...
	|		И ВидыЗапасов.КорАналитикаУчетаНоменклатуры = Расхождения.КорАналитикаУчетаНоменклатуры
	|		И ВидыЗапасов.АналитикаУчетаНаборов = Расхождения.АналитикаУчетаНаборов
	|		И ВидыЗапасов.КодТНВЭД = Расхождения.КодТНВЭД
	|		И ВидыЗапасов.НомерГТД = Расхождения.НомерГТД
	|		И Расхождения.ВариантОтражения = ЗНАЧЕНИЕ(Перечисление.ВариантыОтраженияКорректировокРеализаций.ВернутьВПуть)
	|ГДЕ
	|	ВидыЗапасов.Ссылка В (&Ссылка)
	|	И (ВидыЗапасов.Ссылка.ВидКорректировки В (
	|			ЗНАЧЕНИЕ(Перечисление.ХозяйственныеОперации.ИсправлениеОшибок),
	|			ЗНАЧЕНИЕ(Перечисление.ХозяйственныеОперации.КорректировкаПоСогласованиюСторон))
	|		ИЛИ (ВидыЗапасов.Ссылка.ВидКорректировки В (
	|			ЗНАЧЕНИЕ(Перечисление.ХозяйственныеОперации.РеализацияПерепоставленногоТовара),
	|			ЗНАЧЕНИЕ(Перечисление.ХозяйственныеОперации.ВозвратНедопоставленногоТовара))
	|			И НЕ ВидыЗапасов.СтавкаНДС.ПеречислениеСтавкаНДС = &СтавкаНДСНаЭкспорт))
	|	И (ВЫБОР
...
Функция ТекстЗапросаТаблицаРаспоряженияНаОтгрузку(Запрос, ТекстыЗапроса, Регистры)
	...
	"ВЫБРАТЬ
	|	ТаблицаРасхождения.НомерСтроки КАК НомерСтроки,
	|	ТаблицаРасхождения.Ссылка.Дата КАК Период,
	|	ТаблицаРасхождения.Ссылка КАК Распоряжение,
	|	ТаблицаРасхождения.Номенклатура КАК Номенклатура,
	|	ТаблицаРасхождения.Характеристика КАК Характеристика,
	|	ТаблицаРасхождения.КодСтроки КАК КодСтроки,
	|	ВЫБОР
	|		КОГДА ТаблицаПоказателей.Ссылка = ЗНАЧЕНИЕ(Перечисление.ПоказателиРаспоряженийНаОтгрузкуИВозврат.КПриемке)
	...
	|	ВЫБОР
	|		КОГДА ТаблицаПоказателей.Ссылка = ЗНАЧЕНИЕ(Перечисление.ПоказателиРаспоряженийНаОтгрузкуИВозврат.КПриемке)
	|				И ТаблицаРасхождения.СтатусУказанияСерий В (10, 14)
	...
	|	-ТаблицаРасхождения.Количество КАК Количество,
	|	ВЫБОР
	|		КОГДА ТаблицаРасхождения.СуммаВзаиморасчетов > 0
	|			ТОГДА ТаблицаРасхождения.СуммаВзаиморасчетов
	|		ИНАЧЕ
	|			-ТаблицаРасхождения.СуммаВзаиморасчетов
	|	КОНЕЦ КАК Сумма,
	|	ВЫБОР
	|		КОГДА ТаблицаРасхождения.СуммаНДСРегл > 0
	|			ТОГДА ТаблицаРасхождения.СуммаНДСРегл
	|		ИНАЧЕ
	|			-ТаблицаРасхождения.СуммаНДСРегл
	|	КОНЕЦ КАК СуммаНДСРегл,
	|	ВЫБОР
	|		КОГДА ТаблицаРасхождения.СуммаНДСУпр > 0
	|			ТОГДА ТаблицаРасхождения.СуммаНДСУпр
	|		ИНАЧЕ
	|			-ТаблицаРасхождения.СуммаНДСУпр
	|	КОНЕЦ КАК СуммаНДСУпр
	|ИЗ
	|	Документ.КорректировкаРеализации.Расхождения КАК ТаблицаРасхождения
	|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ Перечисление.ПоказателиРаспоряженийНаОтгрузкуИВозврат КАК ТаблицаПоказателей
	|		ПО ТаблицаПоказателей.Ссылка В (ЗНАЧЕНИЕ(Перечисление.ПоказателиРаспоряженийНаОтгрузкуИВозврат.ЗаявленоНаВозврат),
	...
	|ГДЕ
	|	ТаблицаРасхождения.Ссылка = &Ссылка
	|	И ТаблицаРасхождения.ВариантОтражения = ЗНАЧЕНИЕ(Перечисление.ВариантыОтраженияКорректировокРеализаций.ВернутьВПуть)
	|	И ТИПЗНАЧЕНИЯ(ТаблицаРасхождения.Ссылка.ДокументОснование) = ТИП(Документ.РеализацияТоваровУслуг)
	|	И ТаблицаРасхождения.Ссылка.ХозяйственнаяОперация В
	...
	|	ТаблицаРасхождения.КодСтроки КАК КодСтроки,
	|	ВЫБОР
	|		КОГДА ТаблицаПоказателей.Ссылка В (ЗНАЧЕНИЕ(Перечисление.ПоказателиРаспоряженийНаОтгрузкуИВозврат.Заказано),
	...
	|	ТаблицаПоказателей.Ссылка КАК Показатель,
	|	ТаблицаРасхождения.Количество КАК Количество,
	|	ТаблицаРасхождения.СуммаВзаиморасчетов КАК Сумма,
	|	ТаблицаРасхождения.СуммаНДСРегл КАК СуммаНДСРегл,
	|	ТаблицаРасхождения.СуммаНДСУпр КАК СуммаНДСУпр
	|ИЗ
	|	Документ.КорректировкаРеализации.Расхождения КАК ТаблицаРасхождения
	|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ Перечисление.ПоказателиРаспоряженийНаОтгрузкуИВозврат КАК ТаблицаПоказателей
	|		ПО ТаблицаПоказателей.Ссылка В (ЗНАЧЕНИЕ(Перечисление.ПоказателиРаспоряженийНаОтгрузкуИВозврат.Заказано),
	|			ЗНАЧЕНИЕ(Перечисление.ПоказателиРаспоряженийНаОтгрузкуИВозврат.КОтгрузке),
	...
	|	ТаблицаРасхождения.Номенклатура КАК Номенклатура,
	|	ТаблицаРасхождения.Характеристика КАК Характеристика,
	|	ТаблицаРасхождения.КодСтрокиОснования КАК КодСтроки,
	|	ЗНАЧЕНИЕ(Справочник.Склады.ПустаяСсылка) КАК Склад,
	|	ВЫБОР
	|		КОГДА ТаблицаРасхождения.СтатусУказанияСерий В (10, 14)
	|			ТОГДА ТаблицаРасхождения.Серия
	|		ИНАЧЕ
	|			ЗНАЧЕНИЕ(Справочник.СерииНоменклатуры.ПустаяСсылка)
	|	КОНЕЦ КАК Серия,
	|	ЗНАЧЕНИЕ(Перечисление.ПоказателиРаспоряженийНаОтгрузкуИВозврат.Скорректировано) КАК Показатель,
	|	ТаблицаРасхождения.Количество КАК Количество,
	|	ТаблицаРасхождения.СуммаВзаиморасчетов КАК Сумма,
	|	ТаблицаРасхождения.СуммаНДСРегл КАК СуммаНДСРегл,
	|	ТаблицаРасхождения.СуммаНДСУпр КАК СуммаНДСУпр
	...
	|	ТаблицаРасхождения.Ссылка = &Ссылка
	|	И ТИПЗНАЧЕНИЯ(ТаблицаРасхождения.Ссылка.ДокументОснование) = ТИП(Документ.РеализацияТоваровУслуг)
	|	И ТаблицаРасхождения.Ссылка.ХозяйственнаяОперация =
	|		ЗНАЧЕНИЕ(Перечисление.ХозяйственныеОперации.ПереходПраваСобственности)
	|
	|УПОРЯДОЧИТЬ ПО
	|	НомерСтроки,
...
Функция ОписаниеОперацийУчетаСебестоимости(Документ) Экспорт
	...
	|				ЗНАЧЕНИЕ(Перечисление.ТипыЗапасов.ПолуфабрикатДавальца),
	|				ЗНАЧЕНИЕ(Перечисление.ТипыЗапасов.ПродукцияДавальца))
	|		ТОГДА ТаблицаДокумента.ХозяйственнаяОперация
	|		ИНАЧЕ ЗНАЧЕНИЕ(Перечисление.ХозяйственныеОперации.РеализацияКлиенту)
	|	КОНЕЦ									КАК ХозяйственнаяОперация,
	|	&НастройкаХозяйственнойОперации			КАК НастройкаХозяйственнойОперации
	|
	...
	|		ПО ИСТИНА
	|ГДЕ
	|	(НЕ ВидыЗапасов.НаДоходыРасходы ИЛИ &КорректировкаРеализации2_5)
	...
	|	И (НЕ ТаблицаРасхождения.НаДоходыРасходы ИЛИ &КорректировкаРеализации2_5)
	...
	|	НЕОПРЕДЕЛЕНО 										КАК КорОрганизация,
	|	ВЫБОР
	|		КОГДА ТаблицаДокумента.КорректировкаОтгрузкиБезПереходаПраваСобственности И &УчитыватьСебестоимостьТоваровПоНазначениям
	|		ТОГДА ВидыЗапасов.АналитикаУчетаНоменклатуры
	|		КОГДА ТаблицаДокумента.КорректировкаОтгрузкиБезПереходаПраваСобственности
	...
	|		ТОГДА ТаблицаДокумента.ХозОперацияОснования
	|		КОГДА &КорректировкаОтгрузкиБезПереходаПраваСобственности
	|		ТОГДА ЗНАЧЕНИЕ(Перечисление.ХозяйственныеОперации.РеализацияБезПереходаПраваСобственности)
	|		ИНАЧЕ ЗНАЧЕНИЕ(Перечисление.ХозяйственныеОперации.РеализацияКлиенту) 
	|	КОНЕЦ													КАК ХозяйственнаяОперация,
	|	ВидыЗапасов.ИдентификаторСтроки							КАК ИдентификаторФинЗаписи,
	...
	|			ЗНАЧЕНИЕ(Перечисление.ТипыЗапасов.ПолуфабрикатДавальца),
	|			ЗНАЧЕНИЕ(Перечисление.ТипыЗапасов.ПродукцияДавальца))
	|		 И ВидыЗапасов.КорВидЗапасов <> ЗНАЧЕНИЕ(Справочник.ВидыЗапасов.ПустаяСсылка)
	|			ТОГДА ВидыЗапасов.КорВидЗапасов
	...
	|		КОГДА &КорректировкаПрошлогоПериода
	|		ТОГДА ЗНАЧЕНИЕ(Перечисление.ХозяйственныеОперации.ВозвратТоваровОтКлиентаПрошлыхПериодов)
	|		ИНАЧЕ ЗНАЧЕНИЕ(Перечисление.ХозяйственныеОперации.СторноРеализацииВозвратНаДругойСклад)
	|	КОНЕЦ КАК ХозяйственнаяОперация,
	|	ВидыЗапасов.ИдентификаторСтроки КАК ИдентификаторФинЗаписи,
	|	ВЫБОР
	|		КОГДА &КорректировкаПрошлогоПериода
	|		ТОГДА ТаблицаДокумента.НастройкаХозяйственнойОперации
	|		ИНАЧЕ ЗНАЧЕНИЕ(Справочник.НастройкиХозяйственныхОпераций.СторноРеализацииВозвратНаДругойСклад)
	|	КОНЕЦ КАК НастройкаХозяйственнойОперации,
	|	ВЫБОР
	|		КОГДА &КорректировкаПрошлогоПериода
	...
	//Условия возврата на другое место хранения (ХО СторноРеализацииВозвратНаДругойСклад), для этой ХО будет использоваться движение аналогичное возврату в прошлом периоде
	|		ИЛИ ВидыЗапасов.Склад <> ВидыЗапасов.СкладОтгрузки)
	// При использовании среднескользящей стоимости дата перехода права собственности должна относится к прошлому периоду.
	|	И (&ДатаПереходаПраваСобственности < НАЧАЛОПЕРИОДА(ТаблицаДокумента.Период, МЕСЯЦ)
	|		ИЛИ &ДатаПереходаПраваСобственности = ДАТАВРЕМЯ(1,1,1)
	|		ИЛИ НЕ &СреднеСкользящая)
	|	И ВидыЗапасов.ТипЗапасов В (
	|		ЗНАЧЕНИЕ(Перечисление.ТипыЗапасов.Товар),
	...
	|		ПО ИСТИНА
	|ГДЕ
	|	(НЕ ТаблицаВидыЗапасов.НаДоходыРасходы ИЛИ &КорректировкаРеализации2_5)
	|	И (&КорректировкаТекущегоПериода
	// При использовании среднескользящей стоимости дата перехода права собственности определяет корректировку текущего периода.
	|		ИЛИ &ДатаПереходаПраваСобственности >= НАЧАЛОПЕРИОДА(ТаблицаДокумента.Период, МЕСЯЦ)
	|		И &СреднеСкользящая)
	//Условия отсутствия возврата на другой склад (ХО СторноРеализацииВозвратНаДругойСклад), для этой ХО будет использоваться движение аналогичное возврату в прошлом периоде
	|	И ТаблицаВидыЗапасов.Склад = ТаблицаВидыЗапасов.СкладОтгрузки
	|	И ТаблицаВидыЗапасов.ТипЗапасов В (
	|		ЗНАЧЕНИЕ(Перечисление.ТипыЗапасов.Товар),
	|		ЗНАЧЕНИЕ(Перечисление.ТипыЗапасов.Работа),
	|		ЗНАЧЕНИЕ(Перечисление.ТипыЗапасов.ПолуфабрикатДавальца),
	...
	|	КОНЕЦ											КАК СтоимостьУпр,
	|	ВЫБОР
	|		КОГДА &УправленческийУчетОрганизаций И НЕ ВидыЗапасов.ВидДеятельностиНДС В (&ТипыНалогообложенияНДСУчитываетсяВСтоимости)
	|		ТОГДА ВидыЗапасов.НДСУпр
	|		ИНАЧЕ 0
	|	КОНЕЦ											КАК НДСУпр,
	...
	|	И ВидыЗапасов.Склад = ВидыЗапасов.СкладОтгрузки
	|	И ВидыЗапасов.ТипЗапасов = ЗНАЧЕНИЕ(Перечисление.ТипыЗапасов.Товар)
	|	И ВидыЗапасов.ТипНоменклатуры = ЗНАЧЕНИЕ(Перечисление.ТипыНоменклатуры.МногооборотнаяТара)
	|	И &ВернутьМногооборотнуюТару
	|	И НЕ ВидыЗапасов.СпособОпределенияСебестоимости В (
	...
	// Прочие поля
	|	ВЫБОР
	|		КОГДА НЕ &КорректировкаТекущегоПериода
	...
	|		ПО ИСТИНА
	|ГДЕ
	|	(НЕ ТаблицаРасхождения.НаДоходыРасходы ИЛИ &КорректировкаРеализации2_5)
	|	И (ТаблицаРасхождения.ТипНоменклатуры = ЗНАЧЕНИЕ(Перечисление.ТипыНоменклатуры.Работа)
	|	)
	|	И ТаблицаРасхождения.Количество < 0
	|	И &КорректировкаПрошлогоПериода
	...
	|		КОГДА ТаблицаРасхождения.ВидДеятельностиНДС В (&ТипыНалогообложенияНДСУчитываетсяВСтоимости)
	|		ТОГДА 0
	|		ИНАЧЕ -ТаблицаРасхождения.НДСРегл
	|	КОНЕЦ КАК НДСРегл,
	|	ВЫБОР
	|		КОГДА НЕ &УправленческийУчетОрганизаций ТОГДА 0
	|		КОГДА ТаблицаРасхождения.СпособОпределенияСебестоимости = ЗНАЧЕНИЕ(Перечисление.СпособыОпределенияСебестоимостиВозврата.Вручную)
	...
	|	КОНЕЦ 											КАК СтоимостьУпр,
	|	-ВЫБОР
	|		КОГДА &УправленческийУчетОрганизаций И НЕ ТаблицаРасхождения.ВидДеятельностиНДС В (&ТипыНалогообложенияНДСУчитываетсяВСтоимости)
	|		ТОГДА ТаблицаРасхождения.НДСУпр
	|		ИНАЧЕ 0
	|	КОНЕЦ											КАК НДСУпр,
	|	0												КАК СтоимостьЗабалансовая,
	...
	|														КАК ХозяйственнаяОперация,
	|	ВЫБОР
	|		КОГДА ТаблицаДокумента.ХозяйственнаяОперация В(
	|				ЗНАЧЕНИЕ(Перечисление.ХозяйственныеОперации.ОтчетДавальцу2_5),
	|				ЗНАЧЕНИЕ(Перечисление.ХозяйственныеОперации.ПроизводствоПродукцииИзДавальческогоСырья2_5),
	|				ЗНАЧЕНИЕ(Перечисление.ХозяйственныеОперации.РемонтПродукцииИзДавальческогоСырья2_5),
	|				ЗНАЧЕНИЕ(Перечисление.ХозяйственныеОперации.ВыполнениеРаботСИспользованиемДавальческогоСырья2_5),
...
Процедура ДобавитьКомандыПечати(КомандыПечати) Экспорт
	...
	Если НЕ ПраваПользователяПовтИсп.ЭтоПартнер() Тогда
		...
		КомандаПечати.НаименованиеПечатнойФормы = НСтр("ru = 'Акт об оказании услуг'");
...
Функция ТекстЗапросаДанныхКорректировокДоВводаОстатков()
...
Функция ТекстЗапросаВтВидыЗапасов() Экспорт
	...
	ТекстЗапроса = ТекстЗапросаДанныхКорректировокДоВводаОстатков() + ОбщегоНазначенияУт.РазделительЗапросовВПакете() + ТекстЗапроса;
...
Функция ПараметрыРегистрацииСчетовФактурВыданных(Документ) Экспорт
	...
	Реквизиты = Новый Структура("Ссылка, Дата, Контрагент, Организация, НалогообложениеНДС, ВидКорректировки, ДокументОснование, ХозяйственнаяОперация");
	...
	КонецЕсли;
	ПараметрыРегистрации.ПереходПраваСобственности = (Реквизиты.ХозяйственнаяОперация = Перечисления.ХозяйственныеОперации.ПереходПраваСобственности);
...
//		* КорректировкаРеализации2_5 - Булево - значение реквизита документа.
//		* ОтразитьВПрибылиУбыткахПрошлыхЛет - Булево - значение реквизита документа.
//		* КорректироватьНалоговуюБазуПрошлогоПериода - Булево - значение реквизита документа.
//
Функция ПараметрыОпределенияДоступностиВыбораСтатейИАналитик() Экспорт
	...
	ПараметрыОпределенияДоступности.Вставить("КорректировкаРеализации2_5", Ложь);
	ПараметрыОпределенияДоступности.Вставить("ОтразитьВПрибылиУбыткахПрошлыхЛет", Ложь);
	ПараметрыОпределенияДоступности.Вставить("КорректироватьНалоговуюБазуПрошлогоПериода", Ложь);
...
Функция ПараметрыВыбораСтатейИАналитик(ПараметрыОпределенияДоступности) Экспорт
	...
	ПараметрыВыбора.ДоступностьПоОперации =
		КорректировкаУслугПрочихАктивовТекущегоПериода
			Или КорректировкаУслугПрочихАктивов
				И ПараметрыОпределенияДоступности.КорректировкаРеализации2_5
				И (Не ПараметрыОпределенияДоступности.ОтразитьВПрибылиУбыткахПрошлыхЛет
					Или ПараметрыОпределенияДоступности.КорректироватьНалоговуюБазуПрошлогоПериода);
	...
	#Область РасхожденияСтатьяДоходов
	ПараметрыВыбора = ДоходыИРасходыСервер.ПараметрыВыбораСтатьиИАналитики();
...
Процедура ЗаполнитьТоварыПоАктуПриемки(Объект, ЭтоВозвратВПуть = Ложь) Экспорт
	
	Объект.Товары.Очистить();
	
	ПараметрыПоиска = Новый Структура();
	ПараметрыПоиска.Вставить("Действие", Перечисления.ВариантыДействийПоРасхождениямВАктеПослеОтгрузки.ВозвратПерепоставленного);
	НайденныеСтроки = Объект.АктОРасхожденияхПослеОтгрузкиОснование.Товары.НайтиСтроки(ПараметрыПоиска);
	
	// Две корректировки вводятся в случае, когда в акте о расхождениях способ отражения - внесение корректировки,
	// и излишек отрабатывается вариантом "Оформить и вернуть". В этом случае вводится первая корректировка на
	// внесение излишка (в корректировке увеличивается количество), а вторая корректировка - для возврата "в путь" излишка,
	// оформленного в первой корректировке. 
	// Если для акта соблюдаются, описанные выше условия, плюс есть недостача, которая должны быть возвращена "в путь",
	// (действие с товаром "Вернуть") то все строки, для которых требуется вариант отражения "Вернуть в путь", будут
	// оформлены во второй(!) корректировке.
	
	ТребуетсяВводитьДвеКорректировки =
		ПолучитьФункциональнуюОпцию("ИспользоватьОтгрузкуБезПереходаПраваСобственности2_5")
		И НайденныеСтроки.Количество() > 0
		И Объект.АктОРасхожденияхПослеОтгрузкиОснование.СпособОтраженияРасхождений <>
	...
	// Корректировка на возврат в путь и требуется вводить две корректировки
	|	КОГДА &ЭтоВозвратВПуть
	|			И &ТребуетсяВводитьДвеКорректировки
	|			И АктОРасхожденияхПослеОтгрузкиТовары.Действие = ЗНАЧЕНИЕ(Перечисление.ВариантыДействийПоРасхождениямВАктеПослеОтгрузки.ВозвратПерепоставленного) ТОГДА
	|		АктОРасхожденияхПослеОтгрузкиТовары.КоличествоУпаковокПоДокументу
	|	КОГДА &ЭтоВозвратВПуть
	|			И &ТребуетсяВводитьДвеКорректировки
	|			И АктОРасхожденияхПослеОтгрузкиТовары.ДействиеСТоваром = ЗНАЧЕНИЕ(Перечисление.ВариантыДействийПоТоварамВАктеПослеОтгрузки.Вернуть) ТОГДА
	|		АктОРасхожденияхПослеОтгрузкиТовары.КоличествоУпаковок
	|	КОГДА &ЭтоВозвратВПуть
	|			И &ТребуетсяВводитьДвеКорректировки ТОГДА
	|		АктОРасхожденияхПослеОтгрузкиТовары.КоличествоУпаковок
	// Корректировка на возврат в путь и НЕ требуется вводить две корректировки
	|	КОГДА &ЭтоВозвратВПуть
	|			И НЕ &ТребуетсяВводитьДвеКорректировки
	|			И АктОРасхожденияхПослеОтгрузкиТовары.Действие = ЗНАЧЕНИЕ(Перечисление.ВариантыДействийПоРасхождениямВАктеПослеОтгрузки.ВозвратПерепоставленного) ТОГДА
	|		АктОРасхожденияхПослеОтгрузкиТовары.КоличествоУпаковокПоДокументу
	|	КОГДА &ЭтоВозвратВПуть
	|			И НЕ &ТребуетсяВводитьДвеКорректировки ТОГДА
	|		АктОРасхожденияхПослеОтгрузкиТовары.КоличествоУпаковокПоДокументу
	// НЕ Корректировка на возврат в путь и требуется вводить две корректировки
	|	КОГДА НЕ &ЭтоВозвратВПуть
	|			И &ТребуетсяВводитьДвеКорректировки
	|			И АктОРасхожденияхПослеОтгрузкиТовары.ДействиеСТоваром = ЗНАЧЕНИЕ(Перечисление.ВариантыДействийПоТоварамВАктеПослеОтгрузки.Вернуть) ТОГДА
	|		АктОРасхожденияхПослеОтгрузкиТовары.КоличествоУпаковокПоДокументу
	|	КОГДА НЕ &ЭтоВозвратВПуть
	|			И &ТребуетсяВводитьДвеКорректировки ТОГДА
	|		АктОРасхожденияхПослеОтгрузкиТовары.КоличествоУпаковок
	// НЕ Корректировка на возврат в путь и НЕ требуется вводить две корректировки
	...
	|	
	|	ВЫБОР
	|		КОГДА АктОРасхожденияхПослеОтгрузкиТовары.Ссылка.ХозяйственнаяОперация = ЗНАЧЕНИЕ(Перечисление.ХозяйственныеОперации.ПереходПраваСобственности)
	...
	|	ВЫБОР
	|		КОГДА АктОРасхожденияхПослеОтгрузкиТовары.КоличествоУпаковок > АктОРасхожденияхПослеОтгрузкиТовары.КоличествоУпаковокПоДокументу
	|				И НЕ (АктОРасхожденияхПослеОтгрузкиТовары.Действие = ЗНАЧЕНИЕ(Перечисление.ВариантыДействийПоРасхождениямВАктеПослеОтгрузки.ОприходоватьСейчас)
	|					ИЛИ АктОРасхожденияхПослеОтгрузкиТовары.Действие = ЗНАЧЕНИЕ(Перечисление.ВариантыДействийПоРасхождениямВАктеПослеОтгрузки.ПерепоставленноеДарится))
	...
	|	ВЫБОР
	|		КОГДА АктОРасхожденияхПослеОтгрузкиТовары.КоличествоУпаковок < АктОРасхожденияхПослеОтгрузкиТовары.КоличествоУпаковокПоДокументу
	|			И АктОРасхожденияхПослеОтгрузкиТовары.ДействиеСТоваром = ЗНАЧЕНИЕ(Перечисление.ВариантыДействийПоТоварамВАктеПослеОтгрузки.Вернуть)
	|			ТОГДА ЗНАЧЕНИЕ(Перечисление.ВариантыОтраженияКорректировокРеализаций.ВернутьВПуть)
	|		КОГДА АктОРасхожденияхПослеОтгрузкиТовары.КоличествоУпаковок > АктОРасхожденияхПослеОтгрузкиТовары.КоличествоУпаковокПоДокументу
	|			И АктОРасхожденияхПослеОтгрузкиТовары.Склад.ИспользоватьОрдернуюСхемуПриОтгрузке = ИСТИНА
	|			И АктОРасхожденияхПослеОтгрузкиТовары.Склад.ДатаНачалаОрдернойСхемыПриОтгрузке <= &ТекущаяДата
	|			ТОГДА ЗНАЧЕНИЕ(Перечисление.ВариантыОтраженияКорректировокРеализаций.УвеличитьРеализациюУчестьПриИнвентаризации)
	|		КОГДА АктОРасхожденияхПослеОтгрузкиТовары.КоличествоУпаковок > АктОРасхожденияхПослеОтгрузкиТовары.КоличествоУпаковокПоДокументу
	|			ТОГДА ЗНАЧЕНИЕ(Перечисление.ВариантыОтраженияКорректировокРеализаций.УвеличитьРеализациюУменьшитьСкладскиеОстатки)
	|		КОГДА АктОРасхожденияхПослеОтгрузкиТовары.КоличествоУпаковок < АктОРасхожденияхПослеОтгрузкиТовары.КоличествоУпаковокПоДокументу
	|			И АктОРасхожденияхПослеОтгрузкиТовары.Склад.ИспользоватьОрдернуюСхемуПриОтгрузке = ИСТИНА
	|			И АктОРасхожденияхПослеОтгрузкиТовары.Склад.ДатаНачалаОрдернойСхемыПриОтгрузке <= &ТекущаяДата
	|			ТОГДА ЗНАЧЕНИЕ(Перечисление.ВариантыОтраженияКорректировокРеализаций.УменьшитьРеализациюУчестьПриИнвентаризации)
	|		КОГДА АктОРасхожденияхПослеОтгрузкиТовары.КоличествоУпаковок < АктОРасхожденияхПослеОтгрузкиТовары.КоличествоУпаковокПоДокументу
	|			ТОГДА ЗНАЧЕНИЕ(Перечисление.ВариантыОтраженияКорректировокРеализаций.УменьшитьРеализациюУвеличитьСкладскиеОстатки)
	|	КОНЕЦ КАК ВариантОтраженияРасхождения,
	|
	|	ВЫБОР
	|		КОГДА &ЭтоВозвратВПуть
	|			ИЛИ АктОРасхожденияхПослеОтгрузкиТовары.КоличествоУпаковок < АктОРасхожденияхПослеОтгрузкиТовары.КоличествоУпаковокПоДокументу
	|				И АктОРасхожденияхПослеОтгрузкиТовары.ДействиеСТоваром = ЗНАЧЕНИЕ(Перечисление.ВариантыДействийПоТоварамВАктеПослеОтгрузки.Вернуть)
	|			ТОГДА ЗНАЧЕНИЕ(Справочник.Склады.ПустаяСсылка)
	|		ИНАЧЕ 
	|			АктОРасхожденияхПослеОтгрузкиТовары.Склад
	|	КОНЕЦ КАК СкладРасхождения
	|
	|ИЗ
	...
	Запрос.УстановитьПараметр("ЭтоВозвратВПуть", ЭтоВозвратВПуть);
	Запрос.УстановитьПараметр("ТребуетсяВводитьДвеКорректировки", ТребуетсяВводитьДвеКорректировки);
	...
	ЭтоПереходПраваСобственности =
		Объект.ХозяйственнаяОперация = Перечисления.ХозяйственныеОперации.ПереходПраваСобственности
			Или Объект.ДополнительныеСвойства.Свойство("ХозяйственнаяОперацияОснования")
				И Объект.ДополнительныеСвойства.ХозяйственнаяОперацияОснования =
					Перечисления.ХозяйственныеОперации.ПереходПраваСобственности;
	...
	Если ЭтоПереходПраваСобственности Тогда
		...
		ПроверитьСериюРассчитатьСтатус.Вставить("ПараметрыУказанияСерий", ПараметрыУказанияСерий.Товары);
	...
	Для Каждого СтрокаТаблицы Из РезультатТовары Цикл
		...
		Если СтрокаТаблицы.Количество > 0 Тогда
			...
			Если ЗначениеЗаполнено(СтрокаТаблицы.КоличествоУпаковокСверхЗаказа) Тогда
				ДополнительнаяСтрокаТовары = Объект.Товары.Добавить();
				ЗаполнитьЗначенияСвойств(ДополнительнаяСтрокаТовары, СтрокаТаблицы);
				ДополнительнаяСтрокаТовары.КоличествоУпаковок = СтрокаТаблицы.КоличествоУпаковокСверхЗаказа;
				ДополнительнаяСтрокаТовары.Количество = СтрокаТаблицы.КоличествоСверхЗаказа;
				ДополнительнаяСтрокаТовары.КодСтроки  = 0;
				
				ОбрабатываемыеСтроки.Добавить(НоваяСтрокаТовары);
				ОбрабатываемыеСтроки.Добавить(ДополнительнаяСтрокаТовары);
			
			ИначеЕсли ЭтоПереходПраваСобственности Тогда
				ОбрабатываемыеСтроки.Добавить(НоваяСтрокаТовары);
			КонецЕсли;
	...
	ТребуетсяЗаполнитьСкладВШапке = Ложь;
	СкладВШапке = Объект.Склад;
	Для Каждого СтрокаТЧ Из Объект.Расхождения Цикл
		
		Если ЭтоВозвратВПуть И СтрокаТЧ.Количество < 0 Тогда
			СтрокаТЧ.ВариантОтражения = Перечисления.ВариантыОтраженияКорректировокРеализаций.ВернутьВПуть;
		Иначе
			
			ПараметрыПоиска = Новый Структура(КлючевыеПоля);
			ЗаполнитьЗначенияСвойств(ПараметрыПоиска, СтрокаТЧ);
			НайденныеСтроки = РезультатТовары.НайтиСтроки(ПараметрыПоиска);
			
			// Вариант отражения и склад в ТЧ Расхождения заполняются, только когда есть возможность их определить однозначно.
			// Иначе их потребуется заполнить пользователю.
			// По ключевым полям может быть найдено несколько строк в ТЗ РезультатТовары с разными складами и вариантами отражения,
			// так как строки в ТЧ Товары предыдущих документов цепочки (реализации, акта) могут совпадать
			// (отличаться только кодом строки, который теряется при заполнении ТЧ Расхождения в корректировке реализации)
			
			Если НайденныеСтроки.Количество() > 1 Тогда
				
				ТребуетсяЗаполнениеВариантаОтражения = Истина;
				ТребуетсяЗаполнениеСклада = Истина;
				
				ВариантОтраженияРасхождения = Неопределено;
				СкладРасхождения = Неопределено;
				
				Для Каждого НайденнаяСтрока Из НайденныеСтроки Цикл
					
					Если ЗначениеЗаполнено(ВариантОтраженияРасхождения)
						И ВариантОтраженияРасхождения <> НайденнаяСтрока.ВариантОтраженияРасхождения Тогда
						ТребуетсяЗаполнениеВариантаОтражения = Ложь;
						Прервать;
					КонецЕсли;
					
					Если ЗначениеЗаполнено(СкладРасхождения)
						И СкладРасхождения <> НайденнаяСтрока.СкладРасхождения Тогда
						ТребуетсяЗаполнениеСклада = Ложь;
						Прервать;
					КонецЕсли;
					
					Если Не ЗначениеЗаполнено(ВариантОтраженияРасхождения) Тогда
						ВариантОтраженияРасхождения = НайденнаяСтрока.ВариантОтраженияРасхождения;
					КонецЕсли;
					
					Если Не ЗначениеЗаполнено(СкладРасхождения) Тогда
						СкладРасхождения = НайденнаяСтрока.СкладРасхождения;
					КонецЕсли;
			...
			ИначеЕсли НайденныеСтроки.Количество() = 1 Тогда
				...
				ВариантОтраженияРасхождения = НайденныеСтроки[0].ВариантОтраженияРасхождения;
				СкладРасхождения = НайденныеСтроки[0].СкладРасхождения;
			...
			Если ТребуетсяЗаполнениеВариантаОтражения Тогда
				
				Если СтрокаТЧ.Количество < 0
					И (ВариантОтраженияРасхождения = Перечисления.ВариантыОтраженияКорректировокРеализаций.ВернутьВПуть
						Или ВариантОтраженияРасхождения = Перечисления.ВариантыОтраженияКорректировокРеализаций.УменьшитьРеализациюУвеличитьСкладскиеОстатки
						Или ВариантОтраженияРасхождения = Перечисления.ВариантыОтраженияКорректировокРеализаций.УменьшитьРеализациюУчестьПриИнвентаризации) Тогда
					
					СтрокаТЧ.ВариантОтражения = ВариантОтраженияРасхождения;
					
				ИначеЕсли СтрокаТЧ.Количество > 0
					И (ВариантОтраженияРасхождения = Перечисления.ВариантыОтраженияКорректировокРеализаций.УвеличитьРеализациюУменьшитьСкладскиеОстатки
						Или ВариантОтраженияРасхождения = Перечисления.ВариантыОтраженияКорректировокРеализаций.УвеличитьРеализациюУчестьПриИнвентаризации) Тогда
			...
			Если ТребуетсяЗаполнениеСклада Тогда
				СтрокаТЧ.Склад = СкладРасхождения;
			КонецЕсли;
			
			Если ЗначениеЗаполнено(СтрокаТЧ.Склад)
				И Не ТребуетсяЗаполнитьСкладВШапке Тогда
				ТребуетсяЗаполнитьСкладВШапке = Истина;
			КонецЕсли;
			
			Если Не ЗначениеЗаполнено(СкладВШапке)
				И ЗначениеЗаполнено(СтрокаТЧ.ЗаказКлиента)
				И ТипЗнч(СтрокаТЧ.ЗаказКлиента) <> Тип("ДокументСсылка.ПервичныйДокумент") Тогда
				
				СкладВШапке = ОбщегоНазначения.ЗначениеРеквизитаОбъекта(СтрокаТЧ.ЗаказКлиента, "Склад");
			КонецЕсли;
	...
	Если ТребуетсяЗаполнитьСкладВШапке И Не ЗначениеЗаполнено(Объект.Склад) Тогда
		Объект.Склад = СкладВШапке;
	КонецЕсли;
	
	Если ЗначениеЗаполнено(Объект.Склад)
		И Не ОбщегоНазначения.ЗначениеРеквизитаОбъекта(Объект.Склад, "ЭтоГруппа") Тогда
		
		Для Каждого СтрокаТЧ Из Объект.Расхождения Цикл
			Если ЗначениеЗаполнено(СтрокаТЧ.Склад)
				Или СтрокаТЧ.ВариантОтражения = Перечисления.ВариантыОтраженияКорректировокРеализаций.ВернутьВПуть Тогда
				Продолжить;
			КонецЕсли;
...
Процедура ДополнитьТекстЗапросаПоРеализации(ТекстЗапроса)
	...
	|	ЗНАЧЕНИЕ(Перечисление.ВариантыОтраженияКорректировокРеализаций.ПустаяСсылка) КАК ВариантОтраженияРасхождения,
	|	ЗНАЧЕНИЕ(Справочник.Склады.ПустаяСсылка) КАК СкладРасхождения
	|ИЗ
...
// 
// Параметры:
//  СсылкаОбъект - ДокументСсылка.КорректировкаРеализации - Документ, по которому нужно получить данные.
...
Функция СуммыПоЗаказам(СсылкаОбъект, ЗначенияРеквизитов = Неопределено) Экспорт
	...
	|			КОГДА (Товары.Номенклатура.ТипНоменклатуры <> ЗНАЧЕНИЕ(Перечисление.ТипыНоменклатуры.МногооборотнаяТара)
	|					ИЛИ НЕ Товары.ВернутьМногооборотнуюТару)
	|					И Товары.СуммаВзаиморасчетов > 0
	...
	Если ЗначенияРеквизитов = Неопределено Тогда
		...
		ВидКорректировки = ОбщегоНазначения.ЗначениеРеквизитаОбъекта(СсылкаОбъект, "ВидКорректировки");
		...
		Если ВидКорректировки = Перечисления.ХозяйственныеОперации.КорректировкаРеализацииУвеличениеЗадолженностиСводно
			...
			|	ЛОЖЬ                                             КАК СверхЗаказа,
			|	СУММА(ВЫБОР 
			|		КОГДА КорректировкаЗадолженности.СуммаСНДС > 0
			|			ТОГДА КорректировкаЗадолженности.СуммаСНДС
			|		ИНАЧЕ 0 
			|	КОНЕЦ)                                           КАК СуммаПлатежа,
			|	СУММА(ВЫБОР 
			|		КОГДА КорректировкаЗадолженности.СуммаВзаиморасчетов > 0
			|			ТОГДА КорректировкаЗадолженности.СуммаВзаиморасчетов
			|		ИНАЧЕ 0 
			|	КОНЕЦ)                                           КАК СуммаВзаиморасчетов,
		...
		Иначе
			...
			Запрос.Текст = СтрЗаменить(Запрос.Текст, "&ТаблицаЗначений", "Документ.КорректировкаРеализации.Расхождения");
	...
	Иначе
		...
		Если ЗначенияРеквизитов.ТаблицаЗначений.Количество() = 0
			Или НЕ ОбщегоНазначенияКлиентСервер.ЕстьРеквизитИлиСвойствоОбъекта(ЗначенияРеквизитов.ТаблицаЗначений[0],"Номенклатура") Тогда
			Запрос.Текст = "
			|ВЫБРАТЬ
			|	Товары.СуммаСНДС           КАК Сумма,
			|	Товары.СуммаВзаиморасчетов КАК СуммаВзаиморасчетов
			...
			|	КОНЕЦ)                                           КАК СуммаПлатежа,
			|	СУММА(ВЫБОР 
			|		КОГДА ВТТовары.СуммаВзаиморасчетов > 0
			|			ТОГДА ВТТовары.СуммаВзаиморасчетов
			|		ИНАЧЕ 0 
			|	КОНЕЦ)                                           КАК СуммаВзаиморасчетов,
			|	0                                                КАК СуммаЗалогаЗаТару,
			|	0                                                КАК СуммаВзаиморасчетовПоТаре
...
// Возвращает список значений с вариантами отражений, для которых обязательно заполнение склада в корректировке
// реализации.
//
// Возвращаемое значение:
//	СписокЗначений из ПеречислениеСсылка.ВариантыОтраженияКорректировокРеализаций
//	
Функция ВариантыОтраженийСОбязательнымСкладом() Экспорт

	ВариантыОтраженияСОбязательнымСкладом = Новый СписокЗначений();
	ВариантыОтраженияСОбязательнымСкладом.Добавить(
	...
	Возврат ВариантыОтраженияСОбязательнымСкладом;
...
Функция ТекстЗапросаЗаполненияСтатусовУказанияСерийТовары()
...
Функция ТекстЗапросаЗаполненияСтатусовУказанияСерийРасхождения()
	...
	|	Товары.Серия КАК Серия,
	|	Товары.Количество КАК Количество,
	|	Товары.ВариантОтражения КАК ВариантОтражения,
	|	Товары.СтатусУказанияСерий КАК СтатусУказанияСерий,
	...
	|		КОГДА ПолитикиУчетаСерий.ПолитикаУчетаСерий ЕСТЬ NULL
	|			ТОГДА 0
	|		КОГДА &ОперацияДокумента = ЗНАЧЕНИЕ(Перечисление.ХозяйственныеОперации.ПереходПраваСобственности)
	|				И НЕ Товары.ВариантОтражения В (
	|						ЗНАЧЕНИЕ(Перечисление.ВариантыОтраженияКорректировокРеализаций.УменьшитьРеализациюУчестьПриИнвентаризации),
	|						ЗНАЧЕНИЕ(Перечисление.ВариантыОтраженияКорректировокРеализаций.УменьшитьРеализациюУвеличитьСкладскиеОстатки),
	|						ЗНАЧЕНИЕ(Перечисление.ВариантыОтраженияКорректировокРеализаций.УвеличитьРеализациюУчестьПриИнвентаризации),
	|						ЗНАЧЕНИЕ(Перечисление.ВариантыОтраженияКорректировокРеализаций.УвеличитьРеализациюУменьшитьСкладскиеОстатки)
	...
	|									ИЛИ &ОперацияДокумента = ЗНАЧЕНИЕ(Перечисление.ХозяйственныеОперации.ПереходПраваСобственности)
	|										И ТоварыДляЗапроса.ВидНоменклатуры.ПолитикаУчетаСерий.УчетСерийТоваровОтгруженныхКлиенту
	|									ИЛИ &ОперацияДокумента = ЗНАЧЕНИЕ(Перечисление.ХозяйственныеОперации.РеализацияКлиенту)
	|										И ТоварыДляЗапроса.ВариантОтражения = ЗНАЧЕНИЕ(Перечисление.ВариантыОтраженияКорректировокРеализаций.ВернутьВПуть)
	|								ТОГДА
	|									ВЫБОР
	|										КОГДА Товары.Серия <> ЗНАЧЕНИЕ(Справочник.СерииНоменклатуры.ПустаяСсылка)
	|											ТОГДА 18
	...
	|		ПО Товары.Номенклатура = ТоварыДляЗапроса.Номенклатура
	|			И Товары.Склад = ТоварыДляЗапроса.Склад
	|			И Товары.ВариантОтражения = ТоварыДляЗапроса.ВариантОтражения
	|;
	|
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ
...
Процедура ПриДобавленииОбработчиковОбновления(Обработчики) Экспорт
	...
	СписокОписаний.Добавить(НСтр("ru = '- заполнение реквизитов ""Статус указания серий на складах"" и ""Статус указания серий, переданных товаров"" в табличной части ""Расхождения"".';"));
	СписокОписаний.Добавить(НСтр("ru = '- заполнение реквизита ""Кор. аналитика учета номенклатуры"" в табличных частях ""Расхождения"", ""Виды запасов оприходование"" для документов с основанием ""Реализация товаров и услуг"" с операцией ""Реализация"".';"));
	СписокОписаний.Добавить(НСтр("ru = '- заполнение реквизита ""Кор. аналитика учета номенклатуры"" в табличной части ""Виды запасов списание"" для документов с основанием ""Реализация товаров и услуг"" с операциями ""Реализация"" и ""Переход права собственности"".';"));
...
Процедура ЗарегистрироватьДанныеКОбработкеДляПереходаНаНовуюВерсию(Параметры) Экспорт
	...
	|ИЗ
	|	Документ.КорректировкаРеализации.Расхождения КАК ДанныеРасхождений
	|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ Документ.КорректировкаРеализации КАК РеквизитыШапки
	|		ПО ДанныеРасхождений.Ссылка = РеквизитыШапки.Ссылка
	|ГДЕ
	|	НЕ РеквизитыШапки.ХозяйственнаяОперация В (ЗНАЧЕНИЕ(Перечисление.ХозяйственныеОперации.РеализацияЧерезКомиссионера),
	|												ЗНАЧЕНИЕ(Перечисление.ХозяйственныеОперации.РеализацияЧерезКомиссионераБезПереходаПраваСобственности))
	|	И ДанныеРасхождений.СтатусУказанияСерий > 0
	|	И ДанныеРасхождений.СтатусУказанияСерий <> ДанныеРасхождений.СтатусУказанияСерийНаСкладах
	|
	|ОБЪЕДИНИТЬ ВСЕ
	|
	|ВЫБРАТЬ РАЗЛИЧНЫЕ
	...
	|		ПО ДанныеРасхождений.Ссылка = РеквизитыШапки.Ссылка
	|ГДЕ
	|	РеквизитыШапки.ХозяйственнаяОперация В (ЗНАЧЕНИЕ(Перечисление.ХозяйственныеОперации.РеализацияЧерезКомиссионера),
	|											ЗНАЧЕНИЕ(Перечисление.ХозяйственныеОперации.РеализацияЧерезКомиссионераБезПереходаПраваСобственности))
	|	И ДанныеРасхождений.СтатусУказанияСерий > 0
	|	И ДанныеРасхождений.СтатусУказанияСерий <> ДанныеРасхождений.СтатусУказанияСерийПереданныхТоваров
	|
	|ОБЪЕДИНИТЬ
	|
	|ВЫБРАТЬ РАЗЛИЧНЫЕ
	...
	|		ПО ДанныеРасхождений.Ссылка = РеквизитыШапки.Ссылка
	|ГДЕ
	|	РеквизитыШапки.Проведен
	|	И РеквизитыШапки.ХозяйственнаяОперация = ЗНАЧЕНИЕ(Перечисление.ХозяйственныеОперации.РеализацияКлиенту)
	|	И РеквизитыШапки.ДокументОснование ССЫЛКА Документ.РеализацияТоваровУслуг
	|	И ДанныеРасхождений.КорАналитикаУчетаНоменклатуры = ЗНАЧЕНИЕ(Справочник.КлючиАналитикиУчетаНоменклатуры.ПустаяСсылка)
	|
	|ОБЪЕДИНИТЬ
	|
	|ВЫБРАТЬ РАЗЛИЧНЫЕ
	|	РеквизитыШапки.Ссылка КАК Ссылка
	|ИЗ
	|	Документ.КорректировкаРеализации.ВидыЗапасовСписание КАК ДанныеРасхождений
	|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ Документ.КорректировкаРеализации КАК РеквизитыШапки
	|		ПО ДанныеРасхождений.Ссылка = РеквизитыШапки.Ссылка
	|ГДЕ
	|	РеквизитыШапки.Проведен
	|	И РеквизитыШапки.ХозяйственнаяОперация В (ЗНАЧЕНИЕ(Перечисление.ХозяйственныеОперации.РеализацияКлиенту),
	|												ЗНАЧЕНИЕ(Перечисление.ХозяйственныеОперации.ПереходПраваСобственности))
	|	И РеквизитыШапки.ДокументОснование ССЫЛКА Документ.РеализацияТоваровУслуг
	|	И ДанныеРасхождений.КорАналитикаУчетаНоменклатуры = ЗНАЧЕНИЕ(Справочник.КлючиАналитикиУчетаНоменклатуры.ПустаяСсылка)";
...
Процедура ОбработатьДанныеДляПереходаНаНовуюВерсию(Параметры) Экспорт
	...
	ОтборПустыхАналитик = Новый Структура("КорАналитикаУчетаНоменклатуры",
											Справочники.КлючиАналитикиУчетаНоменклатуры.ПустаяСсылка());
	
	ОперацииРеализацииЧерезКомиссионера = Новый Массив;
	ОперацииРеализацииЧерезКомиссионера.Добавить(Перечисления.ХозяйственныеОперации.РеализацияЧерезКомиссионера);
	ОперацииРеализацииЧерезКомиссионера.Добавить(Перечисления.ХозяйственныеОперации.РеализацияЧерезКомиссионераБезПереходаПраваСобственности);
	...
	|	И ДанныеРасхождений.СтатусУказанияСерий > 0
	|	И ДанныеРасхождений.СтатусУказанияСерий <> ДанныеРасхождений.СтатусУказанияСерийНаСкладах
	|	И НЕ РеквизитыШапки.ХозяйственнаяОперация В (ЗНАЧЕНИЕ(Перечисление.ХозяйственныеОперации.РеализацияЧерезКомиссионера),
	|												ЗНАЧЕНИЕ(Перечисление.ХозяйственныеОперации.РеализацияЧерезКомиссионераБезПереходаПраваСобственности))
	|
	|ОБЪЕДИНИТЬ ВСЕ
	|
	...
	|	И ДанныеРасхождений.СтатусУказанияСерий > 0
	|	И ДанныеРасхождений.СтатусУказанияСерий <> ДанныеРасхождений.СтатусУказанияСерийПереданныхТоваров
	|	И РеквизитыШапки.ХозяйственнаяОперация В (ЗНАЧЕНИЕ(Перечисление.ХозяйственныеОперации.РеализацияЧерезКомиссионера),
	|												ЗНАЧЕНИЕ(Перечисление.ХозяйственныеОперации.РеализацияЧерезКомиссионераБезПереходаПраваСобственности))";
	...
	Для Каждого Документ Из ОбновляемыеДанные Цикл
		...
		Попытка
			...
			ДокументОбъект = Документ.Ссылка.ПолучитьОбъект(); // ДокументОбъект.КорректировкаРеализации - 
			
			Если ДокументОбъект <> Неопределено Тогда
				Если ДокументОбъект.Проведен
					И ТипЗнч(ДокументОбъект.ДокументОснование) = Тип("ДокументСсылка.РеализацияТоваровУслуг") Тогда
					
					Если ДокументОбъект.ХозяйственнаяОперация = Перечисления.ХозяйственныеОперации.РеализацияКлиенту Тогда
						СтрокиРасхождений = ДокументОбъект.Расхождения.НайтиСтроки(ОтборПустыхАналитик);
						
						Для Каждого СтрокаТЧ Из СтрокиРасхождений Цикл
							СтрокаТЧ.КорАналитикаУчетаНоменклатуры = СтрокаТЧ.АналитикаУчетаНоменклатуры;
						КонецЦикла;
						
						СтрокиЗапасов = ДокументОбъект.ВидыЗапасовОприходование.НайтиСтроки(ОтборПустыхАналитик);
						
						Для Каждого СтрокаТЧ Из СтрокиЗапасов Цикл
							СтрокаТЧ.КорАналитикаУчетаНоменклатуры = СтрокаТЧ.АналитикаУчетаНоменклатуры;
						КонецЦикла;
					КонецЕсли;
					
					ЗаполнитьКорАналитикаУчетаНоменклатурыВВидыЗапасовСписание(ДокументОбъект);
				...
				Если Не РезультатЗапроса.Пустой() Тогда
					ИмяПолеСтатуса = ?(ОперацииРеализацииЧерезКомиссионера.Найти(ДокументОбъект.ХозяйственнаяОперация) = Неопределено,
										"СтатусУказанияСерийНаСкладах",
										"СтатусУказанияСерийПереданныхТоваров");
					
					Выборка = РезультатЗапроса.Выбрать();
					
					Пока Выборка.Следующий() Цикл
						СтрокаРасхождения = ДокументОбъект.Расхождения[Выборка.НомерСтроки - 1];
						СтрокаРасхождения[ИмяПолеСтатуса] = СтрокаРасхождения.СтатусУказанияСерий;
					КонецЦикла;
				КонецЕсли;
			КонецЕсли;
...
Процедура ЗаполнитьКорАналитикаУчетаНоменклатурыВВидыЗапасовСписание(ДокументОбъект)
	
	ВидыЗапасов = ДокументОбъект.ВидыЗапасовСписание;
	
	Если ВидыЗапасов.Количество() = 0
		Или Не (ДокументОбъект.ХозяйственнаяОперация = Перечисления.ХозяйственныеОперации.РеализацияКлиенту
	...
	Расхождения = ДокументОбъект.Расхождения;
	
	ОтборПустыхАналитик	= Новый Структура("КорАналитикаУчетаНоменклатуры",
											Справочники.КлючиАналитикиУчетаНоменклатуры.ПустаяСсылка());
	СтрокиРасхождений	= Расхождения.НайтиСтроки(ОтборПустыхАналитик);
	
	Если СтрокиРасхождений.Количество() = Расхождения.Количество() Тогда
		Возврат;
	КонецЕсли;
	
	ИменаКолонокГруппировки		= "АналитикаУчетаНоменклатуры, АналитикаУчетаНаборов, Склад, Упаковка, ЗаказКлиента,
									|КодТНВЭД, ОбъектРасчетов, КорАналитикаУчетаНоменклатуры,
	...
	ИменаКолонокСуммирования	= "Количество, КоличествоУпаковок, СуммаСНДС, СуммаНДС, СуммаВзаиморасчетов,
									|СуммаБезНДСРегл, СуммаБезНДСУпр, СуммаНДСРегл, СуммаНДСУпр";
	...
	Для Каждого СтрокаРасхождений Из Расхождения Цикл
		...
		Если УчитыватьСтроку Тогда
			...
			Если СтрокаРасхождений.Количество < 0 Тогда
				...
				СтрокаТоваров.СуммаНДСРегл			= -СтрокаРасхождений.СуммаНДСРегл;
				СтрокаТоваров.СуммаНДСУпр			= -СтрокаРасхождений.СуммаНДСУпр;
			КонецЕсли;
			
			СтрокаТоваров.НаДоходыРасходы =
				СтрокаРасхождений.ВариантОтражения = Перечисления.ВариантыОтраженияКорректировокРеализаций.ОтразитьНаПрочихДоходах;
		КонецЕсли;
	...
	ЗаполняемыеСвойстваАналитик = "АналитикаУчетаНоменклатуры, КорАналитикаУчетаНоменклатуры";
	...
	Для Каждого СтрокаТоваров Из ТаблицаТовары Цикл
		...
		Для Каждого СтрокаЗапасов Из ВидыЗапасов.НайтиСтроки(СтруктураПоиска) Цикл
			...
			ЗаполнитьЗначенияСвойств(НоваяСтрока, СтрокаТоваров, ЗаполняемыеСвойстваАналитик);
			...
			НоваяСтрока.СуммаНДС				= ?(СтрокаЗапасов.Количество <> 0,
													...
													0);
			НоваяСтрока.СуммаНДСРегл			= ?(СтрокаЗапасов.Количество <> 0,
													Количество * СтрокаТоваров.СуммаНДСРегл / СтрокаЗапасов.Количество,
													0);
			НоваяСтрока.СуммаНДСУпр				= ?(СтрокаЗапасов.Количество <> 0,
													Количество * СтрокаТоваров.СуммаНДСУпр / СтрокаЗапасов.Количество,
													0);
