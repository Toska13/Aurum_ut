...
Процедура ЗаполнитьПоРасходномуКассовомуОрдеру(Знач РасходныйКассовыйОрдерОснование, ДанныеЗаполнения)
	...
	Запрос.УстановитьПараметр("Ссылка", РасходныйКассовыйОрдерОснование); 
	...
	Если РезультатЗапроса.Пустой() Тогда
		Текст = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			...
			РасходныйКассовыйОрдерОснование);
