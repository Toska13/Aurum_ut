...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ЕстьБезналичнаяОплата = Параметры.ФормаОплаты.Найти(Перечисления.ФормыОплаты.Безналичная) <> Неопределено;
	ЕстьНаличнаяОплата = Параметры.ФормаОплаты.Найти(Перечисления.ФормыОплаты.Наличная) <> Неопределено;
	
	Если ЕстьБезналичнаяОплата Тогда
		ФормаОплаты = Перечисления.ФормыОплаты.Безналичная;
	ИначеЕсли ЕстьНаличнаяОплата Тогда
		ФормаОплаты = Перечисления.ФормыОплаты.Наличная;
	Иначе
		ФормаОплаты = Перечисления.ФормыОплаты.ПлатежнаяКарта;
	КонецЕсли;
...
Функция ПоместитьЗаявкиВХранилище()
	...
	ТаблицаВыбранныхЗаявок.Колонки.Добавить("ИдентификаторПлатежа", ОбщегоНазначения.ОписаниеТипаСтрока(25));
	ТаблицаВыбранныхЗаявок.ЗагрузитьКолонку(ТаблицаВыбранныхЗаявок.ВыгрузитьКолонку("ОбъектРасчетов"), "ОснованиеПлатежа");
	ТаблицаВыбранныхЗаявок.ЗаполнитьЗначения(ДанныеЗаполнения.ИдентификаторПлатежа, "ИдентификаторПлатежа");
