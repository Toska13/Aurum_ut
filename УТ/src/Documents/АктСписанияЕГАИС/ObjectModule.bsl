...
Процедура ОбработкаПроверкиЗаполнения(Отказ, ПроверяемыеРеквизиты)
	...
	Если ПричинаСписания <> Перечисления.ПричиныСписанийЕГАИС.Реализация Тогда
	...
	ИначеЕсли ПричиныСписанияТребующиеУказанияМарки().Найти(ПричинаСписания) <> Неопределено Тогда
	...
	Иначе
		АкцизныеМаркиЕГАИС.ПроверитьЗаполнениеШтрихкодовУпаковок(ЭтотОбъект, Отказ);
	КонецЕсли;
