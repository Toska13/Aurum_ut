...
Функция КонечныеСтатусы(ТребуетсяПовторноеОформление = Истина) Экспорт
	...
	Если Не ТребуетсяПовторноеОформление Тогда
		...
		Статусы.Добавить(Перечисления.СтатусыОбработкиМаркировкиТоваровИСМП.ВводВОборотОбработанУспешно);
	КонецЕсли;
...
Функция ДальнейшееДействиеПоУмолчанию(СтруктураПараметров = Неопределено) Экспорт
	...
	Если ТипЗнч(СтруктураПараметров) = Тип("Структура") Тогда
		...
		ИначеЕсли ЗначениеЗаполнено(Реквизиты.ОперацияНанесения)
			...
			Если КонструкторИСМПОбщегоНазначенияКлиентСервер.ЭтоПродукцияПоддерживающаяИндивидуализациюКИЗ(Реквизиты.ТоварнаяГруппа) Тогда
		...
		ИначеЕсли Реквизиты.Операция = Перечисления.ВидыОперацийИСМП.ВводВОборотИмпортСФТС 
			...
			Если Реквизиты.ВариантЗаполненияДекларации = Перечисления.ВариантыЗаполненияДекларацииИСМП.АТК Тогда
				Если Реквизиты.ВариантВыполненияАгрегации <> Перечисления.ВариантыВыполненияАгрегацииИСМП.НеТребуется
					И ЕстьКодыАгрегатов(Реквизиты.Ссылка, Реквизиты) Тогда
					Возврат Перечисления.ДальнейшиеДействияПоВзаимодействиюИСМП.ВыполнитеАгрегацию;
				Иначе
			...
			ИначеЕсли Реквизиты.ВариантЗаполненияДекларации = Перечисления.ВариантыЗаполненияДекларацииИСМП.КодыУпаковок
				И Реквизиты.ВариантВыполненияАгрегации <> Перечисления.ВариантыВыполненияАгрегацииИСМП.НеТребуется
				И ЕстьКодыАгрегатов(Реквизиты.Ссылка, Реквизиты) Тогда
				Возврат Перечисления.ДальнейшиеДействияПоВзаимодействиюИСМП.ВыполнитеАгрегацию;
			КонецЕсли;

		ИначеЕсли Не КонструкторИСМПКлиентСервер.ЭтоСырьеГИСМТ(Реквизиты.ТоварнаяГруппа)
			И ЗначениеЗаполнено(Реквизиты.ВариантВыполненияАгрегации)
	...
	Возврат Перечисления.ДальнейшиеДействияПоВзаимодействиюИСМП.ВведитеВОборот;
...
Функция СтатусПослеПодготовкиКПередачеДанных(ДокументСсылка, Операция, ДополнительныеПараметры = Неопределено) Экспорт
	...
	Если Операция = Перечисления.ВидыОперацийИСМП.ВводВОборотПроизводствоВнеЕАЭС
		...
		Или Операция = Перечисления.ВидыОперацийИСМП.ВводВОборот
		Или Операция = Перечисления.ВидыОперацийИСМП.ВводВОборотСырьяПроизводствоРФ
		Или Операция = Перечисления.ВидыОперацийИСМП.ВводВОборотСырьяПолучениеТовараИзЕАЭС
		Или Операция = Перечисления.ВидыОперацийИСМП.ВводВОборотСырьяПолучениеТовараВнеЕАЭС
		Или Операция = Перечисления.ВидыОперацийИСМП.ВводВОборотСырьяОстатки
		Тогда
...
Функция СтатусПослеПередачиДанных(ДокументСсылка, Операция, СтатусОбработки) Экспорт
	...
	Если Операция = Перечисления.ВидыОперацийИСМП.ВводВОборотПроизводствоВнеЕАЭС
		...
		СтатусыБазовыйПроцесс.ОшибкаДействия.Добавить(Перечисления.ДальнейшиеДействияПоВзаимодействиюИСМП.ВведитеВОборот);
...
Функция СтатусПослеПолученияДанных(ДокументСсылка, Операция, ДополнительныеПараметры = Неопределено) Экспорт
	...
	ОперацииВводаВОборотСырье = Новый Массив;
	ОперацииВводаВОборотСырье.Добавить(Перечисления.ВидыОперацийИСМП.ВводВОборотСырьяПроизводствоРФ);
	ОперацииВводаВОборотСырье.Добавить(Перечисления.ВидыОперацийИСМП.ВводВОборотСырьяПолучениеТовараИзЕАЭС);
	ОперацииВводаВОборотСырье.Добавить(Перечисления.ВидыОперацийИСМП.ВводВОборотСырьяПолучениеТовараВнеЕАЭС);
	ОперацииВводаВОборотСырье.Добавить(Перечисления.ВидыОперацийИСМП.ВводВОборотСырьяОстатки);
	...
	Если Операция = Перечисления.ВидыОперацийИСМП.ПолучениеРезультатаОбработкиДокумента
		...
		Если ДополнительныеПараметры.Свойство("ПакетСтатусовОбработкиОперации")
			...
			Если ДополнительныеПараметры.ПакетСтатусовОбработкиОперации[Перечисления.СтатусыОбработкиСообщенийИСМП.ЗаявкаВыполнена] <> Неопределено
				...
				Если ДляОперацииДоступенРежимИсправленияОшибок Тогда
					Статусы.ОшибкаДействия.Добавить(Перечисления.ДальнейшиеДействияПоВзаимодействиюИСМП.ВведитеВОборотСИсправлениями);
				КонецЕсли;
				
			Иначе
				ДополнительныеПараметры.СтатусОбработки = Перечисления.СтатусыОбработкиСообщенийИСМП.ЗаявкаОтклонена;
				Статусы.Ошибка = Перечисления.СтатусыОбработкиМаркировкиТоваровИСМП.ВводВОборотОшибкаПередачи;
				Статусы.ОшибкаДействия.Добавить(Перечисления.ДальнейшиеДействияПоВзаимодействиюИСМП.ВведитеВОборот);
		...
		Иначе
			...
			Реквизиты = ОбщегоНазначения.ЗначенияРеквизитовОбъекта(
				ДокументСсылка,
				"ТоварнаяГруппа, Операция, ОперацияНанесения,
			...
			ИначеЕсли Реквизиты.Операция = Перечисления.ВидыОперацийИСМП.ВводВОборотИмпортСФТС Тогда
				Если Реквизиты.ВариантЗаполненияДекларации = Перечисления.ВариантыЗаполненияДекларацииИСМП.КодыУпаковок
					Или Реквизиты.ВариантЗаполненияДекларации = Перечисления.ВариантыЗаполненияДекларацииИСМП.АТК Тогда
	...
	ИначеЕсли Операция = Перечисления.ВидыОперацийИСМП.ПолучениеРезультатаОбработкиДокумента
		...
		ИначеЕсли ДополнительныеПараметры.ПараметрыЗапроса <> Неопределено Тогда
			...
			ИначеЕсли ОбщегоНазначенияКлиентСервер.СвойствоСтруктуры(
				...
				Статусы.ПринятДействия.Добавить(Перечисления.ДальнейшиеДействияПоВзаимодействиюИСМП.ВведитеВОборот);
			ИначеЕсли ОбщегоНазначенияКлиентСервер.СвойствоСтруктуры(
					ДополнительныеПараметры.ПараметрыЗапроса, "ТребуетсяАгрегация", Ложь) Тогда
				Статусы.ПринятДействия.Добавить(Перечисления.ДальнейшиеДействияПоВзаимодействиюИСМП.ВыполнитеАгрегацию);
			КонецЕсли;
	...
	ИначеЕсли Операция = Перечисления.ВидыОперацийИСМП.ПолучениеРезультатаОбработкиДокумента
		...
		Если ДополнительныеПараметры.ПараметрыЗапроса = Неопределено Тогда
			Реквизиты = ОбщегоНазначения.ЗначенияРеквизитовОбъекта(
				ДокументСсылка,
				"ТоварнаяГруппа, Операция, ВариантЗаполненияДекларации, ОтчетПроизводственнойЛинии,
			...
			ИначеЕсли Не ЕстьОшибки Тогда
				...
				ИначеЕсли Реквизиты.Операция = Перечисления.ВидыОперацийИСМП.ВводВОборотИмпортСФТС Тогда
					...
					Если Реквизиты.ВариантЗаполненияДекларации = Перечисления.ВариантыЗаполненияДекларацииИСМП.КодыУпаковок Тогда
						Статусы.Принят = Перечисления.СтатусыОбработкиМаркировкиТоваровИСМП.КодыМаркировкиАгрегированы;
						Статусы.ПринятДействия.Добавить(Перечисления.ДальнейшиеДействияПоВзаимодействиюИСМП.ВведитеВОборот);
					ИначеЕсли Реквизиты.ВариантЗаполненияДекларации = Перечисления.ВариантыЗаполненияДекларацииИСМП.АТК Тогда
						Статусы.Принят = Перечисления.СтатусыОбработкиМаркировкиТоваровИСМП.КодыМаркировкиАгрегированы;
						Статусы.ПринятДействия.Добавить(Перечисления.ДальнейшиеДействияПоВзаимодействиюИСМП.ВыполнитеФормированиеАТК);
					Иначе
						Статусы.Принят = Перечисления.СтатусыОбработкиМаркировкиТоваровИСМП.КодыМаркировкиВведеныВОборотИАгрегированы;
		...
		Иначе
			АгрегацияВыполненаЧерезСУЗ = МаркировкаТоваровКлиентСервер.ВидыУпаковокДоступныеДляАгрегацииЧерезСУЗ(Реквизиты.ТоварнаяГруппа).Количество() > 0
	...
	ИначеЕсли Операция = Перечисления.ВидыОперацийИСМП.ПолучениеРезультатаОбработкиДокумента
		И ОперацииВводаВОборотСырье.Найти(ДополнительныеПараметры.ОперацияКвитанции) <> Неопределено Тогда
		
		Статусы = РегистрыСведений.СтатусыДокументовИСМП.СтруктураСтатусы();
		
		Статусы.Принят = Перечисления.СтатусыОбработкиМаркировкиТоваровИСМП.ВводВОборотОбработанУспешно;
...
Функция ПоследовательностьОпераций(ДокументСсылка, ЛинейныйСписок = Ложь) Экспорт
	...
	Реквизиты = ОбщегоНазначения.ЗначенияРеквизитовОбъекта(ДокументСсылка, "ТоварнаяГруппа, Операция, ОперацияНанесения");
	
	ЭтоМех = КонструкторИСМПОбщегоНазначенияКлиентСервер.ЭтоПродукцияМЕХ(Реквизиты.ТоварнаяГруппа);
	ЭтоСырье = КонструкторИСМПКлиентСервер.ЭтоСырьеГИСМТ(Реквизиты.ТоварнаяГруппа);
	...
	ОтчетыОбИспользовании = ИнтеграцияИСМПКлиентСервер.ОперацииНанесенияКодовМаркировки(, Реквизиты.ТоварнаяГруппа);
	...
	Если ЛинейныйСписок
		Или (МаркировкаТоваровКлиентСервер.ДоступенОтчетОНанесении(Реквизиты.ТоварнаяГруппа)
...
Функция СообщениеКПередачеJSON(ДокументСсылка, ДальнейшееДействие, ДополнительныеПараметры) Экспорт
	...
	Если ДальнейшееДействие = Перечисления.ДальнейшиеДействияПоВзаимодействиюИСМП.ПередайтеДанные
		Или ДальнейшееДействие = Перечисления.ДальнейшиеДействияПоВзаимодействиюИСМП.ВведитеВОборот Тогда
		
		Возврат ВводВОборотJSON(ДокументСсылка, ДополнительныеПараметры);
		
	ИначеЕсли ДальнейшееДействие = Перечисления.ДальнейшиеДействияПоВзаимодействиюИСМП.ПередайтеДанныеСИсправлениями
		Или ДальнейшееДействие = Перечисления.ДальнейшиеДействияПоВзаимодействиюИСМП.ВведитеВОборотСИсправлениями Тогда
...
Функция ОбработатьДанныеШтрихкода(Форма, ДанныеШтрихкода, ПараметрыСканирования, ВложенныеШтрихкоды = Неопределено) Экспорт
	...
	Если ДанныеШтрихкода.ВидУпаковки = Перечисления.ВидыУпаковокИС.Логистическая
		Или (ДанныеШтрихкода.ВидУпаковки = Перечисления.ВидыУпаковокИС.Набор
			И ДанныеШтрихкода.ТипУпаковки = Перечисления.ТипыУпаковок.МультитоварнаяУпаковка) Тогда
...
//		РежимОбработки - ПеречислениеСсылка.ВариантыИсправленияОшибокОтчетПроизводственнойЛинииИС - вариант удаления строк в дереве упаковок.
...
Процедура ПодготовитьДанныеЗаполненияОтчетПроизводственноЛинии(ПараметрыЗаполнения, АдресРезультата) Экспорт
	...
	Если РежимОбработки = Перечисления.ВариантыИсправленияОшибокОтчетПроизводственнойЛинииИС.РасформироватьАгрегат Тогда
		УдалитьВложенныеСтроки = Ложь;
	ИначеЕсли  РежимОбработки = Перечисления.ВариантыИсправленияОшибокОтчетПроизводственнойЛинииИС.УдалятьАгрегат Тогда
...
Функция ВсеТребующиеДействия() Экспорт
	...
	МассивДействий.Добавить(Перечисления.ДальнейшиеДействияПоВзаимодействиюИСМП.ВведитеВОборот);
	...
	МассивДействий.Добавить(Перечисления.ДальнейшиеДействияПоВзаимодействиюИСМП.ВведитеВОборотСИсправлениями);
...
Процедура ОтразитьРезультатыПроверкиИПодбора(ПараметрыОкончанияПроверки) Экспорт
	...
	Если ДокументОбъект.Операция <> Перечисления.ВидыОперацийИСМП.ПодтверждениеПоступленияКИЗ Тогда
		...
		СпецификаОперацииНанесения = КонструкторИСМПОбщегоНазначенияКлиентСервер.ЭтоВидПродукцииСоСрокамиГодности(ДокументОбъект.ТоварнаяГруппа);
		...
		Для Каждого СтрокаТаблицы Из ПараметрыОкончанияПроверки.ТаблицаПодобраннойПровереннойПродукции Цикл
			...
			ИнтеграцияИСПереопределяемый.ОбработатьСтрокуТабличнойЧасти(СтрокаТовары,
...
Процедура ПриДобавленииОбработчиковОбновления(Обработчики) Экспорт
	...
	ОбновлениеИнформационнойБазыГосИС.ДобавитьОбработчикОбновленияПереходаНаКонструкторНастроек(
		...
		Новый УникальныйИдентификатор("536bfd0b-f964-4503-b388-68043af9cb2a"));
...
Процедура ПриОпределенииМетодовРазрешенныхДляВызоваКакПроизвольныйКод(Методы) Экспорт
	...
	Методы.Вставить("ПодготовитьДанныеЗаполненияОтчетПроизводственноЛинии", Истина);
	Методы.Вставить("СоздатьШтрихкодыУпаковокПоДаннымДокумента", Истина);
...
Процедура ОбработкаПолученияПолейПредставления(Поля, СтандартнаяОбработка)
	...
	Поля.Добавить("ОперацияНанесения");
...
Процедура ОбработкаПолученияПредставления(Данные, Представление, СтандартнаяОбработка)
	...
	СтандартнаяОбработка = Ложь;
	Представление = ИнтеграцияИСМПКлиентСервер.ПредставлениеДокументаМаркировка(
		Ложь, Данные.Операция, Данные.Номер, Данные.Дата, ЗначениеЗаполнено(Данные.ОперацияНанесения));
...
Функция СохранитьОбработанныеДанныеОтчета(ДокументСсылка, ДанныеОтчета, ПолныеДанныеОтчета,
...
Функция ИменаРеквизитовДляРасчетаДальнейшегоДействия() Экспорт
	...
	Возврат "Ссылка, ОтчетПроизводственнойЛинии, ТоварнаяГруппа, Операция, ОперацияНанесения, ВариантЗаполненияДекларации, ВариантВыполненияАгрегации";
...
Процедура ПроверитьЗаполнениеДанныхДекларации(СообщениеJSON, Шапка)
	ПроверитьЗаполнениеРегистрационныйНомерДекларации(СообщениеJSON, Шапка);
...
Процедура ПроверитьЗаполнениеРегистрационныйНомерДекларации(СообщениеJSON, Шапка)
...
Процедура ЗаполнитьСведенияОТоварахПоШтрихкодамУпаковок(
	СообщениеJSON, ГруппыКодов, ИсточникДанных, СведенияОТоварах, ТоварнаяГруппа, Настройки = Неопределено)
	...
	Для Каждого СтрокаИсточникаДанных Из ИсточникДанных Цикл
		...
		Если Настройки.ЗаполнятьВложенныеКоды И СтрокаИсточникаДанных.Строки.Количество() Тогда
			...
			ЗаполнитьСведенияОТоварахПоШтрихкодамУпаковок(СообщениеJSON, ВложенныеКоды, СтрокаИсточникаДанных.Строки, СведенияОТоварах, ТоварнаяГруппа, НастройкиВложенныхУпаковок);
			
			СтрокаТЧ.Вставить("children", ВложенныеКоды);
			Если Настройки.УказыватьСуммы И МаркировкаТоваровКлиентСервер.ДоступноПолеСуммаАкциза(ТоварнаяГруппа) Тогда
...
Функция ЗаполнитьДанныеСтрокиВводВОборот(СообщениеJSON, ТоварнаяГруппа, СтрокаИсточникаДанных, ИсточникДанныхТовары, Настройки)
	...
	ЭтоТоварнаяГруппаПодконтрольнаяВЕТИС = ИнтеграцияИСМПВЕТИСКлиентСервер.ЭтоВидПродукцииИСМПВЕТИС(ВидыПродукцииПоТоварнойГруппе);
	...
	Если СтрокаИсточникаДанных.ВидУпаковки = Перечисления.ВидыУпаковокИС.Потребительская
		...
		Если ТребуетсяНоменклатура Или ЭтоМаркировкаОстатков Тогда
			...
			Если ТребуетсяНоменклатура Тогда
				...
				Если ЭтоТоварнаяГруппаПодконтрольнаяВЕТИС Тогда
					Отбор.Вставить("ИдентификаторПроисхожденияВЕТИС", СтрокаИсточникаДанных.ИдентификаторПроисхожденияВЕТИС);
				ИначеЕсли КонструкторИСМПОбщегоНазначенияКлиентСервер.ЭтоВидПродукцииСоСрокамиГодности(ВидыПродукцииПоТоварнойГруппе) Тогда
			...
			ИначеЕсли ЭтоМаркировкаОстатков Тогда
				...
				Если ЗначениеЗаполнено(СтрокаИсточникаДанных.Номенклатура) Тогда
					...
					Если КонструкторИСМПОбщегоНазначенияКлиентСервер.ЭтоВидПродукцииСоСрокамиГодности(ВидыПродукцииПоТоварнойГруппе) Тогда
						Отбор.Вставить("СрокГодности", СтрокаИсточникаДанных.ГоденДо);
					КонецЕсли;
				...
				Иначе
					...
					ДанныеКодаМаркировки         = РазборКодаМаркировкиИССлужебный.РазобратьКодМаркировки(
						СтрокаИсточникаДанных.Штрихкод, ВидыПродукцииПоТоварнойГруппе, ПримечаниеКРезультатуРазбора);
		...
		Если СтрокаИсточникаДанных.ВидУпаковки = Перечисления.ВидыУпаковокИС.Потребительская Тогда
			...
			Если Не ЭтоМаркировкаОстатков И Настройки.УказыватьСертификацию
				...
				ДанныеСертификации.Вставить("certificate_type",   ИнтерфейсИСМПОбщегоНазначения.ВидДокументаСертификации(СтрокаТЧТовары.ВидДокументаСертификации));
				...
				Если Настройки.ДоступноУказаниеНомерСкважины
					И ЗначениеЗаполнено(СтрокаТЧТовары.НомерСкважины) Тогда
			...
			Если Настройки.УказыватьИдентификаторПроисхожденияВЕТИС
				И ЭтоТоварнаяГруппаПодконтрольнаяВЕТИС Тогда
			...
			Если Настройки.УказыватьСуммы Тогда
				...
				Если МаркировкаТоваровКлиентСервер.ДоступноПолеСуммаАкциза(ВидыПродукцииПоТоварнойГруппе) Тогда
...
Функция ЗаполнитьДанныеСтрокиВводВОборотПоДаннымОтчета(СтрокаИсточникаДанных, СведенияОТоварах, Настройки)
	...
	Если СтрокаИсточникаДанных.ВидУпаковки = Перечисления.ВидыУпаковокИС.Потребительская Тогда
		...
		Если Настройки.УказыватьИдентификаторПроисхожденияВЕТИС
			И ИнтеграцияИСМПВЕТИСКлиентСервер.ЭтоВидПродукцииИСМПВЕТИС(СведенияОТоварах.ТоварнаяГруппа) Тогда
		...
		Если Настройки.УказыватьСертификацию
			...
			ДанныеСертификации = Новый Структура;
			ДанныеСертификации.Вставить("certificate_type",   ИнтерфейсИСМПОбщегоНазначения.ВидДокументаСертификации(СведенияОТоварах.ВидДокументаСертификации));
			...
			Если Настройки.ДоступноУказаниеНомерСкважины
				И ЗначениеЗаполнено(СведенияОТоварах.НомерСкважины) Тогда
...
Функция ПроверитьИРазбитьНаГруппыПолныеКодыМаркировки(СообщенияJSON, СообщениеJSON, ГруппыКодов,
	...
	ВОтчетеОНанесенииИспользоватьОбъем = МаркировкаТоваровКлиентСервер.ВОтчетеОНанесенииИспользоватьОбъем(СообщениеJSON.ТоварнаяГруппа);
	ВОтчетеОНанесенииИспользоватьВес = МаркировкаТоваровКлиентСервер.ВОтчетеОНанесенииИспользоватьВес(СообщениеJSON.ТоварнаяГруппа);
	
	КоличествоЕдиницИспользование = КоличествоЕдиницИспользованиеПоТоварнойГруппе(СообщениеJSON.ТоварнаяГруппа);
	...
	Для Каждого СтрокаКодМаркировки Из ПолныеКодыМаркировки Цикл
		...
		Иначе
			...
			Если ЗначениеЗаполнено(СтрокаКодМаркировки.Количество) Тогда
				Если КоличествоЕдиницИспользование Тогда
					ПолныйКодМаркировки = ПолныйКодМаркировки + РазделительGS + КоличествоЕдиницКодаМаркировкиСтрокой(СтрокаКодМаркировки.Количество);
				ИначеЕсли Лев(Прав(ПолныйКодМаркировки, 6), 2) = "93"
					Или Лев(Прав(ПолныйКодМаркировки, 46), 2) = "92" Тогда
					Если ВОтчетеОНанесенииИспользоватьОбъем Тогда
					...
					ИначеЕсли ВОтчетеОНанесенииИспользоватьВес Тогда
...
Функция ИнициализироватьПолныеКодыМаркировки()
	...
	Результат.Колонки.Добавить("ВидПродукции",                     Новый ОписаниеТипов("СправочникСсылка.ВидыПродукцииИС"));
	
	Возврат Результат;
	
КонецФункции

Процедура ДобавитьКодКПолучению(ПолныеКодыМаркировки, НормализованныйШтрихкод, ВидУпаковки, РазбиватьПоСрокамГодности = Ложь,
	ДанныеШтрихкодовУпаковок = Неопределено, ПолныйКодМаркировки = Неопределено, GTIN = Неопределено)
	...
	Если ДанныеШтрихкодовУпаковок <> Неопределено Тогда
		ВидПродукции = ДанныеШтрихкодовУпаковок.ВидПродукции;
	КонецЕсли;
	...
	ДанныеСтроки.ВидПродукции                    = ВидПродукции;
...
Функция ТекстЗапросаШапка()
	...
	|
	|	// Сырье
	|	Шапка.Производитель                              КАК Производитель,
	|	ЕСТЬNULL(Шапка.СтранаПроизводства.Код, """")     КАК СтранаПроизводстваКод,
	|	Шапка.НаименованиеПервичногоДокумента            КАК НаименованиеПервичногоДокумента,
	|	Шапка.ИдентификаторФИАС                          КАК ИдентификаторФИАС,
	|	Шапка.МестоОсуществленияДеятельностиАдресСтрокой КАК МестоОсуществленияДеятельностиАдресСтрокой
	|ИЗ
...
Функция ТекстЗапросаТовары()
	...
	|	ЕСТЬNULL(Товары.Сырье.Идентификатор, """") КАК ИдентификаторСырья,
	|	ЕСТЬNULL(Товары.Сырье.ВидПродукции, НЕОПРЕДЕЛЕНО) КАК ВидПродукцииСырья,
...
#Область ТелоДокумента
	...
	Если Шапка.Операция = Перечисления.ВидыОперацийИСМП.ВводВОборотПроизводствоРФ Тогда
		...
		Настройки.УказыватьЛицензии                        = МаркировкаТоваровКлиентСервер.ДоступноПолеЛицензияНаПользованиеНедрами(Шапка.ТоварнаяГруппа);
		Настройки.ЗаполнятьВложенныеКоды                   = КодыАгрегированы;
		Настройки.ОтчетПроизводственнойЛинии               = Шапка.ОтчетПроизводственнойЛинии;
		Настройки.ЭтоМех                                   = КонструкторИСМПОбщегоНазначенияКлиентСервер.ЭтоПродукцияМЕХ(Шапка.ТоварнаяГруппа);
	...
	ИначеЕсли Шапка.Операция = Перечисления.ВидыОперацийИСМП.ВводВОборотПроизводствоРФПоДоговору
		...
		Настройки.ДоступноУказаниеНомерСкважины            = МаркировкаТоваровКлиентСервер.ДоступноПолеНомерСкважины(Шапка.ТоварнаяГруппа);
		Настройки.УказыватьЛицензии                        = МаркировкаТоваровКлиентСервер.ДоступноПолеЛицензияНаПользованиеНедрами(Шапка.ТоварнаяГруппа);
		Настройки.ЗаполнятьВложенныеКоды                   = КодыАгрегированы;
		Настройки.ОтчетПроизводственнойЛинии               = Шапка.ОтчетПроизводственнойЛинии;
		Настройки.ЭтоМех                                   = КонструкторИСМПОбщегоНазначенияКлиентСервер.ЭтоПродукцияМЕХ(Шапка.ТоварнаяГруппа);
	...
	ИначеЕсли Шапка.Операция = Перечисления.ВидыОперацийИСМП.ВводВОборотТрансграничнаяТорговля Тогда
		...
		Если МаркировкаТоваровКлиентСервер.ПриВводеВОборотПередаватьКПП(Шапка.ТоварнаяГруппа) Тогда
	...
	Настройки.УказыватьСертификацию = МаркировкаТоваровКлиентСервер.ДоступноПолеСертификация(Шапка.ТоварнаяГруппа, СообщениеJSON.Операция);
...
Функция СообщенияJSONОтчетОНанесении(Шапка, ДополнительныеПараметры)
	...
	Если Не ЗаказНаЭмиссиюСУЗКлиентСервер.ПоддерживаетсяФорматОбменаСУЗ(ДополнительныеПараметры.ФорматОбмена, Шапка.ТоварнаяГруппа) Тогда
		...
		СообщениеJSON.ТекстОшибки = СтрШаблон(
			НСтр("ru = 'По товарной группе %1 не поддерживается формат обмена с СУЗ ниже V3.
	...
	Если ЗначениеЗаполнено(Шапка.ОперацияНанесения) Тогда
		Операции.Добавить(Шапка.ОперацияНанесения);
	Иначе
		Операции.Добавить(Шапка.Операция);
	КонецЕсли;
	...
	ДоступноПолеПаспортСоответствия = МаркировкаТоваровКлиентСервер.ДоступноПолеПаспортСоответствия(ВидыПродукцииПоТоварнойГруппе, Операции);
	...
	ДопустимыеНачальныеСтатусыОтчетОНанесении = ШтрихкодированиеИСМП.ДопустимыеНачальныеСтатусыОтчетОНанесении(Шапка.ТоварнаяГруппа);
	ДоступноПолеИдентификаторПроизводственнойЛинии = МаркировкаТоваровКлиентСервер.ДоступноПолеИдентификаторПроизводственнойЛинии(ВидыПродукцииПоТоварнойГруппе);
	ДоступноПолеИдентификаторПроизводственногоЗаказа = МаркировкаТоваровКлиентСервер.ДоступноПолеИдентификаторПроизводственногоЗаказа(ВидыПродукцииПоТоварнойГруппе);
	ДляТоварнойГруппыИспользуетсяДатаПроизводства = МаркировкаТоваровКлиентСервер.ДляТоварнойГруппыИспользуетсяДатаПроизводства(
		ВидыПродукцииПоТоварнойГруппе, Перечисления.ВидыОперацийИСМП.ОтчетОВерификацииНанесенныхКМ);
	ВОтчетеОНанесенииПередаватьИНН = МаркировкаТоваровКлиентСервер.ВОтчетеОНанесенииПередаватьИНН(ВидыПродукцииПоТоварнойГруппе);
	ВОтчетеОНанесенииПередаватьКПП = МаркировкаТоваровКлиентСервер.ВОтчетеОНанесенииПередаватьКПП(ВидыПродукцииПоТоварнойГруппе);
	ДоступноПолеНомерПартии = МаркировкаТоваровКлиентСервер.ДоступноПолеНомерПартии(ВидыПродукцииПоТоварнойГруппе);
	ДоступноПолеНомерСерии = МаркировкаТоваровКлиентСервер.ДоступноПолеНомерСерии(ВидыПродукцииПоТоварнойГруппе);
	ДоступноПолеПроизводственнаяПлощадкаВЕТИС = МаркировкаТоваровКлиентСервер.ДоступноПолеПроизводственнаяПлощадкаВЕТИС(ВидыПродукцииПоТоварнойГруппе);
	ОжидаемыеСтатусыПослеПередачиОтчетаОНанесении = ШтрихкодированиеИСМП.ОжидаемыеСтатусыПослеПередачиОтчетаОНанесении(Шапка.ТоварнаяГруппа);
	
	Если ДляТоварнойГруппыИспользуетсяДатаПроизводства Тогда
		Если ЗначениеЗаполнено(Шапка.ДатаПроизводства)
			И МаркировкаТоваровКлиентСервер.ДатаПроизводстваВСУЗСУказаниемЧасовогоПояса(
				ВидыПродукцииПоТоварнойГруппе, Перечисления.ВидыОперацийИСМП.ОтчетОВерификацииНанесенныхКМ) Тогда
			ДатаПроизводства = ИнтеграцияИС.ДатаСЧасовымПоясом(Шапка.ДатаПроизводства,,,,"");
		Иначе
			ДатаПроизводства = Формат(Шапка.ДатаПроизводства,"ДФ=dd.MM.yyyy");
		КонецЕсли;
	Иначе
	...
	Для Каждого ДанныеСообщения Из ДополнительныеПараметры.ГруппыКодов Цикл
		...
		Если ДоступноПолеИдентификаторПроизводственнойЛинии
			И ЗначениеЗаполнено(Шапка.ИдентификаторПроизводственнойЛинии) Тогда
			ТелоЗапроса.Вставить("productionLineId", Шапка.ИдентификаторПроизводственнойЛинии);
		КонецЕсли;
		
		Если ДоступноПолеИдентификаторПроизводственногоЗаказа
			И ЗначениеЗаполнено(Шапка.ИдентификаторПроизводственногоЗаказа) Тогда
		...
		Если ДанныеСообщения.ВидУпаковки = Перечисления.ВидыУпаковокИС.Потребительская
			И ДанныеСообщения.Свойство("ПараметрГоденДо")
		...
		Если ДляТоварнойГруппыИспользуетсяДатаПроизводства
			И ДанныеСообщения.ВидУпаковки = Перечисления.ВидыУпаковокИС.Потребительская
			И ЗначениеЗаполнено(Шапка.ДатаПроизводства) Тогда
			ТелоЗапроса.Вставить("productionDate", ДатаПроизводства);
		КонецЕсли;
		
		Если ВОтчетеОНанесенииПередаватьИНН
			И ЗначениеЗаполнено(РеквизитыОрганизации.ИНН) Тогда
			ТелоЗапроса.Вставить("participantId", РеквизитыОрганизации.ИНН);
		КонецЕсли;
		
		Если ВОтчетеОНанесенииПередаватьКПП
		...
		Если ДоступноПолеНомерПартии
			И ЗначениеЗаполнено(Шапка.НомерПартии) Тогда
			ТелоЗапроса.Вставить("batchNumber",  Шапка.НомерПартии);
		КонецЕсли;
		
		Если ДоступноПолеНомерСерии
			И ЗначениеЗаполнено(Шапка.НомерСерии) Тогда
			ТелоЗапроса.Вставить("seriesNumber", Шапка.НомерСерии);
		КонецЕсли;
		
		Если ДоступноПолеПроизводственнаяПлощадкаВЕТИС
		...
		Если ДоступноПолеПаспортСоответствия Тогда
		...
		Если ДоступноПолеСодержаниеЭтиловогоСпирта Тогда
			ДанныеGTIN = ДополнительныеПараметры.СоответствиеGTIN[ДанныеСообщения.GTIN];
			Если ДанныеGTIN <> Неопределено Тогда
		...
		ИнтерфейсСУЗ.ТелоЗапросаПоФорматуОбмена(ТелоЗапроса, ДополнительныеПараметры.ФорматОбмена, ОперацияНанесения, Шапка.ТоварнаяГруппа);
...
Функция СообщенияJSONАгрегацияЧерезСУЗ(Шапка, ДополнительныеПараметры)
	...
	ПараметрыНормализацииКМ.ВключатьЛидирующиеНули   = Истина;
	ПараметрыНормализацииКМ.ИмяСвойстваКодМаркировки = "Штрихкод";
	Если КонструкторИСМПКлиентСервер.КодМаркировкиВключаетНулевойМРЦ(Шапка.ТоварнаяГруппа) Тогда
	...
	ВидыПродукцииПоТоварнойГруппе = КонструкторИСМПОбщегоНазначенияКлиентСервер.ВидыПродукцииПоТоварнойГруппе(Шапка.ТоварнаяГруппа);
	ДоступноПолеИдентификаторПроизводственнойЛинии = МаркировкаТоваровКлиентСервер.ДоступноПолеИдентификаторПроизводственнойЛинии(ВидыПродукцииПоТоварнойГруппе, Шапка.Операция);
	ДоступноПолеИдентификаторПроизводственногоЗаказа = МаркировкаТоваровКлиентСервер.ДоступноПолеИдентификаторПроизводственногоЗаказа(ВидыПродукцииПоТоварнойГруппе);
	ДляТоварнойГруппыИспользуетсяДатаПроизводства = МаркировкаТоваровКлиентСервер.ДляТоварнойГруппыИспользуетсяДатаПроизводства(
		ВидыПродукцииПоТоварнойГруппе, Перечисления.ВидыОперацийИСМП.Агрегация);
	
	Если ДляТоварнойГруппыИспользуетсяДатаПроизводства Тогда
		Если ЗначениеЗаполнено(Шапка.ДатаПроизводства)
			И МаркировкаТоваровКлиентСервер.ДатаПроизводстваВСУЗСУказаниемЧасовогоПояса(
				ВидыПродукцииПоТоварнойГруппе, Перечисления.ВидыОперацийИСМП.Агрегация) Тогда
			ДатаПроизводства = ИнтеграцияИС.ДатаСЧасовымПоясом(Шапка.ДатаПроизводства,,,,"");
		Иначе
			ДатаПроизводства = Формат(Шапка.ДатаПроизводства,"ДФ=dd.MM.yyyy");
		КонецЕсли;
	...
	Для Каждого ДанныеОбАгрегации Из ПакетКодов Цикл
		...
		ИнтерфейсСУЗ.ТелоЗапросаПоФорматуОбмена(ТелоЗапроса, ДополнительныеПараметры.ФорматОбмена, Операция, Шапка.ТоварнаяГруппа);
...
Функция ИдентификаторАдреса(ВидПродукцииТоварнаяГруппа, РезультатОпределенияСУЗ, СообщениеJSON)
	
	Если МаркировкаТоваровКлиентСервер.ДоступныКодыФИАС(ВидПродукцииТоварнаяГруппа) Тогда
		ИдентификаторАдреса = РезультатОпределенияСУЗ.НастройкаОбмена.КодФИАС;
		Если Не ЗначениеЗаполнено(ИдентификаторАдреса)
			И МаркировкаТоваровКлиентСервер.ПроверятьЗаполнениеКодовФИАС(ВидПродукцииТоварнаяГруппа) Тогда
			ОбщегоНазначенияИСКлиентСервер.ДобавитьТекстОшибки(
				СообщениеJSON,
				СтрШаблон(
...
Функция ВводВОборотJSON(ДокументСсылка, ДополнительныеПараметры, Повторно = Ложь)
	...
	Если ЭтоСырьеГИСМТ Тогда
		Возврат ВводВОборотСырьяJSON(РезультатЗапроса, ДополнительныеПараметры, Повторно);
	ИначеЕсли Шапка.ОтчетПроизводственнойЛинии Тогда
...
Функция ВводВОборотСырьяJSON(РезультатЗапроса, ДополнительныеПараметры, Повторно)
	...
	Если Шапка.Операция = Перечисления.ВидыОперацийИСМП.ВводВОборотСырьяПолучениеТовараИзЕАЭС
		Или Шапка.Операция = Перечисления.ВидыОперацийИСМП.ВводВОборотСырьяПолучениеТовараВнеЕАЭС
		Или Шапка.Операция = Перечисления.ВидыОперацийИСМП.ВводВОборотСырьяОстатки Тогда
		
		Если Шапка.Операция = Перечисления.ВидыОперацийИСМП.ВводВОборотСырьяПолучениеТовараВнеЕАЭС Тогда
			ПроверитьЗаполнениеРегистрационныйНомерДекларации(СообщениеJSON, Шапка);
		КонецЕсли;
		
		Если Шапка.Операция = Перечисления.ВидыОперацийИСМП.ВводВОборотСырьяОстатки Тогда
			
			ИдентификаторАудитора = ИнтеграцияИСВызовСервера.НалоговыйНомерКонтрагента(Шапка.Контрагент);
			Если Не ЗначениеЗаполнено(ИдентификаторАудитора) Тогда
				
				ОбщегоНазначенияИСКлиентСервер.ДобавитьТекстОшибки(
					СообщениеJSON,
					СтрШаблон(
						НСтр("ru = 'Не заполнено поле ""ИНН/Налоговый номер в стране регистрации"".
								   |Аудитор: %1'"), Шапка.Контрагент));
		...
		Если ЗначениеЗаполнено(Шапка.Производитель) Тогда
			
			ИдентификаторПроизводителя = ИнтеграцияИСВызовСервера.НалоговыйНомерКонтрагента(Шапка.Производитель);
			Если Не ЗначениеЗаполнено(ИдентификаторПроизводителя) Тогда
				...
				ОбщегоНазначенияИСКлиентСервер.ДобавитьТекстОшибки(
					...
					СтрШаблон(
						НСтр("ru = 'Не заполнено поле ""ИНН/Налоговый номер в стране регистрации"".
								   |Контрагент: %1'"), Шапка.Производитель));
	...
	ПередаватьИдентификаторМОД = МаркировкаТоваровКлиентСервер.ПриВводеВОборотПередаватьИдентификаторМОД(
		ВидыПродукцииПоТоварнойГруппе, Шапка.Операция);
	
	Если ПередаватьИдентификаторМОД Тогда
		ИдентификаторМОД = "";

		Если Не ЗначениеЗаполнено(Шапка.ИдентификаторФИАС) Тогда
			ОбщегоНазначенияИСКлиентСервер.ДобавитьТекстОшибки(
				СообщениеJSON, СтрШаблон(
					НСтр("ru = 'Не найден идентификатор ФИАС по адресу:
						 |%1'"), Шапка.МестоОсуществленияДеятельностиАдресСтрокой));
		Иначе
			...
			Если МестаОсуществленияДеятельности.Количество() Тогда
				ИдентификаторМОД = МестаОсуществленияДеятельности[0].ИдентификаторМОД;
			Иначе
				ОбщегоНазначенияИСКлиентСервер.ДобавитьТекстОшибки(
					СообщениеJSON, СтрШаблон(
	...
	Для Каждого СтрокаТовары Из Товары Цикл
		...
		Если Не КонструкторИСМПКлиентСервер.СырьеПоддерживаетКодОКЕИ(
			СтрокаТовары.ВидПродукции, ЕдиницаИзмеренияКод, Шапка.Операция) Тогда
			ОбщегоНазначенияИСКлиентСервер.ДобавитьТекстОшибки(
				СообщениеJSON,
				СтрШаблон(
	...
	Если ПередаватьИдентификаторМОД Тогда
		ТелоЗапроса.Вставить("modId", ИдентификаторМОД);
	КонецЕсли;
	
	Если Шапка.Операция = Перечисления.ВидыОперацийИСМП.ВводВОборотСырьяПроизводствоРФ Тогда
		
		ТелоЗапроса.Вставить("action",         "PRODUCTION_CAS");
		
	ИначеЕсли Шапка.Операция = Перечисления.ВидыОперацийИСМП.ВводВОборотСырьяПолучениеТовараИзЕАЭС Тогда
		
		ТелоЗапроса.Вставить("action",         "FROM_EAES");
		
		ТелоЗапроса.Вставить("sourceCountryCode", Шапка.СтранаЭкспортерКод);
		ТелоЗапроса.Вставить("supplierName",      СведенияОКонтрагенте.Наименование);
		ТелоЗапроса.Вставить("supplierId",        СведенияОКонтрагенте.НалоговыйНомерВСтранеРегистрации);
		
		ТелоЗапроса.Вставить("sourceDocType", Шапка.НаименованиеПервичногоДокумента);
		...
		Если ЗначениеЗаполнено(Шапка.СтранаПроизводстваКод) Тогда
			ТелоЗапроса.Вставить("producerCountryCode", Шапка.СтранаПроизводстваКод);
		КонецЕсли;
		Если ЗначениеЗаполнено(Шапка.Производитель) Тогда
			СведенияОКонтрагенте = Новый Структура();
			СведенияОКонтрагенте.Вставить("Наименование", "");
			...
			ИнтеграцияИСПереопределяемый.ЗаполнитьСведенияОбОрганизации(
				Шапка.Производитель,
				СведенияОКонтрагенте);
			ТелоЗапроса.Вставить("producerId", ИдентификаторПроизводителя);
			ТелоЗапроса.Вставить("producerName",  СведенияОКонтрагенте.Наименование);
		КонецЕсли;
		
	ИначеЕсли Шапка.Операция = Перечисления.ВидыОперацийИСМП.ВводВОборотСырьяПолучениеТовараВнеЕАЭС Тогда
		
		ТелоЗапроса.Вставить("action",         "FROM_OTHER_COUNTRY");
		
		ТелоЗапроса.Вставить("importDeclarationNumber", Шапка.РегистрационныйНомерДекларации);
		
		ТелоЗапроса.Вставить("sourceCountryCode", Шапка.СтранаЭкспортерКод);
		ТелоЗапроса.Вставить("supplierName",      СведенияОКонтрагенте.Наименование);
		ТелоЗапроса.Вставить("supplierId",        СведенияОКонтрагенте.НалоговыйНомерВСтранеРегистрации);
		
		Если ЗначениеЗаполнено(Шапка.НаименованиеПервичногоДокумента) Тогда
			ТелоЗапроса.Вставить("sourceDocType", Шапка.НаименованиеПервичногоДокумента);
		КонецЕсли;
		Если ЗначениеЗаполнено(Шапка.НаименованиеПервичногоДокумента) Тогда
			ТелоЗапроса.Вставить("sourceDocNum",  Шапка.НомерПервичногоДокумента);
	...
	ИначеЕсли Шапка.Операция = Перечисления.ВидыОперацийИСМП.ВводВОборотСырьяОстатки Тогда
		
		ТелоЗапроса.Вставить("action",         "OST");
		
		Если ЗначениеЗаполнено(Шапка.РегистрационныйНомерДекларации) Тогда
			ТелоЗапроса.Вставить("importDeclarationNumber", Шапка.РегистрационныйНомерДекларации);
		КонецЕсли;
		
		ТелоЗапроса.Вставить("auditDate",  Формат(Шапка.ДатаИмпорта, "ДФ=yyyy-MM-dd"));
		ТелоЗапроса.Вставить("auditorInn", ИдентификаторАудитора);
		
		ТелоЗапроса.Вставить("sourceDocNum",  Шапка.НомерПервичногоДокумента);
		ТелоЗапроса.Вставить("sourceDocDate", Формат(Шапка.ДатаПервичногоДокумента, "ДФ=yyyy-MM-dd"));
		
		Если ЗначениеЗаполнено(Шапка.СтранаПроизводстваКод) Тогда
			ТелоЗапроса.Вставить("sourceCountryCode", Шапка.СтранаПроизводстваКод);
		КонецЕсли;
		Если ЗначениеЗаполнено(Шапка.Производитель) Тогда
			СведенияОКонтрагенте = Новый Структура();
			СведенияОКонтрагенте.Вставить("Наименование", "");
			...
			ИнтеграцияИСПереопределяемый.ЗаполнитьСведенияОбОрганизации(
				Шапка.Производитель,
				СведенияОКонтрагенте);
			ТелоЗапроса.Вставить("supplierId",   ИдентификаторПроизводителя);
			ТелоЗапроса.Вставить("supplierName", СведенияОКонтрагенте.Наименование);
		КонецЕсли;
	...
	Иначе
		...
		ОбщегоНазначенияИСКлиентСервер.ДобавитьТекстОшибки(
			СообщениеJSON,
			СтрШаблон(
				НСтр("ru = 'По товарной группе %1 не поддерживается операция %2'"),
				Шапка.ТоварнаяГруппа,
				Шапка.Организация));
		СообщенияJSON.Добавить(СообщениеJSON);
	...
	Товары.Свернуть("ИдентификаторСырья, ВидПродукцииСырья,ИдентификаторПроисхожденияВЕТИССтрокой,ЕдиницаИзмеренияКод", "Количество,КоличествоУпаковок");
	Для Каждого СтрокаТовары Из Товары Цикл
		...
		Если ЭтоТоварнаяГруппаПодконтрольнаяВЕТИС
			И ЗначениеЗаполнено(СтрокаТовары.ИдентификаторПроисхожденияВЕТИССтрокой) Тогда
			СтрокаТЧ.Вставить("vsdNumber", СтрокаТовары.ИдентификаторПроисхожденияВЕТИССтрокой);
		КонецЕсли;
	...
	Если ТекущаяГруппа.Количество() Тогда
		...
		ТелоЗапроса.Вставить("products", ТекущаяГруппа);
	...
	Если КодыАгрегированы Тогда
		...
		Если ДанныеДляЗапросаСтатусов.Количество() Тогда
			...
			Если РезультатЗапроса.ТребуетсяОбновлениеКлючаСессии Тогда
				ОбщегоНазначенияИСКлиентСервер.ДобавитьТекстОшибки(
					СообщениеJSON,
						НСтр("ru = 'Требуется обновление ключа сессии для определения длины кода SSCC.'"));
...
Функция ОтчетОНанесенииJSON(ДокументСсылка, ДополнительныеПараметры, Повторно = Ложь)
	...
	Если Не МаркировкаТоваровКлиентСервер.ДоступенОтчетОНанесении(Шапка.ТоварнаяГруппа) Тогда
	...
	Если МаркировкаТоваровКлиентСервер.ВОтчетеОНанесенииПередаватьИНН(Шапка.ТоварнаяГруппа) Тогда
...
Функция ОтчетОНанесенииШтрихкодыУпаковокJSON(РезультатЗапроса, ДополнительныеПараметры, Повторно)
	...
	РазбиватьПоСрокамГодности = КонструкторИСМПОбщегоНазначенияКлиентСервер.ЭтоВидПродукцииСоСрокамиГодности(ВидыПродукцииПоТоварнойГруппе);
		...
		И (АгрегацияПередВводомВОборот
		   ...
		   Или (ЭтоИмпортСФТС
		      И (Шапка.ВариантЗаполненияДекларации = Перечисления.ВариантыЗаполненияДекларацииИСМП.КодыУпаковок
		         Или Шапка.ВариантЗаполненияДекларации = Перечисления.ВариантыЗаполненияДекларацииИСМП.АТК)));
	...
	Если ЭтоИмпортСФТС Тогда
		...
		ИначеЕсли Шапка.ВариантЗаполненияДекларации = Перечисления.ВариантыЗаполненияДекларацииИСМП.АТК Тогда
			...
			ТребуетсяФормированиеАТК = Не ТребуетсяАгрегация;
	...
	СообщениеJSON = ЗаполнитьСообщениеJSON(Шапка, ДокументСсылка, ОперацияДокумента, НомерВерсии);
...
#Область РазборКодовМаркировки
	...
	Если МаркировкаТоваровКлиентСервер.ВОтчетеОНанесенииИспользоватьОбъем(ВидыПродукцииПоТоварнойГруппе) Тогда
		НоменклатураДокумента = РезультатПоиска.МаркированныеТовары.ВыгрузитьКолонку("Номенклатура");
		Если КонструкторИСМПОбщегоНазначенияКлиентСервер.ЭтоВидПродукцииИСМПЕГАИС(ВидыПродукцииПоТоварнойГруппе) Тогда
			// Настройки ЕГАИС
	...
	КоличествоЕдиницИспользование = КоличествоЕдиницИспользованиеПоТоварнойГруппе(Шапка.ТоварнаяГруппа);
	Если КоличествоЕдиницИспользование Тогда
		КоличествоЕдиницДанные = КоличествоЕдиницПолучитьДанные(Шапка.Ссылка);
		Если КоличествоЕдиницДанные = Неопределено Тогда
			КоличествоЕдиницИспользование = Ложь;
		Иначе
			КоличествоЕдиницКэш = Новый Соответствие;
		КонецЕсли;
	КонецЕсли;
	
	ПолныеКодыМаркировки = ИнициализироватьПолныеКодыМаркировки();
	КодыМаркировки       = ШтрихкодированиеИСМП.НоваяТаблицаПоискаКодаМаркировкиВПуле(ВидыПродукцииПоТоварнойГруппе);
	
	СоответствиеБлоковИНаборов = Новый Соответствие;
	ДоступноПолеПаспортСоответствия = МаркировкаТоваровКлиентСервер.ДоступноПолеПаспортСоответствия(ВидыПродукцииПоТоварнойГруппе, ОперацияДокумента);
	ДоступноПолеСодержаниеЭтиловогоСпирта = МаркировкаТоваровКлиентСервер.ДоступноПолеСодержаниеЭтиловогоСпирта(ВидыПродукцииПоТоварнойГруппе, ОперацияДокумента);
	...
	Для Каждого СтрокаТЧМаркированныеТовары Из РезультатПоиска.МаркированныеТовары Цикл
		...
		Если ТребуетсяПередатьКодМаркировки Тогда
			...
			Если КоличествоЕдиницИспользование Тогда
				...
				КэшНоменклатура = КоличествоЕдиницКэш[СтрокаТЧМаркированныеТовары.Номенклатура];
				Если КэшНоменклатура = Неопределено Тогда
					КоличествоЕдиницКэш.Вставить(СтрокаТЧМаркированныеТовары.Номенклатура, Новый Соответствие);
					КэшНоменклатура = КоличествоЕдиницКэш[СтрокаТЧМаркированныеТовары.Номенклатура];
				КонецЕсли;
				
				КоличествоЕдиниц = КэшНоменклатура[СтрокаТЧМаркированныеТовары.Характеристика];
				Если КоличествоЕдиниц = Неопределено Тогда
					СтруктураПоиска = Новый Структура;
					СтруктураПоиска.Вставить("Номенклатура", СтрокаТЧМаркированныеТовары.Номенклатура);
					СтруктураПоиска.Вставить("Характеристика", СтрокаТЧМаркированныеТовары.Характеристика);
					НайденныеСтроки = КоличествоЕдиницДанные.НайтиСтроки(СтруктураПоиска);
					Если НайденныеСтроки.Количество() = 0 Тогда
						КоличествоЕдиниц = 0;
					Иначе
						КоличествоЕдиниц = НайденныеСтроки[0].КоличествоЕдиниц;
					КонецЕсли;
					КэшНоменклатура.Вставить(СтрокаТЧМаркированныеТовары.Характеристика, КоличествоЕдиниц);
				КонецЕсли;
				
				Если КоличествоЕдиниц > 0 Тогда
					СтрокаТЧМаркированныеТовары.ТребуетВзвешивания = Истина;
					СтрокаТЧМаркированныеТовары.Количество = КоличествоЕдиниц;
				КонецЕсли;
				
			ИначеЕсли МаркировкаТоваровКлиентСервер.ВОтчетеОНанесенииИспользоватьОбъем(ВидыПродукцииПоТоварнойГруппе) Тогда
			...
			ШтрихкодированиеИСМП.ДобавитьКодМаркировкиВТаблицуДляПоискаВПуле(
				СтрокаТЧМаркированныеТовары, КодыМаркировки, ВидыПродукцииПоТоварнойГруппе);
			...
			Если СоответствиеБлоковИНаборов[СтрокаРодитель.Штрихкод] = Неопределено Тогда
				...
				Если СтрокаРодитель.ВидУпаковки = Перечисления.ВидыУпаковокИС.Групповая
					...
					Если СтрокаРодитель.ВидУпаковки = Перечисления.ВидыУпаковокИС.Групповая
						...
						СтрокаРодитель.Количество = СтрокаРодитель.Количество * ТекущийОбъем;
					КонецЕсли;
					...
					ШтрихкодированиеИСМП.ДобавитьКодМаркировкиВТаблицуДляПоискаВПуле(
						СтрокаРодитель, КодыМаркировки, ВидыПродукцииПоТоварнойГруппе);
		...
		Если (ДоступноПолеПаспортСоответствия Или ДоступноПолеСодержаниеЭтиловогоСпирта)
		...
		Если ДоступноПолеСодержаниеЭтиловогоСпирта
			И СтрокаРодитель <> Неопределено
			И СтрокаРодитель.ВидУпаковки = Перечисления.ВидыУпаковокИС.Групповая
			И СоответствиеGTIN[СтрокаРодитель.GTIN] = Неопределено Тогда
			ДанныеGTIN = Новый Структура;
			ДанныеGTIN.Вставить("Номенклатура", СтрокаТЧМаркированныеТовары.Номенклатура);
			ДанныеGTIN.Вставить("Характеристика", СтрокаТЧМаркированныеТовары.Характеристика);
			СоответствиеGTIN.Вставить(СтрокаРодитель.GTIN, ДанныеGTIN);
		КонецЕсли;
		
	КонецЦикла;
	
	Если Не Повторно
		И МаркировкаТоваровКлиентСервер.ДоступноПолеВариантВыполненияАгрегации(ВидыПродукцииПоТоварнойГруппе, Операции) Тогда
...
#КонецОбласти
	...
	Если КонструкторИСМПКлиентСервер.ЭтоВидПродукцииСОбязательнымУказаниемДатыПроизводства(ВидыПродукцииПоТоварнойГруппе, ОперацияДокумента) Тогда
	...
	ИдентификаторАдреса = ИдентификаторАдреса(ВидыПродукцииПоТоварнойГруппе, РезультатОпределенияСУЗ, СообщениеJSON);
	Если ЗначениеЗаполнено(СообщениеJSON.ТекстОшибки) Тогда
		СообщенияJSON.Добавить(СообщениеJSON);
		Возврат СообщенияJSON;
	КонецЕсли;
	...
	Если ПолныеКодыМаркировки.Количество() = 0 Тогда
	...
	Если МаркировкаТоваровКлиентСервер.ДоступноПолеЗаводскойСерийныйНомерВнутриКМ(ВидыПродукцииПоТоварнойГруппе, Операции) Тогда
	...
	Если КонструкторИСМПОбщегоНазначенияКлиентСервер.ЭтоВидПродукцииСоСрокамиГодности(ВидыПродукцииПоТоварнойГруппе, Ложь) Тогда
	...
	ИмяПараметраГоденДо = МаркировкаТоваровКлиентСервер.ИмяПараметраГоденДо(ВидыПродукцииПоТоварнойГруппе);
	
	Если ИмяПараметраГоденДо <> Неопределено Тогда
		
		Если ИнтеграцияИСМПВЕТИСКлиентСервер.ЭтоВидПродукцииИСМПВЕТИС(Шапка.ТоварнаяГруппа) Тогда
		...
		Для Каждого ДанныеСообщения Из ГруппыКодов Цикл
			...
			Если ИмяПараметраГоденДо = "expDate" Тогда
			...
			ИначеЕсли ИмяПараметраГоденДо = "expirationDate" Тогда
				
				ИмяПараметраГоденДо = "expirationDate";
				ФорматДаты          = "ДФ=dd.MM.yyyy";
	...
	Для Каждого КлючИЗначение Из СоответствиеGTIN Цикл
		...
		Если ДоступноПолеСодержаниеЭтиловогоСпирта Тогда
			...
			РеквизитовНанесенияНаПиво.Вставить("СодержаниеЭтиловогоСпирта", "0");
			Если НайденныеСтроки.Количество() > 0 Тогда
				...
				РеквизитовНанесенияНаПиво.СодержаниеЭтиловогоСпирта = Формат(НайденныеСтроки[0].СодержаниеЭтиловогоСпирта, "ЧРД=.; ЧН=0;");
			КонецЕсли;
...
Функция ОтчетОНанесенииОтчетПроизводственнойЛинииJSON(РезультатЗапроса, ДополнительныеПараметры, Повторно)
	...
	ПередаватьВДекларациюКодыУпаковок = 
		Шапка.ВариантЗаполненияДекларации = ПредопределенноеЗначение("Перечисление.ВариантыЗаполненияДекларацииИСМП.КодыУпаковок");
...
#Область РазборКодовМаркировки
	...
	ПолныеКодыМаркировки = ИнициализироватьПолныеКодыМаркировки();
	КодыМаркировки       = ШтрихкодированиеИСМП.НоваяТаблицаПоискаКодаМаркировкиВПуле(Шапка.ТоварнаяГруппа);
	...
	Если Не Повторно
		И МаркировкаТоваровКлиентСервер.ДоступноПолеВариантВыполненияАгрегации(ВидыПродукцииПоТоварнойГруппе, Операции)
		И Не (ЭтоИмпортСФТС И Не ПередаватьВДекларациюКодыУпаковок) Тогда
	...
	Если ЕстьОшибки Или ПолныеКодыМаркировки.Количество() = 0 Тогда
		СообщитьОНеправильномФорматеОтчета(СообщениеJSON);
	КонецЕсли;
...
#КонецОбласти
	...
	Если МаркировкаТоваровКлиентСервер.ДоступноПолеЗаводскойСерийныйНомерВнутриКМ(ВидыПродукцииПоТоварнойГруппе, ОперацияДокумента) Тогда
	...
	Если ДоступноПолеПаспортСоответствия
		Или ДоступноПолеСодержаниеЭтиловогоСпирта Тогда
		СоответствиеGTIN = Новый Соответствие;
		Для Каждого ДанныеКодов Из ГруппыКодов Цикл
			Если СоответствиеGTIN[ДанныеКодов.GTIN] = Неопределено Тогда
				...
				ИначеЕсли ДоступноПолеСодержаниеЭтиловогоСпирта Тогда
					...
					ДанныеGTIN.РеквизитовНанесенияНаПиво.Вставить("СодержаниеЭтиловогоСпирта", Формат(Шапка.СодержаниеЭтиловогоСпирта, "ЧРД=.; ЧН=0;"));
				КонецЕсли;
...
Функция ВариантПередачиАгрегации(Шапка, ТребуетсяПередачаАгрегацииЧерезTrueAPI = Ложь, ТребуетсяПередачаАгрегацииЧерезСУЗ = Ложь)
	...
	Если КонструкторИСМПКлиентСервер.ВидПродукцииПоддерживаетАгрегациюКодовМаркировкиЧерезСУЗ(Шапка.ТоварнаяГруппа) Тогда
...
Функция АгрегацияШтрихкодыУпаковокJSON(РезультатЗапроса, ДополнительныеПараметры, Повторно)
	...
	Если ВариантПередачиАгрегации = "ЧерезСУЗ" Тогда
		...
		ВидыПродукцииПоТоварнойГруппе = КонструкторИСМПОбщегоНазначенияКлиентСервер.ВидыПродукции(Шапка.ТоварнаяГруппа);
		ПараметрыСканирования = ШтрихкодированиеОбщегоНазначенияИС.ПараметрыСканирования(ДанныеШапки, Неопределено, ВидыПродукцииПоТоварнойГруппе);
...
#Область ДеревоУпаковокПоДаннымОтчетаПроизводственнойЛинии
		...
		НастройкиРазбораКодаМаркировки.Вставить("Общие",            РазборКодаМаркировкиИССлужебный.НастройкиРазбораКодаМаркировки(ВидыПродукцииПоТоварнойГруппе));
		...
		Для Каждого СтрокаДанныхОтчета Из Штрихкоды Цикл
			...
			ДанныеРазбораШтрихкода = ГрупповаяОбработкаШтрихкодовИС.ВидУпаковкиИПредставлениеШтрихкодаУпрощенныйРазбор(
				СтрокаДанныхОтчета.Штрихкод, ВидыПродукцииПоТоварнойГруппе, КешДанныхРазбора,
			...
			Если ЗначениеЗаполнено(СтрокаДанныхОтчета.ШтрихкодУпаковки) Тогда
				...
				ДанныеРазбораШтрихкодаУпаковки = ГрупповаяОбработкаШтрихкодовИС.ВидУпаковкиИПредставлениеШтрихкодаУпрощенныйРазбор(
					СтрокаДанныхОтчета.ШтрихкодУпаковки, ВидыПродукцииПоТоварнойГруппе, КешДанныхРазбора,
					НастройкиРазбораКодаМаркировки);
			...
			СтрокаДерева.ВидПродукции         = ДанныеРазбораШтрихкода.ВидПродукции;
...
#КонецОбласти
		...
		Если ДополнительныеПараметры.ПараметрыОбмена.КОпределениюВидаУпаковки <> Неопределено Тогда
			...
			СообщениеJSON.Операция = Перечисления.ВидыОперацийИСМП.ПовторноеФормированиеСообщений;
			СообщениеJSON.ПараметрыЗапроса = ДополнительныеПараметры.ПараметрыОбработкиДокумента;
			СообщениеJSON.ТоварнаяГруппа   = Неопределено;
			СообщенияJSON.Добавить(СообщениеJSON);
	...
	ИначеЕсли ВариантПередачиАгрегации = "ЧерезСУЗ" Тогда
		...
		ПараметрыПроверки.ПараметрыПроверкиИерархииАгрегатов       = ПроверкаИПодборПродукцииИСМПКлиентСервер.ДопустимыеВложенияАгрегатовПоВидамПродукции(Шапка.ТоварнаяГруппа);
...
Функция КвитанцияДокументаJSON(ДокументСсылка, ДополнительныеПараметры = Неопределено)
	...
	Если Не МаркировкаТоваровКлиентСервер.ДоступенОтчетОНанесении(Шапка.ТоварнаяГруппа) Тогда
		...
		ОбщегоНазначенияИСКлиентСервер.ДобавитьТекстОшибки(
			СообщениеJSON,
				СтрШаблон(
					НСтр("ru = 'Неизвестная товарная группа для маркировки товаров: ""%1"".'"),
					Шапка.ТоварнаяГруппа));
		СообщенияJSON.Добавить(СообщениеJSON);
		Возврат СообщенияJSON;
	...
	ДопустимыеНачальныеСтатусы    = ШтрихкодированиеИСМП.ДопустимыеНачальныеСтатусыОтчетОНанесении(Шапка.ТоварнаяГруппа);
	ОжидаемыеСтатусы = ШтрихкодированиеИСМП.ОжидаемыеСтатусыПослеПередачиОтчетаОНанесении(Шапка.ТоварнаяГруппа);
...
Процедура ЗаполнениеДанныхОбАгрегацииВСУЗ(СтрокаДерева, ГруппыКодов, ТоварнаяГруппа, ПараметрыНормализацииКМ, КоличествоКодовВДокументе, ПараметрыОбработки = Неопределено)
	
	Фильтр = Неопределено;
	
	Если ТипЗнч(СтрокаДерева) <> Тип("ДеревоЗначений") Тогда
		КодМаркировкиУпаковки = РазборКодаМаркировкиИССлужебныйКлиентСервер.НормализоватьКодМаркировки(
			СтрокаДерева, ТоварнаяГруппа, ПараметрыНормализацииКМ);
	...
	Если СтрокаДерева.Строки.Количество() > 0 Тогда
		...
		Для Каждого СтрокаДереваВложенная Из СтрокаДерева.Строки Цикл
			...
			Если КодМаркировкиУпаковки <> Неопределено Тогда
				КодМаркировки = РазборКодаМаркировкиИССлужебныйКлиентСервер.НормализоватьКодМаркировки(
					СтрокаДереваВложенная, ТоварнаяГруппа, ПараметрыНормализацииКМ);
		...
		Если КодМаркировкиУпаковки <> Неопределено
			...
			ЕмкостьУпаковки = 0;
			Если КонструкторИСМПКлиентСервер.ПоддерживаетсяСераяЗона(ТоварнаяГруппа) Тогда
...
Процедура ЗаполнитьДанныеОбъектаФормыПоДеревуУпаковок(Форма, ДеревоУпаковок, ПараметрыЗаполнения,
	...
	ЭтоВидПродукцииСоСрокамиГодности = КонструкторИСМПОбщегоНазначенияКлиентСервер.ЭтоВидПродукцииСоСрокамиГодности(Форма.Объект.ТоварнаяГруппа);
	...
	Для Каждого СтрокаДерева Из ДеревоУпаковок.Строки Цикл
		...
		Если ЭтоВидПродукцииСоСрокамиГодности Или ЭтоПродукцияПодконтрольнаяВЕТИС Тогда
...
Процедура ОбработатьДанныеШтрихкодаПотребительскойУпаковки(Форма, ДанныеШтрихкода, ПараметрыЗаполнения)
	...
	КонецЕсли;
	Если КонструкторИСМПКлиентСервер.ВидПродукцииПодлежитМаркировкеОстатков(Форма.Объект.ТоварнаяГруппа) Тогда
		СпецификаОбработки = СпецификаОбработки + ",ДоступныКодыМаркировкиОстатков";
	КонецЕсли;
	Если ИнтеграцияИСМПВЕТИСКлиентСервер.ЭтоВидПродукцииИСМПВЕТИС(ДанныеШтрихкода.ВидПродукции)
	...
	КонецЕсли;
	Если КонструкторИСМПОбщегоНазначенияКлиентСервер.ЭтоВидПродукцииСоСрокамиГодности(ДанныеШтрихкода.ВидПродукции) И ТребуетсяСрокГодности Тогда
	...
	Иначе
		...
		Если НайденныеСтрокиТовары.Количество() > 0 Тогда
			...
			Если ДанныеШтрихкода.ПроизвольнаяЕдиницаУчета Тогда
				ВсегоВКешеПотребительскихУпаковок = ПроверкаИПодборПродукцииИС.КоличествоПоДаннымКеша(Форма, ОбновляемаяСтрока, "КоличествоПотребительскихУпаковок");
			Иначе
				ВсегоВКешеПотребительскихУпаковок = 0;
			КонецЕсли;
			
			ВсегоКоличество = 0;
			ВсегоКоличествоПотребительскихУпаковок = 0;
			Для Каждого НайденнаяСтрока Из НайденныеСтрокиТовары Цикл
				ВсегоКоличество = ВсегоКоличество + НайденнаяСтрока.Количество;
				ВсегоКоличествоПотребительскихУпаковок = ВсегоКоличествоПотребительскихУпаковок + НайденнаяСтрока.КоличествоПотребительскихУпаковок;
			КонецЦикла;

			//поле Количество
			КоличествоМаркируемойПродукции = ОбновляемаяСтрока.Количество;
			
			ИспользуетсяДробноеКоличество = КоличествоМаркируемойПродукции <> Окр(КоличествоМаркируемойПродукции, 3);
			Если ИспользуетсяДробноеКоличество
				И ДанныеШтрихкода.ПроизвольнаяЕдиницаУчета
				И ОбновляемаяСтрока.КоличествоПотребительскихУпаковок > 0 Тогда
				КоличествоВОднойПотребительскойУпаковке = ОбновляемаяСтрока.Количество / ОбновляемаяСтрока.КоличествоПотребительскихУпаковок;
				ВсегоКоличество = ВсегоКоличествоПотребительскихУпаковок * КоличествоВОднойПотребительскойУпаковке;
				КоличествоСтроки = СтрокаТовары.КоличествоПотребительскихУпаковок * КоличествоВОднойПотребительскойУпаковке;
			Иначе
				КоличествоСтроки = СтрокаТовары.Количество;
			КонецЕсли;
			
			Если ВсегоВКеше < ВсегоКоличество Тогда
				КоличествоМаркируемойПродукции = Макс(0, КоличествоМаркируемойПродукции + ВсегоВКеше - ВсегоКоличество);
			КонецЕсли;
			
			Если КоличествоМаркируемойПродукции > 0 Тогда
				
				СтрокаТовары.Количество = КоличествоСтроки + КоличествоМаркируемойПродукции;
				...
				Иначе
					СтрокаТовары.КоличествоУпаковок = КоличествоСтроки + КоличествоМаркируемойПродукции;
				КонецЕсли;
			...
			Если ДанныеШтрихкода.ПроизвольнаяЕдиницаУчета Тогда
				...
				Если ВсегоВКешеПотребительскихУпаковок < ВсегоКоличествоПотребительскихУпаковок Тогда
					КоличествоМаркируемойПродукции = Макс(0, КоличествоМаркируемойПродукции + ВсегоВКешеПотребительскихУпаковок - ВсегоКоличествоПотребительскихУпаковок);
				КонецЕсли;
	...
	Если Не ЗначениеЗаполнено(ДанныеШтрихкода.Номенклатура) Тогда
		...
		РегистрыСведений.КэшОписанияОстатковИСМП.ЗаполнитьТаблицуПредставленийGTINОстатки(
			ИсточникДанных.Товары, ИсточникДанных.Организация, ИсточникДанных.ТоварнаяГруппа);
...
Функция КоличествоЕдиницИспользованиеПоТоварнойГруппе(ТоварнаяГруппа) Экспорт
	
	Возврат ОбщегоНазначения.ЗначениеРеквизитаОбъекта(ТоварнаяГруппа, "Имя") = "radio";
	
КонецФункции

Функция КоличествоЕдиницПолучитьДанные(Документ)
	
	Файл = КоличествоЕдиницПолучитьФайл(Документ);
...
Функция КоличествоЕдиницПолучитьФайл(Документ) Экспорт
	...
	|ИЗ
	|	Справочник.ИСМППрисоединенныеФайлы КАК Файл
	|ГДЕ
	|	Файл.ВладелецФайла = &Документ
	|	И Файл.Наименование = ""ДанныеВложенныхЕдиниц""";
...
Функция КоличествоЕдиницКодаМаркировкиСтрокой(Количество) Экспорт
	Возврат "30" + Формат(Количество, "ЧГ=0;");
КонецФункции
