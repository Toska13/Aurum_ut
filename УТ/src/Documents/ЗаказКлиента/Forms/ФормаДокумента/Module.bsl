...
Процедура ПослеЗаписиНаСервере(ТекущийОбъект, ПараметрыЗаписи)
	...
	СобытияФормЛокализация.ПослеЗаписиНаСервере(ЭтотОбъект, ТекущийОбъект, ПараметрыЗаписи);
...
Процедура ОбработкаОповещения(ИмяСобытия, Параметр, Источник)
	...
	Если ИмяСобытия = "ИзмененСтатусОнлайнЗаказа" Тогда
		ДенежныеСредстваКлиентЛокализация.ПроверитьОплатуОнлайнЗаказа(ЭтотОбъект, Объект.Ссылка);
	КонецЕсли;
	...
	ИначеЕсли ИсточникВыбора.ИмяФормы = "Документ.ЗаказКлиента.Форма.РеквизитыПечати" Тогда
		...
		Если ВыбранноеЗначение <> Неопределено Тогда
			...
			Если ДоставкаТоваровКлиентСервер.ИспользуетсяДоставка25() Тогда
				...
				Если Не Объект.ТребуетсяДоставка
					Или (Объект.СпособУказанияДоставки = ПредопределенноеЗначение("Перечисление.СпособыУказанияДоставки.ПоСтрокам")
							И Объект.ТребуетсяДоставка) Тогда
...
Процедура ПартнерПриИзменении(Элемент)
	...
	Если Не ЗначениеЗаполнено (Объект.Партнер) Тогда
		...
		Если Объект.ТребуетсяДоставка Тогда
			...
			ОбновитьВидПланированияДоставки();
...
Процедура ТребуетсяДоставкаПриИзменении(Элемент)
	...
	Иначе
		...
		Объект.ВидПланированияДоставки = ПредопределенноеЗначение("Перечисление.ВидыПланированияДоставки.ПустаяСсылка");
...
Процедура ТоварыПередНачаломИзменения(Элемент, Отказ)
	...
	ТоварыПередНачаломИзмененияЛокализация(Элемент, Отказ);
...
Процедура ТоварыПослеУдаления(Элемент)
	...
	ТоварыПослеУдаленияСервер(ЕстьИзменениеДатОтгрузок);
...
Процедура ТоварыНоменклатураПриИзменении(Элемент)
	...
	СтруктураДействий.Вставить("ЗаполнитьСтавкуНДСПоВидуЦен", ПакетнаяОбработкаТабличнойЧастиКлиентСервер.ПараметрыЗаполненияСтавкиНДСПоВидуЦен(Объект, Истина));
	СтруктураДействий.Вставить("ЗаполнитьСтавкуНДСВозвратнойТары", Объект.ВернутьМногооборотнуюТару);
	СтруктураДействий.Вставить("ПересчитатьСуммуНДС", СтруктураПересчетаСуммы);
...
Процедура ТоварыОтмененоПриИзменении(Элемент)
	...
	Если ВзаиморасчетыКлиент.ЕстьИзменениеДатОтгрузок(ЭтотОбъект) Тогда
		ТоварыОтмененоПриИзмененииНаСервере();
	КонецЕсли;
...
Процедура ТоварыСуммаПриИзменении(Элемент)
	...
	ОперацииПередачи = ОперацииПередачиТоваров();
	СкидкиНеИспользуются = ОперацииПередачи.Найти(Объект.ХозяйственнаяОперация) <> Неопределено;
...
Процедура РеквизитыПечати(Команда)
	...
	СтруктураПараметров.Вставить("СпособУказанияДоставки", Объект.СпособУказанияДоставки);
...
Процедура ПослеЗаполненияОбеспечения(Изменения, Режим = Неопределено, ПараметрыЗаполнения = Неопределено)
	...
	Если ЕстьИзмененияДатыОтгрузки Тогда
		ВзаиморасчетыРаботаСФормами.ФормаПриИзмененииРеквизитов(ЭтотОбъект, "Товары.ДатаОтгрузки");
		СкорректироватьСтавкиНДС();
	КонецЕсли;
	УстановитьВидимостьЭлементовФормыДатОтгрузки();
...
Процедура ЗаполнитьДатуОтгрузкиСервер(ДатаОтгрузки, МассивВыделенныхСтрок)
	...
	СкорректироватьСтавкиНДС(МассивВыделенныхСтрок);
...
Процедура НеОтгружатьЧастямиПриИзмененииСервер()
	...
	ВзаиморасчетыРаботаСФормами.ФормаПриИзмененииРеквизитов(ЭтотОбъект, "Товары.ДатаОтгрузки, НеОтгружатьЧастями");
...
Процедура ПартнерПриИзмененииСервер()
	...
	ВзаиморасчетыРаботаСФормами.ФормаПриИзмененииРеквизитов(ЭтотОбъект, МассивИзмененныхРеквизитов);
...
Процедура КонтрагентПриИзмененииСервер()
	...
	КонецЕсли;
	НаправленияДеятельностиСервер.ПриИзмененииНаправленияДеятельности(ЭтотОбъект);
	ИзмененныеРеквизиты = ВзаиморасчетыРаботаСФормами.ФормаПриИзмененииРеквизитов(ЭтотОбъект, "Контрагент");
...
Процедура ДатаСогласованияПриИзмененииНаСервере()
	ВзаиморасчетыРаботаСФормами.ФормаПриИзмененииРеквизитов(ЭтотОбъект, "ДатаСогласования");
КонецПроцедуры
...
Процедура ОбработатьШтрихкоды(ДанныеШтрихкодов)
	...
	СтруктураДействийСДобавленнымиСтроками.Вставить("ЗаполнитьСтавкуНДСПоВидуЦен", ПакетнаяОбработкаТабличнойЧастиКлиентСервер.ПараметрыЗаполненияСтавкиНДСПоВидуЦен(Объект, Истина));
...
Функция СформироватьНастройкиПараметровДоставки()
	...
	ЕстьПоддержкаДоставкиСвоимиКурьерами = СкладыСервер.ЕстьПоддержкаДоставкиСвоимиКурьерами(
		Объект.Склад, Объект.ДатаОтгрузки);
	...
	НастройкиДоставки.СпособУказанияДоставки = Объект.СпособУказанияДоставки;
	...
	НастройкиДоставки.ИспользуетсяЕдинаяДатаОтгрузки = Объект.НеОтгружатьЧастями;
	...
	ИменаПолейТоваров = "НомерСтроки, КодСтроки, Номенклатура, Характеристика, ХарактеристикиИспользуются, Серия, СтатусУказанияСерий, КоличествоУпаковок, Упаковка, Склад, ДатаОтгрузки";
	ПараметрыПоиска = Новый Структура;
	ПараметрыПоиска.Вставить("Отменено", Ложь);
	ПараметрыПоиска.Вставить("ТипНоменклатуры", Перечисления.ТипыНоменклатуры.Товар);
	ТаблицаТоваров = Объект.Товары.Выгрузить(ПараметрыПоиска, ИменаПолейТоваров);
	ТаблицаДоставки = Объект.ТоварыКДоставке.Выгрузить();
	...
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ
	|	ТаблицаДоставки.КодСтроки КАК КодСтроки,
	|	ТаблицаДоставки.СпособДоставки КАК СпособДоставки,
	|	ТаблицаДоставки.ТочкаДоставки КАК ТочкаДоставки,
	|	ТаблицаДоставки.ЗонаДоставки КАК ЗонаДоставки,
	|	ТаблицаДоставки.ДоставкаДоПеревозчика КАК ДоставкаДоПеревозчика,
	|	ТаблицаДоставки.Перевозчик КАК Перевозчик,
	|	ТаблицаДоставки.ТочкаДоставкиПеревозчика КАК ТочкаДоставкиПеревозчика,
	|	ТаблицаДоставки.ЗонаДоставкиПеревозчика КАК ЗонаДоставкиПеревозчика,
	|	ТаблицаДоставки.ВремяДоставкиС КАК ВремяДоставкиС,
	|	ТаблицаДоставки.ВремяДоставкиПо КАК ВремяДоставкиПо,
	|	ТаблицаДоставки.ДополнительнаяИнформацияПоДоставке КАК ДополнительнаяИнформацияПоДоставке,
	...
	|ПОМЕСТИТЬ ВтТаблицаДоставки
	|ИЗ
	|	&ТаблицаДоставки КАК ТаблицаДоставки
	|;
	|
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ
	...
	|	ЕСТЬNULL(ТаблицаДоставки.СпособДоставки, ЗНАЧЕНИЕ(Перечисление.СпособыДоставки25.НашимиСилами)) КАК СпособДоставки,
	|	ЕСТЬNULL(ТаблицаДоставки.ТочкаДоставки, ЗНАЧЕНИЕ(Справочник.ТочкиДоставки.ПустаяСсылка)) КАК ТочкаДоставки,
	|	ЕСТЬNULL(ТаблицаДоставки.ЗонаДоставки, ЗНАЧЕНИЕ(Справочник.ЗоныДоставки.ПустаяСсылка)) КАК ЗонаДоставки,
	|	ЕСТЬNULL(ТаблицаДоставки.ДоставкаДоПеревозчика, ЛОЖЬ) КАК ДоставкаДоПеревозчика,
	|	ЕСТЬNULL(ТаблицаДоставки.Перевозчик, ЗНАЧЕНИЕ(Справочник.Партнеры.ПустаяСсылка)) КАК Перевозчик,
	|	ЕСТЬNULL(ТаблицаДоставки.ТочкаДоставкиПеревозчика, ЗНАЧЕНИЕ(Справочник.ТочкиДоставки.ПустаяСсылка)) КАК ТочкаДоставкиПеревозчика,
	|	ЕСТЬNULL(ТаблицаДоставки.ЗонаДоставкиПеревозчика, ЗНАЧЕНИЕ(Справочник.ЗоныДоставки.ПустаяСсылка)) КАК ЗонаДоставкиПеревозчика,
	|	ЕСТЬNULL(ТаблицаДоставки.ВремяДоставкиС, ДАТАВРЕМЯ(1, 1, 1)) КАК ВремяДоставкиС,
	|	ЕСТЬNULL(ТаблицаДоставки.ВремяДоставкиПо, ДАТАВРЕМЯ(1, 1, 1)) КАК ВремяДоставкиПо,
	|	ЕСТЬNULL(ТаблицаДоставки.ДополнительнаяИнформацияПоДоставке, """") КАК ДополнительнаяИнформацияПоДоставке,
	|	ЕСТЬNULL(ТаблицаДоставки.ОсобыеУсловияПеревозки, ЛОЖЬ) КАК ОсобыеУсловияПеревозки,
	|	ЕСТЬNULL(ТаблицаДоставки.ОсобыеУсловияПеревозкиОписание, """") КАК ОсобыеУсловияПеревозкиОписание
	|ИЗ
	|	ВтТаблицаТоваров КАК ТаблицаТоваров
	|		ЛЕВОЕ СОЕДИНЕНИЕ ВтТаблицаДоставки КАК ТаблицаДоставки
	|		ПО ТаблицаТоваров.КодСтроки = ТаблицаДоставки.КодСтроки
	...
	Запрос.УстановитьПараметр("ТаблицаДоставки", ТаблицаДоставки);
	...
	Пока Выборка.Следующий() Цикл
		...
		СтрокаДоставки.НомерСтрокиДокумента = Выборка.НомерСтроки;
		СтрокаДоставки.КодСтроки = Выборка.КодСтроки;
		СтрокаДоставки.Номенклатура = Выборка.Номенклатура;
		СтрокаДоставки.Характеристика = Выборка.Характеристика;
		СтрокаДоставки.ХарактеристикиИспользуются = Выборка.ХарактеристикиИспользуются;
		СтрокаДоставки.Серия = Выборка.Серия;
		СтрокаДоставки.СтатусУказанияСерий = Выборка.СтатусУказанияСерий;
		СтрокаДоставки.КоличествоУпаковок = Выборка.КоличествоУпаковок;
		СтрокаДоставки.Упаковка = Выборка.Упаковка;
		СтрокаДоставки.СпособДоставки = Выборка.СпособДоставки;
		СтрокаДоставки.ТочкаДоставки = Выборка.ТочкаДоставки;
		СтрокаДоставки.ЗонаДоставки = Выборка.ЗонаДоставки;
		СтрокаДоставки.ДоставкаДоПеревозчика = Выборка.ДоставкаДоПеревозчика;
		СтрокаДоставки.Перевозчик = Выборка.Перевозчик;
		СтрокаДоставки.ТочкаДоставкиПеревозчика = Выборка.ТочкаДоставкиПеревозчика;
		СтрокаДоставки.ЗонаДоставкиПеревозчика = Выборка.ЗонаДоставкиПеревозчика;
		СтрокаДоставки.ВремяДоставкиС = Выборка.ВремяДоставкиС;
		СтрокаДоставки.ВремяДоставкиПо = Выборка.ВремяДоставкиПо;
		СтрокаДоставки.ДополнительнаяИнформацияПоДоставке = Выборка.ДополнительнаяИнформацияПоДоставке;
		СтрокаДоставки.ОсобыеУсловияПеревозки = Выборка.ОсобыеУсловияПеревозки;
		СтрокаДоставки.ОсобыеУсловияПеревозкиОписание = Выборка.ОсобыеУсловияПеревозкиОписание;
		СтрокаДоставки.ДатаОтгрузки = Выборка.ДатаОтгрузки;
		
		НастройкиДоставки.Товары.Добавить(СтрокаДоставки);
...
Процедура ОбработатьНастройкиПараметровДоставкиСервер(Знач Настройки)
	...
	Объект.СпособУказанияДоставки = Настройки.СпособУказанияДоставки;
	...
	Объект.ТоварыКДоставке.Очистить();
	Для Каждого СтрокаТоваров Из Настройки.Товары Цикл
	
		НоваяСтрока = Объект.ТоварыКДоставке.Добавить();
		ЗаполнитьЗначенияСвойств(НоваяСтрока, СтрокаТоваров);
		
	КонецЦикла;
	Объект.ТоварыКДоставке.Сортировать("КодСтроки");
...
// Параметры:
//  Форма - см. Документ.ЗаказКлиента.Форма.ФормаДокумента
//
&НаКлиентеНаСервереБезКонтекста
Процедура УстановитьДоступностьВидимостьЭлементовДоставки(Форма)
	...
	Если Не ДоставкаТоваровКлиентСервер.ИспользуетсяДоставка25()
		...
		ИменаЭлементов.Добавить("РедактироватьПараметрыДоставкиТовары");
	...
	Иначе
		...
		ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(
			Элементы,
			"РедактироватьПараметрыДоставкиТовары",
			"Видимость",
			Объект.ТребуетсяДоставка);
...
&НаСервере
Процедура ОбновитьВидПланированияДоставки()
	
	Если НЕ Объект.ТребуетсяДоставка Тогда
		Возврат;
	КонецЕсли;
	
	Объект.ВидПланированияДоставки = ДоставкаТоваров.ВидПланированияДоставкиПоПартнеруСоглашению(
		Объект.Партнер,
		Объект.Соглашение);
...
Процедура КонтрольНеСогласованныхИзмененийОбработатьСобытиеКоманды(Команда)
	...
	ИначеЕсли Команда.Имя = "ЗаполнитьЦеныПоДоговору" Тогда
	...
	ИначеЕсли Команда.Имя = "ДобавитьОплатуБонуснымиБаллами" Тогда
		ДобавитьОплатуБонуснымиБаллами(Команда);
	ИначеЕсли Команда.Имя = "ОтменитьОплатуБонуснымиБаллами" Тогда
...
&НаСервере
Процедура ТоварыПослеУдаленияСервер(ЕстьИзменениеДатОтгрузок)
...
&НаСервере
Процедура ТоварыОтмененоПриИзмененииНаСервере()
...
&НаСервере
Процедура СкорректироватьСтавкиНДС(МассивВыделенныхСтрок = Неопределено)
	...
	Иначе
		ВыделенныеСтроки = РаботаСТабличнымиЧастямиКлиентСервер.ЭлементыКоллекции(Объект.Товары, Элементы.Товары.ВыделенныеСтроки);
		ПакетнаяОбработкаТабличнойЧастиСервер.ОбработатьСтрокиТЧ(
			ВыделенныеСтроки,
			СтруктураДействий,
			Объект.Товары,
			КэшированныеЗначенияСлужебный);
	КонецЕсли;
...
Процедура ЗаполнитьМногооборотнуюТаруИзХранилищаСервер(АдресТарыВХранилище)
	...
	СтруктураДействийИзмененныеСтроки.Вставить("ЗаполнитьСтавкуНДСПоВидуЦен", ПакетнаяОбработкаТабличнойЧастиКлиентСервер.ПараметрыЗаполненияСтавкиНДСПоВидуЦен(Объект, Истина));
...
Процедура СкорректироватьСтрокиЗаказа(СтруктураДополнительныхПараметров)
	...
	Если СтруктураРезультата.КоличествоСтрок <> 0 ИЛИ СтруктураРезультата.СуммаКорректировки > 0 Тогда
		...
		ЭтапыОплатыСервер.ПроверитьЗаполнитьЭтапыГрафикаОплаты(ДокументПродажи);
...
&НаКлиенте
Процедура ТоварыПередНачаломИзмененияЛокализация(Элемент, Отказ)
...
Процедура ПроверитьИсправитьНаличиеСкидокОплатБонуснымиБалламиЛокализация()
	...
	РезультатПроверки = РозничныеПродажиЛокализация.ПроверитьИсправитьНаличиеСкидокОплатБонуснымиБаллами(ЭтотОбъект, "Товары", Истина, Истина);
