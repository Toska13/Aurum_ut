...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Элементы.ПереходПраваСобственностиЦена.Заголовок = ЗаголовокЦена;
	Элементы.ПереходПраваСобственностиСумма.Заголовок = ЗаголовокСумма;
	...
	// Заголовки полей итогов
	СтрокаЗаголовка = "%1 (%2)";
	ЗаголовокСуммаВсего = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(СтрокаЗаголовка, НСтр("ru = 'Всего с НДС'"), ВалютаСтр);
	ЗаголовокНДСВсего   = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(СтрокаЗаголовка, НСтр("ru = 'НДС'"), ВалютаСтр);
	
	Элементы.ТоварыИтогСуммаСНДС.Заголовок = ЗаголовокСуммаВсего;
	Элементы.ТоварыИтогСуммаНДС.Заголовок  = ЗаголовокНДСВсего;
	...
	Если Не ЗначениеЗаполнено(Объект.Ссылка) Тогда 
		...
		Если ЗначениеЗаполнено(Параметры.ЗначениеКопирования) Тогда
			Объект.ЦенаВключаетНДС = ОбщегоНазначения.ЗначениеРеквизитаОбъекта(Параметры.ЗначениеКопирования, "ЦенаВключаетНДС");			
	...
	МассивЭлементовНомерГТД.Добавить("ПереходПраваСобственностиНомерГТД");
...
Процедура ПослеЗаписиНаСервере(ТекущийОбъект, ПараметрыЗаписи)
	...
	Если ЭтоОстаткиСобственныхТоваров
		...
		Или ЭтоОстаткиПереданныхВПроизводствоТоваров
		Или ЭтоОстаткиОтгруженныхТоваров Тогда
	...
	УчетПодакцизныхТоваров.ОбновитьЭлементыУчетаПодакцизныхТоваров(ЭтотОбъект, Ложь);
...
Процедура ТекстСчетФактураОбработкаНавигационнойСсылки(Элемент, НавигационнаяСсылкаФорматированнойСтроки, СтандартнаяОбработка)
	...
	Если ЭтоОстаткиСобственныхТоваров Тогда
		...
		УчетНДСУПКлиент.ОбработкаНавигационнойСсылкиСчетаФактурыПолученные(ЭтотОбъект, НавигационнаяСсылкаФорматированнойСтроки,  СтандартнаяОбработка, ПараметрыРегистрации);
...
#Область ОбработчикиСобытийЭлементовФормыСтраницаПереходПраваСобственности

&НаКлиенте
Процедура ПереходПраваСобственностиДатаПриИзменении(Элемент)
...
&НаКлиенте
Процедура ПереходПраваСобственностиОрганизацияПриИзменении(Элемент)
...
&НаКлиенте
Процедура ПереходПраваСобственностиПартнерПриИзменении(Элемент)
...
&НаКлиенте
Процедура ПереходПраваСобственностиДоговорПриИзменении(Элемент)
...
&НаКлиенте
Процедура ПереходПраваСобственностиЦенаВключаетНДСПриИзменении(Элемент)
...
&НаКлиенте
Процедура ПереходПраваСобственностиСкладПриИзменении(Элемент)
...
#Область ОбработчикиСобытийЭлементовТаблицыФормыПереходПраваСобственности

&НаКлиенте
Процедура ПереходПраваСобственностиПослеУдаления(Элемент)
...
&НаКлиенте
Процедура ПереходПраваСобственностиПередУдалением(Элемент, Отказ)
...
&НаКлиенте
Процедура ПереходПраваСобственностиПриОкончанииРедактирования(Элемент, НоваяСтрока, ОтменаРедактирования)
...
&НаКлиенте
Процедура ПереходПраваСобственностиПриНачалеРедактирования(Элемент, НоваяСтрока, Копирование)
...
&НаКлиенте
Процедура ПереходПраваСобственностиНоменклатураПриИзменении(Элемент)
...
&НаКлиенте
Процедура ПереходПраваСобственностиКоличествоУпаковокПриИзменении(Элемент)
...
&НаКлиенте
Процедура ПереходПраваСобственностиЦенаПриИзменении(Элемент)
...
&НаКлиенте
Процедура ПереходПраваСобственностиСуммаПриИзменении(Элемент)
...
&НаКлиенте
Процедура ПереходПраваСобственностиСерияПриИзменении(Элемент)
	
	ВыбранноеЗначение = НоменклатураКлиентСервер.ВыбраннаяСерия();
	
	ТекущиеДанные = Элементы.ПереходПраваСобственности.ТекущиеДанные;
...
&НаКлиенте
Процедура ПереходПраваСобственностиСерияНачалоВыбора(Элемент, ДанныеВыбора, ВыборДобавлением, СтандартнаяОбработка)
...
&НаКлиенте
Процедура ПереходПраваСобственностиУпаковкаПриИзменении(Элемент)
...
&НаКлиенте
Процедура ПереходПраваСобственностиНомерГТДПриИзменении(Элемент)
...
&НаКлиенте
Процедура ПереходПраваСобственностиНомерГТДСоздание(Элемент, СтандартнаяОбработка)
...
#Область ОбработчикиСобытийЭлементовТаблицыФормыОтклонения

&НаКлиенте
Процедура ОтклоненияДатаПриИзменении(Элемент)
	ДатаПриИзмененииСервер();
КонецПроцедуры

&НаКлиенте
Процедура ОтклоненияОрганизацияПриИзменении(Элемент)
	ОрганизацияПриИзмененииСервер();
КонецПроцедуры

&НаКлиенте
Процедура ОтклоненияНоменклатураПриИзменении(Элемент)
	НоменклатураПриИзменении();
КонецПроцедуры

&НаКлиенте
Процедура ОтклоненияСуммаПриИзменении(Элемент)
	СуммаПриИзменении();
КонецПроцедуры

&НаКлиенте
Процедура ОтклоненияСтавкаНДСПриИзменении(Элемент)
	СтавкаНДСПриИзменении();
КонецПроцедуры
...
Процедура ОткрытьПодбор(Команда)
	...
	Если ЭтоОстаткиПереданнойТары
		Или ЭтоОстаткиПринятойТары Тогда
	...
	Иначе
		...
		Если Не ЭтоОстаткиОтгруженныхТоваров Тогда
			МассивТиповНоменклатуры.Добавить(ПредопределенноеЗначение("Перечисление.ТипыНоменклатуры.МногооборотнаяТара"));
		КонецЕсли;
...
Процедура УстановитьУсловноеОформление()
	...
	КомпоновкаДанныхКлиентСервер.ДобавитьОформляемоеПоле(Элемент.Поля, Элементы.ПереходПраваСобственностиУпаковка.Имя);
	...
	НоменклатураСервер.УстановитьУсловноеОформлениеХарактеристикНоменклатуры(ЭтотОбъект, "СобственныеТоварыХарактеристика");
	НоменклатураСервер.УстановитьУсловноеОформлениеХарактеристикНоменклатуры(ЭтотОбъект, "ПолученныеНаКомиссиюХарактеристика");
	НоменклатураСервер.УстановитьУсловноеОформлениеХарактеристикНоменклатуры(ЭтотОбъект, "ПолученныеНаХранениеХарактеристика");
	НоменклатураСервер.УстановитьУсловноеОформлениеХарактеристикНоменклатуры(ЭтотОбъект, "ПереходПраваСобственностиХарактеристика");
	НоменклатураСервер.УстановитьУсловноеОформлениеХарактеристикНоменклатуры(ЭтотОбъект, "ПереданныеНаКомиссиюХарактеристика");
	...
	НоменклатураСервер.УстановитьУсловноеОформлениеХарактеристикНоменклатуры(ЭтотОбъект, "ПринятаяТараХарактеристика");
	НоменклатураСервер.УстановитьУсловноеОформлениеХарактеристикНоменклатуры(ЭтотОбъект, "ПереданнаяТараХарактеристика");
	НоменклатураСервер.УстановитьУсловноеОформлениеХарактеристикНоменклатуры(ЭтотОбъект, "ПереходНаАдресноеХранениеТоварыХарактеристика");
	НоменклатураСервер.УстановитьУсловноеОформлениеХарактеристикНоменклатуры(ЭтотОбъект, "ПереданныеПереработчикамТоварыХарактеристика");
	НоменклатураСервер.УстановитьУсловноеОформлениеХарактеристикНоменклатуры(ЭтотОбъект, "ПереданныеВПроизводствоТоварыХарактеристика");
	НоменклатураСервер.УстановитьУсловноеОформлениеХарактеристикНоменклатуры(ЭтаФорма, "ОтклоненияХарактеристика");
	...
	ПараметрыУсловногоОформления.ИмяПоляВводаНомераГТД = "ПереходПраваСобственностиНомерГТД";
	НоменклатураСервер.УстановитьУсловноеОформлениеНомераГТД(ЭтотОбъект, ПараметрыУсловногоОформления);
	...
	ПараметрыУсловногоОформления.ИмяПоляВводаКоличествоПоРНПТ = "ПереходПраваСобственностиКоличествоПоРНПТ";
	ПараметрыУсловногоОформления.ИмяПоляЕдиницаИзмеренияТНВЭД = "ПереходПраваСобственностиНоменклатураЕдиницаИзмеренияТНВЭД";
	...
	ПараметрыУсловногоОформления = НоменклатураСервер.НовыеПараметрыУсловногоОформленияЕдиницИзмерения(Истина, Истина);
	ПараметрыУсловногоОформления.ИмяПоляЕдиницаИзмерения = "ПереходПраваСобственностиНоменклатураЕдиницаИзмерения";
	НоменклатураСервер.УстановитьУсловноеОформлениеЕдиницИзмерения(ЭтотОбъект, ПараметрыУсловногоОформления);
	...
	КомпоновкаДанныхКлиентСервер.ДобавитьОформляемоеПоле(Элемент.Поля, Элементы.ПереходПраваСобственностиКонтрагент.Имя);
	...
	НоменклатураСервер.УстановитьУсловноеОформлениеСерийНоменклатуры(ЭтотОбъект, Ложь, "СобственныеТоварыСерия");	
	НоменклатураСервер.УстановитьУсловноеОформлениеСерийНоменклатуры(ЭтотОбъект, Ложь, "ПолученныеНаКомиссиюСерия");	
	НоменклатураСервер.УстановитьУсловноеОформлениеСерийНоменклатуры(ЭтотОбъект, Ложь, "ПолученныеНаХранениеСерия");
	НоменклатураСервер.УстановитьУсловноеОформлениеСерийНоменклатуры(ЭтотОбъект, Ложь, "ПереходПраваСобственностиСерия");
	...
	НоменклатураСервер.УстановитьУсловноеОформлениеСерийНоменклатуры(ЭтотОбъект, Ложь, "ПереходНаАдресноеХранениеТоварыСерия");	
	НоменклатураСервер.УстановитьУсловноеОформлениеСерийНоменклатуры(ЭтотОбъект, Ложь, "ПереданныеПереработчикамТоварыСерия");	
	НоменклатураСервер.УстановитьУсловноеОформлениеСерийНоменклатуры(ЭтотОбъект, Ложь, "ПереданныеВПроизводствоТоварыСерия");	
	
	//

	НоменклатураСервер.УстановитьУсловноеОформлениеСтатусовУказанияСерий(ЭтотОбъект, Ложь, "СобственныеТоварыСтатусУказанияСерий");
	НоменклатураСервер.УстановитьУсловноеОформлениеСтатусовУказанияСерий(ЭтотОбъект, Ложь, "ПолученныеНаКомиссиюСтатусУказанияСерий");
	...
	НоменклатураСервер.УстановитьУсловноеОформлениеСтатусовУказанияСерий(ЭтотОбъект, Ложь, "ПереходПраваСобственностиСтатусУказанияСерий");
	НоменклатураСервер.УстановитьУсловноеОформлениеСтатусовУказанияСерий(ЭтотОбъект, Ложь, "ПереходНаАдресноеХранениеТоварыСтатусУказанияСерий");
	НоменклатураСервер.УстановитьУсловноеОформлениеСтатусовУказанияСерий(ЭтотОбъект, Ложь, "ПереданныеПереработчикамТоварыСтатусУказанияСерий");
	НоменклатураСервер.УстановитьУсловноеОформлениеСтатусовУказанияСерий(ЭтотОбъект, Ложь, "ПереданныеВПроизводствоТоварыСтатусУказанияСерий");
	...
	КомпоновкаДанныхКлиентСервер.ДобавитьОформляемоеПоле(Элемент.Поля, Элементы.ПереходПраваСобственностиЦена.Имя);
	КомпоновкаДанныхКлиентСервер.ДобавитьОформляемоеПоле(Элемент.Поля, Элементы.ПереходПраваСобственностиСумма.Имя);
	КомпоновкаДанныхКлиентСервер.ДобавитьОформляемоеПоле(Элемент.Поля, Элементы.ПереходПраваСобственностиСуммаРегл.Имя);
	...
	НоменклатураСервер.УстановитьУсловноеОформлениеНазначенияНоменклатуры(ЭтотОбъект, "СобственныеТоварыНазначение");
	НоменклатураСервер.УстановитьУсловноеОформлениеНазначенияНоменклатуры(ЭтотОбъект, "ПринятаяТараНазначение");
	НоменклатураСервер.УстановитьУсловноеОформлениеНазначенияНоменклатуры(ЭтотОбъект, "ПереходНаАдресноеХранениеТоварыНазначение");
	НоменклатураСервер.УстановитьУсловноеОформлениеНазначенияНоменклатуры(ЭтотОбъект, "ПереданныеПереработчикамТоварыНазначение");
	НоменклатураСервер.УстановитьУсловноеОформлениеНазначенияНоменклатуры(ЭтотОбъект, "ПереданныеВПроизводствоТоварыНазначение");
...
Процедура ОрганизацияПриИзмененииСервер()
	...
	УчетПодакцизныхТоваров.ОбновитьЭлементыУчетаПодакцизныхТоваров(ЭтотОбъект);
...
Процедура ОткрытьПодборСерий(Текст = "", ТекущиеДанные = Неопределено)
	...
	Если НоменклатураКлиент.ДляУказанияСерийНуженСерверныйВызов(ЭтотОбъект,ПараметрыУказанияСерий,Текст,ТекущиеДанные) Тогда
		...
		ОткрытьФорму(ПараметрыФормыУказанияСерий.ИмяФормы,ПараметрыФормыУказанияСерий,ЭтотОбъект,,,, Новый ОписаниеОповещения("ОткрытьПодборСерийЗавершение", ЭтотОбъект, Новый Структура("ПараметрыФормыУказанияСерий", ПараметрыФормыУказанияСерий)), РежимОткрытияОкнаФормы.БлокироватьОкноВладельца);
	КонецЕсли;
...
Процедура ПолучитьСтрокиИзБуфераОбмена()
	...
	Для Каждого СтрокаТовара Из ТаблицаТоваров Цикл
		...
		ТекущаяСтрока.СтавкаНДС = СтавкаНДСНоменклатуры(ТекущаяСтрока.Номенклатура,
			Объект.Организация, Объект.НалогообложениеНДС, Объект.Дата, Объект.ХозяйственнаяОперация);
...
Процедура ПриЧтенииСозданииНаСервере(ДанныеОбъекта)
	...
	ЗапретитьПоступлениеТоваровБезНомеровГТД = ПолучитьФункциональнуюОпцию("ЗапретитьПоступлениеТоваровБезНомеровГТД")
		И (ДанныеОбъекта.ХозяйственнаяОперация = Перечисления.ХозяйственныеОперации.ВводОстатковСобственныхТоваров
			...
			ИЛИ ДанныеОбъекта.ХозяйственнаяОперация = Перечисления.ХозяйственныеОперации.ВводОстатковВозвратнойТарыПереданнойКлиентам
			...
			Или ДанныеОбъекта.ХозяйственнаяОперация = Перечисления.ХозяйственныеОперации.ВводОстатковОтгруженныхТоваров);
	...
	УчетПодакцизныхТоваров.ОбновитьЭлементыУчетаПодакцизныхТоваров(ЭтотОбъект, Объект.Ссылка.Пустая());
...
Процедура УстановитьВидимость()
	...
	ВидимостьРезервовПодОбесценениеЗапасов = ВидимостьРезервовПодОбесценениеЗапасов();
	...
	Элементы.ГруппаВводОстатковКПередачеПраваСобственности.Видимость = ВидимостьГруппУчета;
	...
	Элементы.ГруппаПереходПраваСобственности.Видимость = ЭтоОстаткиОтгруженныхТоваров;
	Если Элементы.ГруппаПереходПраваСобственности.Видимость Тогда
		ИмяТекущейТаблицыФормы = Элементы.ПереходПраваСобственности.Имя;
	КонецЕсли;
	...
	Элементы.ГруппаОтклонения.Видимость = ЭтоОстаткиОтклонений;
	Если Элементы.ГруппаОтклонения.Видимость Тогда
		ИмяТекущейТаблицыФормы = Элементы.Отклонения.Имя;
		Элементы.ОтклоненияПодразделение.Видимость = СтрНайти(ДетализироватьОтклонения, "ПоПодразделениям");
		Элементы.ОтклоненияНазначение.Видимость = СтрНайти(ДетализироватьОтклонения, "ПоНаправлениямДеятельности");
	КонецЕсли;
	...
	Элементы.ПереходПраваСобственностиСтатусУказанияСерий.Видимость = ПараметрыУказанияСерий.ИспользоватьСерииНоменклатуры;
	Элементы.ПереходПраваСобственностиСерия.Видимость = ПараметрыУказанияСерий.ИспользоватьСерииНоменклатуры;
	...
	Элементы.СобственныеТоварыРезервПодОбесценениеРегл.Видимость = ВидимостьРеквизитовРегл И ВидимостьРезервовПодОбесценениеЗапасов;
	Элементы.СобственныеТоварыРезервПодОбесценениеУпр.Видимость  = ВидимостьРеквизитовРегл 
		И УправленческийУчетОрганизаций И ВидимостьРезервовПодОбесценениеЗапасов;
	...
	Элементы.ПереходПраваСобственностиСуммаРегл.Видимость = ВидимостьРеквизитовРегл;
	Элементы.ПереходПраваСобственностиСуммаПР.Видимость   = ВидимостьРеквизитовРегл;
	Элементы.ПереходПраваСобственностиСуммаВР.Видимость   = ВидимостьРеквизитовРегл;
	...
	Элементы.ПереданныеНаКомиссиюРезервПодОбесценениеРегл.Видимость = ВидимостьРеквизитовРегл И ВидимостьРезервовПодОбесценениеЗапасов;
	Элементы.ПереданныеНаКомиссиюРезервПодОбесценениеУпр.Видимость  = ВидимостьРеквизитовРегл 
		И УправленческийУчетОрганизаций И ВидимостьРезервовПодОбесценениеЗапасов;
	...
	Элементы.ПереданныеНаКомиссию25РезервПодОбесценениеРегл.Видимость = ВидимостьРеквизитовРегл И ВидимостьРезервовПодОбесценениеЗапасов;
	Элементы.ПереданныеНаКомиссию25РезервПодОбесценениеУпр.Видимость  = ВидимостьРеквизитовРегл 
		И УправленческийУчетОрганизаций И ВидимостьРезервовПодОбесценениеЗапасов;
	...
	Элементы.ПереданныеНаХранениеРезервПодОбесценениеРегл.Видимость = ВидимостьРеквизитовРегл И ВидимостьРезервовПодОбесценениеЗапасов;
	Элементы.ПереданныеНаХранениеРезервПодОбесценениеУпр.Видимость  = ВидимостьРеквизитовРегл  
		И УправленческийУчетОрганизаций И ВидимостьРезервовПодОбесценениеЗапасов;
	...
	Элементы.ПереданныеПереработчикамТоварыРезервПодОбесценениеРегл.Видимость = ВидимостьРеквизитовРегл И ВидимостьРезервовПодОбесценениеЗапасов;
	Элементы.ПереданныеПереработчикамТоварыРезервПодОбесценениеУпр.Видимость  = ВидимостьРеквизитовРегл 
		И УправленческийУчетОрганизаций И ВидимостьРезервовПодОбесценениеЗапасов;
	...
	Элементы.СобственныеТоварыРезервПодОбесценениеРегл.Видимость = ВидимостьРеквизитовСумм И ВидимостьРезервовПодОбесценениеЗапасов;
	Элементы.СобственныеТоварыРезервПодОбесценениеУпр.Видимость  = ВидимостьРеквизитовСумм 
		И УправленческийУчетОрганизаций И ВидимостьРезервовПодОбесценениеЗапасов;
	...
	Элементы.ПереходПраваСобственностиЦена.Видимость          = ВидимостьРеквизитовСумм И ВидимостьРеквизитовУпр;
	Элементы.ПереходПраваСобственностиСумма.Видимость         = ВидимостьРеквизитовСумм И ВидимостьРеквизитовУпр;
	Элементы.ПереходПраваСобственностиСуммаБезНДС.Видимость   = ВидимостьРеквизитовСумм И ВидимостьРеквизитовУпр;
	Элементы.ПереходПраваСобственностиСуммаНДС.Видимость      = ВидимостьРеквизитовСумм И ВидимостьРеквизитовУпр;
	Элементы.ПереходПраваСобственностиСуммаСНДС.Видимость     = ВидимостьРеквизитовСумм;
	Элементы.ПереходПраваСобственностиСуммаРегл.Видимость     = ВидимостьРеквизитовСумм;
	Элементы.ПереходПраваСобственностиНДСРегл.Видимость       = ВидимостьРеквизитовСумм;
	Элементы.ПереходПраваСобственностиСуммаПР.Видимость       = ВидимостьРеквизитовСумм;
	Элементы.ПереходПраваСобственностиСуммаВР.Видимость       = ВидимостьРеквизитовСумм;
	Элементы.ПереходПраваСобственностиЦенаВключаетНДС.Видимость = ВидимостьРеквизитовСумм;
	...
	Элементы.ПереданныеНаКомиссиюРезервПодОбесценениеРегл.Видимость = ВидимостьРеквизитовСумм И ВидимостьРезервовПодОбесценениеЗапасов;
	Элементы.ПереданныеНаКомиссиюРезервПодОбесценениеУпр.Видимость  = ВидимостьРеквизитовСумм 
		И УправленческийУчетОрганизаций И ВидимостьРезервовПодОбесценениеЗапасов;
	...
	Элементы.ПереданныеНаХранениеРезервПодОбесценениеРегл.Видимость = ВидимостьРеквизитовСумм И ВидимостьРезервовПодОбесценениеЗапасов;
	Элементы.ПереданныеНаХранениеРезервПодОбесценениеУпр.Видимость  = ВидимостьРеквизитовСумм 
		И УправленческийУчетОрганизаций И ВидимостьРезервовПодОбесценениеЗапасов;
	...
	Элементы.ПереданныеНаКомиссию25РезервПодОбесценениеРегл.Видимость = ВидимостьРеквизитовСумм И ВидимостьРезервовПодОбесценениеЗапасов;
	Элементы.ПереданныеНаКомиссию25РезервПодОбесценениеУпр.Видимость  = ВидимостьРеквизитовСумм 
		И УправленческийУчетОрганизаций И ВидимостьРезервовПодОбесценениеЗапасов;
	...
	Элементы.ПереданныеПереработчикамТоварыРезервПодОбесценениеРегл.Видимость = ВидимостьРеквизитовСумм И ВидимостьРезервовПодОбесценениеЗапасов;
	Элементы.ПереданныеПереработчикамТоварыРезервПодОбесценениеУпр.Видимость  = ВидимостьРеквизитовСумм 
		И УправленческийУчетОрганизаций И ВидимостьРезервовПодОбесценениеЗапасов;
	...
	Элементы.ПереходПраваСобственностиПартия.Видимость = Истина;
	...
	Элементы.ПереходПраваСобственности.ПодчиненныеЭлементы.ПереходПраваСобственностиСуммаВР.Видимость = Не ЭтоМеждународнаяВерсия;
	...
	УстановитьВидимостьИтоговыхПоказателей();
...
&НаСервере
Процедура УстановитьВидимостьИтоговыхПоказателей()
	...
	ОтображатьИтогСуммыНДС =
		Не ЭтоОстаткиПринятыхНаХранениеТоваров
		И Не ЭтоОстаткиПринятойТары
		И Не ЭтоОстаткиПереданнойТары
		И УчетНДСУПКлиентСервер.ОтображатьНДСВИтогахДокументаПродажи(Объект.НалогообложениеНДС);
	
	ВалютаСтр = Строка(ВалютаУправленческогоУчета);
	ШаблонЗаголовка = "%1 (%2)";
	СтрокаЗаголовка = ?(
		ВидимостьРеквизитовСумм И ВидимостьРеквизитовУпр И ОтображатьИтогСуммыНДС,
		НСтр("ru = 'Всего с НДС'"),
		НСтр("ru = 'Всего'"));
	ЗаголовокСуммаВсего = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(ШаблонЗаголовка, СтрокаЗаголовка, ВалютаСтр);
	Элементы.ТоварыИтогСуммаСНДС.Заголовок = ЗаголовокСуммаВсего;
	
	Элементы.ТоварыИтогСуммаСНДС.Видимость = ВидимостьРеквизитовСумм И ВидимостьРеквизитовУпр
		И Не (ЭтоПереходНаАдресноеХранение Или ЭтоПереходНаСкладскиеПомещения);
	Элементы.ТоварыИтогСуммаНДС.Видимость  = ВидимостьРеквизитовСумм И ВидимостьРеквизитовУпр И ОтображатьИтогСуммыНДС
		И Не (ЭтоПереходНаАдресноеХранение Или ЭтоПереходНаСкладскиеПомещения);
	
	Элементы.ТоварыИтогСуммаРегл.Видимость = ВидимостьРеквизитовСумм
		И Не (ЭтоПереходНаАдресноеХранение Или ЭтоПереходНаСкладскиеПомещения);
	Элементы.ТоварыИтогНДСРегл.Видимость   = ВидимостьРеквизитовСумм И ОтображатьИтогСуммыНДС
		И Не (ЭтоПереходНаАдресноеХранение Или ЭтоПереходНаСкладскиеПомещения);
...
Процедура УстановитьСвойстваКомментарияИспользованияУстаревшейКомиссии()
	...
	Элементы.ГруппаКомментарийИспользованиеУстаревшейКомиссии.Видимость = ЭтоОстаткиПереданныхНаКомиссиюТоваров;
...
Процедура ДобавитьВСтруктуруДействияПриИзмененииКоличестваУпаковок(СтруктураДействий, Форма)
	...
	Если Форма.ЭтоОстаткиСобственныхТоваров
		...
		Или Форма.ЭтоОстаткиПереданныхВПроизводствоТоваров
		Или Форма.ЭтоОстаткиОтгруженныхТоваров Тогда
...
Процедура ЗаполнитьОстаткамиТоваровНаПустомПомещенииСервер()
	...
	ПересчитатьКоличествоПоРНПТ = ЭтоОстаткиСобственныхТоваров
		...
		Или ЭтоОстаткиПереданнойТары
		Или ЭтоОстаткиПереданныхПереработчикамТоваров2_5
		Или ЭтоОстаткиОтгруженныхТоваров;
...
Процедура ЗаполнитьНалогообложениеНДС()
	...
	ИначеЕсли Объект.ХозяйственнаяОперация = Перечисления.ХозяйственныеОперации.ВводОстатковТоваровПереданныхНаКомиссию2_5
		Или Объект.ХозяйственнаяОперация = Перечисления.ХозяйственныеОперации.ВводОстатковТоваровПереданныхНаКомиссию Тогда
		Объект.НалогообложениеНДС = УчетНДСУП.ПараметрыУчетаПоОрганизации(Объект.Организация, Объект.Дата).ОсновноеНалогообложениеНДСПродажи;
	...
	Если Объект.ХозяйственнаяОперация = Перечисления.ХозяйственныеОперации.ВводОстатковТоваровПереданныхНаКомиссию
		...
		Или Объект.ХозяйственнаяОперация = Перечисления.ХозяйственныеОперации.ВводОстатковОтгруженныхТоваров Тогда
		...
		Элементы.ПереходПраваСобственностиСтавкаНДС.СвязиПараметровВыбора = Новый ФиксированныйМассив(МассивПараметров);
		Элементы.ПереходПраваСобственностиСтавкаНДС.ПараметрыВыбора = Новый ФиксированныйМассив(МассивПараметровВыбора);
		
	КонецЕсли;
		
	Если ЗначениеЗаполнено(Объект.НалогообложениеНДС) И ЭтоОстаткиПереданныхНаХранениеТоваров Тогда
		
		ЭлементВидДеятельностиНДС = Элементы.ПереданныеНаХранениеНалогообложениеНДС;
		ДополнитьСписокВыбораНалогообложенияНДС(Объект.НалогообложениеНДС, ЭлементВидДеятельностиНДС);
...
&НаСервереБезКонтекста
Процедура ДополнитьСписокВыбораНалогообложенияНДС(НалогообложениеНДС, ЭлементВидДеятельностиНДС)
	
	ВыбранноеЗначение = ЭлементВидДеятельностиНДС.СписокВыбора.НайтиПоЗначению(НалогообложениеНДС);
	Если ВыбранноеЗначение = Неопределено Тогда
		Представления = УчетНДСУПСлужебный.ПрименяемыеВидыДеятельностиНДС();
		ЭлементПредставления = Представления.НайтиПоЗначению(НалогообложениеНДС);
		Если ЭлементПредставления <> Неопределено Тогда
			ЭлементВидДеятельностиНДС.СписокВыбора.Добавить(НалогообложениеНДС, ЭлементПредставления.Представление);
		Иначе
			ЭлементВидДеятельностиНДС.СписокВыбора.Добавить(НалогообложениеНДС);
		КонецЕсли;
	КонецЕсли;
...
Процедура НалогообложениеНДСПриИзмененииСервер()
	...
	СтруктураДействий = Новый Структура;
	СтруктураДействий.Вставить("СкорректироватьСтавкуНДС",  ПакетнаяОбработкаТабличнойЧастиКлиентСервер.ПараметрыЗаполненияСтавкиНДС(Объект));
	ПакетнаяОбработкаТабличнойЧастиСервер.ОбработатьТЧ(Объект.ДетализацияПартий, СтруктураДействий, КэшированныеЗначенияСлужебный);
...
Процедура РазбитьСтрокуЗавершение(НоваяСтрока, ДополнительныеПараметры) Экспорт
	...
	Если НоваяСтрока <> Неопределено Тогда
		...
		Если ЭтоОстаткиОтгруженныхТоваров Тогда
...
Процедура УстановитьВидимостьКоличестваРНПТ()
	...
	ИначеЕсли ЭтоОстаткиОтгруженныхТоваров Тогда
		
		УчетПрослеживаемыхТоваровЛокализация.УстановитьВидимостьКоличестваРНПТ(ЭтотОбъект,
			Объект.Дата,
			"ПереходПраваСобственностиГруппаКоличествоПоРНПТ");
...
Процедура ПолучитьМетодОценкиСтоимостиТоваров()
	...
	Если ПараметрыУчетнойПолитики <> Неопределено Тогда
		...
		Если МетодОценкиСтоимости = Перечисления.МетодыОценкиСтоимостиТоваров.Среднескользящая Тогда
			ПоляДетализацииОтклонений = "ПоНаправлениямДеятельности,ПоПодразделениям,ПоСкладам";
			МассивДетализацииОтклонений = Новый Массив;
			Для каждого ПолеДетализации Из СтрРазделить(ПоляДетализацииОтклонений, ",") Цикл
				Если ПараметрыУчетнойПолитики["ДетализироватьОтклонения" + ПолеДетализации] Тогда
					МассивДетализацииОтклонений.Добавить(ПолеДетализации);
				КонецЕсли;
			КонецЦикла;
			ДетализироватьОтклонения = СтрСоединить(МассивДетализацииОтклонений, ",");
		КонецЕсли;
	КонецЕсли;
...
Процедура УказатьДокументыПоступления(Команда)
	...
	ИначеЕсли Объект.ХозяйственнаяОперация = ПредопределенноеЗначение("Перечисление.ХозяйственныеОперации.ВводОстатковОтгруженныхТоваров") Тогда
		ТекущаяСтрока = Элементы.ПереходПраваСобственности.ТекущаяСтрока;
...
Процедура ОткрытьФормаДетализацияПартий(Строка)
	...
	ОткрытьФорму("Документ.ВводОстатковТоваров.Форма.ФормаДетализацияПартий", ПараметрыФормы, ЭтотОбъект, ,  , , ОписаниеОповещения);
...
Процедура УстановитьУсловноеОформлениеПартияВШапке()
	...
	ПолеЭлемента = ЭлементУсловногоОформления.Поля.Элементы.Добавить();
	ПолеЭлемента.Поле = Новый ПолеКомпоновкиДанных(Элементы.ПереходПраваСобственностиПартия.Имя);
...
Процедура УстановитьПризнакПартияОбязательнаКЗаполнению()
	...
	Иначе
		...
		Если ХозяйственнаяОперация <> Перечисления.ХозяйственныеОперации.ВводОстатковОтгруженныхТоваров Тогда
			ПартияОбязательнаКЗаполнению = Ложь;
		КонецЕсли;
...
Процедура УстановитьУсловноеОформлениеДоговорВШапке()
	...
	ПолеЭлемента = ЭлементУсловногоОформления.Поля.Элементы.Добавить();
	ПолеЭлемента.Поле = Новый ПолеКомпоновкиДанных(Элементы.ПереходПраваСобственностиДоговор.Имя);
...
&НаСервереБезКонтекста
Функция ВидимостьРезервовПодОбесценениеЗапасов()
	
	ВидимостьРезервовПодОбесценениеЗапасов = Ложь;
	
	Возврат ВидимостьРезервовПодОбесценениеЗапасов;
КонецФункции
