...
// 
// Параметры:
//  Объект - ДокументОбъект.АктПримененияСАТУРН - Объект в котором происходит заполнение
...
Функция АктПримененияJSON(ДокументСсылка, ДополнительныеПараметры = Неопределено)
	...
	ИнтерфейсСАТУРН.ДобавитьАргументШапки(АргументыОперации, "docDate",     ЗаписатьДатуJSON(Шапка.ДатаПрименения, ФорматДатыJSON.ISO, ВариантЗаписиДатыJSON.УниверсальнаяДата));
