...
Процедура ЗаполнитьПоСтатистикеПродажЗавершение(Настройки, ДополнительныеПараметры) Экспорт
	...
	Если Настройки <> Неопределено Тогда
		...
		ОповещениеОЗавершении = Новый ОписаниеОповещения("ЗаполнитьПоСтатистикеПродажОповещение", ЭтотОбъект);
...
&НаКлиенте
Процедура ЗаполнитьПоСтатистикеПродажОповещение(Результат, ДополнительныеПараметры) Экспорт
	...
	Если Результат.Статус = "Выполнено" Тогда
		ПолучитьРезультатЗаполненияНаСервере(Результат.АдресРезультата);
	КонецЕсли;
...
Функция ЗаполнитьПоСтатистикеПродажНаСервере(ПараметрыЗадания)
	...
	ПараметрыВыполнения.НаименованиеФоновогоЗадания =
		НСтр("ru = 'Заполнение нормативов распределения по статистике продаж'");
...
&НаСервере
Процедура ПолучитьРезультатЗаполненияНаСервере(АдресХранилища)
