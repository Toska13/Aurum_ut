...
Процедура УстановитьПараметрыЗагрузкиИзФайлаВТЧ(Параметры) Экспорт
	...
	Если ТипЗнч(Параметры.ДополнительныеПараметры.Реквизит) = Тип("Строка") Тогда
		...
		МДОбъекта = Метаданные.НайтиПоПолномуИмени(СтруктураРеквизита.ИмяТаблицы);
		
		ДлинаНаименования = МДОбъекта.ДлинаНаименования;
	Иначе
		
		ОписаниеТипаЗначение = ОбщегоНазначения.ЗначениеРеквизитаОбъекта(Параметры.ДополнительныеПараметры.Реквизит, "ТипЗначения");
		МДОбъекта = Метаданные.НайтиПоТипу(ОписаниеТипаЗначение.Типы()[0]);
		
		ДлинаНаименования = МДОбъекта.ДлинаНаименования;
	КонецЕсли;
	
	Параметры.ТипДанныхКолонки.Вставить("Значение", Новый ОписаниеТипов("Строка",, Новый КвалификаторыСтроки(ДлинаНаименования)));
