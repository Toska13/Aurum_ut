...
Функция ТекстЗапросаТаблицаПланыОплатПоставщикам(Запрос, ТекстыЗапроса, Регистры)
	...
	|	ВЫБОР
	|		КОГДА ТаблицаДокумента.ВариантОплаты = ЗНАЧЕНИЕ(Перечисление.ВариантыКонтроляОплатыПоставщику.АвансДоПодтверждения)
	|			ИЛИ ТаблицаДокумента.ВариантОплаты = ЗНАЧЕНИЕ(Перечисление.ВариантыКонтроляОплатыПоставщику.ПредоплатаДоПоступления)
	|			ТОГДА ТаблицаДокумента.СуммаПлатежа
	|		ИНАЧЕ 0
	|	КОНЕЦ КАК СуммаПредоплаты,
	|	ВЫБОР
	|		КОГДА ТаблицаДокумента.ВариантОплаты = ЗНАЧЕНИЕ(Перечисление.ВариантыКонтроляОплатыПоставщику.КредитПослеПоступления)
	|			ИЛИ ТаблицаДокумента.ВариантОплаты = ЗНАЧЕНИЕ(Перечисление.ВариантыКонтроляОплатыПоставщику.КредитСдвиг)
	|			ТОГДА ТаблицаДокумента.СуммаПлатежа
	|		ИНАЧЕ 0
...
Функция ЗапросЗамещенныеИЗамещающиеПланы(Параметры) Экспорт
	...
	|	И ПланЗакупокЗамещающий.Организация = &Организация
	...
	|	И ПланЗакупокЗамещенный.Организация = &Организация
...
Функция ЗапросЗамещения(Параметры) Экспорт
	...
	Запрос.Текст =
		...
		|	ПланыЗакупокОбороты.Организация,
