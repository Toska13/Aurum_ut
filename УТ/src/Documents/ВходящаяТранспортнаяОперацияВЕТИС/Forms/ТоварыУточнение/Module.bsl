...
#Область ОбработчикиСобытийЭлементовТаблицыФормыТоварыУточнение
...
Процедура ТоварыНоменклатураСоздание(Элемент, СтандартнаяОбработка)
	...
	СобытияФормВЕТИСКлиент.ПриСозданииНоменклатуры(Элемент, ЭтотОбъект, СтандартнаяОбработка);
...
Процедура ТоварыХарактеристикаСоздание(Элемент, СтандартнаяОбработка)
	...
	СобытияФормИСКлиентПереопределяемый.ПриСозданииХарактеристики(ЭтотОбъект, Элементы.ТоварыУточнение.ТекущиеДанные, Элемент, СтандартнаяОбработка);
