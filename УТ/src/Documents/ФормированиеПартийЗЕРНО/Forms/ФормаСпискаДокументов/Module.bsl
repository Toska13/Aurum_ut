...
Функция ВозможностьВводаФормированияПартии(Знач ВыделенныеСтроки)
	...
	РеквизитыИсследований = ТоваропроизводительДокументов(ВыделенныеСтроки);
...
&НаСервереБезКонтекста
Функция ТоваропроизводительДокументов(СсылкиНаДокументы)
	Возврат ОбщегоНазначения.ЗначенияРеквизитовОбъектов(СсылкиНаДокументы, "Товаропроизводитель");
КонецФункции
