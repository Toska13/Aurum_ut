...
Функция ПолучитьТекстЗапроса(ИмяДокумента)
	...
	Текст =
		...
		|	ДокументЗапросКоммерческихПредложенийПоставщиков.Наименование КАК Наименование,
		|	ВЫБОР
		...
		|	ДокументЗапросКоммерческихПредложенийПоставщиков.УчетнаяЗапись КАК УчетнаяЗапись,
