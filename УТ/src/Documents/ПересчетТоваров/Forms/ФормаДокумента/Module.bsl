...
Процедура СкладПриИзменении(Элемент)
	...
	СкладПомещениеПриИзмененииСервер(Истина);
	Объект.УчетныеДанныеЗаполнены = Ложь;
...
Процедура УстановитьУсловноеОформление()
	...
	ПолеЭлемента = Элемент.Поля.Элементы.Добавить();
	ПолеЭлемента.Поле = Новый ПолеКомпоновкиДанных(Элементы.ТоварыКонтролируемаяПартия.Имя);
	...
	ОтборЭлемента = ГруппаИли.Элементы.Добавить(Тип("ЭлементОтбораКомпоновкиДанных"));
	ОтборЭлемента.ЛевоеЗначение = Новый ПолеКомпоновкиДанных("Объект.Товары.ТоварыКоличествоУпаковокОтклонение");
	ОтборЭлемента.ВидСравнения = ВидСравненияКомпоновкиДанных.Больше;
	ОтборЭлемента.ПравоеЗначение = Ложь;
	
	Элемент.Оформление.УстановитьЗначениеПараметра("ТолькоПросмотр", Истина);
	Элемент.Оформление.УстановитьЗначениеПараметра("Текст", НСтр("ru = '<только для излишков партий, подлежащих разблокировке>'"));
	Элемент.Оформление.УстановитьЗначениеПараметра("ОтметкаНезаполненного", Ложь);
	Элемент.Оформление.УстановитьЗначениеПараметра("ЦветТекста", ЦветаСтиля.ЦветТекстаОтмененнойСтрокиДокумента);
...
&НаСервере
Процедура СкладПомещениеПриИзмененииСервер(НепосредственноеИзменениеПоляСклад = Ложь)
...
Процедура ОбработатьШтрихкоды(ДанныеШтрихкодов)
	...
	СтруктураДействий.ИзменятьКоличество                     = Не (СостояниеРедактирования = "НеРедактируется");
...
Процедура НастроитьПоСкладуПомещению()
	...
	Элементы.ТоварыКонтролируемаяПартия.Видимость           = Не ИспользоватьАдресноеХранение;
