...
Процедура РазделУчетаПриИзменении(Элемент)
	...
	ИнтеграцияЗЕРНОКлиентСервер.УстановитьПараметрыВыбораНоменклатуры(
		ЭтотОбъект, Объект.РазделУчета, "ОстаткиПоДаннымЗЕРНОНоменклатура");
...
Процедура СопоставитьНоменклатуру(Команда)
	...
	ИнтеграцияИСКлиент.ОткрытьФормуУказанияНоменклатуры(
		ЭтотОбъект, ОповещениеОЗавершении, ИнтеграцияЗЕРНОКлиентСервер.ВидыПродукции(Объект.РазделУчета));
...
Процедура ПриСозданииЧтенииНаСервере()
	...
	ИнтеграцияЗЕРНОКлиентСервер.УстановитьПараметрыВыбораНоменклатуры(ЭтотОбъект, Объект.РазделУчета, "ОстаткиПоДаннымЗЕРНОНоменклатура");
...
Процедура НастроитьЗависимыеЭлементыФормы(Форма, СписокРеквизитов = "")
	...
	Если СтруктураРеквизитов.Свойство("Операция")
		Или СтруктураРеквизитов.Свойство("РазделУчета")
