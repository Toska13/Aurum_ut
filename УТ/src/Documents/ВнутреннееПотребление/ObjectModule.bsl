...
Функция ВременныеТаблицыДанныхДокумента() Экспорт
	...
	|	&НалогообложениеНДС КАК ПотреблениеДляДеятельности,
	...
	|	ТаблицаТоваров.ФизическоеЛицо КАК ФизическоеЛицо,
	...
	|	ТаблицаВидыЗапасов.ФизическоеЛицо КАК ФизическоеЛицо,
...
Процедура ПередЗаписью(Отказ, РежимЗаписи, РежимПроведения)
	...
	Для Каждого ДанныеСтроки Из Товары Цикл
		...
		Если НЕ НаправлениеДеятельностиРасходовУказаноВСписке Тогда
			ДанныеСтроки.НаправлениеДеятельности = НаправлениеДеятельности;
		КонецЕсли;
...
Процедура ЗаполнитьПоЗаказу(СтруктураЗаполнения)
	...
	Документы.ВнутреннееПотребление.ЗаполнитьПоЗаказамОрдерам(ТаблицаНакладная, Ссылка, ПараметрыЗаполнения, ШтрихкодыУпаковок);
...
Процедура ЗаполнитьВидыЗапасов(Отказ)
	...
	Если Не Проведен
		...
		ВидыЗапасов.Свернуть("АналитикаУчетаНоменклатуры, ВидЗапасов, НомерГТД, Серия", ИменаКолонокСуммирования);
...
Функция ПроверитьИзменениеРеквизитовДокумента(МенеджерВременныхТаблиц)
	...
	ИменаРеквизитов = "Дата, Организация, Склад, ПотреблениеДляДеятельности";
...
Процедура ЗаполнитьСтатьюРасходовВидовЗапасов()
	...
	Для Каждого СтрокаТоваров Из Товары Цикл
		...
		Для Каждого СтрокаЗапасов Из ВидыЗапасов.НайтиСтроки(СтруктураПоиска) Цикл
			...
			НоваяСтрока.НаправлениеДеятельности     = СтрокаТоваров.НаправлениеДеятельности;
