...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Элементы.НомерКорректировки.Видимость = Объект.Исправление;
	Если Объект.Исправление Тогда
		Элементы.ЗаполнитьПоОснованию.Заголовок = НСтр("ru='заполнить по первичному уведомлению'");;
	КонецЕсли;
...
Процедура ЗаполнениеТЧТоварыНаСервере()
	...
	Если Объект.Исправление Тогда
		Объект.Товары.Загрузить(Документы.УведомлениеОВвозеПрослеживаемыхТоваров.ДанныеТЧТоварыПоЗаявлению(
			Объект.ПервичныйДокумент,
			Объект.ИсправляемыйДокумент,
			Объект.КодТНВЭД,
