...
Функция ПараметрыУказанияСерий(Объект) Экспорт
	...
	#Иначе
		Отбор = МобильноеРабочееМестоКладовщика.НоменклатураКлиентСерверПараметрыУказанияСерий();
	...
	#Если Не МобильныйАвтономныйСервер Тогда
		...
		ПараметрыСерийСклада = СкладыСервер.ИспользованиеСерийНаСкладе(Объект.Склад, Ложь);
	#Иначе
		Размещение = МобильноеРабочееМестоКладовщика.НоменклатураКлиентСерверПараметрыУказанияСерий();
