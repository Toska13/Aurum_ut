...
// 
// Параметры:
//  ОбъектИлиСсылка - ДокументОбъект.ПоступлениеТоваровНаСклад, ДокументСсылка.ПоступлениеТоваровНаСклад - документ.
...
Функция РеквизитыКонтролируемойПартии(ОбъектИлиСсылка, ИмяПоляКонтролируемаяПартия) Экспорт
	...
	Реквизиты.ДатаПоступления = РеквизитыОбъекта.Дата;
...
// 
// Параметры:
// Объект - ДокументОбъект.ПоступлениеТоваровНаСклад - объект.
// 
// Возвращаемое значение:
...
Процедура ЗаполнитьПараметрыИнициализации(Запрос, ДокументСсылка)
	...
	Запрос.УстановитьПараметр("КонтролируемаяПартия", 				Реквизиты.КонтролируемаяПартия);
