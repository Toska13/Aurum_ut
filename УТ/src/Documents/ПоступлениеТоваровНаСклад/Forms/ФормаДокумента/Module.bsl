...
Процедура ДоговорПриИзменении(Элемент)
	...
	ПриИзмененииДоговораСервер(Истина, Истина);
...
&НаСервере
Процедура ПриИзмененииДоговораСервер(ОчищатьРаспоряжение, НепосредственноеИзменениеПоляДоговор = Ложь)
...
Процедура ПоказатьПредставлениеРаспоряжения()
	...
	Если ЗначениеЗаполнено(Объект.Распоряжение) Тогда
		Если ТолькоПросмотр Тогда
			РаспоряжениеПредставление = СтроковыеФункции.ФорматированнаяСтрока("<a href='ОткрытьРаспоряжение'>%1</a>", Строка(Объект.Распоряжение));
		Иначе
			РаспоряжениеПредставление = СтроковыеФункции.ФорматированнаяСтрока("<a href='ОткрытьРаспоряжение'>%1</a>  <a href='ВыбратьРаспоряжение'>%2</a>",
				Строка(Объект.Распоряжение), НСтр("ru = 'Изменить'"));
		КонецЕсли;
	Иначе
		Если ТолькоПросмотр Тогда
			РаспоряжениеПредставление = СтроковыеФункции.ФорматированнаяСтрока("‹%1›", НСтр("ru = 'не выбрано'"));
		Иначе
			РаспоряжениеПредставление = СтроковыеФункции.ФорматированнаяСтрока("‹%1›  <a href='ВыбратьРаспоряжение'>%2</a>",
				НСтр("ru = 'не выбрано'"), НСтр("ru = 'Выбрать'"));
		КонецЕсли;
	КонецЕсли;
...
Процедура УстановитьВидимость()
	...
	Элементы.ГруппаВалюта.Видимость                 = Не ОперацияБезЦен;
