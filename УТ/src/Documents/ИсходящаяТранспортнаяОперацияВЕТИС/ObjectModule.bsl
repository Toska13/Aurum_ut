...
Процедура ОбработкаЗаполнения(ДанныеЗаполнения, ТекстЗаполнения, СтандартнаяОбработка)
	...
	Если Не ЗначениеЗаполнено(ГрузоотправительХозяйствующийСубъект) Тогда
		...
		Если ЗначениеЗаполнено(ЗначенияПоУмолчанию.ХозяйствующийСубъектВЕТИС) Тогда
			ГрузоотправительХозяйствующийСубъект = ЗначенияПоУмолчанию.ХозяйствующийСубъектВЕТИС;
			ГрузоотправительПредприятие          = ЗначенияПоУмолчанию.ПредприятиеВЕТИС;
		КонецЕсли;
