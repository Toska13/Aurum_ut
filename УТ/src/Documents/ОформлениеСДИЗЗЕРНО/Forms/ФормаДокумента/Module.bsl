...
Процедура РазделУчетаПриИзменении(Элемент)
	ОбновитьДанные(
		Объект.РазделУчета,
		Новый Структура("ИмяПоля, ИдентификаторСтроки", "РазделУчета", Неопределено));
КонецПроцедуры

&НаКлиенте
Процедура РазделУчетаОбработкаВыбора(Элемент, ВыбранноеЗначение, СтандартнаяОбработка)
	
	Если Объект.Товары.Количество() > 0 И ВыбранноеЗначение <> Объект.РазделУчета Тогда
		
		СтандартнаяОбработка = Ложь;
		ТекстВопроса = НСтр("ru = 'При изменении раздела учета табличная часть Товары будет очищена. Продолжить?'");
		ОписаниеОповещения = Новый ОписаниеОповещения("ВопросПриИзмененииРазделаУчетаПриЗавершении", ЭтотОбъект, ВыбранноеЗначение);
...
Процедура ПунктНазначенияНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	...
	Если Элемент.ТекстРедактирования <> Объект.ПунктНазначенияСтрокой Тогда
...
Процедура ПунктНазначенияОбработкаВыбора(Элемент, ВыбранноеЗначение, СтандартнаяОбработка)
	...
	Если ВыбранноеЗначение.Свойство("Действие") Тогда
		Если ВыбранноеЗначение.Действие = "ОткрытьФорму" Тогда
			...
			ОписаниеОповещения = Новый ОписаниеОповещения("ПунктНазначенияОкончаниеВыбора", ЭтотОбъект);
			СобытияФормИСКлиентПереопределяемый.ПолеСоставногоТипаОткрытьФормуВыбора(
				ЭтотОбъект, Элемент, ВыбранноеЗначение, ОткрытьСтандартнуюФормуВыбора, ПараметрыОткрытияФормы, ОписаниеОповещения);
	...
	Иначе
		...
		ИначеЕсли ВыбранноеЗначение.Свойство("ПредставлениеАдреса") Тогда
			Объект.ПунктНазначения = ОбщегоНазначенияИСВызовСервера.ЗначенияПолейКонтактнойИнформации(
...
Процедура ПунктНазначенияАвтоПодбор(Элемент, Текст, ДанныеВыбора, ПараметрыПолученияДанных, Ожидание, СтандартнаяОбработка)
	...
	Если ЗначениеЗаполнено(Объект.ЭлеваторПолучатель) 
		И Объект.РазделУчета = ПредопределенноеЗначение("Перечисление.РазделыУчетаЗЕРНО.Зерно") Тогда
...
Процедура МестоХраненияПриПеремещенииСтрокойПриИзменении(Элемент)
	...
	Объект.МестоХраненияПриПеремещении = ОбщегоНазначенияИСВызовСервера.ЗначенияПолейКонтактнойИнформации(
...
Процедура МестоХраненияПриПеремещенииСтрокойНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	...
	Если Элемент.ТекстРедактирования <> Объект.МестоХраненияПриПеремещенииСтрокой Тогда
...
&НаКлиенте
Процедура РеализацияПокупательСтрокойПриИзменении(Элемент)
	ПолеСоставногоТипаПриИзменении(Элемент);
КонецПроцедуры

&НаКлиенте
Процедура РеализацияПокупательСтрокойОткрытие(Элемент, СтандартнаяОбработка)
	ПолеСоставногоТипаОткрытие(Элемент, СтандартнаяОбработка);
КонецПроцедуры

&НаКлиенте
Процедура РеализацияПокупательСтрокойОбработкаВыбора(Элемент, ВыбранноеЗначение, СтандартнаяОбработка)
	ПолеСоставногоТипаОбработкаВыбора(Элемент, ВыбранноеЗначение, СтандартнаяОбработка);
КонецПроцедуры

&НаКлиенте
Процедура РеализацияПокупательСтрокойАвтоПодбор(Элемент, Текст, ДанныеВыбора, ПараметрыПолученияДанных, Ожидание, СтандартнаяОбработка)
	ПолеСоставногоТипаАвтоПодбор(Элемент, Текст, ДанныеВыбора, ПараметрыПолученияДанных, Ожидание, СтандартнаяОбработка);
КонецПроцедуры

&НаКлиенте
Процедура РеализацияПокупательСтрокойНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	ПолеСоставногоТипаАвтоПодбор(Элемент, Элемент.ТекстРедактирования, ДанныеВыбора, Неопределено, 0, СтандартнаяОбработка);
КонецПроцедуры
...
Процедура ТоварыНоменклатураНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	...
	СобытияФормЗЕРНОКлиент.ПриНачалеВыбораНоменклатуры(Элемент, Объект.РазделУчета, СтандартнаяОбработка);
...
Процедура ТоварыОКПД2ОкончаниеВводаТекста(Элемент, Текст, ДанныеВыбора, ПараметрыПолученияДанных, СтандартнаяОбработка)
	...
	СобытияФормЗерноКлиент.ОКПД2ОкончаниеВводаТекста(Элемент, Текст, ДанныеВыбора, ПараметрыПолученияДанных, СтандартнаяОбработка, Объект.РазделУчета);
...
Процедура ТоварыОКПД2АвтоПодбор(Элемент, Текст, ДанныеВыбора, ПараметрыПолученияДанных, Ожидание, СтандартнаяОбработка)
	...
	СобытияФормЗЕРНОКлиент.ОКПД2АвтоПодбор(Элемент, Текст, ДанныеВыбора, ПараметрыПолученияДанных, Ожидание, СтандартнаяОбработка, Объект.РазделУчета);
...
Процедура МаршрутВыбор(Элемент, ВыбраннаяСтрока, Поле, СтандартнаяОбработка)
	...
	СтруктураОтбора = ЗаполнитьПараметрыОтбораПеревозчикиИБ(ДанныеСтроки.Перевозчик, ДанныеСтроки.Подразделение, ПодразделенияИспользуются);
...
Процедура ПриСозданииЧтенииНаСервере()
	...
	ИнтеграцияЗЕРНОКлиентСервер.УстановитьПараметрыВыбораНоменклатуры(ЭтотОбъект, Объект.РазделУчета);
...
Процедура ЗаполнитьДоступныеОперации(Форма)
	...
	Если Объект.РазделУчета = ПредопределенноеЗначение("Перечисление.РазделыУчетаЗЕРНО.Зерно") Тогда
		Элементы.Операция.СписокВыбора.Добавить(
...
Процедура НастроитьЗависимыеЭлементыФормы(Форма, ИдентификаторСтроки = Неопределено, СписокРеквизитов = "")
	...
	Если СтруктураРеквизитов.Свойство("РазделУчета") Или Инициализация Тогда
	...
	Если СтруктураРеквизитов.Свойство("ФлагиОпераций") Или Инициализация Тогда
		...
		ЭтоЗерно = Объект.РазделУчета = ПредопределенноеЗначение("Перечисление.РазделыУчетаЗЕРНО.Зерно");
	...
	Если Инициализация Или СтруктураРеквизитов.Свойство("Подразделение") Тогда
		...
		Элементы.МаршрутПодразделение.Видимость = ПодразделенияИспользуются;
...
Процедура ОбновитьДанные(Результат, ДополнительныеПараметры) Экспорт
	...
	Если ИмяОбновляемогоПоля = "РазделУчета" Тогда
		...
		Если Объект.РазделУчета = ПредопределенноеЗначение("Перечисление.РазделыУчетаЗЕРНО.ПродуктыПереработкиЗерна")
...
&НаКлиенте
Процедура ВопросПриИзмененииРазделаУчетаПриЗавершении(РезультатВопроса, ДополнительныеПараметры) Экспорт
	
	Если РезультатВопроса = КодВозвратаДиалога.Да Тогда
		
		Объект.РазделУчета = ДополнительныеПараметры;
...
Процедура ВыборМаршрутаЗавершение(Результат, ДополнительныеПараметры) Экспорт
	...
	Иначе
		...
		Если ПодразделенияИспользуются
			И (ДополнительныеПараметры.КлючПеревозчика.Перевозчик <> Результат.Перевозчик
		...
		ИначеЕсли ДополнительныеПараметры.КлючПеревозчика.Перевозчик <> Результат.Перевозчик Тогда
			
			ОчиститьДанныеМаршрута(ДополнительныеПараметры.КлючПеревозчика.Перевозчик, "");
			
			СтрокаМаршрут.Перевозчик    = Перевозчик;
			СтрокаМаршрут.Подразделение = Неопределено;
...
Процедура УстановитьПредставлениеТранспортныхСредствПоСтроке(Форма, СтрокаМаршрут)
	...
	СтруктураПоиска = ЗаполнитьПараметрыОтбораПеревозчикиИБ(СтрокаМаршрут.Перевозчик, СтрокаМаршрут.Подразделение, Форма.ПодразделенияИспользуются);
...
Процедура ЗаполнитьОтборПартийПоШапкеДокумента(ПараметрыФормы)
	...
	ПараметрыФормы.РазделУчета = Объект.РазделУчета;
...
Процедура ОчиститьДанныеМаршрута(Перевозчик, Подразделение)
	...
	ПараметрыОтбора = ЗаполнитьПараметрыОтбораПеревозчикиИБ(Перевозчик, Подразделение, ПодразделенияИспользуются);
...
&НаКлиентеНаСервереБезКонтекста
Функция ЗаполнитьПараметрыОтбораПеревозчикиИБ(Перевозчик, Подразделение, ПодразделенияИспользуютя)
	
	ПараметрыОтбора = Новый Структура();
	ПараметрыОтбора.Вставить("Перевозчик", Перевозчик);
...
Функция КэшПеревозчикиИБ(Перевозчики, ДанныеСтроки = Неопределено)
	...
	Для Каждого КлючИЗначение Из Перевозчики Цикл
		...
		Иначе
			...
			СтрокаДанных.Вставить("Подразделение", Неопределено);
			Если ДанныеСтроки <> Неопределено
				И КлючИЗначение.Ключ = ДанныеСтроки.Перевозчик Тогда
				СтрокаДанных.Вставить("ТекущаяСтрока", Истина);
			Иначе
				СтрокаДанных.Вставить("ТекущаяСтрока", Ложь);
			КонецЕсли;
