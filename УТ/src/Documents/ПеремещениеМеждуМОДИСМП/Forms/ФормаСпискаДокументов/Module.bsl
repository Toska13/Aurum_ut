...
Процедура СписокПриПолученииДанныхНаСервере(ИмяЭлемента, Настройки, Строки)
	...
	ТоварныеГруппы = Документы.ПеремещениеМеждуМОДИСМП.ТоварнаяГруппаПоУмолчанию(Истина);
	ПредставлениеВидаПродукцииПиво = СтрСоединить(ТоварныеГруппы, ", ");
	...
	Для Каждого СтрокаСписка Из Строки Цикл
		...
		ОформлениеСтроки["ТоварнаяГруппа"].УстановитьЗначениеПараметра("Текст", ПредставлениеВидаПродукцииПиво);
