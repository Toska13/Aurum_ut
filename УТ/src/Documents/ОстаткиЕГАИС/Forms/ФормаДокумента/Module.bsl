...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	СобытияФормИСКлиентСерверПереопределяемый.УстановитьПараметрыВыбораНоменклатуры(
		ЭтотОбъект, КонструкторИСОбщегоНазначенияКлиентСервер.ВидыПродукцииЕГАИС(), "ОстаткиПоДаннымЕГАИСНоменклатура");
...
Процедура ПослеЗаписиНаСервере(ТекущийОбъект, ПараметрыЗаписи)
	...
	ИнтеграцияИС.ЗаполнитьСлужебныеРеквизитыВКоллекции(ЭтотОбъект, Объект.ОстаткиПоДаннымЕГАИС);
...
Процедура ОстаткиПоДаннымЕГАИСНоменклатураСоздание(Элемент, СтандартнаяОбработка)
	...
	СобытияФормЕГАИСКлиент.ПриСозданииНоменклатуры(Элемент, Элементы.ОстаткиПоДаннымЕГАИС.ТекущиеДанные, СтандартнаяОбработка);
...
Процедура ОстаткиПоДаннымЕГАИСХарактеристикаСоздание(Элемент, СтандартнаяОбработка)
	...
	СобытияФормИСКлиентПереопределяемый.ПриСозданииХарактеристики(ЭтотОбъект, Элементы.ОстаткиПоДаннымЕГАИС.ТекущиеДанные, Элемент, СтандартнаяОбработка);
...
Процедура КорректировкаОстатковАлкогольнаяПродукцияПриИзмененииНаСервере(Идентификатор)
	...
	ИнтеграцияЕГАИСКлиентСервер.ОкруглитьКоличествоДляУпакованнойПродукции(ТекущиеДанные,
