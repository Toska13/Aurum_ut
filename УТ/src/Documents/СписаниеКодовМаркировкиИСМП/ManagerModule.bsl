...
//  Массив Из ПеречислениеСсылка.СтатусыОбработкиСписанияКодовМаркировкиИСМП - Конечные статусы.
...
//
// Возвращаемое значение:
//  Массив Из ПеречислениеСсылка.СтатусыОбработкиСписанияКодовМаркировкиИСМП - Статусы ошибок.
//
...
Функция СтатусПослеПодготовкиКПередачеДанных(ДокументСсылка, Операция, ДополнительныеПараметры = Неопределено) Экспорт
	...
	Если СписаниеКодовМаркировкиКлиентСервер.ЭтоСписаниеКодовМаркировки(Операция) Тогда
...
Функция СтатусПослеПередачиДанных(ДокументСсылка, Операция, СтатусОбработки) Экспорт
	...
	Если СписаниеКодовМаркировкиКлиентСервер.ЭтоСписаниеКодовМаркировки(Операция)
...
Функция ПоследовательностьОпераций(ДокументСсылка, ЛинейныйСписок = Ложь) Экспорт
	...
	ПротоколОбменаИС.ДобавитьОперациюВПоследовательность(Таблица, 1,
		Исходящий,
		Перечисления.ВидыОперацийИСМП.СписаниеЧерезГИСМТ);
	...
	ПротоколОбменаИС.ДобавитьОперациюВПоследовательность(Таблица, 1,
		Исходящий,
		Перечисления.ВидыОперацийИСМП.УдалитьСписаниеКодовВыбывшихДоОбязательностиМаркировки);
		
	ПротоколОбменаИС.ДобавитьОперациюВПоследовательность(Таблица, 1,
		Исходящий,
		Перечисления.ВидыОперацийИСМП.СписаниеЧерезГИСМТОбщийДокумент);
	...
	ПротоколОбменаИС.ДобавитьОперациюВПоследовательность(Таблица, 11,
		Исходящий,
		Перечисления.ВидыОперацийИСМП.УдалитьСписаниеЭмитированныхКодовМаркировкиПриПоступлении);
		
	ПротоколОбменаИС.ДобавитьОперациюВПоследовательность(Таблица, 11,
		Исходящий,
		Перечисления.ВидыОперацийИСМП.СписаниеЧерезСУЗ);
	
	ПротоколОбменаИС.ДобавитьОперациюВПоследовательность(Таблица, 11,
		Исходящий,
		Перечисления.ВидыОперацийИСМП.СписаниеЧерезСУЗМех);
...
Процедура ОтразитьРезультатыПроверкиИПодбора(ПараметрыОкончанияПроверки) Экспорт
	...
	Если Не ДокументОбъект.Операция = Перечисления.ВидыОперацийИСМП.СписаниеЧерезСУЗМех Тогда
...
//  ДокументСсылка - ДокументСсылка.СписаниеКодовМаркировкиИСМП - Документ, для которого выполняется заполнение
...
Процедура ПриДобавленииОбработчиковОбновления(Обработчики) Экспорт
	...
	ОбновлениеИнформационнойБазыГосИС.ДобавитьОбработчикОбновленияПереходаНаКонструкторНастроек(
		...
		Новый УникальныйИдентификатор("e7a1a2dd-28c7-4a27-98ca-497f22824c6e"));
...
// 
// Параметры:
//  ДокументОбъект - ДокументОбъект.СписаниеКодовМаркировкиИСМП
...
Процедура ДополнительнаяОбработкаДанныхПриПереходеНаКонструкторНастроек(ДокументОбъект, ПроблемыСДанными, КешКонвертаций) Экспорт
	...
	ЗаполнитьОперациюПриПереходеНаКонструкторНастроек(ДокументОбъект, ПроблемыСДанными, КешКонвертаций);
	ЗаполнитьПричинуСписанияПриПереходеНаКонструкторНастроек(ДокументОбъект, ПроблемыСДанными, КешКонвертаций);
...
Функция СписаниеКодовМаркировкиJSON(ДокументСсылка, ДополнительныеПараметры = Неопределено, Повторно = Ложь)
	...
	ДанныеДокумента = ДанныеДокументаДляВыгрузки(ДокументСсылка);

	Шапка = ДанныеДокумента.Шапка;

	Если Не Шапка.Следующий()
		Или (ДанныеДокумента.ШтрихкодыУпаковок.Количество() = 0 И ДанныеДокумента.ДанныеОтчета.Количество() = 0) Тогда

		Возврат СообщениеОбОшибкеНетДанных(ДокументСсылка, ДополнительныеПараметры.Организация, Шапка.Операция);
	КонецЕсли;
	...
	СписаниеЧерезСУЗМех = Шапка.Операция = Перечисления.ВидыОперацийИСМП.СписаниеЧерезСУЗМех;
	СписаниеЧерезСУЗ = Шапка.Операция = Перечисления.ВидыОперацийИСМП.СписаниеЧерезСУЗ;
	СписаниеЧерезГИСМТОбщийДокумент = Шапка.Операция = Перечисления.ВидыОперацийИСМП.СписаниеЧерезГИСМТОбщийДокумент;
	СписаниеЧерезГИСМТ = Шапка.Операция = Перечисления.ВидыОперацийИСМП.СписаниеЧерезГИСМТ;
	
	ДополнительныеПараметры.Вставить("ВидыПродукцииПоТоварнойГруппе", ВидыПродукцииПоТоварнойГруппе);
	ДополнительныеПараметры.Вставить("СписаниеЧерезСУЗМех", СписаниеЧерезСУЗМех);
	ДополнительныеПараметры.Вставить("СписаниеЧерезСУЗ", СписаниеЧерезСУЗ);
	ДополнительныеПараметры.Вставить("СписаниеЧерезГИСМТОбщийДокумент", СписаниеЧерезГИСМТОбщийДокумент);
	ДополнительныеПараметры.Вставить("НомерВерсии", Шапка.ПоследнийНомерВерсии + 1);
	
	Если СписаниеЧерезСУЗМех Тогда
		СообщенияJSON = СообщенияСписаниеЧерезСУЗМех(ДанныеДокумента, ДополнительныеПараметры, Повторно);
	ИначеЕсли СписаниеЧерезГИСМТ Тогда
		СообщенияJSON = СообщенияСписаниеЧерезГИСМТ(ДанныеДокумента, ДополнительныеПараметры, Повторно);
	ИначеЕсли СписаниеЧерезСУЗ Тогда
		СообщенияJSON = СообщенияСписаниеЧерезСУЗ(ДанныеДокумента, ДополнительныеПараметры, Повторно);
	ИначеЕсли СписаниеЧерезГИСМТОбщийДокумент Тогда
		СообщенияJSON = СообщенияСписаниеЧерезГИСМТОбщийДокумент(ДанныеДокумента, ДополнительныеПараметры, Повторно);
	Иначе
...
Функция СообщениеОбОшибкеНетДанных(ДокументСсылка, Организация, Операция)
	...
	СообщениеJSON.Описание    = ОбменДаннымиИСМП.ОписаниеОперацииПередачиДанных(Операция, ДокументСсылка);
...
Функция ДанныеДокументаДляВыгрузки(ДокументСсылка)
	...
	|	Шапка.ПричинаСписания.Имя                  КАК КодПричиныСписания,
	|	
	...
	|	Товары.ПричинаСписания.Имя КАК КодПричиныСписания
	|ИЗ
	...
	ДанныеДокумента.Вставить("Шапка", РезультатЗапроса.Шапка.Выбрать());
	ДанныеДокумента.Вставить("Товары", РезультатЗапроса.Товары.Выгрузить());
	ДанныеДокумента.Вставить("ШтрихкодыУпаковок", РезультатЗапроса.ШтрихкодыУпаковок.Выгрузить());
	ДанныеДокумента.Вставить("ДанныеОтчета", РезультатЗапроса.ДанныеОтчетаПроизводственнойЛинии.Выгрузить());
...
Функция НормализованныеДанныеОтчета(ДанныеДокумента, ДополнительныеПараметры)
	
	Результат = Новый Структура("НормализованныеДанные, ЕстьОшибки, СообщенияОшибокJSON");
	Результат.ЕстьОшибки = Ложь;

	СообщенияJSON = Новый Массив;
		
	СообщениеJSON = ОбменДаннымиИСМП.СтруктураСообщенияJSON();
	СообщениеJSON.Организация = ДанныеДокумента.Шапка.Организация;
	СообщениеJSON.Документ = ДанныеДокумента.Шапка.Документ;
	СообщениеJSON.Описание = ОбменДаннымиИСМП.ОписаниеОперацииПередачиДанных(ДанныеДокумента.Шапка.Операция, ДанныеДокумента.Шапка.Документ);
	...
	ПараметрыСканирования = ШтрихкодированиеОбщегоНазначенияИС.ПараметрыСканирования(ДанныеДокумента.Шапка, Неопределено, ВидыПродукцииПоТоварнойГруппе);
	...
	Если ДанныеДокумента.Шапка.ОтчетПроизводственнойЛинии Тогда
...
#Область ДанныеОтчетаПроизводственнойЛинии
		...
		ДанныеДокумента.ДанныеОтчета.Колонки.Добавить("ТекстОшибкиЗначениеШтрихкода", Новый ОписаниеТипов("Строка"));
		ДанныеДокумента.ДанныеОтчета.Колонки.Добавить("ТекстОшибкиЗначениеШтрихкодаУпаковки", Новый ОписаниеТипов("Строка"));
		...
		РезультатОбработкиДанныхОтчета = РазборКодаМаркировкиИСОтчетПроизводственнойЛинии.НормализоватьДанныеОтчетаПроизводственнойЛинии(
			ДанныеДокумента.ДанныеОтчета, ВидыПродукцииПоТоварнойГруппе, ПараметрыРазбора);
		...
		Если ЕстьОшибки Тогда
			...
			СохранитьДанныеОтчетаПроизводственнойЛинии(ДанныеДокумента.Шапка.Документ, ДанныеДокумента.ДанныеОтчета);
		...
		Для Каждого СтрокаДанных Из РезультатОбработкиДанныхОтчета.ОбработанныеДанныеОтчета Цикл
			...
			Для Каждого ИменаКолонок Из РезультатОбработкиДанныхОтчета.ГруппыКолонок Цикл
				...
				Если СтрокаДанных.ЕстьОшибки Или Не ЗначениеЗаполнено(НормализованныйКодМаркировки) Тогда
				...
				Если КешДанныхРазбора[НормализованныйКодМаркировки] = Неопределено Тогда
					...
					Если ДополнительныеПараметры.СписаниеЧерезСУЗ И Не СписаниеКодовМаркировкиКлиентСервер.ВОтчетеОНанесенииИспользоватьНеполныйКод(
						ВидыПродукцииПоТоварнойГруппе, ДанныеДокумента.Шапка.ПричинаСписания) Тогда
				...
				ИначеЕсли ВидыУпаковокДляПередачиОтчетаОНанесении.Получить(ВидУпаковки) <> Неопределено
					...
					И ДополнительныеПараметры.СписаниеЧерезСУЗ
					И Не СписаниеКодовМаркировкиКлиентСервер.ВОтчетеОНанесенииИспользоватьНеполныйКод(
						ВидыПродукцииПоТоварнойГруппе, ДанныеДокумента.Шапка.ПричинаСписания) Тогда
		...
		Если ДополнительныеПараметры.ПараметрыОбмена.КОпределениюВидаУпаковки <> Неопределено Тогда
			...
			СообщениеJSON.Организация       = ДанныеДокумента.Шапка.Организация;
			СообщениеJSON.Документ          = ДанныеДокумента.Шапка.Документ;
			СообщениеJSON.ДокументОснование = ДанныеДокумента.Шапка.ДокументОснование;
			...
			Результат.СообщенияОшибокJSON = СообщенияJSON;
			
			Возврат Результат;
		КонецЕсли;

		Если ДополнительныеПараметры.СписаниеЧерезСУЗ
			И Не СписаниеКодовМаркировкиКлиентСервер.ВОтчетеОНанесенииИспользоватьНеполныйКод(
				ВидыПродукцииПоТоварнойГруппе, ДанныеДокумента.Шапка.ПричинаСписания)
			И Не ЕстьОшибки И КодыМаркировки.Количество() Тогда

			// 2. Поиск.
			РезультатПоискаВПуле = ШтрихкодированиеИСМП.РезультатПоискаВПулеКодовМаркировки(КодыМаркировки, "ПолныйКодМаркировки");
			...
			Для Каждого КлючИЗначение Из КешКодовДляПоискаВПуле Цикл
				...
				Если СтрокаПулаКодовМаркировки = Неопределено Тогда
					...
					ТекстОшибки = СтрШаблон(
						НСтр("ru = 'Не найден полный код маркировки для %1'"), КодМаркировки);
					...
					Для Каждого ИсходнаяСтрока Из ИсходныеСтроки Цикл
						...
						ИсходнаяСтрока[ИмяКолонкиТекстОшибки] = ?(
							ЗначениеЗаполнено(ИсходнаяСтрока[ИмяКолонкиТекстОшибки]), ИсходнаяСтрока[ИмяКолонкиТекстОшибки] + Символы.ПС + ТекстОшибки,
							ТекстОшибки);
		...
		Результат.НормализованныеДанные = НормализованныеДанныеОтчета;

#КонецОбласти

	ИначеЕсли Не КонструкторИСОбщегоНазначенияКлиентСервер.ЭтоПродукцияМЕХ(ВидыПродукцииПоТоварнойГруппе) Тогда
...
#Область ШтрихкодыУпаковок
		...
		РезультатПоиска = ШтрихкодированиеИС.ВложенныеШтрихкодыУпаковок(
			ДанныеДокумента.ШтрихкодыУпаковок.ВыгрузитьКолонку("ШтрихкодУпаковки"), ПараметрыСканирования, , Истина);

		Если ДополнительныеПараметры.СписаниеЧерезСУЗ Тогда
			...
			Для Каждого СтрокаТЧМаркированныеТовары Из РезультатПоиска.МаркированныеТовары Цикл
				...
				Если СтрокаТЧМаркированныеТовары.ВидУпаковки = Перечисления.ВидыУпаковокИС.Потребительская Тогда
					...
					Если СписаниеКодовМаркировкиКлиентСервер.ВОтчетеОНанесенииИспользоватьНеполныйКод(
						ВидыПродукцииПоТоварнойГруппе, ДанныеДокумента.Шапка.ПричинаСписания)
						Или ДополнительныеПараметры.СписаниеЧерезГИСМТОбщийДокумент Тогда
						СтрокаДанныхОтчета.КодДляПередачиИСМП = РазборКодаМаркировкиИССлужебныйКлиентСервер.НормализоватьКодМаркировки(
							СтрокаТЧМаркированныеТовары.ДанныеРазбора, ДанныеДокумента.Шапка.ТоварнаяГруппа, ПараметрыНормализации);
					Иначе
						ШтрихкодированиеИСМП.ДобавитьКодМаркировкиВТаблицуДляПоискаВПуле(
				...
				Если СтрокаРодитель <> Неопределено Тогда
					Если СоответствиеБлоков[СтрокаРодитель.Штрихкод] = Неопределено Тогда
						...
						Если СтрокаРодитель.ВидУпаковки = Перечисления.ВидыУпаковокИС.Групповая Или СтрокаРодитель.ВидУпаковки
							= Перечисления.ВидыУпаковокИС.Набор Тогда
							СтрокаДанныхОтчета = НормализованныеДанныеОтчета.Добавить();
							...
							Если СписаниеКодовМаркировкиКлиентСервер.ВОтчетеОНанесенииИспользоватьНеполныйКод(
								...
								Или ДополнительныеПараметры.СписаниеЧерезГИСМТОбщийДокумент Тогда
								СтрокаДанныхОтчета.КодДляПередачиИСМП = РазборКодаМаркировкиИССлужебныйКлиентСервер.НормализоватьКодМаркировки(
									СтрокаРодитель.ДанныеРазбора, ДанныеДокумента.Шапка.ТоварнаяГруппа, ПараметрыНормализации);
							Иначе
								ШтрихкодированиеИСМП.ДобавитьКодМаркировкиВТаблицуДляПоискаВПуле(
			...
			Если Не СписаниеКодовМаркировкиКлиентСервер.ВОтчетеОНанесенииИспользоватьНеполныйКод(
				ВидыПродукцииПоТоварнойГруппе, ДанныеДокумента.Шапка.ПричинаСписания)
				И Не ДополнительныеПараметры.СписаниеЧерезГИСМТОбщийДокумент Тогда
		...
		ИначеЕсли СписаниеКодовМаркировкиКлиентСервер.ДоступноСписаниеВложенныхЭлементов(ВидыПродукцииПоТоварнойГруппе) Тогда
			...
			Для Каждого СтрокаТЧМаркированныеТовары Из РезультатПоиска.МаркированныеТовары Цикл
				...
				Если СтрокаРодитель <> Неопределено
					...
					УдаляемыеСтроки.Добавить(СтрокаТЧМаркированныеТовары);
				КонецЕсли;

			КонецЦикла;
			
			Для Каждого СтрокаТаблицы Из УдаляемыеСтроки Цикл
				РезультатПоиска.МаркированныеТовары.Удалить(СтрокаТаблицы);
			КонецЦикла;
			Результат.НормализованныеДанные = РезультатПоиска.МаркированныеТовары;
...
Функция СообщенияСписаниеЧерезСУЗМех(ДанныеДокумента, ДополнительныеПараметры, Повторно)
	...
	СообщениеJSON.Описание = ОбменДаннымиИСМП.ОписаниеОперацииПередачиДанных(Шапка.Операция, Шапка.Документ, НомерВерсии);

	РезультатОпределенияСУЗ = ИнтеграцияИСМПСлужебный.ОпределитьСтанциюУправленияЗаказами(СообщенияJSON, СообщениеJSON, Шапка, ДополнительныеПараметры);
	...
	СообщениеJSON.ТребуетсяПодписание       = Ложь;
	Запрос = ЗапросШтрихкодыУпаковок(Истина);

	Запрос.УстановитьПараметр("Ссылка", Шапка.Документ);
	...
	Пока ВыборкаПоИдентификаторамЗаказаСУЗ.Следующий() Цикл
		...
		Пока ВыборкаДетальныеЗаписи.Следующий() Цикл
			...
			Если ШтрихкодыУпаковокКПовторнойПередаче <> Неопределено И ШтрихкодыУпаковокКПовторнойПередаче[ВыборкаДетальныеЗаписи.ШтрихкодУпаковки]
				= Неопределено Тогда
				Продолжить;
			КонецЕсли;
		...
		СтрокаКодыМаркировки.Вставить("reason", Шапка.КодПричиныСписания);
		...
		СообщениеJSON.Описание = ОбменДаннымиИСМП.ОписаниеОперацииПередачиДанных(
					Шапка.Операция, Шапка.Документ, НомерВерсии);
...
Функция СообщенияСписаниеЧерезГИСМТ(ДанныеДокумента, ДополнительныеПараметры, Повторно)

	Запрос = ЗапросШтрихкодыУпаковок(Ложь);
	Запрос.УстановитьПараметр("Ссылка", ДанныеДокумента.Шапка.Документ);
	ДанныеШтрихкодов = Запрос.Выполнить().Выгрузить();

	РеквизитыОрганизации = РаботаСКонтрагентамиИСВызовСервера.ИННКПППоОрганизацииКонтрагенту(ДанныеДокумента.Шапка.Организация);
	...
	ДополнительныеПараметры.Вставить("РеквизитыОрганизации", РеквизитыОрганизации);
	ДополнительныеПараметры.Вставить("ИсточникДанных", ДанныеШтрихкодов);
	ДополнительныеПараметры.Вставить("ПользовательскиеПараметрыРазбораКодаМаркировки", ПользовательскиеПараметрыРазбораКодаМаркировки);

	Возврат СообщенияJSONСписаниеКодовМаркировкиИСМП(ДанныеДокумента, ДополнительныеПараметры);

КонецФункции

Функция СообщенияСписаниеЧерезСУЗ(ДанныеДокумента, ДополнительныеПараметры, Повторно)
	...
	СообщениеJSON.Организация = Шапка.Организация;
	СообщениеJSON.Документ    = Шапка.Документ;
	СообщениеJSON.Описание = ОбменДаннымиИСМП.ОписаниеОперацииПередачиДанных(Шапка.Операция, Шапка.Документ);
	...
	Если Не ЗаказНаЭмиссиюСУЗКлиентСервер.ПоддерживаетсяФорматОбменаСУЗ(ФорматОбмена, Шапка.ТоварнаяГруппа) Тогда
		СообщениеJSON.ТекстОшибки = СтрШаблон(
				НСтр("ru = 'По товарной группе %1 не поддерживается формат обмена с СУЗ ниже V3.
					 |Перейдите в список СУЗ и установите формат обмена V3.'"), Шапка.ТоварнаяГруппа);
		СообщениеJSON.ТребуетсяПодписание = Ложь;
		СообщенияJSON.Добавить(СообщениеJSON);
	...
	ТелоЗапроса.Вставить("dropoutReason", Шапка.КодПричиныСписания);
	ТелоЗапроса.Вставить("sntins", Новый Массив);
	
	Если МаркировкаТоваровКлиентСервер.ДоступноПолеВидПервичногоДокумента(ВидыПродукцииПоТоварнойГруппе, Шапка.Операция) Тогда
		ТелоЗапроса.Вставить("sourceDocDate", Формат(Шапка.Дата, "ДФ=yyyy-MM-dd;"));
		ТелоЗапроса.Вставить("sourceDocNum", Шапка.Номер);
	КонецЕсли;
	
	Если СписаниеКодовМаркировкиКлиентСервер.ДоступноПредставлениеАдресаПроизводственногоОбъекта(ВидыПродукцииПоТоварнойГруппе, Шапка.ПричинаСписания) Тогда
		ТелоЗапроса.Вставить("address", Шапка.ПроизводственныйОбъектАдресСтрокой);
	КонецЕсли;
	
	ДоступноСписаниеВложенныхЭлементов = СписаниеКодовМаркировкиКлиентСервер.ДоступноСписаниеВложенныхЭлементов(ВидыПродукцииПоТоварнойГруппе);
	
	ТелоЗапроса.Вставить("withChild", ДоступноСписаниеВложенныхЭлементов);
	...
	РезультатНормализованныеДанныеОтчета = НормализованныеДанныеОтчета(ДанныеДокумента, ДополнительныеПараметры);
	Если РезультатНормализованныеДанныеОтчета.ЕстьОшибки Тогда
		Возврат РезультатНормализованныеДанныеОтчета.СообщенияОшибокJSON;
	КонецЕсли;
	
	НормализованныеДанныеОтчета = РезультатНормализованныеДанныеОтчета.НормализованныеДанные;
	
	Для Каждого СтрокаДанныхОтчета Из НормализованныеДанныеОтчета Цикл
		
		Если СписаниеКодовМаркировкиКлиентСервер.ВОтчетеОНанесенииИспользоватьНеполныйКод(
				ВидыПродукцииПоТоварнойГруппе, Шапка.ПричинаСписания) Тогда
		...
		ИначеЕсли Не ЗначениеЗаполнено(СтрокаДанныхОтчета.ПолныйКодМаркировки) Тогда
			ЕстьОшибки = Истина;
			ОбщегоНазначенияИСКлиентСервер.ДобавитьТекстОшибки(
					СообщениеJSON, СтрШаблон(НСтр("ru = 'Не найден полный код маркировки для кода %1.'"), СтрокаДанныхОтчета.КодМаркировки));
		Иначе
	...
	ИнтерфейсСУЗ.ТелоЗапросаПоФорматуОбмена(ТелоЗапроса, ФорматОбмена, Шапка.Операция, Шапка.ТоварнаяГруппа);
	
	ТекстСообщенияJSON = ОбменДаннымиИСМПКлиентСервер.ОбъектВТекстJSON(ТелоЗапроса, Истина);
	
	СообщениеJSON.ТекстСообщенияJSON  = ТекстСообщенияJSON;
	СообщениеJSON.ТипСообщения        = Перечисления.ТипыЗапросовИС.Исходящий;
	СообщениеJSON.Версия              = ДополнительныеПараметры.НомерВерсии;
	СообщениеJSON.ТребуетсяПодписание = Ложь;
...
Функция СообщенияСписаниеЧерезГИСМТОбщийДокумент(ДанныеДокумента, ДополнительныеПараметры, Повторно)
	...
	Если СписаниеКодовМаркировкиКлиентСервер.ДоступноПолеКодФИАС(ВидыПродукцииПоТоварнойГруппе, Шапка.ПричинаСписания) Тогда
		...
		Если Не ЗначениеЗаполнено(КодФИАС) Тогда
			...
			КодФИАС = ИдентификаторАдреса(ВидыПродукцииПоТоварнойГруппе, РезультатОпределенияСУЗ, СообщениеJSON);
		...
		ДополнительныеПараметры.Вставить("КодФИАС", КодФИАС);
	...
	ДополнительныеПараметры.Вставить("РеквизитыОрганизации", РеквизитыОрганизации);
	ДополнительныеПараметры.Вставить("ИсточникДанных", НормализованныеДанныеОтчета);
	ДополнительныеПараметры.Вставить("ПользовательскиеПараметрыРазбораКодаМаркировки", ПользовательскиеПараметрыРазбораКодаМаркировки);
...
Функция ЗапросШтрихкодыУпаковок(Знач СписаниеЧерезСУЗМех)
...
Функция СообщенияJSONСписаниеКодовМаркировкиИСМП(ДанныеДокумента, ДополнительныеПараметры)
	...
	СообщениеJSON.ДокументОснование = Шапка.ДокументОснование;
	СообщениеJSON.Описание = ОбменДаннымиИСМП.ОписаниеОперацииПередачиДанных(Шапка.Операция, Шапка.Ссылка, НомерВерсии);
	...
	ТелоЗапроса = Новый Структура;
	Если ДополнительныеПараметры.СписаниеЧерезГИСМТОбщийДокумент Тогда
		
		ТелоЗапроса.Вставить("participantId", РеквизитыОрганизации.ИНН);
		ИмяПараметрКодыМаркировки = "sntins";
		ТелоЗапроса.Вставить("dropoutReason", Шапка.КодПричиныСписания);
		Если СписаниеКодовМаркировкиКлиентСервер.ДоступноПредставлениеАдресаПроизводственногоОбъекта(
			ВидыПродукцииПоТоварнойГруппе, Шапка.ПричинаСписания) И ЗначениеЗаполнено(Шапка.ПроизводственныйОбъектАдресСтрокой) Тогда
			ТелоЗапроса.Вставить("address", Шапка.ПроизводственныйОбъектАдресСтрокой);
		КонецЕсли;
		Если СписаниеКодовМаркировкиКлиентСервер.ДоступноПолеКодФИАС(ВидыПродукцииПоТоварнойГруппе, Шапка.ПричинаСписания) Тогда
		...
		Если МаркировкаТоваровКлиентСервер.ДоступноПолеВидПервичногоДокумента(ВидыПродукцииПоТоварнойГруппе, Шапка.Операция)
			И ЗначениеЗаполнено(Шапка.ДатаПервичногоДокумента) Тогда
			...
			Если ВыводИзОборотаКлиентСервер.ДоступноПолеВидПервичногоДокумента(ВидыПродукцииПоТоварнойГруппе) Тогда
	...
	Если Шапка.ОтчетПроизводственнойЛинии Тогда
		...
		Для Каждого СтрокаДанныхОтчета Из ИсточникДанных Цикл
			...
			Иначе
				...
				СтрокаТЧ.Вставить("uit", СтрокаДанныхОтчета.КодДляПередачиИСМП);
				СтрокаТЧ.Вставить("cancellation_reason", Шапка.КодПричиныСписания);
	...
	Иначе
		...
		Для Каждого СтрокаИсточникаДанных Из ИсточникДанных Цикл
			...
			Если НайденныеСтроки.Количество() = 1 Тогда
				...
				Если Не КонструкторИСОбщегоНазначенияКлиентСервер.ЭтоПродукцияМЕХ(ВидыПродукцииПоТоварнойГруппе) Тогда
					РезультатРазбора = ШтрихкодированиеОбщегоНазначенияИС.НоваяСтруктураОбработкиШтрихкода(
						СтрокаИсточникаДанных.Штрихкод, Шапка.ТоварнаяГруппа, ПользовательскиеПараметрыРазбораКодаМаркировки);
				...
				Иначе
					...
					Если ЗначениеЗаполнено(СтрокаТЧТовары.КодПричиныСписания) Тогда
						КодПричиныСписания = СтрокаТЧТовары.КодПричиныСписания;
					Иначе
						КодПричиныСписания = Шапка.КодПричиныСписания;
					КонецЕсли;
					
					СтрокаТЧ = Новый Структура;
					Если КонструкторИСОбщегоНазначенияКлиентСервер.ЭтоПродукцияМЕХ(ВидыПродукцииПоТоварнойГруппе) Тогда
						СтрокаТЧ.Вставить("uit", СтрокаИсточникаДанных.ЗначениеШтрихкода);
					Иначе
						СтрокаТЧ.Вставить("uit", КодМаркировкиДляПередачиИСМП);
					КонецЕсли;
					
					СтрокаТЧ.Вставить("cancellation_reason", КодПричиныСписания);
					ГруппаКодов.Добавить(СтрокаТЧ);
				КонецЕсли;
	...
	Если Не Шапка.Операция = Перечисления.ВидыОперацийИСМП.СписаниеЧерезСУЗ
		И Не Шапка.Операция = Перечисления.ВидыОперацийИСМП.СписаниеЧерезСУЗМех Тогда
...
Функция ОбработатьДанныеШтрихкодаМаркируемойПродукции(Форма, ДанныеШтрихкода, ПараметрыСканирования)
	...
	Если КонструкторИСМПОбщегоНазначенияКлиентСервер.ЭтоПродукцияИСМП(ВидыПродукцииПоТоварнойГруппе, Истина) Тогда
...
Функция ОбработатьДанныеШтрихкодаПотребительскойУпаковки(Форма, ДанныеШтрихкода, ПараметрыСканирования, ПараметрыЗаполнения = Неопределено)
	...
	КонецЕсли;
	Если КонструкторИСМПКлиентСервер.ВидПродукцииПодлежитМаркировкеОстатков(ДанныеШтрихкода.ВидПродукции) Тогда
	...
	СписаниеЧерезСУЗМех = Операция = Перечисления.ВидыОперацийИСМП.СписаниеЧерезСУЗМех;
	...
	Если Не ЗначениеЗаполнено(ДанныеШтрихкода.Номенклатура)
		И Не СписаниеЧерезСУЗМех Тогда
...
Процедура ЗаполнитьПричинуСписанияПриПереходеНаКонструкторНастроек(ДокументОбъект, ПроблемыСДанными, КешКонвертаций)

	Если Не ЗначениеЗаполнено(ДокументОбъект.УдалитьПричинаСписания) Тогда
		Возврат;
	КонецЕсли;

	Если ДокументОбъект.Операция = Перечисления.ВидыОперацийИСМП.СписаниеЧерезСУЗМех Тогда

		Если КешКонвертаций.ПричиныСписаниеЧерезСУЗМех = Неопределено Тогда
			КешКонвертаций.ПричиныСписаниеЧерезСУЗМех = Перечисления.УдалитьПричиныСписанияКодовМаркировкиИСМП.ПричиныСписаниеЧерезСУЗМехКонструктораНастроекПоПеречислению();
		КонецЕсли;

		ПричиныВыбытия = КешКонвертаций.ПричиныСписаниеЧерезСУЗМех;

	ИначеЕсли ДокументОбъект.Операция = Перечисления.ВидыОперацийИСМП.СписаниеЧерезГИСМТ Тогда

		Если КешКонвертаций.ПричиныСписаниеЧерезГИСМТ = Неопределено Тогда
			КешКонвертаций.ПричиныСписаниеЧерезГИСМТ = Перечисления.УдалитьПричиныСписанияКодовМаркировкиИСМП.ПричиныСписаниеЧерезГИСМТКонструктораНастроекПоПеречислению();
		КонецЕсли;

		ПричиныВыбытия = КешКонвертаций.ПричиныСписаниеЧерезГИСМТ;

	ИначеЕсли ДокументОбъект.Операция = Перечисления.ВидыОперацийИСМП.СписаниеЧерезСУЗ
		Или ДокументОбъект.Операция = Перечисления.ВидыОперацийИСМП.СписаниеЧерезГИСМТОбщийДокумент Тогда
		...
		ПричиныВыбытия = КешКонвертаций.ПричиныВыбытия;

	КонецЕсли;

	ПричинаСписания = ПричиныВыбытия[ДокументОбъект.УдалитьПричинаСписания];

	ТекстыПроблем = Новый Соответствие;

	Если ЗначениеЗаполнено(ПричинаСписания) Тогда
		ДокументОбъект.ПричинаСписания = ПричинаСписания;
	Иначе

		ТекстПроблемы = СтрШаблон(
			НСтр("ru = 'Не удалось обработать причину списания кода маркировки ""%1"" при переходе на конструктор настроек видов продукции для объекта ""%2""'"),
			ДокументОбъект.УдалитьПричинаСписания, ДокументОбъект.Ссылка);

		ТекстыПроблем.Вставить(ТекстПроблемы, Истина);

	КонецЕсли;

	Для Каждого СтрокаТовары Из ДокументОбъект.Товары Цикл

		Если Не ЗначениеЗаполнено(СтрокаТовары.УдалитьПричинаСписания) Тогда
			Продолжить;
		КонецЕсли;

		ПричинаСписания = ПричиныВыбытия[СтрокаТовары.УдалитьПричинаСписания];

		Если ЗначениеЗаполнено(ПричинаСписания) Тогда
			СтрокаТовары.ПричинаСписания = ПричинаСписания;
		Иначе
			ТекстПроблемы = СтрШаблон(
				НСтр(
				"ru = 'Не удалось обработать причину списания кода маркировки ""%1"" при переходе на конструктор настроек видов продукции для объекта ""%2""'"),
				СтрокаТовары.УдалитьПричинаСписания, ДокументОбъект.Ссылка);
			Если ТекстыПроблем[ТекстПроблемы] = Неопределено Тогда
				ТекстыПроблем.Вставить(ТекстПроблемы);
			КонецЕсли;
		КонецЕсли;

	КонецЦикла;
	Если ТекстыПроблем.Количество() Тогда
		ОписаниеПроблемы = Новый Массив;
		Для Каждого КлючИЗначение Из ТекстыПроблем Цикл
			ОписаниеПроблемы.Добавить(КлючИЗначение.Ключ);
		КонецЦикла;
		ПроблемыСДанными[ДокументОбъект.Ссылка] = СтрСоединить(ОписаниеПроблемы, "; ");
	КонецЕсли;

КонецПроцедуры

Процедура ЗаполнитьОперациюПриПереходеНаКонструкторНастроек(ДокументОбъект, ПроблемыСДанными, КешКонвертаций)

	Если ДокументОбъект.Операция = Перечисления.ВидыОперацийИСМП.СписаниеЧерезГИСМТ
		Или ДокументОбъект.Операция = Перечисления.ВидыОперацийИСМП.СписаниеЧерезСУЗМех
		Или ДокументОбъект.Операция = Перечисления.ВидыОперацийИСМП.СписаниеЧерезГИСМТОбщийДокумент
		Или ДокументОбъект.Операция = Перечисления.ВидыОперацийИСМП.СписаниеЧерезСУЗ Тогда
			Возврат;
	КонецЕсли;

	ЭтоСписаниеПриПоступлении = ДокументОбъект.Операция = Перечисления.ВидыОперацийИСМП.УдалитьСписаниеЭмитированныхКодовМаркировкиПриПоступлении;
	ПередачаОтчетаЧерезСУЗ = ВидПродукцииИспользуетПередачуОтчетаОбОтбраковкеЧерезСУЗ(ДокументОбъект.УдалитьВидПродукции);
	ЭтоВыбытиеДоОбязательностиМаркировки = ДокументОбъект.УдалитьПричинаСписания
		= Перечисления.УдалитьПричиныСписанияКодовМаркировкиИСМП.ВыбытиеДоОбязательностиМаркировки;
	Если ДокументОбъект.УдалитьВидПродукции = Перечисления.ВидыПродукцииИС.ПродукцияИзНатуральногоМеха Тогда

		Если ЭтоСписаниеПриПоступлении Тогда
			ДокументОбъект.Операция = Перечисления.ВидыОперацийИСМП.СписаниеЧерезСУЗМех;
		Иначе
			ДокументОбъект.Операция = Перечисления.ВидыОперацийИСМП.СписаниеЧерезГИСМТ;
		КонецЕсли;

	ИначеЕсли ПередачаОтчетаЧерезСУЗ И Не ЭтоВыбытиеДоОбязательностиМаркировки Тогда
		ДокументОбъект.Операция = Перечисления.ВидыОперацийИСМП.СписаниеЧерезСУЗ;
	ИначеЕсли ЭтоВыбытиеДоОбязательностиМаркировки Тогда
		ДокументОбъект.Операция = Перечисления.ВидыОперацийИСМП.СписаниеЧерезГИСМТОбщийДокумент;
	ИначеЕсли КонструкторИСМПОбщегоНазначенияКлиентСервер.ЭтоПродукцияИСМП(ДокументОбъект.ТоварнаяГруппа) Тогда
		ДокументОбъект.Операция = Перечисления.ВидыОперацийИСМП.СписаниеЧерезГИСМТ;
	Иначе
		ТекстПроблемы = СтрШаблон(
			НСтр(
			"ru = 'Не удалось обработать операцию списания кода маркировки ""%1"" при переходе на конструктор настроек видов продукции для объекта ""%2""'"),
			ДокументОбъект.Операция, ДокументОбъект.Ссылка);

		ПроблемыСДанными[ДокументОбъект.Ссылка] = ТекстПроблемы;
	КонецЕсли;
...
Функция ВидПродукцииИспользуетПередачуОтчетаОбОтбраковкеЧерезСУЗ(ВидПродукции)
