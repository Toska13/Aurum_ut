...
Процедура ЗаполнитьНоменклатуруОприходованиеВидовЗапасов(Отказ)
	...
	Запрос.УстановитьПараметр("СписываемыеЗапасы",	ВидыЗапасов.ВыгрузитьКолонку("ВидЗапасов"));
	
	РезультатЗапроса = Запрос.ВыполнитьПакет();
	
	ДанныеТоваровДокументы			= РезультатЗапроса[1].Выгрузить();
	...
	ВидыЗапасовСписания	= РезультатЗапроса[2].Выгрузить();
	...
	Для Каждого СтрокаТоваров Из Товары Цикл
		...
		Для Каждого СтрокаЗапасов Из ВидыЗапасов.НайтиСтроки(ОтборСтрок) Цикл
			...
			Если ТекущийТипЗапасов = Перечисления.ТипыЗапасов.Товар
				Или ТекущийТипЗапасов = Перечисления.ТипыЗапасов.КомиссионныйТовар Тогда
