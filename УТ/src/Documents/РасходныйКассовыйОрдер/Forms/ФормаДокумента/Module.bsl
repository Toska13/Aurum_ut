...
Процедура КассаПриИзменении(Элемент)
	...
	РазрешеныПлатежиБезУказанияЗаявок =
		(СтруктурыРеквизитов.РазрешитьПлатежиБезУказанияЗаявок И ИспользоватьЗаявкиНаРасходованиеДенежныхСредств)
...
Процедура ПриЧтенииСозданииНаСервере()
	...
	РазрешеныПлатежиБезУказанияЗаявок =
		(Справочники.Кассы.ПолучитьРеквизитыКассы(ТекущаяКасса).РазрешитьПлатежиБезУказанияЗаявок И ИспользоватьЗаявкиНаРасходованиеДенежныхСредств)
		Или Не ИспользоватьЗаявкиНаРасходованиеДенежныхСредств;
	...
	ДенежныеСредстваСервер.ПолучитьДоступныеХозяйственныеОперацииПоОснованию(
		Объект.ДокументОснование, Перечисления.ФормыОплаты.Наличная, ДоступныеОперацииПоОснованию);
...
Процедура ЗаполнитьОрганизациюПолучателя()
	...
	Если Объект.ХозяйственнаяОперация = Перечисления.ХозяйственныеОперации.ОплатаДенежныхСредствВДругуюОрганизацию
		...
		Если ЗначениеЗаполнено(СтруктураРеквизитов.Организация) Тогда
			Если ЗначениеЗаполнено(ТекущаяОрганизацияПолучатель) 
				И ТекущаяОрганизацияПолучатель <> СтруктураРеквизитов.Организация Тогда
				ВзаиморасчетыРаботаСФормами.ФормаПриИзмененииРеквизитов(ЭтотОбъект, "КассаПолучатель.Владелец");
			КонецЕсли;
...
Процедура УстановитьПризнакОплатыПоЗаявкам()
	...
	Если Не РазрешеныПлатежиБезУказанияЗаявок
		И ЗначениеЗаполнено(Объект.Касса) Тогда
		Объект.ОплатаПоЗаявкам = Истина;
	ИначеЕсли Не ЗначениеЗаполнено(Объект.Касса) Тогда
