...
Процедура СформироватьЗаявлениеОВвозеТоваров(Команда)
	...
	Для Каждого Заявление Из МассивСсылок Цикл
		...
		Если ТипЗнч(Заявление.Распоряжение) = Тип("ДокументСсылка.ПриобретениеТоваровУслуг") Тогда
			ОткрытьФорму("Документ.ЗаявлениеОВвозеТоваров.ФормаОбъекта", Новый Структура("Основание", Заявление.Распоряжение), , Истина);
