...
Функция ТекстЗапросаОперации(Запрос, ТекстыЗапроса, Регистры = "")
	...
	ТекстЗапроса = "ВЫБРАТЬ
		...
		|	ТаблицаОперации.ВестиУчетКомиссииВоВзаиморасчетах КАК ВестиУчетКомиссииВоВзаиморасчетах,
		|
...
Функция ТекстЗапросаТаблицаВтИсходныеПрочиеРасходы(Запрос, ТекстыЗапроса)
	...
	|ГДЕ
	|	ТаблицаОперации.СуммаКомиссии <> 0
	|	И НЕ ТаблицаОперации.ВестиУчетКомиссииВоВзаиморасчетах
	|";
...
Функция ТекстЗапросаТаблицаВтПрочиеРасходы(Запрос, ТекстыЗапроса)
	...
	ТекстЗапроса = РегистрыНакопления.ПрочиеРасходы.ТекстЗапросаТаблицаВтПрочиеРасходы("ПериодКорректировки");
	ТекстыЗапроса.Добавить(ТекстЗапроса, ИмяРегистра);
	Возврат ТекстЗапроса;
...
Функция ТекстЗапросаТаблицаПрочиеРасходы(Запрос, ТекстыЗапроса, Регистры)
	...
	ТекстЗапроса = РегистрыНакопления.ПрочиеРасходы.ТекстЗапросаТаблицаПрочиеРасходы("ПериодКорректировки");
	ТекстыЗапроса.Добавить(ТекстЗапроса, ИмяРегистра);
	Возврат ТекстЗапроса;
