...
Процедура ОбработкаПроверкиЗаполненияНаСервере(Отказ, ПроверяемыеРеквизиты)
	...
	ВыполнятьПроверкуЗаполненияДоговораКомисии = (Объект.СуммаКомиссии <> 0 И Объект.ВестиУчетКомиссииВоВзаиморасчетах);
...
Процедура ОснованиеПлатежаОбработкаВыбораСервер(ВыбранноеЗначение)
	...
	Иначе
		...
		Если ОбщегоНазначенияКлиентСервер.ЕстьРеквизитИлиСвойствоОбъекта(ВыбранноеЗначение, "ОснованиеПлатежа") Тогда
			...
			Объект.ОбъектРасчетов = ОбъектыРасчетовСервер.ОбъектРасчетовПоОснованиюПлатежа(Объект.ОснованиеПлатежа);
		КонецЕсли;
