...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ИнтеграцияИС.УстановитьВидимостьОтветственный(ЭтотОбъект, Истина);
	ИнтеграцияИС.УстановитьНавигационнуюСсылкуФормыСпискаДокументов(ЭтотОбъект);
	
	ИнтеграцияЕГАИС.УстановитьВидимостьОрганизацияЕГАИСВСпискахДокументов(
		ЭтотОбъект,
		"Оформлено,КОформлению,ВРегистр3");
...
Процедура ОформитьАктПостановкиНаБаланс(Команда)
	...
	Если Не ОбщегоНазначенияИСКлиент.ВыборСтрокиСпискаКорректен(Элементы.СписокКОформлению, Истина) Тогда
		Возврат;
	КонецЕсли;
...
Процедура ОформитьВРегистр3(Команда)
	...
	Если Не ОбщегоНазначенияИСКлиент.ВыборСтрокиСпискаКорректен(Элементы.СписокВРегистр3, Истина) Тогда
		Возврат;
	КонецЕсли;
