...
//
// Возвращаемое значение:
//  Массив Из ПеречислениеСсылка.СтатусыИнформированияЕГАИС - Статусы ошибок.
//
...
// 
// Возвращаемое значение:
//  Массив из ПеречислениеСсылка.СтатусыИнформированияЕГАИС - Конечные статусы.
...
//  ДокументСсылка - ДокументСсылка.ЧекЕГАИСВозврат - Документ, для которого выполняется заполнение
...
Функция ЭтотОбъект(ЭтоМетаданные = Ложь)
	Если ЭтоМетаданные Тогда
		Возврат Метаданные.Документы.ЧекЕГАИСВозврат;
	Иначе
		Возврат Документы.ЧекЕГАИСВозврат;
	КонецЕсли;
КонецФункции
