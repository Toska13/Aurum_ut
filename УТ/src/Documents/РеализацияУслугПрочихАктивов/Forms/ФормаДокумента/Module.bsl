...
Процедура ЗаполнитьСписокВыбораОпераций(УстановитьОперацию = Истина)
	...
	ИначеЕсли Не ИспользоватьСоглашенияСКлиентами
...
Процедура ОткрытьРеквизитыПечатиРеализации(ПоказыватьРеквизитыТТН)
	...
	СтруктураПараметров.Вставить("АдресДоставкиЗначение",          "");
	СтруктураПараметров.Вставить("АдресДоставкиЗначенияПолей",     "");
	СтруктураПараметров.Вставить("ЗонаДоставки",                   "");
	СтруктураПараметров.Вставить("ВремяДоставкиС",                 "");
	СтруктураПараметров.Вставить("ВремяДоставкиПо",                "");
	СтруктураПараметров.Вставить("ДополнительнаяИнформацияПоДоставке", "");
