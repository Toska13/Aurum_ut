	...
	Если Параметры.Свойство("Основание") Тогда
		Если ЗначениеЗаполнено(Параметры.Основание) Тогда
			...
			Если ТипЗнч(Параметры.Основание) = Тип("ДокументСсылка.ЗаявкаНаРасходованиеДенежныхСредств") Тогда
				...
				Иначе
					ПараметрыСчета = ДенежныеСредстваСервер.ПараметрыЗаполненияБанковскогоСчетаОрганизации(Реквизиты.Организация);
					ПараметрыСчета.Валюта = Реквизиты.Валюта;
...
Процедура СоздатьДокументыСписаниеНаСервере(ФизическоеЛицо, ЛицевойСчет, Сумма, ВедомостьПоВыплатеЗП, ИндексСтроки)
	...
	//++ Локализация
	ДенежныеСредстваСерверЛокализация.ЗаполнитьРеквизитыПлательщика(ДокументСписаниеОбъект, ДокументСписаниеОбъект.Дата);
	//-- Локализация
