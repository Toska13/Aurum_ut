...
Процедура ЗапроситьСДИЗ(Команда)
	...
	Если Элементы.СписокКОформлению.ТекущиеДанные <> Неопределено Тогда
		ПараметрыФормы.РазделУчета   = Элементы.СписокКОформлению.ТекущиеДанные.РазделУчета;
	КонецЕсли;
...
Функция ВозможностьВводаПогашенияСДИЗ(Знач ВыделенныеСтроки)
	...
	РеквизитыСДИЗов = РеквизитыСДИЗДляПроверкиВозможностиВводаПогашения(ВыделенныеСтроки);
...
Функция РеквизитыСДИЗДляПроверкиВозможностиВводаПогашения(СсылкиНаДокументы)
	...
	Возврат ОбщегоНазначения.ЗначенияРеквизитовОбъектов(СсылкиНаДокументы, СтрСоединить(ТребуемыеРеквизиты, ","));
...
Процедура ВыборОрганизацииЗавершение(ВыбранноеЗначение, ДополнительныеПараметры) Экспорт
	...
	Если ВыбранноеЗначение.СохраненыНастройки Тогда
