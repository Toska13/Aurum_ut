...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	СобытияФормИСКлиентСерверПереопределяемый.УстановитьПараметрыВыбораНоменклатуры(ЭтотОбъект, КонструкторИСОбщегоНазначенияКлиентСервер.ВидыПродукцииИСМПЕГАИС());
...
Процедура НастроитьЭлементыФормы(Форма)
	...
	Элементы.СтраницаШтрихкодыУпаковок.Видимость = Форма.ДоступенРежимОтладки И Не Объект.ОтчетПроизводственнойЛинии;
