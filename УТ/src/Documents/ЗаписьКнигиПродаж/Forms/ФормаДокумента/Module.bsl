...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ОписаниеТиповДокументРасчетов = Метаданные.Документы.ЗаписьКнигиПродаж.Реквизиты.ДокументРасчетов.Тип;
...
&НаКлиенте
Процедура ДокументРасчетовНачалоВыбора(Элемент, ДанныеВыбора, ВыборДобавлением, СтандартнаяОбработка)
