...
Процедура ЗаполнитьДоходыПоОстаткам() Экспорт
	...
	|	ПрочиеДоходы.СуммаОборот КАК Сумма,
	|	ПрочиеДоходы.СуммаУпрОборот КАК СуммаУпр,
	|	ПрочиеДоходы.СуммаРеглОборот КАК СуммаРегл,
	|
	...
	|ИЗ
	|	РегистрНакопления.ПрочиеДоходы.Обороты(&НачалоПериода,&Граница,, 
	...
	|ГДЕ
	|	ПрочиеДоходы.СуммаОборот <> 0
	|	ИЛИ ПрочиеДоходы.СуммаУпрОборот <> 0
	|	ИЛИ ПрочиеДоходы.СуммаРеглОборот <> 0
	|");
