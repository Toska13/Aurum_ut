...
Процедура ЗаполнитьУсловияЗакупок(Знач УсловияЗакупок) Экспорт
	...
	Если СписаниеЗаНашСчет И КонтрагентДоИзменения <> Контрагент Тогда
	...
	Иначе
		...
		Если СписаниеЗаНашСчет И ОплатаВВалюте <> УсловияЗакупок.ОплатаВВалюте Тогда
...
Процедура ЗаполнитьУсловияЗакупокПоУмолчанию(ПересчитатьЦены = Истина) Экспорт
	...
	Если ЗначениеЗаполнено(Партнер) Тогда
		...
		Иначе
			...
			Если СписаниеЗаНашСчет Тогда
				ПараметрыСчета = ДенежныеСредстваСервер.ПараметрыЗаполненияБанковскогоСчетаКонтрагента(Контрагент);
				БанковскийСчетКонтрагента = ДенежныеСредстваСервер.ПолучитьБанковскийСчетКонтрагентаПоУмолчанию(
					ПараметрыСчета, БанковскийСчетКонтрагента, ФормаОплаты);
			КонецЕсли;
...
Процедура ЗаполнитьДокументПоОтбору(Знач ДанныеЗаполнения)
	...
	Если ДанныеЗаполнения.Свойство("Партнер") Тогда
		...
		СтруктураДействий.Вставить("ЗаполнитьНоменклатуруПартнераПоНоменклатуре", ДанныеЗаполнения.Партнер);
...
Процедура ИнициализироватьДокумент()
	...
	Если Операции.Найти(ХозяйственнаяОперация) <> Неопределено Тогда
		...
		Если Не ЗначениеЗаполнено(БанковскийСчетОрганизации) Или Не ЗначениеЗаполнено(БанковскийСчетКонтрагента) Тогда
		...
		ПараметрыСчета = ДенежныеСредстваСервер.ПараметрыЗаполненияБанковскогоСчетаКонтрагента(Контрагент);
		БанковскийСчетКонтрагента = ДенежныеСредстваСервер.ПолучитьБанковскийСчетКонтрагентаПоУмолчанию(ПараметрыСчета,
			БанковскийСчетКонтрагента, ФормаОплаты);
