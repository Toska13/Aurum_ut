...
Процедура КомиссионерПриИзмененииСервер()
	...
	Если ИспользоватьНаправленияДеятельности
		...
		НаправленияДеятельностиСервер.ЗаполнитьНаправлениеПоУмолчанию(Объект.НаправлениеДеятельности, Неопределено, Объект.ДоговорПокупки);
	КонецЕсли;
	...
	ЗаполнитьПодчиненныеСвойстваПоСтатистике("Комиссионер");
...
Процедура ДоговорПриИзмененииНаСервере()
	...
	Если Не ЗначениеЗаполнено(Объект.БанковскийСчетОрганизацииПолучателя) Тогда
		ПараметрыСчета = ДенежныеСредстваСервер.ПараметрыЗаполненияБанковскогоСчетаОрганизации(Объект.Комиссионер);
		ПараметрыСчета.НаправлениеДеятельности = Объект.НаправлениеДеятельности;
		ПараметрыСчета.ИсключитьСчетаВВалюте = Объект.ОплатаВВалюте;
		ПараметрыСчета.Валюта = ВалютаРегл;
		Объект.БанковскийСчетОрганизацииПолучателя =
...
Процедура РасчетыЧерезОтдельногоКонтрагентаПриИзмененииСервер()
	...
	Если ИспользоватьНаправленияДеятельности Тогда
		ОпределяющийДоговор = ?(Объект.РасчетыЧерезОтдельногоКонтрагента, Объект.ДоговорПокупки, Объект.Договор);
