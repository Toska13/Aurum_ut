...
Процедура ПриКопировании(ОбъектКопирования)
	...
	ПакетнаяОбработкаТабличнойЧастиСервер.ОбработатьТЧ(Авансы, СтруктураДействий, Неопределено);
...
Процедура ЗаполнитьАвансы()
	...
	ДополнительныеПараметры.РасчетныйДокумент = ДокументОснование;
	ДополнительныеПараметры.ВРазрезеСтавокНДС = Истина;
	ДополнительныеПараметры.ВРазрезеОР = Истина;
