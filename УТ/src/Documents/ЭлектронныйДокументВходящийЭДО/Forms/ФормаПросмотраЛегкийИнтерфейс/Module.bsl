...
Процедура ОбработкаОповещения(ИмяСобытия, Параметр, Источник)
	...
	Если ИмяСобытия = ИнтерфейсДокументовЭДОКлиент.ИмяСобытияОбновленияСостоянияЭДО()
		...
		Если ОбработатьОповещение Или ТребуетсяОднородностьОтвета Тогда
...
Процедура ПослеЗаписи(ПараметрыЗаписи)
	...
	Если Объект.ИспользоватьЦентрЭДО Тогда
		...
		МодульЭлектронныеДокументыЭДОИнтеграцияЦентраЭДОКлиент.ИзменитьДанныеВходящегоДокументаВЦентреЭДО(
...
&НаКлиенте
Процедура ВидДокументаДляРедактированияПриИзменении(Элемент)
...
&НаКлиенте
Процедура НомерДокументаДляРедактированияПриИзменении(Элемент)
	Модифицированность = Истина;
КонецПроцедуры

&НаКлиенте
Процедура ДатаДокументаДляРедактированияПриИзменении(Элемент)
	Модифицированность = Истина;
КонецПроцедуры

&НаКлиенте
Процедура СуммаДокументаДляРедактированияПриИзменении(Элемент)
	Модифицированность = Истина;
КонецПроцедуры

&НаКлиенте
Процедура ГруппаСтраницыПанельЗакладокПриСменеСтраницы(Элемент, ТекущаяСтраница)
...
Процедура ОтказатьсяОтПодписания(Команда)
	ЛегкийИнтерфейсДокументовЭДОКлиент.ВыполнитьДействиеОтказатьсяОтПодписанияИзКарточкиДокумента(ЭтотОбъект, ЭтоПакетДокументов);
КонецПроцедуры

&НаКлиенте
Процедура ЗапроситьУточнение(Команда)

	ЛегкийИнтерфейсДокументовЭДОКлиент.ВыполнитьДействиеЗапроситьУточнениеИзКарточкиДокумента(ЭтотОбъект,
		ЭтоПакетДокументов);
...
Процедура ОтправитьСообщение(Команда)
	...
	ЛегкийИнтерфейсДокументовЭДОКлиент.ВыполнитьДействиеОтправитьСообщение(ЭтотОбъект);
...
Процедура ОтказатьсяОтПодписанияДокумент(Команда)
	ЛегкийИнтерфейсДокументовЭДОКлиент.ВыполнитьДействиеОтказатьсяОтПодписанияИзКарточкиДокумента(ЭтотОбъект);
КонецПроцедуры
...
Процедура ОткрытьФайл(Команда)
	ЛегкийИнтерфейсДокументовЭДОКлиент.ОткрытьФайлИнформацииОтправителяДокумента(
		Объект.Ссылка, Объект.ИспользоватьЦентрЭДО, УникальныйИдентификатор);
КонецПроцедуры
...
Процедура ОбновитьДанныеДляПросмотраДокумента()
	...
	ДанныеКомпонентов = ЛегкийИнтерфейсДокументовЭДО.НовыеДанныеКомпонентовПросмотраДокумента(
		...
		|ПанельРеквизитовВходящегоДокументаДляРедактирования, ПанельСообщений");
...
Процедура ОбновитьВизуализациюДокументаНаСервере()
	...
	ДанныеКомпонентов = ЛегкийИнтерфейсДокументовЭДО.НовыеДанныеКомпонентовПросмотраДокумента(
		...
		|ПанельПредставленияФайла, ПанельРеквизитовВходящегоДокументаДляРедактирования");
...
Процедура ОбновитьДанныеПослеИзмененияОбъектовУчетаНаСервере()
	...
	ДанныеКомпонентов = ЛегкийИнтерфейсДокументовЭДО.НовыеДанныеКомпонентовПросмотраДокумента(
		"ПанельСостояния, ПанельОтраженияВУчете, ПанельПакета");
...
Процедура СоставПакетаПослеАктивизацииСтроки()
	...
	Если Модифицированность Тогда
		ЗаписатьДокументПриИзмененииТекущегоДокументаПакета(ТекущийДокументПакета);
		Возврат;
	КонецЕсли;
...
&НаКлиенте
Процедура ЗаписатьДокументПриИзмененииТекущегоДокументаПакета(НовыйТекущийДокумент)
	
	Если Не Записать() Тогда
		Возврат;
	КонецЕсли;
	
	ТекущийДокументПакета = НовыйТекущийДокумент;
