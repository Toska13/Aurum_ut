	...
	Иначе
		...
		Если ЗначениеЗаполнено(ДоговорЭквайринга) Тогда
			...
			Если ОтражатьКомиссию Тогда
				ВестиУчетКомиссииВоВзаиморасчетах = ЗначенияРеквизитов.ВестиУчетКомиссииВоВзаиморасчетах;
				ОбъектРасчетовКомиссии = ЗначенияРеквизитов.ОбъектРасчетовКомиссии;
			КонецЕсли;
		КонецЕсли;
	КонецЕсли;
...
Процедура ИнициализироватьДокумент(ДанныеЗаполнения = Неопределено)
	...
	Если ЗначениеЗаполнено(ДоговорЭквайринга) Тогда
		...
		ОтразитьКомиссиюПоДоговоруЭквайринга(ЗначенияРеквизитов);
	...
	ИначеЕсли ТипЗнч(ДанныеЗаполнения) = Тип("Структура") И ДанныеЗаполнения.Свойство("Организация") Тогда
		...
		ДоговорЭквайрингаРеквизиты = Справочники.ДоговорыЭквайринга.РеквизитыДоговора(ДоговорЭквайринга);
		ОтразитьКомиссиюПоДоговоруЭквайринга(ДоговорЭквайрингаРеквизиты);
...
Процедура ОтразитьКомиссиюПоДоговоруЭквайринга(РеквизитыДоговораЭквайринга)
	
	Если ХозяйственнаяОперация = Перечисления.ХозяйственныеОперации.ПоступлениеОплатыОтКлиента Тогда
		ОтражатьКомиссию = (РеквизитыДоговораЭквайринга.СпособОтраженияКомиссии = Перечисления.СпособыОтраженияЭквайринговойКомиссии.ВоВремяТранзакции);
	...
	Если ЗначениеЗаполнено(РеквизитыДоговораЭквайринга.ПодразделениеРасходов) Тогда
	...
	Если ОтражатьКомиссию Тогда
		...
		Иначе
			СтавкаКомиссии = 0;
		КонецЕсли;
		ЗаполнитьЗначенияСвойств(ЭтотОбъект, РеквизитыДоговораЭквайринга, "СтатьяРасходов, АналитикаРасходов,
