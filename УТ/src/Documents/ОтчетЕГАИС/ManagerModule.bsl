...
//
// Возвращаемое значение:
//  Массив Из ПеречислениеСсылка.СтатусыОбработкиОтчетаЕГАИС - Статусы ошибок.
//
...
// 
// Возвращаемое значение:
//  Массив Из ПеречислениеСсылка.СтатусыОбработкиОтчетаЕГАИС - Конечные статусы.
...
//    * ВНаличииЕГАИС - Массив Из СправочникСсылка.ШтрихкодыУпаковокТоваров - марки в наличии по данным ЕГАИС, отсутствующие в базе
//    * ОтсутствуютЕГАИС - Массив Из СправочникСсылка.ШтрихкодыУпаковокТоваров - марки, не числившиеся по данным ЕГАИС, в наличии в базе
...
//   * ВНаличииЕГАИС    - Массив Из СправочникСсылка.ШтрихкодыУпаковокТоваров - марки в наличии по данным ЕГАИС, отсутствующие в базе
//   * ОтсутствуютЕГАИС - Массив Из СправочникСсылка.ШтрихкодыУпаковокТоваров - марки, не числившиеся по данным ЕГАИС, в наличии в базе
//   * Списать          - Массив Из СправочникСсылка.ШтрихкодыУпаковокТоваров - марки, отмеченные в базе к списанию
//   * Оприходовать     - Массив Из СправочникСсылка.ШтрихкодыУпаковокТоваров - марки, отмеченные в базе к оприходованию
//
Функция ОтработатьРасхожденияЗапросОтчетаОстаткиВРегистре3(ДокументСсылка, ОбработатьРасхождения = Неопределено, ПринятьЕГАИС = Истина) Экспорт
	...
	РеквизитыЗаписи = "ОрганизацияЕГАИС, АкцизнаяМарка, Статус, Справка2, Основание";
	ДанныеЗаписи = Новый Структура(РеквизитыЗаписи);
