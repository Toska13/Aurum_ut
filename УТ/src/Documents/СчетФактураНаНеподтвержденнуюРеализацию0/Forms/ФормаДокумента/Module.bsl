...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ПолучитьФункциональнуюОпцию("УправлениеТорговлей") Тогда
		Элементы.ТоварыКодОперации.Видимость = Ложь;
	КонецЕсли;
...
Процедура СформироватьСтрокуРасчетноПлатежныхДокументов(НовыйАдресВХранилище)
	...
	СтрокаНомеровИДатаАвансов = Документы.СчетФактураВыданный.СтрокаАвансовыеСчетаФактуры(Объект.ПлатежноРасчетныеДокументы);
	...
	Если Объект.СтрокаАвансовыеСчетаФактуры <> СтрокаНомеровИДатаАвансов Тогда
		Объект.СтрокаАвансовыеСчетаФактуры = СтрокаНомеровИДатаАвансов;
	КонецЕсли;
