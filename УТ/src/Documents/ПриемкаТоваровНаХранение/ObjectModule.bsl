...
Процедура ОбработкаПроверкиЗаполнения(Отказ, ПроверяемыеРеквизиты)
	...
	ПараметрыУказанияСерий = НоменклатураСервер.ПараметрыУказанияСерий(ЭтотОбъект, Документы.ПриемкаТоваровНаХранение);
...
Процедура ЗаполнитьДокументНаОснованииЗаказаПоставщику(Знач ДокументОснование, Знач СкладПоступления = Неопределено,
	...
	Если Не РеквизитыЗаказа = Неопределено Тогда
...
Процедура КорректировкаИсправленияДокументаНаОснованииАктаОРасхожденияхПослеПоступления(ДанныеЗаполнения)
	...
	Если ПоступлениеПоЗаказам Тогда
		КолонкиОтбора = "КодСтроки, ЗаказПоставщику, " + КолонкиОтбора;
	КонецЕсли;
