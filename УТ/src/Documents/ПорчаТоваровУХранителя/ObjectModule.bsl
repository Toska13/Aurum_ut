...
Процедура ПроверитьСтавкиНДС(Отказ)
	...
	СписокНоменклатура = Товары.ВыгрузитьКолонку("Номенклатура");
	НоменклатураОприходование = Товары.ВыгрузитьКолонку("НоменклатураОприходование");
	ОбщегоНазначенияКлиентСервер.ДополнитьМассив(СписокНоменклатура, НоменклатураОприходование, Истина);
	
	СтавкиНДС = УчетНДСУП.СтавкиНДСПоМассивуНоменклатуры(СписокНоменклатура, Организация, Дата);
