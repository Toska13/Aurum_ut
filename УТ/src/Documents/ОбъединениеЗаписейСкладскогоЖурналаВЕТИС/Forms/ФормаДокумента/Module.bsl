...
Процедура ОбъединяемыеЗаписиСкладскогоЖурналаВыбор(Элемент, ВыбраннаяСтрока, Поле, СтандартнаяОбработка)
	...
	ИначеЕсли Поле = Элементы.ОбъединяемыеЗаписиСкладскогоЖурналаЗаписьСкладскогоЖурналаПродукция
		...
		ПродукцияЗаписи = ПродукцияЗаписиСкладскогоЖурнала(ТекущиеДанные.ЗаписьСкладскогоЖурнала);
...
&НаСервереБезКонтекста
Функция ПродукцияЗаписиСкладскогоЖурнала(ЗаписьСкладскогоЖурнала)
	Возврат ОбщегоНазначения.ЗначениеРеквизитаОбъекта(ЗаписьСкладскогоЖурнала, "Продукция");
КонецФункции
