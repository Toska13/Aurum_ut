...
// 
// Параметры:
//  СтруктураПараметров - Произвольный - объект расчета (непосредственно, в структуре или отсутствует),
//  
// Возвращаемое значение:
...
// Обработка загрузки полученных данных.
// 
// Параметры:
//  ЭлементОчереди - Структура - Элемент очереди
//  ПараметрыОбмена - Структура - Параметры обмена
//  ПолученныеДанные - Структура - Полученные данные
//  ИзмененныеОбъекты - Массив Из ЛюбаяСсылка - Измененные объекты
...
Функция СообщенияСозданиеМестФормированияПартий(ДокументСсылка, ДополнительныеПараметры)
	...
	Для Каждого СтрокаТовары Из Товары Цикл
		...
		ИнтеграцияЗЕРНОСлужебный.ЗаполнитьСвойствоXDTO(СтрокаТоварыXDTO, "PlaceOfFormation", МестоХраненияXDTO, АбстрактноеСообщениеXML);
