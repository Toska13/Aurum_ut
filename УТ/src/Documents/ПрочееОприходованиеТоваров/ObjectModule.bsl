...
Процедура ОбработкаПроверкиЗаполнения(Отказ, ПроверяемыеРеквизиты)
	...
	ПараметрыУказанияСерий = НоменклатураСервер.ПараметрыУказанияСерий(ЭтотОбъект, Документы.ПрочееОприходованиеТоваров);
...
Процедура ЗаполнитьДокументНаОснованииПередачиВЭксплуатацию(ДокументОснование)
	...
	|
	|	ВЫБОР
	|		КОГДА Товары.Ссылка.НаправлениеДеятельностиРасходовУказаноВСписке
	|			ТОГДА Товары.НаправлениеДеятельности
	|		ИНАЧЕ Товары.Ссылка.НаправлениеДеятельности
...
Функция ВременныеТаблицыДанныхДокумента() Экспорт
	...
	|	ТаблицаТоваров.СтатьяРасходовДоходов КАК СтатьяРасходов,
	...
	|ИЗ
	|	ТаблицаТоваров КАК ТаблицаТоваров
	|		ЛЕВОЕ СОЕДИНЕНИЕ Документ.ПрочееОприходованиеТоваров КАК СохраненныеДанные
