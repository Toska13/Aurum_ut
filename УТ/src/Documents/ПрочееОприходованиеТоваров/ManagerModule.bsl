...
// 
// Параметры:
//  ОбъектИлиСсылка - ДокументОбъект.ПрочееОприходованиеТоваров, ДокументСсылка.ПрочееОприходованиеТоваров - документ.
...
Функция РеквизитыКонтролируемойПартии(ОбъектИлиСсылка, ИмяПоляКонтролируемаяПартия) Экспорт
	...
	Реквизиты.Отправитель = РеквизитыОбъекта.Подразделение;
...
Функция ОписаниеОперацийУчетаСебестоимости(Документ) Экспорт
	...
	|	0															КАК ДопРасходыУпр,
	|	ВЫБОР 
	|		КОГДА ТаблицаДокумента.ХозяйственнаяОперация = ЗНАЧЕНИЕ(Перечисление.ХозяйственныеОперации.ОприходованиеЗаСчетДоходов)
	|			ТОГДА ВЫБОР 
	...
	|				КОНЕЦ 
	|		ИНАЧЕ ВЫБОР
	|				КОГДА ТаблицаВидыЗапасов.СтатьяРасходов.ПринятиеКналоговомуУчету = ЛОЖЬ
	|					ТОГДА ТаблицаВидыЗапасов.СуммаРегл
	|				ИНАЧЕ 0
	|			КОНЕЦ
	|	КОНЕЦ 												 		КАК ПостояннаяРазница,
