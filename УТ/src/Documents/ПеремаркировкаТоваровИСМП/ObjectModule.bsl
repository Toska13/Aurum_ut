...
Процедура ПередЗаписью(Отказ, РежимЗаписи, РежимПроведения)
	...
	Если ТребуетсяИндивидуализацияКИЗ
		И Не КонструкторИСМПОбщегоНазначенияКлиентСервер.ЭтоПродукцияПоддерживающаяИндивидуализациюКИЗ(ТоварнаяГруппа) Тогда
...
Процедура ПроверитьДоступныеПричиныПеремаркировки()
	...
	ДоступныеПричины = ПеремаркировкаТоваровКлиентСервер.ДопустимыеПричиныПеремаркировкиКодовМаркировки(ТоварнаяГруппа);
	
	Для Каждого Строка Из Товары Цикл
		Если ДоступныеПричины.Найти(Строка.ПричинаПеремаркировки) = Неопределено Тогда
