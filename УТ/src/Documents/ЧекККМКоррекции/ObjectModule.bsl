...
Процедура ПередЗаписью(Отказ, РежимЗаписи, РежимПроведения)
	...
	ЧекККМКоррекцииЛокализация.ПередЗаписью(ЭтотОбъект, Отказ, РежимЗаписи, РежимПроведения);
...
Процедура ЗаполнитьДокументПоЧекуККМ(ДокументОснование)
	...
	ПолученоНаличными = СуммаДокумента - ОплатаПлатежнымиКартами.Итог("Сумма") - ПодарочныеСертификаты.Итог("Сумма");
