...
Процедура ОбработкаЗаписиНового(НовыйОбъект, Источник, СтандартнаяОбработка)
	...
	СобытияФормИСКлиентПереопределяемый.ОбработкаВыбораНоменклатуры(ОписаниеОповещения, НовыйОбъект, Источник);
...
Процедура ОперацияПриИзменении(Элемент)
	...
	Если Объект.Операция <> ПредопределенноеЗначение("Перечисление.ВидыОперацийСАТУРН.НакладнаяЭкспорт") Тогда
		Объект.СтранаЭкспортер           = Неопределено;
		Объект.СтранаИмпортер            = Неопределено;
		Объект.ТипТранспорта             = Неопределено;
		Объект.ТерриториальноеУправление = Неопределено;
		Объект.ТаможенныйПункт           = Неопределено;
	КонецЕсли;
...
Процедура ТоварыНоменклатураСоздание(Элемент, СтандартнаяОбработка)
	...
	СобытияФормСАТУРНКлиент.ПриСозданииНоменклатуры(Элемент, Элементы.Товары.ТекущиеДанные, СтандартнаяОбработка);
...
&НаКлиенте
Процедура ТоварыКоличествоУпаковокОкончаниеВводаТекста(Элемент, Текст, ДанныеВыбора, ПараметрыПолученияДанных, СтандартнаяОбработка)
	...
	КоличествоОтгружено = ОписаниеТипаЧисло.ПривестиЗначение(Текст);
	
	Если КоличествоОтгружено < ТекущиеДанные.КоличествоУпаковокПринято Тогда
...
Процедура ТоварыУпаковкаПриИзменении(Элемент)
	...
	ТекущиеДанные = Элементы.Товары.ТекущиеДанные;
	ПараметрыЗаполнения = ПараметрыЗаполненияСтроки();
	ПараметрыЗаполнения.ПересчитатьКоличествоУпаковок = Объект.ВходящаяНакладная;
	ПараметрыЗаполнения.КоличествоСуффикс = ",Принято,Возвращено";
...
Процедура ТоварыПартияНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	...
	ПослеВыбораПартии = Новый ОписаниеОповещения("ПослеВыбораПартииВТабличнойЧасти", ЭтотОбъект);
	
	ОткрытьФорму("РегистрНакопления.ОстаткиПартийСАТУРН.Форма.ФормаОстатков",
		ПараметрыФормы, Элемент,,,, ПослеВыбораПартии, РежимОткрытияОкнаФормы.БлокироватьОкноВладельца);
...
Процедура ТоварыПартияОбработкаВыбора(Элемент, ВыбранноеЗначение, СтандартнаяОбработка)
	...
	Если ИнтеграцияСАТУРНКлиентСервер.ЭтоВыборПартииСАТУРН(ВыбранноеЗначение) Тогда
		...
		Если ВыбранноеЗначение.КоличествоСАТУРН < ТекущиеДанные.Количество Тогда
			ПараметрыОбработки = СобытияФормСАТУРНКлиент.ПараметрыОбработкиВыбораПартииСНедостаткомКоличества();
			ПараметрыОбработки.Форма                = ЭтотОбъект;
			ПараметрыОбработки.ТекущиеДанные        = ТекущиеДанные;
			ПараметрыОбработки.КэшированныеЗначения = КэшированныеЗначения;
			ОписаниеОповещения = Новый ОписаниеОповещения(
				"Подключаемый_ОбработатьВыборПартииСНедостаткомКоличества",
		...
		Иначе
			СобытияФормСАТУРНКлиент.ОбработатьВыборПартии(ЭтотОбъект, ВыбранноеЗначение, ТекущиеДанные, КэшированныеЗначения);
		КонецЕсли;
...
Процедура УстановитьУсловноеОформление()
	...
	ОтборЭлемента = ЭлементУсловногоОформления.Отбор.Элементы.Добавить(Тип("ЭлементОтбораКомпоновкиДанных"));
	ОтборЭлемента.ЛевоеЗначение  = Новый ПолеКомпоновкиДанных(Элементы.ТоварыКоличествоПринятоСАТУРН.ПутьКДанным);
	ОтборЭлемента.ВидСравнения   = ВидСравненияКомпоновкиДанных.Равно;
	ОтборЭлемента.ПравоеЗначение = Новый ПолеКомпоновкиДанных(Элементы.ТоварыКоличествоСАТУРН.ПутьКДанным);
...
Процедура ПриСозданииЧтенииНаСервере(ОбновитьКомандыОснования = Истина)
	...
	ГрузополучательСопоставленСОрганизацией = ИнтеграцияСАТУРНВызовСервера.ОрганизацияСАТУРНСопоставленаСОрганизациейИБ(
		ГрузополучательОрганизацияСАТУРН(ЭтотОбъект).Значение).Сопоставлено;
	...
	СобытияФормИСКлиентСерверПереопределяемый.УстановитьПараметрыВыбораНоменклатуры(
		ЭтотОбъект, КонструкторИСОбщегоНазначенияКлиентСервер.ВидыПродукцииСАТУРН());
...
Процедура НастроитьЗависимыеЭлементыФормы(Форма, СписокРеквизитов = "")
	...
	СтатусВозвращеноУтрачено = СтатусВозвращен
		...
		Или Форма.СтатусСАТУРН = ПредопределенноеЗначение("Перечисление.СтатусыОбработкиНакладнойСАТУРН.УтраченПриВозврате");
	...
	Если Инициализация Тогда
		...
		Элементы.ТоварыКоличествоУпаковок.ТолькоПросмотр = Форма.УпаковкиИспользуются И ЭтоВходящаяНакладная;
	...
	Если Инициализация Или СтруктураРеквизитов.Свойство("Операция") Тогда
		...
		Элементы.ИдентификаторГосКонтракта.Видимость               = Не ЭтоЭкспорт;
		Элементы.Перевозчик.Видимость                              = Не ЭтоЭкспорт;
		Элементы.Контрагент.Видимость                              = ЭтоЭкспорт;
		Элементы.ТоварыКодТНВЭД.Видимость                          = ЭтоЭкспорт;
		Элементы.СтранаИмпортер.Видимость                          = ЭтоЭкспорт;
		Элементы.СтранаЭкспортер.Видимость                         = ЭтоЭкспорт;
		Элементы.ТипТранспорта.Видимость                           = ЭтоЭкспорт;
		Элементы.ТерриториальноеУправление.Видимость               = ЭтоЭкспорт;
		Элементы.ТаможенныйПункт.Видимость                         = ЭтоЭкспорт;
		Элементы.ГосударственныйКонтракт.Видимость                 = Не ЭтоЭкспорт И Форма.ГосударственныеКонтрактыИспользуются;
	...
	Если Инициализация Или СтруктураРеквизитов.Свойство("Операция") Или СтруктураРеквизитов.Свойство("ТипТранспорта")  Тогда
		...
		Элементы.НомерТранспортногоСредства.Видимость   = ЭтоЭкспорт И ЭтоАвтоперевозка Или Не ЭтоЭкспорт;
		Элементы.НомерТранспортногоПрицепа.Видимость    = ЭтоЭкспорт И ЭтоАвтоперевозка;
		Элементы.НомерТранспортногоКонтейнера.Видимость = ЭтоЭкспорт;
		Элементы.НомерТранспортногоРейса.Видимость      = ЭтоЭкспорт И ЭтоАвиаперевозка;
		Элементы.НомерПломбы.Видимость                  = ЭтоЭкспорт;
		Элементы.ТранспортноеСредство.Видимость = (Не ЭтоЭкспорт И Форма.УказываетсяТранспортноеСредство
			Или ЭтоЭкспорт И ЭтоАвтоперевозка);
...
Процедура ОбновитьСтатусСАТУРН()
	...
	РедактированиеРеквизитовПриемки = ГрузополучательСопоставленСОрганизацией
	                                     ...
	                                     Или СтатусСАТУРН = Перечисления.СтатусыОбработкиНакладнойСАТУРН.ОтправленНаУтилизацию
	                                     Или СтатусСАТУРН = Перечисления.СтатусыОбработкиНакладнойСАТУРН.КВозврату
	                                     Или СтатусСАТУРН = Перечисления.СтатусыОбработкиНакладнойСАТУРН.КВозвратуЧастично)
...
Процедура ОбработатьНажатиеНавигационнойСсылки(НавигационнаяСсылкаФорматированнойСтроки)
	...
	Если НавигационнаяСсылкаФорматированнойСтроки = "ПередатьДанные"
		...
		Или НавигационнаяСсылкаФорматированнойСтроки = "ПередатьНаДосмотр"
		Или НавигационнаяСсылкаФорматированнойСтроки = "ПодтвердитьЭкспорт"
		Или НавигационнаяСсылкаФорматированнойСтроки = "ПодтвердитьУтилизацию"
		Или НавигационнаяСсылкаФорматированнойСтроки = "ОтклонитьЭкспорт" Тогда
		...
		ИначеЕсли НавигационнаяСсылкаФорматированнойСтроки = "ПодтвердитьУтилизацию" Тогда
			ПараметрыОбработкиДокументов.ДальнейшееДействие = ПредопределенноеЗначение("Перечисление.ДальнейшиеДействияПоВзаимодействиюСАТУРН.ПодтвердитеУтилизацию");
	...
	ИначеЕсли НавигационнаяСсылкаФорматированнойСтроки = "ПодтвердитьНакладную"
		...
		Или НавигационнаяСсылкаФорматированнойСтроки = "ПодтвердитьУтерюГруза"
		Или НавигационнаяСсылкаФорматированнойСтроки = "ПодтвердитьВозвратЧастично"
		Или НавигационнаяСсылкаФорматированнойСтроки = "ПодтвердитьУтерюПриВозвратеЧастично" Тогда
		...
		ИначеЕсли НавигационнаяСсылкаФорматированнойСтроки = "ПодтвердитьВозвратЧастично" Тогда
			ПараметрыОбработкиДокументов.ДальнейшееДействие = ПредопределенноеЗначение("Перечисление.ДальнейшиеДействияПоВзаимодействиюСАТУРН.ПодтвердитеВозвратЧастично");
		ИначеЕсли НавигационнаяСсылкаФорматированнойСтроки = "ПодтвердитьУтерюПриВозвратеЧастично" Тогда
			ПараметрыОбработкиДокументов.ДальнейшееДействие = ПредопределенноеЗначение("Перечисление.ДальнейшиеДействияПоВзаимодействиюСАТУРН.ПодтвердитеУтерюПриВозвратеЧастично");
		КонецЕсли;
...
Процедура ЗаполнитьГиперссылкиРеквизитов(ИмяХозяйствующегоСубъекта = Неопределено)
	...
	Если ИмяХозяйствующегоСубъекта = Неопределено Тогда
		...
		ДанныеГрузополучателя = ГрузополучательОрганизацияСАТУРН(ЭтотОбъект);
		
		ПараметрПредставления = ИнтеграцияСАТУРН.НовыеПараметрыФормированияПредставленияСопоставлений();
		ПараметрПредставления.Префикс                                = "Грузополучатель";
		
		ПараметрПредставления.ОрганизацияСАТУРН                      = ДанныеГрузополучателя.Значение;
		ПараметрПредставления.ДополнительныйПрефиксПолученияЗначения = ДанныеГрузополучателя.Префикс;
	...
	Иначе
		...
		Если ИмяХозяйствующегоСубъекта = "Грузополучатель" Тогда
			...
			ОрганизацияСАТУРН                                            = ДанныеГрузополучателя.Значение;
			ПараметрПредставления.ДополнительныйПрефиксПолученияЗначения = ДанныеГрузополучателя.Префикс;
...
Функция ГрузополучательОрганизацияСАТУРН(Форма)
	...
	СтруктураВозврата = Новый Структура("Значение, Префикс", Неопределено, "");
	
	Объект = Форма.Объект;
	Если ЗначениеЗаполнено(Объект.ГрузополучательОрганизацияСАТУРН)
		Или Не ВидимостьГрузополучателя(Форма) Тогда
		СтруктураВозврата.Значение = Объект.ГрузополучательОрганизацияСАТУРН;
		СтруктураВозврата.Префикс  = "Грузополучатель";
	ИначеЕсли ЗначениеЗаполнено(Форма.ГрузополучательИзОснованияДляОтбораОрганизацииСАТУРН) Тогда
		СтруктураВозврата.Значение = ПредопределенноеЗначение("Справочник.КлассификаторОрганизацийСАТУРН.ПустаяСсылка");
		СтруктураВозврата.Префикс  = "Грузополучатель";
	Иначе 
		СтруктураВозврата.Значение = Объект.ГрузоотправительОрганизацияСАТУРН;
		СтруктураВозврата.Префикс  = "Грузоотправитель";
	КонецЕсли;
...
Функция ВидимостьГрузополучателя(Форма)
	...
	Объект        = Форма.Объект;
	ЭтоПеревозка  = (Объект.Операция = ПредопределенноеЗначение("Перечисление.ВидыОперацийСАТУРН.НакладнаяПеревозка"));
	ЭтоУтилизация = (Объект.Операция = ПредопределенноеЗначение("Перечисление.ВидыОперацийСАТУРН.НакладнаяУтилизация"));
	ЭтоЭкспорт    = (Объект.Операция = ПредопределенноеЗначение("Перечисление.ВидыОперацийСАТУРН.НакладнаяЭкспортЧерезПунктДосмотра"));
	
	Возврат (ЭтоПеревозка Или ЭтоЭкспорт Или ЭтоУтилизация);
...
&НаКлиенте
Процедура ПослеВыбораПартииВТабличнойЧасти(Результат, ДополнительныеПараметры) Экспорт
...
Функция ПараметрыЗаполненияСтроки(ПриемкаТовара = Ложь)
	...
	ПараметрыЗаполнения = ИнтеграцияСАТУРНКлиентСервер.ПараметрыЗаполненияТабличнойЧасти();
	ПересчетЗапрещен = РедактированиеФормыНедоступно
	...
	ПараметрыЗаполнения.ПересчитатьКоличествоСАТУРН   = Не ПересчетЗапрещен;
	ПараметрыЗаполнения.КоличествоСуффикс             = ",Принято,Возвращено";
...
Процедура НоменклатураПриИзменении(ТекущиеДанные = Неопределено, ПараметрыЗаполнения = Неопределено)
	...
	СобытияФормСАТУРНКлиент.ПриИзмененииНоменклатуры(
...
Функция СтатусыАннулированияГрузоотправителя()
	...
	Результат.Добавить(ПредопределенноеЗначение("Перечисление.СтатусыОбработкиНакладнойСАТУРН.Утилизирован"));
	...
	Результат.Добавить(ПредопределенноеЗначение("Перечисление.СтатусыОбработкиНакладнойСАТУРН.Утрачен"));
	...
	Результат.Добавить(ПредопределенноеЗначение("Перечисление.СтатусыОбработкиНакладнойСАТУРН.НаправленНаЭкспорт"));
	...
	Результат.Добавить(ПредопределенноеЗначение("Перечисление.СтатусыОбработкиНакладнойСАТУРН.АннулированиеПодтвержденияУтилизацииКПередаче"));
	Результат.Добавить(ПредопределенноеЗначение("Перечисление.СтатусыОбработкиНакладнойСАТУРН.АннулированиеПодтвержденияУтилизацииОшибка"));
...
Функция СтатусыАннулированияГрузополучателя()
	...
	Результат.Добавить(ПредопределенноеЗначение("Перечисление.СтатусыОбработкиНакладнойСАТУРН.АннулированиеОшибка"));
	Результат.Добавить(ПредопределенноеЗначение("Перечисление.СтатусыОбработкиНакладнойСАТУРН.УтраченПриВозврате"));
	Результат.Добавить(ПредопределенноеЗначение("Перечисление.СтатусыОбработкиНакладнойСАТУРН.ГрузУтраченПриВозвратеЧастичноОшибка"));
...
Функция СтатусыОбрабатывается()
	...
	Результат.Добавить(ПредопределенноеЗначение("Перечисление.СтатусыОбработкиНакладнойСАТУРН.АннулированиеПодтвержденияУтилизацииОбрабатывается"));
	Результат.Добавить(ПредопределенноеЗначение("Перечисление.СтатусыОбработкиНакладнойСАТУРН.ГрузУтраченПриВозвратеЧастичноОбрабатывается"));
