...
Процедура ДебиторскаяЗадолженностьБезРазбиенияОбъектРасчетовПриИзменении(Элемент)
	...
	ДебиторскаяЗадолженностьБезРазбиенияОбъектРасчетовПриИзмененииНаСервере(ТекущиеДанные.НаправлениеДеятельности, ТекущиеДанные.ОбъектРасчетов);
КонецПроцедуры
...
Процедура ДебиторскаяЗадолженностьОбъектРасчетовПриИзменении(Элемент)
	ОбъектРасчетовРасчетовПриИзменении("ДебиторскаяЗадолженность");
	ТекущиеДанные = Элементы.КредиторскаяЗадолженность.ТекущиеДанные;
	ЗадолженностьОбъектРасчетовПриИзмененииСервер(ТекущиеДанные.НаправлениеДеятельности,ТекущиеДанные.ОбъектРасчетов);
КонецПроцедуры
...
Процедура КредиторскаяЗадолженностьБезРазбиенияОбъектРасчетовПриИзменении(Элемент)
	...
	ТекущиеДанные = Элементы.КредиторскаяЗадолженность.ТекущиеДанные;
	КредиторскаяЗадолженностьБезРазбиенияОбъектРасчетовПриИзмененииНаСервере(ТекущиеДанные.НаправлениеДеятельности,ТекущиеДанные.ОбъектРасчетов);
КонецПроцедуры
...
Функция ЗаполнитьПоДебиторскойЗадолженностиНаСервере(Результат, ДополнительныеПараметры)
	...
	Если Объект.КредиторскаяЗадолженность.Количество() = 0 Тогда
		...
		КонецЕсли;
	ИначеЕсли Объект.КредиторскаяЗадолженность.Количество() = 1 И НЕ ВыбранВидОперацииПроизвольныйИлиБартер() Тогда
		Объект.КредиторскаяЗадолженность[0].ВалютаВзаиморасчетов = Объект.ДебиторскаяЗадолженность[0].ВалютаВзаиморасчетов;
		Объект.КредиторскаяЗадолженность[0].СуммаВзаиморасчетов = Объект.ДебиторскаяЗадолженность.Итог("СуммаВзаиморасчетов");
		Объект.КредиторскаяЗадолженность[0].СуммаРегл = Объект.ДебиторскаяЗадолженность.Итог("СуммаРегл");
		Объект.КредиторскаяЗадолженность[0].СуммаУпр = Объект.ДебиторскаяЗадолженность.Итог("СуммаУпр");
		ИнициализироватьЗадолженность("Кт");
...
Функция ЗаполнитьПоКредиторскойЗадолженностиНаСервере(Результат, ДополнительныеПараметры)
	...
	Если Объект.ДебиторскаяЗадолженность.Количество() = 0 Тогда
		...
		КонецЕсли;
	ИначеЕсли Объект.ДебиторскаяЗадолженность.Количество() = 1 И НЕ ВыбранВидОперацииПроизвольныйИлиБартер() Тогда
		Объект.ДебиторскаяЗадолженность[0].ВалютаВзаиморасчетов = Объект.КредиторскаяЗадолженность[0].ВалютаВзаиморасчетов;
		Объект.ДебиторскаяЗадолженность[0].СуммаВзаиморасчетов = Объект.КредиторскаяЗадолженность.Итог("СуммаВзаиморасчетов");
		Объект.ДебиторскаяЗадолженность[0].СуммаРегл = Объект.КредиторскаяЗадолженность.Итог("СуммаРегл");
		Объект.ДебиторскаяЗадолженность[0].СуммаУпр = Объект.КредиторскаяЗадолженность.Итог("СуммаУпр");
		ИнициализироватьЗадолженность("Дт");
	Иначе
		РассчитатьСуммыВзаимозачетаСервер(СуммаКРаспределению);
		ИнициализироватьЗадолженность("Дт");
...
Процедура УстановитьВидимостьНаправленияДеятельности()
	ВидимостьНаправленияДеятельности = 
		Объект.ВидОперации = Перечисления.ВидыОперацийВзаимозачетаЗадолженности.Произвольный
		И Объект.ТипДебитора <> Перечисления.ТипыУчастниковВзаимозачета.ОрганизацияКлиент
		И Объект.ТипДебитора <> Перечисления.ТипыУчастниковВзаимозачета.ОрганизацияПоставщик
		И Объект.ТипКредитора <> Перечисления.ТипыУчастниковВзаимозачета.ОрганизацияКлиент
		И Объект.ТипКредитора <> Перечисления.ТипыУчастниковВзаимозачета.ОрганизацияПоставщик;
	
	Элементы.КредиторскаяЗадолженностьБезРазбиенияНаправлениеДеятельности.Видимость = ВидимостьНаправленияДеятельности;
	Элементы.КредиторскаяЗадолженностьНаправлениеДеятельности.Видимость = ВидимостьНаправленияДеятельности;
	Элементы.ДебиторскаяЗадолженностьБезРазбиенияНаправлениеДеятельности.Видимость = ВидимостьНаправленияДеятельности;
	Элементы.ДебиторскаяЗадолженностьНаправлениеДеятельности.Видимость = ВидимостьНаправленияДеятельности;
КонецПроцедуры
...
Процедура ЗаполнитьПоОстаткамДебиторскуюЗадолженностьСервер(ПараметрыЗадолженностиКредитор)
	...
	ЗаблокироватьОбъектыРасчетов();
	ЗаполнитьНаправленияДеятельности(Элементы.ДебиторскаяЗадолженность.Имя);
...
Процедура ЗаполнитьПоОстаткамКредиторскуюЗадолженностьСервер(ПараметрыЗадолженностиКредитор)
	...
	ЗаблокироватьОбъектыРасчетов();
	ЗаполнитьНаправленияДеятельности(Элементы.КредиторскаяЗадолженность.Имя);
...
Процедура ОбъектРасчетовОбработкаВыбораСервер(ВидЗадолженности)
	...
	ЗаблокироватьОбъектыРасчетов();
	ЗаполнитьНаправленияДеятельности(?(ВидЗадолженности = "Кт",Элементы.КредиторскаяЗадолженность.Имя,Элементы.ДебиторскаяЗадолженность.Имя));
...
&НаСервере
Процедура ДебиторскаяЗадолженностьБезРазбиенияОбъектРасчетовПриИзмененииНаСервере(НаправлениеДеятельности, ОбъектРасчетов)
	УстановитьДоступностьЭлементовДебиторскаяЗадолженностьБезРазбиения();
	ЗаблокироватьОбъектыРасчетов();
	ЗадолженностьОбъектРасчетовПриИзмененииСервер(НаправлениеДеятельности, ОбъектРасчетов);
КонецПроцедуры

&НаСервере
Процедура КредиторскаяЗадолженностьБезРазбиенияОбъектРасчетовПриИзмененииНаСервере(НаправлениеДеятельности, ОбъектРасчетов)
	УстановитьДоступностьЭлементовКредиторскаяЗадолженностьБезРазбиения();
	ЗаблокироватьОбъектыРасчетов();
	ЗадолженностьОбъектРасчетовПриИзмененииСервер(НаправлениеДеятельности, ОбъектРасчетов);
КонецПроцедуры
...
&НаСервере
Процедура ЗадолженностьОбъектРасчетовПриИзмененииСервер(НаправлениеДеятельности, ОбъектРасчетов)
	ЗаблокироватьОбъектыРасчетов();
	Если ЗначениеЗаполнено(ОбъектРасчетов) И Объект.ВидОперации = ПредопределенноеЗначение("Перечисление.ВидыОперацийВзаимозачетаЗадолженности.Произвольный") Тогда
		НаправлениеДеятельности = ОбщегоНазначения.ЗначениеРеквизитаОбъекта(ОбъектРасчетов, "НаправлениеДеятельности");
	Иначе
		НаправлениеДеятельности = Справочники.ОбъектыРасчетов.ПустаяСсылка();
	КонецЕсли;
КонецПроцедуры

&НаСервере
Процедура ЗаполнитьНаправленияДеятельности(ИмяТЧ = "")
	
	МассивОбъектовРасчетов = Объект.ДебиторскаяЗадолженность.Выгрузить().ВыгрузитьКолонку("ОбъектРасчетов");
	ОбщегоНазначенияКлиентСервер.ДополнитьМассив(МассивОбъектовРасчетов, Объект.КредиторскаяЗадолженность.Выгрузить().ВыгрузитьКолонку("ОбъектРасчетов"));
	СоответствиеНаправлений = ОбщегоНазначения.ЗначениеРеквизитаОбъектов(МассивОбъектовРасчетов, "НаправлениеДеятельности");
	
	Если ИмяТЧ = "" ИЛИ ИмяТЧ = Элементы.ДебиторскаяЗадолженность.Имя Тогда
	...
	Если ИмяТЧ = "" ИЛИ ИмяТЧ = Элементы.КредиторскаяЗадолженность.Имя Тогда
...
Процедура ОткрытьФормуВыбораОбъектовРасчетов(Элемент, ЗначенияОтбора, ЕщеНастройкиВыбора = Неопределено)
	...
	Если ЕщеНастройкиВыбора <> Неопределено Тогда
		...
		КонецЦикла;
	КонецЕсли;
	ОчиститьВалютуВзаиморасчетов();//очистим валюту взаиморасчетов если в документе не указаны другие объекты расчетов
