...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если СтороннийТорговыйОбъектЗначениеПоУмолчанию = Неопределено Тогда
		Элементы.СписокТорговыйОбъект.Видимость = Ложь;
	КонецЕсли;
	
	ПравоИзменения = ПравоДоступа("Изменение", Метаданные.Документы.ТТНВходящаяЕГАИС) ИЛИ Пользователи.ЭтоПолноправныйПользователь();
	Элементы.СписокПодтвердитьПолучение.Доступность        = ПравоИзменения;
	Элементы.СписокОтказатьсяОтНакладной.Доступность       = ПравоИзменения;
	Элементы.СписокОформитьДокументПоступления.Доступность = ПравоИзменения;
	УпрощеннаяИнтеграцияБЭД = Не ИнтеграцияИС.УпрощеннаяИнтеграцияБЭД();
	Элементы.СписокОформитьДокументПоступления.Видимость = УпрощеннаяИнтеграцияБЭД;
	Элементы.СписокПоступлениеТоваров.Видимость          = УпрощеннаяИнтеграцияБЭД;
	Элементы.СписокЕстьРасхождения.Видимость             = УпрощеннаяИнтеграцияБЭД;
	...
	ИнтеграцияИС.УстановитьВидимостьОтветственный(ЭтотОбъект, Ложь);
	ИнтеграцияИС.УстановитьНавигационнуюСсылкуФормыСпискаДокументов(ЭтотОбъект);
	ИнтеграцияЕГАИС.УстановитьВидимостьОрганизацияЕГАИСВСпискахДокументов(ЭтотОбъект, "Оформлено", "СписокОрганизация");
