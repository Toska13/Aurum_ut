...
Процедура ПриОпределенииМетодовРазрешенныхДляВызоваКакПроизвольныйКод(Методы) Экспорт
	...
	Методы.Вставить("ПолучитьСведенияХозяйствующегоСубъекта", Истина);
...
Процедура ПолучитьСведенияХозяйствующегоСубъекта(СтруктураПараметров, АдресВоВременномХранилище) Экспорт
	...
	СтруктураДанных.Вставить("АдресДанныхЛогаЗапроса",      Неопределено);
	СтруктураДанных.Вставить("ИзвлекатьДанныеЛогаЗапросов", ОбщегоНазначенияИСВызовСервера.ЭтоФоновоеЗаданиеНаСервере());
	
	Если СтруктураПараметров.Свойство("ПараметрыЛогированияЗапросовВЕТИС") Тогда
		ЛогированиеЗапросовВЕТИС.УстановитьПараметрыЛогированияЗапросов(СтруктураПараметров.ПараметрыЛогированияЗапросовВЕТИС);
		ЛогированиеЗапросовИС.НастроитьПараметрыЛогированияВФоновомЗадании(СтруктураПараметров.ПараметрыЛогированияЗапросовВЕТИС);
		ЛогированиеЗапросовВЕТИС.УстановитьПараметрыЛогированияЗапросов(СтруктураПараметров.ПараметрыЛогированияЗапросовВЕТИС);
	КонецЕсли;
	...
	ИнтеграцияВЕТИСВызовСервера.ЗаписатьЛогЗапросовВоВременноеХранилищеВозвращаемогоЗначения(СтруктураПараметров, СтруктураДанных);
...
Процедура ЗаписатьСведенияХозяйствующегоСубъекта(СтруктураДанных, Отказ)
	...
	Исключение
		...
		СообщитьОбОшибке(ЗаголовокОшибки, ОбработкаОшибок.КраткоеПредставлениеОшибки(ИнформацияОбОшибке()));
