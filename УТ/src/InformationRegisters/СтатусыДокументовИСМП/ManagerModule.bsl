...
//   * НовыйСтатус - ОпределяемыйТип.СтатусыОбработкиДокументовИСМП - Новый статус.
...
//
// Возвращаемое значение:
//  ОпределяемыйТип.СтатусыОбработкиДокументовИСМП - новый статус документа ИС МП.
//
...
// 
// Параметры:
//  ДокументСсылка - ДокументСсылка - Документ для которого выполняется расчет статусов
//  СтатусОбработки - ПеречислениеСсылка.СтатусыОбработкиСообщенийИСМП - Статус обработки
//  Статусы - Структура - Статусы
// 
// Возвращаемое значение:
//  Неопределено, См. ВозвращаемоеЗначениеДальнейшиеДействияСтатус - 
...
Функция Архивировать(ДокументыКАрхивированию) Экспорт
	...
	Для Каждого ДокументСсылка Из ДокументыКАрхивированию Цикл
		...
		ОтменитьРазрешениеНаОтгрузку = (РазрешенияКПересчетуСтатусов.Найти(ДокументСсылка) <> Неопределено);
		
		НачатьТранзакцию();
		
		Попытка
			
			Если ОтменитьРазрешениеНаОтгрузку Тогда
			...
			Если ОтменитьРазрешениеНаОтгрузку Тогда
				МодульРасчетСтатусовОформленияИСМП = ОбщегоНазначенияИСПовтИсп.ОбщийМодуль("РасчетСтатусовОформленияИСМП");
...
// 
// Параметры:
//  Статус - ОпределяемыйТип.СтатусыОбработкиДокументовИСМП - Статус
//  ДальнейшиеДействия - Массив Из ПеречислениеСсылка.ДальнейшиеДействияПоВзаимодействиюИСМП - Дальнейшие действия
// 
// Возвращаемое значение:
...
// * ДальнейшееДействие2 - ПеречислениеСсылка.ДальнейшиеДействияПоВзаимодействиюИСМП - 
// * ДальнейшееДействие3 - ПеречислениеСсылка.ДальнейшиеДействияПоВзаимодействиюИСМП - 
