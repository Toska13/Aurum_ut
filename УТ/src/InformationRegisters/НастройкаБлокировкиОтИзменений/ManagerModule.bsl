...
// 	** ПервыйПериод - Дата -
// 	** ИмяРегистра - Строка -
// 	** Операция - СправочникСсылка.ОперацииЗакрытияМесяца -
Функция СведенияОБлокировкеОтИзменений(Организации, Период = Неопределено, ОбновлениеИБ = Ложь) Экспорт
	...
	Запрос.УстановитьПараметр("НеиспользуемыеОперацииЗакрытияМесяца", Справочники.ОперацииЗакрытияМесяца.НеиспользуемыеОперации());
...
// Первый/последний незаблокированный период.
// 
// Параметры:
//  Организации - Массив из СправочникСсылка.Организации - Организации
//  Первый - Булево - получает первый незаблокированный период, в противном случае - последний
//  	Значение по умолчанию: Истина.
// 
// Возвращаемое значение:
//  Дата - Первый/последний (в зависимости от параметра) незаблокированный период
Функция НезаблокированныйПериод(Организации, Первый = Истина) Экспорт
	...
	Запрос.Текст = СтрЗаменить(Запрос.Текст, "МИНИМУМ", ?(Первый, "МИНИМУМ", "МАКСИМУМ"));
	Запрос.УстановитьПараметр("Организации", Организации);
