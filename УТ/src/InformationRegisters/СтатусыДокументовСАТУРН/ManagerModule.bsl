...
//
// Параметры:
//  СсылкаНаОформляемыйДокумент - См. РегистрСведений.СтатусыДокументовСАТУРН.Документ
//  ИдентификаторСтроки - Строка - идентификатор строки.
// 
// Возвращаемое значение:
//	Структура - Структура со свойствами:
//   * Документ - См. РегистрСведений.СтатусыДокументовСАТУРН.Документ
//   * Статус - См. РегистрСведений.СтатусыДокументовСАТУРН.Статус
//   * ИдентификаторСтроки - Строка - идентификатор строки.
//   * ДальнейшееДействие1 - ПеречислениеСсылка.ДальнейшиеДействияПоВзаимодействиюСАТУРН - Дальнейшее действие.
//   * ДальнейшееДействие2 - ПеречислениеСсылка.ДальнейшиеДействияПоВзаимодействиюСАТУРН - Дальнейшее действие.
//   * ДальнейшееДействие3 - ПеречислениеСсылка.ДальнейшиеДействияПоВзаимодействиюСАТУРН - Дальнейшее действие.
//
Функция ЗначенияПоУмолчанию(СсылкаНаОформляемыйДокумент, ИдентификаторСтроки = "") Экспорт
	...
	СтруктураЗначенияПоУмолчанию.Вставить("Статус",              МенеджерОбъекта.СтатусПоУмолчанию(СтруктураПараметров));
	...
	СтруктураЗначенияПоУмолчанию.Вставить("ДальнейшееДействие1", СтекДействий[0]);
	СтруктураЗначенияПоУмолчанию.Вставить("ДальнейшееДействие2", СтекДействий[1]);
	СтруктураЗначенияПоУмолчанию.Вставить("ДальнейшееДействие3", СтекДействий[2]);
...
//
// Параметры:
//  ДанныеЗаписи - См. ЗначенияПоУмолчанию - данные для записи в регистр
//
...
//  СтатусОбработки - ПеречислениеСсылка.СтатусыОбработкиСообщенийСАТУРН - Статус обработки
//  Статусы - Структура - Статусы
// 
// Возвращаемое значение:
//  Неопределено - 
//  См. ВозвращаемоеЗначениеДальнейшиеДействияСтатус - 
