...
Функция ПодставитьСоединение(ТекстЗапроса, ИмяПараметра, ПоляСоединения = Неопределено, ПсевдонимТаблицы = "ТоварныеОграничения") Экспорт
	...
	// Если исходный текст запроса был получен с использованием схемы запроса, то параметр бдует взят в скобки.
...
//
// Параметры:
//	КлючиЗаписиХарактеристик - Массив Из см. РегистрыСведений.ТоварныеОграничения.КлючЗаписиХарактеристики
//		- см. РегистрыСведений.ТоварныеОграничения.КлючЗаписиХарактеристики
//
