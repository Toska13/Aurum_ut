...
Процедура ОбновитьКурсЗависимойВалюты(ЗависимаяВалюта, ЗаписьОсновнойВалюты)
	...
	Если ЗависимаяВалюта.СпособУстановкиКурса = Перечисления.СпособыУстановкиКурсаВалюты.НаценкаНаКурсДругойВалюты Тогда
		...
		ТочностьКурса = Метаданные.ОпределяемыеТипы.КурсВалюты.Тип.КвалификаторыЧисла.РазрядностьДробнойЧасти;
		КоэффициентНаценки = 1 + ЗависимаяВалюта.Наценка / 100;
	
		Если ЗаписьОсновнойВалюты.КурсЧислитель = 1 Тогда
			ЗаписьКурсовВалют.КурсЧислитель = 1;
			ЗаписьКурсовВалют.КурсЗнаменатель = Окр(ЗаписьОсновнойВалюты.КурсЗнаменатель / КоэффициентНаценки, ТочностьКурса);
		Иначе
			ЗаписьКурсовВалют.КурсЧислитель = Окр(ЗаписьОсновнойВалюты.КурсЧислитель * КоэффициентНаценки, ТочностьКурса);
