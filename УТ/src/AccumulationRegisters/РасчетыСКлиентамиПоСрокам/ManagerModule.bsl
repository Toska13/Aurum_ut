...
Процедура ПриДобавленииОбработчиковОбновления(Обработчики) Экспорт
	...
	Обработчик.Идентификатор = Новый УникальныйИдентификатор("489f7d26-6bd5-7943-a55c-3d06d325974a");
	...
	Обработчик.Комментарий = СтрШаблон(НСтр("ru = 'Очищает реквизит ""%1"" и исправляет реквизит ""%2"" для движений документов ""%3"".
		...
		Метаданные.РегистрыНакопления.РасчетыСКлиентамиПоСрокам.Реквизиты.ВалютаДокумента.Представление(),
		Метаданные.РегистрыНакопления.РасчетыСКлиентамиПоСрокам.Реквизиты.ПорядокЗачета.Представление(),
		Метаданные.Документы.РасчетКурсовыхРазниц.Представление(),
		Метаданные.РегистрыНакопления.РасчетыСКлиентамиПоСрокам.Реквизиты.ПорядокОперации.Представление());
...
Процедура ОбработатьДанныеДляПереходаНаНовуюВерсию(Параметры) Экспорт
	...
	ПолноеИмяОбъекта = "РегистрНакопления.РасчетыСКлиентамиПоСрокам";
