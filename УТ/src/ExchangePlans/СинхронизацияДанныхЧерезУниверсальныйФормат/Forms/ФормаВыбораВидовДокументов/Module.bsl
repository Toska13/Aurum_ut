...
Процедура СформироватьДеревоВидовДокументов(МассивВыбранныхЗначений)
	...
	ДобавитьСтрокуДереваВидовДокументов(МетаДокументы.ОтгрузкаТоваровКлиенту, СтрокаВерхнегоУровня);
	...
	ДобавитьСтрокуДереваВидовДокументов(МетаДокументы.Сторно, СтрокаВерхнегоУровня);
