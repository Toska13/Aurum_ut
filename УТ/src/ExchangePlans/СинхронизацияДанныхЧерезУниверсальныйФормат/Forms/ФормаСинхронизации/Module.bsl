...
#Область СкладыИнформОстатков
	...
	ОбщегоНазначенияУТКлиентСервер.УстановитьСвойствоЭлементаФормы(
		...
		И Объект.ВариантНастройки <> ПланыОбмена.СинхронизацияДанныхЧерезУниверсальныйФормат.ИдентификаторНастройкиОбменаБП30()
		И Объект.ВариантНастройки <> ПланыОбмена.СинхронизацияДанныхЧерезУниверсальныйФормат.ИдентификаторНастройкиОбменаБПКОРП30());
...
#Область ГруппаЭквайринговыйТерминалПоУмолчанию
	ОбщегоНазначенияУТКлиентСервер.УстановитьСвойствоЭлементаФормы(
		...
		(Объект.ВариантНастройки = "ОбменУПРМК" И ВерсияФорматаНиже(Объект.ВерсияФорматаОбмена, "1.17")
			ИЛИ Объект.ВариантНастройки <> "ОбменУП2ЗУП3"));
#КонецОбласти  
