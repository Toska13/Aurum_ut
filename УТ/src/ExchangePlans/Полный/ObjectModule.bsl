...
Процедура ПриПолученииДанныхОтПодчиненного(ЭлементДанных, ПолучениеЭлемента, ОтправкаНазад)
	...
	Если ТипЗнч(ЭлементДанных) <> Тип("УдалениеОбъекта") Тогда
		...
		Если ОбщегоНазначения.ЭтоРегистр(МетаДанныеЭлементаДанных) Тогда
			ЭлементДанных.ДополнительныеСвойства.Вставить("ОбменРИБСоздаватьЗаданияНеоперативнойОчереди", Истина);
		КонецЕсли;
...
Процедура ПослеЗагрузкиДанных()
	...
	//++ Локализация
	ИнтеграцияИСУТ.ЗаменитьДублиКлючейВидовПродукцииИС();
	//-- Локализация
	...
	НеоперативнаяОчередьЗаданий.ВыполнитьЗаданияНеоперативнойОчередиПоСпискуДокументов(Неопределено,
