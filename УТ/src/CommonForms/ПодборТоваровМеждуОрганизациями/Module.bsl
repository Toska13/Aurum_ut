...
Процедура ЗаполнитьТаблицуТоваров()
	...
	|			И НЕ (&СкрыватьПодакцизныеТовары
	|				И АналитикаУчетаНоменклатуры.Номенклатура.УдалитьПодакцизныйТовар)
	...
	|			И НЕ (&СкрыватьПодакцизныеТовары
	|				И АналитикаУчетаНоменклатуры.Номенклатура.УдалитьПодакцизныйТовар)
	|			И АналитикаУчетаНоменклатуры.Номенклатура.ОблагаетсяНДСУПокупателя = &ОблагаетсяНДСУПокупателя
	|		) КАК Остатки
	|
	|	ГДЕ
