...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	СтатьиАктивовПассивов.Параметры.УстановитьЗначениеПараметра("ДвиженияПоПрочимАктивамПассивам", Метаданные.РегистрыНакопления.ДвиженияПоПрочимАктивамПассивам.Имя);
...
Процедура СтатьиРасходовВыбор(Элемент, ВыбраннаяСтрока, Поле, СтандартнаяОбработка)
	...
	Если ЗначениеЗаполнено(СтатьяРасходов) 
	 И НЕ Элементы.СтатьиРасходов.ДанныеСтроки(СтатьяРасходов).ЭтоГруппа Тогда
