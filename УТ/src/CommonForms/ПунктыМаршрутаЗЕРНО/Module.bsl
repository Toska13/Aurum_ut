...
Процедура МестаПерегрузкиАдресПриИзменении(Элемент)
	...
	ТекущиеДанные.Адрес = ОбщегоНазначенияИСВызовСервера.ЗначенияПолейКонтактнойИнформации(
...
Процедура ЗаполнитьДанныеФормыТраспортныеСредства()
	...
	УказываетсяТранспортноеСредство = (ИнтеграцияИС.УказываетсяТранспортноеСредство() И Параметры.ИспользоватьТранспортныеСредства);
