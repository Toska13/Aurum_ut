...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ДенежныеСредстваСервер.УстановитьПараметрыВыбораНаправленияДеятельности(ЭтотОбъект, Элементы.НаправлениеДеятельности);
...
Процедура ОК(Команда)
	...
	СтруктураРеквизитов.Вставить("Модифицированность",      Модифицированность);
...
Процедура ДоговорПриИзмененииНаСервере()
	...
	Если ТипЗнч(Договор) = Тип("СправочникСсылка.ДоговорыКонтрагентов") Тогда
		ЗначенияРеквизитов = ОбщегоНазначения.ЗначенияРеквизитовОбъекта(Договор, "ГруппаФинансовогоУчета, НаправлениеДеятельности");
	Иначе
		ЗначенияРеквизитов = ОбщегоНазначения.ЗначенияРеквизитовОбъекта(Договор, "НаправлениеДеятельности");
	КонецЕсли;

	Если ОбщегоНазначенияКлиентСервер.ЕстьРеквизитИлиСвойствоОбъекта(ЗначенияРеквизитов, "ГруппаФинансовогоУчета") Тогда
		ГруппаФинансовогоУчета = ЗначенияРеквизитов.ГруппаФинансовогоУчета;
	КонецЕсли;

	НаправлениеДеятельности = ДенежныеСредстваСервер.НаправлениеДеятельности(
		ХозяйственнаяОперация,
		ЗначенияРеквизитов.НаправлениеДеятельности);
