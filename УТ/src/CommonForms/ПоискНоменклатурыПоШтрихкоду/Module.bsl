...
Функция ДанныеПоШтрихкодам()
	...
	Для каждого ЭлементКоллекции Из ШтрихкодыНоменклатуры Цикл
		Если ЗначениеЗаполнено(ЭлементКоллекции.Номенклатура)
			...
			РаботаСНоменклатуройПереопределяемый.ПоискНоменклатурыПоШтрихкодуДанныеПоШтрихкодам(ДанныеПоШтрихкоды);
...
&НаКлиенте
Процедура Подключаемый_ПоискНоменклатурыПоШтрихкодуВыполнитьКоманду(Команда)
	
	РаботаСНоменклатуройКлиентПереопределяемый.ПоискНоменклатурыПоШтрихкодуВыполнитьКоманду(
		ЭтотОбъект,
		Команда);
...
&НаКлиенте
Процедура Подключаемый_ПоискНоменклатурыПоШтрихкодуПриИзменении(Элемент)
	
	РаботаСНоменклатуройКлиентПереопределяемый.ПоискНоменклатурыПоШтрихкодуПриИзменении(
		ЭтотОбъект,
		Элемент);
...
&НаКлиенте
Процедура Подключаемый_ПоискНоменклатурыПоШтрихкодуОчистка(Элемент, СтандартнаяОбработка)
	
	РаботаСНоменклатуройКлиентПереопределяемый.ПоискНоменклатурыПоШтрихкодуОчистка(
		ЭтотОбъект,
		Элемент,
...
&НаКлиенте
Процедура Подключаемый_ПоискНоменклатурыПоШтрихкодуСоздание(Элемент, СтандартнаяОбработка) Экспорт
	
	РаботаСНоменклатуройКлиентПереопределяемый.ПоискНоменклатурыПоШтрихкодуСоздание(
		ЭтотОбъект,
		Элемент,
		СтандартнаяОбработка);
...
&НаКлиенте
Процедура Подключаемый_ПоискНоменклатурыПоШтрихкодуНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	
	РаботаСНоменклатуройКлиентПереопределяемый.ПоискНоменклатурыПоШтрихкодуНачалоВыбора(
		ЭтотОбъект,
		Элемент, 
		ДанныеВыбора, 
		СтандартнаяОбработка);
