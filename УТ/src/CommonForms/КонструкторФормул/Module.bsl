...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Параметры.Свойство("ЭтоРасчетЦен", ЭтоРасчетЦен);
	...
	Если Не ЭтоРасчетЦен
		Или ПраваПользователяПовтИсп.УтверждениеВидовЦен() Тогда
		
		Элементы.ПодсказкаЗапретРедактирования.Видимость = Ложь;
	...
	Иначе
		...
		Элементы.ПодсказкаЗапретРедактирования.Заголовок =
			Новый ФорматированнаяСтрока(
				Новый ФорматированнаяСтрока(БиблиотекаКартинок.Предупреждение),
				Новый ФорматированнаяСтрока(СтроковыеФункцииКлиентСервер.СформироватьСтрокуСимволов(" ", 2)),
				Новый ФорматированнаяСтрока(НСтр("ru = 'Редактирование формул расчета цен недоступно для текущего пользователя.
					|Обратитесь к пользователю с ролью утверждения видов цен или администратору.'"),,
					ЦветаСтиля.ЦветТекстаПодсказки));
