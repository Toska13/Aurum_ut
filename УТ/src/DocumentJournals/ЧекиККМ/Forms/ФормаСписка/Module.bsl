...
Процедура УстановитьУсловноеОформление()
	...
	Если Элементы.ЧекиККМ.ПодчиненныеЭлементы.Найти("Статус") <> Неопределено Тогда
		...
		ОтборЭлемента.ПравоеЗначение = Перечисления.СтатусыЧековККМ.ОтложенБезРезервирования;
...
&НаКлиенте
Процедура СверкаПродажЛьготныхТоваровОплаченныхЭСФСС(Команда)
	
	СверкаПродажЛьготныхТоваровОплаченныхЭСФССЛокализация();
...
Процедура УстановитьВидимостьЭлементовФормыЛокализация()
	...
	//++ Локализация
	ИспользуетсяОплатаЭлектроннымиСертификатамиФСС = ПолучитьФункциональнуюОпцию("ОплатаЭлектроннымиСертификатамиФСС");
	Элементы.ОтправитьПодтверждениеНСПК.Видимость = ИспользуетсяОплатаЭлектроннымиСертификатамиФСС;
	Элементы.СверкаПродажЛьготныхТоваровОплаченныхЭСФСС.Видимость = ИспользуетсяОплатаЭлектроннымиСертификатамиФСС;
	ПереводыСБПДоступны = Ложь;
	Если ПереводыСБПc2b.ПереводыСБПДоступны() Тогда
		ДействующиеДоговораПодключения = 
			РегистрыСведений.НастройкиИнтеграцииСПлатежнымиСистемамиУТ.ДействующиеДоговораСНастройкамиИнтеграции(Перечисления.ВариантыНастройкиСБП.c2b);
	...
	Элементы.СверкаПродажЛьготныхТоваровОплаченныхЭСФСС.Видимость = Ложь;
...
&НаКлиенте
Процедура СверкаПродажЛьготныхТоваровОплаченныхЭСФССЛокализация()
	
	//++ Локализация
	
	ОткрытьФорму(
		"Обработка.СверкаПродажЛьготныхТоваровОплаченныхЭСФСС.Форма.Форма",,
