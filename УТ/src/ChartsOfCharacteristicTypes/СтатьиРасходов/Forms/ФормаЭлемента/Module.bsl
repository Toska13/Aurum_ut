...
Процедура ПередЗаписьюНаСервере(Отказ, ТекущийОбъект, ПараметрыЗаписи)
	...
	Если Не ПустаяСтрока(ТипЗначения) Тогда
		...
		Тогда
			...
			ТекущийОбъект.ТипЗначения = ПланыВидовХарактеристик.СтатьиРасходов.ТипыДокументовСтатейРаспределяемыхНаПродажу();
		Иначе
...
&НаКлиенте
Процедура ГруппаФинансовогоУчетаУУНачалоВыбора(Элемент, ДанныеВыбора, ВыборДобавлением, СтандартнаяОбработка)
	СтандартнаяОбработка = Ложь;
	ГруппаФинансовогоУчетаНачалоВыбора(Элемент, "ВариантРаспределенияРасходовУпр");
КонецПроцедуры

&НаКлиенте
Процедура ГруппаФинансовогоУчетаРеглНачалоВыбора(Элемент, ДанныеВыбора, ВыборДобавлением, СтандартнаяОбработка)
	СтандартнаяОбработка = Ложь;
	ГруппаФинансовогоУчетаНачалоВыбора(Элемент, "ВариантРаспределенияРасходовРегл");
КонецПроцедуры

&НаКлиенте
Процедура ГруппаФинансовогоУчетаНУНачалоВыбора(Элемент, ДанныеВыбора, ВыборДобавлением, СтандартнаяОбработка)
	СтандартнаяОбработка = Ложь;
	ГруппаФинансовогоУчетаНачалоВыбора(Элемент, "ВариантРаспределенияРасходовНУ");
КонецПроцедуры
...
&НаКлиенте
Процедура ГруппаФинансовогоУчетаНачалоВыбора(Элемент, ВариантРаспределения)
	
	ПараметрыФормы = Новый Структура;
	Отбор = Новый Структура;
	Отбор.Вставить("Расходы", Истина);
		
	
	ПараметрыФормы.Вставить("Отбор", Отбор);
	
	ОткрытьФорму("Справочник.ГруппыФинансовогоУчетаДоходовРасходов.Форма.ФормаВыбора", ПараметрыФормы, Элемент);
...
Процедура ТипЗначенияПриИзмененииСервер(ИмяЭлемента)
	...
	Если Не ПустаяСтрока(ТипЗначения) Тогда
		...
		Тогда
			...
			Объект.ТипЗначения = ПланыВидовХарактеристик.СтатьиРасходов.ТипыДокументовСтатейРаспределяемыхНаПродажу();
		Иначе
...
Процедура ОпределитьИспользованиеПолныхВозможностей()
	...
	Если Объект.ВариантРаспределенияРасходовУпр = Перечисления.ВариантыРаспределенияРасходов.НаСебестоимостьТоваров 
			...
			ИЛИ Объект.ВариантРаспределенияРасходовУпр = Перечисления.ВариантыРаспределенияРасходов.НаРасходыТекущегоПериода 
	...
	Если Объект.ВариантРаспределенияРасходовРегл = Перечисления.ВариантыРаспределенияРасходов.НаСебестоимостьТоваров 
			...
			ИЛИ Объект.ВариантРаспределенияРасходовРегл = Перечисления.ВариантыРаспределенияРасходов.НаРасходыТекущегоПериода 
...
Процедура ЗаполнитьВидЦенностиНДС()
	...
	// Условие заполнения должно совпадать с условием в модуле менеджера.
