...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Параметры.Предопределенный Тогда
		...
		ВариантыРаспределения = СоответствиеСтатейВариантамРаспределения.Получить(Параметры.СтатьяРасходов);
		ТипРасходов = СоответствиеСтатейТипамРасходов.Получить(Параметры.СтатьяРасходов);
		
		Если ВариантыРаспределения <> Неопределено
			И ВариантыРаспределения.НайтиПоЗначению(Параметры.ВариантРаспределенияРасходовНУ) <> Неопределено
			И ВариантыРаспределения.НайтиПоЗначению(Параметры.ВариантРаспределенияРасходовУпр) <> Неопределено
			И ВариантыРаспределения.НайтиПоЗначению(Параметры.ВариантРаспределенияРасходовРегл) <> Неопределено Тогда
		...
		Если ТипРасходов <> Неопределено Тогда
			...
			Элементы.РазрешитьРедактированиеВидаДеятельностиИВариантаРаспределенияРасходов.Заголовок = 
				?(ВариантыРаспределения <> Неопределено, НСтр("ru = 'Разрешить редактирование вида деятельности расходов'"),
