...
Процедура ПриНачальномЗаполненииЭлемента(Объект, Данные, ДополнительныеПараметры) Экспорт
	...
	Если ПустаяСтрока(Объект.ИмяПредопределенныхДанных) Тогда
		Объект.ТипЗначения = Данные.ТипЗначения;
	КонецЕсли;
...
Процедура ДополнитьЭлементСтатьиРасходов(Элемент)
	...
	ЗаполнитьВидЦенностиНДС(Элемент);
	
КонецПроцедуры

Процедура ЗаполнитьВидЦенностиНДС(Элемент)
	
	// Условие заполнения должно совпадать с условием форме элемента.
	Если Элемент.ВариантРаспределенияРасходовРегл = Перечисления.ВариантыРаспределенияРасходов.НаСебестоимостьТоваров Тогда
		Элемент.ВидЦенностиНДС = Перечисления.ВидыЦенностей.Товары;
	Иначе
		Элемент.ВидЦенностиНДС = Перечисления.ВидыЦенностей.ПрочиеРаботыИУслуги;
	КонецЕсли;
