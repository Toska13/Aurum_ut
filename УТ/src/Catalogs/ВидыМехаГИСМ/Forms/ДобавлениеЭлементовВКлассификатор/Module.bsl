...
//
// Параметры:
//  ВыбраннаяСтрока - ДанныеФормыЭлементКоллекции - Строка таблицы, источник данных для заполнения реквизитов
//    классификатора. Если в строке присутствуют данные о единице измерения, запускается ее поиск и добавление.
&НаСервере
...
//
// Параметры:
// ВыбранныеСтроки - Число, Массив Из Число - массив идентификаторов выбранных строк таблицы формы классификатор
