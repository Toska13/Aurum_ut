...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	//++ Локализация
	ЕстьКонтрольЦеныТолькоПоМРЦ = РозничныеПродажиКлиентСерверЛокализация.РозничныеПродажиТабачнойПродукцииТолькоПоМРЦ(ЭтотОбъект);
	//-- Локализация
	...
	Пока Выборка.Следующий() Цикл
		...
		//++ Локализация
		Если ЕстьКонтрольЦеныТолькоПоМРЦ
			И РозничныеПродажиЛокализация.КонтролироватьЦенуПродажиПоМРЦДляВидаПродукцииИС(СтрокаТЧ.ВидПродукцииИС) Тогда
			Продолжить;
		КонецЕсли;
		//-- Локализация
