...
Процедура ПриЧтенииСозданииНаСервере()
	...
	ОформлениеНакладныхВСистеме = Константы.ПорядокОформленияНакладныхРасходныхОрдеров.Получить();
	ДоступноИзменениеПорядкаСборки = НЕ ДоставкаТоваровКлиентСервер.ИспользуетсяДоставка25()
		ИЛИ (ОформлениеНакладныхВСистеме <> Перечисления.ПорядокОформленияНакладныхРасходныхОрдеров.СначалаНакладные);
	...
	ДоставкаТоваров.УстановитьНастройкиЭлементовФормыСклада(ЭтотОбъект);
...
Процедура УстановитьДоступностьПолей()
	...
	Элементы.ГруппаДоставка.Доступность = Объект.ИспользоватьОрдернуюСхемуПриОтгрузке
		И ДоступноИзменениеПорядкаСборки;
	Элементы.ГруппаДоставка.ТолькоПросмотр = Элементы.ИспользоватьОрдернуюСхемуПриОтгрузке.ТолькоПросмотр;
	
	Элементы.ГруппаКомментарий.Видимость = НЕ ДоступноИзменениеПорядкаСборки;
