...
Функция ЗаписатьИзменениеСостоянияНовостиСервер(Знач ЛокальныйСписокНовостей, Знач ЛокальноеОповещениеВключено, Знач ЛокальныйТекущийПользователь)
	...
	НовыеЗначенияСостояний = ОбработкаНовостейКлиентСервер.НовыйОписательЗначенийСостоянияНовости(
		...
		ЛокальноеОповещениеВключено, // ОповещениеВключено
		Неопределено,                // ДатаНачалаОповещения
	...
	ОбработкаНовостейПереопределяемый.ПослеИзмененияСостоянияНовостей(
		ОбщегоНазначенияКлиентСервер.ЗначениеВМассиве(ЛокальныйТекущийПользователь),
		ОбщегоНазначенияКлиентСервер.ЗначениеВМассиве(ТекущаяНовость.Значение),
