		...
		Если НЕ ПустаяСтрока(Объект.СсылкаНаПолныйТекстНовости) Тогда
			...
			Если ПропуститьЧтениеЗаписьПользовательскихНастроекНовости <> Истина Тогда
				ОписательНовости = Новый Структура;
					...
					ОписательНовости.Вставить("ПрочтенаПриОткрытии"            , ПрочтенаПриОткрытии);
					ОписательНовости.Вставить("ПометкаПриОткрытии"             , ПометкаПриОткрытии);
					ОписательНовости.Вставить("ПрочитатьПозжеПриОткрытии"      , ПрочитатьПозжеПриОткрытии);
					ОписательНовости.Вставить("ОповещениеВключеноПриОткрытии"  , ОповещениеВключеноПриОткрытии);
					ОписательНовости.Вставить("ДатаНачалаОповещенияПриОткрытии", ДатаНачалаОповещения); // Оставить как есть
...
Процедура ЗаписатьИзменениеСостояния(
	...
	ПредыдущиеЗначенияСостояний = ОбработкаНовостейКлиентСервер.НовыйОписательЗначенийСостоянияНовости(
		ОписательНовости.ПрочтенаПриОткрытии,
		ОписательНовости.ПометкаПриОткрытии,
		ОписательНовости.ОповещениеВключеноПриОткрытии,
		ОписательНовости.ДатаНачалаОповещенияПриОткрытии,
		Неопределено,
		?(ОписательНовости.ПрочитатьПозжеПриОткрытии = 1, Истина, Ложь));
	НовыеЗначенияСостояний = ОбработкаНовостейКлиентСервер.НовыйОписательЗначенийСостоянияНовости(
		ОписательНовости.Прочтена,
		ОписательНовости.Пометка,
		ОписательНовости.ОповещениеВключено,
		ОписательНовости.ДатаНачалаОповещения,
		Неопределено,
		?(ОписательНовости.ПрочитатьПозже = 1, Истина, Ложь));
	ОбработкаНовостейПереопределяемый.ПослеИзмененияСостоянияНовостей(
		...
		ОбщегоНазначенияКлиентСервер.ЗначениеВМассиве(ОписательНовости.НовостьСсылка),
