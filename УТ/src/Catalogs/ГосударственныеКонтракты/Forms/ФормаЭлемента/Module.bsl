...
Процедура ПередЗаписьюНаСервере(Отказ, ТекущийОбъект, ПараметрыЗаписи)
	...
	Если ТекущийОбъект.ТипСопровождения = Перечисления.ТипыСопровожденияГосударственныхКонтрактов.Банковское
...
&НаКлиенте
Процедура ТипСопровожденияПриИзменении(Элемент)
	УправлениеФормой(ЭтотОбъект);
КонецПроцедуры
...
Процедура УправлениеФормой(Форма)
	...
	ЭтоКонтрактГОЗНаБанковскомСопровождении = Форма.Объект.ТипСопровождения = ПредопределенноеЗначение("Перечисление.ТипыСопровожденияГосударственныхКонтрактов.Банковское");
	ЭтоГосконтрактИзЕИС = ЗначениеЗаполнено(Форма.Объект.ВнутреннийИдентификаторЕИС);
	
	Форма.Элементы.ГоловнойИсполнитель.Видимость = ЭтоКонтрактГОЗНаБанковскомСопровождении; 
	Форма.Элементы.УполномоченныйБанк.Видимость = ЭтоКонтрактГОЗНаБанковскомСопровождении; 
	Форма.Элементы.НомерГОЗ.Видимость = ЭтоКонтрактГОЗНаБанковскомСопровождении; 
	Форма.Элементы.ЗаполнитьИдентификатор.Видимость = ЭтоКонтрактГОЗНаБанковскомСопровождении; 

	Форма.Элементы.КодСпособаОпределенияПоставщика.Видимость = ЭтоКонтрактГОЗНаБанковскомСопровождении; 
	Форма.Элементы.КодГосударственногоЗаказчика.Видимость = ЭтоКонтрактГОЗНаБанковскомСопровождении; 
	Форма.Элементы.ПорядковыйНомер.Видимость = ЭтоКонтрактГОЗНаБанковскомСопровождении; 
	Форма.Элементы.ВидЦены.Видимость = ЭтоКонтрактГОЗНаБанковскомСопровождении; 
	Форма.Элементы.ДополнительныеРазряды.Видимость = ЭтоКонтрактГОЗНаБанковскомСопровождении; 
	...
	Форма.Элементы.УполномоченныйБанк.АвтоОтметкаНезаполненного = ЭтоКонтрактГОЗНаБанковскомСопровождении И Не ЭтоГосконтрактИзЕИС;
	Форма.Элементы.НомерГОЗ.АвтоОтметкаНезаполненного = ЭтоКонтрактГОЗНаБанковскомСопровождении;
	Форма.Элементы.КодСпособаОпределенияПоставщика.АвтоОтметкаНезаполненного = ЭтоКонтрактГОЗНаБанковскомСопровождении И Не ЭтоГосконтрактИзЕИС;
	Форма.Элементы.КодГосударственногоЗаказчика.АвтоОтметкаНезаполненного = ЭтоКонтрактГОЗНаБанковскомСопровождении И Не ЭтоГосконтрактИзЕИС;
	Форма.Элементы.ПорядковыйНомер.АвтоОтметкаНезаполненного = ЭтоКонтрактГОЗНаБанковскомСопровождении И Не ЭтоГосконтрактИзЕИС;
	Форма.Элементы.ДополнительныеРазряды.АвтоОтметкаНезаполненного = ЭтоКонтрактГОЗНаБанковскомСопровождении И Не ЭтоГосконтрактИзЕИС;
...
Функция ОбновитьИнформациюПоДоговорам()
	...
	Иначе
		ТекстПокупателей = ОбщегоНазначенияУТКлиентСервер.СклонениеСлова(
				...
				НСтр("ru = 'договор с контрагентом, договора с контрагентами, договоров с контрагентами, м'"));
