...
Процедура ОбработкаПроверкиЗаполнения(Отказ, ПроверяемыеРеквизиты)
	...
	Если Не ЗначениеЗаполнено(ВнутреннийИдентификаторЕИС) Тогда
		...
		Если ТипСопровождения = Перечисления.ТипыСопровожденияГосударственныхКонтрактов.Банковское Тогда
	...
	Если ТипСопровождения = Перечисления.ТипыСопровожденияГосударственныхКонтрактов.Казначейское Тогда
...
Процедура ПередЗаписью(Отказ)
	...
	Если УдалитьТипНаправленияДеятельности = Перечисления.УдалитьТипыНаправленийДеятельности.ГосударственныйКонтракт Тогда
