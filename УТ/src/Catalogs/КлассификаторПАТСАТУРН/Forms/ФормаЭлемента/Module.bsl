...
Процедура ОбработкаОповещения(ИмяСобытия, Параметр, Источник)
	...
	ИначеЕсли ИмяСобытия = "Запись_СоответствиеНоменклатурыСАТУРН"
...
Процедура УправлениеЭлементамиФормы(Форма)
	...
	Элементы.ДанныеКомбипака.Видимость        = ЭтоКомбипак;
	Элементы.ДанныеТукосмеси.Видимость        = (Не ЭтоКомбипак);
