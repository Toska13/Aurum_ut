...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ЭтоWildberries  = (Объект.ВидМаркетплейса = ПредопределенноеЗначение("Перечисление.ВидыМаркетплейсов.МаркетплейсWildberries"));
	ЭтоSellmonitor  = (Объект.ВидМаркетплейса = ПредопределенноеЗначение("Перечисление.ВидыМаркетплейсов.СервисАналитикиSellmonitor"));
	...
	ИначеЕсли ЭтоWildberries Тогда
		
		Элементы.НеОбновлятьДанныеТорговойПлощадки.Видимость = Ложь;
		Элементы.ИдентификаторАккаунта.Видимость = Ложь;
		Элементы.ИдентификаторКабинета.Видимость = Ложь;
		Элементы.ИдентификаторМагазина.Видимость = Ложь;
		...
		Элементы.ДекорацияАрхивнаяУчетнаяЗапись.Видимость = Ложь;
		Элементы.ФормаУстановитьПометкуУдаления.Доступность = Ложь;
		Элементы.ВалютаУчета.Доступность = Элементы.ВалютаУчета.Доступность
			И ПравоДоступа("Изменение", Метаданные.Документы.УстановкаЦенНоменклатуры)
			
	ИначеЕсли ЭтоSellmonitor Тогда
		Элементы.НеОбновлятьДанныеТорговойПлощадки.Видимость = Ложь;
		Элементы.ИдентификаторАккаунта.Видимость = Ложь;
		Элементы.ИдентификаторКабинета.Видимость = Ложь;
		Элементы.ИдентификаторМагазина.Видимость = Ложь;
