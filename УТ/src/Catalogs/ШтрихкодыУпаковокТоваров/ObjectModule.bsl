	...
	Если ТипШтрихкода = Перечисления.ТипыШтрихкодов.GS1_128
		...
		Если ОбновитьРеквизитыGS1 Тогда
			...
			ИначеЕсли ЗначениеЗаполнено(Номенклатура) Тогда
				ВидыПродукции.Добавить(ИнтеграцияИСПовтИсп.ОписаниеНоменклатуры(Номенклатура)[Номенклатура].КлючВидовПродукции);
			КонецЕсли;
			...
			Если Не ЗначениеЗаполнено(ХешСуммаНормализации)
				...
				Если Результат <> Неопределено Тогда
					...
					Если ПараметрыШтрихкода.ТипШтрихкода <> Перечисления.ТипыШтрихкодов.SSCC
						И ПараметрыШтрихкода.ТипШтрихкода <> Перечисления.ТипыШтрихкодов.SSCC18
						И ПараметрыШтрихкода.ТипШтрихкода <> Перечисления.ТипыШтрихкодов.SSCC20 Тогда
