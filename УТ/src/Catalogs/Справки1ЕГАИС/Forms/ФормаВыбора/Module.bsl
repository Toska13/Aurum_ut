...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Параметры.Свойство("Номенклатура", Номенклатура)
		И Параметры.Свойство("Характеристика", Характеристика) Тогда
		УстановитьОтборПоНоменклатуре(Номенклатура, Характеристика);
	КонецЕсли;
...
&НаСервере
Процедура УстановитьОтборПоНоменклатуре(Номенклатура, Характеристика)
	...
	Если СписокАлкогольнаяПродукция.Количество() > 0 Тогда
		...
		ПредставлениеНоменклатуры = ОбщегоНазначенияИС.ПредставлениеНоменклатуры(Номенклатура, Характеристика);
