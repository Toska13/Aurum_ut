...
Процедура ОбработкаПолученияДанныхВыбора(ДанныеВыбора, Параметры, СтандартнаяОбработка)
	...
	МультиязычностьСервер.ОбработкаПолученияДанныхВыбора(ДанныеВыбора, Параметры, СтандартнаяОбработка, Метаданные.Справочники.ГруппыФинансовогоУчетаДоходовРасходов);
...
Процедура ПриДобавленииОбработчиковОбновления(Обработчики) Экспорт
	...
	Обработчик.Идентификатор = Новый УникальныйИдентификатор("2493702a-a62b-4956-b9b0-46a7505900d9");
	...
	СписокОписаний.Добавить(НСтр("ru = 'Обновление справочника ""Группы настроек финансового учета доходов/расходов"":'"));
...
Процедура ЗарегистрироватьДанныеКОбработкеДляПереходаНаНовуюВерсию(Параметры) Экспорт
	...
	|ГДЕ
	|	НЕ ГруппыФинансовогоУчетаДоходовРасходов.Наименование = """"
	|	И ГруппыФинансовогоУчетаДоходовРасходов.НаименованиеЯзык1 = """"
	|	
	|ОБЪЕДИНИТЬ 
	|
	|ВЫБРАТЬ
	...
	|ГДЕ
	|	НЕ ГруппыФинансовогоУчетаДоходовРасходов.Наименование = """"
	|	И ГруппыФинансовогоУчетаДоходовРасходов.НаименованиеЯзык2 = """"";
...
Процедура ОбработатьДанныеДляПереходаНаНовуюВерсию(Параметры) Экспорт
	...
	СписокОписаний = Новый Массив;
	СписокОписаний.Добавить(НСтр("ru = 'Не удалось обработать справочник ""Группы настроек финансового учета доходов/расходов"" по обработчику:'"));
	СписокОписаний.Добавить(НСтр("ru = '- Заполнение мультиязычных реквизитов справочника';"));
	Запрос = Новый Запрос;
	Запрос.Текст = 
	"ВЫБРАТЬ
	...
	|	ГруппыФинансовогоУчетаДоходовРасходов.ВерсияДанных КАК ВерсияДанных
	|ИЗ
	|	ВТ КАК ВТ
	|		ЛЕВОЕ СОЕДИНЕНИЕ Справочник.ГруппыФинансовогоУчетаДоходовРасходов КАК ГруппыФинансовогоУчетаДоходовРасходов
	|		ПО ВТ.Ссылка = ГруппыФинансовогоУчетаДоходовРасходов.Ссылка";
