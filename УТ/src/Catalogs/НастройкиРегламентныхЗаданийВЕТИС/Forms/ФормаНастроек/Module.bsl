...
Процедура УстановитьДоступность()
	...
	РедактированиеНастроекРегламентныхЗаданий = ПравоДоступа(
		"Редактирование", Метаданные.Справочники.НастройкиРегламентныхЗаданийВЕТИС);
	...
	Если Не РедактированиеНастроекРазрешено Тогда
		Элементы.ПредприятияБезНастроекНадпись.Доступность = Ложь;
		Элементы.ИспользоватьИндивидуальныеРегламентныеЗадания.Доступность = Ложь;
		Элементы.ГруппаСинхронизацияКлассификаторов.Доступность = Ложь;
		Элементы.ГруппаЕдиноеРегламентноеЗадание.Доступность = Ложь;
...
Процедура УстановитьВидимостьДоступность(Форма)
	...
	Если Форма.РедактированиеНастроекРазрешено Тогда
...
Процедура ТаблицаНастроекАктивизацияСтроки()
	...
	ИначеЕсли ТекущиеДанные.ВремяПоследнегоВыполнения = -1 Тогда
		ВремяПоследнегоВыполнения = Новый ФорматированнаяСтрока(
