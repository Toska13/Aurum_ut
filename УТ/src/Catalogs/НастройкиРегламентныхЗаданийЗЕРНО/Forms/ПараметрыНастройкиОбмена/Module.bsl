...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Не ЗначениеЗаполнено(ВидНастройкиОбмена) Тогда
		Отказ = Истина;
		Возврат;
	КонецЕсли;
	...
	НастроитьЗависимыеОтРазделаУчетаЭлементыФормы(ЭтотОбъект);
...
Процедура ОбработкаПроверкиЗаполненияНаСервере(Отказ, ПроверяемыеРеквизиты)
	...
	Если ВидНастройкиОбмена = Перечисления.ВидыНастроекОбменаЗЕРНО.ЗагрузкаСДИЗ Тогда
		ПроверяемыеРеквизиты.Добавить("РазделУчета");
...
Процедура НастроитьЗависимыеОтРазделаУчетаЭлементыФормы(Форма)
	...
	Форма.Элементы.ТипОрганизации.Видимость =
		...
		И Форма.РазделУчета = ПредопределенноеЗначение("Перечисление.РазделыУчетаЗЕРНО.Зерно");
