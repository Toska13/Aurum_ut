...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	УстановитьЗаголовокСтраницыПолномочий();
...
Процедура ПередЗаписьюНаСервере(Отказ, ТекущийОбъект, ПараметрыЗаписи)
	...
	ЗаполнитьДополнительныеСвойстваЦентраЭДОПередЗаписью(ТекущийОбъект, ПараметрыЗаписи);
...
Процедура ДоверенностьДокументДоверСвДоверитДоверитРосОргДоверЛицоБезДов_ЛицоБезДоверенностиНачалоВыбора(Элемент,
	...
	СтандартнаяОбработка = Ложь;
	ОбработчикВыбранногоЗначения = Новый ОписаниеОповещения("ВыбратьЛицоБезДоверенностиЗавершение", ЭтотОбъект);
...
&НаКлиенте
Процедура ДоверенностьДокументДоверСвДоверитДоверитРосОргДоверСвРосОргАдрРегАдрРФНачалоВыбора(Элемент, ДанныеВыбора,
...
&НаКлиенте
Процедура ДоверенностьДокументДоверСвУпПредПредСведФизЛСведФЛАдрМЖАдрРФНачалоВыбора(Элемент, ДанныеВыбора,
	ВыборДобавлением, СтандартнаяОбработка)
...
&НаКлиенте
Процедура ДоверенностьДокументДоверСвДоверитДоверитРосОргДоверЛицоБезДовСВЮЛСвЮЛЕИОАдрРегАдрРФНачалоВыбора(Элемент,
...
Процедура ДоверенностьДокументДоверСвПолнТипПолнПриИзменении(Элемент)
	...
	ПриИзмененииВариантаЗаполненияНаСервере();
...
&НаКлиенте
Процедура ДоверенностьДокументДоверСвУпПредПредСведФизЛСведФЛАдрМЖРегионАвтоПодбор(Элемент, Текст, ДанныеВыбора,
	ПараметрыПолученияДанных, Ожидание, СтандартнаяОбработка)

	ОбщегоНазначенияБЭДКлиент.АвтоПодборНайтиИВыделитьОформлением(Элемент.СписокВыбора, Текст, ДанныеВыбора,
		СтандартнаяОбработка);

КонецПроцедуры

&НаКлиенте
Процедура ДоверенностьДокументДоверСвДоверитДоверитРосОргДоверЛицоБезДовСВЮЛСвЮЛЕИОАдрРегРегионАвтоПодбор(Элемент,
	Текст, ДанныеВыбора, ПараметрыПолученияДанных, Ожидание, СтандартнаяОбработка)
...
&НаКлиенте
Процедура ДоверенностьДокументДоверСвДоверитДоверитРосОргДоверСвРосОргАдрРегРегионАвтоПодбор(Элемент, Текст,
	ДанныеВыбора, ПараметрыПолученияДанных, Ожидание, СтандартнаяОбработка)
...
&НаКлиенте
Процедура ДоверенностьДокументДоверСвДоверитДоверитРосОргДоверСвРосОргКонтактТлфНачалоВыбора(Элемент, ДанныеВыбора,
	ВыборДобавлением, СтандартнаяОбработка)
...
&НаКлиенте
Процедура ДоверенностьДокументДоверСвДоверитДоверитИПДоверСведФЛКонтактТлфНачалоВыбора(Элемент, ДанныеВыбора,
	ВыборДобавлением, СтандартнаяОбработка)
...
Процедура ДоверенностьДокументДоверСвУпПредПредСведФизЛСведФЛУдЛичнФЛКодВидДокПриИзменении(Элемент)
	...
	МашиночитаемыеДоверенностиКлиент.УстановитьОформлениеНастройкиОтображенияИЗначенияПолейДУЛФЛПоУмолчанию(
		Элемент.Родитель,
		ПоляУдостоверяющиеЛичностьФизическогоЛица,
		Элементы.ДоверенностьДокументДоверСвУпПредПредСведФизЛСведФЛУдЛичнФЛСрокДействия);
...
Процедура ДоверенностьДокументДоверСвУпПредПредСведИПСведФЛУдЛичнФЛКодВидДокПриИзменении(Элемент)
	...
	МашиночитаемыеДоверенностиКлиент.УстановитьОформлениеНастройкиОтображенияИЗначенияПолейДУЛФЛПоУмолчанию(
		Элемент.Родитель,
		ПоляУдостоверяющиеЛичностьФизическогоЛица,
		Элементы.ДоверенностьДокументДоверСвУпПредПредСведИПСведФЛУдЛичнФЛСрокДействия);
...
Процедура ДеревоПолномочийСОграничениямиВыбор(Элемент, ВыбраннаяСтрока, Поле, СтандартнаяОбработка)
	...
	Если Не ЭлементДерева.Предопределенное Тогда 
		...
		Правила = ПолучитьПараметрыРедактированияПравила(ЭлементДерева.ПорядковыйНомер, Истина, Истина);
		ПрименяютсяОграничения = 
			Правила.НастройкиТекущегоПравила[0].КонтекстПолномочия = 
				МашиночитаемыеДоверенностиКлиентСервер.ПризнакПолномочиеСОграничением();
		
		ТекущийПорядковыйНомер = ЭлементДерева.ПорядковыйНомер;
		ПараметрыФормы = Новый Структура;
		ПараметрыФормы.Вставить("ДополнительныеПараметры", Правила);

		Если ПрименяютсяОграничения Тогда
			ОткрытьФормуРедактированияСоставныхПолномочий(ПараметрыФормы);
		Иначе
			ПараметрыФормы.Вставить("КодКлассификатора", Правила.НастройкиТекущегоПравила[0].КодПолномочия);
			ОткрытьФормуРедактированияПолномочий(ПараметрыФормы);
		КонецЕсли;
	КонецЕсли;
...
Процедура ДеревоПолномочийСОграничениямиПередНачаломИзменения(Элемент, Отказ)
	...
	Отказ = Истина;
	ТекущийПорядковыйНомер = Элемент.ТекущиеДанные.ПорядковыйНомер;
	ПрименяютсяОграничения = Элемент.ТекущиеДанные.ПрименяютсяОграничения;
	
	ПараметрыФормы = Новый Структура;
	ПараметрыФормы.Вставить("ДополнительныеПараметры", 
		ПолучитьПараметрыРедактированияПравила(ТекущийПорядковыйНомер, Истина, Истина));
...
Процедура ДеревоПолномочийСОграничениямиПослеУдаления(Элемент)
	...
	ПараметрыВыполнения = Новый Структура("УдаляемыйПорядковыйНомер", УдаляемыйПорядковыйНомер);
...
&НаКлиенте
Процедура ДоверенностьДокументДоверСвУпПредПередНачаломДобавления(Элемент, Отказ, Копирование, Родитель, ЭтоГруппа,
	Параметр)
	Отказ = Истина;
...
Процедура ВыполнитьПодписатьИЗарегистрировать()
	...
	Если Не КриптографияБЭДКлиент.ЭтоТипПодписиCAdESBES(ТипПодписи) Тогда
		...
		ДатаВыдачиОтличаетсяБолееЧемНаДень = Не (СвДов.ДатаВыдДовер >= НачалоДиапазона И СвДов.ДатаВыдДовер
			<= КонецДиапазона);

		Если ДатаВыдачиОтличаетсяБолееЧемНаДень Тогда
			ТекстОшибки = НСтр(
				"ru='Штамп времени в электронной подписи должен совпадать с моментом подписания МЧД и не отличаться от даты совершения доверенности более или менее, чем на день';");
	...
	Если ЗначениеЗаполнено(ПоляПериода) Тогда
		...
		ЭлементыКОформлению = МашиночитаемыеДоверенностиКлиент.ЭлементыПериодаПоСпискуПолей(
			ОписаниеЭлементовПолейПериодаДоверенности(), ПоляПериода);
...
&НаКлиенте
Процедура ДобавитьСоставноеПолномочие(Команда)
	ДобавитьНовоеСоставноеПолномочие();
КонецПроцедуры
...
Функция ТипыПолномочий()
	Возврат Новый ФиксированнаяСтруктура("Текстовые, Машиночитаемые, Составные", "0", "1", "2");
КонецФункции
...
Процедура ПерезаполнитьСведенияОДоверителе(Доверитель)
	...
	Если ЗначениеЗаполнено(Доверитель) И ОбщегоНазначения.ЭтоСсылка(ТипЗнч(Доверитель)) Тогда
		...
		Если ИнтеграцияЭДО.ЭтоФизЛицо(Доверитель) Тогда
			...
			СброситьОформлениеЭлементовФормы(Элементы.ГруппаДоверитель_ИндивидуальныйПредприниматель, Истина);
		Иначе
	...
	Если ЗначениеЗаполнено(ЛицоБезДоверенности) И ОбщегоНазначения.ЭтоСсылка(ТипЗначения) Тогда
		...
		Иначе
			...
			Если ИнтеграцияЭДО.ЭтоФизЛицо(ЛицоБезДоверенности) Тогда
				...
				СброситьОформлениеЭлементовФормы(Элементы.ГруппаЛицоБезДоверенности_ИндивидуальныйПредприниматель,
					Истина);
			Иначе
				Доверенность[0].Документ[0].Довер[0].СвДоверит[0].Доверит[0].РосОргДовер[0].ЕИОФЛ = ДаНет.Нет;
		...
		СброситьОформлениеЭлементовФормы(
...
Процедура ПерезаполнитьСведенияОПредставителе(Представитель)
	...
	Если ЗначениеЗаполнено(Представитель) И ОбщегоНазначения.ЭтоСсылка(ТипЗначения) Тогда
		...
		Если Метаданные.ОпределяемыеТипы.ФизическоеЛицо.Тип.СодержитТип(ТипЗначения) Тогда
			...
			УстановитьВидимостьПоляСрокДействия(
				Элементы.ДоверенностьДокументДоверСвУпПредПредСведФизЛСведФЛУдЛичнФЛСрокДействия,
				СведенияОФизЛице.СведФЛ[0].УдЛичнФЛ[0].КодВидДок);
		Иначе
			...
			Если ИнтеграцияЭДО.ЭтоФизЛицо(Представитель) Тогда
				...
				УстановитьВидимостьПоляСрокДействия(
					Элементы.ДоверенностьДокументДоверСвУпПредПредСведИПСведФЛУдЛичнФЛСрокДействия,
					СведенияОбИП.СведФЛ[0].УдЛичнФЛ[0].КодВидДок);
			Иначе
...
Процедура ЗаполнитьТаблицуТипаСведФЛ(СведФЛ, СтруктураСведений)
	...
	МашиночитаемыеДоверенности.ЗаполнитьТаблицуТипаСведФЛ(СведФЛ, СтруктураСведений);
...
Процедура ЗаполнитьСписокРегионов()
	...
	Иначе
		...
		Для Каждого Регион Из СписокРегионов Цикл
			...
			Элементы.ДоверенностьДокументДоверСвДоверитДоверитРосОргДоверСвРосОргАдрРегРегион.СписокВыбора.Добавить(
				Код, Наименование);

			Элементы.ДоверенностьДокументДоверСвДоверитДоверитРосОргДоверЛицоБезДовСВЮЛСвЮЛЕИОАдрРегРегион.СписокВыбора.Добавить(
				Код, Наименование);

			Элементы.ДоверенностьДокументДоверСвУпПредПредСведФизЛСведФЛАдрМЖРегион.СписокВыбора.Добавить(Код,
				Наименование);
...
Процедура НачальноеЗаполнениеРеквизитов()
	...
	ТокенДоступа = "";
	НомерДоверенности = МашиночитаемыеДоверенности.ПолучитьНомерМЧД(ТокенДоступа,
		ПоказыватьСлужебныеСообщения).НомерДоверенности;
	...
	Доверенность[0].Документ[0].Довер[0].СвДов[0].СведСист = "https://m4d.nalog.gov.ru/EMCHD/check-status?guid="
		+ НомерДоверенности;
	...
	ЗаполнениеТекстовыхПолномочийПоУмолчаниюОтключено = МашиночитаемыеДоверенности.ЗаполнениеТекстовыхПолномочийПоУмолчаниюОтключено();
...
Процедура ОбновитьВидимостьКомандТаблицыПолномочий(Форма)
	...
	Если ЭтоМашинныеПолномочия Тогда
		Форма.Элементы.ДеревоПолномочийСОграничениямиИзменить.Доступность = ЕстьПолномочия;
		Форма.Элементы.ДеревоПолномочийСОграничениямиУдалить.Доступность = ЕстьПолномочия;
	КонецЕсли;
КонецПроцедуры
...
Процедура УстановитьДоступностьЭлементов()
	...
	Если Не ДобавлениеИзменениеМЧДОрганизацийЭДО Или Не ЕстьПравоИзменения Тогда
...
Процедура НастроитьЭлементыСФиксированнымиСпискамиЗначений()
	...
	НастраиваемыеЭлементы.Добавить(
		Элементы.ДоверенностьДокументДоверСвДоверитДоверитРосОргДоверЛицоБезДовСВЮЛСвЮЛЕИОАдрРегРегион);
...
&НаКлиенте
Процедура РазвернутьДеревоВизуализации()

	Дерево = ДеревоПолномочийСОграничениями.ПолучитьЭлементы();
	Для Каждого Строка Из Дерево Цикл
		ИдентификаторСтроки = Строка.ПолучитьИдентификатор();
		Элементы.ДеревоПолномочийСОграничениями.Развернуть(ИдентификаторСтроки);
	КонецЦикла;

КонецПроцедуры

&НаСервере
Процедура УстановитьЗаголовокСтраницыПолномочий()
	
	ТипПолномочий = ЗначениеВДеревеДоверенности("Доверенность[0].Документ[0].Довер[0].СвПолн[0].ТипПолн");
	
	Если ТипПолномочий = ТипыПолномочий().Текстовые Тогда
		
		ТекстПолномочий = ЗначениеВДеревеДоверенности("Доверенность[0].Документ[0].Довер[0].СвПолн[0].ТекстПолн");
		
		Если Не ЗначениеЗаполнено(ТекстПолномочий) Тогда
			ПараметрПредставления = НСтр("ru = 'Не указаны'");
		ИначеЕсли ТекстПолномочий = МашиночитаемыеДоверенностиКлиентСервер.ПредставлениеНеограниченныхПолномочий() Тогда
			ПараметрПредставления = НСтр("ru = 'По умолчанию'");
		Иначе
			ПараметрПредставления = НСтр("ru = 'Указаны текстом'");
		КонецЕсли;
		
	Иначе
		ПараметрПредставления = НСтр("ru = 'Не указаны'");
		Если ДеревоПолномочийСОграничениями.ПолучитьЭлементы().Количество() > 0 Тогда
			ПараметрПредставления = Строка(ДеревоПолномочийСОграничениями.ПолучитьЭлементы().Количество());
		КонецЕсли;
	КонецЕсли;
	
	Элементы.Полномочия.Заголовок = 
		СтрШаблон(НСтр("ru = 'Полномочия (%1)'"), ПараметрПредставления);
...
&НаКлиенте
Процедура ДобавитьМашинноеПолномочиеЗавершение(Результат, ИдентификаторСтроки = Неопределено) Экспорт
	
	Если Результат = Неопределено Тогда
		Возврат;
	КонецЕсли;
	
	ДублиПолномочий = Новый Массив;
	Для Каждого ДобавляемоеПолномочие Из Результат.НастройкиТекущегоПравила Цикл
		
		ПараметрыОтбора = Новый Структура("КодПолномочия", ДобавляемоеПолномочие.КодПолномочия);
		НайденныеСтроки = НастройкиПроверкиРасширенные.НайтиСтроки(ПараметрыОтбора);
		Если НайденныеСтроки.Количество() > 0 Тогда
			ДублиПолномочий.Добавить(ДобавляемоеПолномочие);
		КонецЕсли;
	КонецЦикла;
	
	Если ДублиПолномочий.Количество() > 0 Тогда 
		Если Результат.НастройкиТекущегоПравила.Количество() = 1 Тогда
			ПоказатьПредупреждение(, НСтр("ru = 'Добавляемое полномочие уже есть в списке.'"));
			Возврат;
		Иначе
			ПоказатьПредупреждение(, НСтр("ru = 'Дубли добавляемых полномочий были удалены.'"));
		КонецЕсли;
		Результат.НастройкиТекущегоПравила = 
			ОбщегоНазначенияКлиентСервер.РазностьМассивов(Результат.НастройкиТекущегоПравила, ДублиПолномочий);
	КонецЕсли;
		
	Модифицированность = Истина;
	ТекущийПорядковыйНомер = Результат.ПорядковыйНомер;
...
&НаКлиенте
Процедура ДобавитьСоставноеПолномочиеЗавершение(Результат, ИдентификаторСтроки = Неопределено) Экспорт
...
Процедура ДобавитьНовоеМашинноеПолномочие()
	...
	ПараметрыФормы.Вставить("ТолькоПолномочияБезПримененияОграничений", Истина);
	ПараметрыФормы.Вставить("ДополнительныеПараметры", 
		ПолучитьПараметрыРедактированияПравила(ТекущийПорядковыйНомер, Ложь, Истина));

	ОбработкаВыбора = Новый ОписаниеОповещения("ДобавитьМашинноеПолномочиеЗавершение", ЭтотОбъект);
	ОткрытьФорму("Справочник.КлассификаторПолномочийМЧД003.Форма.ФормаВыбора", ПараметрыФормы,
		Элементы.ДеревоПолномочийСОграничениямиЗначение, УникальныйИдентификатор, , , ОбработкаВыбора,
		РежимОткрытияОкнаФормы.БлокироватьОкноВладельца);
		
КонецПроцедуры

&НаКлиенте
Процедура ДобавитьНовоеСоставноеПолномочие()
	...
	ОбработкаВыбора = Новый ОписаниеОповещения("ДобавитьСоставноеПолномочиеЗавершение", ЭтотОбъект);
	ОткрытьФорму("Справочник.КлассификаторПолномочийМЧД003.Форма.ФормаПодбораСоставныхПолномочий", ПараметрыФормы,
		Элементы.ДеревоПолномочийСОграничениямиЗначение, УникальныйИдентификатор, , , ОбработкаВыбора,
		РежимОткрытияОкнаФормы.БлокироватьОкноВладельца);
...
Процедура ОбработатьСобытиеДереваПолномочийСОграничениями(ПараметрыВыполнения, ЭтоСобытиеУдалениеПравила)
	...
	ПодготовитьНастройкиПроверкиРасширенныеДляВизуализацииВДереве(ПараметрыВыполнения, ЭтоСобытиеУдалениеПравила);
	ОбновитьДанныеПолномочийСОграничениямиПоДеревуПолномочий();
	ПостроитьДеревоВизуализации();

КонецПроцедуры

&НаСервере
Процедура ПодготовитьНастройкиПроверкиРасширенныеДляВизуализацииВДереве(ПараметрыВыполнения, ЭтоСобытиеУдалениеПравила)
	
	Если ЭтоСобытиеУдалениеПравила Тогда 
		
		ПараметрыОтбора = Новый Структура("ПорядковыйНомер", ПараметрыВыполнения.УдаляемыйПорядковыйНомер);
		НайденныеСтроки = НастройкиПроверкиРасширенные.НайтиСтроки(ПараметрыОтбора);
...
Процедура ПостроитьДеревоВизуализации()
	...
	МашиночитаемыеДоверенности.ПостроитьДеревоВизуализацииПравилПроверки(
		ДеревоПолномочийСОграничениями, ТаблицаНастроек, Истина);
...
&НаКлиенте
Функция ПолучитьПараметрыРедактированияПравила(Знач ПорядковыйНомер, Знач Редактирование, Знач СозданиеМЧД = Ложь)
	
	Результат = МашиночитаемыеДоверенностиКлиент.НовыйПараметрыОткрытияФормыРедактированияПолномочий();
	Результат.Редактирование = Редактирование;
	Результат.СозданиеМЧД = СозданиеМЧД;
	...
	Если Редактирование Тогда 
		...
		НастройкиТекущегоПравила = Новый Массив;
		Если НастройкиПолномочия.Количество() > 0 Тогда 
			...
			Если НастройкиТекущегоПравила.Количество() = 1 Тогда 
	...
	Иначе 
		...
		Для Каждого ТекущаяНастройка Из НастройкиПроверкиРасширенные Цикл
			ПорядковыйНомер = Макс(ПорядковыйНомер,	ТекущаяНастройка.ПорядковыйНомер);
		КонецЦикла; 	
		
		Результат.ПорядковыйНомер = ПорядковыйНомер + 1;
...
&НаКлиенте
Процедура ОткрытьФормуРедактированияСоставныхПолномочий(Параметры)

	ОписаниеОповещенияПослеВыбора = Новый ОписаниеОповещения("ДеревоПолномочийСОграничениямиПослеВыбора", ЭтотОбъект);
	ОткрытьФорму("Справочник.КлассификаторПолномочийМЧД003.Форма.ФормаПодбораСоставныхПолномочий", 
		Параметры, ЭтотОбъект,,,, ОписаниеОповещенияПослеВыбора, РежимОткрытияОкнаФормы.БлокироватьОкноВладельца);
	
КонецПроцедуры
	
&НаКлиенте
Процедура ОткрытьФормуРедактированияПолномочий(Параметры)
...
Процедура ДеревоПолномочийСОграничениямиПослеВыбора(Результат, ДополнительныеПараметры) Экспорт 
	...
	ЭтоПолномочиеСОграничением = 
		Результат.НастройкиТекущегоПравила[0].КонтекстПолномочия = 
			МашиночитаемыеДоверенностиКлиентСервер.ПризнакПолномочиеСОграничением();
	
	ПараметрыОтбора = Новый Структура("КодПолномочия", Результат.НастройкиТекущегоПравила[0].КодПолномочия);
	НайденныеСтроки = НастройкиПроверкиРасширенные.НайтиСтроки(ПараметрыОтбора);
	Если Не ЭтоПолномочиеСОграничением И НайденныеСтроки.Количество() > 0 Тогда
		ПоказатьПредупреждение(, НСтр("ru = 'Выбранное полномочие уже есть в списке.'"));
		Возврат;
	КонецЕсли;
...
&НаСервере
Процедура ОбновитьДанныеПолномочийСОграничениямиПоДеревуПолномочий()

	Доверенность[0].Документ[0].Довер[0].СвПолн[0].МашПолн.Очистить();
	
	ПолномочияСОграничениями = 
		НастройкиПроверкиРасширенные.Выгрузить(,
			"ПорядковыйНомер, НаименованиеПолномочия, КодПолномочия, МнемоникаПолномочия, КонтекстПолномочия");
	
	ПолномочияСОграничениями.Свернуть(
		"ПорядковыйНомер, НаименованиеПолномочия, КодПолномочия, МнемоникаПолномочия, КонтекстПолномочия");
	
	Для Каждого Полномочие Из ПолномочияСОграничениями Цикл
		
		ДанныеПолномочия = Доверенность[0].Документ[0].Довер[0].СвПолн[0].МашПолн.Добавить();
		ДанныеПолномочия.КодПолн = Полномочие.КодПолномочия;
		ДанныеПолномочия.НаимПолн = Полномочие.НаименованиеПолномочия;
		ДанныеПолномочия._Полномочие = МашиночитаемыеДоверенностиКлиентСервер.СформироватьПредставлениеПолномочия(
			Полномочие.КодПолномочия, Полномочие.НаименованиеПолномочия);
		
		ВзведенВторойФлаг = Сред(Доверенность[0].ПрЭлФорм, 2, 1) = "1";
		Если ВзведенВторойФлаг Тогда  
			ДанныеПолномочия.МнПолн = Полномочие.МнемоникаПолномочия;
		КонецЕсли;
		
		Если Полномочие.КонтекстПолномочия = МашиночитаемыеДоверенностиКлиентСервер.ПризнакПолномочиеСОграничением() Тогда
			
			ОтборПоОграничениям = Новый Структура("ПорядковыйНомер", Полномочие.ПорядковыйНомер);
			ОграниченияПоПолномочиям = НастройкиПроверкиРасширенные.НайтиСтроки(ОтборПоОграничениям);
			
			Для Каждого Ограничение Из ОграниченияПоПолномочиям Цикл 
				Если ЗначениеЗаполнено(Ограничение.КодОграничения) Тогда
					ДанныеОграничения = ДанныеПолномочия.ОгрСвПолн.Добавить();
					ДанныеОграничения.ИдОгр = Ограничение.ИдентификаторОграничения;
					ДанныеОграничения.КодОгр = Ограничение.КодОграничения;
					ДанныеОграничения.НаимОгр = Ограничение.НаименованиеОграничения;
					ДанныеОграничения.НаимЗначОгр = Ограничение.НаименованиеЗначенияОграничения;
					ДанныеОграничения.КодЗначОгр = Ограничение.КодЗначенияОграничения;
					ДанныеОграничения.ТексЗначОгр = Ограничение.ТекстовоеОписаниеОграничения;
					
					Если Ограничение.КодОграничения = МашиночитаемыеДоверенностиКлиентСервер.КодОграниченияЛимитПоСумме() Тогда
						ДанныеОграничения.ТексЗначОгр = 
							Формат(СтроковыеФункцииКлиентСервер.СтрокаВЧисло(
								Ограничение.ТекстовоеОписаниеОграничения),"ЧЦ=14; ЧГ=0");	
					КонецЕсли;
					Если Ограничение.КодОграничения = МашиночитаемыеДоверенностиКлиентСервер.КодОграниченияКонтрагент()
						Или Ограничение.КодОграничения = МашиночитаемыеДоверенностиКлиентСервер.КодОграниченияФилиалКонтрагента() Тогда
						ДанныеОграничения.ТексЗначОгр = СокрЛП(Ограничение.ТекстовоеОписаниеОграничения);	
					КонецЕсли;
...
Процедура УдалитьТекущегоПредставителя()
	...
	ИначеЕсли КоличествоЗаписей = 1 Тогда
		...
		Элементы.ДекорацияЗаголовокГруппыПредставителей.Заголовок = НСтр("ru='Сведения о представителях';");
		СброситьОформлениеЭлементовФормы(Элементы.ГруппаПредставитель, Истина);
	КонецЕсли;
	ОбновитьВидимостьКомандТаблицыПредставителей(ЭтотОбъект);
	ОбновитьНумерациюТаблицы(Доверенность[0].Документ[0].Довер[0].СвУпПред);
КонецПроцедуры
...
Процедура УстановкаПризнакаУтратыПолномочийПриПередоверии()
	...
	Если СведенияДоверенности.ПрПередов = ПризнакПередоверия.Однократное Или СведенияДоверенности.ПрПередов
		= ПризнакПередоверия.ПоследующееПередоверие Тогда
...
Функция Псевдонимы(Форма)
	...
	Псевдонимы.Вставить("ЛицоБезДоверенностиОрганизации",
		Форма.Доверенность[0].Документ[0].Довер[0].СвДоверит[0].Доверит[0].РосОргДовер[0].ЛицоБезДов[0]);
	Возврат Псевдонимы;
КонецФункции
...
Процедура ПриИзмененииДаты(ИмяЭлемента)
	...
	Если ИмяЭлемента = Элементы.ДоверенностьДокументДоверСвДовДатаВыдДовер.Имя И ЗначениеЗаполнено(СвДов.ДатаВыдДовер)
		...
		МашиночитаемыеДоверенностиКлиент.СброситьОформлениеПолей(ОбщегоНазначенияКлиентСервер.ЗначениеВМассиве(
...
//    * ЭтоЧерновик - Булево
//    * КонтекстЗаписи - Неопределено - Контекст записи еще не создан.
//                     - см. НовыйКонтекстЗаписи
//    * РегистрироватьВРР - Булево
//    * ИспользоватьЦентрЭДО - Булево
//    * ПараметрыСинхронизацииСЦентромЭДО - Неопределено
...
Функция НовыеПараметрыЗаписи()
	...
	ПараметрыЗаписиФормы.Вставить("ИспользоватьЦентрЭДО", Ложь);
	ПараметрыЗаписиФормы.Вставить("ПараметрыСинхронизацииСЦентромЭДО", Неопределено);
...
Процедура ЗаполнитьКонтекстИЗаписать(ПараметрыЗаписи)
	...
	Если ПараметрыЗаписиФормы.ИспользоватьЦентрЭДО Тогда
		ЗаписатьВЦентрЭДО(ПараметрыЗаписиФормы);
		Возврат;
	КонецЕсли;
...
Процедура ПодготовитьФормуПередЗаписью(ПараметрыЗаписи)
	...
	ПодготовитьФормуПередЗаписьюЧерезЦентрЭДО(ПараметрыЗаписи);
...
Процедура ЗаполнитьКонтекстЗаписи(ПараметрыЗаписи)
	...
	КонтекстЗаписи.АдресДанныхФайлаМЧД = ПоместитьВоВременноеХранилище(ДвоичныеДанные, УникальныйИдентификатор);
...
Функция ЭтоТаблицаПростыхЗначенийМЧД(Путь)
	...
	Если Реквизиты.Количество() = 1 И Реквизиты[0].Имя = ИмяКолонкиПростогоЗначения() Тогда
...
Процедура СообщитьОбОшибках(ОшибкиФормирования)
	...
	Если ЗначениеЗаполнено(ГруппыОшибок.Общее) Тогда
		ШаблонСообщения = НСтр("ru='Не удалось заполнить общие сведения доверенности:
							   |%1';");
		ОбщегоНазначения.СообщитьПользователю(СтрШаблон(ШаблонСообщения, СтрСоединить(ГруппыОшибок.Общее, Символы.ПС)));
	КонецЕсли;
...
Функция ЗаданВопросОбОшибкахПриРегистрацииМЧД(ПараметрыЗаписи)
	...
	ПоказатьВопрос(ОбработчикОтвета, ТекстВопроса, РежимДиалогаВопрос.ДаНет, , , НСтр("ru = 'Ошибки формирования МЧД'"));
...
Процедура ЗарегистрироватьМЧДПриНеобходимости(ПараметрыЗаписи)
	...
	МашиночитаемыеДоверенностиКлиент.ПодписатьЗарегистрироватьМЧД(
		РегистрироватьВРР, МашиночитаемыеДоверенностиКлиентСервер.ФорматМЧД_003(), ОбработчикПослеПодписания,
...
Процедура ОбработатьРегистрациюМЧД(Результат, Контекст) Экспорт
	...
	Если ТипЗнч(Результат) <> Тип("Структура") Или Не ЗначениеЗаполнено(Результат.ИдентификаторТранзакции) Тогда

		Если ЗначениеЗаполнено(Результат.ОписаниеОшибкиРегистрации) И Не МашиночитаемыеДоверенностиКлиентСервер.РодительскаяМЧДОтсутствуетВРеестре(
...
Процедура ЗаполнитьДанныеФормыПоДаннымМЧД(ДанныеМЧД)
	...
	ТипПолномочий = ЗначениеВДеревеДоверенности("Доверенность[0].Документ[0].Довер[0].СвПолн[0].ТипПолн");
	Если ТипПолномочий = ТипыПолномочий().Текстовые Тогда
		ВариантЗаполненияПолномочий = ТипыПолномочий().Текстовые;
	Иначе
		ВариантЗаполненияПолномочий = ТипыПолномочий().Машиночитаемые;
		ЗаполнитьДеревоПолномочийСОграничениямиПоДаннымМЧД();
	КонецЕсли;
...
&НаСервере
Процедура ЗаполнитьДеревоПолномочийСОграничениямиПоДаннымМЧД()
	
	НастройкиПроверкиРасширенные.Очистить();
	
	ПолномочияПоДаннымМЧД = ЗначениеВДеревеДоверенности("Доверенность[0].Документ[0].Довер[0].СвПолн[0].МашПолн");
	МассивКодовПолномочий = ПолномочияПоДаннымМЧД.Выгрузить(, "КодПолн").ВыгрузитьКолонку("КодПолн");
	...
	Для Каждого ПолномочиеПоДаннымМЧД Из ПолномочияПоДаннымМЧД Цикл
		
		Если Не ЗначениеЗаполнено(ПолномочиеПоДаннымМЧД.КодПолн) Тогда
			Продолжить;
		КонецЕсли;
		
		Если ПолномочиеПоДаннымМЧД.ОгрСвПолн.Количество() > 0 Тогда
			
			Для Каждого ОграничениеПоДаннымМЧД Из ПолномочиеПоДаннымМЧД.ОгрСвПолн Цикл
				
				ПолномочиеВДереве = НастройкиПроверкиРасширенные.Добавить();
				ПолномочиеВДереве.КодПолномочия = ПолномочиеПоДаннымМЧД.КодПолн;
				ПолномочиеВДереве.МнемоникаПолномочия = ПолномочиеПоДаннымМЧД.МнПолн;
				ПолномочиеВДереве.НаименованиеПолномочия = ПолномочиеПоДаннымМЧД.НаимПолн;
				ПолномочиеВДереве.СтрокаЭлемент = ПолномочиеПоДаннымМЧД.НаимПолн;
				ПолномочиеВДереве.СтрокаЗначение = ОграничениеПоДаннымМЧД.НаимЗначОгр;
				ПолномочиеВДереве.ПорядковыйНомер = Число(ПолномочиеПоДаннымМЧД._НомерСтроки);
				ПолномочиеВДереве.КонтекстПолномочия = КонтекстПолномочийПоКодам[ПолномочиеПоДаннымМЧД.КодПолн];
					
				Если ЗначениеЗаполнено(ОграничениеПоДаннымМЧД.КодОгр) Тогда
					ПолномочиеВДереве.ИдентификаторОграничения = ОграничениеПоДаннымМЧД.ИдОгр;
					ПолномочиеВДереве.КодЗначенияОграничения = ОграничениеПоДаннымМЧД.КодЗначОгр;
					ПолномочиеВДереве.КодОграничения = ОграничениеПоДаннымМЧД.КодОгр;
					ПолномочиеВДереве.НаименованиеЗначенияОграничения = ОграничениеПоДаннымМЧД.НаимЗначОгр;
					ПолномочиеВДереве.НаименованиеОграничения = ОграничениеПоДаннымМЧД.НаимОгр; 
					ПолномочиеВДереве.ТекстовоеОписаниеОграничения = ОграничениеПоДаннымМЧД.ТексЗначОгр;
				КонецЕсли;
			КонецЦикла;
		Иначе
			ПолномочиеВДереве = НастройкиПроверкиРасширенные.Добавить();
			...
			ПолномочиеВДереве.НаименованиеПолномочия = ПолномочиеПоДаннымМЧД.НаимПолн;
			ПолномочиеВДереве.СтрокаЭлемент = ПолномочиеПоДаннымМЧД.НаимПолн;
			ПолномочиеВДереве.СтрокаЗначение = ПолномочиеПоДаннымМЧД.КодПолн;
			ПолномочиеВДереве.ПорядковыйНомер = Число(ПолномочиеПоДаннымМЧД._НомерСтроки);
			ПолномочиеВДереве.КонтекстПолномочия = КонтекстПолномочийПоКодам[ПолномочиеПоДаннымМЧД.КодПолн];
		КонецЕсли;
	КонецЦикла;
...
Процедура ЗаполнитьСлужебныеРеквизитыДоверителей()
	...
	Иначе
		...
		Если ЕИОУК = БулевыйКлассификатор.Да Тогда
			...
			УстановитьЗначениеВДеревеДоверенности(СтрШаблон("%1._ЛицоБезДоверенности", ПутьЛица), ПредставлениеЕИО);
...
Процедура ЗаполнитьСлужебныеРеквизитыПредставителей()
	...
	Для ИндексПредставителя = 0 По КоличествоПредставителей - 1 Цикл
		...
		УстановитьЗначениеВДеревеДоверенности(СтрШаблон("%1._НомерСтроки", ПутьПредставителя), ИндексПредставителя + 1);

		ТипПредставителя = ЗначениеВДеревеДоверенности(СтрШаблон("%1.ТипПред", ПутьПредставителя));

		Если ТипПредставителя = ТипыПредставителей.ЮридическоеЛицо Тогда

			ПредставлениеПредставителя = ЗначениеВДеревеДоверенности(СтрШаблон("%1.Пред[0].СведОрг[0].НаимОрг",
				ПутьПредставителя));
		...
		ИначеЕсли ТипПредставителя = ТипыПредставителей.ИндивидуальныйПредприниматель Тогда
			...
			Если Не ЗначениеЗаполнено(ПредставлениеПредставителя) Тогда
				...
				Фамилия = ЗначениеВДеревеДоверенности(СтрШаблон("%1.Пред[0].СведИП[0].СведФЛ[0].ФИО[0].Фамилия",
					ПутьПредставителя));
				Имя = ЗначениеВДеревеДоверенности(СтрШаблон("%1.Пред[0].СведИП[0].СведФЛ[0].ФИО[0].Имя",
					ПутьПредставителя));
				Отчество = ЗначениеВДеревеДоверенности(СтрШаблон("%1.Пред[0].СведИП[0].СведФЛ[0].ФИО[0].Отчество",
					ПутьПредставителя));
		...
		ИначеЕсли ТипПредставителя = ТипыПредставителей.ФизическоеЛицо Тогда
			...
			Фамилия = ЗначениеВДеревеДоверенности(СтрШаблон("%1.Пред[0].СведФизЛ[0].СведФЛ[0].ФИО[0].Фамилия",
				ПутьПредставителя));
			Имя = ЗначениеВДеревеДоверенности(СтрШаблон("%1.Пред[0].СведФизЛ[0].СведФЛ[0].ФИО[0].Имя",
				ПутьПредставителя));
			Отчество = ЗначениеВДеревеДоверенности(СтрШаблон("%1.Пред[0].СведФизЛ[0].СведФЛ[0].ФИО[0].Отчество",
				ПутьПредставителя));
...
Процедура ЗаполнитьСлужебныеРеквизитыПолномочий()
	...
	Для ИндексПолномочия = 0 По КоличествоПолномочий - 1 Цикл
		...
		УстановитьЗначениеВДеревеДоверенности(СтрШаблон("%1._НомерСтроки", ПутьПолномочия), ИндексПолномочия + 1);
		...
		УстановитьЗначениеВДеревеДоверенности(СтрШаблон("%1._Полномочие", ПутьПолномочия), Представление);
...
Процедура ОчиститьЗначенияНеиспользуемыхТиповПолномочий()
	...
	Если ТипПолномочий = ТипыПолномочий().Текстовые Тогда
		...
		ТаблицаМашиночитаемыхПолномочий = ЗначениеВДеревеДоверенности(
			"Доверенность[0].Документ[0].Довер[0].СвПолн[0].МашПолн"); // ДанныеФормыКоллекция
...
&НаСервере
Процедура ПриИзмененииВариантаЗаполненияНаСервере()
...
Функция ЗначениеВДеревеДоверенности(Путь)
	...
	Если ЧастиПути.Количество() = 0 Тогда
		ВызватьИсключение НСтр(
			"ru = 'Некорректный вызов метода, в качестве пути должен быть передан путь в формате Доверенность[0].<Свойство>[N]...'");
	КонецЕсли;
...
//  ПараметрыЗаписи - см. НовыеПараметрыЗаписи
&НаСервере
Процедура ПодготовитьФормуПередЗаписьюЧерезЦентрЭДО(ПараметрыЗаписи)
	
	Если Не НастройкиЭДО.ИспользоватьИнтеграциюЦентраЭДО() Тогда
		Возврат;
	КонецЕсли;
	
	РеквизитыДоверителя = РеквизитыДоверителя();
	Если Не ЗначениеЗаполнено(РеквизитыДоверителя.ИНН) Тогда
		Возврат
	КонецЕсли;
	...
	ПараметрыЗаписи.ИспользоватьЦентрЭДО =
		МодульМашиночитаемыеДоверенностиИнтеграцияЦентраЭДО.ЕстьУчетныеЗаписиЦентровЭДОПоДоверителю(РеквизитыДоверителя);
	
КонецПроцедуры

// Возвращаемое значение:
//  См. ИнтеграцияЭДО.НовыеКлючевыеРеквизитыУчастникаЭДО
&НаСервере
Функция РеквизитыДоверителя()
	
	Реквизиты = ИнтеграцияЭДО.НовыеКлючевыеРеквизитыУчастникаЭДО();
	
	СведенияОДоверителе = Доверенность[0].Документ[0].Довер[0].СвДоверит[0];
	ТипыДоверителей = ТипыДоверителей();
	
	Если СведенияОДоверителе.ТипДоверит = ТипыДоверителей.ИндивидуальныйПредприниматель Тогда
		Реквизиты.ИНН = СведенияОДоверителе.Доверит[0].ИПДовер[0].ИННФЛ;
	ИначеЕсли СведенияОДоверителе.ТипДоверит = ТипыДоверителей.ЮридическоеЛицо Тогда
		СведенияЮридическогоЛица = СведенияОДоверителе.Доверит[0].РосОргДовер[0].СвРосОрг[0];
		Реквизиты.ИНН = СведенияЮридическогоЛица.ИННЮЛ;
		Реквизиты.КПП = СведенияЮридическогоЛица.КПП;
	КонецЕсли;
...
//  ПараметрыЗаписи - см. НовыеПараметрыЗаписи
&НаКлиенте
Процедура ЗаписатьВЦентрЭДО(ПараметрыЗаписи)
	
	КонтекстЗаписи = ПараметрыЗаписи.КонтекстЗаписи; // См. НовыйКонтекстЗаписи
	Если Не ЗначениеЗаполнено(КонтекстЗаписи) Тогда
		ВызватьИсключение НСтр("ru = 'Некорректные параметры для записи в центр ЭДО'");
	КонецЕсли;
	...
	Оповещение = Новый ОписаниеОповещения("ЗаписатьВЦентрЭДОЗавершение", ЭтотОбъект, ПараметрыЗаписи);
	...
	МодульМашиночитаемыеДоверенностиИнтеграцияЦентраЭДОКлиент.ЗаписатьЧерновикВЦентрЭДО(
		Оповещение, Объект.Ссылка, КонтекстЗаписи.АдресДанныхФайлаМЧД, ЭтотОбъект);
	
КонецПроцедуры

// Параметры:
//  Результат - см. МашиночитаемыеДоверенностиИнтеграцияЦентраЭДОКлиент.ЗаписатьЧерновикВЦентрЭДОЗавершение
//  ПараметрыЗаписи - см. НовыеПараметрыЗаписи
&НаКлиенте
Процедура ЗаписатьВЦентрЭДОЗавершение(Результат, ПараметрыЗаписи) Экспорт
	...
	Если Результат.Успех Тогда
		Если Результат.ЭтоНовыйОбъектСинхронизации Тогда
			ПараметрыЗаписи.ПараметрыСинхронизацииСЦентромЭДО = Результат.ПараметрыСинхронизации;
		КонецЕсли;
...
//  ПараметрыЗаписи - см. НовыеПараметрыЗаписи
&НаСервере
Процедура ЗаполнитьДополнительныеСвойстваЦентраЭДОПередЗаписью(ТекущийОбъект, ПараметрыЗаписи)
	
	Если ЗначениеЗаполнено(ПараметрыЗаписи.ПараметрыСинхронизацииСЦентромЭДО) Тогда
		ТекущийОбъект.ДополнительныеСвойства.Вставить(
			"ПараметрыСинхронизацииСЦентромЭДО", ПараметрыЗаписи.ПараметрыСинхронизацииСЦентромЭДО);
	КонецЕсли;
...
&НаСервере
Процедура УстановитьВидимостьПоляСрокДействия(ПолеФормыСрокДействия, ЗначениеПоляКодВидДок)
	
	МашиночитаемыеДоверенностиКлиентСервер.УстановитьВидимостьПоляСрокДействия(ПолеФормыСрокДействия, 
