...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Элементы.СоздатьВручную.Видимость = ПравоНастройкиОбмена;
	Элементы.СписокЗагрузитьНастройкиИзФайла.Видимость = ПравоНастройкиОбмена;
	...
	Если ОбщегоНазначения.ЭтоМобильныйКлиент() Тогда
		...
		Элементы.СписокКоманднаяПанель.ПодчиненныеЭлементы.СоздатьВручную.Видимость = Ложь;
		Элементы.СписокКоманднаяПанель.ПодчиненныеЭлементы.СписокЗагрузитьНастройкиИзФайла.Видимость = Ложь;
