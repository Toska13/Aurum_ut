...
Процедура ПартнерПриИзменении(Элемент)
	...
	ОбновитьСписокВыбораПланированияДоставки();
...
Процедура ПриЧтенииСозданииНаСервере()
	...
	НастроитьСписокВыбораРазбиватьРасходныеОрдераПоРаспоряжениям();
...
&НаСервере
Процедура НастроитьСписокВыбораРазбиватьРасходныеОрдераПоРаспоряжениям()
	
	СписокВыбора = Элементы.РазбиватьРасходныеОрдераПоРаспоряжениям.СписокВыбора;
	СписокВыбора.Очистить();
	
	СписокВыбора.Добавить(1, НСтр("ru = 'с разбиением по заказам и накладным'"));
	ИспользуетсяДоставка25 = ДоставкаТоваровКлиентСервер.ИспользуетсяДоставка25();
	Если ИспользуетсяДоставка25 Тогда
		
		СписокВыбора.Добавить(0, НСтр("ru = 'с разбиением по партнерам'"));
		
	Иначе
		
		СписокВыбора.Добавить(0, НСтр("ru = 'с группировкой по партнерам и заданиям на перевозку'"));
...
&НаСервере
Процедура ОбновитьСписокВыбораПланированияДоставки()
