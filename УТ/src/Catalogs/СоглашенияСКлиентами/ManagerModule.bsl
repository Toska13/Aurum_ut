...
Процедура ДобавитьКомандыСозданияНаОсновании(КомандыСозданияНаОсновании, Параметры) Экспорт
	...
	КомандаСоздания = Документы.ОтгрузкаТоваровКлиенту.ДобавитьКомандуСоздатьНаОсновании(
		КомандыСозданияНаОсновании);
	
	Если КомандаСоздания <> Неопределено Тогда
		КомандаСоздания.ВидимостьВФормах = "ФормаСписка,ФормаСпискаИндивидуальныхСоглашений";
		КомандаСоздания.РежимЗаписи = "";
		ПодключаемыеКоманды.ДобавитьУсловиеВидимостиКоманды(КомандаСоздания,
																	"Типовое",
																	Ложь,
...
Процедура ПриОпределенииДоступныхВидовОповещенийПользователей(ОписаниеВидовОповещений) Экспорт
	...
	НовыйВидОповещений.Идентификатор = "d0dcb5bd-9406-481c-aa51-f0426398cc6d";
	НовыйВидОповещений.Наименование = НСтр("ru = 'Согласование соглашений об условиях продаж'", ОбщегоНазначения.КодОсновногоЯзыка());
	НовыйВидОповещений.ТипОповещения = Перечисления.ТипыОповещенийПользователей.Неоперативное;
	НовыйВидОповещений.ИмяШаблонаСКД = Метаданные.Справочники.СоглашенияСКлиентами.Макеты.Оповещения_Согласование.ПолноеИмя();
	НовыйВидОповещений.ШаблонТекстаОповещения = "ru = 'Согласовать соглашение.'"; // @NStr-1
	НовыйВидОповещений.ТекстСгруппированногоОповещения = "ru = 'Согласовать соглашения об условиях продаж.'"; // @NStr-1
	
	НовыйВидОповещений = ОповещенияПользователейОСобытиях.ДобавитьОписаниеВидаОповещенийПользователей(ОписаниеВидовОповещений);
	НовыйВидОповещений.ГруппаВидаОповещений = ГруппаВидаОповещенийПродажи;
	НовыйВидОповещений.Идентификатор = "413b40aa-ec43-4c07-a73b-fcc1dafd25a2";
	НовыйВидОповещений.Наименование = НСтр("ru = 'Приближение даты окончания действия соглашений об условиях продаж'", ОбщегоНазначения.КодОсновногоЯзыка());
	НовыйВидОповещений.ТипОповещения = Перечисления.ТипыОповещенийПользователей.Неоперативное;
	НовыйВидОповещений.ИмяШаблонаСКД = Метаданные.Справочники.СоглашенияСКлиентами.Макеты.Оповещения_ОкончаниеСрокаДействияПриближается.ПолноеИмя();
	НовыйВидОповещений.ШаблонТекстаОповещения = "ru = 'Заканчивается срок действия соглашения [ДатаОкончанияДействия].'"; // @NStr-1
	НовыйВидОповещений.ТекстСгруппированногоОповещения = "ru = 'Заканчивается срок действия соглашений об условиях продаж.'"; // @NStr-1
	
	НовыйВидОповещений = ОповещенияПользователейОСобытиях.ДобавитьОписаниеВидаОповещенийПользователей(ОписаниеВидовОповещений);
	НовыйВидОповещений.ГруппаВидаОповещений = ГруппаВидаОповещенийПродажи;
	НовыйВидОповещений.Идентификатор = "ed019256-d7ca-4717-991f-62a6eef8f4f1";
	НовыйВидОповещений.Наименование = НСтр("ru = 'Окончание срока действия соглашений об условиях продаж'", ОбщегоНазначения.КодОсновногоЯзыка());
	НовыйВидОповещений.ТипОповещения = Перечисления.ТипыОповещенийПользователей.Неоперативное;
	НовыйВидОповещений.ИмяШаблонаСКД = Метаданные.Справочники.СоглашенияСКлиентами.Макеты.Оповещения_ОкончаниеСрокаДействияПросрочено.ПолноеИмя();
	НовыйВидОповещений.ШаблонТекстаОповещения = "ru = 'Закончился срок действия соглашения [ДатаОкончанияДействия].'"; // @NStr-1
	НовыйВидОповещений.ТекстСгруппированногоОповещения = "ru = 'Закончился срок действия соглашений об условиях продаж.'"; // @NStr-1
...
Процедура ОбработкаПолученияДанныхВыбора(ДанныеВыбора, Параметры, СтандартнаяОбработка)
	...
	ОтгрузкаБезПереходаПраваСобственности25 = Неопределено;
	...
	Если Параметры.Свойство("ОтгрузкаБезПереходаПраваСобственности25") Тогда
		ОтгрузкаБезПереходаПраваСобственности25 = Параметры.ОтгрузкаБезПереходаПраваСобственности25;
	КонецЕсли;
	
	Если ОтгрузкаБезПереходаПраваСобственности25 = Истина Тогда
	...
	Запрос = Новый Запрос("
		...
		|			ИЛИ ДокументСоглашениеСКлиентом.ХозяйственнаяОперация = ЗНАЧЕНИЕ(Перечисление.ХозяйственныеОперации.РеализацияКлиенту)
		|				И &ОтборОтгрузкаБезПереходаПраваСобственности25
		|				И ДокументСоглашениеСКлиентом.ВозможнаРеализацияБезПереходаПраваСобственности
		|				И ДокументСоглашениеСКлиентом.ИспользуютсяДоговорыКонтрагентов
		...
		|		И ДокументСоглашениеСКлиентом.ХозяйственнаяОперация В (ЗНАЧЕНИЕ(Перечисление.ХозяйственныеОперации.РеализацияКлиенту))
		|			ТОГДА ДокументСоглашениеСКлиентом.ВозможнаРеализацияБезПереходаПраваСобственности
		|			И ДокументСоглашениеСКлиентом.ИспользуютсяДоговорыКонтрагентов
		|		ИНАЧЕ ИСТИНА
		|	КОНЕЦ
	...
	Запрос.УстановитьПараметр("ОтборОтгрузкаБезПереходаПраваСобственности25",
								ОтгрузкаБезПереходаПраваСобственности25 = Истина);
...
Процедура ЗаполнитьРеквизитыШапкиДокументСоглашениеСКлиентом(ДанныеПечати, Макет, ТабличныйДокумент)
	...
	ТипСоглашенияДляПечати = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(Нстр("ru = 'Тип соглашения: %1'",
		ОбщегоНазначения.КодОсновногоЯзыка()),
		ДанныеПечати.ХозяйственнаяОперация);
	СтруктураДанныхТипСоглашения = Новый Структура("ТипСоглашения", ТипСоглашенияДляПечати);
