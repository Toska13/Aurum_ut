...
Процедура ПриДобавленииОбработчиковОбновления(Обработчики) Экспорт
	...
	Обработчик.Идентификатор = Новый УникальныйИдентификатор("c5c85890-b0f4-11f0-8de9-0242ac120002");
	...
	Обработчик.Комментарий = НСтр("ru = 'Обновление кэшированных запросов для скидок/наценок'");
...
Процедура ЗарегистрироватьДанныеДляПереходаНаНовуюВерсию(Параметры) Экспорт
	...
	Запрос = Новый Запрос(
		...
		|ГДЕ
		|	НЕ СкидкиНаценки.УдалитьОбновленНаПолучениеОстатковСУчетомТоваровНаКонтроле
