...
//  РазделУчета   - ПеречислениеСсылка.РазделыУчетаЗЕРНО - РазделУчета.
//  ДанныеРеестраЭлеваторовXML - Строка                 - Данные реестра.
//
// Возвращаемое значение:
//  Массив из См. ИнтеграцияЗЕРНОСлужебный.СтруктураСообщенияXML
//
Функция СообщенияЗагрузкиРеестраЭлеваторов(СсылкаНаОбъект, Организация, РазделУчета, ДанныеРеестраЭлеваторовXML)
	...
	Попытка
		...
		Иначе
			...
			ОбработкаЗагрузкиПолученныхДанных(
				Неопределено, ПараметрыОбмена, ДанныеОбработки.Объект, ИзмененныеОбъекты, ПараметрыОбмена.ПараметрыОптимизации.ВерсияAPI);
		КонецЕсли;
