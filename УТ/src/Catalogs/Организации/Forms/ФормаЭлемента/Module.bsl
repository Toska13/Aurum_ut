...
Процедура ОбработкаОповещения(ИмяСобытия, Параметр, Источник)
	...
	ИначеЕсли ИмяСобытия = "УстановкаОсновногоБанковскогоСчета" Тогда
		...
		Если Объект.Ссылка = Параметр.Организация Тогда
			
			Объект.ОсновнойБанковскийСчет = Параметр.ОсновнойБанковскийСчет;
			Модифицированность = Истина;
			Оповестить("ИзменениеОсновногоБанковскогоСчета", Объект.ОсновнойБанковскийСчет, ЭтотОбъект);
...
&НаКлиенте
Процедура ОсобыйПризнакЗаявителяДОПППриИзменении(Элемент)
