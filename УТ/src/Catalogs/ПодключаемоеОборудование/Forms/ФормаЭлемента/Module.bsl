...
Процедура ПодключитьТСПИоТ_Продолжить(РезультатВыполнения, Параметры) Экспорт
	...
	Если РезультатВыполнения.Результат Тогда     
		...
		Если ОписаниеДрайвера.РевизияИнтерфейса < 5000 Тогда  
			ОписаниеОшибки = СтрШаблон(НСтр("ru = 'Для использования ""%1"" необходимо использования драйвера стандарта 5.0 и выше.'"), Наименование1СТСПиОТ());
