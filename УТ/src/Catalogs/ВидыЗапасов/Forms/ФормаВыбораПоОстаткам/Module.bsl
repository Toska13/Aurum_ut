...
#Область ОбработчикиСобытийЭлементовТаблицыФормыТаблицаВидовЗапасов

&НаКлиенте
Процедура ТаблицаВидовЗапасовВыбор(Элемент, ВыбраннаяСтрока, Поле, СтандартнаяОбработка)
...
&НаКлиенте
Процедура УстановитьОтборПоОстаткам(Команда)
	
	БезОстатков = Не БезОстатков;
	Элементы.УстановитьОтборПоОстаткам.Пометка = БезОстатков;
	ЗаполнитьТаблицаВидовЗапасов();
	
КонецПроцедуры

&НаКлиенте
Процедура УстановитьОблагаетсяАкцизом(Команда)
	
	ОблагаетсяАкцизом = Не ОблагаетсяАкцизом;
	Элементы.УстановитьОблагаетсяАкцизом.Пометка = ОблагаетсяАкцизом;
	ЗаполнитьТаблицаВидовЗапасов();
...
Процедура ЗаполнитьТаблицаВидовЗапасов()
	...
	|	ЕСТЬNULL(ВидыЗапасов.ОблагаетсяАкцизом, ЛОЖЬ) КАК ОблагаетсяАкцизом,
	...
	|	И НЕ ВидыЗапасов.Ссылка В (ВЫБРАТЬ ВТОстатки.ВидЗапасов ИЗ ВТОстатки)
	|	И &УсловияТаблицаВыборки";
	...
	ПараметрыЗапроса.Вставить("ОблагаетсяАкцизом",     ОблагаетсяАкцизом);
	ПараметрыЗапроса.Вставить("БезОстатков",           БезОстатков);
