...
Процедура УстановитьУсловноеОформление()
	...
	ПараметрыУсловногоОформления.ИмяПоляТипНоменклатуры = "Товары.ТипНоменклатуры";
	ПараметрыУсловногоОформления.ПроверятьЗаполненностьСклада = Истина;
	ПараметрыУсловногоОформления.ИмяПоляСкладВТЧ = "Товары.Склад";
...
Процедура ОбновитьСтруктуруКроссТаблицы(ТаблицаПериоды, ПересчитыватьИтоговыеПоказатели = Истина)
	...
	Планирование.ДобавитьПолеКроссТаблицыСумма(ПараметрыВывода, ПланироватьПоСумме И ЭтоОдинПериод, ПараметрыПоляСумма);
