...
Процедура УстановитьНастройкиПоУмолчанию(Команда)
	...
	Если ДеревоЭлементы.Количество() > 0 Тогда
		...
		Если ЭлементыИсточники.Количество() > 0 Тогда
			...
			Для индекс = 0 По ЭлементыИсточники.Количество() - 1 Цикл
				
				ЭлементИсточник = ЭлементыИсточники.Получить(индекс);
				ЭлементИсточник.АдресПользовательскихНастроек = ПоместитьВоВременноеХранилище(Неопределено, УникальныйИдентификатор);
				...
				Если ПользовательскиеНастройки <> Неопределено Тогда
					КомпоновщикНастроекИсточникаКоличества.ЗагрузитьПользовательскиеНастройки(ПользовательскиеНастройки);
				КонецЕсли;
	...
	Если ДеревоЭлементы.Количество() > 1 Тогда
		...
		Если ЭлементыИсточники.Количество() > 0 Тогда
			...
			Для индекс = 0 По ЭлементыИсточники.Количество() - 1 Цикл
				...
				Если ПользовательскиеНастройки <> Неопределено Тогда
					КомпоновщикНастроекИсточникаЦены.ЗагрузитьПользовательскиеНастройки(ПользовательскиеНастройки);
				КонецЕсли;
