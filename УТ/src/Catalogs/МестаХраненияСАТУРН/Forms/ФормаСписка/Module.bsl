...
Процедура Создать(Команда)
	...
	ОповещениеПослеСоздания = Новый ОписаниеОповещения("МестоХраненияПослеСоздания", ЭтотОбъект);
	ОткрытьФорму("Справочник.МестаХраненияСАТУРН.Форма.ПомощникСоздания", ПараметрыОткрытияФормы, ЭтотОбъект,,,,ОповещениеПослеСоздания);
