...
Функция НастройкиПодключения() Экспорт
	...
	Запрос.Текст =
	"ВЫБРАТЬ
	|	НастройкиПодключенияКИнтернетЭквайрингу.Ссылка КАК Ссылка,
	|	НастройкиПодключенияКИнтернетЭквайрингу.Используется КАК Используется,
	|	НастройкиПодключенияКИнтернетЭквайрингу.ИдентификаторУчастника КАК ИдентификаторУчастника
	|ИЗ
	|	Справочник.НастройкиПодключенияКИнтернетЭквайрингу КАК НастройкиПодключенияКИнтернетЭквайрингу";
	...
	Пока Выборка.Следующий() Цикл
		...
		ОписаниеНастройки.Вставить("ИдентификаторУчастника", Выборка.ИдентификаторУчастника);
