...
&НаКлиенте
Процедура СоздатьМестоПрименения(Команда)
	
	ПараметрыОткрытияФормы = Новый Структура;
	ПараметрыОткрытияФормы.Вставить("ЗначенияЗаполнения",     ПараметрыПоиска);
	
	ОповещениеПослеСоздания = Новый ОписаниеОповещения("МестоПримененияПослеСоздания", ЭтотОбъект);
	ОткрытьФорму("Справочник.МестаПримененияСАТУРН.Форма.ПомощникСоздания", ПараметрыОткрытияФормы, ЭтотОбъект,,,,ОповещениеПослеСоздания);
...
Процедура ОбработатьПереданныеПараметры(Отказ)
	...
	Элементы.Создать.Видимость = Не РежимВыбора И ПараметрыПоиска.Количество() > 0;
...
Процедура УстановитьУсловноеОформление()
	...
	РабочиеСтатусы = Новый СписокЗначений;
	РабочиеСтатусы.Добавить(Перечисления.СтатусыОбъектовСАТУРН.Актуально);
	РабочиеСтатусы.Добавить(Перечисления.СтатусыОбъектовСАТУРН.НаСогласовании);
	
	ОтборЭлемента.ПравоеЗначение = РабочиеСтатусы;
