...
Процедура ОКПДАвтоПодбор(Элемент, Текст, ДанныеВыбора, ПараметрыПолученияДанных, Ожидание, СтандартнаяОбработка)
	...
	СобытияФормЗЕРНОКлиент.ОКПД2АвтоПодбор(Элемент, Текст, ДанныеВыбора, ПараметрыПолученияДанных, Ожидание, СтандартнаяОбработка);
...
Процедура ОКПДОкончаниеВводаТекста(Элемент, Текст, ДанныеВыбора, ПараметрыПолученияДанных, СтандартнаяОбработка)
	...
	СобытияФормЗерноКлиент.ОКПД2ОкончаниеВводаТекста(Элемент, Текст, ДанныеВыбора, ПараметрыПолученияДанных, СтандартнаяОбработка);
...
Процедура ОткрытьЧерезБраузер(Команда)
	...
	Если ЗначениеЗаполнено(Объект.ИдентификаторФГИС)Тогда 
		ФайловаяСистемаКлиент.ОткрытьНавигационнуюСсылку(
			ИнтеграцияЗЕРНОКлиентСервер.ПутьКСерверуСИнформациейОПартии(Объект.ИдентификаторФГИС, РазделУчета));
	Иначе 
...
Процедура ЗапроситьПартии(Команда)
	...
	Если ЗначениеЗаполнено(РазделУчета) Тогда
		ПараметрыОткрытияФормы.РазделУчета = РазделУчета;
	КонецЕсли;
...
Процедура ПриСозданииЧтенииНаСервере()
	...
	ИнтеграцияЗЕРНОКлиентСервер.УстановитьПараметрыВыбораНоменклатуры(
		ЭтотОбъект, РазделУчета, "Номенклатура");
