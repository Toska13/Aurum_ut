...
//
// Возвращаемое значение:
// 	Массив из СправочникСсылка.Патенты - список действующих патентов.
//
Функция ПолучитьПатентыПоОрганизации(Организация, Подразделение = Неопределено, Знач ДатаПроверки = Неопределено) Экспорт
	...
	Если ОбиратьВсеПатенты Или НастройкиНалоговУчетныхПолитикЛокализация.ОрганизацияПрименяетПатенты(Организация, ДатаПроверки) Тогда
