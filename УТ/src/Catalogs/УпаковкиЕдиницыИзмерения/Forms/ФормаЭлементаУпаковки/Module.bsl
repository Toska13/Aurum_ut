...
Процедура НастроитьФорму()
	...
	Элементы.ДекорацияЧислительЕдиницаИзмерения.Заголовок = ?(ЗначениеЗаполнено(ЕдиницаИзмеренияВладельца),
																Строка(ЕдиницаИзмеренияВладельца),
																НСтр("ru = 'Декорация числитель единица измерения'"));
	
	ПредставленияЗнаменателя = Новый Массив;
	Если ЗначениеЗаполнено(Объект.ЕдиницаИзмерения) Тогда
		ПредставленияЗнаменателя.Добавить(ПредставлениеЕдиницыИзмерения);
	КонецЕсли;
	ПредставленияЗнаменателя.Добавить(НСтр("ru = '(разупаковка)'"));
	
	Элементы.ДекорацияРазупаковка.Заголовок = СтрСоединить(ПредставленияЗнаменателя, " ");
	
	Элементы.ДекорацияЕдиницаИзмерения.Заголовок = ?(ЗначениеЗаполнено(Объект.ЕдиницаИзмерения),
													ПредставлениеЕдиницыИзмерения,
													НСтр("ru = 'Декорация единица измерения'"));
	
	Элементы.ДекорацияЧислительЕдиницаИзмерения.Видимость = ЗначениеЗаполнено(ЕдиницаИзмеренияВладельца);
	...
	Элементы.ДекорацияЕдиницаИзмерения.Видимость	= ИспользоватьОрдерныеСклады
	...
	Элементы.ДекорацияЕдиницаИзмерения.Доступность	= (Объект.ТипУпаковки = Перечисления.ТипыУпаковокНоменклатуры.ТоварноеМесто);
