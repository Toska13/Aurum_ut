...
Процедура СоздатьЕдиницуИзмеренияИзКлассификатора(Команда)
	...
	Если ЛокализацияРФ Тогда
		...
		ПараметрыПодбора.ОповещениеОЗавершении = Новый ОписаниеОповещения("СоздатьУпаковкуЕдиницуИзмерениеЗавершение", ЭтотОбъект);
...
Процедура ОткрытьВстроенныйПодбор(Результат, ДополнительныеПараметры) Экспорт
	...
	ОткрытьФорму("Справочник.УпаковкиЕдиницыИзмерения.Форма.КлассификаторЕдиницИзмерения",
		...
		,
		,
		Новый ОписаниеОповещения("СоздатьУпаковкуЕдиницуИзмерениеЗавершение", ЭтотОбъект));
