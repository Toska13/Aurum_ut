...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Параметры.Свойство("Склад",Склад) Тогда
		...
		ДобавлятьЕдиницуХранения = Не МобильноеРабочееМестоКладовщика.ИспользоватьАдресноеХранение(Склад,Помещение)
	Иначе
	...
	ЕдиницаХранения = МобильноеРабочееМестоКладовщика.ЗначениеРеквизитаОбъекта(Номенклатура, "ЕдиницаИзмерения");
...
Процедура ЗаполнитьДеревоЕдиницИзмеренийУпаковок()
	...
	ТекстЗапроса = СтрЗаменить(ТекстЗапроса, "&ТекстЗапросаКоэффициентУпаковки", МобильноеРабочееМестоКладовщика.ТекстЗапросаКоэффициентаУпаковкиДляВыбора("УпаковкиНоменклатуры", "Номенклатура"));
	ТекстЗапроса = СтрЗаменить(ТекстЗапроса, "&ТекстЗапросаДоступностьКоэффициентУпаковки", МобильноеРабочееМестоКладовщика.ТекстЗапросаДоступностьКоэффициентаДляВыбораУпаковки("УпаковкиНоменклатуры", "Номенклатура"));
