...
Процедура ОбработкаПроверкиЗаполнения(Отказ, ПроверяемыеРеквизиты)
	...
	ИначеЕсли ПоказательТоваров = Перечисления.ЦелевыеПоказателиРетроБонусовПоТоварам.КоличествоСовокупно Тогда
...
Процедура ПередЗаписью(Отказ)
	...
	Если (ПоказательТоваров <> ПоказателиПродаж.НеИспользуется
		  И ПоказательТоваров <> ПоказателиПродаж.Сумма) Тогда
		
		ОтборТоваров = Перечисления.СоставыСписковРетроБонусов.Выбранные;
		
	КонецЕсли;
	
	Если ПоказательТоваров = ПоказателиПродаж.НеИспользуется Тогда
	...
	ИначеЕсли ПоказательТоваров = ПоказателиПродаж.КоличествоСовокупно Тогда
	...
	Если БезРасчета Тогда
		...
		ПорядокРаспределения = Перечисления.ПорядкиРаспределенияРетроБонусов.ПустаяСсылка();
		БазаРасчетаПродаж = Перечисления.БазыРасчетаРетроБонусов.ПустаяСсылка();
	...
	Если БазаРасчетаПродаж = Перечисления.БазыРасчетаРетроБонусов.ВыручкаБазовыеЦены Тогда
