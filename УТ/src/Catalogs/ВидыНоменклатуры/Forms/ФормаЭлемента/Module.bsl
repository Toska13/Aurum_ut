...
Процедура ПриЗаписиНаСервере(Отказ, ТекущийОбъект, ПараметрыЗаписи)
	...
	Если ЗначениеЗаполнено(Объект.Ссылка) Тогда
		АктуализироватьНастройкиДопРеквизитовДляКонтроляПриЗаписи(ТекущийОбъект, "Номенклатура");
		АктуализироватьНастройкиДопРеквизитовДляКонтроляПриЗаписи(ТекущийОбъект, "ХарактеристикиНоменклатуры");
		АктуализироватьНастройкиДопРеквизитовДляКонтроляПриЗаписи(ТекущийОбъект, "СерииНоменклатуры");
...
Процедура НастройкаИспользованияСерийПриИзмененииФрагмент(ПрименитьИзменения)
	...
	Справочники.ВидыНоменклатуры.ОтработатьЛогикуСвязиРеквизитов(ЗаполняемыйОбъект);
...
Процедура ПриИзмененииФлагаУникален(ВладелецРеквизитов, ИдентификаторСтрокиТаблицы)
	...
	КоллекцияРеквизитовДляКонтроля = Справочники.ВидыНоменклатуры.КоллекцияРеквизитовДляКонтроля(Объект, ВладелецРеквизитов);
	...
	ЗаполняемыйОбъект = Объект;
	НоменклатураЛокализация.ДополнитьОбъектФормы(ЭтотОбъект, ЗаполняемыйОбъект);
	Справочники.ВидыНоменклатуры.ПриИзмененииФлагаУникален(ЗаполняемыйОбъект, ВладелецРеквизитов, ТекущиеДанные);
...
Процедура НастроитьФорму()
	...
	ЗаполняемыйОбъект = Объект;
	НоменклатураЛокализация.ДополнитьОбъектФормы(ЭтотОбъект, ЗаполняемыйОбъект);
	ВидимостьЭлементов = Справочники.Номенклатура.ИспользованиеЭлементов(ЗаполняемыйОбъект, Ложь, Ложь);
	НоменклатураЛокализация.ВосстановитьОбъектФормы(ЭтотОбъект, ЗаполняемыйОбъект);
	...
	ЗначенияРеквизитов = Справочники.ВидыНоменклатуры.ЗначенияРеквизитовСтрогоЗаполняемыеПоОсобенностиУчета(КлючВидовПродукцииДоИзменения);
	...
	Если Элементы.НадписьНастройкаИспользованияСерий.Видимость Тогда
		...
		Элементы.АвтоматическиГенерироватьСерии.Видимость =
			Справочники.ВидыНоменклатуры.ПредусмотренаАвтоматическаяГенерацияСерий(НастройкиИспользованияСерий);
		Элементы.ИспользоватьНомерСерии.Доступность = Не Объект.АвтоматическиГенерироватьСерии;
		
		Элементы.ТочностьУказанияСрокаГодностиСерии.Доступность =
			Объект.ИспользоватьСрокГодностиСерии Или Объект.ИспользоватьДатуПроизводстваСерии;
		
		Элементы.ИспользоватьRFIDМеткиСерии.Доступность = 
	...
	Элементы.НоменклатураГруппаСоздатьРеквизиты.Видимость	= ЕстьПравоРедактирования;
	Элементы.ХарактеристикиГруппаСоздатьРеквизиты.Видимость = ЕстьПравоРедактирования;
	Элементы.СерииГруппаСоздатьРеквизиты.Видимость			= ЕстьПравоРедактирования;
	Элементы.НоменклатураГруппаСоздатьСведения.Видимость	= ЕстьПравоРедактирования;
	Элементы.ХарактеристикиГруппаСоздатьСведения.Видимость	= ЕстьПравоРедактирования;
	Элементы.СерииГруппаСоздатьСведения.Видимость			= ЕстьПравоРедактирования;
	
	Элементы.РеквизитыДляКонтроляНоменклатурыПредставлениеРеквизитаГиперссылка.ГиперссылкаЯчейки	= ЕстьПравоРедактирования;
	Элементы.РеквизитыДляКонтроляХарактеристикПредставлениеРеквизитаГиперссылка.ГиперссылкаЯчейки	= ЕстьПравоРедактирования;
	Элементы.РеквизитыДляКонтроляСерийПредставлениеРеквизитаГиперссылка.ГиперссылкаЯчейки			= ЕстьПравоРедактирования;
	
	Элементы.РеквизитыДляКонтроляНоменклатурыВиденСУсловием.ГиперссылкаЯчейки	= ЕстьПравоРедактирования;
	Элементы.РеквизитыДляКонтроляХарактеристикВиденСУсловием.ГиперссылкаЯчейки	= ЕстьПравоРедактирования;
	
	Элементы.РеквизитыДляКонтроляНоменклатурыДоступенСУсловием.ГиперссылкаЯчейки	= ЕстьПравоРедактирования;
	Элементы.РеквизитыДляКонтроляХарактеристикДоступенСУсловием.ГиперссылкаЯчейки	= ЕстьПравоРедактирования;
	#КонецОбласти
	...
	ЗначенияРеквизитов = Справочники.ВидыНоменклатуры.ЗначенияРеквизитовСтрогоЗаполняемыеПоОсобенностиУчета(КлючВидовПродукции);
	Если ЗначенияРеквизитов <> Неопределено Тогда
		Для Каждого КлючЗначение Из ЗначенияРеквизитов Цикл
			Если Элементы.Найти(КлючЗначение.Ключ) <> Неопределено Тогда
...
Процедура ПриЧтенииСозданииНаСервере()
	...
	ИнтеграцияИС.ЗаполнитьДанныеПоКлючуВидовПродукции(ЭтотОбъект);
	КлючВидовПродукцииДоИзменения = КлючВидовПродукции;
	НастроитьДоступныеРеквизитыСерий();
	//-- Локализация
	...
	Справочники.ВидыНоменклатуры.ЗаполнитьРеквизитыДляКонтроля(ЗаполняемыйОбъект, "Номенклатура");
	Справочники.ВидыНоменклатуры.ЗаполнитьДопРеквизитыДляКонтроляИОтбора(ЗаполняемыйОбъект, "Номенклатура");
	
	Справочники.ВидыНоменклатуры.ЗаполнитьРеквизитыДляКонтроля(ЗаполняемыйОбъект, "ХарактеристикиНоменклатуры");
	Справочники.ВидыНоменклатуры.ЗаполнитьДопРеквизитыДляКонтроляИОтбора(ЗаполняемыйОбъект, "ХарактеристикиНоменклатуры");
	
	Справочники.ВидыНоменклатуры.ЗаполнитьДопРеквизитыДляКонтроляИОтбора(ЗаполняемыйОбъект, "СерииНоменклатуры");
...
Процедура ИспользоватьХарактеристикиПриИзмененииНаСервере()
	...
	Справочники.ВидыНоменклатуры.ЗаполнитьРеквизитыПоУмолчанию(ЗаполняемыйОбъект);
	Справочники.ВидыНоменклатуры.ОтработатьЛогикуСвязиРеквизитов(ЗаполняемыйОбъект);
...
Процедура ДобавитьСкладВПолитикиУчетаСерийЗавершение(РезультатЗакрытия, ДополнительныеПараметры) Экспорт
	...
	СтруктураОтбора = Новый Структура();
	СтруктураОтбора.Вставить("Склад", РезультатЗакрытия);
	
	НайденныеСтроки = Объект.ПолитикиУчетаСерий.НайтиСтроки(СтруктураОтбора);
	Для Каждого СтрокаТаблицы Из НайденныеСтроки Цикл
		Элементы.ПолитикиУчетаСерий.ТекущаяСтрока = СтрокаТаблицы.ПолучитьИдентификатор();
	КонецЦикла;
...
Процедура РеквизитыДляКонтроляВыбор(ЗначащаяЧастьИмени, Поле, СтандартнаяОбработка)
	...
	ВидНастройки	= ВидНастройкиРеквизитаДляКонтроляПоИмениПоля(Элементы, Поле.Имя);
	
	Если Не ЕстьПравоРедактирования Тогда
		Возврат;
	ИначеЕсли ТекущиеДанные = Неопределено Тогда
		Возврат;
	ИначеЕсли Не ТекущиеДанные.ЭтоДопРеквизит Тогда
		Возврат;
	ИначеЕсли Не ТекущиеДанные.ЗаполнятьОбязательно
		И ВидНастройки = "ЗаполнятьОбязательно" Тогда
...
Процедура РеквизитыДляКонтроляВыборЗавершение(Результат, ДополнительныеПараметры) Экспорт
	...
	Если ВидНастройки = "ПредставлениеРеквизита" Тогда
	...
	ИначеЕсли ВидНастройки = "Виден"
		Или ВидНастройки = "Доступен"
		Или ВидНастройки = "ЗаполнятьОбязательно" Тогда
		
		ЗаполнитьЗависимостиРедактируемогоСвойства();
		
		РедактируемоеСвойствоВидНастройки = ВидНастройки;
...
&НаКлиентеНаСервереБезКонтекста
Функция ВидНастройкиРеквизитаДляКонтроляПоИмениПоля(Элементы, ИмяЭлемента)
	
	ВидНастройки = "";
	
	Если ИмяЭлемента = Элементы.РеквизитыДляКонтроляНоменклатурыПредставлениеРеквизита.Имя
		Или ИмяЭлемента = Элементы.РеквизитыДляКонтроляНоменклатурыПредставлениеРеквизитаГиперссылка.Имя
		Или ИмяЭлемента = Элементы.РеквизитыДляКонтроляХарактеристикПредставлениеРеквизита.Имя
		Или ИмяЭлемента = Элементы.РеквизитыДляКонтроляХарактеристикПредставлениеРеквизитаГиперссылка.Имя
		Или ИмяЭлемента = Элементы.РеквизитыДляКонтроляСерийПредставлениеРеквизита.Имя
		Или ИмяЭлемента = Элементы.РеквизитыДляКонтроляСерийПредставлениеРеквизитаГиперссылка.Имя Тогда
		
		ВидНастройки = "ПредставлениеРеквизита";
		
	ИначеЕсли ИмяЭлемента = Элементы.РеквизитыДляКонтроляНоменклатурыВиденСУсловием.Имя
		Или ИмяЭлемента = Элементы.РеквизитыДляКонтроляНоменклатурыДляРазмераЯчейкиВиденСУсловием.Имя
		Или ИмяЭлемента = Элементы.РеквизитыДляКонтроляХарактеристикВиденСУсловием.Имя
		Или ИмяЭлемента = Элементы.РеквизитыДляКонтроляХарактеристикДляРазмераЯчейкиВиденСУсловием.Имя Тогда
		
		ВидНастройки = "Виден";
		
	ИначеЕсли ИмяЭлемента = Элементы.РеквизитыДляКонтроляНоменклатурыДоступенСУсловием.Имя
		Или ИмяЭлемента = Элементы.РеквизитыДляКонтроляНоменклатурыДляРазмераЯчейкиДоступенСУсловием.Имя
		Или ИмяЭлемента = Элементы.РеквизитыДляКонтроляХарактеристикДоступенСУсловием.Имя
		Или ИмяЭлемента = Элементы.РеквизитыДляКонтроляХарактеристикДляРазмераЯчейкиДоступенСУсловием.Имя Тогда
		
		ВидНастройки = "Доступен";
		
	ИначеЕсли ИмяЭлемента = Элементы.РеквизитыДляКонтроляНоменклатурыЗаполнятьОбязательно.Имя
		Или ИмяЭлемента = Элементы.РеквизитыДляКонтроляНоменклатурыДляРазмераЯчейкиЗаполнятьОбязательно.Имя
		Или ИмяЭлемента = Элементы.РеквизитыДляКонтроляХарактеристикЗаполнятьОбязательно.Имя
		Или ИмяЭлемента = Элементы.РеквизитыДляКонтроляХарактеристикДляРазмераЯчейкиЗаполнятьОбязательно.Имя
		Или ИмяЭлемента = Элементы.РеквизитыДляКонтроляСерийЗаполнятьОбязательно.Имя
		Или ИмяЭлемента = Элементы.РеквизитыДляКонтроляСерийДляРазмераЯчейкиЗаполнятьОбязательно.Имя Тогда
		
		ВидНастройки = "ЗаполнятьОбязательно";
		
	КонецЕсли;
	
	Возврат ВидНастройки;
...
&НаСервере
Процедура АктуализироватьНастройкиДопРеквизитовДляКонтроляПриЗаписи(ТекущийОбъект, НазначениеДопРеквзитов)
	
	КолонкиОтбора		= "ЭтоДопРеквизит, Свойство";
	ЗаполняемыеКолонки	= "ЗаполнятьОбязательно, ОтображатьПриСоздании, ДоступностьУникален,
							|ДоступностьЗаполнятьОбязательно, ДоступностьОтображатьПриСоздании";
	
	Если НазначениеДопРеквзитов = "Номенклатура" Тогда
		РеквизитыДляКонтроля	= ТекущийОбъект.РеквизитыДляКонтроляНоменклатуры;
		АктуальныеРеквизиты		= Объект.РеквизитыДляКонтроляНоменклатуры;
	ИначеЕсли НазначениеДопРеквзитов = "ХарактеристикиНоменклатуры" Тогда
		РеквизитыДляКонтроля	= ТекущийОбъект.РеквизитыДляКонтроляХарактеристик;
		АктуальныеРеквизиты		= Объект.РеквизитыДляКонтроляХарактеристик;
	ИначеЕсли НазначениеДопРеквзитов = "СерииНоменклатуры" Тогда
		РеквизитыДляКонтроля	= ТекущийОбъект.РеквизитыДляКонтроляСерий;
		АктуальныеРеквизиты		= Объект.РеквизитыДляКонтроляСерий;
		ЗаполняемыеКолонки		= "ЗаполнятьОбязательно, ДоступностьЗаполнятьОбязательно";
	КонецЕсли;
	
	ТаблицаРеквизитов = РеквизитыДляКонтроля.Выгрузить();
	ТаблицаРеквизитов.Индексы.Добавить(КолонкиОтбора);
	
	ОтборРеквизитов = Новый Структура("ЭтоДопРеквизит", Истина);
	ДополнительныеРеквизиты = АктуальныеРеквизиты.НайтиСтроки(ОтборРеквизитов);
	
	ОтборСтрок = Новый Структура(КолонкиОтбора);
	
	Для Каждого ДопРеквизит Из ДополнительныеРеквизиты Цикл
		ЗаполнитьЗначенияСвойств(ОтборСтрок, ДопРеквизит);
		
		НайденныеСтроки = ТаблицаРеквизитов.НайтиСтроки(ОтборСтрок);
		
		Если НайденныеСтроки.Количество() > 0 Тогда
			ЗаполнитьЗначенияСвойств(НайденныеСтроки[0], ДопРеквизит, ЗаполняемыеКолонки);
		КонецЕсли;
	КонецЦикла;
	
	РеквизитыДляКонтроля.Загрузить(ТаблицаРеквизитов);
...
&НаСервере
Процедура ЗаписатьКлючВидовПродукции(Ссылка)
	
	Блокировка = Новый БлокировкаДанных;
	ЭлементБлокировки = Блокировка.Добавить("РегистрСведений.ОписаниеНоменклатурыИС");
	ЭлементБлокировки.Режим = РежимБлокировкиДанных.Исключительный;
	ЭлементБлокировки.УстановитьЗначение("Номенклатура", Ссылка);
	...
	Попытка
		...
		КонецЕсли;
		Запись.КлючВидовПродукции = КлючВидовПродукции;
...
&НаСервере
Процедура НастроитьДоступныеРеквизитыСерий()
	
	Элементы.ГруппаРеквизитыЛокализацииСерий.Видимость = Истина;
	// Устаревшие (только включенные)
	Элементы.ИспользоватьНомерКИЗГИСМСерии.Видимость = Объект.ИспользоватьНомерКИЗГИСМСерии;
	Элементы.ИспользоватьСправку2ЕГАИССерии.Видимость = Объект.ИспользоватьСправку2ЕГАИССерии;
	Элементы.ИспользоватьЗаписьСкладскогоЖурналаВЕТИССерии.Видимость = Объект.ИспользоватьЗаписьСкладскогоЖурналаВЕТИССерии;
	// По подсистемам
	Элементы.ИспользоватьПроизводителяЕГАИССерии.Видимость = ИспользуетсяПодсистемаЕГАИС;
	Элементы.ИспользоватьПроизводителяВЕТИССерии.Видимость = ИспользуетсяПодсистемаВЕТИС;
	Элементы.ИспользоватьИдентификаторПартииВЕТИССерии.Видимость = ИспользуетсяПодсистемаВЕТИС;
	Элементы.ИспользоватьМРЦМОТПСерии.Видимость = ИспользуетсяПодсистемаГИСМТ;
	
КонецПроцедуры

&НаСервере
Процедура ЗаполнитьКлючВидовПродукции()
...
Процедура ПриЗаписиНаСервереЛокализация(Отказ, ТекущийОбъект)
	...
	ЗаписатьКлючВидовПродукции(ТекущийОбъект.Ссылка);
