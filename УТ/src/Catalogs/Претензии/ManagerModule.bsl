...
Функция ПараметрыВзаиморасчеты(ДанныеЗаполнения = Неопределено) Экспорт
	...
	ВестиРасчетыПоПретензии = Ложь;
	Если ОбщегоНазначения.ЗначениеСсылочногоТипа(ДанныеЗаполнения) Тогда
		СтруктураДанныеЗаполнения = ОбщегоНазначения.ЗначенияРеквизитовОбъекта(ДанныеЗаполнения, "ЭтоПретензияПоставщику, ВестиРасчетыПоПретензии");
		ЭтоПретензияПоставщику = СтруктураДанныеЗаполнения.ЭтоПретензияПоставщику;
		ВестиРасчетыПоПретензии = СтруктураДанныеЗаполнения.ВестиРасчетыПоПретензии;
	ИначеЕсли ДанныеЗаполнения <> Неопределено Тогда
		ЭтоПретензияПоставщику = ДанныеЗаполнения.ЭтоПретензияПоставщику;
		ВестиРасчетыПоПретензии = ДанныеЗаполнения.ВестиРасчетыПоПретензии;
	КонецЕсли;
	...
	// Не является объектом расчетов, если не ведутся расчеты.
	СтруктураПараметров.МожетЯвлятьсяОбъектомРасчетов = ВестиРасчетыПоПретензии;
