...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Не ЗначениеЗаполнено(ХозяйствующийСубъект) Тогда
		ДанныеХозСубъектПредприятие = Справочники.ХозяйствующиеСубъектыВЕТИС.ХозяйствующийСубъектИПредприятиеПоУмолчанию();
		ХозяйствующийСубъект = ДанныеХозСубъектПредприятие.ХозяйствующийСубъектВЕТИС;
		Предприятие          = ДанныеХозСубъектПредприятие.ПредприятиеВЕТИС;
		Если ЗначениеЗаполнено(ХозяйствующийСубъект)
		     И ЗначениеЗаполнено(Предприятие)
		     И ИнтеграцияИС.УпрощеннаяИнтеграцияБЭД() Тогда
