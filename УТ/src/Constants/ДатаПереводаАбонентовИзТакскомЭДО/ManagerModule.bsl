...
Процедура ОбработатьДанныеДляПереходаНаНовуюВерсию(Параметры) Экспорт
	...
	МетаданныеОбъекта = Метаданные.Константы.ДатаПереводаАбонентовИзТакскомЭДО;
	...
	Попытка
		...
		Менеджер = Константы.ДатаПереводаАбонентовИзТакскомЭДО.СоздатьМенеджерЗначения();
		
		ДатаИзНастроек = ОбщегоНазначения.ХранилищеОбщихНастроекЗагрузить("ПереводИзТакскомКлючНастроек", 
			"ДатаПереводаАбонентовИзТакском", 
			Дата(1, 1, 1), 
			, 
