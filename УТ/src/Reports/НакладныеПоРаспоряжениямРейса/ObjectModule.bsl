...
Процедура ПриКомпоновкеРезультата(ДокументРезультат, ДанныеРасшифровки, СтандартнаяОбработка)
	...
	ШаблонЗаголовка = НСтр("ru = 'Накладные по распоряжениям документа %1'");
...
//      * Отчет - ОтчетОбъект.НакладныеПоРаспоряжениямРейса
//      * Параметры - Структура:
...
Процедура ПриСозданииНаСервере(Форма, Отказ, СтандартнаяОбработка) Экспорт
	...
	Если НЕ Параметры.Свойство("ПараметрКоманды")
	   И НЕ ЗначениеЗаполнено(Параметры.ПредставлениеВарианта) Тогда
