...
Функция ТекстЗапросаРасчетыСКлиентами(МассивВыбранныхПолей, НастройкиОтчета, ВычисляемыеПоля)
	...
	ТекстЗапроса = СтрЗаменить(ТекстЗапроса,"&ОтгруженоПартнеру", ВзаиморасчетыОтчеты.ШаблонПоляОтгружено());
	ТекстЗапроса = СтрЗаменить(ТекстЗапроса,"&Зачтено", ВзаиморасчетыОтчеты.ШаблонПоляЗачтено());
	ТекстЗапроса = СтрЗаменить(ТекстЗапроса,"&ОплаченоНам", ВзаиморасчетыОтчеты.ШаблонПоляОплачено());
...
Функция ТекстЗапросаРасчетыСПоставщиками(МассивВыбранныхПолей, НастройкиОтчета, ВычисляемыеПоля)
	...
	ТекстЗапроса = СтрЗаменить(ТекстЗапроса,"&ОтгруженоНам", ВзаиморасчетыОтчеты.ШаблонПоляОтгружено());
	ТекстЗапроса = СтрЗаменить(ТекстЗапроса,"&Зачтено", ВзаиморасчетыОтчеты.ШаблонПоляЗачтено());
	ТекстЗапроса = СтрЗаменить(ТекстЗапроса,"&ОплаченоПартнеру", ВзаиморасчетыОтчеты.ШаблонПоляОплачено());
	ТекстЗапроса = СтрЗаменить(ТекстЗапроса,"&СписаниеПереоценка", ВзаиморасчетыОтчеты.ШаблонПоляСписаниеПереоценка());
