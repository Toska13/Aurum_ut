...
Функция ТекстЗапроса()
	...
	|	ВЫБОР КОГДА НЕ РасчетыОбороты.ОбъектРасчетов.РегистрыВзаиморасчетовНеДелятсяПоНаправлениямДеятельности
	|		ТОГДА Аналитика.НаправлениеДеятельности
	|		ИНАЧЕ РасчетыОбороты.ОбъектРасчетов.НаправлениеДеятельности
	|	КОНЕЦ                                  КАК НаправлениеДеятельности,
