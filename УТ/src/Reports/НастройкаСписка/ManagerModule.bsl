...
// Инициализирует компоновщик настроек для таблицы формы
// Параметры:
//  РеквизитыСписка - Массив Из РеквизитФормы - реквизиты таблицы формы.
//  НастройкиСписка - КомпоновщикНастроекКомпоновкиДанных - компоновщик настроек.
//  УникальныйИдентификаторФормы - УникальныйИдентификатор - идентификатор формы.
//  НастройкаПолей - Структура - структура с полями:
//   * НедоступныеПоля - Массив Из Строка - имена недоступных для настроек полей таблицы формы.
...
// Сохраняет настройки.
// Параметры:
//  КлючОбъекта - Строка - ключ объекта в хранилище настроек пользователя. 
//  КлючНастроек - Строка - ключ настроек в хранилище настроек пользователя.
//  НастройкиСписка - КомпоновщикНастроекКомпоновкиДанных - компоновщик настроек, куда будут загружены настройки.
...
//  КлючОбъекта - Строка - ключ объекта в хранилище настроек пользователя. 
//  КлючНастроек - Строка - ключ настроек в хранилище настроек пользователя.
//  НастройкиСписка - КомпоновщикНастроекКомпоновкиДанных - сохраняемые настройки.
