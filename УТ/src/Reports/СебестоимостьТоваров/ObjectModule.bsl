...
Процедура ПриКомпоновкеРезультата(ДокументРезультат, ДанныеРасшифровки, СтандартнаяОбработка)
	...
	РасчетСебестоимостиПрикладныеАлгоритмы.ДобавитьПредупреждениеОПредварительномЗакрытииМесяца(ДокументРезультат, КомпоновщикНастроек, "СтруктураПредприятия.Организация");
...
Процедура ПроверитьИУстановитьПараметрВыводаДетализации(КомпоновщикНастроек, ДокументРезультат)
	...
	КомпоновкаДанныхКлиентСервер.УстановитьПараметр(КомпоновщикНастроек, "ВыводитьДетализацию", Истина);
...
Функция НеиспользуемыеПоляОтчета()
	...
	МассивПолей.Добавить("НДСВключенВСтоимостьПродукции");
	МассивПолей.Добавить("СтатьяКалькуляцииПродукции");
	МассивПолей.Добавить("ДетализацияСтоимостьПродукцииНачальныйОстаток");
	МассивПолей.Добавить("ДетализацияСтоимостьПродукцииКонечныйОстаток");
	МассивПолей.Добавить("ДетализацияСтоимостьПродукцииПриход");
	МассивПолей.Добавить("ДетализацияСтоимостьПродукцииРасход");
