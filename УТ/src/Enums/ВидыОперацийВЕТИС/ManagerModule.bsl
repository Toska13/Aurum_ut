...
//  Неопределено, Структура - Параметры запроса ВЕТИС:
// * ТипВЕТИС - Строка - 
// * ПространствоИмен - Строка - 
// * Операция - ПеречислениеСсылка.ВидыОперацийВЕТИС - 
// * ФорматОбмена - ПеречислениеСсылка.ФорматыОбменаВЕТИС - 
// * ТипСообщения - ПеречислениеСсылка.ТипыЗапросовИС - 
// * ОтветНаЗапрос - Неопределено, Структура - параметры ответа:
//  ** ТипВЕТИС - Строка - 
//  ** ПространствоИмен - Строка - 
//  ** Операция - ПеречислениеСсылка.ВидыОперацийВЕТИС - 
//  ** ФорматОбмена - ПеречислениеСсылка.ФорматыОбменаВЕТИС - 
Функция ПараметрыЗапросаВЕТИС(Операция, ФорматОбмена) Экспорт
	...
	ВозвращаемоеЗначение.Вставить("ОтветНаЗапрос",    Неопределено);
...
// Полученные результаты запросов ВЕТИС.
// 
// Возвращаемое значение:
//  Массив из ПеречислениеСсылка.ВидыОперацийВЕТИС - Полученные результаты запросов ВЕТИС
Функция ПолученныеРезультатыЗапросовВЕТИС() Экспорт
	
	Результат = Новый Массив;
	
	Результат.Добавить(ПолучениеРезультатаЗапроса);
