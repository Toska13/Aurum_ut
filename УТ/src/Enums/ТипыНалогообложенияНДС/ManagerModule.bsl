...
Процедура ОбработкаПолученияДанныхВыбора(ДанныеВыбора, Параметры, СтандартнаяОбработка)
	...
	ПараметрыВыбора = Новый Структура("Продажи, Закупки, РаздельныйУчет", Истина, Истина, Истина);
	...
	ДоступныеТипыНалогообложения = УчетНДСУПКлиентСервер.ПрименяемыеТипыНалогообложенияНДС(
		ПараметрыВыбора.Продажи,
		ПараметрыВыбора.Закупки,
		ПараметрыВыбора.РаздельныйУчет);
