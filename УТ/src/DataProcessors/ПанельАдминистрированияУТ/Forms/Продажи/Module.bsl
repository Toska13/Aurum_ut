...
Процедура УстановитьДоступность(РеквизитПутьКДанным = "")
	...
	Если РеквизитПутьКДанным = "НаборКонстант.ИспользоватьСтатусыРеализацийТоваровУслуг"
		...
		ИспользоватьСтатусыРеализацийТоваровУслуг = НаборКонстант.ИспользоватьСтатусыРеализацийТоваровУслуг;
		
		// Галка "Использовать отгрузку без перехода права собственности" будет доступна в следующих случаях:
		// 1. Если не используются договоры с контрагентами, но есть документы продаж с отложенным переходом права собственности 2.0
		// и используются статусы реализаций (при включении будет установлена ФО ИспользоватьОтгрузкуБезПереходаПраваСобственности2_0)
		// 2. Если развернута чистая база или в базе не работали с продажами с отложенным переходом права собственности, и включены договоры с клиентами
		// (при включении будет установлена ФО ИспользоватьОтгрузкуБезПереходаПраваСобственности2_5)
		// 3. Если в базе работали с продажами с отложенным переходом права собственности 2.0, используются статусы реализаций и договоры с контрагентами
		// (в этом случае будут включены обе ФО: ИспользоватьОтгрузкуБезПереходаПраваСобственности2_0 и ИспользоватьОтгрузкуБезПереходаПраваСобственности2_5)
		// Код этих правил установки зависимых ФО тут: НастройкаСистемы.СинхронизироватьЗначенияПодчиненныхКонстант
		// и НастройкаСистемыПовтИсп.ПолучитьТаблицуЗависимостиКонстант
		ДоступностьОтгрузкиБезПереходаПраваСобственности =
			ЕстьДокументыОтгрузкиБезПереходаПраваСобственности2_0
				И Не ИспользоватьДоговорыСКлиентами
				И ИспользоватьСтатусыРеализацийТоваровУслуг
					Или ИспользоватьДоговорыСКлиентами;
			
		Элементы.ИспользоватьОтгрузкуБезПереходаПраваСобственности.Доступность = ДоступностьОтгрузкиБезПереходаПраваСобственности;
		Элементы.ГруппаКомментарийИспользоватьОтгрузкуБезПереходаПраваСобственности.Видимость = Не ДоступностьОтгрузкиБезПереходаПраваСобственности;
	...
	Если РеквизитПутьКДанным = "НаборКонстант.ИспользоватьОказаниеАгентскихУслугПриЗакупке"
		...
		ИЛИ РеквизитПутьКДанным = "НаборКонстант.ВыбиратьВерсиюКомиссионныхПродаж"
		ИЛИ РеквизитПутьКДанным = "" Тогда
		...
		Элементы.ГруппаКомментарийИспользованиеУстаревшейКомиссии.Видимость = НаборКонстант.ВыбиратьВерсиюКомиссионныхПродаж;
	...
	Если РеквизитПутьКДанным = "НаборКонстант.ИспользоватьДоговорыСКлиентами"
		...
		Или РеквизитПутьКДанным = "НаборКонстант.ИспользоватьКомиссиюПриПродажах"
		Или РеквизитПутьКДанным = "НаборКонстант.ИспользоватьОтгрузкуБезПереходаПраваСобственности"
		Или РеквизитПутьКДанным = "" Тогда
		...
		ЗначениеКонстантыИспользоватьОтгрузкуБезПереходаПраваСобственности2_5 = Константы.ИспользоватьОтгрузкуБезПереходаПраваСобственности2_5.Получить();
		...
		ДоступноРедактированиеДоговорыСКлиентами =
			...
			И Не ЗначениеКонстантыИспользоватьОтгрузкуБезПереходаПраваСобственности2_5
		...
		Элементы.ГруппаИспользоватьДоговорыСКлиентамиПредупреждение.Видимость =
			ЗначениеКонстантыИспользоватьДоговорыСКлиентами
		...
		ТекстКомментария = ТекстКомментария
			+ ?(ЗначениеКонстантыИспользоватьОтгрузкуБезПереходаПраваСобственности2_5,
				Символы.ПС + НСтр("ru = '— включена опция ""Отгрузка без перехода права собственности""'"),
				"");
