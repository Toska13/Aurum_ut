...
&НаКлиенте
Процедура ОкруглятьСуммыНДСиАкцизовДоЦелыхВЗаявленияхОВвозеТоваровПриИзменении(Элемент)
	Подключаемый_ПриИзмененииРеквизита(Элемент);
КонецПроцедуры
...
Процедура УстановитьДоступность(РеквизитПутьКДанным = "")
	...
	//++ Локализация
	Если РеквизитПутьКДанным = "НаборКонстант.ИспользоватьПечатныеФормыСФ2_5" Или РеквизитПутьКДанным = "" Тогда
		ЗначениеКонстанты = НаборКонстант.ИспользоватьПечатныеФормыСФ2_5;
		ИспользоватьПодакцизныеТовары = Ложь;
		ДоступноИзменениеИспользованияПечатныеФормыСФ2_5 = Не ЗначениеКонстанты Или Не ИспользоватьПодакцизныеТовары;
		Элементы.ИспользоватьПечатныеФормыСФ2_5.Доступность = ДоступноИзменениеИспользованияПечатныеФормыСФ2_5;
		Элементы.ЛокализацияГруппаКомментарийИспользоватьПечатныеФормыСФ2_5.Видимость = ЗначениеКонстанты
