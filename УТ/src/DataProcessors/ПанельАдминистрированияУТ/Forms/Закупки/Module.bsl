...
&НаКлиенте
Процедура ИспользоватьРетроБонусыПоставщиковПриИзменении(Элемент)
...
&НаКлиенте
Процедура ВыводитьПолныеНаименованияРетроБонусовПоставщиковПриИзменении(Элемент)
...
&НаКлиенте
Процедура ИспользоватьСогласованиеСписанийРетроБонусовПоставщиков(Элемент)
...
&НаКлиенте
Процедура ИспользоватьЗаявкиНаЗакупкуПриИзменении(Элемент)
...
Процедура УстановитьДоступность(РеквизитПутьКДанным = "")
	...
	Если РеквизитПутьКДанным = "НаборКонстант.ИспользоватьЗаказыПоставщикам" ИЛИ РеквизитПутьКДанным = "" Тогда
		...
		Элементы.ГруппаКомментарийКонтролироватьЗакрытие.Видимость                      = ЗначениеКонстанты И НЕ НаборКонстант.ИспользоватьСтатусыЗаказовПоставщикам;
				Элементы.ГруппаКомментарийУправлениеСогласованиемДокументовЗакупок.Видимость = ЗначениеКонстанты И НЕ НаборКонстант.ИспользоватьСтатусыЗаказовПоставщикам;
		Элементы.ИспользоватьЗаявкиНаЗакупку.Доступность                                = ЗначениеКонстанты;
		Элементы.ГруппаКомментарийИспользоватьЗаявкиНаЗакупку.Видимость                 = Не ЗначениеКонстанты;
	...
	Если РеквизитПутьКДанным = "НаборКонстант.ИспользоватьСтатусыЗаказовПоставщикам" ИЛИ РеквизитПутьКДанным = "" Тогда
		...
		Элементы.ГруппаКомментарийУправлениеСогласованиемДокументовЗакупок.Видимость    = НаборКонстант.ИспользоватьЗаказыПоставщикам И НЕ ЗначениеКонстанты;
	...
	Если РеквизитПутьКДанным = "НаборКонстант.ИспользоватьАктыРасхожденийПослеПриемки"
		...
		Элементы.АктыРасхожденийПослеПриемкиПоПриемкамТоваровНаХранение.Доступность = ЗначениеКонстанты;
		Элементы.АктыОРасхожденияхПослеПриемкиПоПоступлениям.Доступность = ЗначениеКонстанты;
		Элементы.АктыРасхожденийПослеПриемкиПоПоступлениямТоваровОтХранителя.Доступность = ЗначениеКонстанты;
		
	КонецЕсли;
	
	Если РеквизитПутьКДанным = "НаборКонстант.ИспользоватьРетроБонусыПоставщиков"
	 ИЛИ РеквизитПутьКДанным = "НаборКонстант.ВыводитьПолныеНаименованияРетроБонусовПоставщиков"
	 ИЛИ РеквизитПутьКДанным = "НаборКонстант.ИспользоватьСогласованиеСписанийРетроБонусовПоставщиков"
	 ИЛИ РеквизитПутьКДанным = "" Тогда
		
		#Область Доступность_ИспользоватьРетроБонусыПоставщиков
		ДоступностьВключенияРетроБонусов = Истина;
		ДоступностьВыключенияРетроБонусов = Истина;
		ЭлементыВключения = Новый Массив; // Массив из Строка
		ЭлементыВключения.Добавить(Элементы.ГруппаИспользоватьРетроБонусыПоставщиковПредупреждениеВключение.Имя);
		
		Если НЕ НаборКонстант.ИспользоватьПартнеровИКонтрагентов Тогда
			
			ДоступностьВключенияРетроБонусов = Ложь;
			ЭлементыВключения.Добавить(Элементы.КомментарийИспользоватьРетроБонусыПоставщиковНезависимыеПартнеры.Имя);
			
		КонецЕсли;
		
		Элементы.ИспользоватьРетроБонусыПоставщиков.Доступность =
			(ДоступностьВключенияРетроБонусов
			 И ДоступностьВыключенияРетроБонусов);
		...
		#Область Доступность_ВыводитьПолныеНаименованияРетроБонусовПоставщиков
		Элементы.ВыводитьПолныеНаименованияРетроБонусовПоставщиков.Доступность =
			(ДоступностьВключенияРетроБонусов
			 И НаборКонстант.ИспользоватьРетроБонусыПоставщиков);
		#КонецОбласти
		
		#Область Доступность_ИспользоватьСогласованиеСписанийРетроБонусовПоставщиков
		Элементы.ИспользоватьСогласованиеСписанийРетроБонусовПоставщиков.Доступность =
			(ДоступностьВключенияРетроБонусов
			 И НаборКонстант.ИспользоватьРетроБонусыПоставщиков);
		#КонецОбласти
