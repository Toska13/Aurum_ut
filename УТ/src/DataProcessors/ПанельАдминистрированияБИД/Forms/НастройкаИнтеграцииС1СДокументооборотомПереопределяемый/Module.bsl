...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ПояснениеСрокХранения = СтроковыеФункции.ФорматированнаяСтрока(
		СтрШаблон(
			НСтр("ru = 'Количество времени, в течение которого будет храниться <a href = ""%1"">история отправки</a> и <a href = ""%2"">очередь отправки</a> сообщений'"),
	...
	Элементы.ПояснениеСрокХраненияСообщений.Заголовок = ПояснениеСрокХранения;
	Элементы.ПояснениеСрокХраненияСообщенийДО3.Заголовок = ПояснениеСрокХранения;
	...
	Если ЗначениеЗаполнено(СокращенноеНаименованиеКонфигурации) Тогда
		Элементы.СоздаватьЭПДляОбъектов1СДокументооборотаСредствамиИС.Заголовок = СтрШаблон(
			НСтр("ru = 'Создавать подписи средствами %1'"),
			СокращенноеНаименованиеКонфигурации);
		Элементы.ПояснениеСоздаватьЭПДляОбъектов1СДокументооборотаСредствамиИС.Заголовок = СтрШаблон(
			НСтр("ru = 'Электронные подписи объектов 1С:Документооборота будут создаваться с использованием сертификатов и настроек, указанных на стороне %1'"),
			СокращенноеНаименованиеКонфигурации);
...
&НаКлиенте
Процедура СоздаватьЭПДляОбъектов1СДокументооборотаСредствамиИСПриИзменении(Элемент)
...
&НаКлиенте
Процедура ИспользоватьПрисоединенныеФайлы1СДокументооборотаПриИзменении(Элемент)
...
Процедура УстановитьДоступностьИспользованияИнтеграцииДО3(Значение)
	...
	Элементы.СоздаватьЭПДляОбъектов1СДокументооборотаСредствамиИС.Доступность = Значение;
	Элементы.ИспользоватьПрисоединенныеФайлы1СДокументооборота.Доступность = Значение;
