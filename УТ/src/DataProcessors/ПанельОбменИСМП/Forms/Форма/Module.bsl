...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ЕстьПравоОткрытьПомощникНастройки = ПравоДоступа("Просмотр", Метаданные.Обработки.ПомощникНастройкиИСМП);
...
Процедура ПриОткрытии(Отказ)
	...
	ЗапуститьРасчетПроблем();
	
	Если ТребуетсяНастройкаТоварныхГрупп
		И ЕстьПравоОткрытьПомощникНастройки Тогда
		ПодключитьОбработчикОжидания("ОткрытьФормуПомощникНастройкиИСМП", 0.5, Истина);
	КонецЕсли;
...
Процедура ОбработкаНавигационнойСсылки(НавигационнаяСсылкаФорматированнойСтроки, СтандартнаяОбработка)
	...
	СобытияФормИСМПКлиентПереопределяемый.ОбработкаНавигационнойСсылки(
...
Процедура ОбработкаОповещения(ИмяСобытия, Параметр, Источник)
	...
	Если ИмяСобытия = "ИзменениеАктивностиАварийногоРежимаИСМП" Тогда
		Подключаемый_ОбработкаОжиданияЗавершенияАварийногоРежима();
	ИначеЕсли ИмяСобытия = "ИСМП_СинхронизированыТоварныеГруппы" Тогда
		ОбновитьСпискиДокументов();
	ИначеЕсли ИмяСобытия = "НастройкаНоменклатурыПоТНВЭДиОКПД2" Тогда
...
Процедура НадписьСостояниеОбменаНажатие(Элемент)
	...
	ИначеЕсли ТребуетсяНастройкаТоварныхГрупп Тогда
		
		Если ЕстьПравоОткрытьПомощникНастройки Тогда
			ОткрытьФормуПомощникНастройкиИСМП();
		Иначе
			ПоказатьПредупреждение(,
			НСтр("ru = 'Для настройки товарных групп обратитесь к администратору.'"));
		КонецЕсли;
...
Процедура ОткрытьМаркировкаТоваровИСМП(Команда)
	...
	ОткрытьФормуСпискаДокументов(
		...
		Новый Структура("РежимОткрытияПоВидуОперации", ИнтеграцияИСМПКлиентСервер.РежимОткрытияВводВОборот()));
...
#Область ПодтверждениеПоступленияКИЗ

&НаКлиенте
Процедура ОткрытьПодтверждениеПоступленияКИЗИСМП(Команда)
	
	ОценкаПроизводительностиКлиент.ЗамерВремени("Документ.МаркировкаТоваровИСМП.Форма.ФормаСпискаДокументов.ОткрытиеОсновногоСписка");
	ОткрытьФормуСпискаДокументов(
		"Документ.МаркировкаТоваровИСМП.Форма.ФормаСпискаДокументов",
		"ВсеТребующиеДействияИлиОжидания",,
		Новый Структура("РежимОткрытияПоВидуОперации", ИнтеграцияИСМПКлиентСервер.РежимОткрытияПоступлениеКИЗ()));
	
КонецПроцедуры

&НаКлиенте
Процедура ОткрытьПодтверждениеПоступленияКИЗИСМПОформите(Команда)
...
&НаКлиенте
Процедура ОткрытьПодтверждениеПоступленияКИЗИСМПОтработайте(Команда)
...
&НаКлиенте
Процедура ОткрытьПодтверждениеПоступленияКИЗИСМПОжидайте(Команда)
...
&НаКлиенте
Процедура ОткрытьАгрегацияТоваровИСМП(Команда)
	
	ОценкаПроизводительностиКлиент.ЗамерВремени("Документ.МаркировкаТоваровИСМП.Форма.ФормаСпискаДокументов.ОткрытиеОсновногоСписка");
	ОткрытьФормуСпискаДокументов(
		"Документ.МаркировкаТоваровИСМП.Форма.ФормаСпискаДокументов",
		"ВсеТребующиеДействияИлиОжидания",,
		Новый Структура("РежимОткрытияПоВидуОперации", ИнтеграцияИСМПКлиентСервер.РежимОткрытияАгрегация()));
	
КонецПроцедуры

&НаКлиенте
Процедура ОткрытьАгрегацияТоваровИСМПОжидайте(Команда)
...
&НаКлиенте
Процедура ОткрытьАгрегацияТоваровИСМПОтработайте(Команда)
...
Процедура ОткрытьВскрытыеПотребительскиеУпаковкиИСОтработайте(Команда)
	...
	ОценкаПроизводительностиКлиент.ЗамерВремени("РегистрСведений.ВскрытыеПотребительскиеУпаковкиИС.Форма.ФормаСписка.ОткрытиеОсновногоСписка");
	ОткрытьФормуСпискаДокументов("РегистрСведений.ВскрытыеПотребительскиеУпаковкиИС", "ВсеТребующиеДействия");
...
Процедура ОткрытьВскрытыеПотребительскиеУпаковкиИСОжидайте(Команда)
	...
	ОценкаПроизводительностиКлиент.ЗамерВремени("РегистрСведений.ВскрытыеПотребительскиеУпаковкиИС.Форма.ФормаСписка.ОткрытиеОсновногоСписка");
	ОткрытьФормуСпискаДокументов("РегистрСведений.ВскрытыеПотребительскиеУпаковкиИС", "ВсеТребующиеОжидания");
...
&НаКлиенте
Процедура ОткрытьОтчетИСМПСведенияОбОтклонениях(Команда)
	
	ОценкаПроизводительностиКлиент.ЗамерВремени("Документ.ОтчетИСМП.Форма.ФормаСпискаДокументов.ОткрытиеОсновногоСписка");
	ОткрытьФормуСпискаДокументов(
		"Документ.ОтчетИСМП.Форма.ФормаСпискаДокументов",
		"ВсеТребующиеДействияИлиОжидания",,
		Новый Структура("РежимОткрытияПоВидуОперации", ИнтеграцияИСМПКлиентСервер.РежимОткрытияСведенияОбОтклонениях()));
	
КонецПроцедуры

&НаКлиенте
Процедура ОткрытьОтчетИСМПСведенияОбОтклоненияхОтработайте(Команда)
...
&НаКлиенте
Процедура ОткрытьОтчетИСМПСведенияОбОтклоненияхОжидайте(Команда)
...
Процедура ОткрытьОтчетИСМП(Команда)
	...
	ОткрытьФормуСпискаДокументов(
		"Документ.ОтчетИСМП.Форма.ФормаСпискаДокументов",
		"ВсеТребующиеДействияИлиОжидания",,
		Новый Структура("РежимОткрытияПоВидуОперации", ИнтеграцияИСМПКлиентСервер.РежимОткрытияОстаткиКодов()));
...
&НаКлиенте
Процедура ПерейтиВЛичныйКабинетТестовыйКонтур(Команда)
...
Процедура ОткрытьФормуСпискаДокументов(ИмяФормы,
	...
	Если ДополнительныеПараметры <> Неопределено Тогда
		Для Каждого ЭлементКоллекции Из ДополнительныеПараметры Цикл
			ПараметрыФормы.Вставить(ЭлементКоллекции.Ключ, ЭлементКоллекции.Значение);
		КонецЦикла;
	КонецЕсли;
...
Процедура НастроитьЭлементыФормыНаСервере()
	...
	Элементы.ГруппаЭлектронныйДокументВходящий.Видимость =  ПравоДоступаОбменЭДО И Не УпрощеннаяИнтеграцияБЭД;
	Элементы.ГруппаЭлектронныйДокументИсходящий.Видимость = ПравоДоступаОбменЭДО И Не УпрощеннаяИнтеграцияБЭД;
	
	Элементы.Ответственный.Видимость = Не УпрощеннаяИнтеграцияБЭД;
	Элементы.НастройкаИСМП.Видимость = Не УпрощеннаяИнтеграцияБЭД;
	Если Пользователи.ЭтоПолноправныйПользователь() Тогда
		Элементы.НастройкаИСМП.Заголовок = НСтр("ru='Настройки и справочники'");
	Иначе
		Элементы.НастройкаИСМП.Заголовок = НСтр("ru='Товарные группы'");
	КонецЕсли;
	...
	Элементы.ГруппаПодтверждениеПоступленияКИЗИСМП.Видимость = ВключенУчетМеха;
	...
	Элементы.ФормаПерейтиВЛичныйКабинетТестовыйКонтур.Видимость = Константы.РежимРаботыСТестовымКонтуромИСМП.Получить();
	Элементы.ОткрытьПроверкуКодаМаркировкиИСМП.Видимость = Не ОбщегоНазначенияИСМПКлиентСерверПовтИсп.УчитываетсяТолькоСырье();
...
Процедура ОбновитьСпискиДокументовИСМП()
	...
	ТаблицаДокументы.Колонки.Добавить("ИмяЭлемента");
	ТаблицаДокументы.Колонки.Добавить("ТекстОтборДокументов");
	
	ДобавитьДокумент(
		ТаблицаДокументы,
		Метаданные.Документы.ЗаказНаЭмиссиюКодовМаркировкиСУЗ,
		НСтр("ru='Заказы на эмиссию кодов маркировки'"),
		Истина,  // Оформите
		Истина,  // Отработайте
		Истина); // Ожидайте
	
	ПредставлениеВводВОборот = ИнтеграцияИСМПКлиентСервер.ПредставлениеСпискаВводВОборот();
	
	ДобавитьДокумент(
		ТаблицаДокументы,
		Метаданные.Документы.МаркировкаТоваровИСМП,
		ПредставлениеВводВОборот,
		Метаданные.ОпределяемыеТипы.ОснованиеМаркировкаТоваровИСМП.Тип.Типы()[0] <> Тип("Строка"),  // Оформите
		Истина,  // Отработайте
		Истина,, // Ожидайте
		"И ДокументИСМП.Операция <> Значение(Перечисление.ВидыОперацийИСМП.Агрегация)");
	
	ДобавитьДокумент(
		ТаблицаДокументы,
		Метаданные.Документы.МаркировкаТоваровИСМП,
		НСтр("ru='Подтверждение поступления КИЗ'"),
		Ложь,    // Оформите - для "Отчета о нанесении" создавать документ совместно с операцией ввода в оборот
		Истина,  // Отработайте
		Истина,  // Ожидайте
		"ПодтверждениеПоступленияКИЗИСМП",
		"И ДокументИСМП.Операция = Значение(Перечисление.ВидыОперацийИСМП.ПодтверждениеПоступленияКИЗ)");
	...
	ДобавитьДокумент(
		...
		НСтр("ru='Списания кодов маркировки'"),
	...
	ДобавитьДокумент(
		...
		НСтр("ru='Сведения об отклонениях'"),
		Метаданные.ОпределяемыеТипы.ОснованиеОтчетИСМП.Тип.Типы()[0] <> Тип("Строка"),  // Оформите
		Истина,  // Отработайте
		Истина, // Ожидайте
		"ОтчетИСМПСведенияОбОтклонениях",
		"И ДокументИСМП.Операция = Значение(Перечисление.ВидыОперацийИСМП.ОтчетИСМПСведенияОбОтклонениях)");
		
	ДобавитьДокумент(
		ТаблицаДокументы,
		Метаданные.Документы.ОтчетИСМП,
		НСтр("ru='Остатки кодов маркировки'"),
		Метаданные.ОпределяемыеТипы.ОснованиеОтчетИСМП.Тип.Типы()[0] <> Тип("Строка"),  // Оформите
		Истина,  // Отработайте
		Истина,, // Ожидайте
		"И ДокументИСМП.Операция <> Значение(Перечисление.ВидыОперацийИСМП.ОтчетИСМПСведенияОбОтклонениях)");
	...
	ДобавитьДокумент(
		...
		?(ВключенУчетМеха, НСтр("ru='Отгрузка'"), НСтр("ru='Отгрузка (ЕАЭС)'")),
		Истина,  // Оформите
		Истина,  // Отработайте
		Истина); // Ожидайте
	...
	ДобавитьДокумент(
		...
		?(ВключенУчетМеха, НСтр("ru='Приемка'"), НСтр("ru='Приемка (ЕАЭС)'")),
		Истина,  // Оформите
		Истина,  // Отработайте
		Истина); // Ожидайте
	...
	ДобавитьДокумент(
		...
		НСтр("ru='Разрешения на отгрузку'"),
	...
	ДобавитьДокумент(
		...
		СокрЛП(СтрЗаменить(ОбщегоНазначенияИСПовтИсп.ПредставленияВскрытыхПотребительскихУпаковок("ИСМП").ЗаголовокСписка, "ИС МП", "")),
		Ложь,    // Оформите
		Истина,  // Отработайте
		Истина); // Ожидайте
	...
	Для Каждого ТекЭлемент Из ТаблицаДокументы Цикл
		...
		Если ЗначениеЗаполнено(ТекЭлемент.ИмяЭлемента) Тогда
			ИмяТекЭлемента = ТекЭлемент.ИмяЭлемента;
		Иначе
			ИмяТекЭлемента = ИмяЭлементаПоМетаданным(ТекЭлемент.Метаданные);
		КонецЕсли;
		
		Если НЕ ТекЭлемент.ЕстьПравоЧтение Тогда
			Элементы["Группа" + ИмяТекЭлемента].Видимость = Ложь;
			Продолжить;
		КонецЕсли;
		...
		Если ТекЭлемент.Оформите Тогда
			ТекстыЗапроса.Добавить(
				...
				ИмяТекЭлемента + "Оформите");
		КонецЕсли;
		
		Если ТекЭлемент.Отработайте Тогда
			ТекстыЗапроса.Добавить(
				ТекстЗапросаОтработайте(ТекЭлемент.Метаданные, ТекЭлемент.ТекстОтборДокументов),
				ИмяТекЭлемента + "Отработайте");
		КонецЕсли;
		
		Если ТекЭлемент.Ожидайте Тогда
			ТекстыЗапроса.Добавить(
				ТекстЗапросаОжидайте(ТекЭлемент.Метаданные, ТекЭлемент.ТекстОтборДокументов),
				ИмяТекЭлемента + "Ожидайте");
		КонецЕсли;
		...
		Для Каждого КлючИЗначение Из СтруктураДействий Цикл
			...
			ЭлементНадписи = Элементы.Найти("Открыть" + ИмяТекЭлемента + КлючИЗначение.Ключ);
			...
			Иначе
				СобытияФормИС.ВывестиПоказатель(
					РезультатыЗапроса[ИмяТекЭлемента + КлючИЗначение.Ключ].Выбрать(),
					ЭлементНадписи,
					КлючИЗначение.Значение.Представление,
					КлючИЗначение.Значение.Доступно);
			КонецЕсли;
		...
		СобытияФормИС.ВывестиПоказатель(
			0,
			Элементы["Открыть" + ИмяТекЭлемента],
...
Процедура ОтобразитьСостояниеОбмена()
	...
	ТребуетсяНастройкаТоварныхГрупп = ОбщегоНазначенияИСМПКлиентСерверПовтИсп.УчитываемыеВидыМаркируемойПродукции().Количество() = 0;
	Если ТребуетсяНастройкаТоварныхГрупп Тогда
		ПерваяПроблема = НСтр("ru='Настройте товарные группы и загрузите номенклатуру'");
	...
	Проблемы = РезультатыЗапроса["НастроитьУдалениеНеиспользованныхКодовМаркировки"].Выбрать();
	ЕстьПроблемы = Выборка.Количество() = 0;
	Если ЕстьПроблемы Тогда
		Если ПерваяПроблема <> Неопределено Тогда
			ЕщеПроблемы = ЕщеПроблемы + 1;
		Иначе
			ПерваяПроблема = НСтр("ru='Рекомендуется настроить удаление кодов маркировки с истекшим сроком использования'");
			Элементы.ГруппаДекорацияСостояниеОбмена.ТекущаяСтраница = Элементы.СостояниеОбменаЖелтый;
		КонецЕсли;
	КонецЕсли;
	...
	Проблемы = РезультатыЗапроса["НастройкаНоменклатурыПоТНВЭДиОКПД2"].Выбрать();
	Если Проблемы.Количество() > 0 Тогда
		Если ПерваяПроблема <> Неопределено Тогда
			ЕщеПроблемы = ЕщеПроблемы + 1;
		Иначе
			ПерваяПроблема = НСтр("ru='Рекомендуется настроить номенклатуру по ТН ВЭД и ОКПД2'");
			Элементы.ГруппаДекорацияСостояниеОбмена.ТекущаяСтраница = Элементы.СостояниеОбменаЖелтый;
		КонецЕсли;
	КонецЕсли;
...
Процедура ДобавитьДокумент(Таблица, ОбъектМетаданных, Заголовок, Оформите, Отработайте, Ожидайте,
	ИмяЭлементаФормы = "", ТекстОтборДокументов = "")
	...
	Если ИмяЭлементаФормы = "АгрегацияКодовМаркировкиИСМП" Тогда
		ОпцияВключена = ИнтеграцияИСМППовтИсп.ОбъектМетаданныхДоступен(ИмяЭлементаФормы);
	Иначе
		ОпцияВключена = ИнтеграцияИСМППовтИсп.ОбъектМетаданныхДоступен(ОбъектМетаданных.ПолноеИмя());
	КонецЕсли;
	...
	НоваяСтрока.ИмяЭлемента   = ИмяЭлементаФормы;
	НоваяСтрока.ТекстОтборДокументов = ТекстОтборДокументов;
	
КонецПроцедуры

&НаСервере
Функция ТекстЗапросаОтработайте(МетаданныеДокументаИСМП, ДополнительныйОтбор = "")
...
&НаСервере
Функция ТекстЗапросаОжидайте(МетаданныеДокументаИСМП, ДополнительныйОтбор = "")
...
&НаСервере
Функция ТекстЗапросаКоличестваДокументовПоДальнейшемуДействию(МетаданныеДокументаИСМП, ОтборДействия, ДополнительныйОтбор)
...
&НаКлиенте
Процедура ЗапуститьРасчетПроблем()
	
	ОбработатьРезультатЗапускаРасчетаПроблем(
		ИнтеграцияИСМПВызовСервера.ЗапуститьРасчетПроблем(УникальныйИдентификатор));
	
КонецПроцедуры

&НаКлиенте
Процедура ОбработатьРезультатЗапускаРасчетаПроблем(Результат) Экспорт
	
	Если Результат <> Неопределено Тогда
		
		ПараметрыОжидания = ДлительныеОперацииКлиент.ПараметрыОжидания(Неопределено);
		ПараметрыОжидания.ТекстСообщения             = НСтр("ru='Выполняется расчет проблем'");
		...
		ДлительныеОперацииКлиент.ОжидатьЗавершение(
			Результат,
			Новый ОписаниеОповещения("ПослеЗавершенияРасчетаПроблем", ЭтотОбъект),
			ПараметрыОжидания);
...
&НаКлиенте
Процедура ПослеЗавершенияРасчетаПроблем(Результат, ДополнительныеПараметрыДлительнойОперации) Экспорт
	...
	Если Результат.Статус = "Выполнено" Тогда
		...
		ИначеЕсли РезультатВыполнения.ЕстьИзменения Тогда
			ОтобразитьСостояниеОбмена();
		КонецЕсли;
...
&НаКлиенте
Процедура ОткрытьФормуПомощникНастройкиИСМП()
	
	ОткрытьФорму("Обработка.ПомощникНастройкиИСМП.Форма.ПомощникНастройкиИСМП");
