...
Процедура ОбработкаНавигационнойСсылки(НавигационнаяСсылкаФорматированнойСтроки, СтандартнаяОбработка)
	...
	ИначеЕсли НавигационнаяСсылкаФорматированнойСтроки = "НастройкаНоменклатурыПоТНВЭДиОКПД2" Тогда
...
Процедура ОбработкаОповещения(ИмяСобытия, Параметр, Источник)
	...
	Если ИмяСобытия = "НастройкаНоменклатурыПоТНВЭДиОКПД2" Тогда
		ОбновитьСписокПроблем();
	КонецЕсли;
...
Процедура ОбновитьСписокПроблем()
	...
	ПроверитьНастройкиУдаленияНеиспользованныхКодовМаркировки(РезультатыЗапроса);
	...
	ПроверитьНастройкуНоменклатурыПоТНВЭДиОКПД2(РезультатыЗапроса);
	ПроблемыОбновленияКлассификаторов();
...
&НаСервере
Процедура ПроверитьНастройкуНоменклатурыПоТНВЭДиОКПД2(РезультатЗапроса)
	
	ИдентификаторПроблемы = "НастройкаНоменклатурыПоТНВЭДиОКПД2";
	ИмяЭлемента           = "НастройкаНоменклатурыПоТНВЭДиОКПД2";
...
&НаСервере
Процедура ПроверитьНастройкиУдаленияНеиспользованныхКодовМаркировки(РезультатыЗапроса)
...
&НаСервере
Процедура ПроблемыОбновленияКлассификаторов()
	
	ПроблемыКлассификаторовВПанелиОбмена = ИнтеграцияИС.ПроблемыКлассификаторовВПанелиОбмена();
