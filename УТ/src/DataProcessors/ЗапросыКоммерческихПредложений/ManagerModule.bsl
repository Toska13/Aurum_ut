...
Процедура ПриОпределенииМетодовРазрешенныхДляВызоваКакПроизвольныйКод(Методы) Экспорт
    ...
    Методы.Вставить("НайтиЗапросыКоммерческихПредложений", Истина);
    Методы.Вставить("ДанныеЗапросаКоммерческихПредложенийВСервисе", Истина);
    Методы.Вставить("СохранитьЗапросУКлиента", Истина);
    Методы.Вставить("ПолучитьФайлИзСервиса", Истина);
