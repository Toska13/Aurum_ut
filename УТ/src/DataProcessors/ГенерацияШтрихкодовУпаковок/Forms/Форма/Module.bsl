...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если РежимУказанияПараметровГенерации Тогда
...
Процедура Готово(Команда)
	...
	Если ТипШтрихкода = ПредопределенноеЗначение("Перечисление.ТипыШтрихкодов.SSCC")
		Или ТипШтрихкода = ПредопределенноеЗначение("Перечисление.ТипыШтрихкодов.SSCC18") Тогда
		ВозвращаемыеПараметры.Вставить("ТипШтрихкода", ПредопределенноеЗначение("Перечисление.ТипыШтрихкодов.SSCC20"));
	Иначе
	...
	Если ВозвращатьАдресВременногоХранилища
	   И ВладелецФормы <> Неопределено Тогда
		...
		Если ПоследниеНомераПоТипамШтрихкодов = Неопределено Тогда
			...
			ПоследниеНомераПоТипамШтрихкодов = Новый Соответствие; // Соответствие Из Строка - 
		КонецЕсли;
