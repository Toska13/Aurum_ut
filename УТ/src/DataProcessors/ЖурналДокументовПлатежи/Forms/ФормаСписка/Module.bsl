...
Процедура ОбработкаОповещения(ИмяСобытия, Параметр, Источник)
	...
	ПараметрыОповещенияЭДО.ИмяДинамическогоСписка = "ЖурналПлатежей";
...
Процедура Подключаемый_ВыполнитьКомандуЭДО(Команда)
	...
	ТекущиеДанные = Элементы.ЖурналПлатежей.ТекущиеДанные;
	...
	ЭлектронноеВзаимодействиеКлиент.ВыполнитьПодключаемуюКомандуЭДО(Команда, ЭтотОбъект, Элементы.ЖурналПлатежей);
...
Процедура ЗагрузитьОплатыИзЯндексКассыЛокализация(Команда)
	...
	ОповещениеПолученияОперацийПоЯндексКассе =
		Новый ОписаниеОповещения("ОбработкаПолученияОперацийЗавершение", ЭтотОбъект, ДополнительныеПараметры);
...
Процедура УстановитьВидимостьЛокализация()
	...
	Элементы.ЗагрузитьОплаченныеСсылкиСБП.Видимость = ЕстьПравоЗагрузкиОплатИзСБП;
	
	ЕстьПравоЗагрузкиОплатОнлайнЗаказов = ОнлайнЗаказы.ОнлайнЗаказыДоступны()
		Или Пользователи.ЭтоПолноправныйПользователь();
	Элементы.ЗагрузитьОплаченныеСсылкиОнлайнЗаказов.Видимость = ЕстьПравоЗагрузкиОплатОнлайнЗаказов
