...
&НаСервере
Перем ДокументИсправление; // ДокументСсылка
...
Процедура ОбработкаОповещения(ИмяСобытия, Параметр, Источник)
	...
	Если ИмяСобытия = "Запись_ВозвратТоваровОтКлиента"
		...
		Или ИмяСобытия = "Запись_ПоступлениеТоваровОтКлиента"
...
Процедура СформироватьОтчет()
	...
	Если ТипЗнч(АктОРасхождениях) = Тип("ДокументСсылка.АктОРасхожденияхПослеОтгрузки") Тогда
		...
		Если РасхожденияКлиентСервер.ТипОснованияРеализацияТоваровУслуг(ТипОснованияАктаОРасхождении) Тогда
			...
			ТекстЗапроса = ТекстЗапросаАктОРасхожденияхПослеРеализации(ПраваДоступаНаТаблицы, СоответствиеНаборовДанных);
			
		ИначеЕсли РасхожденияКлиентСервер.ТипОснованияОтгрузкаТоваровКлиенту(ТипОснованияАктаОРасхождении) Тогда
			
			ПраваДоступаНаТаблицы.Вставить("ЧтениеСписаниеНедостачТоваров", ПравоДоступа("Чтение", Метаданные.Документы.СписаниеНедостачТоваров));
			
			ТекстЗапроса = ТекстЗапросаАктОРасхожденияхПослеОтгрузкиТоваровКлиенту(ПраваДоступаНаТаблицы, СоответствиеНаборовДанных);
			
		ИначеЕсли РасхожденияКлиентСервер.ТипОснованияВозвратПоставщику(ТипОснованияАктаОРасхождении) Тогда
			
			ПраваДоступаНаТаблицы.Вставить("ЧтениеСписаниеНедостачТоваров", ПравоДоступа("Чтение", Метаданные.Документы.СписаниеНедостачТоваров));
			
			ТекстЗапроса = ТекстЗапросаАктОРасхожденияхПослеВозвратаПоставщику(ПраваДоступаНаТаблицы, СоответствиеНаборовДанных);
		...
		ИначеЕсли РасхожденияКлиентСервер.ТипОснованияПередачаТоваровХранителю(ТипОснованияАктаОРасхождении)
			...
			ТекстЗапроса = ТекстЗапросаАктОРасхожденияхПослеПередачиТоваровХранителю(ПраваДоступаНаТаблицы, СоответствиеНаборовДанных);
	...
	Для Каждого СтрокаДействия Из Действия Цикл
		...
		Если ТипЗнч(АктОРасхождениях) = Тип("ДокументСсылка.АктОРасхожденияхПослеОтгрузки") Тогда
			...
			ВывестиСтрокиДействийПоАктуПослеОтгрузки(СтрокаДействия, Макет, ТипОснованияАктаОРасхождении, ПраваДоступаНаТаблицы);
...
Процедура ЗаполнитьТаблицуДействий(АктОРасхождениях, РезультатЗапроса)
	...
	ЭтоАктОРасхожденияхПослеОтгрузки = ТипЗнч(АктОРасхождениях) = Тип("ДокументСсылка.АктОРасхожденияхПослеОтгрузки");
	...
	Пока ВыборкаОснования.Следующий() Цикл
		...
		Пока ВыборкаДействия.Следующий() Цикл
			...
			Если ЭтоАктОРасхожденияхПослеОтгрузки Тогда
				НоваяСтрокаВариантыДействийСТоваром = НоваяСтрока.ВариантыДействийСТоваром.Добавить();
				НоваяСтрокаВариантыДействийСТоваром.ВариантДействияСДокументом = ВыборкаДействия.Действие;
				НоваяСтрокаВариантыДействийСТоваром.ВариантДействияСТоваром = ВыборкаДействия.ДействиеСТоваром;
			КонецЕсли;
			...
			Если ВыборкаДействия.Действие = Перечисления.ВариантыДействийПоРасхождениямВАктеПослеПриемки.ОтнестиНедостачуНаПрочиеРасходы
				...
				Или ВыборкаДействия.Действие = Перечисления.ВариантыДействийПоРасхождениямВАктеПослеПриемки.ОформитьНедостачуИОжидатьДопоставку
				Или (ЭтоАктОРасхожденияхПослеОтгрузки
					И ВыборкаДействия.ДействиеСТоваром = Перечисления.ВариантыДействийПоТоварамВАктеПослеОтгрузки.Списать) Тогда
				...
				Если ЭтоАктОРасхожденияхПослеОтгрузки Тогда
					НоваяСтрокаВариантыДействийСклады.ВариантДействияСТоваром = ВыборкаДействия.ДействиеСТоваром;
				КонецЕсли;
		...
		ВариантыДействийСТоваром = НоваяСтрока.ВариантыДействийСТоваром.Выгрузить();
		ВариантыДействийСТоваром.Свернуть("ВариантДействияСДокументом, ВариантДействияСТоваром");
		НоваяСтрока.ВариантыДействийСТоваром.Загрузить(ВариантыДействийСТоваром);
...
Процедура ЗаполнитьТаблицыСозданныхДокументов(РезультатЗапроса, ТипОснованияАктаОРасхождении, СоответствиеНаборовДанных)
	...
	Если ТипЗнч(АктОРасхождениях) = Тип("ДокументСсылка.АктОРасхожденияхПослеОтгрузки") Тогда
		...
		Если РасхожденияКлиентСервер.ТипОснованияРеализацияТоваровУслуг(ТипОснованияАктаОРасхождении) Тогда
			...
			ОтгрузкиПоОтгрузкамТоваровКлиенту.Загрузить(РезультатЗапроса[6].Выгрузить());
			ОснованияОприходованияИзлишковОтгруженныхТоваров.Загрузить(РезультатЗапроса[7].Выгрузить());
			ОснованияПоступленийТоваровОтКлиента.Загрузить(РезультатЗапроса[8].Выгрузить());
			ОснованияСписанияТоваровОтгруженныхКлиенту.Загрузить(РезультатЗапроса[9].Выгрузить());
			РеализацииКорректировкиВернутьВПуть.Загрузить(РезультатЗапроса[10].Выгрузить());
			ОтгрузкиТоваровКлиентуПоПереходуПраваСобственности2_5.Загрузить(РезультатЗапроса[11].Выгрузить());
		...
		ИначеЕсли РасхожденияКлиентСервер.ТипОснованияОтгрузкаТоваровКлиенту(ТипОснованияАктаОРасхождении) Тогда
			...
			ОснованияПоступленийТоваровОтКлиента.Загрузить(РезультатЗапроса[2].Выгрузить());
			ОтгрузкиТоваровКлиентуЗаказы.Загрузить(РезультатЗапроса[3].Выгрузить());
			ОтгрузкиПоОтгрузкамТоваровКлиенту.Загрузить(РезультатЗапроса[4].Выгрузить());
			ОснованияОприходованияИзлишковОтгруженныхТоваров.Загрузить(РезультатЗапроса[5].Выгрузить());
			ОснованияСписанияТоваровОтгруженныхКлиенту.Загрузить(РезультатЗапроса[6].Выгрузить());
		...
		ИначеЕсли РасхожденияКлиентСервер.ТипОснованияПередачаТоваровХранителю(ТипОснованияАктаОРасхождении) Тогда
			...
			ПередачиИсправления.Загрузить(РезультатЗапроса[5].Выгрузить());
		...
		Иначе
			...
			ИсправленияПоОтгрузкамТоваровСХранения.Загрузить(РезультатЗапроса[4].Выгрузить());
		КонецЕсли;
...
&НаСервере
Функция ТекстЗапросаАктОРасхожденияхПослеРеализации(ПраваДоступаНаТаблицы, СоответствиеНаборовДанных)
	
	ТекстЗапроса = "
	|ВЫБРАТЬ РАЗРЕШЕННЫЕ РАЗЛИЧНЫЕ
	|	АктОРасхожденияхПослеОтгрузкиТовары.Действие         КАК Действие,
	|	АктОРасхожденияхПослеОтгрузкиТовары.ДействиеСТоваром КАК ДействиеСТоваром,
	...
	|	Действия.ДействиеСТоваром КАК ДействиеСТоваром,
	|	Действия.Реализация       КАК Основание,
	|	Действия.Склад            КАК Склад,
	|	ЛОЖЬ                      КАК ПоВинеСтороннейКомпании,
	|	МАКСИМУМ(ВЫБОР
	|		КОГДА Действия.ЗаказКлиента ССЫЛКА Документ.ЗаказКлиента
	|			ТОГДА Действия.Реализация.РеализацияПоЗаказам
	|		КОГДА Действия.ЗаказКлиента ССЫЛКА Документ.ЗаявкаНаВозвратТоваровОтКлиента
	|			ТОГДА Действия.Реализация.РеализацияПоЗаказам
	|		ИНАЧЕ
	|			ЛОЖЬ
	|	КОНЕЦ)                    КАК ПоЗаказам,
	...
	|////////////////////////////////////////////////////////////////////////////////6
	|ВЫБРАТЬ РАЗРЕШЕННЫЕ РАЗЛИЧНЫЕ
	|	Документ.Ссылка      КАК ОтгрузкаТоваровКлиенту,
	|	Документ.ОснованиеАктаОРасхожденияхДляИсправления КАК Основание,
	|	Документ.Исправление КАК Исправление,
	|	ЛОЖЬ                 КАК Допоставка
	|ИЗ
	|	Действия КАК Действия
	|	ВНУТРЕННЕЕ СОЕДИНЕНИЕ Документ.ОтгрузкаТоваровКлиенту КАК Документ
	|		ПО (Документ.Проведен)
	|			И Действия.Реализация = Документ.ОснованиеАктаОРасхожденияхДляИсправления
	|
	|ОБЪЕДИНИТЬ ВСЕ
	|
	|ВЫБРАТЬ РАЗЛИЧНЫЕ
	|	Документ.Ссылка      КАК ОтгрузкаТоваровКлиенту,
	|	Документ.ОснованиеАктаОРасхождениях КАК Основание,
	|	Документ.Исправление КАК Исправление,
	|	ИСТИНА               КАК Допоставка
	|ИЗ
	|	Действия КАК Действия
	|	ВНУТРЕННЕЕ СОЕДИНЕНИЕ Документ.ОтгрузкаТоваровКлиенту КАК Документ
	|		ПО (Документ.Проведен)
	|			И Действия.Реализация = Документ.ОснованиеАктаОРасхождениях
	|;
	|
	|////////////////////////////////////////////////////////////////////////////////7
	|ВЫБРАТЬ РАЗРЕШЕННЫЕ РАЗЛИЧНЫЕ
	|	ОприходованиеИзлишковОтгруженныхТоваров.ОснованиеАктаОРасхождениях КАК Основание,
	|	ОприходованиеИзлишковОтгруженныхТоваров.Ссылка КАК Оприходование
	|ИЗ
	|	Действия КАК Действия
	|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ Документ.ОприходованиеИзлишковОтгруженныхТоваров КАК ОприходованиеИзлишковОтгруженныхТоваров
	|		ПО ОприходованиеИзлишковОтгруженныхТоваров.Проведен
	|			И ОприходованиеИзлишковОтгруженныхТоваров.ОснованиеАктаОРасхождениях = Действия.Реализация
	|;
	|
	|////////////////////////////////////////////////////////////////////////////////8
	|ВЫБРАТЬ РАЗРЕШЕННЫЕ РАЗЛИЧНЫЕ
	|	ПоступлениеТоваровОтКлиента.ОснованиеАктаОРасхождениях КАК Основание,
	|	ПоступлениеТоваровОтКлиента.Ссылка КАК ПоступлениеТоваровОтКлиента,
	|	ПоступлениеТоваровОтКлиента.УменьшитьОтгрузкуПоРаспоряжению КАК УменьшитьОтгрузкуПоРаспоряжению
	|ИЗ
	|	Действия КАК Действия
	|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ Документ.ПоступлениеТоваровОтКлиента КАК ПоступлениеТоваровОтКлиента
	|		ПО ПоступлениеТоваровОтКлиента.Проведен
	|			И ПоступлениеТоваровОтКлиента.ОснованиеАктаОРасхождениях = Действия.Реализация
	|;
	|
	|////////////////////////////////////////////////////////////////////////////////9
	|ВЫБРАТЬ РАЗРЕШЕННЫЕ РАЗЛИЧНЫЕ
	|	СписаниеОтгруженныхТоваров.ОснованиеАктаОРасхождениях КАК Основание,
	|	СписаниеОтгруженныхТоваров.Ссылка КАК Списание,
	|	СписаниеОтгруженныхТоваров.УменьшитьОтгрузкуПоРаспоряжению КАК УменьшитьОтгрузкуПоРаспоряжению
	|ИЗ
	|	Действия КАК Действия
	|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ Документ.СписаниеОтгруженныхТоваров КАК СписаниеОтгруженныхТоваров
	|		ПО СписаниеОтгруженныхТоваров.Проведен
	|			И СписаниеОтгруженныхТоваров.ОснованиеАктаОРасхождениях = Действия.Реализация
	|;
	|
	|////////////////////////////////////////////////////////////////////////////////10
	|ВЫБРАТЬ РАЗРЕШЕННЫЕ РАЗЛИЧНЫЕ
	|	ТаблицаРасхождения.Ссылка.ДокументОснование КАК Реализация,
	|	ТаблицаРасхождения.Ссылка                   КАК Корректировка
	|ИЗ
	|	Документ.КорректировкаРеализации.Расхождения КАК ТаблицаРасхождения
	|ГДЕ
	|	ТаблицаРасхождения.Ссылка.АктОРасхожденияхПослеОтгрузкиОснование = &АктОРасхождениях
	|	И ТаблицаРасхождения.Ссылка.Проведен
	|	И ТаблицаРасхождения.ВариантОтражения = ЗНАЧЕНИЕ(Перечисление.ВариантыОтраженияКорректировокРеализаций.ВернутьВПуть)
	|;
	|
	|////////////////////////////////////////////////////////////////////////////////11
	|ВЫБРАТЬ РАЗРЕШЕННЫЕ РАЗЛИЧНЫЕ
	|	ОтгрузкаТовары.Ссылка КАК ОтгрузкаТоваровКлиенту
	|ИЗ
	...
	|				ИЛИ АктТовары.КодСтроки = 0)
	|			И ОтгрузкаТовары.ЗаказКлиента = АктТовары.ЗаказКлиента
	|	ЛЕВОЕ СОЕДИНЕНИЕ РегистрСведений.РеестрДокументов КАК РеестрДокументов
	|		ПО (ОтгрузкаТовары.Ссылка = РеестрДокументов.ИсправляемыйДокумент
	|				ИЛИ ОтгрузкаТовары.Ссылка = РеестрДокументов.СторнируемыйДокумент)
	|			И РеестрДокументов.Проведен
	|			И НЕ РеестрДокументов.ДополнительнаяЗапись
	|	ЛЕВОЕ СОЕДИНЕНИЕ РегистрСведений.РеестрДокументов КАК РеестрДокументовПоследующиеИсправления
	|		ПО РеестрДокументов.ТипСсылки = РеестрДокументовПоследующиеИсправления.ТипСсылки
	...
	|		ИЛИ РеестрДокументовПоследующиеИсправления.Ссылка ЕСТЬ НЕ NULL)
	|
	|ОБЪЕДИНИТЬ
	|
	|ВЫБРАТЬ РАЗЛИЧНЫЕ
	...
	|			И (ОтгрузкаТовары.КодСтроки = АктТовары.КодСтроки
	|				ИЛИ АктТовары.КодСтроки = 0)
	|			И ОтгрузкаТовары.Ссылка = АктТовары.ЗаказКлиента
	|	ЛЕВОЕ СОЕДИНЕНИЕ РегистрСведений.РеестрДокументов КАК РеестрДокументов
	|		ПО (ОтгрузкаТовары.Ссылка = РеестрДокументов.ИсправляемыйДокумент
	|				ИЛИ ОтгрузкаТовары.Ссылка = РеестрДокументов.СторнируемыйДокумент)
	|			И РеестрДокументов.Проведен
	...
	|			И (ОтгрузкаТовары.КодСтроки = АктТовары.КодСтроки
	|				ИЛИ АктТовары.КодСтроки = 0)
	|			И ОтгрузкаТовары.Ссылка.ИсправляемыйДокумент = АктТовары.ЗаказКлиента
	|	ЛЕВОЕ СОЕДИНЕНИЕ РегистрСведений.РеестрДокументов КАК РеестрДокументов
	|		ПО (ОтгрузкаТовары.Ссылка = РеестрДокументов.ИсправляемыйДокумент
	|				ИЛИ ОтгрузкаТовары.Ссылка = РеестрДокументов.СторнируемыйДокумент)
	|			И РеестрДокументов.Проведен
	...
	Если ПраваДоступаНаТаблицы.ЧтениеСписаниеНедостачТоваров Тогда
		...
		|	СписаниеНедостачТоваров.ОснованиеАктаОРасхождениях КАК Основание
		|ИЗ
		|	Действия КАК Действия
		|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ Документ.СписаниеНедостачТоваров КАК СписаниеНедостачТоваров
		|		ПО (СписаниеНедостачТоваров.Проведен)
		|			И Действия.Реализация = СписаниеНедостачТоваров.ОснованиеАктаОРасхождениях
		|			И Действия.Склад = СписаниеНедостачТоваров.Склад
		|";
		
		ТекущийНомер = 12;
		СоответствиеНаборовДанных.Вставить("ОснованияСписанияНедостачПоДокументамОтгрузки", ТекущийНомер);
...
&НаСервере
Функция ТекстЗапросаАктОРасхожденияхПослеОтгрузкиТоваровКлиенту(ПраваДоступаНаТаблицы, СоответствиеНаборовДанных)
	...
	|	МАКСИМУМ(ВЫБОР
	|		КОГДА Действия.ЗаказКлиента ССЫЛКА Документ.ЗаказКлиента
	|			ТОГДА Действия.Реализация.ОтгрузкаПоЗаказам
	|		КОГДА Действия.ЗаказКлиента ССЫЛКА Документ.ЗаявкаНаВозвратТоваровОтКлиента
	|			ТОГДА Действия.Реализация.ОтгрузкаПоЗаказам
	|		ИНАЧЕ
	|			ЛОЖЬ
	...
	|////////////////////////////////////////////////////////////////////////////////2
	|ВЫБРАТЬ РАЗРЕШЕННЫЕ РАЗЛИЧНЫЕ
	|	Документ.Ссылка                          КАК ПоступлениеТоваровОтКлиента,
	|	Документ.ОснованиеАктаОРасхождениях      КАК Основание,
	|	Документ.УменьшитьОтгрузкуПоРаспоряжению КАК УменьшитьОтгрузкуПоРаспоряжению
	|ИЗ
	|	Действия КАК Действия
	|	ВНУТРЕННЕЕ СОЕДИНЕНИЕ Документ.ПоступлениеТоваровОтКлиента КАК Документ
	|		ПО Документ.Проведен
	|			И Действия.Реализация = Документ.ОснованиеАктаОРасхождениях
	|;
	|
	...
	|ВЫБРАТЬ РАЗРЕШЕННЫЕ РАЗЛИЧНЫЕ
	|	АктОРасхожденияхПослеОтгрузкиТовары.ЗаказКлиента КАК ЗаказКлиента,
	|	АктОРасхожденияхПослеОтгрузкиТовары.Реализация   КАК ОтгрузкаТоваровКлиенту
	|ИЗ
	|	Документ.АктОРасхожденияхПослеОтгрузки.Товары КАК АктОРасхожденияхПослеОтгрузкиТовары
	|ГДЕ
	|	АктОРасхожденияхПослеОтгрузкиТовары.КоличествоУпаковокПоДокументу <> АктОРасхожденияхПослеОтгрузкиТовары.КоличествоУпаковок
	|	И АктОРасхожденияхПослеОтгрузкиТовары.Действие = ЗНАЧЕНИЕ(Перечисление.ВариантыДействийПоРасхождениямВАктеПослеОтгрузки.ДопоставкаНеТребуется)
	|	И АктОРасхожденияхПослеОтгрузкиТовары.Ссылка = &АктОРасхождениях
	|	И НЕ АктОРасхожденияхПослеОтгрузкиТовары.ЗаказКлиента В (
...
Функция ТекстЗапросаАктОРасхожденияхПослеВозвратаОтКлиента(ПраваДоступаНаТаблицы, СоответствиеНаборовДанных)
	...
	Если ПраваДоступаНаТаблицы.ЧтениеСписаниеЗадолженности Тогда
		...
		|			И &АктОРасхождениях = КорректировкаЗадолженности.АктОРасхожденияхОснование
		|";
...
&НаСервере
Функция ТекстЗапросаАктОРасхожденияхПослеВозвратаПоставщику(ПраваДоступаНаТаблицы, СоответствиеНаборовДанных)
	...
	|	Действия.Действие,
	|	Действия.ДействиеСТоваром,
	|	Действия.ВозвратТоваровПоставщику,
	|	Действия.Склад
	|
	|ИТОГИ ПО
	...
	Если ПраваДоступаНаТаблицы.ЧтениеСписаниеНедостачТоваров Тогда
		...
		|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ Документ.СписаниеНедостачТоваров КАК СписаниеНедостачТоваров
		|		ПО (СписаниеНедостачТоваров.Проведен)
		|			И Действия.ВозвратТоваровПоставщику = СписаниеНедостачТоваров.ОснованиеАктаОРасхождениях
		|			И Действия.Склад = СписаниеНедостачТоваров.Склад
		|";
...
Функция ТекстЗапросаАктОРасхожденияхПослеПоступленияТоваров(ПраваДоступаНаТаблицы, СоответствиеНаборовДанных)
	...
	ТекстЗапроса = "
	|ВЫБРАТЬ РАЗРЕШЕННЫЕ РАЗЛИЧНЫЕ
	|	АктОРасхожденияхПослеПриемкиТовары.Ссылка КАК Акт,
	|	АктОРасхожденияхПослеПриемкиТовары.Действие,
	|	АктОРасхожденияхПослеПриемкиТовары.ДокументОснование КАК Основание,
	|	АктОРасхожденияхПослеПриемкиТовары.Склад КАК Склад,
	...
	Если ПраваДоступаНаТаблицы.ЧтениеПоступленияТоваровНаСклад Тогда
		...
		|		И ПоступлениеТоваровНаСклад.АктОРасхожденияхПослеПриемкиОснование = &АктОРасхождениях
		|
		|ОБЪЕДИНИТЬ ВСЕ
		|
		|ВЫБРАТЬ РАЗЛИЧНЫЕ
		...
		|		ПО ПоступлениеТоваровНаСклад.Проведен 
		|		И Действия.Склад  = ПоступлениеТоваровНаСклад.Склад
		|		И ПоступлениеТоваровНаСклад.АктОРасхожденияхПослеПриемкиОснование =
		|			ЗНАЧЕНИЕ(Документ.АктОРасхожденияхПослеПриемки.ПустаяСсылка)
	...
	Если ПраваДоступаНаТаблицы.ЧтениеКорректировкаЗадолженности Тогда
        ...
        |		ВНУТРЕННЕЕ СОЕДИНЕНИЕ Документ.КорректировкаЗадолженности КАК КорректировкаЗадолженности
        |		ПО (КорректировкаЗадолженности.Ссылка.Проведен)
        |			И Действия.Акт = КорректировкаЗадолженности.АктОРасхожденияхОснование"; 
...
&НаСервере
Процедура ВывестиСтрокиДействийПоАктуПослеОтгрузки(СтрокаДействия, Макет, ТипОснованияАктаОРасхождении, ПраваДоступаНаТаблицы)
	
	ЭтоПереходПраваСобственности = 
		(ХозяйственнаяОперацияАкта = Перечисления.ХозяйственныеОперации.ПереходПраваСобственности);
	...
	Если СпособОтраженияРасхождений = Перечисления.СпособыОтраженияРасхожденийАктПриемкиКлиента.ИсправлениеПервичныхДокументов Тогда
		...
		Если СтрокаДействия.ВариантыДействий.НайтиПоЗначению(Перечисления.ВариантыДействийПоРасхождениямВАктеПослеОтгрузки.ТребуетсяДопоставка) <> Неопределено Тогда
			...
			Если РасхожденияКлиентСервер.ТипОснованияРеализацияТоваровУслуг(ТипОснованияАктаОРасхождении) Тогда
				...
				ПараметрыПоиска = Новый Структура;
				ПараметрыПоиска.Вставить("ВариантДействияСДокументом", Перечисления.ВариантыДействийПоРасхождениямВАктеПослеОтгрузки.ТребуетсяДопоставка);
				ПараметрыПоиска.Вставить("ВариантДействияСТоваром", Перечисления.ВариантыДействийПоТоварамВАктеПослеОтгрузки.Списать);
				НайденныеСтроки = СтрокаДействия.ВариантыДействийСТоваром.НайтиСтроки(ПараметрыПоиска);
				Если НайденныеСтроки.Количество() > 0 Тогда
					...
					Описание.ВариантДействия  = Перечисления.ВариантыДействийПоРасхождениямВАктеПослеОтгрузки.ТребуетсяДопоставка;
					Описание.СпособОтражения  = СпособОтраженияРасхождений;
					
					ВывестиДокументСписаниеНедостачТоваровРеализацияТоваровУслуг(СтрокаДействия, Макет, Описание);
					
				КонецЕсли;
				
				ПараметрыПоиска = Новый Структура;
				ПараметрыПоиска.Вставить("ВариантДействияСДокументом", Перечисления.ВариантыДействийПоРасхождениямВАктеПослеОтгрузки.ТребуетсяДопоставка);
				ПараметрыПоиска.Вставить("ВариантДействияСТоваром", Перечисления.ВариантыДействийПоТоварамВАктеПослеОтгрузки.СписатьИзПути);
				НайденныеСтроки = СтрокаДействия.ВариантыДействийСТоваром.НайтиСтроки(ПараметрыПоиска);
				Если НайденныеСтроки.Количество() > 0 Тогда
					...
					Описание.Вставить("ВариантДействия", Перечисления.ВариантыДействийПоРасхождениямВАктеПослеОтгрузки.ТребуетсяДопоставка);
					Описание.Вставить("СпособОтражения", СпособОтраженияРасхождений);
					Описание.Вставить("ПоЗаказам", СтрокаДействия.ПоЗаказам);
					
					ВывестиСписаниеТоваровОтгруженныхКлиенту(СтрокаДействия, Макет, Описание);
					
				КонецЕсли;
				
				ПараметрыПоиска = Новый Структура;
				ПараметрыПоиска.Вставить("ВариантДействияСДокументом", Перечисления.ВариантыДействийПоРасхождениямВАктеПослеОтгрузки.ТребуетсяДопоставка);
				ПараметрыПоиска.Вставить("ВариантДействияСТоваром", Перечисления.ВариантыДействийПоТоварамВАктеПослеОтгрузки.Вернуть);
				НайденныеСтроки = СтрокаДействия.ВариантыДействийСТоваром.НайтиСтроки(ПараметрыПоиска);
				Если НайденныеСтроки.Количество() > 0 Тогда
					...
					ВывестиДокументПоступлениеТоваровОтКлиента(СтрокаДействия, Макет, Описание);
				...
				Если ЭтоПереходПраваСобственности Тогда
					...
					ПараметрыПоиска = Новый Структура;
					ПараметрыПоиска.Вставить("ВариантДействияСДокументом", Перечисления.ВариантыДействийПоРасхождениямВАктеПослеОтгрузки.ТребуетсяДопоставка);
					ПараметрыПоиска.Вставить("ВариантДействияСТоваром", Перечисления.ВариантыДействийПоТоварамВАктеПослеОтгрузки.УчестьПриИнвентаризации);
					НайденныеСтроки = СтрокаДействия.ВариантыДействийСТоваром.НайтиСтроки(ПараметрыПоиска);
					Если НайденныеСтроки.Количество() > 0 Тогда
						...
						ВывестиИсправлениеОтгрузокТоваровКлиентуПриПереходеПраваСобственности(
							СтрокаДействия,
							Макет,
							Описание);
					...
					ВывестиОтгрузкаТоваровКлиентуНаДопоставкуНедопоставленногоТовара(СтрокаДействия, Макет, Описание);
			...
			ИначеЕсли РасхожденияКлиентСервер.ТипОснованияОтгрузкаТоваровКлиенту(ТипОснованияАктаОРасхождении) Тогда
				...
				ТребуетсяГруппироватьСтроки = Ложь;
				...
				Если НайденныеСтроки.Количество() > 0 Тогда
					...
					ВывестиИсправлениеОтгрузкаТоваровКлиенту(СтрокаДействия.Основание, Макет, Описание);
					
					ТребуетсяГруппироватьСтроки = Истина;
					
				КонецЕсли;
				
				Если ТребуетсяГруппироватьСтроки Тогда
					ТабличныйДокумент.НачатьГруппуСтрок();
				КонецЕсли;
		...
		Если СтрокаДействия.ВариантыДействий.НайтиПоЗначению(Перечисления.ВариантыДействийПоРасхождениямВАктеПослеОтгрузки.ДопоставкаНеТребуется) <> Неопределено Тогда
			...
			Если РасхожденияКлиентСервер.ТипОснованияРеализацияТоваровУслуг(ТипОснованияАктаОРасхождении) Тогда
				...
				ПараметрыПоиска = Новый Структура;
				ПараметрыПоиска.Вставить("ВариантДействияСДокументом", Перечисления.ВариантыДействийПоРасхождениямВАктеПослеОтгрузки.ДопоставкаНеТребуется);
				ПараметрыПоиска.Вставить("ВариантДействияСТоваром", Перечисления.ВариантыДействийПоТоварамВАктеПослеОтгрузки.Списать);
				НайденныеСтроки = СтрокаДействия.ВариантыДействийСТоваром.НайтиСтроки(ПараметрыПоиска);
				Если НайденныеСтроки.Количество() > 0 Тогда
					...
					Описание.АктОРасхождениях = АктОРасхождениях;
					Описание.ИмяКоманды       = "Оформить";
					Описание.ВариантДействия  = Перечисления.ВариантыДействийПоРасхождениямВАктеПослеОтгрузки.ДопоставкаНеТребуется;
					Описание.СпособОтражения  = СпособОтраженияРасхождений;
				...
				ПараметрыПоиска.Вставить("ВариантДействияСТоваром", Перечисления.ВариантыДействийПоТоварамВАктеПослеОтгрузки.УчестьПриИнвентаризации);
				НайденныеСтроки = СтрокаДействия.ВариантыДействийСТоваром.НайтиСтроки(ПараметрыПоиска);
				Если НайденныеСтроки.Количество() > 0 И ЭтоПереходПраваСобственности Тогда
					...
					ВывестиИсправлениеОтгрузокТоваровКлиентуПриПереходеПраваСобственности(СтрокаДействия, Макет, Описание);
				...
				ПараметрыПоиска.Вставить("ВариантДействияСТоваром", Перечисления.ВариантыДействийПоТоварамВАктеПослеОтгрузки.УчестьПриИнвентаризации);
				НайденныеСтроки = СтрокаДействия.ВариантыДействийСТоваром.НайтиСтроки(ПараметрыПоиска);
				Если НайденныеСтроки.Количество() > 0 И СтрокаДействия.ПоЗаказам Тогда
		...
		Если СтрокаДействия.ВариантыДействий.НайтиПоЗначению(Перечисления.ВариантыДействийПоРасхождениямВАктеПослеОтгрузки.ОтгрузитьСейчас) <> Неопределено Тогда
			
			Если РасхожденияКлиентСервер.ТипОснованияРеализацияТоваровУслуг(ТипОснованияАктаОРасхождении) Тогда
				
				ПараметрыПоиска = Новый Структура;
				ПараметрыПоиска.Вставить("ВариантДействияСДокументом", Перечисления.ВариантыДействийПоРасхождениямВАктеПослеОтгрузки.ОтгрузитьСейчас);
				ПараметрыПоиска.Вставить("ВариантДействияСТоваром", Перечисления.ВариантыДействийПоТоварамВАктеПослеОтгрузки.Списать);
				НайденныеСтроки = СтрокаДействия.ВариантыДействийСТоваром.НайтиСтроки(ПараметрыПоиска);
				Если НайденныеСтроки.Количество() > 0 Тогда
					...
					Описание.АктОРасхождениях = АктОРасхождениях;
					Описание.ИмяКоманды       = "Оформить";
					Описание.ВариантДействия  = Перечисления.ВариантыДействийПоРасхождениямВАктеПослеОтгрузки.ОтгрузитьСейчас;
					Описание.СпособОтражения  = СпособОтраженияРасхождений;
		...
		Если СтрокаДействия.ВариантыДействий.НайтиПоЗначению(Перечисления.ВариантыДействийПоРасхождениямВАктеПослеОтгрузки.ВозвратПерепоставленного) <> Неопределено Тогда
			...
			Если РасхожденияКлиентСервер.ТипОснованияРеализацияТоваровУслуг(ТипОснованияАктаОРасхождении) Тогда
				...
				ПараметрыПоиска = Новый Структура;
				ПараметрыПоиска.Вставить("ВариантДействияСДокументом", Перечисления.ВариантыДействийПоРасхождениямВАктеПослеОтгрузки.ВозвратПерепоставленного);
				ПараметрыПоиска.Вставить("ВариантДействияСТоваром", Перечисления.ВариантыДействийПоТоварамВАктеПослеОтгрузки.УчестьПриИнвентаризации);
				НайденныеСтроки = СтрокаДействия.ВариантыДействийСТоваром.НайтиСтроки(ПараметрыПоиска);
				Если НайденныеСтроки.Количество() > 0 И ЭтоПереходПраваСобственности Тогда
				...
				ПараметрыПоиска = Новый Структура;
				ПараметрыПоиска.Вставить("ВариантДействияСДокументом", Перечисления.ВариантыДействийПоРасхождениямВАктеПослеОтгрузки.ВозвратПерепоставленного);
				ПараметрыПоиска.Вставить("ВариантДействияСТоваром", Перечисления.ВариантыДействийПоТоварамВАктеПослеОтгрузки.ОприходоватьВПуть);
				НайденныеСтроки = СтрокаДействия.ВариантыДействийСТоваром.НайтиСтроки(ПараметрыПоиска);
				Если НайденныеСтроки.Количество() > 0 Тогда
					...
					ВывестиОприходованиеИзлишковОтгруженныхТоваров(СтрокаДействия, Макет, Описание);
				...
				Если ЭтоПереходПраваСобственности Тогда
					...
					Описание.Вставить("ИмяКоманды", "Оформить");
					Описание.Вставить("ВариантДействия", Перечисления.ВариантыДействийПоРасхождениямВАктеПослеОтгрузки.ВозвратПерепоставленного);
					Описание.Вставить("СпособОтражения", Перечисления.СпособыОтраженияРасхожденийАктПриемкиКлиента.ОформлениеКорректировкиКакИсправлениеПервичныхДокументов);
					...
					ВывестиДокументКорректировкаРеализацииВернутьВПуть(
						СтрокаДействия,
						ВидКорректировки,
						Макет,
						Описание);
		...
		Если СтрокаДействия.ВариантыДействий.НайтиПоЗначению(Перечисления.ВариантыДействийПоРасхождениямВАктеПослеОтгрузки.ПокупкаПерепоставленного) <> Неопределено Тогда
			...
			Если РасхожденияКлиентСервер.ТипОснованияРеализацияТоваровУслуг(ТипОснованияАктаОРасхождении) Тогда
				...
				ПараметрыПоиска = Новый Структура;
				ПараметрыПоиска.Вставить("ВариантДействияСДокументом", Перечисления.ВариантыДействийПоРасхождениямВАктеПослеОтгрузки.ПокупкаПерепоставленного);
				ПараметрыПоиска.Вставить("ВариантДействияСТоваром", Перечисления.ВариантыДействийПоТоварамВАктеПослеОтгрузки.ОприходоватьВПуть);
				НайденныеСтроки = СтрокаДействия.ВариантыДействийСТоваром.НайтиСтроки(ПараметрыПоиска);
				Если НайденныеСтроки.Количество() > 0 Тогда
	...
	ИначеЕсли СпособОтраженияРасхождений = Перечисления.СпособыОтраженияРасхожденийАктПриемкиКлиента.ОформлениеКорректировкиКакИсправлениеПервичныхДокументов
		...
		Если СтрокаДействия.ВариантыДействий.НайтиПоЗначению(Перечисления.ВариантыДействийПоРасхождениямВАктеПослеОтгрузки.ВозвратПерепоставленного) <> Неопределено Тогда
			...
			ИначеЕсли РасхожденияКлиентСервер.ТипОснованияОтгрузкаТоваровКлиенту(ТипОснованияАктаОРасхождении) Тогда
				...
				Если НайденныеСтроки.Количество() > 0 Тогда
					...
					Описание.Вставить("ВариантДействия", Перечисления.ВариантыДействийПоРасхождениямВАктеПослеОтгрузки.ВозвратПерепоставленного);
					Описание.Вставить("СпособОтражения", СпособОтраженияРасхождений);
					Описание.Вставить("Исправление", Истина);
					
					ВывестиИсправлениеОтгрузкаТоваровКлиенту(СтрокаДействия.Основание, Макет, Описание, ИспользоватьИсправлениеДокументов);
			...
			ИначеЕсли СпособОтраженияРасхождений = Перечисления.СпособыОтраженияРасхожденийАктПриемкиКлиента.ОформлениеКорректировкиКакИсправлениеПервичныхДокументов
				И РасхожденияКлиентСервер.ТипОснованияПередачаТоваровХранителю(ТипОснованияАктаОРасхождении) Тогда
				
				// +Исправление документа "ПередачаТоваровХранителю" (КомандаГиперссылка).
				// +Выводим команду на создание исправления, по которой увеличиваем накладную сверх заказа (КомандаГиперссылка).
				// +Если есть заявки на возврат, то оформление заявки  на возврат перепоставленного (КомандаГиперссылка).
				// +Если нет заявок на возврат , то оформление возврата перепоставленного. (КомандаГиперссылка).
				Описание = Новый Структура;
				Описание.Вставить("ОснованиеАкта",    СтрокаДействия.Основание);
				...
				ВывестиДокументИсправлениеПередачаТоваровХранителю(СтрокаДействия, Макет, Описание);
			...
			ИначеЕсли СпособОтраженияРасхождений = Перечисления.СпособыОтраженияРасхожденийАктПриемкиКлиента.ОформлениеКорректировкиКакИсправлениеПервичныхДокументов
				И РасхожденияКлиентСервер.ТипОснованияПередачаНаКомиссию(ТипОснованияАктаОРасхождении) Тогда
			...
			ИначеЕсли СпособОтраженияРасхождений = Перечисления.СпособыОтраженияРасхожденийАктПриемкиКлиента.ОформлениеКорректировкиКакИсправлениеПервичныхДокументов
				И (РасхожденияКлиентСервер.ТипОснованияОтгрузкаТоваровСХранения(ТипОснованияАктаОРасхождении)
				Или Ложь) Тогда
				
				// +Исправление документа "ОтгрузкаТоваровСХранения" (КомандаГиперссылка).
				...
				ВывестиДокументИсправлениеОтгрузкаТоваровСХранения(СтрокаДействия, Макет, Описание);
		...
		Если СтрокаДействия.ВариантыДействий.НайтиПоЗначению(Перечисления.ВариантыДействийПоРасхождениямВАктеПослеОтгрузки.ДопоставкаНеТребуется) <> Неопределено Тогда
			...
			ИначеЕсли СпособОтраженияРасхождений = Перечисления.СпособыОтраженияРасхожденийАктПриемкиКлиента.ОформлениеКорректировкиКакИсправлениеПервичныхДокументов
				И (РасхожденияКлиентСервер.ТипОснованияПередачаТоваровХранителю(ТипОснованияАктаОРасхождении)
					Или РасхожденияКлиентСервер.ТипОснованияПередачаНаКомиссию(ТипОснованияАктаОРасхождении)) Тогда
				
				// +Исправление документа "ПередачаТоваровХранителю" (КомандаГиперссылка).
				// Если есть заказы:
				// +Выводим команду на создание исправления, по которой уменьшаем накладную (КомандаГиперссылка).
				// +Выводим заказ, в котором строки подлежат отмене. (КнопкаИзменений).
				// Если нет заказов:
				// +Выводим команду на создание исправления, по которой уменьшаем накладную. (КомандаГиперссылка).
				Описание = Новый Структура;
		...
		Если СтрокаДействия.ВариантыДействий.НайтиПоЗначению(Перечисления.ВариантыДействийПоРасхождениямВАктеПослеОтгрузки.ПокупкаПерепоставленного) <> Неопределено Тогда
			...
			Если РасхожденияКлиентСервер.ТипОснованияРеализацияТоваровУслуг(ТипОснованияАктаОРасхождении) Тогда
				...
				// +Документ "Отгрузка товаров клиенту (исправление) по выявленным расхождениям (КомандаГиперссылка)."
...
Процедура ВывестиСтрокиДействийПоАктуПослеПриемки(СтрокаДействия, Макет, ТипОснованияАктаОРасхождении, ПраваДоступаНаТаблицы)
	...
	ИначеЕсли ТипОснованияАктаОРасхождении = Перечисления.ТипыОснованияАктаОРасхождении.ПриемкаТоваровНаХранение
		...
		Если СтрокаДействия.ВариантыДействий.НайтиПоЗначению(Перечисления.ВариантыДействийПоРасхождениямВАктеПослеПриемки.ОформитьПерепоставленное) <> Неопределено
			...
			Если СпособОтраженияРасхождений = Перечисления.СпособыОтраженияАктовОРасхожденияПослеПоступления.ОформлениеКорректировокПоступления Тогда
				// Исправление документа "ПриемкаТоваровНаХранение" (КомандаГиперссылка).
				Описание.ИмяКоманды    = "Оформить";
				ВывестиДокументИсправлениеПриемкаТоваровНаХранение(СтрокаДействия, Макет, Описание);
			Иначе
				Описание.ИмяКоманды    = "Изменить";
	...
	ИначеЕсли РасхожденияКлиентСервер.ТипОснованияПоступлениеТоваровОтХранителя(ТипОснованияАктаОРасхождении) Тогда
		...
		Если СтрокаДействия.ВариантыДействий.НайтиПоЗначению(Перечисления.ВариантыДействийПоРасхождениямВАктеПослеПриемки.ОформитьПерепоставленное) <> Неопределено
			...
			Если СпособОтраженияРасхождений = Перечисления.СпособыОтраженияАктовОРасхожденияПослеПоступления.ОформлениеКорректировокПоступления Тогда
				// Исправление документа "ПоступлениеТоваровОтХранителя" (КомандаГиперссылка).
				Описание.ОснованиеАкта = СтрокаДействия.Основание;
				Описание.ИмяКоманды    = "Оформить";
				ВывестиДокументИсправлениеПоступлениеТоваровОтХранителя(СтрокаДействия, Макет, Описание);
			Иначе
				Описание.ОснованиеАкта = СтрокаДействия.Основание;
				Описание.ИмяКоманды    = "Изменить";
...
Процедура ВывестиДокументКорректировкаРеализации(СтрокаДействия, ХозяйственнаяОперация, Макет, Описание)
	...
	Если ОформленныеДокументы.Количество() = 0 Тогда
		...
		СтруктураКОформлению.Вставить("Реализация", Документы.КорректировкаРеализации.ПустаяСсылка());
		СтруктураКОформлению.Вставить("ХозяйственнаяОперация", ХозяйственнаяОперация);
...
&НаСервере
Процедура ВывестиДокументКорректировкаРеализацииВернутьВПуть(СтрокаДействия, ХозяйственнаяОперация, Макет, Описание)
	
	Если НеВыводитьВОтчет("ВывестиДокументКорректировкаРеализацииВернутьВПуть", СтрокаДействия.Основание) Тогда
		Возврат;
	КонецЕсли;
	...
	ОформленныеДокументы = РеализацииКорректировкиВернутьВПуть.НайтиСтроки(СтруктураПоиска);
	...
	Если ОформленныеДокументы.Количество() = 0 Тогда
		...
		СтруктураКОформлению.Вставить("Реализация", Документы.КорректировкаРеализации.ПустаяСсылка());
		СтруктураКОформлению.Вставить("ХозяйственнаяОперация", ХозяйственнаяОперация);
		СтруктураКОформлению.Вставить("ЭтоВозвратВПуть", Истина);
	...
	ВывестиДокументКОформлению(
		"КорректировкаРеализацииВернутьВПуть",
		2,
		Макет,
		МассивОформленныхДокументов,
		ХозяйственнаяОперация,,
...
&НаСервере
Процедура ВывестиИсправлениеОтгрузкаТоваровКлиенту(ОтгрузкаТоваровКлиенту,
														Макет,
														Описание,
														ИспользоватьИсправлениеДокументов = Ложь)
	
	Если НеВыводитьВОтчет("ВывестиИсправлениеОтгрузкаТоваровКлиенту", ОтгрузкаТоваровКлиенту) Тогда
		Возврат;
	КонецЕсли;
	...
	Если ИспользоватьИсправлениеДокументов Тогда 
		...
		ПараметрыПоиска = Новый Структура;
		ПараметрыПоиска.Вставить("Основание",   ОтгрузкаТоваровКлиенту);
		ПараметрыПоиска.Вставить("Исправление", Истина);
		ОформленныеДокументы = ОтгрузкиПоОтгрузкамТоваровКлиенту.НайтиСтроки(ПараметрыПоиска);
		
		Если ОформленныеДокументы.Количество() = 0 Тогда 

			ОформленныйДокумент = Новый Структура;
			ОформленныйДокумент.Вставить("ИсправляемыйДокумент", Документы.ОтгрузкаТоваровКлиенту.ПустаяСсылка());
			ОформленныйДокумент.Вставить("Исправление",          Истина);
			ОформленныйДокумент.Вставить("Допоставка",           Ложь);
		...
		Иначе
			...
			Для Каждого ОформленныйДокумент Из ОформленныеДокументы Цикл 
				МассивОформленныхДокументов.Добавить(ОформленныйДокумент.ОтгрузкаТоваровКлиенту);
			КонецЦикла;
		...
		ВывестиДокументКОформлению(
			"ИсправлениеОтгрузкаТоваровКлиенту",
			1,
			Макет,
			МассивОформленныхДокументов,
			,
	...
	Иначе
		...
		МассивОформленныхДокументов.Добавить(ОтгрузкаТоваровКлиенту);
		
		Описание.ИмяКоманды = "Изменить";
		
		ВывестиДокументКОформлению(
			"ИзменениеОтгрузкаТоваровКлиенту",
			1,
			Макет,
			МассивОформленныхДокументов,
			,
...
&НаСервере
Процедура ВывестиОприходованиеИзлишковОтгруженныхТоваров(СтрокаДействия, Макет, Описание)
	
	Если НеВыводитьВОтчет("ВывестиОприходованиеИзлишковОтгруженныхТоваров", СтрокаДействия.Основание) Тогда
		Возврат;
	КонецЕсли;
	...
	ПараметрыПоиска = Новый Структура;
	ПараметрыПоиска.Вставить("Основание", СтрокаДействия.Основание);
	ОформленныеДокументы = ОснованияОприходованияИзлишковОтгруженныхТоваров.НайтиСтроки(ПараметрыПоиска);
	
	Если ОформленныеДокументы.Количество() = 0 Тогда 
	
		МассивОформленныхДокументов.Добавить(Документы.ОприходованиеИзлишковОтгруженныхТоваров.ПустаяСсылка());
...
&НаСервере
Процедура ВывестиСписаниеТоваровОтгруженныхКлиенту(СтрокаДействия, Макет, Описание)
	
	УменьшитьОтгрузкуПоРаспоряжению =
		(Описание.ВариантДействия =
			Перечисления.ВариантыДействийПоРасхождениямВАктеПослеОтгрузки.ТребуетсяДопоставка
			И СтрокаДействия.ПоЗаказам);
	
	Если УменьшитьОтгрузкуПоРаспоряжению Тогда
		ИмяКоманды = "СписаниеТоваровОтгруженныхКлиентуИДопоставка";
	Иначе
		ИмяКоманды = "СписаниеТоваровОтгруженныхКлиентуБезДопоставки";
	КонецЕсли;
	...
	ПараметрыПоиска = Новый Структура;
	ПараметрыПоиска.Вставить("Основание", СтрокаДействия.Основание);
	ПараметрыПоиска.Вставить("УменьшитьОтгрузкуПоРаспоряжению", УменьшитьОтгрузкуПоРаспоряжению);
	ОформленныеДокументы = ОснованияСписанияТоваровОтгруженныхКлиенту.НайтиСтроки(ПараметрыПоиска);
	
	Если ОформленныеДокументы.Количество() = 0 Тогда 
		
		ОформленныйДокумент = Новый Структура;
		ОформленныйДокумент.Вставить("ОформляемыйДокумент", Документы.СписаниеОтгруженныхТоваров.ПустаяСсылка());
		ОформленныйДокумент.Вставить("УменьшитьОтгрузкуПоРаспоряжению", УменьшитьОтгрузкуПоРаспоряжению);
...
&НаСервере
Процедура ВывестиИсправлениеОтгрузокТоваровКлиентуПриПереходеПраваСобственности(СтрокаДействия, Макет, Описание)
	
	НеВыводитьВОтчет = НеВыводитьВОтчет(
		"ВывестиИсправлениеОтгрузокТоваровКлиентуПриПереходеПраваСобственности",
		СтрокаДействия.Основание);
	
	Если НеВыводитьВОтчет Тогда
		Возврат;
	КонецЕсли;
	
	МассивОформленныхДокументов =
		ОтгрузкиТоваровКлиентуПоПереходуПраваСобственности2_5.Выгрузить().ВыгрузитьКолонку("ОтгрузкаТоваровКлиенту");
...
&НаСервере
Процедура ВывестиОтгрузкаТоваровКлиентуНаДопоставкуНедопоставленногоТовара(СтрокаДействия, Макет, Описание)

	Если НеВыводитьВОтчет("ВывестиОтгрузкаТоваровКлиентуНаДопоставкуНедопоставленногоТовара",
		СтрокаДействия.Основание) Тогда
	...
	ПараметрыПоиска = Новый Структура;
	ПараметрыПоиска.Вставить("Основание",  СтрокаДействия.Основание);
	ПараметрыПоиска.Вставить("Допоставка", Истина);
	ОформленныеДокументы = ОтгрузкиПоОтгрузкамТоваровКлиенту.НайтиСтроки(ПараметрыПоиска);
	...
	Если ОформленныеДокументы.Количество() = 0 Тогда 
		...
		ОформленныйДокумент = Новый Структура;
		ОформленныйДокумент.Вставить("ИсправляемыйДокумент", Документы.ОтгрузкаТоваровКлиенту.ПустаяСсылка());
		ОформленныйДокумент.Вставить("Исправление",          Ложь);
		ОформленныйДокумент.Вставить("Допоставка",           Истина);
	...
	ВывестиДокументКОформлению(
		"ДопоставкаОтгрузкаТоваровКлиенту",
		2,
		Макет,
		МассивОформленныхДокументов,
		,
...
&НаСервере
Процедура ВывестиДокументПоступлениеТоваровОтКлиента(СтрокаДействия, Макет, Описание)
	...
	Если УменьшитьОтгрузкуПоРаспоряжению Тогда
		ИмяКоманды = "ПоступлениеТоваровОтКлиентаИДопоставка";
	Иначе
		ИмяКоманды = "ПоступлениеТоваровОтКлиентаБезДопоставки";
	КонецЕсли;
	...
	ПараметрыПоиска.Вставить("Основание", СтрокаДействия.Основание);
	ПараметрыПоиска.Вставить("УменьшитьОтгрузкуПоРаспоряжению", УменьшитьОтгрузкуПоРаспоряжению);
	ОформленныеДокументы = ОснованияПоступленийТоваровОтКлиента.НайтиСтроки(ПараметрыПоиска);
	
	Если ОформленныеДокументы.Количество() = 0 Тогда
		
		ОформленныйДокумент = Новый Структура;
		ОформленныйДокумент.Вставить("ОформляемыйДокумент", Документы.ПоступлениеТоваровОтКлиента.ПустаяСсылка());
		ОформленныйДокумент.Вставить("УменьшитьОтгрузкуПоРаспоряжению", УменьшитьОтгрузкуПоРаспоряжению);
	...
	Иначе
		...
		Для Каждого ОформленныйДокумент Из ОформленныеДокументы Цикл
			...
			МассивОформленныхДокументов.Добавить(ОформленныйДокумент.ПоступлениеТоваровОтКлиента);
...
Процедура ВывестиДокументДопоставкиПоПоступлениюНаСклад(СтрокаДействия, Макет, Описание)
	...
	Уровень = 1;
	ПриобретениеОснование = СтрокаДействия.Основание;
	
	Если ТипЗнч(ПриобретениеОснование) = Тип("ДокументСсылка.ПриобретениеТоваровУслуг") Тогда
		
		Реквизиты = ОбщегоНазначения.ЗначенияРеквизитовОбъекта(ПриобретениеОснование,
			"ПоступлениеПоЗаказам,ВариантПриемкиТоваров");
		
		Если (Не Реквизиты.ПоступлениеПоЗаказам
			И Реквизиты.ВариантПриемкиТоваров = Перечисления.ВариантыПриемкиТоваров.РазделенаПоЗаказамИНакладным)
			Или Реквизиты.ВариантПриемкиТоваров = Перечисления.ВариантыПриемкиТоваров.РазделенаТолькоПоНакладным Тогда
			
			Уровень = 2;
			ПриобретениеОснование = Неопределено;
			Если ПоступленияПоступления.Количество() > 0 Тогда
				ОтборПоПоступлению = Новый Структура;
				ОтборПоПоступлению.Вставить("ДопоставкаПоПоступлению", СтрокаДействия.Основание);
				ДанныеПоПоступлению = ПоступленияПоступления.НайтиСтроки(ОтборПоПоступлению);
				Если ДанныеПоПоступлению.Количество() = 1 Тогда
					ПриобретениеОснование = ДанныеПоПоступлению[0].ОформленноеПоступление;
				КонецЕсли;
			КонецЕсли;
			Описание.ОснованиеАкта = ПриобретениеОснование;
	...
	Для Каждого СкладПоступления Из МассивСкладовПоступления Цикл
		...
		Если ПриобретениеОснование = Неопределено Тогда
			Описание.ИмяКоманды = "ОжидатьОформлениеПриобретения";
		КонецЕсли;
...
Процедура ВывестиДокументДоВозвратаПоПоступлениюОтХранителя(СтрокаДействия, Макет, Описание)
	...
	Если ОформленныеДокументы.Количество() = 0 Тогда
		Если Описание.СпособОтражения = Перечисления.СпособыОтраженияАктовОРасхожденияПослеПоступления.ОформлениеКорректировокПоступления Тогда
			ОписаниеОформляемогоДокумента = Новый Структура;
			ОписаниеОформляемогоДокумента.Вставить("ОформляемыйДокумент", Документы.ПоступлениеТоваровОтХранителя.ПустаяСсылка());
			ОписаниеОформляемогоДокумента.Вставить("Исправление",         Ложь);
			ОписаниеОформляемогоДокумента.Вставить("ЕстьИсправление",     ЗначениеЗаполнено(ДокументИсправление));
			ОписаниеОформляемогоДокумента.Вставить("ДокументИсправление", ДокументИсправление);
...
Процедура ВывестиИсправлениеДокументаЗаказ(СтрокаДействия, Макет, Описание)
	...
	Если ТипЗнч(СтрокаДействия.Основание) = Тип("ДокументСсылка.ОтгрузкаТоваровКлиенту") Тогда

		ОформленныеДокументы = ОтгрузкиТоваровКлиентуЗаказы.НайтиСтроки(
			Новый Структура("ОтгрузкаТоваровКлиенту", СтрокаДействия.Основание));
...
&НаСервере
Процедура ВывестиДокументСписаниеНедостачТоваровРеализацияТоваровУслуг(СтрокаДействия, Макет, Описание)
	
	Если НеВыводитьВОтчет("ВывестиДокументСписаниеНедостачТоваровРеализацияТоваровУслуг", СтрокаДействия.Основание) Тогда
		Возврат;
	КонецЕсли;
	...
	НайденныеСтроки = СтрокаДействия.ДействияСклады.НайтиСтроки(ПараметрыПоиска);
	МассивСкладовСписания  = Новый Массив;
	Для Каждого СтрокаСоСписанием Из НайденныеСтроки Цикл
	
		Если ЗначениеЗаполнено(СтрокаСоСписанием.Склад)
			И МассивСкладовСписания.Найти(СтрокаСоСписанием.Склад) = Неопределено Тогда
			МассивСкладовСписания.Добавить(СтрокаСоСписанием.Склад);
		КонецЕсли;
	...
	Для Каждого СкладСписания Из МассивСкладовСписания Цикл
		...
		ПараметрыПоиска = Новый Структура;
		ПараметрыПоиска.Вставить("Основание", СтрокаДействия.Основание);
		ПараметрыПоиска.Вставить("Склад",     СкладСписания);
		
		ОформленныеДокументы = ОснованияСписанияНедостачПоДокументамОтгрузки.НайтиСтроки(ПараметрыПоиска);
		
		Если ОформленныеДокументы.Количество() = 0 Тогда
			
			Структура = Новый Структура;
			Структура.Вставить("ОформляемыйДокумент", Документы.СписаниеНедостачТоваров.ПустаяСсылка());
			Структура.Вставить("Склад",               СкладСписания);
			
			МассивОформленныхДокументов.Добавить(Структура);
...
Процедура ВывестиДокументКОформлению(ВидДокумента, Уровень, Макет,
	...
	Если Описание <> Неопределено Тогда
		...
		ИначеЕсли Описание.ИмяКоманды = "ОжидатьОформлениеПриобретения" Тогда
			
			ЦветНадписи = ЦветаСтиля.ПоясняющийОшибкуТекст;
			ТекстГиперссылки = НСтр("ru = 'Предварительно необходимо оформить приобретение.'");
		...
		Если (ВыведеныОформленныеДокументы И Описание.ИмяКоманды = "Изменить")
			...
			Или Описание.ИмяКоманды = "Подтвердить"
			Или Описание.ИмяКоманды = "ОжидатьОформлениеПриобретения" Тогда
...
Функция ТекстШапки(ТипДокумента, Описание , ХозяйственнаяОперация = Неопределено)
	...
	Если ТипДокумента = "КорректировкаРеализации" Тогда
		...
		КонецЕсли;
	ИначеЕсли ТипДокумента = "КорректировкаРеализацииВернутьВПуть" Тогда
		ТекстШапки = НСтр("ru = 'Документ ""Корректировка реализации"" для возврата ""в путь""'");
	...
	ИначеЕсли ТипДокумента = "ИзменениеОтгрузкаТоваровКлиенту" Тогда 
		ТекстШапки = НСтр("ru = 'Отразить расхождения в документе ""Отгрузка товаров клиенту""'");
	ИначеЕсли ТипДокумента = "ИсправлениеОтгрузкаТоваровКлиенту" Тогда 
		ТекстШапки = НСтр("ru = 'Документ ""Отгрузка товаров клиенту (исправление)""'");
	ИначеЕсли ТипДокумента = "ДопоставкаОтгрузкаТоваровКлиенту" Тогда 
		ТекстШапки = НСтр("ru = 'Документ ""Отгрузка товаров клиенту"" для отгрузки недопоставленного товара'");
	ИначеЕсли ТипДокумента = "ОприходованиеИзлишковОтгруженныхТоваров" Тогда
		ТекстШапки = НСтр("ru = 'Документ ""Оприходование излишков отгруженных товаров"" для оприходования ""в путь""'");
	ИначеЕсли ТипДокумента = "СписаниеТоваровОтгруженныхКлиентуБезДопоставки" Тогда
		ТекстШапки = НСтр("ru = 'Документ ""Списание товаров, отгруженных клиенту"" (списанные товары не отгружать) для списания ""из пути""'");
	ИначеЕсли ТипДокумента = "СписаниеТоваровОтгруженныхКлиентуИДопоставка" Тогда
		ТекстШапки = НСтр("ru = 'Документ ""Списание товаров, отгруженных клиенту"" (списанные товары отгрузить вновь) для списания ""из пути""'");
	...
	ИначеЕсли ТипДокумента = "ОтгрузкаТоваровСХранения" Тогда
		...
		ПредставлениеОперации = НСтр("ru = 'довозврата недовозращенного товара'");
		
			ПредставлениеОбъекта = НСтр("ru = 'Отгрузка товаров с хранения'");
		
		ТекстШапки = СтрШаблон(НСтр("ru = 'Документ ""%1"" для %2'"), ПредставлениеОбъекта, ПредставлениеОперации);
	...
	ИначеЕсли ТипДокумента = "ДокументИсправлениеОтгрузкаТоваровСХранения" Тогда
			ПредставлениеОбъекта = НСтр("ru = 'Отгрузка товаров с хранения'");
		ТекстШапки = СтрШаблон(НСтр("ru = 'Документ ""%1"" (исправление)'"), ПредставлениеОбъекта);
	...
	ИначеЕсли ТипДокумента = "ИсправлениеВозвратаТоваровОтХранителя" Тогда
		...
		ТекстШапки = СтрШаблон(НСтр("ru = 'Отразить расхождения в документе ""%1""'"), Обработчик.ПредставлениеОбъекта());
	ИначеЕсли ТипДокумента = "ДокументИсправлениеПоступлениеТоваровОтХранителя" Тогда
		Обработчик = Документы.ПоступлениеТоваровОтХранителя.ОбработчикДействий(ХозяйственнаяОперацияАкта);
		ТекстШапки = СтрШаблон(НСтр("ru = 'Документ ""%1"" (исправление)'"), Обработчик.ПредставлениеОбъекта());
	ИначеЕсли ТипДокумента = "ДокументИсправлениеПриемкаТоваровНаХранение" Тогда
			ПредставлениеОбъекта = НСтр("ru = 'Приемка товаров на хранение'");
		ТекстШапки = СтрШаблон(НСтр("ru = 'Документ ""%1"" (исправление)'"), ПредставлениеОбъекта);
	...
	ИначеЕсли ТипДокумента = "ДокументИсправлениеПередачаТоваровХранителю" Тогда
		Обработчик = Документы.ПередачаТоваровХранителю.ОбработчикДействий(ХозяйственнаяОперацияАкта);
		ТекстШапки = СтрШаблон(НСтр("ru = 'Документ ""%1"" (исправление)'"), Обработчик.ПредставлениеОбъекта());
	...
	ИначеЕсли ТипДокумента = "ДокументВозврата" Тогда
		...
		КонецЕсли;
	ИначеЕсли ТипДокумента = "ПоступлениеТоваровОтКлиентаБезДопоставки" Тогда
		ТекстШапки = НСтр("ru = 'Документ ""Поступление товаров от клиента"" (поступившие товары не отгружать) для возврата ""из пути""'");
	ИначеЕсли ТипДокумента = "ПоступлениеТоваровОтКлиентаИДопоставка" Тогда
		ТекстШапки = НСтр("ru = 'Документ ""Поступление товаров от клиента"" (поступившие товары отгрузить вновь) для возврата ""из пути""'");
...
Функция ТекстЛегенды(ТипДокумента, ХозяйственнаяОперация = Неопределено)
	...
	Если ТипДокумента = "КорректировкаРеализации" Тогда
		...
		КонецЕсли;
	ИначеЕсли ТипДокумента = "КорректировкаРеализацииВернутьВПуть" Тогда
		Возврат НСтр("ru = 'Необходимо оформить документ ""Корректировка реализации"" по излишкам, отмеченным к возврату клиентом. Оформляется на строки акта о расхождениях с вариантом отработки ""Оформить и вернуть"".'");
	ИначеЕсли ТипДокумента = "КорректировкаПриобретения" Тогда
	...
	ИначеЕсли ТипДокумента = "ИсправлениеРеализации" Тогда
		Возврат НСтр("ru = 'Необходимо скорректировать документ ""Реализация товаров и услуг"", отразив в нем количество по факту. Следует выполнить для строк акта о расхождениях с вариантами отработки: ""Оформить и вернуть"", ""Оформить"" и ""Оформить и допоставить"".'");
	ИначеЕсли ТипДокумента = "ИзменениеОтгрузкаТоваровКлиенту" Тогда
		Возврат НСтр("ru = 'Необходимо скорректировать документ ""Отгрузка товаров клиенту"", отразив в нем количество по факту. Следует выполнить для строк акта о расхождениях с вариантами отработки: ""Оформить и вернуть"", ""Оформить"" и ""Оформить и допоставить"".'");
	ИначеЕсли ТипДокумента = "ИсправлениеОтгрузкаТоваровКлиенту" Тогда
		Возврат НСтр("ru = 'Необходимо оформить документ ""Отгрузка товаров клиенту (исправление)"", отразив в нем количество по факту. Следует выполнить для строк акта о расхождениях с вариантами отработки: ""Оформить и вернуть"", ""Оформить"" и ""Оформить и допоставить"".'");
	ИначеЕсли ТипДокумента = "ДопоставкаОтгрузкаТоваровКлиенту" Тогда 
		Возврат НСтр("ru = 'Необходимо оформить документ ""Отгрузка товаров клиенту"" по недостачам, отмеченным к допоставке клиенту. Оформляется на строки акта о расхождениях с вариантом отработки ""Оформить и допоставить"".'");
	ИначеЕсли ТипДокумента = "ОприходованиеИзлишковОтгруженныхТоваров" Тогда
		Возврат НСтр("ru = 'Необходимо оформить документ ""Оприходование излишков отгруженных товаров"" по излишкам, отмеченным к оприходованию ""в путь"". Оформляется на строки акта о расхождениях с вариантом отработки ""Оприходовать ""в путь"""".'");
	ИначеЕсли ТипДокумента = "СписаниеТоваровОтгруженныхКлиентуБезДопоставки" Тогда
		Возврат НСтр("ru = 'Необходимо оформить документ ""Списание товаров, отгруженных клиенту"" по недостачам, отмеченным к списанию ""из пути"". Оформляется на строки акта о расхождениях с вариантом отработки ""Списать из ""пути"""".'");
	ИначеЕсли ТипДокумента = "СписаниеТоваровОтгруженныхКлиентуИДопоставка" Тогда
		Возврат НСтр("ru = 'Необходимо оформить документ ""Списание товаров, отгруженных клиенту"" по недостачам, отмеченным к списанию ""из пути"". Оформляется на строки акта о расхождениях с вариантом отработки ""Списать из ""пути"""".'");
	ИначеЕсли ТипДокумента = "ИсправлениеВозвратаТоваровПоставщику" Тогда
	...
	ИначеЕсли ТипДокумента = "ДокументВозврата" Тогда
		...
		КонецЕсли;
	ИначеЕсли ТипДокумента = "ПоступлениеТоваровОтКлиентаБезДопоставки" Тогда
		Возврат НСтр("ru = 'Необходимо оформить документ ""Поступление товаров от клиента"" по расхождениям, отмеченным к возврату. Оформляется на строки акта о расхождениях с вариантом отработки ""Вернуть"", ""Оформить и вернуть"".'");
	ИначеЕсли ТипДокумента = "ПоступлениеТоваровОтКлиентаИДопоставка" Тогда
		Возврат НСтр("ru = 'Необходимо оформить документ ""Поступление товаров от клиента"" по расхождениям, отмеченным к возврату. Оформляется на строки акта о расхождениях с вариантом отработки ""Вернуть"", ""Оформить и вернуть"".'");
	ИначеЕсли ТипДокумента = "ДокументВозвратаПередачи" Тогда
		Если ИспользоватьЗаявкиНаВозврат
	...
	ИначеЕсли ТипДокумента = "ДокументИсправлениеОтгрузкаТоваровСХранения" Тогда
			ПредставлениеОбъекта = НСтр("ru = 'Отгрузка товаров с хранения'");
		Возврат СтрШаблон(НСтр("ru = 'Необходимо оформить исправление документа ""%1"".'"), ПредставлениеОбъекта);
	ИначеЕсли ТипДокумента = "ОтгрузкаТоваровСХраненияПоПриемке" Тогда
			ПредставлениеОбъекта    = НСтр("ru = 'Отгрузка товаров с хранения'");
			ПредставлениеПоставщика = НСтр("ru = 'поставщику'");
	...
	ИначеЕсли ТипДокумента = "ДокументИсправлениеПоступлениеТоваровОтХранителя" Тогда
		Обработчик = Документы.ПоступлениеТоваровОтХранителя.ОбработчикДействий(ХозяйственнаяОперацияАкта);
		Возврат СтрШаблон(НСтр("ru = 'Необходимо оформить исправление документа ""%1"".'"), Обработчик.ПредставлениеОбъекта());
	ИначеЕсли ТипДокумента = "ДокументИсправлениеПриемкаТоваровНаХранение" Тогда
			ПредставлениеОбъекта = НСтр("ru = 'Приемка товаров на хранение'");
		Возврат СтрШаблон(НСтр("ru = 'Необходимо оформить исправление документа ""%1"".'"), ПредставлениеОбъекта);
	ИначеЕсли ТипДокумента = "ВозвратТоваровОтХранителяДовозврат" Тогда
...
Функция ТекстЗапросаАктОРасхожденияхПослеОтгрузкиТоваровСХранения()
	...
	|////////////////////////////////////////////////////////////////////////////////4
	|ВЫБРАТЬ РАЗРЕШЕННЫЕ РАЗЛИЧНЫЕ
	|	Действия.ОтгрузкаТоваровСХранения КАК ОтгрузкаТоваровСХранения,
	|	Документ.Ссылка КАК ОтгрузкаТоваровСХраненияИсправление
	|ИЗ
	|	Действия КАК Действия
	|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ Документ.ОтгрузкаТоваровСХранения КАК Документ
	|		ПО Документ.Проведен
	|			И (Действия.ОтгрузкаТоваровСХранения = Документ.ИсправляемыйДокумент
	|				ИЛИ (Действия.ОтгрузкаТоваровСХранения = Документ.СторнируемыйДокумент
	|					И Действия.ОтгрузкаТоваровСХранения.ИсправляемыйДокумент = Документ.ИсправляемыйДокумент))";
...
Функция ТекстЗапросаАктОРасхожденияхПослеПриемкиТоваровНаХранение(ПраваДоступаНаТаблицы, СоответствиеНаборовДанных)
	...
	Если ПраваДоступаНаТаблицы.ЧтениеПриемкаТоваровНаХранение Тогда
		...
		ТекстЗапроса = ТекстЗапроса + "
		|ВЫБРАТЬ РАЗРЕШЕННЫЕ РАЗЛИЧНЫЕ
		|	Действия.Основание              КАК Поступление,
		|	ПриемкаТоваровНаХранение.Ссылка КАК ПоступлениеИсправление
		|ИЗ
		|	Действия КАК Действия
		|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ Документ.ПриемкаТоваровНаХранение КАК ПриемкаТоваровНаХранение
		|		ПО ПриемкаТоваровНаХранение.Проведен
		|			И (Действия.Основание = ПриемкаТоваровНаХранение.ИсправляемыйДокумент
		|				ИЛИ (Действия.Основание = ПриемкаТоваровНаХранение.СторнируемыйДокумент
		|					И Действия.Основание.ИсправляемыйДокумент = ПриемкаТоваровНаХранение.ИсправляемыйДокумент))";
		
		СоответствиеНаборовДанных.Вставить("ПоступленияИсправления", ТекущийНомер);
	...
	Если ПраваДоступаНаТаблицы.ЧтениеОприходованиеИзлишковТоваров Тогда
		...
		|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ Документ.ОприходованиеИзлишковТоваров КАК ОприходованиеИзлишковТоваров
		|		ПО ОприходованиеИзлишковТоваров.Проведен
		|			И ОприходованиеИзлишковТоваров.Основание = &АктОРасхождениях
...
Функция ТекстЗапросаАктОРасхожденияхПослеВозвратаОтХранителя(ПраваДоступаНаТаблицы, СоответствиеНаборовДанных)
	...
	Если ПраваДоступаНаТаблицы.ЧтениеПоступлениеТоваровОтХранителя Тогда
		...
		|ВЫБРАТЬ РАЗРЕШЕННЫЕ РАЗЛИЧНЫЕ
		|	Действия.Основание            КАК Поступление,
		|	ПоступлениеОтХранителя.Ссылка КАК ПоступлениеИсправление
		|ИЗ
		|	Действия КАК Действия
		|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ Документ.ПоступлениеТоваровОтХранителя КАК ПоступлениеОтХранителя
		|		ПО ПоступлениеОтХранителя.Проведен
		|			И (Действия.Основание = ПоступлениеОтХранителя.ИсправляемыйДокумент
		|				ИЛИ (Действия.Основание = ПоступлениеОтХранителя.СторнируемыйДокумент
		|					И Действия.Основание.ИсправляемыйДокумент = ПоступлениеОтХранителя.ИсправляемыйДокумент))";
...
&НаСервере
Процедура ВывестиДокументИсправлениеОтгрузкаТоваровСХранения(СтрокаДействия, Макет, Описание)
	
	Если НеВыводитьВОтчет("ВывестиДокументИсправлениеОтгрузкаТоваровСХранения", СтрокаДействия.Основание) Тогда
		Возврат;
	КонецЕсли;
	
	МассивОформленныхДокументов = Новый Массив;
	
	ОформленныеДокументы = ИсправленияПоОтгрузкамТоваровСХранения.НайтиСтроки(
		Новый Структура("ОтгрузкаТоваровСХранения", СтрокаДействия.Основание));
	Если ОформленныеДокументы.Количество() = 0 Тогда
		
		ОписаниеОформляемогоДокумента = Новый Структура("ОформляемыйДокумент, Склад, Исправление",
			СтрокаДействия.Основание,
	...
	Иначе
		...
		Для Каждого ОформленныйДокумент Из ОформленныеДокументы Цикл
			ДокументИсправление = ОформленныйДокумент.ОтгрузкаТоваровСХраненияИсправление;
			МассивОформленныхДокументов.Добавить(ОформленныйДокумент.ОтгрузкаТоваровСХраненияИсправление);
		КонецЦикла;
		
	КонецЕсли;
	
	ВывестиДокументКОформлению(
		"ДокументИсправлениеОтгрузкаТоваровСХранения",
		1,
		Макет,
		МассивОформленныхДокументов,
		ХозяйственнаяОперацияАкта,
...
Процедура ВывестиДокументПриемкаТоваровНаХранение(СтрокаДействия, Макет, Описание)
	...
	Если ОформленныеДокументы.Количество() = 0 Тогда
		Если Описание.СпособОтражения = Перечисления.СпособыОтраженияРасхожденийАктПриемкиКлиента.ОформлениеКорректировкиКакИсправлениеПервичныхДокументов Тогда
			ОписаниеОформляемогоДокумента = Новый Структура;
			ОписаниеОформляемогоДокумента.Вставить("ОформляемыйДокумент", Документы.ПриемкаТоваровНаХранение.ПустаяСсылка());
			ОписаниеОформляемогоДокумента.Вставить("Исправление",         Ложь);
			ОписаниеОформляемогоДокумента.Вставить("ЕстьИсправление",     ЗначениеЗаполнено(ДокументИсправление));
			ОписаниеОформляемогоДокумента.Вставить("ДокументИсправление", ДокументИсправление);
			МассивОформленныхДокументов.Добавить(ОписаниеОформляемогоДокумента);
...
Процедура ВывестиДокументОтгрузкаТоваровСХраненияДляВозвратаНедопоставленногоТовара(СтрокаДействия, Макет, Описание)
	...
	Если ОформленныеДокументы.Количество() = 0 Тогда
		Если Описание.СпособОтражения = Перечисления.СпособыОтраженияРасхожденийАктПриемкиКлиента.ОформлениеКорректировкиКакИсправлениеПервичныхДокументов Тогда
			ОписаниеОформляемогоДокумента = Новый Структура;
			ОписаниеОформляемогоДокумента.Вставить("ОформляемыйДокумент", Документы.ОтгрузкаТоваровСХранения.ПустаяСсылка());
			ОписаниеОформляемогоДокумента.Вставить("Склад",               Справочники.Склады.ПустаяСсылка());
			ОписаниеОформляемогоДокумента.Вставить("Исправление",         Ложь);
			ОписаниеОформляемогоДокумента.Вставить("ЕстьИсправление",     Истина);
			ОписаниеОформляемогоДокумента.Вставить("ДокументИсправление", ДокументИсправление);
			МассивОформленныхДокументов.Добавить(ОписаниеОформляемогоДокумента);
		Иначе
...
Процедура ВывестиДокументПередачиНаДопоставкуНедопоставленногоТовара(СтрокаДействия, Макет, Описание)
	...
	Если ОформленныеДокументы.Количество() = 0 Тогда
		Если Описание.СпособОтражения = Перечисления.СпособыОтраженияРасхожденийАктПриемкиКлиента.ОформлениеКорректировкиКакИсправлениеПервичныхДокументов Тогда
			ОписаниеОформляемогоДокумента = Новый Структура;
			ОписаниеОформляемогоДокумента.Вставить("ОформляемыйДокумент",   Документы.ПередачаТоваровХранителю.ПустаяСсылка());
			ОписаниеОформляемогоДокумента.Вставить("ХозяйственнаяОперация", Перечисления.ХозяйственныеОперации.ПустаяСсылка());
			ОписаниеОформляемогоДокумента.Вставить("Исправление",           Ложь);
			ОписаниеОформляемогоДокумента.Вставить("ЕстьИсправление",       ЗначениеЗаполнено(ДокументИсправление));
			ОписаниеОформляемогоДокумента.Вставить("ДокументИсправление",   ДокументИсправление);
			МассивОформленныхДокументов.Добавить(ОписаниеОформляемогоДокумента);
...
Процедура СформироватьДокументыОтгрузкиТоваровСХранения(СтрокаДействия, Макет, ОформляемыеДокументыПоАкту, Описание)
	...
	Для Каждого СкладОтгрузки Из МассивСкладовВозврата Цикл
		...
		Если ОформленныеДокументы.Количество() = 0 Тогда
			ОписаниеОформляемогоДокумента = Новый Структура;
			ОписаниеОформляемогоДокумента.Вставить("ОформляемыйДокумент", Документы.ОтгрузкаТоваровСХранения.ПустаяСсылка());
			ОписаниеОформляемогоДокумента.Вставить("Склад",               СкладОтгрузки);
			ОписаниеОформляемогоДокумента.Вставить("Исправление",         Ложь);
			Если Описание.СпособОтражения = Перечисления.СпособыОтраженияАктовОРасхожденияПослеПоступления.ОформлениеКорректировокПоступления Тогда
				ОписаниеОформляемогоДокумента.Вставить("ЕстьИсправление",     ЗначениеЗаполнено(ДокументИсправление));
				ОписаниеОформляемогоДокумента.Вставить("ДокументИсправление", ДокументИсправление);
			Иначе
				ОписаниеОформляемогоДокумента.Вставить("ЕстьИсправление", Ложь);
			КонецЕсли;
			МассивОформленныхДокументов.Добавить(ОписаниеОформляемогоДокумента);
		Иначе
			Для Каждого ОформленныйДокумент Из ОформленныеДокументы Цикл
...
&НаСервере
Функция ТекстЗапросаАктОРасхожденияхПослеПередачиТоваровХранителю(ПраваДоступаНаТаблицы, СоответствиеНаборовДанных)
	...
	|//////////////////////////////////////////////////////////////////////////////// 5
	|ВЫБРАТЬ РАЗРЕШЕННЫЕ РАЗЛИЧНЫЕ
	|	Действия.Передача КАК Передача,
	|	ИсправлениеПередачиТоваров.Ссылка КАК ПередачаИсправление
	|ИЗ
	|	Действия КАК Действия
	|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ Документ.ПередачаТоваровХранителю КАК ИсправлениеПередачиТоваров
	|		ПО ИсправлениеПередачиТоваров.Проведен
	|			И (Действия.Передача = ИсправлениеПередачиТоваров.ИсправляемыйДокумент
	|				ИЛИ (Действия.Передача = ИсправлениеПередачиТоваров.СторнируемыйДокумент
	|					И Действия.Передача.ИсправляемыйДокумент = ИсправлениеПередачиТоваров.ИсправляемыйДокумент))
	|";
	...
	Если ПраваДоступаНаТаблицы.ЧтениеСписаниеНедостачТоваров Тогда
		...
		|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ Документ.СписаниеНедостачТоваров КАК СписаниеНедостачТоваров
		|		ПО (СписаниеНедостачТоваров.Проведен)
		|			И Действия.Передача = СписаниеНедостачТоваров.ОснованиеАктаОРасхождениях
		|			И Действия.Склад = СписаниеНедостачТоваров.Склад
		|";
...
Процедура ВывестиДокументВозвратаПоПередаче(СтрокаДействия, Макет, Описание)
	...
	Если ОформленныеДокументы.Количество() = 0 Тогда
		...
		Если Описание.СпособОтражения = Перечисления.СпособыОтраженияРасхожденийАктПриемкиКлиента.ОформлениеКорректировкиКакИсправлениеПервичныхДокументов Тогда
			Если ДобавитьЗаявкиНаВозврат Тогда
				ОписаниеОформляемогоДокумента = Новый Структура;
				ОписаниеОформляемогоДокумента.Вставить("ОформляемыйДокумент", Документы.ЗаявкаНаВозвратТоваровОтКлиента.ПустаяСсылка());
				ОписаниеОформляемогоДокумента.Вставить("ЕстьИсправление",     ЗначениеЗаполнено(ДокументИсправление));
				ОписаниеОформляемогоДокумента.Вставить("ДокументИсправление", ДокументИсправление);
				МассивОформленныхДокументов.Добавить(ОписаниеОформляемогоДокумента);
			Иначе
...
&НаСервере
Процедура ВывестиДокументИсправлениеПоступлениеТоваровОтХранителя(СтрокаДействия, Макет, Описание)
	
	Если НеВыводитьВОтчет("ВывестиДокументИсправлениеПоступлениеТоваровОтХранителя", СтрокаДействия.Основание) Тогда
		Возврат;
	КонецЕсли;
	
	МассивОформленныхДокументов = Новый Массив;
	
	ОформленныеДокументы = ПоступленияИсправления.НайтиСтроки(
		Новый Структура("Поступление", СтрокаДействия.Основание));
	Если ОформленныеДокументы.Количество() = 0 Тогда
		
		ОписаниеОформляемогоДокумента = Новый Структура("ОформляемыйДокумент, Исправление",
			СтрокаДействия.Основание,
			Истина);
		МассивОформленныхДокументов.Добавить(ОписаниеОформляемогоДокумента);
	...
	Иначе
		...
		Для Каждого ОформленныйДокумент Из ОформленныеДокументы Цикл
			ДокументИсправление = ОформленныйДокумент.ПоступлениеИсправление;
			МассивОформленныхДокументов.Добавить(ОформленныйДокумент.ПоступлениеИсправление);
		КонецЦикла;
		
	КонецЕсли;
	
	ВывестиДокументКОформлению(
		"ДокументИсправлениеПоступлениеТоваровОтХранителя",
		1,
		Макет,
		МассивОформленныхДокументов,,,
		Описание);
...
&НаСервере
Процедура ВывестиДокументИсправлениеПриемкаТоваровНаХранение(СтрокаДействия, Макет, Описание)
	
	Если НеВыводитьВОтчет("ВывестиДокументИсправлениеПриемкаТоваровНаХранение", СтрокаДействия.Основание) Тогда
		Возврат;
	КонецЕсли;
	...
	ВывестиДокументКОформлению(
		"ДокументИсправлениеПриемкаТоваровНаХранение",
		1,
		Макет,
		МассивОформленныхДокументов,,,
		Описание);
...
Процедура ВывестиДокументПередачаТоваровХранителю(СтрокаДействия, Макет, Описание)
	...
	Если ОформленныеДокументы.Количество() = 0 Тогда
		...
		ОписаниеОформляемогоДокумента = Новый Структура;
		ОписаниеОформляемогоДокумента.Вставить("ОформляемыйДокумент",     Документы.ПередачаТоваровХранителю.ПустаяСсылка());
		ОписаниеОформляемогоДокумента.Вставить("ХозяйственнаяОперация",   ОперацияДокумента);
		ОписаниеОформляемогоДокумента.Вставить("Исправление",             Ложь);
		Если Описание.СпособОтражения = Перечисления.СпособыОтраженияАктовОРасхожденияПослеПоступления.ОформлениеКорректировокПоступления Тогда
			ОписаниеОформляемогоДокумента.Вставить("ЕстьИсправление",     ЗначениеЗаполнено(ДокументИсправление));
			ОписаниеОформляемогоДокумента.Вставить("ДокументИсправление", ДокументИсправление);
...
&НаСервере
Процедура ВывестиДокументИсправлениеПередачаТоваровХранителю(СтрокаДействия, Макет, Описание)
	
	Если НеВыводитьВОтчет("ВывестиДокументИсправлениеПередачаТоваровХранителю", СтрокаДействия.Основание) Тогда
		Возврат;
	КонецЕсли;
	
	МассивОформленныхДокументов = Новый Массив;
	
	ОформленныеДокументы = ПередачиИсправления.НайтиСтроки(Новый Структура("Передача", СтрокаДействия.Основание));
	Если ОформленныеДокументы.Количество() = 0 Тогда
	...
	Иначе
		...
		Для Каждого ОформленныйДокумент Из ОформленныеДокументы Цикл
			ДокументИсправление = ОформленныйДокумент.ПередачаИсправление;
			МассивОформленныхДокументов.Добавить(ОформленныйДокумент.ПередачаИсправление);
		КонецЦикла;
		
	КонецЕсли;
	
	ВывестиДокументКОформлению(
		"ДокументИсправлениеПередачаТоваровХранителю",
		1,
		Макет,
		МассивОформленныхДокументов,,,
		Описание);
...
Процедура ВывестиДокументПередачаТоваровКомиссионеру(СтрокаДействия, Макет, Описание)
	...
	Если ОформленныеДокументы.Количество() = 0 Тогда
		Если Описание.СпособОтражения = Перечисления.СпособыОтраженияРасхожденийАктПриемкиКлиента.ОформлениеКорректировкиКакИсправлениеПервичныхДокументов Тогда
			ОписаниеОформляемогоДокумента = Новый Структура;
			ОписаниеОформляемогоДокумента.Вставить("ОформляемыйДокумент",   Документы.ПередачаТоваровХранителю.ПустаяСсылка());
			ОписаниеОформляемогоДокумента.Вставить("ХозяйственнаяОперация", Перечисления.ХозяйственныеОперации.ПередачаНаКомиссию);
			ОписаниеОформляемогоДокумента.Вставить("Исправление",           Ложь);
			ОписаниеОформляемогоДокумента.Вставить("ЕстьИсправление",       ЗначениеЗаполнено(ДокументИсправление));
			ОписаниеОформляемогоДокумента.Вставить("ДокументИсправление",   ДокументИсправление);
			МассивОформленныхДокументов.Добавить(ОписаниеОформляемогоДокумента);
