...
Функция ПриИзмененииРеквизитаСервер(ИмяЭлемента)
	...
	Если ИмяЭлемента = Элементы.ВестиУчетПодконтрольныхТоваровВЕТИС.Имя
		И НаборКонстант.ВестиУчетПодконтрольныхТоваровВЕТИС
		И Не ОбщегоНазначенияИС.КлассификаторНастроекВидовПродукцийЗагружен() Тогда
		
		НаборКонстант.ВестиУчетПодконтрольныхТоваровВЕТИС = Ложь;
...
Процедура УстановитьДоступность(РеквизитПутьКДанным = "")
	...
	Элементы.СтраницаСправочники.Доступность                                    = ВестиУчетПодконтрольныхТоваровВЕТИС;
	Элементы.СтраницаРегламентныеЗадания.Доступность                            = ВестиУчетПодконтрольныхТоваровВЕТИС;
...
&НаКлиенте
Процедура ОткрытьФормуСпискаДокументов(ИмяФормы, ДальнейшееДействиеВЕТИС)
...
Процедура ЗагрузкаКлассификатораНастроекЗавершение(Результат, ДополнительныеПараметры) Экспорт
	...
	Если Результат.Статус = "Выполнено" Тогда
		...
		Иначе
			НаборКонстант.ВестиУчетПодконтрольныхТоваровВЕТИС = Истина;
			Подключаемый_ПриИзмененииРеквизита(Элементы.ВестиУчетПодконтрольныхТоваровВЕТИС);
		КонецЕсли;
