...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ПараметрыПроверки.КлючЗадания   = "ЯндексМаркет_ИмпортТоварногоКаталога_"
		+ ДанныеУчетнойЗаписи.ИдентификаторКабинета;
	Результат = ИнтеграцияСМаркетплейсамиСервер.ПроверитьНаличиеДанныхИЗапускИмпортаКаталога(ПараметрыПроверки);

	Элементы.ГруппаДлительноеОжиданиеЦены.ТолькоПросмотр = Результат.ЗаданиеАктивно;
	Элементы.ДекорацияИмпортТоварногоКаталога.Заголовок  =
		ИнтеграцияСМаркетплейсамиВызовСервера.ПредставлениеРезультатаВыполненияЗаданияИмпортаКаталога(
			Результат.ЗаданиеЗавершено);
...
Процедура ОбработкаОповещения(ИмяСобытия, Параметр, Источник)
	...
	ИначеЕсли ИмяСобытия = "ЯндексМаркет_ИмпортТоварногоКаталога_Окончание"
		...
		Элементы.ДекорацияИмпортТоварногоКаталога.Заголовок =
			ИнтеграцияСМаркетплейсамиВызовСервера.ПредставлениеРезультатаВыполненияЗаданияИмпортаКаталога(Параметр);
		Элементы.ЗагружаемыеТовары.Обновить();
		ПриАктивацииГиперСсылкиНаПанели(ИмяАктивнойКнопки);
...
Функция ВыгрузитьОстаткиНаСервере()
	...
	ИмяМетода = "ИнтеграцияСМаркетплейсамиСервер.ВыгрузитьОстаткиНаМаркетплейсы";
	
	ДополнительныеПараметры = ИнтеграцияСМаркетплейсамиСервер.ДополнительныеПараметрыРегламентногоЗадания();
	ДополнительныеПараметры.Вставить("ПоРасписанию", Ложь);
	ДополнительныеПараметры.Вставить("АдресРезультата", ПараметрыВыполнения.АдресРезультата);
	
	Возврат ДлительныеОперации.ВыполнитьПроцедуру(ПараметрыВыполнения, ИмяМетода, УчетнаяЗапись, ДополнительныеПараметры);
...
Функция ВыгрузитьУстановленныеЦеныНаСервере()
	...
	ИмяМетода = "ИнтеграцияСМаркетплейсамиСервер.ВыгрузитьЦеныНаМаркетплейсы";
