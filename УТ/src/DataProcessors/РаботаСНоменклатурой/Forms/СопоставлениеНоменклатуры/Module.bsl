...
Функция СохранениеСопоставлений()
	...
	Возврат ДлительныеОперации.ВыполнитьВФоне("РаботаСНоменклатурой.СохранитьПодтвержденныеСопоставления",
		ПараметрыМетода, 
		ПараметрыВыполнения);
...
Функция НайтиСоответствияНаСервере()
	...
	Возврат ДлительныеОперации.ВыполнитьВФоне("РаботаСНоменклатурой.ПоискСоответствийНоменклатурыСервиса",
		ПараметрыМетода, 
		ПараметрыВыполнения);
...
Функция ОбновитьВариантыСопоставленияВФоне(Знач ПараметрыПодбораВариантов, Знач ИдентификаторФормы)
	...
	Возврат ДлительныеОперации.ВыполнитьВФоне("РаботаСНоменклатурой.ОбновитьВариантыСопоставленияНоменклатуры",
		ПараметрыПодбораВариантов, 
		ПараметрыВыполнения);
