...
Процедура ВыполнитьДлительнуюОперацию(СледующаяСтраница = Ложь)
	...
	ПараметрыВыполнения.НаименованиеФоновогоЗадания = НСтр("ru = '1С:Торговая площадка. Получение внешних публикаций.'");
	ПараметрыВыполнения.ЗапуститьВФоне = Истина;
	ПараметрыВыполнения.ОжидатьЗавершение = 0.2;
	
	ДлительнаяОперация = ДлительныеОперации.ВыполнитьВФоне(
		"ТорговыеПредложенияСлужебный.ПолучитьВнешниеПрайсЛисты",
		Неопределено, 
		ПараметрыВыполнения);
