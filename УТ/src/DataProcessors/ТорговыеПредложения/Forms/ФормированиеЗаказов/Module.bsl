...
Процедура ВыполнитьДлительнуюОперацию(Знач ТекущаяСтраница, СледующаяСтраница)
	...
	Если ТекущаяСтраница = Элементы.СтраницаПодготовкаЗаказов
		...
		Задание.Наименование = НаименованиеДлительнойОперацииФормированиеДокументов();
	...
	ИначеЕсли ТекущаяСтраница = Элементы.СтраницаОтправкиЗаказов
		...
		Задание.Наименование = НаименованиеДлительнойОперацииОтправкаДокументовПоставщику();
	...
	ДлительнаяОперация = ВыполнитьЗаданиеВФоне(Задание);
...
&НаСервере
Функция ВыполнитьЗаданиеВФоне(Знач Задание)
	
	ПараметрыВыполнения = ДлительныеОперации.ПараметрыВыполненияВФоне(УникальныйИдентификатор);
	ПараметрыВыполнения.НаименованиеФоновогоЗадания = Задание.Наименование;
	ПараметрыВыполнения.ЗапуститьВФоне = Истина;
	
	Если Задание.Наименование = НаименованиеДлительнойОперацииФормированиеДокументов() Тогда
		ИмяПроцедуры = "Обработки.ТорговыеПредложения.СформироватьЗаказы";
	ИначеЕсли Задание.Наименование = НаименованиеДлительнойОперацииОтправкаДокументовПоставщику() Тогда
		ИмяПроцедуры = "Обработки.ТорговыеПредложения.ОтправитьЗаказы";
	Иначе
		ВызватьИсключение СтрШаблон(
			НСтр("ru = 'Неизвестное наименование операции: %1'",  ОбщегоНазначения.КодОсновногоЯзыка()),
	...
	Если Задание.Наименование = НаименованиеДлительнойОперацииФормированиеДокументов() Тогда
		Возврат ДлительныеОперации.ВыполнитьВФоне("Обработки.ТорговыеПредложения.СформироватьЗаказы",
			Задание.ПараметрыПроцедуры, ПараметрыВыполнения);
	ИначеЕсли Задание.Наименование = НаименованиеДлительнойОперацииОтправкаДокументовПоставщику() Тогда
		Возврат ДлительныеОперации.ВыполнитьВФоне("Обработки.ТорговыеПредложения.ОтправитьЗаказы",
			Задание.ПараметрыПроцедуры, ПараметрыВыполнения);
	Иначе
		ВызватьИсключение СтрШаблон(
			НСтр("ru = 'Неизвестное наименование операции: %1'",  ОбщегоНазначения.КодОсновногоЯзыка()),
...
&НаКлиентеНаСервереБезКонтекста
Функция НаименованиеДлительнойОперацииФормированиеДокументов()
	Возврат НСтр("ru = '1С:Бизнес-сеть. Торговые предложения. Формирование документов.'");
КонецФункции

&НаКлиентеНаСервереБезКонтекста
Функция НаименованиеДлительнойОперацииОтправкаДокументовПоставщику()
	Возврат НСтр("ru = '1С:Бизнес-сеть. Торговые предложения. Отправка документов поставщику.'");
КонецФункции
