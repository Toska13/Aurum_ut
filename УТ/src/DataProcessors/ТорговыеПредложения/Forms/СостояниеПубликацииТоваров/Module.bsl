...
Процедура ОбновитьТорговыеПредложенияТорговойПлощадкиВФоне(ДлительнаяОперация, ТорговоеПредложение, Номенклатура, УникальныйИдентификаторФормы)
	...
	ДлительнаяОперация = ДлительныеОперации.ВыполнитьВФоне(
		"ТорговыеПредложенияСлужебный.ОбновитьТорговыеПредложенияТорговойПлощадки",
		ПараметрыПроцедуры,
		ПараметрыВыполнения);
...
Процедура ОбновитьСтатистикуСостоянийВФоне(
	...
	ДлительнаяОперация = ДлительныеОперации.ВыполнитьВФоне(
		"Обработки.ТорговыеПредложения.ОбновитьСтатистикуСостояний",
		ПараметрыПроцедуры,
		ПараметрыВыполнения);
...
Процедура СинхронизоватьВФоне(ДлительнаяОперация, ПозицииТорговогоПредложения, УникальныйИдентификатор)
	...
	ДлительнаяОперация = ДлительныеОперации.ВыполнитьВФоне(
		"ТорговыеПредложенияСлужебный.СинхронизацияТорговыхПредложений",
		ПараметрыПроцедуры,
		ПараметрыВыполнения);
