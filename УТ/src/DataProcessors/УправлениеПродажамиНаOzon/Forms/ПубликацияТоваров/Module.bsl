...
Процедура ЗапуститьОбновлениеДанныхСтатусовПубликацииПоНоменклатуреПартнера()
	...
	ДлительнаяОперация = ДлительнаяОперацияОбновленияДанныхСтатусовПубликацииПоНоменклатуреПартнера(
		УчетнаяЗаписьМаркетплейса, Элементы.Товары.ВыделенныеСтроки, УникальныйИдентификатор, Не Параметры.ВРежимеИмпортаДанных);
...
Функция ДлительнаяОперацияОбновленияДанныхСтатусовПубликацииПоНоменклатуреПартнера(УчетнаяЗаписьМаркетплейса,
			Знач ВыделенныеСтроки, УникальныйИдентификатор, ЗаписыватьПрисоединенныеФайлы = Ложь)
	...
	Возврат ДлительныеОперации.ВыполнитьФункцию(
		ПараметрыВыполнения, ИмяМетода, УчетнаяЗаписьМаркетплейса, МассивНоменклатурыПартнера, ЗаписыватьПрисоединенныеФайлы);
