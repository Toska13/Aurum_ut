...
Процедура СоздатьОрдер(Команда)
	...
	Если ТекущиеДанные <> Неопределено Тогда
		...
		Основание.Вставить("КонтролируемаяПартия",       ТекущиеДанные.КонтролируемаяПартия);
...
Процедура УстановитьУсловноеОформление()
	...
	ПолеЭлемента = Элемент.Поля.Элементы.Добавить();
	ПолеЭлемента.Поле = Новый ПолеКомпоновкиДанных(Элементы.РаспоряженияНаПоступлениеКонтролируемаяПартия.Имя);

	ОтборЭлемента = Элемент.Отбор.Элементы.Добавить(Тип("ЭлементОтбораКомпоновкиДанных"));
	ОтборЭлемента.ЛевоеЗначение = Новый ПолеКомпоновкиДанных("РаспоряженияНаПоступление.КонтролируемаяПартия");
	ОтборЭлемента.ВидСравнения = ВидСравненияКомпоновкиДанных.НеЗаполнено;

	Элемент.Оформление.УстановитьЗначениеПараметра("Текст", НСтр("ru = 'текущее распоряжение'"));
...
Процедура ЗаполнитьРаспоряженияНаПоступление()
	...
	|	ВложенныйЗапрос.КонтролируемаяПартия КАК КонтролируемаяПартия,
	...
	|				И ТоварыКПоступлениюОстаткиНаДату.КонтролируемаяПартия = ТоварыКПоступлениюОстаткиТекущие.КонтролируемаяПартия
	...
	|				И ТоварыКПоступлениюОстаткиНаДату.КонтролируемаяПартия = ТоварыКОформлениюОрдеровОбороты.КонтролируемаяПартия
...
Функция ДанныеДляПечатиЭтикетокПоРаспоряжению(Распоряжение)
	...
	|	ТоварыКПоступлениюОстаткиНаДату.Номенклатура КАК Номенклатура,
	|	ТоварыКПоступлениюОстаткиНаДату.Характеристика КАК Характеристика,
	|	ТоварыКПоступлениюОстаткиНаДату.Серия КАК Серия,
	|	ТоварыКПоступлениюОстаткиНаДату.Назначение,
	|	ВЫБОР
	|		КОГДА ТоварыКПоступлениюОстаткиНаДату.КОформлениюОрдеровОстаток - ТоварыКПоступлениюОстаткиНаДату.ПринимаетсяОстаток > 0
	...
	|			И ТоварыКПоступлениюОстаткиНаДату.Характеристика = ТоварыКПоступлениюОстаткиТекущие.Характеристика
	|			И ТоварыКПоступлениюОстаткиНаДату.Серия = ТоварыКПоступлениюОстаткиТекущие.Серия
	|			И ТоварыКПоступлениюОстаткиНаДату.Склад = ТоварыКПоступлениюОстаткиТекущие.Склад
	|			И ТоварыКПоступлениюОстаткиНаДату.Назначение = ТоварыКПоступлениюОстаткиТекущие.Назначение";
