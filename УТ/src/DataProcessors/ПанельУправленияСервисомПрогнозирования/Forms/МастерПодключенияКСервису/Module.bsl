...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ДоступноПодключениеТестовыхПериодов = СервисПрогнозирования.ДоступноПодключениеТестовыхПериодов();
...
Процедура ПолучитьНастройкиСервиса()
	...
	|ИдентификаторПриложения, ТокенПриложения, ИзмененыНастройкиИнтернетПоддержки, ИзмененАПИСервиса,
...
Процедура УстановитьВидимостьДоступность()
	...
	Элементы.ГруппаНедоступноПодключениеТестовыхПериодов.Видимость = Не ДоступноПодключениеТестовыхПериодов;
	...
	ИначеЕсли Элементы.Страницы.ТекущаяСтраница = Элементы.СтраницаПростойРежим Тогда
		...
		ИначеЕсли Не РазрешенаРаботаССервисамиИнтернетПоддержки Тогда
			...
			Элементы.ГруппаНеРазрешенаРаботаССервисамиНедоступноПодключениеТестовыхПериодов.Видимость = Не ДоступноПодключениеТестовыхПериодов;
		Иначе
			Элементы.СтраницыПростойРежимНижнийБлок.ТекущаяСтраница = Элементы.СтраницаПростойРежимТестовыйПрогноз;
			Элементы.ГруппаТестовыйПрогнозНедоступноПодключениеТестовыхПериодов.Видимость = Не ДоступноПодключениеТестовыхПериодов;
		КонецЕсли;
...
Процедура РассчитатьРеквизитыСтатусовАвторизации()
	...
	Если РегламентныеЗаданияСервер.РаботаСВнешнимиРесурсамиЗаблокирована() Тогда
		...
		РазрешенаРаботаССервисамиИнтернетПоддержки = Не ОбщегоНазначения.РазделениеВключено()
			И ПараметрыБлокировки.СервисыИнтернетПоддержки[НСтр("ru = 'Сервисы аутентификации'")].РазрешенаРабота;
		Если ДоступноПодключениеТестовыхПериодов Тогда
			РазрешенаРаботаССервисамиИнтернетПоддержки = РазрешенаРаботаССервисамиИнтернетПоддержки
				И ПараметрыБлокировки.СервисыИнтернетПоддержки[НСтр("ru = 'Подключение тестовых периодов'")].РазрешенаРабота; 
		КонецЕсли;
