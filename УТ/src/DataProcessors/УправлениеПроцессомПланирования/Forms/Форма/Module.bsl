...
&НаКлиенте
Процедура ЗапуститьФоновоеЗадание(ИмяЗадания, ПараметрыПроцедуры)
...
&НаСервере
Функция ЗапуститьФоновоеЗаданиеНаСервере(ИмяЗадания, ПараметрыПроцедуры)
	
	Если ИмяЗадания = "ЗапуститьПересчетДефицитовПоЭтапамПоВсемПериодам" Тогда
		НаименованиеЗадания = НСтр("ru = 'Запустить пересчет дефицитов по этапам по всем периодам'");
		ИмяПроцедуры = "Обработки.УправлениеПроцессомПланирования.ЗапуститьПересчетДефицитовПоЭтапамПоВсемПериодам";
	ИначеЕсли ИмяЗадания = "ЗаполнитьПланыПоДефицитамВоВсехПериодах" Тогда
		НаименованиеЗадания = НСтр("ru = 'Заполнить планы по дефицитам во всех периодах'");
		ИмяПроцедуры = "Обработки.УправлениеПроцессомПланирования.ЗаполнитьПланыПоДефицитуПоПериодам";
	ИначеЕсли ИмяЗадания = "ЗаполнитьПланыПоДефицитамДоКолонки" Тогда
		НаименованиеЗадания = НСтр("ru = 'Заполнить планы по дефицитам'");
		ИмяПроцедуры = "Обработки.УправлениеПроцессомПланирования.ЗаполнитьПланыПоДефицитуПоПериодам";
	ИначеЕсли ИмяЗадания = "ПерерасчетПомощникПланирования" Тогда
		НаименованиеЗадания = НСтр("ru = 'Глобальный перерасчет помощник планирования'");
		ИмяПроцедуры = "Обработки.УправлениеПроцессомПланирования.ПерерасчетПомощникПланирования";
	КонецЕсли;
