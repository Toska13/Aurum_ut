...
Процедура ПерейтиВЛичныйКабинетТестовыйКонтур(Команда)
	ФайловаяСистемаКлиент.ОткрытьНавигационнуюСсылку("https://demo-hs.fgis-saturn.ru/");
КонецПроцедуры
...
Процедура НастроитьЭлементыФормыНаСервере()
	...
	Элементы.ПерейтиВЛичныйКабинетТестовыйКонтур.Видимость = ИнтеграцияСАТУРНКлиентСервер.РежимРаботыСТестовымКонтуромСАТУРН();
	Если Пользователи.ЭтоПолноправныйПользователь() Тогда
		Элементы.ПанельАдминистрирования.Заголовок = НСтр("ru='Настройки и справочники'");
	Иначе
		Элементы.ПанельАдминистрирования.Заголовок = НСтр("ru='Справочники'");
	КонецЕсли;
