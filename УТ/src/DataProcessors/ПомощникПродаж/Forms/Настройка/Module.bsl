...
Процедура УстановитьДоступностьЗаявкиНаВозврат(Форма)
	...
	ЗаказКлиентаПередачаТоваровХранителю = Форма.ВариантОформленияДокументов = ПредопределенноеЗначение("Перечисление.ВариантыОформленияДокументовПродажи.ЗаказКлиентаПередачаТоваровХранителю");
	Элементы.ГруппаЗаявкаНаВозвратТоваровЗаказКлиентаПередачаТоваровХранителю.Видимость = НЕ ЗаказКлиентаПередачаТоваровХранителю;
	Элементы.ГруппаПечататьЗаявкуНаВозвратТоваровОтКлиентовЗаказКлиентаПередачаТоваровХранителю.Видимость = ИспользоватьРасширенныеВозможностиЗаказаКлиента И НЕ ЗаказКлиентаПередачаТоваровХранителю;
	
	Элементы.ДекорацияЗаказКлиента.Видимость = Не ИспользоватьРасширенныеВозможностиЗаказаКлиента;
	Элементы.ДекорацияЗаказКлиентаЗаказРеализация.Видимость = Не ИспользоватьРасширенныеВозможностиЗаказаКлиента;
	Элементы.ДекорацияЗаказКлиентаЗаказПередача.Видимость = Не ИспользоватьРасширенныеВозможностиЗаказаКлиента;
...
Процедура УстановитьДоступностьДокументаПродажи(Форма)
	...
	ОбработатьИзменениеФлага(
		Форма.СоздаватьДокументПродажи ИЛИ Форма.СоздаватьПередачуТоваровХранителю,
		МассивЭлементовПечататьСФ,
		Форма.ПечататьСчетФактуру);
	
	МассивЭлементовПечататьСФ = Новый Массив;
	МассивЭлементовПечататьСФ.Добавить(Форма.Элементы.ПечататьСчетФактуруПередачаТоваров);
	МассивЭлементовПечататьСФ.Добавить(Форма.Элементы.ПечататьСчетФактуруЗаказКлиентаПередачаТоваров);
	
	ОбработатьИзменениеФлага(
		Форма.СоздаватьПередачуТоваровХранителю,
		МассивЭлементовПечататьСФ,
		Форма.ПечататьСчетФактуру);
...
Процедура УстановитьЗаголовкиПрогнозированияПродажПоПередачеТоваров(Форма)
	...
	Элементы.ОтображатьРекомендацииКПокупке.Заголовок = НСтр("ru = 'Прогнозировать передачу/отгрузку товаров клиенту'");
	Элементы.СпособПрогнозированияПродаж.Заголовок = НСтр("ru = 'Способ прогнозирования передачи/отгрузки товаров'");
