...
//                                                или "РегистрыНакопления.РасчетыСКлиентамиПоСрокам.Измерения.ОбъектРасчетов".
//
...
// См. Справочники.СтатьиДвиженияДенежныхСредств.СтатьиХозяйственнойОперации
// 
Функция СтатьиХозяйственнойОперации(ХозяйственнаяОперация) Экспорт

	Возврат Справочники.СтатьиДвиженияДенежныхСредств.СтатьиХозяйственнойОперации(ХозяйственнаяОперация);
