...
Процедура ДополнитьИменамиПоиска(ИмяФайла, МассивИмен)
	...
	ЕстьСлеш = СтрНайти(ИмяФайла, "/") <> 0;
	ЕстьОбратныйСлеш = СтрНайти(ИмяФайла, "\") <> 0;
	
	ИмяФайлаИсправленныйЧастично = СтрЗаменить(ИмяФайла, "и" + Символ(774), "й");
	ИмяФайлаИсправленныйПервыйВариант = СтрЗаменить(ИмяФайлаИсправленныйЧастично, "е" + Символ(776), "е");
	ИмяФайлаИсправленныйВторойВариант = СтрЗаменить(ИмяФайлаИсправленныйЧастично, "е" + Символ(776), "ё");
	
	Если ЕстьСлеш Тогда
		ДополнитьИмяРазделителемПути(ИмяФайла, МассивИмен, "/");
	КонецЕсли;
	Если ЕстьОбратныйСлеш Тогда
		ДополнитьИмяРазделителемПути(ИмяФайла, МассивИмен, "\");
	КонецЕсли;
	
	Если ИмяФайла <> ИмяФайлаИсправленныйПервыйВариант Тогда
		
		МассивИмен.Добавить(ИмяФайлаИсправленныйПервыйВариант);
		Если ЕстьСлеш Тогда
			ДополнитьИмяРазделителемПути(ИмяФайлаИсправленныйПервыйВариант, МассивИмен, "/");
		КонецЕсли;
		Если ЕстьОбратныйСлеш Тогда
			ДополнитьИмяРазделителемПути(ИмяФайлаИсправленныйПервыйВариант, МассивИмен, "\");
		КонецЕсли;
	...
	Если ИмяФайла <> ИмяФайлаИсправленныйВторойВариант Тогда
		
		МассивИмен.Добавить(ИмяФайлаИсправленныйВторойВариант);
		Если ЕстьСлеш Тогда
			ДополнитьИмяРазделителемПути(ИмяФайлаИсправленныйВторойВариант, МассивИмен, "/");
		КонецЕсли;
		Если ЕстьОбратныйСлеш Тогда
			ДополнитьИмяРазделителемПути(ИмяФайлаИсправленныйВторойВариант, МассивИмен, "\");
		КонецЕсли;
