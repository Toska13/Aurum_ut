...
Процедура ПриОпределенииМетодовРазрешенныхДляВызоваКакПроизвольныйКод(Методы) Экспорт
	...
	Методы.Вставить("ЗагрузитьВБазуДанныеТНВЭД", Истина);
	Методы.Вставить("ОбновитьКлассификаторТНВЭД", Истина);
	Методы.Вставить("ОбработатьПоисковыйЗапросТНВЭД", Истина);
	Методы.Вставить("ПолучитьВеткуТНВЭД", Истина);
	Методы.Вставить("ПолучитьПодчиненныеЭлементыТНВЭД", Истина);
	Методы.Вставить("ПолучитьРазделыТНВЭД", Истина);
	
	Методы.Вставить("ЗагрузитьВБазуДанныеОКПД2", Истина);
	Методы.Вставить("ОбновитьКлассификаторОКПД2", Истина);
	Методы.Вставить("ОбработатьПоисковыйЗапросОКПД2", Истина);
	Методы.Вставить("ПолучитьВеткуОКПД2", Истина);
	Методы.Вставить("ПолучитьПодчиненныеЭлементыОКПД2", Истина);
	Методы.Вставить("ПолучитьРазделыОКПД2", Истина);
	
	Методы.Вставить("ЗагрузитьВБазуДанныеОКЕИ", Истина);
	Методы.Вставить("ПолучитьИерархиюЭлементовОКЕИ", Истина);
...
Функция ПолучитьИерархиюЭлементовОКЕИ(ДополнительныеПараметры = Неопределено) Экспорт
	...
	СсылкиПоКоду = Новый Соответствие;
	ОблачныеКлассификаторыПереопределяемый.ОпределитьЗагруженныеЭлементыОКЕИ(СсылкиПоКоду, ДополнительныеПараметры);
	...
	Для Каждого СтрокаТаблицыЗначений Из ДанныеСервиса Цикл
		...
		Если ЗначениеЗаполнено(СтрокаТаблицыЗначений.Код) Тогда
			Отказ = Ложь;
			ОблачныеКлассификаторыПереопределяемый.ПроверитьЭлементОКЕИ(СтрокаТаблицыЗначений, ДополнительныеПараметры, Отказ);
	...
	Для Каждого СтрокаДереваЗначений Из Строки Цикл
		Если СтрокаДереваЗначений.Пометка Тогда
			Если ЗначениеЗаполнено(СтрокаДереваЗначений.Код) Тогда
				...
				ОблачныеКлассификаторыПереопределяемый.СоздатьОбновитьЭлементОКЕИ(СтрокаДереваЗначений, Ссылка, ЭтоНовый);
