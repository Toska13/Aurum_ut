...
Процедура НажатиеНаИнформационнуюСсылку(Форма, Элемент) Экспорт
	...
	// Локализация		
		...
		Если ОбщегоНазначенияКлиент.ПодсистемаСуществует("ИнтернетПоддержкаПользователей.БазоваяФункциональностьБИП") И 
			СтрНачинаетсяС(Элемент.Имя, "_") Тогда

			МодульИнтернетПоддержкаПользователейКлиент = ОбщегоНазначенияКлиент.ОбщийМодуль("ИнтернетПоддержкаПользователейКлиент");
			МодульИнтернетПоддержкаПользователейКлиент.ОткрытьСтраницуИнтегрированногоСайта(Гиперссылка.Представление);
...
//	ПараметрыОбращения - см. ИнформационныйЦентрКлиентСервер.НовыеПараметрыОбращенияВСлужбуПоддержки
//
...
// Устарела. Следует использовать ИнформационныйЦентрКлиентСервер.НовыеПараметрыОбращенияВСлужбуПоддержки
// 
// См. ИнформационныйЦентрКлиентСервер.НовыеПараметрыОбращенияВСлужбуПоддержки
// 
Функция НовыеПараметрыОбращенияВСлужбуПоддержки() Экспорт

	Возврат ИнформационныйЦентрКлиентСервер.НовыеПараметрыОбращенияВСлужбуПоддержки();
