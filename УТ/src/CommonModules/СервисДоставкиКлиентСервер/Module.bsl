...
Функция ИдентификаторГрузоперевозчика(ТипГрузоперевозки) Экспорт
	...
	ИначеЕсли ЭтоКурьерика(ТипГрузоперевозки) Тогда
		Результат = "000000004";
	ИначеЕсли ЭтоСДЭК(ТипГрузоперевозки) Тогда
		Результат = ИдентификаторГрузоперевозчикаСДЭК();
	КонецЕсли;
...
// Идентификатор грузоперевозчика СДЭК.
// 
// Возвращаемое значение:
//  Строка - Идентификатор грузоперевозчика СДЭК
Функция ИдентификаторГрузоперевозчикаСДЭК() Экспорт
	Возврат "delivery_CDEK";
КонецФункции
...
// 
// Возвращаемое значение:
//  Структура - направления доставки 1- Отгрузка, 2 - Доставка:
//   * Отгрузка - Число - 1
//   * Доставка - Число - 2
Функция НаправленияПеревозки() Экспорт
	
	Результат = Новый Структура();
	Результат.Вставить("Отгрузка", 1);
	Результат.Вставить("Доставка", 2);
...
// Возвращаемое значение:
//  Строка - Имя процедуры получить характеры груза
Функция ИмяМетодаПолучитьХарактерыГруза() Экспорт
	Возврат "ПолучитьХарактерыГруза";
КонецФункции
...
//   * ИдентификаторНазначения - УникальныйИдентификатор, Неопределено - Форма, из который был сделан вызов
...
Функция НовыйПараметрыЗапросаПолучитьНаселенныеПункты() Экспорт
	...
	Результат.Вставить("ПодтипыЗаказа", Новый Массив); // tariffPlanIds
...
// Конструктор обязательных параметров запроса.
// 
// Возвращаемое значение:
//  Структура - Новый обязательные параметры запроса. Свойства:
...
//
Функция НовыйОбязательныеПараметрыЗапроса() Экспорт
	Результат = Новый Структура;
	Результат.Вставить("ТипГрузоперевозки", 0);
	Результат.Вставить("ЗависитОт", "");
	Результат.Вставить("ЗависимыеПоля", "");
	Возврат Результат;
КонецФункции
...
//   * Первые - Число - ограничение на количество возвращаемых записей.
Функция НовыйПараметрыЗапросаПолучитьДоступныеТерминалы() Экспорт
	
	Результат = НовыйОбязательныеПараметрыЗапроса();
...
Функция НовыйПараметрыПропуска() Экспорт
	...
	Результат.Вставить("Заказывать", Ложь);
	Результат.Вставить("ВремяЗаказа", 1);
	Результат.Вставить("Стоимость", 0);
	Результат.Вставить("ВозмещениеОплаты", 1);
