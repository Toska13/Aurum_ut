...
Процедура ПриОпределенииМетодовРазрешенныхДляВызоваКакПроизвольныйКод(Методы) Экспорт
	...
	Методы.Вставить("ЗагрузитьИУстановитьОбновленияВФоновомРежиме", Истина);
	Методы.Вставить("ИсправитьРасписаниеЗагрузкиИсправлений");
	Методы.Вставить("ОбновитьРасписаниеЗагрузкиИсправлений");
	Методы.Вставить("ОбновитьРасписаниеЗаданияПоОбновлениюИнформацииОВерсияхПлатформы");
	Методы.Вставить("ОбновлениеИнформационнойБазы_ОбновитьНастройкиПолученияОбновлений_2_1_8_1");
	Методы.Вставить("ПроверитьНаличиеОбновленияВФоновомРежиме", Истина);
