...
Функция КодМаркировкиБезСкобок(КодМаркировки, УстанавливатьИдентификаторПримененияSSCC = Истина) Экспорт
	...
	Если ЧтениеШтрихкода.Результат <> Неопределено Тогда
		...
		ИначеЕсли ЧтениеШтрихкода.ТипШтрихкода = ПредопределенноеЗначение("Перечисление.ТипыШтрихкодов.SSCC18") Тогда
			Возврат ШтрихкодSSCC(ЧтениеШтрихкода.Результат, Ложь, Ложь);
		ИначеЕсли ЧтениеШтрихкода.ТипШтрихкода = ПредопределенноеЗначение("Перечисление.ТипыШтрихкодов.SSCC20") Тогда
			Возврат ШтрихкодSSCC(ЧтениеШтрихкода.Результат, Ложь, Истина);
...
// 	УстанавливатьИдентификаторПрименения - Булево - Если истина, то будет установлен идентификатор применения.
//
// Возвращаемое значение:
