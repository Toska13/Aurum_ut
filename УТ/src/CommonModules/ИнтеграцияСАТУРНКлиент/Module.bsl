...
Процедура ПодготовитьСообщенияКПередаче(ДинамическийСписок, ПараметрыПередачи, Префикс = "") Экспорт
	...
	ПараметрыОпределенияДоступности.Подсистема = ИнтеграцияСАТУРНКлиентСервер.ИмяПодсистемы();
	ПараметрыОпределенияДоступности.Префикс    = Префикс;
...
Процедура ОткрытьФормуПодбораТНВЭД(Форма, ТекущиеДанные, Владелец, ДополнительныеПараметры = Неопределено) Экспорт
	...
	СобытияФормСАТУРНКлиентПереопределяемый.ОткрытьФормуПодбораТНВЭД(Форма, ТекущиеДанные, Владелец, ДополнительныеПараметры);
