...
Процедура СервисОтправитьУведомления(ИдентификаторЭДО, ПараметрыОперации) Экспорт
	...
	СервисВзаимодействияМПЭПД.СервисОтправитьУведомления(ИдентификаторЭДО, ПараметрыОперации);
...
Функция СписокПодключенныхМП(Отборы = Неопределено, ТолькоАктивные = Ложь) Экспорт
	...
	Возврат СервисВзаимодействияМПЭПД.СписокПодключенныхМП(Отборы, ТолькоАктивные);
