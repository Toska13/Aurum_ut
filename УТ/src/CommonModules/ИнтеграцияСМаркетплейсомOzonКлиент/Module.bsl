...
//   см. ИнтеграцияСМаркетплейсамиКлиент.НовоеОписаниеПараметровДействия.
//
...
// Получает сохраненные данные по категориям.
//
// Возвращаемое значение:
//   Структура из КлючИЗначение - где ключ - идентификатор категории, а значение - сохраненные настройки.
//
