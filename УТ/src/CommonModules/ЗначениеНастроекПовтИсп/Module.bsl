...
// Функция определяет банковский счет по переданным параметрам.
//
// Возвращает ссылку на счет, если по параметрам найден один банковский счет.
// Возвращает пустую ссылку, если банковский счет не найден или счетов больше одного.
//
// Параметры:
//  ПараметрыСчета - см. ДенежныеСредстваСервер.ПараметрыЗаполненияБанковскогоСчетаКонтрагента.
//
// Возвращаемое значение:
//  СправочникСсылка.БанковскиеСчетаКонтрагентов - банковский счет контрагента по умолчанию.
//
Функция БанковскийСчетКонтрагентаПоУмолчанию(ПараметрыСчета) Экспорт
	
	Возврат Справочники.БанковскиеСчетаКонтрагентов.ПолучитьБанковскийСчетПоУмолчанию(ПараметрыСчета.Контрагент,
		ПараметрыСчета.Валюта, ПараметрыСчета.КорреспондирующийСчет, ПараметрыСчета.ИсключитьСчетаВВалюте);
	
КонецФункции

// Определяет банковский счет организации по заданным параметрам.
//
// См. Справочники.БанковскиеСчетаОрганизаций.ПолучитьБанковскийСчетПоУмолчанию.
//
// Параметры:
//  ПараметрыСчета - см. ДенежныеСредстваСервер.ПараметрыЗаполненияБанковскогоСчетаОрганизации.
//
// Возвращаемое значение:
//  СправочникСсылка.БанковскиеСчетаОрганизаций - банковский счет контрагента по умолчанию.
//
Функция БанковскийСчетОрганизацииПоУмолчанию(ПараметрыСчета) Экспорт
	
	Возврат Справочники.БанковскиеСчетаОрганизаций.ПолучитьБанковскийСчетПоУмолчанию(ПараметрыСчета);
...
// Возвращает структуру по ответственному лицу указанного склада если указан отвественный или его должность.
//
// Параметры:
// 		Склад - СправочникСсылка.Склады
//
// Возвращаемое значение:
// 		Неопределено, Структура - Структура с полями: 
...
Функция ВидЗапасовПоОтборам(Организация,
	...
	ВидЦены,
	ОблагаетсяАкцизом,
	ПодразделениеПроизводства) Экспорт // Количество параметров повышает описанное в стандарте, но тут это осознанное решение для работы кэша
	...
	СтруктураАналитики.ОблагаетсяАкцизом = ОблагаетсяАкцизом;
	СтруктураАналитики.ПодразделениеПроизводства = ПодразделениеПроизводства;
...
Функция ПолучитьКассуОрганизацииПоУмолчанию(СтруктураПараметров = Неопределено) Экспорт
	...
	ИначеЕсли ЗначениеЗаполнено(Касса) И (ФормаОплаты = Перечисления.ФормыОплаты.Безналичная
...
// Возвращает префиксы весовых штрихкодов.
//
// Возвращаемое значение:
...
// Возвращает настройки диапазонов весовых штрихкодов.
//
// Возвращаемое значение:
//	Массив Из см. РегистрыСведений.ШтрихкодыНоменклатуры.НастройкаДиапазонаШтрихкода.
//
...
// Возвращает настройки диапазонов штучных штрихкодов.
//
// Возвращаемое значение:
//	Массив Из см. РегистрыСведений.ШтрихкодыНоменклатуры.НастройкаДиапазонаШтрихкода.
//
...
// Устарела. Следует использовать ДенежныеСредстваСервер.ПолучитьБанковскийСчетКонтрагентаПоУмолчанию.
...
//  СправочникСсылка.БанковскиеСчетаКонтрагентов - банковский счет контрагента по умолчанию.
//
Функция ПолучитьБанковскийСчетКонтрагентаПоУмолчанию(Знач Контрагент, Знач ФормаОплаты = Неопределено,
	Знач БанковскийСчет = Неопределено, Знач КорреспондирующийСчет = Неопределено) Экспорт
	...
	Возврат ДенежныеСредстваСервер.ПолучитьБанковскийСчетКонтрагентаПоУмолчанию(ПараметрыСчета, БанковскийСчет, ФормаОплаты);
	
КонецФункции

// Устарела. Следует использовать ДенежныеСредстваСервер.ПолучитьБанковскийСчетОрганизацииПоУмолчанию.
...
//     * ИсключитьСчетаВВалюте   - Булево - если Истина, счета в валюте, переданной в параметре Валюта исключаются.
//
// Возвращаемое значение:
...
Функция ПолучитьБанковскийСчетОрганизацииПоУмолчанию(СтруктураПараметров = Неопределено) Экспорт
	...
	Возврат ДенежныеСредстваСервер.ПолучитьБанковскийСчетОрганизацииПоУмолчанию(СтруктураПараметров,
		СтруктураПараметров.БанковскийСчет, СтруктураПараметров.ФормаОплаты);
