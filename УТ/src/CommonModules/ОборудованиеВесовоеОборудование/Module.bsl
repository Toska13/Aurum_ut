...
Процедура ОбновитьПоставляемыеДрайвера(ДрайвераОборудования) Экспорт
	...
	Драйвер = ДрайвераОборудования.Добавить();
	Драйвер.ТипОборудования = Перечисления.ТипыПодключаемогоОборудования.ЭлектронныеВесы;
	Драйвер.ИмяДрайвера = "ДрайверПОСЦентрЭлектронныеВесыNG";
	Драйвер.Наименование = НСтр("ru = 'POScenter:Электронные весы SLIM NG'", ОбщегоНазначенияБПО.КодОсновногоЯзыка());
	Драйвер.ИдентификаторОбъекта = "POScenter_scales_drv_ng_V1"; 
	Драйвер.РекомендуемоеИспользование = Истина;
	
	Драйвер = ДрайвераОборудования.Добавить();
	Драйвер.ТипОборудования = Перечисления.ТипыПодключаемогоОборудования.ЭлектронныеВесы;
	Драйвер.ИмяДрайвера  = "ДрайверAQSIЭлектронныеВесы";
	Драйвер.Наименование = НСтр("ru = 'AQSI:Электронные весы'", ОбщегоНазначенияБПО.КодОсновногоЯзыка());
	Драйвер.ИдентификаторОбъекта = "DrvAQSIWM1C";   
	...
	Драйвер = ДрайвераОборудования.Добавить();
	Драйвер.ТипОборудования = Перечисления.ТипыПодключаемогоОборудования.ВесыСПечатьюЭтикеток;
	Драйвер.ИмяДрайвера  = "ДрайверПОСЦентрВесыСПечатьюЭтикетокNG";
	Драйвер.Наименование = НСтр("ru = 'ПОСЦЕНТР:Драйвер весов с печатью этикеток NG'", ОбщегоНазначенияБПО.КодОсновногоЯзыка());
	Драйвер.ИдентификаторОбъекта = "POScenter_lp_drv_ng_V1";        
	Драйвер.РекомендуемоеИспользование = Истина;    
	...
	Драйвер.Наименование = НСтр("ru = 'Мертех:Электронные весы с устройством распознования'", ОбщегоНазначенияБПО.КодОсновногоЯзыка());
	...
	Драйвер.Наименование = НСтр("ru = 'Мертех:Весы с печатью этикеток'", ОбщегоНазначенияБПО.КодОсновногоЯзыка());
	Драйвер.ИдентификаторОбъекта = "Mertech";        
	Драйвер.ИмяМакетаДрайвера = "ДрайверМертехВесыСПечатьюЭтикетокРаспознаватель";    
	Драйвер.РекомендуемоеИспользование = Истина;                                  
	...
	Драйвер = ДрайвераОборудования.Добавить();
	Драйвер.ТипОборудования = Перечисления.ТипыПодключаемогоОборудования.ВесыСПечатьюЭтикеток;
	Драйвер.ИмяДрайвера  = "ДрайверДатаПринтВесыCПечатьюЭтикетокDPWASP";
	Драйвер.Наименование = НСтр("ru = 'ДатаПринт:Весы с печатью этикеток DP WASP'", ОбщегоНазначенияБПО.КодОсновногоЯзыка());
	Драйвер.ИдентификаторОбъекта = "DpNonPcDriver";   
	
	Драйвер = ДрайвераОборудования.Добавить();
	Драйвер.ТипОборудования = Перечисления.ТипыПодключаемогоОборудования.ВесыСПечатьюЭтикеток;
	Драйвер.ИмяДрайвера  = "ДрайверДатаПринтВесыCПечатьюЭтикетокDPFalcon";
	Драйвер.Наименование = НСтр("ru = 'ДатаПринт:Компьютерные весы с печатью этикеток DP'", ОбщегоНазначенияБПО.КодОсновногоЯзыка());
	Драйвер.ИдентификаторОбъекта = "DpPcDriver";   
	// -- Локализация
	// -- НеМобильноеПриложение     
...
Функция СформироватьТаблицуТоваровВесыСПечатьюЭтикеток(ДанныеЗагрузки, РевизияИнтерфейса = 0) 
	...
	Для Каждого Позиция Из ДанныеЗагрузки  Цикл
		...
		Если РевизияИнтерфейса > 3007 Тогда // Версия стандарта 3.8 и выше // 
			...
			Если РевизияИнтерфейса > 4005 И Не ВесовойТовар Тогда      
				Если Не ПустаяСтрока(Позиция.ВесЕдиницыШтучногоТовара) И Позиция.ВесЕдиницыШтучногоТовара > 0 Тогда 
					ЗаписьXML.ЗаписатьАтрибут("WeightPieceOfGoods", XMLСтрока(Число(Позиция.ВесЕдиницыШтучногоТовара)));    
				КонецЕсли;
			КонецЕсли;
...
//
// Возвращаемое значение:
//  Массив из см. СформироватьТаблицуТоваровВесыСПечатьюЭтикеток
//
