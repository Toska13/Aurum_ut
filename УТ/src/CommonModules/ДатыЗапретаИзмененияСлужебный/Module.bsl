...
Процедура ПриДобавленииОбработчиковУстановкиПараметровСеанса(Обработчики) Экспорт
	...
	Обработчики.Вставить("ПользовательДляПроверкиДатЗапрета",
		"ДатыЗапретаИзмененияСлужебный.УстановкаПараметровСеанса");
...
Процедура УстановкаПараметровСеанса(ИмяПараметра, УстановленныеПараметры) Экспорт
	...
	ИначеЕсли ИмяПараметра = "ПользовательДляПроверкиДатЗапрета" Тогда
		ПараметрыСеанса.ПользовательДляПроверкиДатЗапрета = Неопределено;
		УстановленныеПараметры.Добавить("ПользовательДляПроверкиДатЗапрета");
	КонецЕсли;
...
Функция НайденЗапретИзмененияДанных(Знач ДанныеДляПроверки, ПараметрыСообщенияОЗапрете,
	...
	Если УзелПроверкиЗапретаЗагрузки = Неопределено Тогда
		...
		Если ПараметрыСеанса.ПользовательДляПроверкиДатЗапрета <> Неопределено Тогда
			Адресат = ПараметрыСеанса.ПользовательДляПроверкиДатЗапрета;
		Иначе
