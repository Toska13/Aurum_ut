...
// Возвращаемое значение:
//  Булево 
Функция ТипЗначенияКорректировкиПрошлыхПериодов(ТипЭлемента) Экспорт
	
	ЭтоКорректировкаПрошлыхПериодов = Ложь;
	
	
	Возврат ЭтоКорректировкаПрошлыхПериодов;
