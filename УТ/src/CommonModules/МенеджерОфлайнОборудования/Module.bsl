...
// Возвращает значение ставки 22
//
// Возвращаемое значение:
// 	Строка.
//
Функция СтавкаНДС22() Экспорт
...
Процедура УстановитьВерсиюФорматаОбменаККМED(Параметры) Экспорт
	
	Справочники.ОфлайнОборудование.УстановитьВерсиюФорматаОбменаККМED(Параметры);
