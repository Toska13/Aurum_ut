...
#Область РеквизитыПечатиРеализации
...
//
Процедура ПриСозданииНаСервереРеквизитыПечатиРеализации(Форма, Отказ, СтандартнаяОбработка) Экспорт
...
Функция ТекстЗапросаМаркировки(РазмерПакета = 0) Экспорт
	...
	|	И РасходныйОрдерНаТоварыШтрихкодыУпаковок.ШтрихкодУпаковки.Номенклатура <> ЗНАЧЕНИЕ(Справочник.Номенклатура.ПустаяСсылка)
	|;
	|
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ
...
//++ Локализация
	...
	ИнтеграцияИСУТ.ПеренестиШтрихкодыУпаковок(Форма, ШтрихкодыУпаковок, ИмяТЧ);
