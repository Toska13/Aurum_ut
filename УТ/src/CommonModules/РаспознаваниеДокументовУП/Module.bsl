...
Функция ОпределитьСтавкуНДС(Всего, СуммаНДС) Экспорт
	...
	Если Ставка = 22 Тогда
		СтавкаСсылкой = Справочники.СтавкиНДС.НайтиПоРеквизиту("ПеречислениеСтавкаНДС",Перечисления.СтавкиНДС.НДС22);
...
Функция СтавкаНДСПоРаспознанномуТексту(Ставка, ТекущееЗначение) Экспорт
	...
	Если Ставка = "НДС22" Тогда
		Возврат Справочники.СтавкиНДС.НайтиПоРеквизиту("ПеречислениеСтавкаНДС", Перечисления.СтавкиНДС.НДС22);
	...
	ИначеЕсли Ставка = "НДС22_122" Тогда
		Возврат Справочники.СтавкиНДС.НайтиПоРеквизиту("ПеречислениеСтавкаНДС", Перечисления.СтавкиНДС.НДС22_122);
...
// Устанавливает связи, прикрепляет изображения
//
// Параметры:
...
Процедура УстановитьСвязиПрикрепитьИзображения(Источник) Экспорт
	...
	РаспознанныеДокументы = Источник.ДополнительныеСвойства.РаспознанныеДокументы;
	РаспознанныеДокументыИсточника
		= РегистрыСведений.СвязанныеОбъектыРаспознаниеДокументов.РаспознанныеДокументыПоСвязанным(Источник.Ссылка);
	РаспознанныеДокументы = ОбщегоНазначенияКлиентСервер.РазностьМассивов(РаспознанныеДокументы,
		РаспознанныеДокументыИсточника);
	...
	Для Каждого РаспознанныйДокумент Из РаспознанныеДокументы Цикл
		...
		РегистрыСведений.СвязанныеОбъектыРаспознаниеДокументов.ЗаписатьЗначения(Источник.Ссылка, РаспознанныйДокумент, Ложь);
