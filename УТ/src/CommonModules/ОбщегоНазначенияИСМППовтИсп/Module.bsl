...
Функция РазрешенОборотНемаркируемыхОстатковПродукции(ВидПродукции, Знач НаДату = Неопределено) Экспорт
	...
	СтруктураДатКонтроля = КонструкторИСМПОбщегоНазначенияКлиентСервер.ДатыРаздельногоКонтроляМаркируемойПродукции(
		ВидПродукции);
...
Функция ДействуетКонтрольПоВидуОперацииИПродукции(ВидОперации, ВидПродукции, Знач НаДату = Неопределено) Экспорт
	...
	ИначеЕсли ВидОперации = Перечисления.ВидыОперацийИСМП.ОтгрузкаПродажа
			Или ВидОперации = Перечисления.ВидыОперацийИСМП.ВозвратВОборот
			Или ВидОперации = Перечисления.ВидыОперацийИСМП.Приемка Тогда
...
Функция ДействуетКонтрольРазрешительныхДокументов(ВидПродукции, Знач НаДату = Неопределено) Экспорт
	...
	СтруктураДатКонтроля = КонструкторИСМПОбщегоНазначенияКлиентСервер.ДатыРаздельногоКонтроляМаркируемойПродукции(ВидПродукции);
...
// Возвращает дату начала контроля разрешительной документации
// 
// Параметры:
...
Функция ДатаКонтроляРазрешительнойДокументации(ВидПродукции) Экспорт
	...
	Возврат СтруктураДатКонтроля.ДатаКонтроляРазрешительныхДокументов;
