...
Процедура ПриСозданииНаСервереФормаЭлемента(Форма, Отказ, СтандартнаяОбработка) Экспорт
	...
	НастроитьВидимостьЭлементовОплатыЭСФССЛокализация(Форма);
...
Процедура УправлениеФормойНаСервере(Форма) Экспорт
	...
	ОбщегоНазначенияУТКлиентСервер.УстановитьСвойствоЭлементаФормы(
				Элементы,
				"ОсновныеКодыОбособленногоПодразделения",
				"Видимость",
				ВидОрганизации = "ОбособленноеПодразделение");
	
	ОбщегоНазначенияУТКлиентСервер.УстановитьСвойствоЭлементаФормы(
				Элементы,
				"ОсновныеКодыИндивидуальногоПредпринимателя",
				"Видимость",
	...
	Элементы.ИнойОсобыйПризнакЗаявителяДОПП.Видимость = Объект.ОсобыйПризнакЗаявителяДОПП = 2;
	
	ПодсказкаОсобыйПризнак = НСтр("ru = '0 – признак отсутствует
							|1 – есть право на освобождение от внесения обеспечительного платежа из списка:
							|крупнейший налогоплательщик Российской Федерации; налогоплательщик на налоговом мониторинге;
							|резидент свободной экономической зоны; уполномоченный экономический оператор;
							|заявитель соответствует критериям, утверждаемым Правительством Российской Федерации;
							|2 – иной признак'");
	Элементы.ОсобыйПризнакЗаявителяДОПП.Подсказка = ПодсказкаОсобыйПризнак;
...
Процедура НастроитьВидимостьЭлементовОплатыЭСФССЛокализация(Форма)
