...
Функция ПолучитьСостоянияКонтрагентовИзКэша(ДанныеКонтрагентов)
	...
	Запрос.Текст =	
		...
		|		ЛЕВОЕ СОЕДИНЕНИЕ РегистрСведений.ПриглашенияКОбменуЭлектроннымиДокументами КАК ПриглашенияРеквизитыКонтрагентов
		...
		|		И ПриглашенияРеквизитыКонтрагентов.Статус В (&СтатусыПриглашенийСИзвестнымИдентификаторомКонтрагента)
...
Процедура ПриОпределенииМетодовРазрешенныхДляВызоваКакПроизвольныйКод(Методы) Экспорт
	...
	Методы.Вставить("ОбновитьДанныеАбонентаИзСервисаНастроекПоИдентификатору", Истина);
	Методы.Вставить("ПолучитьИдентификаторыВСервисе1СЭДОПоРеквизитам", Истина);
	Методы.Вставить("ПроверитьКонтрагентаФоновоеЗадание", Истина);
	Методы.Вставить("ПроверитьКонтрагентовРегламентноеЗаданиеВыполнения", Истина);
	Методы.Вставить("ПроверитьКонтрагентовРегламентноеЗаданиеУправления", Истина);
	Методы.Вставить("РейтингУчетныхЗаписей", Истина);
