...
//  ПараметрыОпределения           - см. ОбменДаннымиИСКлиентСервер.ПараметрыОпределенияДоступностиДействий
//
Процедура ОпределитьДоступностьДействий(Контекст, ИменаКолонокДальнейшиеДействия, ПараметрыОпределения = Неопределено) Экспорт
	...
	Если ПараметрыОпределения <> Неопределено Тогда
		Если ПараметрыОпределения.Подсистема = "ЗЕРНО" Тогда
			МодульИнтеграцияЗЕРНОКлиентСервер = ОбщегоНазначенияКлиент.ОбщийМодуль("ИнтеграцияЗЕРНОКлиентСервер");
			ИменаРеквизитов = МодульИнтеграцияЗЕРНОКлиентСервер.ИменаРеквизитовОпределенияДоступностиДействий();
		ИначеЕсли ПараметрыОпределения.Подсистема = "ИСМП" Тогда
			МодульОбменДаннымиИСМПКлиентСервер = ОбщегоНазначенияКлиент.ОбщийМодуль("ОбменДаннымиИСМПКлиентСервер");
			ИменаРеквизитов = МодульОбменДаннымиИСМПКлиентСервер.ИменаРеквизитовОпределенияДоступностиДействий();
		ИначеЕсли ПараметрыОпределения.Подсистема = "САТУРН" Тогда
			МодульИнтеграцияСАТУРНСлужебныйКлиентСервер = ОбщегоНазначенияКлиент.ОбщийМодуль("ИнтеграцияСАТУРНСлужебныйКлиентСервер");
			ИменаРеквизитов = МодульИнтеграцияСАТУРНСлужебныйКлиентСервер.ИменаРеквизитовОпределенияДоступностиДействий(
				ПараметрыОпределения.Префикс);
		КонецЕсли;
	КонецЕсли;
	...
	Если ДокументыДляПолученияРеквизитов.Количество() Тогда
		...
		Если ПараметрыОпределения.Подсистема = "ЗЕРНО" Тогда
			МодульВызовСервера = ОбщегоНазначенияКлиент.ОбщийМодуль("ИнтеграцияЗЕРНОВызовСервера");
		ИначеЕсли ПараметрыОпределения.Подсистема = "ИСМП" Тогда
			МодульВызовСервера = ОбщегоНазначенияКлиент.ОбщийМодуль("ОбменДаннымиИСМПВызовСервера");
		ИначеЕсли ПараметрыОпределения.Подсистема = "САТУРН" Тогда
			МодульВызовСервера = ОбщегоНазначенияКлиент.ОбщийМодуль("ИнтеграцияСАТУРНВызовСервера");
		КонецЕсли;
		
		ЗначенияРеквизитов = МодульВызовСервера.ЗначенияРеквизитовДляОпределенияДоступностиДействий(
			ДокументыДляПолученияРеквизитов, ПараметрыОпределения);
