...
Процедура ДополнитьПрофиль(ОписаниеПрофиля, ИмяПрофиля) Экспорт
	...
	ИначеЕсли ИмяПрофиля = "РаботникСклада" Тогда
		ДополнитьПрофильРаботникСклада(ОписаниеПрофиля);
...
Процедура ДополнитьПрофильДиспетчерПроизводства(ОписаниеПрофиля)
	...
	ОписаниеПрофиля.Роли.Добавить("ИспользованиеОбработкиПроверкаИПодборПродукцииИС");
...
Процедура ДополнитьПрофильРаботникСклада(ОписаниеПрофиля)
