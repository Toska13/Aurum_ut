...
// Открывает форму для выбора значения набора корректировок с установленными отборами.
//
// Параметры:
//	СписокПараметров - Структура:
//		* Организация - СправочникСсылка.Организации - отбор по владельцу.
//	ПараметрыФормы - Структура - Содержит параметры, передаваемые в форму.
//	Элемент - ПолеФормы - Элемент формы, из которого вызвана форма выбора.
//
Процедура ОткрытьФормуВыбораКорректировкиПрошлыхПериодовНУ(СписокПараметров, ПараметрыФормы, Элемент) Экспорт
