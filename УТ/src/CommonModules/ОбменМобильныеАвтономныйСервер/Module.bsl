...
// Функция получает код узла плана обмена Мобильные автономной конфигурации для текущего сеанса
// Возвращаемое значение:
...
// Процедура создает узел плана обмена Мобильные для автономной конфигурации 
Процедура СоздатьУзелОбмена() Экспорт
	...
	НовыйКод = ОсновнойСервер.ОбменМобильныеВызовПК.СоздатьУзелОбмена(КодУзла, НаименованиеУзла);
...
// Функция запускает фоновое задание для создания узла плана обмена Мобильные
// Возвращаемое значение:
//  УникальныйИдентификатор
//
Функция СоздатьУзелОбменаВФоне() Экспорт
	
	Задание = ФоновыеЗадания.Выполнить("ОбменМобильныеАвтономныйСервер.СоздатьУзелОбмена");
	Возврат Задание.УникальныйИдентификатор;
