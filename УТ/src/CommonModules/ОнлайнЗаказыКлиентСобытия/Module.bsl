...
Процедура ПриВыбореНастройкиПодключения(Владелец, Оповещение, СпособОплаты) Экспорт
	...
	ИначеЕсли СпособОплаты = ПредопределенноеЗначение("Перечисление.СпособыОплатыОнлайнЗаказов.Эквайринг")
		...
		ПараметрыОткрытия.Подсистема = МодульНастройкиПлатежныхСистемКлиентСервер.ИмяПодсистемыИнтернетЭквайринг();
	...
	ИначеЕсли СпособОплаты = ПредопределенноеЗначение("Перечисление.СпособыОплатыОнлайнЗаказов.ЯндексПэй")
		И ОбщегоНазначенияКлиент.ПодсистемаСуществует("ИнтернетПоддержкаПользователей.ПлатежныеСистемы.ЯндексПэй") Тогда
		
		ПараметрыОткрытия.Подсистема = МодульНастройкиПлатежныхСистемКлиентСервер.ИмяПодсистемыЯндексПэй();
...
// Определяет поведение системы при подключении платежной системы.
//
// Параметры:
//  СпособОплаты - ПеречислениеСсылка.СпособыОплатыОнлайнЗаказов - способ оплаты по настройке подключения.
...
Процедура ПриПодключенииПлатежнойСистемы(СпособОплаты, ОповещениеОЗавершении) Экспорт
	...
	ИначеЕсли СпособОплаты = ПредопределенноеЗначение("Перечисление.СпособыОплатыОнлайнЗаказов.ЯндексПэй") Тогда
