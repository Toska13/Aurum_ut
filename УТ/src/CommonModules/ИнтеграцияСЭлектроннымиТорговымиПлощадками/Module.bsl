...
Процедура ПриОпределенииМетодовРазрешенныхДляВызоваКакПроизвольныйКод(Методы) Экспорт
	...
	Методы.Вставить("ПроверитьСвязьСЭТПБидзаарДляПоставщиков", Истина);
	Методы.Вставить("ПроверитьСвязьСЭТПБидзаарДляПокупателей", Истина);
	Методы.Вставить("ПубликацияТоваровИУслугБидзаар", Истина);
	Методы.Вставить("ПубликацияЗапросаКоммерческихПредложенийБидзаар", Истина);
	Методы.Вставить("ОбновлениеЗапросаКоммерческихПредложенийБидзаар", Истина);
	Методы.Вставить("ПолучениеФайловКоммерческихПредложенийБидзаар", Истина);
	Методы.Вставить("ЗапросТекущихСостоянийОпубликованныхДокументовБидзаар", Истина);
	Методы.Вставить("ПолучениеДанныхКоммерческихПредложенийПоЗапросуБидзаар", Истина);
	Методы.Вставить("ПолучениеДанныхУчастниковПоЗапросуБидзаар", Истина);
	Методы.Вставить("ПодборКлючевыхСловДляЗапросаКоммерческихПредложенийБидзаар", Истина);
	Методы.Вставить("КлючевыеСловаБидзаар", Истина);
...
Функция ТекстОшибкиПоКодуОтвета(Результат = Неопределено, ПараметрыЗапроса = Неопределено)
	...
	Если ТипЗнч(Результат) = Тип("Структура") Тогда
		...
		Если Не ПустаяСтрока(ТекстОтвета) И КодОтвета <> 200 Тогда
			Попытка
				// В некоторых случаях сервис может вернуть произвольный ответ,
				// при попытке преобразования может происходить ошибка.
