...
// Возвращает параметры определения доступности действий.
//
// Возвращаемое значение:
//  Структура - Параметры определения доступности действий:
//    * Подсистема - Строка - Подсистема, для которой определяется доступность действий.
//    * Префикс - Строка - Префикс реквизитов
Функция ПараметрыОпределенияДоступностиДействий() Экспорт
	
	ВозвращаемоеЗначение = Новый Структура;
	ВозвращаемоеЗначение.Вставить("Подсистема", "");
