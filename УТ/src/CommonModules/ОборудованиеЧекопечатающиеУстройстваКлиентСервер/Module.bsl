...
Функция ПараметрыФискальнойСтрокиЧека() Экспорт;
	...
	// Дополнительные атрибуты для формирования данных отчета о выбытии МТ для ЛМ ЧЗ.
	ПараметрыСтроки.Вставить("НормализованныйКодМаркировки"); // Строка,Необязательно - Нормализованный код маркировки.
	...
	ПараметрыСтроки.Вставить("ИспользованСертификатФСС", Ложь); // Булево,Необязательно - Признак реализации позиции с использованием Сертификатов ФСС
...
Функция ПараметрыЗапросКМ() Экспорт
	...
	// Служебные поля
	Параметры.Вставить("ПараметрыXML", "");
...
// Получить cтатус cостояния из XML пакета.
//             
// Параметры:
//  ДанныеXML - Строка, XML текст
// 
// Возвращаемое значение:
//  Структура.
//
Функция ПолучитьСтатусСостоянияИзXMLПакета(ДанныеXML) Экспорт
	
	ПараметрыСтатус = ОборудованиеЧекопечатающиеУстройстваКлиентСервер.ПараметрыСтатусСостоянияПИоТ();
	Параметры = ОбщегоНазначенияБПОКлиентСервер.ПрочитатьПараметрыИзXML(ДанныеXML);
...
//  Структура.
//
Функция ПолучитьПараметрыРезультатаИзXMLПакета(ДанныеXML) Экспорт
...
//  Структура.
//
Функция ПолучитьСлужебнуюИнформациюИзXMLПакета(ДанныеXML) Экспорт
