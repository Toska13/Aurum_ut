...
// Определяет необходимость вызова новых процедур общего модуля ОбменСКонтрагентамиПереопределяемый
// для отражения электронных документов в учет. Используется для поддержки обратной совместимости.
// После поддержки новой процедуры необходимо установить соответствующему свойству значение Истина.
//
// Параметры:
//  ОбработчикиОтражения - Структура - поддерживаемые процедуры:
//   * ПриОтраженииВУчетеУниверсальногоКорректировочногоДокумента_2020 - Булево - поддержана новая процедура
//      вместо устаревшего метода НайтиСоздатьУКД_2020. По умолчанию установлено Ложь.
//   * ПриОтраженииВУчетеУниверсальногоКорректировочногоДокумента_2016 - Булево - поддержана новая процедура
//      вместо устаревшего метода НайтиСоздатьУниверсальныйКорректировочныйДокумент. По умолчанию установлено Ложь.
//   * ПриОтраженииВУчетеУниверсальногоПередаточногоДокумента_5_02 - Булево - поддержана новая процедура
//      вместо устаревшего метода НайтиСоздатьУниверсальныйПередаточныйДокумент_5_02. По умолчанию установлено Ложь.
//   * ПриОтраженииВУчетеУниверсальногоПередаточногоДокумента_5_03 - Булево - поддержана новая процедура
//      вместо устаревшего метода НайтиСоздатьУниверсальныйПередаточныйДокумент_5_03. По умолчанию установлено Ложь.
//   * ПриОтраженииВУчетеУниверсальногоПередаточногоДокумента_2019 - Булево - поддержана новая процедура
//      вместо устаревшего метода НайтиСоздатьУниверсальныйПередаточныйДокумент_2019. По умолчанию установлено Ложь.
//   * ПриОтраженииВУчетеУниверсальногоПередаточногоДокумента_2016 - Булево - поддержана новая процедура
//      вместо устаревшего метода НайтиСоздатьУниверсальныйПередаточныйДокумент. По умолчанию установлено Ложь.
//   * ПриОтраженииВУчетеДокументаПередачаТоваров - Булево - поддержана новая процедура
//      вместо устаревшего метода НайтиСоздатьДокументПередачаТоваров. По умолчанию установлено Ложь.
//   * ПриОтраженииВУчетеДокументаПередачаРезультатовРабот - Булево - поддержана новая процедура
//      вместо устаревшего метода НайтиСоздатьДокументПередачаРезультатовРабот. По умолчанию установлено Ложь.
//   * ПриОтраженииВУчетеДокументаАктОРасхождениях_ФНС_2019 - Булево - поддержана новая процедура
//      вместо устаревшего метода НайтиСоздатьАктОРасхождениях_ФНС_2019. По умолчанию установлено Ложь.
//   * ПриОтраженииВУчетеДокументаАктОПриемкеСтроительныхРаботУслуг - Булево - поддержана новая процедура
//      вместо устаревшего метода НайтиСоздатьАктОПриемкеСтроительныхРаботУслуг. По умолчанию установлено Ложь.
//   * ПриОтраженииВУчетеДокументаАктСверкиВзаиморасчетов - Булево - поддержана новая процедура
//      вместо устаревшего метода НайтиСоздатьАктСверкиВзаиморасчетов. По умолчанию установлено Ложь.
//   * ПриОтраженииВУчетеДокументаСчетНаОплату101 - Булево - поддержана новая процедура
//      вместо устаревшего метода НайтиСоздатьСчетНаОплату101. По умолчанию установлено Ложь.
//   * ПриОтраженииВУчетеДокументаСчетНаОплату_5_01 - Булево - поддержана новая процедура
//      вместо устаревшего метода НайтиСоздатьСчетНаОплату_5_01. По умолчанию установлено Ложь.
//   * ПриОтраженииВУчетеДоговорногоДокументаXML - Булево - поддержана новая процедура
//      вместо устаревшего метода НайтиСоздатьДоговорныйДокументXML. По умолчанию установлено Ложь.
//   * ПриОтраженииВУчетеДоговорногоДокумента101 - Булево - поддержана новая процедура
//      вместо устаревшего метода ПриОтраженииВУчетеДоговорногоДокумента101. По умолчанию установлено Ложь.
//   * ПриОтраженииВУчетеДокументаCML - Булево - поддержана новая процедура
//      вместо устаревшего метода СохранитьДанныеОбъектаВБД. По умолчанию установлено Ложь.
//   * ПриОтраженииВУчетеДокументаЗапросКоммерческихПредложений - Булево - поддержана новая процедура
//      вместо устаревшего метода НайтиСоздатьЗапросКоммерческихПредложений. По умолчанию установлено Ложь.
//   * ПриОтраженииВУчетеДокументаКоммерческоеПредложение - Булево - поддержана новая процедура
//      вместо устаревшего метода НайтиСоздатьКоммерческоеПредложение. По умолчанию установлено Ложь.
//   * ПриОтраженииВУчетеДокументаПредприятия - Булево - поддержана новая процедура
//      вместо устаревшего метода НайтиСоздатьДокументПредприятия. По умолчанию установлено Ложь.
//
Процедура ПриОпределенииОбработчикаПриОтраженииЭлектронногоДокумента(ОбработчикиОтражения) Экспорт

	//++ НЕ ГОСИС
	ОбменСКонтрагентамиУТ.ПриОпределенииОбработчикаПриОтраженииЭлектронногоДокумента(ОбработчикиОтражения);
	//-- НЕ ГОСИС
	
КонецПроцедуры

// Определяет настройки подключаемых команд ЭДО.
//
// Параметры:
//  Настройки - см. ОбменСКонтрагентамиКлиентСервер.НовыйНастройкиПодключаемыхКомандЭДО
//
Процедура ПриОпределенииНастроекПодключаемыхКомандЭДО(Настройки) Экспорт
...
//
Процедура ПриОтраженииВУчетеДокументаТЭДО(ДокументУчета, Знач СпособОбработки, Знач ДанныеТЭДО, ОписаниеОшибки) Экспорт
	
	//++ НЕ ГОСИС
	ОбменСКонтрагентамиУТ.ПриОтраженииВУчетеДокументаТЭДО(ДокументУчета, СпособОбработки, ДанныеТЭДО, ОписаниеОшибки);
	//-- НЕ ГОСИС
...
Процедура ЗаполнитьДанныеПакетаПоОбъектуУчета(Данные, ОбъектУчета, Параметры, Отказ) Экспорт
	...
	//++ НЕ ГОСИС
	Данные = ОбменСКонтрагентамиУТ.ЗаполнитьОтветныйТитулПоОбъектуУчетаТЭДО(ОбъектУчета, Параметры);
	//-- НЕ ГОСИС
...
// Поиск и создание учетных документов при отражении в учете документа УКД (информация продавца).
// Вызывается для УКД всех возможных функций (КСЧФ, КСЧФДИС, ДИС).
//
// Параметры:
//  РезультатОтраженияВУчете - см. ОтражениеВУчетеЭДО.НовыйРезультатОтраженияВУчете
//  ДанныеЭлектронногоДокумента - ДеревоЗначений - данные электронного документа в виде заполненного макета
//                                 см. Обработка.ОбменСКонтрагентами.Макет.УКД_ИнформацияПродавца_2020.
//  ПараметрыДляОтраженияВУчете - Структура - данные для заполнения электронного документа:
...
Процедура ПриОтраженииВУчетеУниверсальногоКорректировочногоДокумента_2020(РезультатОтраженияВУчете, Знач ДанныеЭлектронногоДокумента,
	...
	//++ НЕ ГОСИС
	ОбменСКонтрагентамиУТ.ПриОтраженииВУчетеУниверсальногоКорректировочногоДокумента_2020(РезультатОтраженияВУчете,
		ДанныеЭлектронногоДокумента, ПараметрыДляОтраженияВУчете);
	//-- НЕ ГОСИС
...
// Поиск и создание учетных документов при отражении в учете документа УПД (информация продавца).
// Вызывается для УПД всех возможных функций (СЧФ, СЧФДОП, ДОП). Формат по приказу ЕД-7-26/970@.
//
// Параметры:
//  РезультатОтраженияВУчете - см. ОтражениеВУчетеЭДО.НовыйРезультатОтраженияВУчете
//  ДанныеЭлектронногоДокумента - ДеревоЗначений - данные электронного документа в виде заполненного макета
...
Процедура ПриОтраженииВУчетеУниверсальногоПередаточногоДокумента_5_02(РезультатОтраженияВУчете, Знач ДанныеЭлектронногоДокумента,
	...
	//++ НЕ ГОСИС
	ОбменСКонтрагентамиУТ.ПриОтраженииВУчетеУниверсальногоПередаточногоДокумента_5_02(РезультатОтраженияВУчете,
		ДанныеЭлектронногоДокумента, ПараметрыДляОтраженияВУчете);
	//-- НЕ ГОСИС
...
// Поиск и создание учетных документов при отражении в учете документа УПД (информация продавца).
// Вызывается для УПД всех возможных функций (СЧФ, СЧФДОП, ДОП). Формат по приказу ЕД-7-26/1032@.
//
// Параметры:
//  РезультатОтраженияВУчете - см. ОтражениеВУчетеЭДО.НовыйРезультатОтраженияВУчете
//  ДанныеЭлектронногоДокумента - ДеревоЗначений - данные электронного документа в виде заполненного макета
//                                 см. Обработка.ОбменСКонтрагентами.Макет.УПД_ИнформацияПродавца_5_03.
//  ПараметрыДляОтраженияВУчете - Структура - данные для заполнения электронного документа:
//   * ПараметрыЭлектронногоДокумента - см. ОтражениеВУчетеЭДО.НовыеПараметрыЭлектронногоДокумента
//   * ПараметрыСпособаОбмена - см. ОтражениеВУчетеЭДО.НовыеПараметрыСпособаОбмена
//   * ПараметрыПоФорматуДокумента - Структура - дополнительные параметры по формату документа для отражения в учете:
...
// Поиск и создание учетных документов при отражении в учете документа УПД (информация продавца).
// Вызывается для УПД всех возможных функций (СЧФ, СЧФДОП, ДОП). Формат по приказу ММВ-7-15/820@.
// Поиск и создание учетных документов при отражении в учете документа УПД (информация продавца).
// Вызывается для УПД всех возможных функций (СЧФ, СЧФДОП, ДОП). Формат по приказу ЕД-7-26/1032@.
//
// Параметры:
...
Процедура ПриОтраженииВУчетеУниверсальногоПередаточногоДокумента_2019(РезультатОтраженияВУчете, Знач ДанныеЭлектронногоДокумента,
	...
	//++ НЕ ГОСИС
	ОбменСКонтрагентамиУТ.ПриОтраженииВУчетеУниверсальногоПередаточногоДокумента_2019(РезультатОтраженияВУчете,
		ДанныеЭлектронногоДокумента, ПараметрыДляОтраженияВУчете);
	//-- НЕ ГОСИС	
...
// Поиск и создание учетных документов при отражении в учете документа УПД (информация продавца).
// Вызывается для УПД всех возможных функций (СЧФ, СЧФДОП, ДОП). Формат по приказу ММВ-7-15/155@.
//
// Параметры:
//  РезультатОтраженияВУчете - см. ОтражениеВУчетеЭДО.НовыйРезультатОтраженияВУчете
//  ДанныеЭлектронногоДокумента - ДеревоЗначений - данные электронного документа в виде заполненного макета
...
//        *** СчетФактура       - Строка - способ сохранения счета-фактуры.
//
Процедура ПриОтраженииВУчетеУниверсальногоПередаточногоДокумента_2016(РезультатОтраженияВУчете,
	Знач ДанныеЭлектронногоДокумента, Знач ПараметрыДляОтраженияВУчете) Экспорт

	//++ НЕ ГОСИС
	ОбменСКонтрагентамиУТ.ПриОтраженииВУчетеУниверсальногоПередаточногоДокумента_2016(РезультатОтраженияВУчете,
		ДанныеЭлектронногоДокумента, ПараметрыДляОтраженияВУчете);
	//-- НЕ ГОСИС	
...
// Поиск и создание учетных документов при отражении в учете документа УКД (информация продавца).
// Вызывается для УКД всех возможных функций (КСЧФ, КСЧФДИС, ДИС). Формат по приказу ММВ-7-15/189@.
//
// Параметры:
//  РезультатОтраженияВУчете - см. ОтражениеВУчетеЭДО.НовыйРезультатОтраженияВУчете
//  ДанныеЭлектронногоДокумента - ДеревоЗначений - данные электронного документа в виде заполненного макета
...
Процедура ПриОтраженииВУчетеУниверсальногоКорректировочногоДокумента_2016(РезультатОтраженияВУчете, Знач ДанныеЭлектронногоДокумента,
	...
	//++ НЕ ГОСИС
	ОбменСКонтрагентамиУТ.ПриОтраженииВУчетеУниверсальногоКорректировочногоДокумента_2016(РезультатОтраженияВУчете,
		ДанныеЭлектронногоДокумента, ПараметрыДляОтраженияВУчете);
	//-- НЕ ГОСИС	
...
Процедура ПриОтраженииВУчетеДокументаПередачаТоваров(РезультатОтраженияВУчете, Знач ДанныеЭлектронногоДокумента,
	...
	//++ НЕ ГОСИС
	ОбменСКонтрагентамиУТ.ПриОтраженииВУчетеДокументаПередачаТоваров(РезультатОтраженияВУчете,
		ДанныеЭлектронногоДокумента, ПараметрыДляОтраженияВУчете);
	//-- НЕ ГОСИС	
...
Процедура ПриОтраженииВУчетеДокументаПередачаРезультатовРабот(РезультатОтраженияВУчете, Знач ДанныеЭлектронногоДокумента,
	...
	//++ НЕ ГОСИС
	ОбменСКонтрагентамиУТ.ПриОтраженииВУчетеДокументаПередачаРезультатовРабот(РезультатОтраженияВУчете,
		ДанныеЭлектронногоДокумента, ПараметрыДляОтраженияВУчете);
	//-- НЕ ГОСИС	
...
//  Данные - ДеревоЗначений - данные для заполнения электронного документа. Строится по макету 
//                            см. Обработка.ОбменСКонтрагентами.Макет.АктОРасхождениях_ИнформацияОтправителя_5_01. Выходной параметр.
//  Описание - Структура - дополнительная информация о документе. Выходной параметр:
//   * Основания - Массив из ОпределяемыйТип.ОснованияЭлектронныхДокументовЭДО - ссылки на дополнительные объекты-основания
//                 электронного документа помимо указанного в параметре "Основание".
//  Отказ - Булево - признак отказа от дальнейшего формирования электронного документа.
...
//  Основание - ОпределяемыйТип.ОснованияЭлектронныхДокументовЭДО - основание для электронного документа.
//  Данные - ДеревоЗначений - данные для заполнения электронного документа. Строится по макету 
//                            см. Обработка.ОбменСКонтрагентами.Макет.АктОРасхождениях_ДополнительныеСведения_5_01. Выходной параметр.
//  Отказ - Булево - признак отказа от дальнейшего формирования электронного документа.
//                   Информационное сообщение пользователю необходимо формировать самостоятельно.
//
Процедура ЗаполнитьДанныеАктОРасхождениях_ДополнительныеСведения(Знач Основание, Данные, Отказ) Экспорт
	...
	//++ НЕ ГОСИС
	ОбменСКонтрагентамиУТ.ЗаполнитьДанныеАктОРасхождениях_ДополнительныеСведения(Основание, Данные, Отказ);
	//-- НЕ ГОСИС
...
//  РезультатОтраженияВУчете - см. ОтражениеВУчетеЭДО.НовыйРезультатОтраженияВУчете
//  ДанныеЭлектронногоДокумента - ДеревоЗначений - данные электронного документа в виде заполненного макета
//                                 см. Обработка.ОбменСКонтрагентами.Макет.АктОРасхождениях_ИнформацияОтправителя_5_01.
//  ПараметрыДляОтраженияВУчете - Структура - данные для заполнения электронного документа:
//   * ПараметрыЭлектронногоДокумента - см. ОтражениеВУчетеЭДО.НовыеПараметрыЭлектронногоДокумента
//   * ПараметрыСпособаОбмена - см. ОтражениеВУчетеЭДО.НовыеПараметрыСпособаОбмена
//   * ПараметрыПоФорматуДокумента - Структура - дополнительные параметры по формату документа для отражения в учете:
...
Процедура ПриОтраженииВУчетеДокументаАктОРасхождениях_ФНС_2019(РезультатОтраженияВУчете, Знач ДанныеЭлектронногоДокумента,
	...
	//++ НЕ ГОСИС
	ОбменСКонтрагентамиУТ.ПриОтраженииВУчетеДокументаАктОРасхождениях_ФНС_2019(РезультатОтраженияВУчете,
		ДанныеЭлектронногоДокумента, ПараметрыДляОтраженияВУчете);
	//-- НЕ ГОСИС	
...
// Параметры:
//  РезультатОтраженияВУчете - см. ОтражениеВУчетеЭДО.НовыйРезультатОтраженияВУчете
//  ДанныеЭлектронногоДокумента - ОбработкаОбъект.ФорматАктПриемкиСтроительныхРаботИнформацияПодрядчикаЭДО
//  ПараметрыДляОтраженияВУчете - Структура - данные для заполнения электронного документа:
//   * ПараметрыЭлектронногоДокумента - см. ОтражениеВУчетеЭДО.НовыеПараметрыЭлектронногоДокумента
//   * ПараметрыСпособаОбмена - см. ОтражениеВУчетеЭДО.НовыеПараметрыСпособаОбмена
//   * ПараметрыПоФорматуДокумента - Структура - дополнительные параметры по формату документа для отражения в учете:
...
//          См. ОбменСКонтрагентамиПереопределяемый.ПриОпределенииСпособовОбработкиПрикладногоТипаЭлектронногоДокумента
//
Процедура ПриОтраженииВУчетеДокументаАктОПриемкеСтроительныхРаботУслуг(РезультатОтраженияВУчете, Знач ДанныеЭлектронногоДокумента,
	Знач ПараметрыДляОтраженияВУчете) Экспорт
...
//          См. ОбменСКонтрагентамиПереопределяемый.ПриОпределенииСпособовОбработкиПрикладногоТипаЭлектронногоДокумента
//
Процедура ПриОтраженииВУчетеДокументаАктСверкиВзаиморасчетов(РезультатОтраженияВУчете, Знач ДанныеЭлектронногоДокумента,
	Знач ПараметрыДляОтраженияВУчете) Экспорт

	//++ НЕ ГОСИС
	ОписаниеЗамера = ОценкаПроизводительности.НачатьЗамерДлительнойОперации(
		"ОбщийМодуль.ОбменСКонтрагентамиПереопределяемый.ПриОтраженииВУчетеДокументаАктСверкиВзаиморасчетов");
	ОбменСКонтрагентамиУТ.ПриОтраженииВУчетеДокументаАктСверкиВзаиморасчетов(РезультатОтраженияВУчете,
		ДанныеЭлектронногоДокумента, ПараметрыДляОтраженияВУчете);
	ОценкаПроизводительности.ЗакончитьЗамерДлительнойОперации(ОписаниеЗамера, 1);
	//-- НЕ ГОСИС	
...
//          См. ОбменСКонтрагентамиПереопределяемый.ПриОпределенииСпособовОбработкиПрикладногоТипаЭлектронногоДокумента
//
Процедура ПриОтраженииВУчетеДокументаСчетНаОплату101(РезультатОтраженияВУчете, Знач ДанныеЭлектронногоДокумента,
	Знач ПараметрыДляОтраженияВУчете) Экспорт

	//++ НЕ ГОСИС
	ОбменСКонтрагентамиУТ.ПриОтраженииВУчетеДокументаСчетНаОплату101(РезультатОтраженияВУчете,
		ДанныеЭлектронногоДокумента, ПараметрыДляОтраженияВУчете);
	//-- НЕ ГОСИС	
...
Процедура ЗаполнитьДанныеПоСчетуНаОплату_5_01(Знач Основание, Знач Настройки, Данные, Описание, Отказ) Экспорт
	...
	//++ НЕ ГОСИС
	ОбменСКонтрагентамиУТ.ЗаполнитьДанныеПоСчетуНаОплату_5_01(Основание, Настройки, Данные, Описание, Отказ);
	//-- НЕ ГОСИС
...
//          См. ОбменСКонтрагентамиПереопределяемый.ПриОпределенииСпособовОбработкиПрикладногоТипаЭлектронногоДокумента
//
Процедура ПриОтраженииВУчетеДокументаСчетНаОплату_5_01(РезультатОтраженияВУчете, Знач ДанныеЭлектронногоДокумента,
	Знач ПараметрыДляОтраженияВУчете) Экспорт

	//++ НЕ ГОСИС
	ОбменСКонтрагентамиУТ.ПриОтраженииВУчетеДокументаСчетНаОплату_5_01(РезультатОтраженияВУчете,
		ДанныеЭлектронногоДокумента, ПараметрыДляОтраженияВУчете);
	//-- НЕ ГОСИС	
...
// Формат по приказу ЕД-7-26/236@.
//
//
// Параметры:
//  РезультатОтраженияВУчете - см. ОтражениеВУчетеЭДО.НовыйРезультатОтраженияВУчете
//  ДанныеЭлектронногоДокумента - ОбработкаОбъект.ФорматДоговорныйДокумент101
//  ПараметрыДляОтраженияВУчете - Структура - данные для заполнения электронного документа:
//   * ПараметрыЭлектронногоДокумента - см. ОтражениеВУчетеЭДО.НовыеПараметрыЭлектронногоДокумента
//   * ПараметрыСпособаОбмена - см. ОтражениеВУчетеЭДО.НовыеПараметрыСпособаОбмена
//   * ПараметрыПоФорматуДокумента - Структура - дополнительные параметры по формату документа для отражения в учете:
...
//          См. ОбменСКонтрагентамиПереопределяемый.ПриОпределенииСпособовОбработкиПрикладногоТипаЭлектронногоДокумента
//
Процедура ПриОтраженииВУчетеДоговорногоДокумента101(РезультатОтраженияВУчете, Знач ДанныеЭлектронногоДокумента,
	Знач ПараметрыДляОтраженияВУчете) Экспорт

	//++ НЕ ГОСИС
	ОбменСКонтрагентамиУТ.ПриОтраженииВУчетеДоговорногоДокумента101(РезультатОтраженияВУчете,
		ДанныеЭлектронногоДокумента, ПараметрыДляОтраженияВУчете);
	//-- НЕ ГОСИС
...
// Параметры:
//  РезультатОтраженияВУчете - см. ОтражениеВУчетеЭДО.НовыйРезультатОтраженияВУчете
//  ДанныеЭлектронногоДокумента - ОбъектXDTO
//  ПараметрыДляОтраженияВУчете - Структура - данные для заполнения электронного документа:
//   * ПараметрыЭлектронногоДокумента - см. ОтражениеВУчетеЭДО.НовыеПараметрыЭлектронногоДокумента
//   * ПараметрыСпособаОбмена - см. ОтражениеВУчетеЭДО.НовыеПараметрыСпособаОбмена
//   * ПараметрыПоФорматуДокумента - Структура - дополнительные параметры по формату документа для отражения в учете:
...
//          См. ОбменСКонтрагентамиПереопределяемый.ПриОпределенииСпособовОбработкиПрикладногоТипаЭлектронногоДокумента
//
Процедура ПриОтраженииВУчетеДоговорногоДокументаXML(РезультатОтраженияВУчете, Знач ДанныеЭлектронногоДокумента,
	Знач ПараметрыДляОтраженияВУчете) Экспорт

	//++ НЕ ГОСИС
	ОбменСКонтрагентамиУТ.ПриОтраженииВУчетеДоговорногоДокументаXML(РезультатОтраженияВУчете,
		ДанныеЭлектронногоДокумента, ПараметрыДляОтраженияВУчете);
	//-- НЕ ГОСИС	
...
// Поиск и создание учетного документа при отражении в учете документа CML формата.
//
// Параметры:
//  РезультатОтраженияВУчете - см. ОтражениеВУчетеЭДО.НовыйРезультатОтраженияВУчете
//  ДанныеЭлектронногоДокумента - СтрокаДереваЗначений - строка дерева, описывающая данные электронного документа.
//                                 Реквизиты документа содержатся в подчиненных строках.
//  ПараметрыДляОтраженияВУчете - Структура - данные для заполнения электронного документа:
//   * ПараметрыЭлектронногоДокумента - см. ОтражениеВУчетеЭДО.НовыеПараметрыЭлектронногоДокумента
//   * ПараметрыСпособаОбмена - см. ОтражениеВУчетеЭДО.НовыеПараметрыСпособаОбмена
//   * ПараметрыПоФорматуДокумента - Структура - дополнительные параметры по формату документа для отражения в учете:
//     ** СпособОбработки - Строка - способ сохранения данных в информационной базе.
//                       См. ОбменСКонтрагентамиПереопределяемый.ПриОпределенииСпособовОбработкиПрикладногоТипаЭлектронногоДокумента.
//     ** ДеревоСсылокНаОбъекты - ДеревоЗначений - дерево с найденными ссылками на учетные сущности
...
Процедура ПриОтраженииВУчетеДокументаCML(РезультатОтраженияВУчете, Знач ДанныеЭлектронногоДокумента,
	...
	//++ НЕ ГОСИС
	ОбменСКонтрагентамиУТ.ПриОтраженииВУчетеДокументаCML(РезультатОтраженияВУчете,
		ДанныеЭлектронногоДокумента, ПараметрыДляОтраженияВУчете);
	//-- НЕ ГОСИС	
...
//
//@skip-warning
Процедура ПриОтраженииВУчетеДокументаЗапросКоммерческихПредложений(РезультатОтраженияВУчете, Знач ДанныеЭлектронногоДокумента,
	Знач ПараметрыДляОтраженияВУчете) Экспорт
...
//
//@skip-warning
Процедура ПриОтраженииВУчетеДокументаКоммерческоеПредложение(РезультатОтраженияВУчете, Знач ДанныеЭлектронногоДокумента,
	Знач ПараметрыДляОтраженияВУчете) Экспорт
...
// Параметры:
//  РезультатОтраженияВУчете - см. ОтражениеВУчетеЭДО.НовыйРезультатОтраженияВУчете
//  ДанныеЭлектронногоДокумента - ОбработкаОбъект.ФорматДокументПредприятия
//  ПараметрыДляОтраженияВУчете - Структура - данные для заполнения электронного документа:
//   * ПараметрыЭлектронногоДокумента - см. ОтражениеВУчетеЭДО.НовыеПараметрыЭлектронногоДокумента
//   * ПараметрыСпособаОбмена - см. ОтражениеВУчетеЭДО.НовыеПараметрыСпособаОбмена
//   * ПараметрыПоФорматуДокумента - Структура - дополнительные параметры по формату документа для отражения в учете:
...
Процедура ИмяОбъектаМетаданныхПоСпособуОтраженияВУчете(СпособОтраженияВУчете, ИмяДокумента) Экспорт 
	...
	//++ НЕ ГОСИС
	ОбменСКонтрагентамиУТ.ИмяОбъектаМетаданныхПоСпособуОтраженияВУчете(СпособОтраженияВУчете, ИмяДокумента);
	//-- НЕ ГОСИС
...
//   * СуммаНДСДокумента - Число - сумма НДС документа.
//   
...
Процедура ПриОпределенииТипаУчастникаЭДО(ПроверяемоеЛицо, Признаки) Экспорт
	...
	//++ НЕ ГОСИС
	ОбменСКонтрагентамиУТ.ПриОпределенииТипаУчастникаЭДО(ПроверяемоеЛицо, Признаки);
	//-- НЕ ГОСИС
...
//     * ЭлектронныеПодписи              - см. ЭлектроннаяПодпись.ПодписиОбъекта - Список установленных подписей.
...
// Устарела. Следует использовать ПриОтраженииВУчетеУниверсальногоКорректировочногоДокумента_2020.
...
// Устарела. Следует использовать ПриОтраженииВУчетеУниверсальногоПередаточногоДокумента_5_02.
...
// Устарела. Следует использовать ПриОтраженииВУчетеУниверсальногоПередаточногоДокумента_5_03.
// Поиск и создание учетных документов при отражении в учете документа УПД (информация продавца). Вызывается для УПД всех
...
// Устарела. Следует использовать ПриОтраженииВУчетеУниверсальногоПередаточногоДокумента_2019.
// Поиск и создание учетных документов при отражении в учете документа УПД (информация продавца). Вызывается для УПД всех
...
// Устарела. Следует использовать ПриОтраженииВУчетеУниверсальногоПередаточногоДокумента_2016.
// Поиск и создание учетных документов при отражении в учете документа УПД (информация продавца). Вызывается для УПД всех
...
// Устарела. Следует использовать ПриОтраженииВУчетеУниверсальногоКорректировочногоДокумента_2016.
// Поиск и создание учетных документов при отражении в учете документа УКД (информация продавца). Вызывается для УКД всех
...
// Устарела. Следует использовать ПриОтраженииВУчетеДокументаПередачаТоваров.
// Поиск и создание учетного документа при отражении в учете документа Передача товаров (информация продавца).
// Формат по приказу ММВ-7-10/551@.
//
// Параметры:
...
// Устарела. Следует использовать ПриОтраженииВУчетеДокументаПередачаРезультатовРабот.
// Поиск и создание учетного документа при отражении в учете документа Передача результатов работ (информация продавца). 
// Формат по приказу ММВ-7-10/552@.
//
// Параметры:
...
// Устарела. Следует использовать ПриОтраженииВУчетеДокументаАктОРасхождениях_ФНС_2019.
// Поиск и создание учетного документа при отражении в учете документа Акт о расхождениях (информация покупателя).
// Формат по приказу ММВ-7-15/423@.
//
// Параметры:
...
// Устарела. Следует использовать ПриОтраженииВУчетеДокументаАктОПриемкеСтроительныхРаботУслуг.
// Поиск и создание учетного документа при отражении входящего электронного документа.
//
// Параметры:
//  КонструкторЭД - ОбработкаОбъект.ФорматАктПриемкиСтроительныхРаботИнформацияПодрядчикаЭДО
...
// Устарела. Следует использовать ПриОтраженииВУчетеДокументаАктСверкиВзаиморасчетов.
// Поиск и создание учетного документа при отражении в учете документа Акт сверки взаиморасчетов (информация отправителя).
// Формат по приказу ЕД-7-26/405@.
//
// Параметры:
...
// Устарела. Следует использовать ПриОтраженииВУчетеДокументаСчетНаОплату_5_01.
// Поиск и создание учетного документа при отражении в учете документа "Счет на оплату".
//
// Параметры:
//  ДеревоДанных		 - ДеревоЗначений - данные электронного документа в виде заполненного макета 
...
// Устарела. Следует использовать ПриОтраженииВУчетеДокументаСчетНаОплату101.
// Поиск и создание учетного документа при отражении в учете документа Счет на оплату.
// Тестовый формат ФНС.
//
// Параметры:
...
// Устарела. Следует использовать ПриОтраженииВУчетеДоговорногоДокумента101.
// Поиск и создание учетного документа при отражении в учете договорного документа формата PDF/A3.
// Формат по приказу.
//
// Параметры:
...
// Устарела. Следует использовать ПриОтраженииВУчетеДоговорногоДокументаXML.
// Поиск и создание учетного документа при отражении в учете договорного документа формата XML.
// Формат по приказу ЕД-7-26/115@.
//
// Параметры:
...
// Устарела. Следует использовать ПриОтраженииВУчетеДокументаCML.
...
// Устарела. Следует использовать ПриОтраженииВУчетеДокументаЗапросКоммерческихПредложений.
// Создание нового или перезаполнение существующего прикладного документа Запрос коммерческих предложений от клиента
// по данным входящего электронного документа.
// Если существует подсистема КоммерческиеПредложенияДокументы.ЗапросКоммерческогоПредложенияОтКлиента, обработчик
// не вызывается.
...
// Устарела. Следует использовать ПриОтраженииВУчетеДокументаКоммерческоеПредложение.
// Создание нового или перезаполнение существующего прикладного документа Коммерческое предложение поставщика
// по данным входящего электронного документа.
// Если существует подсистема КоммерческиеПредложенияДокументы.КоммерческоеПредложениеПоставщика, обработчик
// не вызывается.
...
// Устарела. Следует использовать ПриОтраженииВУчетеДокументаПредприятия.
// Поиск и создание учетного документа при отражении в учете документа предприятия.
//
// Параметры:
