...
Процедура ПриОпределенииМетодовРазрешенныхДляВызоваКакПроизвольныйКод(Методы) Экспорт
	Методы.Вставить("СинхронизацияТорговыхПредложенийОбработчикЗадания", Истина);
	Методы.Вставить("СинхронизацияТорговыхПредложений", Истина);
	Методы.Вставить("ПодсказкиПоКонтексту", Истина);
	Методы.Вставить("ОбновитьСтатистикуСинхронизации", Истина);
	Методы.Вставить("СоздатьПрочитатьКорзинуСохранитьРезультат", Истина);
	Методы.Вставить("СоздатьЗаказПеречитатьКорзинуСохранитьРезультат", Истина);
	Методы.Вставить("ВыполнитьДействиеСТоваромКорзиныСохранитьРезультат", Истина);
	Методы.Вставить("СоздатьКорзинуДобавитьТовар", Истина);
	Методы.Вставить("УдалитьКорзинуСохранитьРезультат", Истина);
	Методы.Вставить("ДеактивироватьРекомендациюСохранитьРезультат", Истина);
	Методы.Вставить("ОтразитьОткликНаРекомендациюСохранитьРезультат", Истина);
	Методы.Вставить("ПолучитьКатегорииТорговыхПредложенийСохранитьРезультат", Истина);
	Методы.Вставить("ПолучитьХарактеристикиКатегории", Истина);
	Методы.Вставить("ПроверитьЗаписиТорговыеПредложенияТорговойПлощадки", Истина);
	Методы.Вставить("ПолучитьВнешниеПрайсЛисты", Истина);
	Методы.Вставить("ДанныеТорговогоПредложенияДляВыводаВКарточку", Истина);
	Методы.Вставить("СформироватьПредставлениеТорговогоПредложения", Истина);
	Методы.Вставить("ПоместитьСкачанноеИзображениеПоАдресуХранилища", Истина);
	Методы.Вставить("ПоискТорговыхПредложенийПоОтборуВФоне", Истина);
	Методы.Вставить("ПоискТорговыхПредложенийПоСпискуВФоне", Истина);
	Методы.Вставить("ОбновитьТорговыеПредложенияТорговойПлощадки", Истина);
	Методы.Вставить("ПроверитьИзменениеПрайсЛистовВФоне", Истина);
КонецПроцедуры
...
Функция СоздатьПрочитатьКорзинуВФоне(ПараметрыМетода, УникальныйИдентификатор) Экспорт
	...
	Возврат ДлительныеОперации.ВыполнитьВФоне(
		"ТорговыеПредложенияСлужебный.СоздатьПрочитатьКорзинуСохранитьРезультат",
		ПараметрыМетода,
		ПараметрыВыполнения);
...
Функция СоздатьЗаказПеречитатьКорзинуВФоне(ПараметрыСозданияЗаказа, УникальныйИдентификатор) Экспорт
	...
	Возврат ДлительныеОперации.ВыполнитьВФоне(
		"ТорговыеПредложенияСлужебный.СоздатьЗаказПеречитатьКорзинуСохранитьРезультат",
		ПараметрыСозданияЗаказа,
		ПараметрыВыполнения);
...
Функция ВыполнитьДействиеСТоваромКорзиныВФоне(ПараметрыМетода, УникальныйИдентификатор) Экспорт
	...
	Возврат ДлительныеОперации.ВыполнитьВФоне(
		"ТорговыеПредложенияСлужебный.ВыполнитьДействиеСТоваромКорзиныСохранитьРезультат",
		ПараметрыМетода,
		ПараметрыВыполнения);
...
Процедура ВыполнитьДействиеСТоваромКорзиныСохранитьРезультат(Знач ПараметрыПроцедуры, Знач АдресРезультата) Экспорт
	...
	ИначеЕсли ПараметрыПроцедуры.ВидОперации = "Удаление" Тогда
		УдалитьТоварИзКорзины(
			ПараметрыПроцедуры.Организация, ПараметрыПроцедуры.АдресКомандыУдалить, Отказ, Ошибка);
	Иначе
...
Функция СоздатьКорзинуДобавитьТоварВФоне(Организация, ДанныеПредложений, УникальныйИдентификатор) Экспорт
	...
	Возврат ДлительныеОперации.ВыполнитьВФоне(
		"ТорговыеПредложенияСлужебный.СоздатьКорзинуДобавитьТовар",
		ПараметрыПроцедуры,
		ПараметрыВыполнения);
...
Процедура СоздатьКорзинуДобавитьТовар(ПараметрыПроцедуры, АдресРезультата) Экспорт
	...
	ЕстьДобавленныеПредложения = Ложь;
	ЕстьОшибкиДобавленияПредложений = Ложь;
	ОшибкиДобавленияПредложений = Новый Массив;
	Если Не ПустаяСтрока(АдресКомандыДобавитьТовар) Тогда
		...
		Для Каждого ДанныеПредложения Из ДанныеПредложений Цикл
			...
			ОшибкаДобавленияПредложения = Неопределено;
			...
			ДобавитьТоварВКорзину(
				...
				ОшибкаДобавленияПредложения);
			
			Если ОтказДобавленияТовара Тогда
				// Отказ добавления предложения может быть и без возвращаемых от сервиса текстов ошибок
				ЕстьОшибкиДобавленияПредложений = Истина; 
				Если ЗначениеЗаполнено(ОшибкаДобавленияПредложения) Тогда
					ОшибкаДобавленияПредложения.Вставить("ИдентификаторПредложения", 
						ДанныеПредложения.ИдентификаторПредложения);
					ОшибкиДобавленияПредложений.Добавить(ОшибкаДобавленияПредложения);
				КонецЕсли;
			Иначе
				ЕстьДобавленныеПредложения = Истина;
			КонецЕсли;
	...
	Результат = Новый Структура;
	Результат.Вставить("ДанныеКорзины", ДанныеКорзины);
	Результат.Вставить("ЕстьДобавленныеПредложения", ЕстьДобавленныеПредложения);
	Результат.Вставить("ЕстьОшибкиДобавленияПредложений", ЕстьОшибкиДобавленияПредложений);
	Результат.Вставить("ОшибкиДобавленияПредложений", ОшибкиДобавленияПредложений);
...
Процедура ДобавитьТоварВКорзину(
	...
	ВыполнитьЗапрос(ПараметрыКоманды, Отказ, Ошибка);
...
Функция УдалитьКорзинуВФоне(ПараметрыМетода, УникальныйИдентификатор) Экспорт
	...
	Возврат ДлительныеОперации.ВыполнитьВФоне(
		"ТорговыеПредложенияСлужебный.УдалитьКорзинуСохранитьРезультат",
		ПараметрыМетода,
		ПараметрыВыполнения);
...
Процедура УдалитьТоварИзКорзины(Организация, АдресКоманды, Отказ, Ошибка = Неопределено)
...
Процедура ИзменитьКоличествоТовараВКорзине(Организация, АдресКоманды, Количество, Отказ, Ошибка = Неопределено)
...
Функция ДеактивироватьРекомендациюАсинхронно(Организация, УникальныйИдентификатор, АдресРесурса) Экспорт
	...
	Возврат ДлительныеОперации.ВыполнитьВФоне(
		"ТорговыеПредложенияСлужебный.ДеактивироватьРекомендациюСохранитьРезультат",
		ПараметрыПроцедуры,
		ПараметрыВыполнения);
...
Функция ОтразитьОткликНаРекомендациюАсинхронно(Организация, УникальныйИдентификатор, АдресРесурса) Экспорт
	...
	Возврат ДлительныеОперации.ВыполнитьВФоне(
		"ТорговыеПредложенияСлужебный.ОтразитьОткликНаРекомендациюСохранитьРезультат",
		ПараметрыПроцедуры,
		ПараметрыВыполнения);
...
//
// Параметры:
//  ПараметрыЗапроса - см. НовыеПараметрыПолученияТорговыхПредложений.
// 
// Возвращаемое значение:
...
Функция ПолучитьКатегорииТорговыхПредложенийВФоне(УникальныйИдентификатор) Экспорт
	...
	Возврат ДлительныеОперации.ВыполнитьВФоне(
		"ТорговыеПредложенияСлужебный.ПолучитьКатегорииТорговыхПредложенийСохранитьРезультат",
		ПараметрыПроцедуры,
		ПараметрыВыполнения);
...
Функция ПолучитьХарактеристикиКатегорииВФоне(
	...
	Возврат ДлительныеОперации.ВыполнитьВФоне(
		"ТорговыеПредложенияСлужебный.ПолучитьХарактеристикиКатегории",
		ПараметрыЗапроса,
		ПараметрыВыполнения);
...
Процедура ПолучитьВнешниеПрайсЛисты(Знач ПараметрыПроцедуры, Знач АдресРезультата) Экспорт
	...
	|		ЛЕВОЕ СОЕДИНЕНИЕ РегистрСведений.СостоянияСинхронизацииТорговыеПредложения КАК
...
// Возвращаемое значение:
//  Структура:
//  * ВнутреннийИдентификатор - Строка - code
//  * ВнутреннийИдентификаторПрайсЛиста - Строка - priceListExternalCode
//  * Идентификатор - Строка - id
//  * Страница - Число - page
//  * РазмерСтраницы - Число - size
//  * Сортировка - Строка - sort
//  * ИдентификаторОрганизации - Строка
//  
...
Функция НовыйОписаниеОшибки()
	...
	Результат.Вставить("ТекстОшибкиСервиса", "");
	Результат.Вставить("ПодробныйТекстОшибки", "");
...
Функция ОбработатьОшибкуСервиса(Соединение, ЗапросСервиса, КодСостояния, Данные, Ошибка, Отказ)
	...
	ОшибкаСервиса = ТекстОшибкиИзДанныхСервиса(Данные, ТекстОшибки, ОписаниеОшибкиСервиса);
	...
	Ошибка.ТекстОшибкиСервиса = ОписаниеОшибкиСервиса;
	Ошибка.ПодробныйТекстОшибки = ПодробныйТекстОшибки;
...
Функция ТекстОшибкиИзДанныхСервиса(Данные, ТекстОшибки, ОписаниеОшибкиСервиса)
	...
	Если ЕстьСвойство(Данные, "detail", ЗначениеСвойства) Тогда
		ОшибкаСервиса = СтрШаблон(
			...
			ЗначениеСвойства);
		ОписаниеОшибкиСервиса = ЗначениеСвойства;
	КонецЕсли;
...
Процедура ОбновитьСтатистикуСинхронизации(Знач Параметры, Знач АдресРезультата) Экспорт
	...
	Если Параметры.ИспользоватьРегистрациюОрганизации Или Параметры.ИспользоватьСтатистикуПубликации Тогда
		...
		ОрганизацииТребуетсяПовторноеПодключение = Новый Массив;
		Пока Выборка.Следующий() Цикл
			ПодключенныеОрганизации.Добавить(Выборка.Организация);
			Если Выборка.ТребуетсяПовторноеПодключение Тогда
				ОрганизацииТребуетсяПовторноеПодключение.Добавить(Выборка.Организация);
			КонецЕсли;
		КонецЦикла;
		
		Статистика.Вставить("ПодключенныеОрганизации", ПодключенныеОрганизации);
		Статистика.Вставить("ОрганизацииТребуетсяПовторноеПодключение", ОрганизацииТребуетсяПовторноеПодключение);
...
//  РегламентноеЗаданиеВключено - Неопределено, Булево - Регламентное задание включено
//
Процедура УсловноеОформлениеГруппыСинхронизации(Форма, РегламентноеЗаданиеВключено) Экспорт
	...
	Форма.Элементы.Расписание.Заголовок   = РегламентноеЗаданиеСинхронизации.Расписание;
...
Процедура ПроверитьЗаписиТорговыеПредложенияТорговойПлощадки(Отбор, АдресРезультата = Неопределено) Экспорт
	...
	ДопустимыеЗначенияСтавокНДС = ДопустимыеЗначенияСтавокНДСДляПубликации();
...
// Допустимые значения ставок НДС для публикации.
// 
// Возвращаемое значение:
//  Массив Из Строка - Допустимые значения ставок НДС для публикации
Функция ДопустимыеЗначенияСтавокНДСДляПубликации()
	
	Результат = Новый Массив;
	Результат.Добавить("VAT_WITHOUT");
	Результат.Добавить("VAT_10");
	
	ДатаПроверки = ТекущаяДатаСеанса();
	Если ДействуетСтавкаНДС22(ДатаПроверки) Тогда
		Результат.Добавить("VAT_22");
	Иначе
		Результат.Добавить("VAT_20");
	КонецЕсли;
...
// Действует ставка НДС 22%.
// 
// Параметры:
//  ДатаПроверки - Дата - Дата проверки
// 
// Возвращаемое значение:
//  Булево - Истина, если ставки 22% и 22/122 начали действовать
Функция ДействуетСтавкаНДС22(ДатаПроверки)
	
	ДатаВводаСтавкиНДС22 = Дата(2026, 1, 1);
	Возврат ДатаПроверки >= ДатаВводаСтавкиНДС22;
