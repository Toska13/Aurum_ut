...
Функция СтатусыПлательщика(ПрименениеПриказа107н, Период = Неопределено) Экспорт
	...
	Если ДействуетПриказ58н_202604(Период) Тогда
		
		Статусы = Новый Соответствие;
		Статусы.Вставить("01", НСтр("ru='01 - налогоплательщик (плательщик сборов, страховых взносов и платежей, администрируемых налоговыми органами) - юридическое лицо, физическое лицо, индивидуальный предприниматель, нотариус, занимающийся частной практикой, адвокат, учредивший адвокатский кабинет, глава крестьянского (фермерского) хозяйства, составившие распоряжения о переводе денежных средств'"));
		Статусы.Вставить("03", НСтр("ru='03 - организация федеральной почтовой связи, составившая распоряжение клиента по каждому платежу физического лица (за исключением платежей, администрируемых налоговыми и таможенными органами)'"));
		Статусы.Вставить("04", НСтр("ru='04 - организация, исполняющая решение налогового органа'"));
		Статусы.Вставить("05", НСтр("ru='05 - Федеральная служба судебных приставов и ее территориальные органы'"));
		Статусы.Вставить("06", НСтр("ru='06 - юридическое лицо, за исключением получателя международного почтового отправления, осуществляющее перевод денежных средств в уплату платежей, администрируемых таможенными органами'"));
		Статусы.Вставить("07", НСтр("ru='07 - таможенный орган (за исключением платежей, администрируемых налоговыми органами)'"));
		Статусы.Вставить("08", НСтр("ru='08 - плательщик - юридическое лицо, индивидуальный предприниматель, нотариус, занимающийся частной практикой, адвокат, учредивший адвокатский кабинет, глава крестьянского (фермерского) хозяйства (за исключением платежей, администрируемых налоговыми и таможенными органами)'"));
		Статусы.Вставить("13", НСтр("ru='13 - иностранное лицо, не состоящее на учете в налоговых органах Российской Федерации, при осуществлении перевода денежных средств в уплату иных платежей, администрируемых налоговыми органами, в бюджетную систему Российской Федерации (за исключением единого налогового платежа), у которого отсутствует ИНН'"));
		Статусы.Вставить("15", НСтр("ru='15 - кредитная организация (филиал кредитной организации), платежный агент, организация федеральной почтовой связи, составившие платежное поручение, платежное распоряжение на общую сумму с реестром о переводе денежных средств, принятых от плательщиков - физических лиц'"));
		Статусы.Вставить("16", НСтр("ru='16 - физическое лицо, осуществляющее перевод денежных средств в уплату платежей, администрируемых таможенными органами'"));
		Статусы.Вставить("17", НСтр("ru='17 - индивидуальный предприниматель, осуществляющий перевод денежных средств в уплату платежей, администрируемых таможенными органами'"));
		Статусы.Вставить("19", НСтр("ru='19 - организации и их филиалы (далее - организации), составившие распоряжение клиента о переводе денежных средств, удержанных из заработной платы (дохода) должника - физического лица в счет погашения задолженности по платежам на основании исполнительного документа, направленного в организацию (за исключением платежей, администрируемых налоговыми органами)'"));
		Статусы.Вставить("20", НСтр("ru='20 - кредитная организация (филиал кредитной организации), платежный агент, составившие распоряжение клиента по каждому платежу физического лица (за исключением платежей, администрируемых налоговыми и таможенными органами)'"));
		Статусы.Вставить("23", НСтр("ru='23 - Фонд пенсионного и социального страхования Российской Федерации (за исключением платежей, администрируемых налоговыми и таможенными органами)'"));
		Статусы.Вставить("24", НСтр("ru='24 - плательщик - физическое лицо, осуществляющее перевод денежных средств в уплату сборов, страховых взносов, администрируемых Фондом пенсионного и социального страхования Российской Федерации, и иных платежей, поступающих на казначейские счета, открытые в органах Федерального казначейства, платежей за выполнение работ, оказание услуг автономными учреждениями (за исключением платежей, администрируемых налоговыми и таможенными органами)'"));
		Статусы.Вставить("27", НСтр("ru='27 - кредитные организации (филиалы кредитных организаций), подразделения Центрального банка Российской Федерации, составившие распоряжение клиента о переводе денежных средств, перечисленных из бюджетной системы Российской Федерации, не зачисленных получателю и подлежащих возврату в бюджетную систему Российской Федерации'"));
		Статусы.Вставить("28", НСтр("ru='28 - получатель международного почтового отправления, осуществляющий перевод денежных средств в уплату платежей, администрируемых таможенными органами'"));
		Статусы.Вставить("29", НСтр("ru='29 - политическая партия, избирательное объединение, инициативная группа по проведению референдума, кандидат, зарегистрированный кандидат или уполномоченный представитель инициативной группы по проведению референдума, инициативная агитационная группа при перечислении денежных средств со специальных избирательных счетов и специальных счетов фондов референдума, а также территориальная избирательная комиссия (за исключением платежей, администрируемых налоговыми и таможенными органами)'"));
		Статусы.Вставить("30", НСтр("ru='30 - иностранное лицо, не состоящее на учете в налоговых органах Российской Федерации (при уплате платежей, администрируемых таможенными органами)'"));
		Статусы.Вставить("31", НСтр("ru='31 - плательщик - физическое лицо, юридическое лицо, индивидуальный предприниматель, осуществляющие перевод денежных средств в счет погашения задолженности по исполнительному производству, кредитные организации (филиалы кредитных организаций), составившие распоряжение клиента о переводе денежных средств в счет погашения задолженности по исполнительному производству'"));
		Статусы.Вставить("32", НСтр("ru='32 - таможенный орган (в рамках бесспорного взыскания)'"));
		Статусы.Вставить("33", НСтр("ru='33 - плательщик - физическое лицо, юридическое лицо, индивидуальный предприниматель, осуществляющие перевод денежных средств в счет оплаты приобретаемого государственного (муниципального) имущества, имущества, обращенного в собственность государства, вещественных доказательств и изъятых вещей, а также задержанных таможенными органами товаров'"));
		Статусы.Вставить("34", НСтр("ru='34 - гарантирующие объединения (ассоциации), поручители и банки-гаранты, исполняющие требования таможенных органов'"));
		
	ИначеЕсли ПрименениеПриказа107н Тогда
...
// Возвращает признак, действует ли приказ 58н в указанный период.
//
// Параметры:
//   Период - Дата, Неопределено - Проверяемый период
//
// Возвращаемое значение:
//   Булево - Истина, если период определен и не меньше начала действия приказа 58н от 16.05.2025 с 01.04.2026
Функция ДействуетПриказ58н_202604(Период) Экспорт

	Возврат Период <> Неопределено
		И Период >= НачалоДействияПриказа58н();
...
// Проверяет, является ли переданный код кодом администратора начисления ФССП.
//
// Параметры:
//   Код - Строка - проверяемый код (допустимая длина: 20 или 25 символов).
//
// Возвращаемое значение:
//   Булево - Истина, если код соответствует администратору начисления ФССП, иначе Ложь
Функция АдминистраторНачисленияФССП(Код) Экспорт
	
	Если СтрДлина(СокрЛП(Код)) <> 20
		И СтрДлина(СокрЛП(Код)) <> 25 Тогда
		Возврат Ложь;
	КонецЕсли;
	
	Возврат Лев(Код, 3) = КодАдминистрированияФССП();
...
// Возвращает код Федеральной службы судебных приставов (ФССП).
//
// Возвращаемое значение:
//   Строка - код ФССП
//
Функция КодАдминистрированияФССП() Экспорт
...
#Область СистемаПодтвержденияОжиданияПоставкиТоваров

// Возвращает дату начала действия федерального закона № 102-ФЗ от 17.04.2026
//
// Возвращаемое значение:
//    Дата - начало обязательной уплаты обеспечительных платежей при ввозе товаров из ЕАЭС
//
Функция НачалоДействияФедеральногоЗакона102ФЗ() Экспорт
	
	// Федеральный закон от 17.04.2026 № 102-ФЗ "О внесении изменений в статью 11-3 части первой и статьи 177 и 205 части второй
	// Налогового кодекса Российской Федерации" устанавливает что с 1 июня 2026 года внесение обеспечительного платежа станет
	// обязательным условием для получения QR-кода в национальной системе подтверждения ожидания товаров (СПОТ)
...
// Возвращает список доступных статусов плательщика в бюджет с учетом вида платежа и периода.
//
// Параметры:
//   ВидПлатежа - ПеречислениеСсылка.ВидыПеречисленийВБюджет - вид платежа
//   КодБК - Строка - код бюджетной классификации
//   Период - Дата - период для определения действующих нормативных актов
//
// Возвращаемое значение:
//   СписокЗначений из Строка - доступные статусы плательщика для указанного вида платежа
Функция ДоступныеСтатусыПлательщикаПоВидуПлатежа(ВидПлатежа, КодБК, Период) Экспорт

	ОбщийСписокСтатусов = СтатусыПлательщика(ДействуетПриказ107н(Период), Период);
	
	Если Не ДействуетПриказ58н_202604(Период)
		Или ВидПлатежа = ПредопределенноеЗначение("Перечисление.ВидыПеречисленийВБюджет.ПустаяСсылка") Тогда
		ДоступныеСтатусы = "";
		
	ИначеЕсли ЭтоПлатежВНалоговыйОрган(ВидПлатежа, КодБК) Тогда
		ДоступныеСтатусы = "01,04,13";
	ИначеЕсли ЭтоПлатежВТаможенныйОрган(ВидПлатежа, КодБК) Тогда
		ДоступныеСтатусы = "05,06,07,16,17,19,28,30,32,34";
	Иначе
		ДоступныеСтатусы = "03,05,08,15,19,20,23,24,27,29,31,33";
	КонецЕсли;
	
	Если ДоступныеСтатусы = "" Тогда
		НовыйСписокСтатусов = ОбщийСписокСтатусов;
	Иначе
		
		ДоступныеСтатусы = СтрРазделить(ДоступныеСтатусы, ",");
		НовыйСписокСтатусов = Новый СписокЗначений;
		
		Для Каждого Статус Из ДоступныеСтатусы Цикл
			
			ИскомоеЗначение = ОбщийСписокСтатусов.НайтиПоЗначению(Статус);
			
			Если ИскомоеЗначение <> Неопределено Тогда
				НовыйСписокСтатусов.Добавить(ИскомоеЗначение.Значение, ИскомоеЗначение.Представление);
			КонецЕсли;
	...
	Возврат НовыйСписокСтатусов;

КонецФункции

// Возвращает признак того, что является ли платеж платежом в налоговый орган.
//
// Параметры:
//   ВидПлатежа - ПеречислениеСсылка.ВидыПеречисленийВБюджет - вид платежа
//   КодБК - Строка - код бюджетной классификации
//
// Возвращаемое значение:
//   Булево - Истина, если платеж является платежом в налоговый орган
Функция ЭтоПлатежВНалоговыйОрган(ВидПлатежа, КодБК) Экспорт

	Возврат (Не ПустаяСтрока(КодБК)
		И ПлатежАдминистрируетсяНалоговымиОрганами(КодБК))
		Или ((ПустаяСтрока(КодБК) Или СокрЛП(КодБК) = "0")
		И ВидПлатежа = ПредопределенноеЗначение("Перечисление.ВидыПеречисленийВБюджет.НалоговыйПлатеж"));

КонецФункции

// Возвращает признак того, что является ли платеж платежом в таможенный орган.
//
// Параметры:
//   ВидПлатежа - ПеречислениеСсылка.ВидыПеречисленийВБюджет - вид платежа
//   КодБК - Строка - код бюджетной классификации
//
// Возвращаемое значение:
//   Булево - Истина, если платеж является платежом в таможенный орган
Функция ЭтоПлатежВТаможенныйОрган(ВидПлатежа, КодБК) Экспорт

	Возврат (Не ПустаяСтрока(КодБК)
		И ПлатежАдминистрируетсяТаможеннымиОрганами(КодБК))
		Или ((ПустаяСтрока(КодБК) Или СокрЛП(КодБК) = "0")
		И ВидПлатежа = ПредопределенноеЗначение("Перечисление.ВидыПеречисленийВБюджет.ТаможенныйПлатеж"));
...
Функция ОснованияТаможенногоПлатежа(ПрименениеПриказа107н, Период = Неопределено)
	...
	Если ДействуетПриказ58н_202604(Период) Тогда
		...
		ОснованияПлатежа.Добавить("ПК", НСтр("ru='ПК - таможенный приходный ордер'"));
		ОснованияПлатежа.Добавить("КЭ", НСтр("ru='КЭ - квитанция физического лица - получателя товаров, перемещаемых в качестве экспресс-грузов'"));
		ОснованияПлатежа.Добавить("УВ", НСтр("ru='УВ - уведомление (уточнение к уведомлению) о не уплаченных в установленный срок суммах таможенных платежей, специальных, антидемпинговых, компенсационных пошлин, процентов и пеней'"));
		ОснованияПлатежа.Добавить("ИЛ", НСтр("ru='ИЛ - исполнительный лист'"));
		ОснованияПлатежа.Добавить("ПБ", НСтр("ru='ПБ - поручение таможенного органа на бесспорное взыскание'"));
		ОснованияПлатежа.Добавить("ПР", НСтр("ru='ПР - решение таможенного органа на бесспорное взыскание'"));
		ОснованияПлатежа.Добавить("ТГ", НСтр("ru='ТГ - требование об уплате денежных средств гарантирующим объединением (ассоциацией)'"));
		ОснованияПлатежа.Добавить("ТБ", НСтр("ru='ТБ - требование об уплате суммы по банковской гарантии или договору поручительства, если уплата денежных средств производится по банковской гарантии'"));
		ОснованияПлатежа.Добавить("ТД", НСтр("ru='ТД - требование об уплате суммы по банковской гарантии или договору поручительства, если уплата денежных средств производится по договору поручительства'"));
		ОснованияПлатежа.Добавить("ПВ", НСтр("ru='ПВ - постановление о взыскании таможенных платежей, специальных, антидемпинговых, компенсационных пошлин, процентов и пени за счет имущества'"));
...
// Возвращает дату действия изменения приказа 58н от 16.05.2025 с 01.04.2026
//
// Возвращаемое значение:
//	Дата - дата начала действия изменения
Функция НачалоДействияПриказа58н()

	Возврат Дата('20260401');
