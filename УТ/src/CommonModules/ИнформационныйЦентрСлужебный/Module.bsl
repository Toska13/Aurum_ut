...
Процедура ПриОпределенииМетодовРазрешенныхДляВызоваКакПроизвольныйКод(Методы) Экспорт
	...
	Методы.Вставить("ЗаполнитьИнформационнуюСсылкуИзКонфигурации");
	Методы.Вставить("ЗаполнитьДатуОкончанияАктуальностиИнформационныхСсылок");
	Методы.Вставить("ЗаполнитьХешПолногоПутиКФорме");
	Методы.Вставить("ОбновитьИнформационныеСсылкиДляФормВЛокальномРежиме");
	Методы.Вставить("СформироватьСловарьПолныхПутейКФормам");
