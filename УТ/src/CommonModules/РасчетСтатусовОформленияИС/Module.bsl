...
Процедура ПриОпределенииМетодовРазрешенныхДляВызоваКакПроизвольныйКод(Методы) Экспорт
	...
	Методы.Вставить("РасчетСтатусовОформленияИС", Истина);
	Методы.Вставить("РасчетСтатусовОформленияПослеЗаписиДокумента", Истина);
...
Функция СформироватьТаблицуТоварыДокументовОснования(МассивДокументов, МетаданныеДокументаИС, Модуль, МенеджерВТ = Неопределено)
	...
	Запрос.УстановитьПараметр("ВидыПродукцииПоддерживающиеПеременноеКоличество",
		КонструкторИСМПКлиентСервер.ВидыПродукцииПоддерживающиеПеременноеКоличествоМернойПродукции());
