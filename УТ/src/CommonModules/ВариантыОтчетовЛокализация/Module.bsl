...
Процедура ОпределитьОбъектыСКомандамиОтчетов(Объекты) Экспорт
	...
	Объекты.Добавить(Метаданные.Документы.БронированиеSmartway);
...
Процедура НастроитьВариантыОтчетов(Настройки) Экспорт
	...
	#Область СверкаРасчетовСКонтрагентами_Сверка20
	ОписаниеОтчета = ВариантыОтчетов.ОписаниеОтчета(Настройки, Метаданные.Отчеты.СверкаРасчетовСКонтрагентами);
	ОписаниеВарианта = ВариантыОтчетов.ОписаниеВарианта(Настройки, ОписаниеОтчета, "СверенныеСОтбором");
	ОписаниеВарианта.Наименование = ОписаниеОтчета.Наименование;
	ОписаниеВарианта.Описание = НСтр("ru = 'Анализ расхождений по данными первичных документов.
		|Покажет пары документов с обнаруженными расхождениями: даты, номера документов, суммы и НДС.'");
	#КонецОбласти
...
Процедура ЗарегистрироватьИзмененияКлючейВариантовОтчетов(Изменения) Экспорт
	...
	ВариантыОтчетовУТПереопределяемый.ДобавитьИзменениеКлючей(Изменения, "СверкаРасчетовСКонтрагентами", "Основной", "СверенныеСОтбором");
