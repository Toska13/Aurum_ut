...
Функция ПредметыРасчетовПоДокументу(ДокументСсылка, ЧекКоррекцииИсправленииОшибки = Ложь) Экспорт
	...
	|	ТаблицаДанныхДокументов.Валюта,
	|	ТаблицаДанныхДокументов.Организация,
	|	ТаблицаДанныхДокументов.Дата
	|ИЗ ТаблицаДанныхДокументов КАК ТаблицаДанныхДокументов";
	Запрос.УстановитьПараметр("Ссылка", ДокументСсылка);
	...
	Запрос.Текст = "
	|" + УчетПодакцизныхТоваров.ТекстЗапросаВтПодакцизныеТовары("ВыкупВозвратнойТарыКлиентомТаблицаТоваров")
	...
	|	ПО ВыкупВозвратнойТарыКлиентомТаблицаТоваров.Номенклатура = ВтПодакцизныеТовары.Номенклатура
	|
	|УПОРЯДОЧИТЬ ПО
	|	ВыкупВозвратнойТарыКлиентомТаблицаТоваров.НомерСтроки
	|";
