...
// Проверяет наличие у пользователя роли РазрешитьОтключениеКонтроляРетроБонусовКлиентовНаВремяСеанса
// 
// Параметры:
// 	Пользователь - ПользовательИнформационнойБазы
// 	
...
// Проверяет наличие у пользователя роли УтверждениеВидовЦен
// Параметры:
// 	Пользователь - ПользовательИнформационнойБазы
// Возвращаемое значение:
//	Булево - наличие роли
Функция УтверждениеВидовЦен(Пользователь = Неопределено) Экспорт
	Возврат Пользователи.РолиДоступны(Метаданные.Роли.УтверждениеВидовЦен.Имя, Пользователь, Ложь);
КонецФункции
...
// Проверяет наличие у пользователя роли РазрешитьОформлениеВыпускаЗаднимЧислом
// Параметры:
// 	Пользователь - ПользовательИнформационнойБазы
// Возвращаемое значение:
//	Булево - наличие роли
Функция РазрешитьОформлениеВыпускаЗаднимЧислом(Пользователь = Неопределено) Экспорт
...
// Проверяет наличие у пользователя роли "СогласованиеЗаявокНаЗакупку"
// Параметры:
// 	Пользователь - СправочникСсылка.Пользователи
// Возвращаемое значение:
//	Булево - наличие роли
Функция СогласованиеЗаявокНаЗакупку(Пользователь = Неопределено) Экспорт
	Возврат Пользователи.РолиДоступны("СогласованиеЗаявокНаЗакупку", Пользователь, Ложь);
КонецФункции

// Проверяет наличие у пользователя роли "СогласованиеЗаявокНаОбеспечение"
// Параметры:
// 	Пользователь - СправочникСсылка.Пользователи
// Возвращаемое значение:
//	Булево - наличие роли
Функция СогласованиеЗаявокНаОбеспечение(Пользователь = Неопределено) Экспорт
	Возврат Пользователи.РолиДоступны("СогласованиеЗаявокНаОбеспечение", Пользователь, Ложь);
КонецФункции
