...
// Это тип сообщения о просмотре титула в МП.
// 
// Параметры:
//  ТипСообщенияМП - Строка - Тип сообщения от МП.
// 
// Возвращаемое значение:
//  Булево - Признак того, что переданный тип это тип сообщения о просмотре титула в МП.
Функция ЭтоТипСообщенияОПросмотреТитулаВМП(ТипСообщенияМП) Экспорт
	
	Возврат НРег(ТипСообщенияМП) = "readressing_viewed" Или НРег(ТипСообщенияМП) = "replacement_viewed";
...
// Возвращает массив типов взаимодействий МПЭПД которые будут загружаться с сервера МП.
//
// Возвращаемое значение:
//   Массив из ПеречислениеСсылка.ТипыВзаимодействияМПЭПД - список типов взаимодействий для загрузки
Функция МассивЗагружаемыхТиповВзаимодействий() Экспорт
	
	Массив = Новый Массив;
	
	Массив.Добавить(ПредопределенноеЗначение("Перечисление.ТипыВзаимодействияМПЭПД.ПовторнаяРегистрацияМП"));
	Массив.Добавить(ПредопределенноеЗначение("Перечисление.ТипыВзаимодействияМПЭПД.ИзменениеСведенийМП"));
	Массив.Добавить(ПредопределенноеЗначение("Перечисление.ТипыВзаимодействияМПЭПД.ОтвязкаВодителя"));
	Массив.Добавить(ПредопределенноеЗначение("Перечисление.ТипыВзаимодействияМПЭПД.ПривязкаВодителя"));
	Массив.Добавить(ПредопределенноеЗначение("Перечисление.ТипыВзаимодействияМПЭПД.УдалениеМП"));
	Массив.Добавить(ПредопределенноеЗначение("Перечисление.ТипыВзаимодействияМПЭПД.Сообщение"));
...
Функция ИндексРаботыПоТитулу(Титул) Экспорт
	...
	Если Титул = ПредопределенноеЗначение("Перечисление.ТипыЭлементовРегламентаЭДО.ЭТрН_Титул2") 
