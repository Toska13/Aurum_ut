...
Процедура ПриИзмененииРеквизита(Элемент, Форма) Экспорт
	...
	Если Элемент.Имя = "ОсобыйПризнакЗаявителяДОПП" Тогда
		ОсобыйПризнакПриИзменении(Элемент, Форма);
	КонецЕсли;
...
Процедура ОсобыйПризнакПриИзменении(Элемент, Форма) Экспорт
	
	Объект = Форма.Объект;
	Форма.Элементы.ИнойОсобыйПризнакЗаявителяДОПП.Видимость = Объект.ОсобыйПризнакЗаявителяДОПП = "2";
