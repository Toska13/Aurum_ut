...
//
// Параметры:
//	СтрокиДерева - Массив Из Структура - содержит структуры с данными упаковок, для которых требуется получить хеш сумму:
...
//
Функция ПересчитатьХешСуммы(СтрокиДерева, ПараметрыСканирования = Неопределено) Экспорт
	...
	ПроверкаИПодборПродукцииИС.ОбработатьТаблицуПеремаркировкиСУчетомДетализации(Форма, ТаблицаПеремаркировки, ШтрихкодИДанныеУпаковки);
