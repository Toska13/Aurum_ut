...
Процедура ПриОпределенииМетодовРазрешенныхДляВызоваКакПроизвольныйКод(Методы) Экспорт
	...
	Методы.Вставить("ПолучитьКатегорииНаПутиКЭлементу", Истина);
	Методы.Вставить("ПолучитьКатегорииНаПутиКЭлементуСКорневымиКатегориями", Истина);
	Методы.Вставить("НайтиКатегорииПоСтрокеПоиска", Истина);
	Методы.Вставить("ПолучитьКорневыеКатегории", Истина);
	Методы.Вставить("ПолучитьПредставлениеДочернихКатегорий", Истина);
	Методы.Вставить("ПолучитьКраткоеОписаниеДочернихКатегорий", Истина);
	Методы.Вставить("ПолучитьПолноеОписаниеДочернихКатегорий", Истина);
	Методы.Вставить("ПолучитьПредставлениеКатегорииПоИдентификатору", Истина);
	Методы.Вставить("ПолучитьОписаниеКатегорииПоИдентификатору", Истина);
	Методы.Вставить("ПолучитьПолноеОписаниеКатегорииПоИдентификатору", Истина);
	Методы.Вставить("ПолучитьДанныеКатегорийСервиса", Истина);
	Методы.Вставить("ПолучитьДополнительныеРеквизитыКатегорий", Истина);
	Методы.Вставить("ПолучитьЗначенияДополнительногоРеквизитаКатегории", Истина);
	Методы.Вставить("ПолучитьФильтрыКатегории", Истина);
	Методы.Вставить("ПолучитьПроизводителейКатегории", Истина);
	Методы.Вставить("СформироватьПредставлениеКарточкиКатегории", Истина);
	Методы.Вставить("ЗагрузитьКатегории", Истина);
	Методы.Вставить("ПолучитьЗначенияСоответствующиеЗаданным", Истина);
	
	Методы.Вставить("ПолучитьДанныеНоменклатурыСервиса", Истина);
	Методы.Вставить("ПолучитьПереченьНоменклатуры", Истина);
	Методы.Вставить("СформироватьПредставленияКарточекНоменклатуры", Истина);
	Методы.Вставить("ЗагрузитьНоменклатуруИХарактеристики", Истина);
	Методы.Вставить("КоличествоНоменклатурыПоСтрокеПоиска", Истина);
	Методы.Вставить("КупитьКарточкиНоменклатуры", Истина);
	Методы.Вставить("ПолучитьНоменклатуруПоШтрихкодам", Истина);
	Методы.Вставить("ПараметрыЗаполненияФормыНоменклатурыПодготовлены", Истина);
	
	Методы.Вставить("ЗакэшироватьИзображенияБаннеров", Истина);
	Методы.Вставить("ПроверитьСостояниеСервиса", Истина);
	
	Методы.Вставить("ПолучитьОбновленияВидовНоменклатуры", Истина);
	Методы.Вставить("ПолучитьОбновленияНоменклатуры", Истина);
	
	Методы.Вставить("ДанныеСертификатаСоответствия", Истина);
	Методы.Вставить("ДанныеДекларацииСоответствия", Истина);
	
	Методы.Вставить("ПолучитьТоварыНациональногоКаталогаКПодписанию", Истина);
	Методы.Вставить("ПодписатьТоварыНациональногоКаталога", Истина);
	
	Методы.Вставить("ВыгрузитьНоменклатуру", Истина);
	Методы.Вставить("ОбновитьВариантыСопоставленияНоменклатуры", Истина);
	Методы.Вставить("ОбновлениеНоменклатуры", Истина);
	Методы.Вставить("ОбработкаОчередиЗапросовФСА", Истина);
	Методы.Вставить("ПоискСоответствийНоменклатурыСервиса", Истина);
	Методы.Вставить("ПолучитьРеквизитыРубрикатора", Истина);
	Методы.Вставить("СохранитьПодтвержденныеСопоставления", Истина);
	Методы.Вставить("СтатистикаСопоставленияНоменклатуры", Истина);
