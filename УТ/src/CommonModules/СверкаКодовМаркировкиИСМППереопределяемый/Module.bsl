...
// Определяет соответствие документа корректировке приобретения с хозяйственной операции "По согласованию сторон",
// результат возвращает через второй параметр.
//
// Параметры:
//  Контекст - ДокументСсылка - Проверяемый документ.
//  ЭтоКорректировкаПоСогласованиюСторон - Булево - исходящий, это корректировка по согласованию сторон.
Процедура ЭтоКорректировкаПриобретенияПоСогласованию(Контекст, ЭтоКорректировкаПоСогласованиюСторон) Экспорт
	
	//++ НЕ ГОСИС
	ЭтоКорректировкаПоСогласованиюСторон = ИнтеграцияИСУТКлиентСервер.ЭтоДокументПоНаименованию(Контекст, "КорректировкаПриобретения")
		И ОбщегоНазначения.ЗначениеРеквизитаОбъекта(Контекст, "ВидКорректировки") = Перечисления.ХозяйственныеОперации.КорректировкаПоСогласованиюСторон
	//-- НЕ ГОСИС
...
//
Процедура ПриОпеределенииТаблицыПродукцииПринятойБезРасхождений(ДокументОснование, НоменклатураПоДаннымЭДО, ТаблицаПродукции) Экспорт
	
	//++ НЕ ГОСИС
	ТаблицаПродукции = ИнтеграцияИСМПУТ.ПриОпределенииТаблицыПродукцииПринятойБезРасхождений(ДокументОснование, НоменклатураПоДаннымЭДО);
	//-- НЕ ГОСИС
...
Процедура ПриОпределенииПараметровИнтеграцииФормыСверкиПоКодамМаркировки(Форма, ПараметрыИнтеграции) Экспорт
	...
	Если ИнтеграцияИСУТКлиентСервер.ЭтоДокументПоНаименованию(Форма, "АктОРасхожденияхПослеПриемки") Тогда
		...
		ПараметрыИнтеграции.ИмяКоманднойПанели = Форма.Элементы.Товары.КоманднаяПанель.Имя;
...
//  ТаблицаМаркируемойПродукции - См. СверкаКодовМаркировкиИСМП.ТаблицаМаркируемойПродукцииДокумента
