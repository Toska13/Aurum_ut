...
Процедура ОтправитьСообщенияОчереди() Экспорт
	...
	// задание будет запущено вновь при добавлении сообщения
	Если ОбщегоНазначенияБПО.РазделениеВключено() Тогда
...
Процедура ПриОпределенииМетодовРазрешенныхДляВызоваКакПроизвольныйКод(Методы) Экспорт
	...
	Методы.Вставить("ОтправитьСообщенияОчереди", Истина);
	Методы.Вставить("ОтправитьСообщениеОчередиВФоне", Истина);
