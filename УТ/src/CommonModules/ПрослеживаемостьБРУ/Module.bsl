...
Функция ЗаполнитьДополнительныеРеквизитыУведомленияОВвозе(Контейнер, Документ)
	...
	ПараметрыДокумента = ОбщегоНазначения.ЗначенияРеквизитовОбъекта(Документ, "Организация,Дата,Номер,НомерКорректировки,ИсправляемыйДокумент");
	...
	Если ПараметрыДокумента.НомерКорректировки > 0 Тогда
		...
		ПараметрыДокументаИсходного = ОбщегоНазначения.ЗначенияРеквизитовОбъекта(ПараметрыДокумента.ИсправляемыйДокумент, "Дата,Номер");
...
Процедура ЗаполнитьРаздел1УведомленияОВвозе(ТаблицаРаздел1, ДокументСсылка)
	...
	РеквизитыДокумента = ОбщегоНазначения.ЗначенияРеквизитовОбъекта(ДокументСсылка, "Дата, НомерКорректировки, ПервичныйДокумент");
