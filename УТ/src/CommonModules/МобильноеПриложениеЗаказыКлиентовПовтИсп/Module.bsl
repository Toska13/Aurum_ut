...
Функция СоответствиеТиповСостоянияЗаказовКлиентов() Экспорт
	...
	Результат.Вставить(Перечисления.СостоянияЗаказовКлиентов.ОжидаетсяПереходПраваСобственности, "ОжидаетсяПереходПраваСобственности"); //@NON-NLS-1
