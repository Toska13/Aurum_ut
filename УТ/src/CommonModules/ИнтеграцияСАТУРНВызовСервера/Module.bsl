...
Функция ДанныеПартий(ВходящиеДанные, ИмяКолонки = "Партия") Экспорт
	...
	Возврат ИнтеграцияСАТУРН.ДанныеПартий(ВходящиеДанные, ИмяКолонки);
...
Функция ЗначенияРеквизитовДляОпределенияДоступностиДействий(СсылкиНаДокументы, ПараметрыОпределения) Экспорт
	...
	ИменаРеквизитов = ИнтеграцияСАТУРНСлужебныйКлиентСервер.ИменаРеквизитовОпределенияДоступностиДействий(ПараметрыОпределения.Префикс);
	
	Возврат ОбщегоНазначения.ЗначенияРеквизитовОбъектов(СсылкиНаДокументы, ИменаРеквизитов);
