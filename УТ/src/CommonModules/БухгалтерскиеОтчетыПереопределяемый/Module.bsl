...
//
Процедура ВысотаВыводимыхПараметров(Схема, КоличествоСтрокПараметров, ПараметрыОтчета = Неопределено) Экспорт
КонецПроцедуры
