...
Процедура ПодготовитьДанныеПоКарточке(ОписаниеОбъекта, ДеревоКарточки)
	...
	Если ОписаниеОбъекта.ЗакрытыйПакет Тогда
		НоваяСтрока = ДополнительныеДанные.Добавить();
		НоваяСтрока.Имя = "ClosedMessage";
	...
	Если Не ОписаниеОбъекта.СпособОбмена = Перечисления.СпособыОбменаЭД.БыстрыйОбмен Тогда
		...
		Если РегламентыЭДО.ЭтоЭлементРегламентаОтправителя(ОписаниеОбъекта.ТипЭлементаРегламента)
			...
			Если ОписаниеОбъекта.ОписаниеДокумента <> Неопределено Тогда
				...
				НоваяСтрока.Значение = Формат(ОписаниеОбъекта.ОписаниеДокумента.Сумма, "ЧДЦ=6; ЧРД=,; ЧГ=0");
...
//                             только старые типы (после расширения состава типов они передаются в новом реквизите
//                             карточки, а старые в дополнительных данных).
//   ТипыДокументовТранспортнойИнформации - см. ТипыДокументовТранспортнойИнформации
//
// Возвращаемое значение:
...
Функция ПараметрыДокумента(ТипДокументаСтрокой, ТипРегламента, КодТранзакции, ДляДополнительныхДанных = Ложь,
	ТипыДокументовТранспортнойИнформации = Неопределено) Экспорт
	...
	Если ТипыДокументовТранспортнойИнформации <> Неопределено Тогда
		Таблица = ТипыДокументовТранспортнойИнформации;
	Иначе
		Таблица = ТипыДокументовТранспортнойИнформации();
	КонецЕсли;
...
// Формирует таблицу типов документов транспортной информации.
// 
// Возвращаемое значение:
//  ТаблицаЗначений:
//   * ТипДокументаСтрокой - Строка
...
//   * ТипЭлементаРегламента - ПеречислениеСсылка.ТипыЭлементовРегламентаЭДО
//   * ТипРегламента - ПеречислениеСсылка.ТипыРегламентовЭДО
//   * ТипДокументаДляДополнительныхДанныхСтрокой - Строка
//   * ЭтоОтветнаяПодпись - Булево
//                        - Неопределено
// 
Функция ТипыДокументовТранспортнойИнформации() Экспорт
...
Процедура ПриОпределенииМетодовРазрешенныхДляВызоваКакПроизвольныйКод(Методы) Экспорт
	...
	Методы.Вставить("ОтменитьРаспаковкуКонтейнеров", Истина);
	Методы.Вставить("ПометитьНаУдалениеТранспортныеКонтейнерыПоРасписанию", Истина);
