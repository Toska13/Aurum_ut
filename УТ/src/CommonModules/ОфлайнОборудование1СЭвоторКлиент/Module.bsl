...
Процедура ЗаполнитьТовар(СтруктураТовара, Товар)
	...
	Если Товар.ЭтоАлкоголь Тогда
		...
		ИначеЕсли Товар.ВидМаркированнойПродукции = ПредопределенноеЗначение("Перечисление.ВидыМаркированнойПродукцииБПО.БезалкогольноеПиво") Тогда
			СтруктураТовара.type = "NOT_ALCOHOL_BEER_MARKED";
		КонецЕсли;
	...
	ИначеЕсли Товар.Свойство("ЭтоМаркированнаяПродукция") Тогда
		...
		Если Товар.ЭтоМаркированнаяПродукция Тогда 
			...
			ИначеЕсли Товар.ТипМаркированнойПродукции = ПредопределенноеЗначение("Перечисление.ВидыМаркированнойПродукцииБПО.СоковаяПродукция")
				ИЛИ Товар.ВидМаркированнойПродукции = ПредопределенноеЗначение("Перечисление.ВидыМаркированнойПродукцииБПО.СоковаяПродукция")
				ИЛИ Товар.ТипМаркированнойПродукции = ПредопределенноеЗначение("Перечисление.ВидыМаркированнойПродукцииБПО.БезалкогольныеНапитки")
				ИЛИ Товар.ВидМаркированнойПродукции = ПредопределенноеЗначение("Перечисление.ВидыМаркированнойПродукцииБПО.БезалкогольныеНапитки") Тогда
			...
			ИначеЕсли Товар.ТипМаркированнойПродукции = ПредопределенноеЗначение("Перечисление.ВидыМаркированнойПродукцииБПО.Антисептики")
				ИЛИ Товар.ВидМаркированнойПродукции = ПредопределенноеЗначение("Перечисление.ВидыМаркированнойПродукцииБПО.Антисептики")
				ИЛИ Товар.ТипМаркированнойПродукции = ПредопределенноеЗначение("Перечисление.ВидыМаркированнойПродукцииБПО.ДезинфицирующиеСредства")
				ИЛИ Товар.ВидМаркированнойПродукции = ПредопределенноеЗначение("Перечисление.ВидыМаркированнойПродукцииБПО.ДезинфицирующиеСредства") Тогда
			...
			ИначеЕсли Товар.ТипМаркированнойПродукции = ПредопределенноеЗначение("Перечисление.ВидыМаркированнойПродукцииБПО.Пиво") 
				...
				СтруктураТовара.alcoholProductKindCode = Товар.АлкогольныеРеквизиты.КодВидаАлкогольнойПродукции;
				СтруктураТовара.tareVolume             = Товар.АлкогольныеРеквизиты.ЕмкостьТары;
			ИначеЕсли Товар.ТипМаркированнойПродукции = ПредопределенноеЗначение("Перечисление.ВидыМаркированнойПродукцииБПО.БезалкогольноеПиво") 
				ИЛИ Товар.ВидМаркированнойПродукции = ПредопределенноеЗначение("Перечисление.ВидыМаркированнойПродукцииБПО.БезалкогольноеПиво") Тогда
				СтруктураТовара.type = "NOT_ALCOHOL_BEER_MARKED";
				СтруктураТовара.alcoholByVolume        = Товар.АлкогольныеРеквизиты.Крепость;
				СтруктураТовара.alcoholProductKindCode = Товар.АлкогольныеРеквизиты.КодВидаАлкогольнойПродукции;
				СтруктураТовара.tareVolume             = Товар.АлкогольныеРеквизиты.ЕмкостьТары;
			ИначеЕсли Товар.ТипМаркированнойПродукции = ПредопределенноеЗначение("Перечисление.ВидыМаркированнойПродукцииБПО.Морепродукты")
				ИЛИ Товар.ВидМаркированнойПродукции = ПредопределенноеЗначение("Перечисление.ВидыМаркированнойПродукцииБПО.Морепродукты") Тогда
				СтруктураТовара.type = "CAVIAR_MARKED";
			ИначеЕсли Товар.ТипМаркированнойПродукции = ПредопределенноеЗначение("Перечисление.ВидыМаркированнойПродукцииБПО.ВетеринарныеПрепараты")
				ИЛИ Товар.ВидМаркированнойПродукции = ПредопределенноеЗначение("Перечисление.ВидыМаркированнойПродукцииБПО.ВетеринарныеПрепараты") Тогда
				СтруктураТовара.type = "VETERINARY_MARKED";
			ИначеЕсли Товар.ТипМаркированнойПродукции = ПредопределенноеЗначение("Перечисление.ВидыМаркированнойПродукцииБПО.КормаДляЖивотных")
				ИЛИ Товар.ВидМаркированнойПродукции = ПредопределенноеЗначение("Перечисление.ВидыМаркированнойПродукцииБПО.КормаДляЖивотных")
				ИЛИ Товар.ТипМаркированнойПродукции = ПредопределенноеЗначение("Перечисление.ВидыМаркированнойПродукцииБПО.КормаДляЖивотныхВлажные")
				ИЛИ Товар.ВидМаркированнойПродукции = ПредопределенноеЗначение("Перечисление.ВидыМаркированнойПродукцииБПО.КормаДляЖивотныхВлажные") Тогда
				СтруктураТовара.type = "PET_FOOD_MARKED";
			ИначеЕсли Товар.ТипМаркированнойПродукции = ПредопределенноеЗначение("Перечисление.ВидыМаркированнойПродукцииБПО.РастительныеМасла")
				ИЛИ Товар.ВидМаркированнойПродукции = ПредопределенноеЗначение("Перечисление.ВидыМаркированнойПродукцииБПО.РастительныеМасла") Тогда
				СтруктураТовара.type = "VEGETABLE_OIL_MARKED";
			ИначеЕсли Товар.ТипМаркированнойПродукции = ПредопределенноеЗначение("Перечисление.ВидыМаркированнойПродукцииБПО.МоторныеМасла")
				ИЛИ Товар.ВидМаркированнойПродукции = ПредопределенноеЗначение("Перечисление.ВидыМаркированнойПродукцииБПО.МоторныеМасла") Тогда
				СтруктураТовара.type = "AUTO_FLUIDS_MARKED";
			ИначеЕсли Товар.ТипМаркированнойПродукции = ПредопределенноеЗначение("Перечисление.ВидыМаркированнойПродукцииБПО.ПарфюмерныеИКосметическиеСредстваИБытоваяХимия")
				ИЛИ Товар.ВидМаркированнойПродукции = ПредопределенноеЗначение("Перечисление.ВидыМаркированнойПродукцииБПО.ПарфюмерныеИКосметическиеСредстваИБытоваяХимия") Тогда
				СтруктураТовара.type = "CHEMICALS_MARKED";
			Иначе
	...
	ИначеЕсли Строка(Товар.СтавкаНДС) = "22" Тогда
		СтруктураТовара.tax                    = "VAT_22";
	ИначеЕсли Строка(Товар.СтавкаНДС) = "122" Тогда
		СтруктураТовара.tax                    = "VAT_22_122"
	Иначе
			...
			Для Каждого Транзакция Из Документ.transactions Цикл
				...
				ИначеЕсли Транзакция.type = "POSITION_TAX" Тогда
					...
					Если ЗначениеЗаполнено(Товар) Тогда
						...
						ИначеЕсли Транзакция.tax = "VAT_22" Тогда
							Товар.СтавкаНДС = "22"
						ИначеЕсли Транзакция.tax = "VAT_22_122" Тогда
							Товар.СтавкаНДС = "22/122"
						КонецЕсли;
