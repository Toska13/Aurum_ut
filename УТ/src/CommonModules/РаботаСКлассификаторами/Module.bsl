...
#Область БиблиотекаСистемыМаркировки

// Добавляет классификатор в список доступных для обновления.
// Метод следует использовать, если классификатор включается
// через функциональную опцию.
//
// Параметры:
//  Классификаторы - Массив из Структура - содержит описание
//    классификаторов см. ОписаниеКлассификатора.
//
Процедура ДобавитьКлассификаторы(Классификаторы) Экспорт
...
Процедура ПриОпределенииМетодовРазрешенныхДляВызоваКакПроизвольныйКод(Методы) Экспорт
	...
	Методы.Вставить("ИнтерактивноеОбновлениеКлассификаторовИзСервиса", Истина);
	Методы.Вставить("ИнтерактивноеОбновлениеКлассификаторовИзФайла", Истина);
	Методы.Вставить("НастроитьОбновленияКлассификаторов");
	Методы.Вставить("ОбновитьНастройкиРаботыСКлассификаторами");
...
Процедура ЗаполнитьДанныеРегистраВерсииКлассификаторовОбластейДанных(Параметры) Экспорт
	...
	Попытка
		...
		ВерсииКлассификаторов.Заполнить(Неопределено);
...
#Область ДляВызоваИзДругихПодсисте
