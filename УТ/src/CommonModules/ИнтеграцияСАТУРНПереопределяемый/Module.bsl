...
//
// Параметры:
//  Реквизиты - см. ИнтеграцияСАТУРН.ИнициализироватьСтруктуруРеквизитовТранспортногоСредства
...
Процедура ПриОпределенииРеквизитовТранспортногоСредства(Реквизиты, ТранспортноеСредство) Экспорт
	...
	Если ЗначениеЗаполнено(ТранспортноеСредство) Тогда
		...
		Реквизиты.НомерТранспортногоПрицепа  = ЗначенияРеквизитов.ГосударственныйНомерПрицепа;
