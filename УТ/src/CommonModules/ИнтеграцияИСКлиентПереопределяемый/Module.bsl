...
// При обновлениия поля интеграции в форме документа основания.
// 
// Параметры:
//  Форма - ФормаКлиентскогоПриложения
//  Подсистема - Строка - имя подсистемы
Процедура ПриОбновлениияПоляИнтеграцииВФормеДокументаОснования(Форма, Подсистема) Экспорт
...
Процедура ЗаполнитьДляУказанияСерийНуженСерверныйВызов(
	...
	Если Форма.ИмяФормы = "Обработка.ПроверкаИПодборПродукцииИС.Форма.ПроверкаИПодбор" Тогда
		Если ПараметрыУказанияСерийКопия <> Неопределено Тогда
			...
			ИначеЕсли ПараметрыУказанияСерийКопия.Свойство("Товары") Тогда
				ПараметрыУказанияСерийКопия = ПараметрыУказанияСерийКопия.Товары;
			ИначеЕсли ПараметрыУказанияСерийКопия.Свойство("Сырье") Тогда
				ПараметрыУказанияСерийКопия = ПараметрыУказанияСерийКопия.Сырье;
			КонецЕсли;
	...
	Если ТипЗнч(ТекущиеДанные) = Тип("ФормаКлиентскогоПриложения") Тогда 
		...
		|	СтатусУказанияСерийОтправитель,СтатусУказанияСерийПолучатель,СтатусУказанияСерийОтгруженныхТоваров");
