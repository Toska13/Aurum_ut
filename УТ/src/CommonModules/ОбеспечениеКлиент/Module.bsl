...
//  ПараметрыПроверки - см. ОбеспечениеКлиентСервер.ИнициализироватьПараметрыПроверкиЗаполнения
...
//  Возвращаемое значение:
//   Структура: 
//    * КлючНазначенияИспользования - Строка, Неопределено - См. одноименный параметр форм.
...
Функция ПараметрыОткрытияФормыОбработкиОбеспечениеПотребностей() Экспорт
	...
	Результат.Вставить("КлючНазначенияИспользования", Неопределено);
