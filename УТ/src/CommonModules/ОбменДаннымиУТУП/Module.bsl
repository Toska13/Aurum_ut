...
Функция ОпределитьПараметрыЗапросаОбъекта(ЭлементДанных, ТипЗначенияОбъекта = Неопределено, ФормироватьИерархию = Истина) Экспорт
	...
	ИначеЕсли ТипЗначенияОбъекта = Тип("ДокументОбъект.ЗаказНаДоставку") Тогда
		
		ЗначенияФильтра_ЗаказНаДоставку(ЭлементДанных, ПараметрыЗапроса, ФормироватьИерархию);
	...
	ИначеЕсли ТипЗначенияОбъекта = Тип("ДокументОбъект.ЗаявкаНаДепозитОбменСБанками") Тогда
		
		ЗначенияФильтра_ЗаявкаНаДепозитОбменСБанками(ЭлементДанных, ПараметрыЗапроса, ФормироватьИерархию);
	...
	ИначеЕсли ТипЗначенияОбъекта = Тип("ДокументОбъект.Рейс") Тогда
		
		ЗначенияФильтра_Рейс(ЭлементДанных, ПараметрыЗапроса, ФормироватьИерархию);
	...
	ИначеЕсли ТипЗначенияОбъекта = Тип("РегистрНакопленияЗапись.Доставка") Тогда
		
		ЗначенияФильтра_РегистрыНакопления_Доставка(ЭлементДанных, ПараметрыЗапроса, ФормироватьИерархию);
	...
	ИначеЕсли ТипЗначенияОбъекта = Тип("РегистрСведенийЗапись.ВходящиеПлатежныеСсылкиСБП") Тогда
		
		ЗначенияФильтра_РегистрыСведений_ВходящиеПлатежныеСсылкиСБП(ЭлементДанных, ПараметрыЗапроса, ФормироватьИерархию);
	...
	ИначеЕсли ТипЗначенияОбъекта = Тип("РегистрСведенийЗапись.ИдентификаторыПлатежныхСистем") Тогда
		
		ЗначенияФильтра_РегистрыСведений_ИдентификаторыПлатежныхСистем(ЭлементДанных, ПараметрыЗапроса, ФормироватьИерархию);
	...
	ИначеЕсли ТипЗначенияОбъекта = Тип("РегистрСведенийЗапись.КомментарииСверкиВзаиморасчетов") Тогда
		
		ЗначенияФильтра_РегистрыСведений_КомментарииСверкиВзаиморасчетов(ЭлементДанных, ПараметрыЗапроса, ФормироватьИерархию);
	...
	ИначеЕсли ТипЗначенияОбъекта = Тип("РегистрСведенийЗапись.СервисСверкиРасчетовУстраненныеРасхождения") Тогда
		
		ЗначенияФильтра_РегистрыСведений_СервисСверкиРасчетовУстраненныеРасхождения(ЭлементДанных, ПараметрыЗапроса, ФормироватьИерархию);
	...
	ИначеЕсли ТипЗначенияОбъекта = Тип("СправочникОбъект.КонтролируемыеПартии") Тогда
		
		ЗначенияФильтра_Справочники_КонтролируемыеПартии(ЭлементДанных, ПараметрыЗапроса, ФормироватьИерархию);
	...
	ИначеЕсли ТипЗначенияОбъекта = Тип("СправочникОбъект.ТочкиДоставки") Тогда
		
		ЗначенияФильтра_Справочники_ТочкиДоставки(ЭлементДанных, ПараметрыЗапроса, ФормироватьИерархию);
	...
	ИначеЕсли ТипЗначенияОбъекта = Тип("СправочникОбъект.НастройкиАвторизацииМакс") Тогда
		
		ЗначенияФильтра_Справочники_НастройкиАвторизацииМакс(ЭлементДанных, ПараметрыЗапроса, ФормироватьИерархию);
...
Процедура ЗначенияФильтра_ЗаказНаДоставку(Объект, ПараметрыЗапроса, ФормироватьИерархию)
	ОтборПоПодразделениюИзРеквизитаИОрганизации(Объект, ПараметрыЗапроса, ФормироватьИерархию, "Отправитель");
	ПараметрыЗапроса.РеквизитПроверкиПодразделения = НСтр("ru = 'Подразделение, указанное в складе-отправителе'");
КонецПроцедуры
...
Процедура ЗначенияФильтра_Рейс(Объект, ПараметрыЗапроса, ФормироватьИерархию)
	ОтборПоПодразделениюИзРеквизитаИОрганизации(Объект, ПараметрыЗапроса, ФормироватьИерархию, "СкладОтправления");
	ПараметрыЗапроса.РеквизитПроверкиПодразделения = НСтр("ru = 'Подразделение, указанное в складе отправления'");
КонецПроцедуры
...
Процедура ЗначенияФильтра_ЗаявкаНаДепозитОбменСБанками(Объект, ПараметрыЗапроса, ФормироватьИерархию)
	ОтборПоОрганизацииОбъекта(Объект, ПараметрыЗапроса, ФормироватьИерархию);
КонецПроцедуры
...
Процедура ЗначенияФильтра_РегистрыНакопления_Доставка(Объект, ПараметрыЗапроса, ФормироватьИерархию)
...
Процедура ЗначенияФильтра_РегистрыСведений_ВходящиеПлатежныеСсылкиСБП(Объект, ПараметрыЗапроса, ФормироватьИерархию)
...
Процедура ЗначенияФильтра_РегистрыСведений_ИдентификаторыПлатежныхСистем(Объект, ПараметрыЗапроса, ФормироватьИерархию)
...
Процедура ЗначенияФильтра_РегистрыСведений_КомментарииСверкиВзаиморасчетов(Объект, ПараметрыЗапроса, ФормироватьИерархию)
	ОтборПоОрганизацииОбъекта(Объект, ПараметрыЗапроса, ФормироватьИерархию);
КонецПроцедуры
...
Процедура ЗначенияФильтра_РегистрыСведений_СервисСверкиРасчетовУстраненныеРасхождения(Объект, ПараметрыЗапроса, ФормироватьИерархию)
	ОтборПоОрганизацииОбъекта(Объект, ПараметрыЗапроса, ФормироватьИерархию);
КонецПроцедуры
...
Процедура ЗначенияФильтра_Справочники_НастройкиАвторизацииМакс(Объект, ПараметрыЗапроса, ФормироватьИерархию)
...
Процедура ЗначенияФильтра_Справочники_КонтролируемыеПартии(Объект, ПараметрыЗапроса, ФормироватьИерархию)
	
	Если ПроверитьНаличиеСвязаннойСсылки(Объект.Партия, ПараметрыЗапроса) Тогда
		
		ОбъектДокументПартии = Объект.Партия.ПолучитьОбъект();
		
		ПараметрыЗапроса = ОпределитьПараметрыЗапросаОбъекта(ОбъектДокументПартии, ТипЗнч(ОбъектДокументПартии), ФормироватьИерархию);
...
Процедура ЗначенияФильтра_Справочники_ТочкиДоставки(Объект, ПараметрыЗапроса, ФормироватьИерархию)
	
	Если ТипЗнч(Объект.Владелец) = Тип("СправочникСсылка.Склады") Тогда
