	...
	Если ИсторияНаименований.Количество() > 0 Тогда
		...
		Для Счетчик = 0 По ИсторияНаименований.Количество() - 1 Цикл
			...
			Если Не ЭтоЮрЛицо Тогда
				...
				ПартнерыИКонтрагентыЛокализацияКлиент.ДополнитьДанныеИсторииНаименования(СтрокаИсторииНаименований, ИмяРеквизитаСокращенноеНаименование, РеквизитыКомпании.НаименованиеСокращенное);
