...
//   "ПолноеНаименованиеОрганизации" (обязательное)
...
Процедура ПриСозданииФормыПодсистемы(Контекст, Отказ, СтандартнаяОбработка) Экспорт
	...
	ИнтеграцияСМаркетплейсамиСервер.ПриСозданииФормыСопоставленияНоменклатуры(Контекст, Отказ, СтандартнаяОбработка);
