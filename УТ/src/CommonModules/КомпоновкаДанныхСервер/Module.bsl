...
// Возвращает схему компоновки данных с набором данных с заданным текстом запроса.
//
// Параметры:
//  ТекстЗапроса - Строка - текст запроса для набора данных
//
// Возвращаемое значение:
//  СхемаКомпоновкиДанных
//
Функция СхемаКомпоновкиДанныхПоТекстуЗапроса(ТекстЗапроса) Экспорт
	
	СхемаКомпоновкиДанных = ПустаяСхема();
	НаборДанных = ДобавитьПустойНаборДанных(СхемаКомпоновкиДанных);
...
Процедура СформироватьГрадиентПоСериямЦветов(СтруктураСерийЦветов)
	Для Каждого СерияРазныхЦветов Из СтруктураСерийЦветов Цикл 
		ДанныеСерии = СерияРазныхЦветов.Значение; // Структура -
