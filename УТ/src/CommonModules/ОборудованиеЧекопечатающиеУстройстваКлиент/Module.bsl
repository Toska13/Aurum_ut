...
// Начать подготовку данных аутентификации ТС ПИоТ.
//
// Параметры:
//   ОповещениеПриЗавершении - ОписаниеОповещения - оповещение при завершении.
//   ИдентификаторКлиента    - ФормаКлиентскогоПриложения -идентификатор формы.
...
//   ДополнительныеПараметры - Структура - дополнительные команды.
//
Процедура НачатьПодготовитьДанныеАутентификацииПиот(ОповещениеПриЗавершении, ИдентификаторКлиента, ИдентификаторУстройства, ПараметрыОперации = Неопределено, ДополнительныеПараметры = Неопределено) Экспорт
	
	ПараметрыВыполнениеКоманды = МенеджерОборудованияКлиентСервер.ПараметрыВыполнениеКоманды("PiotSetChallenge", 
		"ОборудованиеЧекопечатающиеУстройства", ДополнительныеПараметры, Ложь, Ложь);
...
// Извлечь токен аутентификации ТС ПИоТ.
//
// Параметры:
//   ОповещениеПриЗавершении - ОписаниеОповещения - оповещение при завершении.
//   ИдентификаторКлиента    - ФормаКлиентскогоПриложения -идентификатор формы.
...
//   ДополнительныеПараметры - Структура - дополнительные команды.
//
Процедура НачатьИзвлечьТокенАутентификацииПИоТ(ОповещениеПриЗавершении, ИдентификаторКлиента, ИдентификаторУстройства, ПараметрыОперации = Неопределено, ДополнительныеПараметры = Неопределено) Экспорт
	
	ПараметрыВыполнениеКоманды = МенеджерОборудованияКлиентСервер.ПараметрыВыполнениеКоманды("PiotCheckChallenge", 
		"ОборудованиеЧекопечатающиеУстройства", ДополнительныеПараметры, Ложь, Ложь);
...
// Сформировать контейнер ТС ПИоТ.
//
// Параметры:
//   ОповещениеПриЗавершении - ОписаниеОповещения - оповещение при завершении.
//   ИдентификаторКлиента    - ФормаКлиентскогоПриложения -идентификатор формы.
...
//   ДополнительныеПараметры - Структура - дополнительные команды.
//
Процедура НачатьСформироватьКонтейнерПИоТПИоТ(ОповещениеПриЗавершении, ИдентификаторКлиента, ИдентификаторУстройства, ПараметрыОперации = Неопределено, ДополнительныеПараметры = Неопределено) Экспорт
	
	ПараметрыВыполнениеКоманды = МенеджерОборудованияКлиентСервер.ПараметрыВыполнениеКоманды("PiotSetDKMsg", 
		"ОборудованиеЧекопечатающиеУстройства", ДополнительныеПараметры, Ложь, Ложь);
...
// Расшифровать контейнер ТС ПИоТ.
//
// Параметры:
//   ОповещениеПриЗавершении - ОписаниеОповещения - оповещение при завершении.
//   ИдентификаторКлиента    - ФормаКлиентскогоПриложения -идентификатор формы.
...
//   ДополнительныеПараметры - Структура - дополнительные команды.
//
Процедура НачатьРасшифроватьКонтейнерПИоТ(ОповещениеПриЗавершении, ИдентификаторКлиента, ИдентификаторУстройства, ПараметрыОперации = Неопределено, ДополнительныеПараметры = Неопределено) Экспорт
	
	ПараметрыВыполнениеКоманды = МенеджерОборудованияКлиентСервер.ПараметрыВыполнениеКоманды("PiotGetDKMsg", 
		"ОборудованиеЧекопечатающиеУстройства", ДополнительныеПараметры, Ложь, Ложь);
...
//   ДополнительныеПараметры - Структура - дополнительные команды.
//
Процедура НачатьРаботуПИоТ(ОповещениеПриЗавершении, ИдентификаторКлиента, ИдентификаторУстройства, ПараметрыОперации = Неопределено, ДополнительныеПараметры = Неопределено) Экспорт
	
	Если ПараметрыОперации = Неопределено Тогда
		ПараметрыОперации = Новый Структура();  
	КонецЕсли;
		
	ПараметрыВыполнениеКоманды = МенеджерОборудованияКлиентСервер.ПараметрыВыполнениеКоманды("PiotStart", 
		"ОборудованиеЧекопечатающиеУстройства", ДополнительныеПараметры, Ложь, Ложь);
...
// Начать получение статуса ТС ПИоТ
//
// Параметры:
//   ОповещениеПриЗавершении - ОписаниеОповещения - оповещение при завершении.
//   ИдентификаторКлиента    - ФормаКлиентскогоПриложения -идентификатор формы.
...
//   ДополнительныеПараметры - Структура - дополнительные команды.
//
Процедура НачатьПолучениеСтатусаПИоТ(ОповещениеПриЗавершении, ИдентификаторКлиента, ИдентификаторУстройства, ПараметрыОперации = Неопределено, ДополнительныеПараметры = Неопределено) Экспорт
	
	Если ПараметрыОперации = Неопределено Тогда
		ПараметрыОперации = Новый Структура();  
	КонецЕсли;
		
	ПараметрыВыполнениеКоманды = МенеджерОборудованияКлиентСервер.ПараметрыВыполнениеКоманды("PiotStatus", 
		"ОборудованиеЧекопечатающиеУстройства", ДополнительныеПараметры, Ложь, Ложь);
	ПараметрыВыполнениеКоманды.ПодготовитьДанные = Ложь;   
	ПараметрыВыполнениеКоманды.ПодготовитьДанныеКлиент = Истина;  
	ПараметрыВыполнениеКоманды.ОбработатьДанныеКлиент  = Истина; 
...
//   ДополнительныеПараметры - Структура - дополнительные команды.
//
Процедура НачатьПроверкаКМПИоТ(ОповещениеПриЗавершении, ИдентификаторКлиента, ИдентификаторУстройства, ПараметрыОперации = Неопределено, ДополнительныеПараметры = Неопределено) Экспорт
	
	ПараметрыВыполнениеКоманды = МенеджерОборудованияКлиентСервер.ПараметрыВыполнениеКоманды("PiotCheckKM", 
		"ОборудованиеЧекопечатающиеУстройства", ДополнительныеПараметры, Ложь, Ложь);   
	ПараметрыВыполнениеКоманды.ПодготовитьДанные = Истина;
	ПараметрыВыполнениеКоманды.ОбработатьДанныеКлиент  = Истина;       
	ПараметрыВыполнениеКоманды.ОбработатьДанныеПриОшибке = Истина;   
	ПараметрыОперации.Вставить("ИдентификаторКлиента", ИдентификаторКлиента);   
...
//   ДополнительныеПараметры - Структура - дополнительные команды.
//
Процедура НачатьПолучениеСлужебнойИнформацииПИоТ(ОповещениеПриЗавершении, ИдентификаторКлиента, ИдентификаторУстройства, ПараметрыОперации = Неопределено, ДополнительныеПараметры = Неопределено) Экспорт
	
	Если ПараметрыОперации = Неопределено Тогда
		ПараметрыОперации = Новый Структура();  
	КонецЕсли;
		
	ПараметрыВыполнениеКоманды = МенеджерОборудованияКлиентСервер.ПараметрыВыполнениеКоманды("ServiceInformation", 
		"ОборудованиеЧекопечатающиеУстройства", ДополнительныеПараметры, Ложь, Ложь);
	ПараметрыВыполнениеКоманды.ПодготовитьДанные = Ложь;   
	ПараметрыВыполнениеКоманды.ПодготовитьДанныеКлиент = Ложь;  
	ПараметрыВыполнениеКоманды.ОбработатьДанныеКлиент  = Истина; 
	ПараметрыОперации.Вставить("ИдентификаторКлиента", ИдентификаторКлиента);   
...
// Начать снятие экземпляра с регистрации ПИоТ
//
// Параметры:
//   ОповещениеПриЗавершении - ОписаниеОповещения - оповещение при завершении.
//   ИдентификаторКлиента    - ФормаКлиентскогоПриложения -идентификатор формы.
...
//   ДополнительныеПараметры - Структура - дополнительные команды.
//
Процедура НачатьСнятьЭкземплярСРегистрацииПИоТ(ОповещениеПриЗавершении, ИдентификаторКлиента, ИдентификаторУстройства, ПараметрыОперации = Неопределено, ДополнительныеПараметры = Неопределено) Экспорт
	
	Если ПараметрыОперации = Неопределено Тогда
		ПараметрыОперации = Новый Структура();  
	КонецЕсли;
		
	ПараметрыВыполнениеКоманды = МенеджерОборудованияКлиентСервер.ПараметрыВыполнениеКоманды("PiotUnregister", 
		"ОборудованиеЧекопечатающиеУстройства", ДополнительныеПараметры, Ложь, Ложь);
	ПараметрыВыполнениеКоманды.ПодготовитьДанные = Ложь;   
	ПараметрыВыполнениеКоманды.ПодготовитьДанныеКлиент = Ложь;  
	ПараметрыОперации.Вставить("ИдентификаторКлиента", ИдентификаторКлиента);   
...
// Функция возвращает поддерживает ли фискальное устройство ТСПИоТ.
// 
// Параметры:
//  ИдентификаторУстройства - СправочникСсылка.ПодключаемоеОборудование - Идентификатор устройства.
// 
// Возвращаемое значение:
//  Булево - Фискальное устройство поддерживает ТСПИоТ
...
Функция ПодготовитьДанныеОперации(ПараметрыПодключения, Команда, ПараметрыОперации, ДанныеОперации) Экспорт
	...
	ИначеЕсли Команда = "PiotStatus" Тогда  
...
Процедура ОбработатьДанныеОперации(ПараметрыПодключения, Команда, РезультатВыполнения, ДанныеОперации) Экспорт
	...
	ИначеЕсли Команда = "PiotStart" Или Команда = "PiotCheckKM" Или Команда = "PiotStatus"  Тогда  
		...
		Если РезультатВыполнения.Свойство("СтатусСостоянияXML") Тогда
			СтатусСостоянияСтруктура = ПолучитьСтатусСостоянияИзXMLПакета(РезультатВыполнения.СтатусСостоянияXML); 
		Иначе
			СтатусСостоянияСтруктура = Неопределено;
		КонецЕсли;        
		РезультатВыполнения.Вставить("СтатусСостояния", СтатусСостоянияСтруктура); 
		
		Если Команда = "PiotCheckKM" Тогда
			Если РезультатВыполнения.Свойство("РезультатПараметрыXML") Тогда
				РезультатПараметрыСтруктура = ПолучитьПараметрыРезультатаИзXMLПакета(РезультатВыполнения.РезультатПараметрыXML); 
			Иначе
				РезультатПараметрыСтруктура = Неопределено;
			КонецЕсли;        
			РезультатВыполнения.Вставить("РезультатПараметры", РезультатПараметрыСтруктура); 
		КонецЕсли;  
		// -- Локализация
		
	ИначеЕсли Команда = "ServiceInformation"  Тогда  

		// ++ Локализация
		Если РезультатВыполнения.Свойство("СлужебнаяИнформацияXML") Тогда
			СлужебнаяИнформацияСтруктура = ПолучитьСлужебнуюИнформациюИзXMLПакета(РезультатВыполнения.СлужебнаяИнформацияXML); 
		Иначе
			СлужебнаяИнформацияСтруктура = Неопределено;
		КонецЕсли;        
		РезультатВыполнения.Вставить("СлужебнаяИнформация", СлужебнаяИнформацияСтруктура); 
		// -- Локализация
...
#Если ВебКлиент Тогда
	Возврат ОборудованиеЧекопечатающиеУстройстваВызовСервера.ПолучитьПараметрыСостоянияИзXMLПакета(Данные, НомерСмены);
#Иначе
...
#Если ВебКлиент Тогда
	Возврат ОборудованиеЧекопечатающиеУстройстваВызовСервера.ПолучитьСтатусСостоянияИзXMLПакета(Данные);
#Иначе
...
#Если ВебКлиент Тогда
	Возврат ОборудованиеЧекопечатающиеУстройстваВызовСервера.ПолучитьПараметрыРезультатаИзXMLПакета(Данные);
#Иначе
...
#Если ВебКлиент Тогда
	Возврат ОборудованиеЧекопечатающиеУстройстваВызовСервера.ПолучитьСлужебнуюИнформациюИзXMLПакета(Данные);
#Иначе
