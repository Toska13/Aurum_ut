...
Функция ПараметрыВыполненияВФоне(ПараметрыПроцедуры) Экспорт
...
Функция ОтправитьФайлНаСервер(Соединение, Файл)
	...
	ИмяФайла = ОбщегоНазначенияБТСКлиентСервер.ЗаголовокHTTP(Ответ, "X-New-Name");
...
Процедура ПриОпределенииМетодовРазрешенныхДляВызоваКакПроизвольныйКод(Методы) Экспорт
	...
	Методы.Вставить("ПолучитьВременныйПароль", Истина);
	Методы.Вставить("ПолучитьСеансовыйКлюч", Истина);
	Методы.Вставить("ПолучитьНастройкиПолученияВременныхПаролей", Истина);
	Методы.Вставить("ПроверитьСертификатСПараметрами", Истина);
	Методы.Вставить("ПроверитьСертификат", Истина);
	Методы.Вставить("ПроверитьПодпись", Истина);
	Методы.Вставить("Подписать", Истина);
	Методы.Вставить("РасшифроватьБлок", Истина);
	Методы.Вставить("Расшифровать", Истина);
	Методы.Вставить("ЗашифроватьБлок", Истина);
	Методы.Вставить("Зашифровать", Истина);
	Методы.Вставить("ХешированиеДанных", Истина);
	Методы.Вставить("ПолучитьСвойстваКриптосообщения", Истина);
	Методы.Вставить("ПолучитьСертификатыИзПодписи", Истина);
