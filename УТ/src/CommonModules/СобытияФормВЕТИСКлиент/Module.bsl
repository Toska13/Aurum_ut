...
//   * Продукция - СправочникСсылка.ПродукцияВЕТИС - данные продукции
//   * ЕдиницаИзмеренияВЕТИС - СправочникСсылка.ЕдиницыИзмеренияВЕТИС - данные единицы измерения
...
Процедура ПриСозданииНоменклатуры(Элемент, ДанныеСтроки, СтандартнаяОбработка) Экспорт
	...
	ДанныеЗаполнения = ИнтеграцияВЕТИСВызовСервера.ПараметрыСозданияНоменклатуры(ДанныеСтроки.Продукция, ДанныеСтроки.ЕдиницаИзмеренияВЕТИС);
	
	Если ОбщегоНазначенияКлиентСервер.ЕстьРеквизитИлиСвойствоОбъекта(ДанныеСтроки,"ДанныеВСД")
		И ДанныеСтроки.ДанныеВСД <> Неопределено
		И ЗначениеЗаполнено(ДанныеСтроки.ДанныеВСД.ВетеринарноСопроводительныйДокумент) Тогда
		
		ДанныеЗаполнения.Вставить("СтранаПроизводства", ДанныеСтроки.ДанныеВСД.СтранаПроизводства);
		ДанныеЗаполнения.Вставить("Производители", ДанныеСтроки.ДанныеВСД.АдресаТабличныхЧастей.Производители);
