...
// 
// Параметры:
//  ДокументСсылка - ДокументСсылка.СчетНаОплатуКлиенту - счет на оплату, в котором формируется текст гиперссылки.
//  НадписьГиперссылки - ФорматированнаяСтрока - строка с текстом гиперссылки.
//
Процедура УстановитьНадписьОплатыСБП(ДокументСсылка, НадписьГиперссылки) Экспорт

	//++ Локализация
	НадписьГиперссылки = СистемаБыстрыхПлатежейУТ.ТекстНадписиОплатыСБП(ДокументСсылка);
	//-- Локализация
...
//
// Параметры:
//  Элемент - ГруппаФормы - группа, зависимая от формы оплаты.
//  ДокументСсылка - ДокументСсылка.СчетНаОплатуКлиенту - счет на оплату, в котором устанавливается доступность.
//  ФормаОплаты - ПеречислениеСсылка.ФормыОплаты - форма оплаты в счете на оплату.
//
Процедура УстановитьДоступностьЭлементовПоФормеОплаты(Элемент, ДокументСсылка, ФормаОплаты) Экспорт

	//++ Локализация
	Элемент.Видимость = 
		ДенежныеСредстваСерверЛокализация.ДоступнаГиперссылкаСБП(ДокументСсылка, ФормаОплаты, Ложь);
	//-- Локализация
