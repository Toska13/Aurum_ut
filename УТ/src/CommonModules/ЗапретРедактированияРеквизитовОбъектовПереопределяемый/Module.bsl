...
Процедура ПриОпределенииОбъектовСЗаблокированнымиРеквизитами(Объекты) Экспорт
	...
	Объекты.Вставить(Метаданные.Справочники.ВидыРетроБонусовКлиентов.ПолноеИмя(), "ПолучитьБлокируемыеРеквизитыОбъекта");
	Объекты.Вставить(Метаданные.Справочники.ВидыРетроБонусовПоставщиков.ПолноеИмя(), "ПолучитьБлокируемыеРеквизитыОбъекта");
	...
	Объекты.Вставить(Метаданные.Справочники.ДоговорыМеждуОрганизациями.ПолноеИмя(), "ПолучитьБлокируемыеРеквизитыОбъекта");
	...
	Объекты.Вставить(Метаданные.Справочники.ТочкиДоставки.ПолноеИмя(), "ПолучитьБлокируемыеРеквизитыОбъекта");
	...
	Объекты.Вставить(Метаданные.Справочники.КатегорииПодакцизныхТоваров.ПолноеИмя(), "ПолучитьБлокируемыеРеквизитыОбъекта");
