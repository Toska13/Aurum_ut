...
//  ПараметрыСбораСтатистики - Структура - см. ЗаполнениеОбъектовПоСтатистике.НовыйПараметрыСбораСтатистики()
//  БезУчетаАвтора - Булево - Истина, если не нужно учитывать автора при определении значения реквизита.
//
//  Возвращаемое значение:
...
Функция ЗначениеРеквизитаПоСтатистике(
	...
	БезУчетаАвтора = Ложь) Экспорт
		
	ЧастотаИспользованияЗначения = ПараметрыСбораСтатистики.ЧастотаИспользованияЗначения;
	РазмерВыборки = ПараметрыСбораСтатистики.РазмерВыборки;
	...
	Для Каждого Родитель Из ЗначенияРеквизитовРодителей Цикл
		Если БезУчетаАвтора И Родитель.Ключ = "Автор" Тогда 
			Продолжить;
		КонецЕсли;
...
Функция ШаблонОписанияРеквизитовОбъекта()
	...
	ОписаниеРеквизитовОбъекта.Вставить("ПараметрыСбораСтатистики",    Новый Структура);
...
Процедура ДобавитьВОписаниеРеквизитыОбъекта(ИмяОбъектаМетаданных, ОписаниеРеквизитовОбъекта, ЗаполняемыеРеквизиты)
	...
	Для Каждого ЗаполняемыйРеквизит Из ЗаполняемыеРеквизиты Цикл
		...
		Для Каждого РеквизитРодитель Из ЗаполняемыйРеквизит.Значение Цикл
			...
			Если РеквизитРодитель.Ключ = "ПараметрыСбораСтатистики" Тогда
				ОписаниеРеквизитовОбъекта.ПараметрыСбораСтатистики.Вставить(ЗаполняемыйРеквизит.Ключ,
