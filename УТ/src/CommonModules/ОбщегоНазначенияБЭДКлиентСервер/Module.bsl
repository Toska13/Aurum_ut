...
// * ТЭДО - Строка
// * МашиночитаемыеДоверенности - Строка
Функция ПодсистемыБЭД() Экспорт
	...
	Подсистемы.Вставить("МашиночитаемыеДоверенности", "ЭлектронноеВзаимодействие.ОбменСКонтрагентами.МашиночитаемыеДоверенности");
...
Функция ЭтоКППФилиалаИностраннойОрганизации(КПП) Экспорт
	...
	КодПричиныПостановкиНаУчет = ОписаниеТипаЧисло.ПривестиЗначение(Сред(КПП, 5, 2));
	...
	Возврат КодПричиныПостановкиНаУчет >= 51 И КодПричиныПостановкиНаУчет <= 99;
...
// Функция для поиска значения в структуре
// Параметры:
//   Данные - Структура
//   ЗначениеДляПоиска - Произвольный
// Возвращаемое значение:
//   Булево - Истина, если значение найдено
Функция СтруктураСодержитЗначение(Данные, ЗначениеДляПоиска) Экспорт
	Для Каждого Элемент Из Данные Цикл
		Если Элемент.Значение = ЗначениеДляПоиска Тогда
			Возврат Истина;
		КонецЕсли;
	КонецЦикла;
	Возврат Ложь;
...
// Параметры:
//  Массив1 - Массив из Произвольный
//  Массив2 - Массив из Произвольный
// 
// Возвращаемое значение:
//  Массив из Произвольный
