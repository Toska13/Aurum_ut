...
Процедура ПриДобавленииОбработчиковОбновления(Обработчики) Экспорт
	...
	Обработчик.Процедура = "ОбновлениеИнформационнойБазыБИД.ПерейтиНаВерсию_3_0_4_2";
	Обработчик.РежимВыполнения = "Оперативно";
	Обработчик.Комментарий = НСтр("ru = 'Обновление правил интеграции с 1С:Документооборотом'");
...
Процедура ПриОпределенииМетодовРазрешенныхДляВызоваКакПроизвольныйКод(Методы) Экспорт
	...
	Методы.Вставить("ПроверитьСоответствиеПравилИнтеграцииМетаданным");
	Методы.Вставить("ПриОбновленииИнформационнойБазы");
	Методы.Вставить("ПерейтиНаВерсию_1_1_6_1");
	Методы.Вставить("ПерейтиНаВерсию_1_1_8_4");
	Методы.Вставить("ПерейтиНаВерсию_1_1_12_2");
	Методы.Вставить("ПерейтиНаВерсию_3_0_1_1");
	Методы.Вставить("ПерейтиНаВерсию_3_0_2_1");
	Методы.Вставить("ПерейтиНаВерсию_3_0_2_5");
	Методы.Вставить("ПерейтиНаВерсию_3_0_3_1");
	Методы.Вставить("ПерейтиНаВерсию_3_0_4_2");
...
Процедура ПроверитьСоответствиеПравилИнтеграцииМетаданным() Экспорт
	...
	Если ИнтеграцияС1СДокументооборотБазоваяФункциональность.ЕстьПодсистемаДО3() Тогда
		...
		МодульИнтеграцияС1СДокументооборот3.ПроверитьСоответствиеПравилИнтеграцииМетаданным();
	КонецЕсли;
...
Процедура ПерейтиНаВерсию_3_0_4_2() Экспорт
	...
	Если ИнтеграцияС1СДокументооборотБазоваяФункциональность.ЕстьПодсистемаДО2() Тогда
		МодульИнтеграцияС1СДокументооборот = ОбщегоНазначения.ОбщийМодуль("ИнтеграцияС1СДокументооборот");
		МодульИнтеграцияС1СДокументооборот.ПерейтиНаВерсию_3_0_4_2();
	КонецЕсли;
	Если ИнтеграцияС1СДокументооборотБазоваяФункциональность.ЕстьПодсистемаДО3() Тогда
		МодульИнтеграцияС1СДокументооборот3 = ОбщегоНазначения.ОбщийМодуль("ИнтеграцияС1СДокументооборот3");
		МодульИнтеграцияС1СДокументооборот3.ПерейтиНаВерсию_3_0_4_2();
	КонецЕсли;
