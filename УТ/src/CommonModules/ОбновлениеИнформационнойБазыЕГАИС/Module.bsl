...
Процедура ПриДобавленииПодсистемы(Описание) Экспорт
	...
	Описание.Версия = ОбщегоНазначенияИС.ВерсияПодсистемы("11");
...
Процедура ПриОпределенииМетодовРазрешенныхДляВызоваКакПроизвольныйКод(Методы) Экспорт
	...
	Методы.Вставить("ЗаполнитьТипЗапроса");
	Методы.Вставить("ЗаполнитьИдентификаторЗапроса");
	Методы.Вставить("ЗаполнитьТипОрганизацииЕГАИС");
	Методы.Вставить("ЗаполнитьЕдиницуИзмеренияЛитр");
	Методы.Вставить("УстановитьПризнакИспользованияОбработкиОтветов");
	Методы.Вставить("ЗаполнитьИдентификаторАктаПостановкиНаБаланс");
	Методы.Вставить("ЗаполнитьВидыОперацийТТНВходящей");
	Методы.Вставить("ЗаполнитьДокументОснованиеВПротоколеОбмена");
	Методы.Вставить("ЗаполнитьПричинуПостановкиНаБаланс");
	Методы.Вставить("ЗаполнитьВидДокумента");
	Методы.Вставить("УстановитьПризнакПроведенияТТН");
	Методы.Вставить("УдалитьДвиженияПоТорговомуЗалу");
	Методы.Вставить("СоздатьСправкиВТТН");
	Методы.Вставить("ОбновитьСтатусыОбработкиЕГАИС");
	Методы.Вставить("УдалитьОбработчикОбновленияАктаСписания");
