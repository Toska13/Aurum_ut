...
// Имя серверного оповещения выполнена проверка в регламентном задании.
// 
// Возвращаемое значение:
//  Строка - Имя серверного оповещения выполнена проверка в регламентном задании
Функция ИмяСерверногоОповещенияВыполненаПроверкаВРегламентномЗадании() Экспорт
