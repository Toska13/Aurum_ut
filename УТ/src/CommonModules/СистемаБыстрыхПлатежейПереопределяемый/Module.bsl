...
Процедура ПриОпределенииНастроекПодключения(Настройки) Экспорт
	...
	СистемаБыстрыхПлатежейУТ.ПриОпределенииНастроекПодключения(Настройки);
	
	РозничныеПродажиЛокализация.ПриОпределенииНастроекПодключенияСБП(Настройки);
...
Процедура ПриЗаписиНастроекПодключения(
	...
	//++ Локализация
	СистемаБыстрыхПлатежейУТ.ПриЗаписиНастроекПодключения(ПараметрыОплаты, Отказ, СообщениеОбОшибке);
	//-- Локализация
...
Процедура ПриНастройкеЭлементовФормыПодключения(
	...
	//++ Локализация
	СистемаБыстрыхПлатежейУТ.ПриНастройкеЭлементовФормыПодключения(НастройкиФормы, ДополнительныеПараметры);
	//-- Локализация
...
Процедура ПриЗаполненииФормыНастройкиПодключения(
	...
	//++ Локализация
	СистемаБыстрыхПлатежейУТ.ПриЗаполненииФормыНастройкиПодключения(Настройки, ДополнительныеПараметры);
	//-- Локализация
...
Процедура ПриПроверкеИспользованияШаблоновСообщений(Используется) Экспорт
	...
	//++ Локализация
	СистемаБыстрыхПлатежейУТ.ПриПроверкеИспользованияШаблоновСообщений(Используется);
	//-- Локализация
...
Процедура ПриОпределенииПредопределенныхШаблоновСообщений(НастройкиШаблонов) Экспорт 
	...
	СистемаБыстрыхПлатежейУТ.ПриОпределенииПредопределенныхШаблоновСообщений(НастройкиШаблонов);
	//-- Локализация
...
Процедура ПриОпределенииОбъектовСКомандамиСБП(ИменаДокументовОперации) Экспорт
	...
	//++ Локализация
	СистемаБыстрыхПлатежейУТ.ПриОпределенииОбъектовСКомандамиСБП(ИменаДокументовОперации);
	//-- Локализация
...
Процедура ПриОпределенииДоступностиПодключенияПоДокументуОперации(
	...
	//++ Локализация
	СистемаБыстрыхПлатежейУТ.ПриОпределенииДоступностиПодключенияПоДокументуОперации(ДокументОперации, Результат);
	//-- Локализация
...
Процедура ПриОпределенииПараметровПодключенияДокументаОперации(
	...
	//++ Локализация
	СистемаБыстрыхПлатежейУТ.ПриОпределенииПараметровПодключенияДокументаОперации(
		ДокументОперации,
		НастройкиПодключения,
		ДополнительныеНастройки,
		ПараметрыВопроса);
...
Процедура ПриФормированииСпискаПолучателейСообщенияСБП(
	...
	//++ Локализация
	СистемаБыстрыхПлатежейУТ.ПриФормированииСпискаПолучателейСообщенияСБП(ДокументОперации, ВариантОтправки, Получатели);
	//-- Локализация
