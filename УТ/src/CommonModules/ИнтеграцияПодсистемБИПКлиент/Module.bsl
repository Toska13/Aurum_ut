...
// См. СообщенияВСлужбуТехническойПоддержкиКлиентПереопределяемый.ПриОпределенииПараметровСообщенияСлужбуТехническойПоддержки.
//
Процедура ПриОпределенииПараметровСообщенияСлужбуТехническойПоддержки(
		ДанныеСообщения,
		Контекст) Экспорт
	
	Если ИнтеграцияПодсистемБИПКлиентПовтИсп.ПодпискиБСП().ПриОпределенииПараметровСообщенияСлужбуТехническойПоддержки Тогда
		МодульИнтеграцияПодсистемБСПКлиент = ОбщегоНазначенияКлиент.ОбщийМодуль("ИнтеграцияПодсистемБСПКлиент");
		МодульИнтеграцияПодсистемБСПКлиент.ПриОпределенииПараметровСообщенияСлужбуТехническойПоддержки(
			ДанныеСообщения,
			Контекст);
	КонецЕсли;
...
// См. НастройкиПлатежныхСистемКлиентПереопределяемый.ПриНастройкеКассовыхСсылок
//
Процедура ПриНастройкеКассовыхСсылокПлатежныхСистем(
	ПараметрыНастройки,
	ПараметрыОплаты,
	ОповещениеПослеЗакрытияФормы) Экспорт

	Если ИнтеграцияПодсистемБИПКлиентПовтИсп.ПодпискиБСП().ПриНастройкеКассовыхСсылокПлатежныхСистем Тогда
		МодульИнтеграцияПодсистемБСПКлиент = ОбщегоНазначенияКлиент.ОбщийМодуль("ИнтеграцияПодсистемБСПКлиент");
		МодульИнтеграцияПодсистемБСПКлиент.ПриНастройкеКассовыхСсылокПлатежныхСистем(
			ПараметрыНастройки,
			ПараметрыОплаты,
			ОповещениеПослеЗакрытияФормы);
	КонецЕсли;
...
Функция СобытияБИП() Экспорт
	...
	События.Вставить("ПриОпределенииПараметровСообщенияСлужбуТехническойПоддержки", Ложь);
	...
	События.Вставить("ПриНастройкеКассовыхСсылокПлатежныхСистем", Ложь);
