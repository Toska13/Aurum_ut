...
Процедура ОбработкаНавигационнойСсылкиДОПП(Форма, Параметры, НавигационнаяСсылка, СтандартнаяОбработка) Экспорт
	...
	Если НавигационнаяСсылка = "ОткрытьСписокДОПП" Тогда
		...
		ИмяФормыУведомлений = "Документ.ДокументОПредстоящейПоставке.Форма.ФормаСписка";
		СтандартнаяОбработка = Ложь;
		СтруктураОтбора = Новый Структура;
		СтруктураОтбора.Вставить("ДокументОснование", Параметры.Основание);
		ПараметрыФормы.Вставить("Отбор", СтруктураОтбора);
	...
	ИначеЕсли НавигационнаяСсылка = "ОткрытьДОПП" Тогда
		...
		Если ЗначениеЗаполнено(Ключ) Тогда
			...
			ОткрытьФорму("Документ.ДокументОПредстоящейПоставке.Форма.ФормаДокументаДОПП", ПараметрыФормы, Форма);
		КонецЕсли;
