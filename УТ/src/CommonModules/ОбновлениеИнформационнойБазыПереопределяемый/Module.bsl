...
Процедура ПриОпределенииНастроек(Параметры) Экспорт
	...
	Объекты.Добавить(Метаданные.Справочники.ПричиныБлокировкиТоваров);
	...
	Объекты.Добавить(Метаданные.Справочники.ВидыНалоговВзносов);
	...
	Если Не ОбщегоНазначения.РазделениеВключено() Тогда
		Объекты.Добавить(Метаданные.Справочники.ОперацииЗакрытияМесяца);
	КонецЕсли;
	
	Если Не ОбщегоНазначения.РазделениеВключено() Тогда
		Объекты.Добавить(Метаданные.Справочники.ВидыНеоперативныхЗаданий);
	КонецЕсли;
...
Процедура ПриЗаполненииОбъектовПланируемыхКУдалению(Объекты) Экспорт
	...
	ОбновлениеИнформационнойБазы.ДобавитьОбъектПланируемыйКУдалению(Объекты,
		"Перечисление.УдалитьОперацииЗакрытияМесяца.УдалитьИсправлениеОшибокКорреспонденцииФинансовыхРегистров");
	ОбновлениеИнформационнойБазы.ДобавитьОбъектПланируемыйКУдалению(Объекты,
		"Перечисление.УдалитьОперацииЗакрытияМесяца.УдалитьПроверкаОшибокКорреспонденцииФинансовыхРегистров");
		
	
	ОбновлениеИнформационнойБазы.ДобавитьОбъектПланируемыйКУдалению(Объекты,
		"Документ.УдалитьКассоваяСмена");
	ОбновлениеИнформационнойБазы.ДобавитьОбъектПланируемыйКУдалению(Объекты,
		"Документ.УдалитьКассовыйЧекКоррекции");
	ОбновлениеИнформационнойБазы.ДобавитьОбъектПланируемыйКУдалению(Объекты,
		"Перечисление.УдалитьСтатусыКассовойСмены");
	
	ОбновлениеИнформационнойБазы.ДобавитьОбъектПланируемыйКУдалению(Объекты,
		"Документ.УдалитьРегистраторГрафикаДвиженияТоваров");
	
	ОбновлениеИнформационнойБазыЛокализация.ПриЗаполненииОбъектовПланируемыхКУдалению(Объекты);
	
	ОбновлениеИнформационнойБазы.ДобавитьОбъектПланируемыйКУдалению(Объекты,
		"Перечисление.УдалитьПорядокОплатыПоСоглашениям");
	ОбновлениеИнформационнойБазы.ДобавитьОбъектПланируемыйКУдалению(Объекты,
		"Перечисление.УдалитьТипыОперацийВводаОстатков");
