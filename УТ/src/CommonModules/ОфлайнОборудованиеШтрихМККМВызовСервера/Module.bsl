...
Функция ЗагружаемыеДанныеИзККМ(ТекстСодержания, ВыходныеПараметры) Экспорт
	...
	Пока ПродолжатьЧтениеФайла Цикл
		...
		Иначе
			...
			ИначеЕсли Транзакция.Тип = 175 Тогда
				//НалоговыеСтавки
				ДобавитьНалогиВЧек(ТекущаяСмена, Смены, Транзакция);
			КонецЕсли;
...
Функция СпискиНалоговИКомбинацийНалогов()
	...
	СтавкаНалога20.Вставить("Код", 11);
...
Процедура ДобавитьНалогиВЧек(Смена, Смены, Транзакция)
	...
	ИндексТовара = ТекущийЧек.Товары.Количество() - 1;
	
	Товар = ТекущийЧек.Товары[ИндексТовара];
	Товар.Вставить("СтавкаНДС", Неопределено);
	Если Товар.Свойство("СтавкаНДС") Тогда
		Товар.СтавкаНДС = Транзакция.Поле8;
	КонецЕсли;
	...
	Если Уровень = "Номенклатура" Тогда
		...
		ИначеЕсли ЗначениеЗаполнено(Источник.ЭтоМаркированнаяПродукция) И Источник.ЭтоМаркированнаяПродукция Тогда
			...
			ИначеЕсли Источник.ВидМаркированнойПродукции = ПредопределенноеЗначение("Перечисление.ВидыМаркированнойПродукцииБПО.БезалкогольноеПиво") Тогда
				ДанныеДляЗаполнения.Вставить("ТипМаркировки", "0027");
			ИначеЕсли Источник.ВидМаркированнойПродукции = ПредопределенноеЗначение("Перечисление.ВидыМаркированнойПродукцииБПО.КормаДляЖивотных")
				...
				ДанныеДляЗаполнения.Вставить("ТипМаркировки", "0028");
			ИначеЕсли Источник.ВидМаркированнойПродукции = ПредопределенноеЗначение("Перечисление.ВидыМаркированнойПродукцииБПО.ВетеринарныеПрепараты") Тогда
				ДанныеДляЗаполнения.Вставить("ТипМаркировки", "0029");
			ИначеЕсли Источник.ВидМаркированнойПродукции = ПредопределенноеЗначение("Перечисление.ВидыМаркированнойПродукцииБПО.МоторныеМасла") Тогда
				ДанныеДляЗаполнения.Вставить("ТипМаркировки", "0032");
			ИначеЕсли Источник.ВидМаркированнойПродукции = ПредопределенноеЗначение("Перечисление.ВидыМаркированнойПродукцииБПО.ИгрыИИгрушкиДляДетей") Тогда
				ДанныеДляЗаполнения.Вставить("ТипМаркировки", "0033");
			ИначеЕсли Источник.ВидМаркированнойПродукции = ПредопределенноеЗначение("Перечисление.ВидыМаркированнойПродукцииБПО.РастительныеМасла") Тогда
				ДанныеДляЗаполнения.Вставить("ТипМаркировки", "0035");
			ИначеЕсли Источник.ВидМаркированнойПродукции = ПредопределенноеЗначение("Перечисление.ВидыМаркированнойПродукцииБПО.ПарфюмерныеИКосметическиеСредстваИБытоваяХимия") Тогда
				ДанныеДляЗаполнения.Вставить("ТипМаркировки", "1006");
			Иначе
				ДанныеДляЗаполнения.Вставить("ТипМаркировки", "");
			КонецЕсли;
