...
Процедура ПередВыгрузкойДанных(Контейнер) Экспорт
	...
	ОбщегоНазначенияИС.ПередВыгрузкойДанных(Контейнер);
	//-- Локализация
...
Процедура ПередЗагрузкойДанных(Контейнер) Экспорт
	...
	ОбщегоНазначенияИС.ПередЗагрузкойДанных(Контейнер);
...
Процедура ПослеЗагрузкиДанных(Контейнер) Экспорт
	...
	ОбщегоНазначенияИС.ПослеЗагрузкиДанных(Контейнер);
...
Процедура ПриЗаполненииТиповОбщихДанныхПоддерживающихСопоставлениеСсылокПриЗагрузке(Типы) Экспорт
	...
	ОбщегоНазначенияИС.ПриЗаполненииТиповОбщихДанныхПоддерживающихСопоставлениеСсылокПриЗагрузке(Типы);
