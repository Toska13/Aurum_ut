...
Функция НачатьОтправкуЗаявлениеНаРегистрациюВСервис1СЭДО(ДанныеПакета, КонтекстДиагностики) Экспорт
	...
	Возврат ДлительныеОперации.ВыполнитьФункцию(ПараметрыВыполнения, 
		"СервисЭДО.ОтправитьРегистрационныйПакет1СЭДО", ДанныеПакета, КонтекстДиагностики, Неопределено);
...
Функция НачатьПолучениеПараметровУведомлений(КлючСинхронизации,
	...
	Возврат ДлительныеОперации.ВыполнитьФункцию(ПараметрыВыполнения, "СервисЭДО.ПолучитьПараметрыУведомлений",
		КлючСинхронизации);
...
Функция НачатьОбновлениеПараметровУведомлений(Знач ПараметрыУведомлений, КлючСинхронизации,
	...
	Возврат ДлительныеОперации.ВыполнитьФункцию(ПараметрыВыполнения, "СервисЭДО.ОбновитьПараметрыУведомлений", 
		ПараметрыУведомлений, КлючСинхронизации);
