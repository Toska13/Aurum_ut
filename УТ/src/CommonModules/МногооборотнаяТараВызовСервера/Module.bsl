...
Функция ПоместитьТоварыДляПодбораТарыВоВременноеХранилище(Знач Объект,
	                                                      ...
	                                                      Знач ИспользоватьДату,
                                                          Знач ИспользоватьДатуПоступления = Ложь) Экспорт
	...
	ТаблицаТоваров.Колонки.Добавить("ДатаПоступления");
	...
	Для Каждого ТекСтрока Из ТоварыОбъекта Цикл
		...
		Если ИспользоватьДатуПоступления Тогда
			НоваяСтрока.ДатаПоступления = ТекСтрока[МассивКолонок[5]];
		КонецЕсли;
