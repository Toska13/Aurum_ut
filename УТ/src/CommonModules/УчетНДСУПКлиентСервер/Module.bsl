...
//
Функция ТипыНалогообложенияСкрывающиеРеквизитыНДС(ИмяПоляВводаСтавкиНДС = "") Экспорт
	...
	УчетНДСКлиентСерверЛокализация.ДополнитьТипыНалогообложенияСкрывающиеРеквизитыНДС(Результат, ИмяПоляВводаСтавкиНДС);
...
// Параметры для действия "ЗаполнитьНалогообложениеНДСЗакупки" пакетной обработки табличной части.
// 
// Возвращаемое значение:
//  Структура - Параметры пакетного заполнения налогообложения НДСПокупки:
// * Документ - ДокументСсылка - в котором выполняется заполнение.
// * Дата - Дата - Дата документа
Функция ПараметрыПакетногоЗаполненияНалогообложенияНДСЗакупки() Экспорт
...
Функция ПараметрыРегистрацииСчетовФактурВыданных() Экспорт
	...
	ПараметрыРегистрации.Вставить("НачислениеНДСПриОтгрузке", Ложь);
