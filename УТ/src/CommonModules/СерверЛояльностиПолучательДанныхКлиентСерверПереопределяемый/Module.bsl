...
// Заполняет структуру параметров метода запроса НачислитьБонусыКлиента
//
// Параметры:
//  ПараметрыМетода - Структура - Структура для заполнения параметров метода запроса к серверу см. СерверЛояльностиПолучательДанныхКлиентСервер.ПараметрыМетодовБонуснойПодсистемы
//  ЗначенияПараметровМетода - Структура - Структура для заполнения ПараметрыМетода
//
Процедура ЗаполнитьПараметрыЗапросаНачислитьБонусыКлиента(ПараметрыМетода, ЗначенияПараметровМетода) Экспорт
	

	
КонецПроцедуры

// Заполняет структуру параметров метода запроса НачислитьПодарочныйСертификат
//
// Параметры:
//  ПараметрыМетода - Структура - Структура для заполнения параметров метода запроса к серверу см. СерверЛояльностиПолучательДанныхКлиентСервер.ПараметрыМетодовБонуснойПодсистемы
//  ЗначенияПараметровМетода - Структура - Структура для заполнения ПараметрыМетода
//
Процедура ЗаполнитьПараметрыЗапросаНачислитьПодарочныйСертификат(ПараметрыМетода, ЗначенияПараметровМетода) Экспорт
