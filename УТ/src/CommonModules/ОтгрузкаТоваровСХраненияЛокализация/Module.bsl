...
Функция ПолучитьДанныеДляПечатнойФормыТОРГ12(ПараметрыПечати, МассивОбъектов) Экспорт
	...
	|		ПО СерииНоменклатуры.Ссылка = ТаблицаТоваров.Серия
	|
...
Функция ПолучитьДанныеДляПечатнойФормыУКД(ПараметрыПечати, МассивОбъектов) Экспорт
	...
	|	ОтгрузкаТоваровСХраненияТаблицаТоваров КАК ТаблицаТоваровПредыдущие
	|ЛЕВОЕ СОЕДИНЕНИЕ
	|	ОтгрузкаТоваровСХраненияТаблицаТоваров КАК ТаблицаТоваровПослеКорректировки
	|ПО
...
Процедура ПолучитьИсходныеДокументы(МенеджерВременныхТаблиц)
	...
	|ВНУТРЕННЕЕ СОЕДИНЕНИЕ
	|	Документ.ОтгрузкаТоваровСХранения КАК ШапкаОснования
	|ПО
	...
	|ВНУТРЕННЕЕ СОЕДИНЕНИЕ
	|	Документ.ОтгрузкаТоваровСХранения КАК ДанныеОснования
	|ПО
