...
Процедура ПриОпределенииМетодовРазрешенныхДляВызоваКакПроизвольныйКод(Методы) Экспорт
	...
	Методы.Вставить("ВключитьПроверкуКонтрагентовВМоделиСервиса");
	Методы.Вставить("ОпределитьНедействующихКонтрагентовВОтчетеФоновоеЗадание", Истина);
	Методы.Вставить("ПроверитьКонтрагента", Истина);
	Методы.Вставить("ПроверитьКонтрагентовПослеВключенияПроверки");
	Методы.Вставить("ПроверитьКонтрагентовПослеВключенияПроверкиВФоне", Истина);
	Методы.Вставить("ПроверкаДоступностиСервисов", Истина);
