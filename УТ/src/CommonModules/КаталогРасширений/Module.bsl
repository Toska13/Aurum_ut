...
Процедура ПриИзмененииКонстантыИспользованиеКаталогаРасширенийВМоделиСервиса(Знач НовоеЗначение) Экспорт
КонецПроцедуры

// Возвращает признак поддержки информационной базы использования каталога расширений.
// 
// Возвращаемое значение:
//  Булево - признак поддержки информационной базы использования каталога расширений
Функция ДоступноВИнформационнойБазе() Экспорт
...
Процедура ПриОпределенииМетодовРазрешенныхДляВызоваКакПроизвольныйКод(Методы) Экспорт
	...
	Методы.Вставить("СостояниеРасширения", Истина);
