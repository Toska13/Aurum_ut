...
Процедура ПересчитатьПроблемныеРеквизитыТаблицыДокумента(Форма, СтрокаТаблицы, ИмяТаблицы = "ТаблицаДокумента") Экспорт
	...
	ДанныеШапки.Вставить("СуммаВключаетНДС", ЗначениеРеквизитаДокумента(Объект, "СуммаВключаетНДС", Ложь));
	ДанныеШапки.Вставить("ВидСкидки", ЗначениеРеквизитаДокумента(Объект, "ВидСкидки", ВидыСкидок().НеПредоставлена));
	...
	Для Каждого ИмяРеквизита Из СсылочныеРеквизиты Цикл
		Если ИмяРеквизита = "Номенклатура" И Объект.ТипДокумента = ПредопределенноеЗначение(
