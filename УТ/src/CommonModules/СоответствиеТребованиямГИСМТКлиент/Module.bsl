...
// Имя события выполнена проверка в регламентном задании.
// 
// Возвращаемое значение:
//  Строка - Имя события выполнена проверка в регламентном задании
Функция ИмяСобытияВыполненаПроверкаВРегламентномЗадании() Экспорт
	Возврат "БГосИС.ИСМП.ВыполненаПроверкаВРегламентномЗадании";
КонецФункции
...
Процедура ПриПолученииСерверногоОповещения(ИмяОповещения, Результат) Экспорт
	...
	Если ИмяОповещения =  СоответствиеТребованиямГИСМТКлиентСервер.ИмяСерверногоОповещенияВыполненаПроверкаВРегламентномЗадании() Тогда
	
		Оповестить(ИмяСобытияВыполненаПроверкаВРегламентномЗадании(), Результат);
...
Процедура ПослеПроверкиДокументаНаСоответствиеТребованиямГИСМТ(Результат, ДополнительныеПараметры) Экспорт
	...
	Оповестить(
		ИмяСобытияОповещенияПослеПроверкиДокументаНаСоответствиеТребованиямГИСМТ(),
		Результат,
