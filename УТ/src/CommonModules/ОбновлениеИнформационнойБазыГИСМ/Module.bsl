...
Процедура ПриОпределенииМетодовРазрешенныхДляВызоваКакПроизвольныйКод(Методы) Экспорт
	...
	Методы.Вставить("НастройкиОбменаГИСМ_ОбработатьДанныеДляПереходаНаНовуюВерсию");
	Методы.Вставить("ВерсииСхемОбменаГИСМ_ВерсияСхемОбменаПоУмолчанию_ОбработатьДанныеДляПереходаНаНовуюВерсию");
	Методы.Вставить("ВерсииСхемОбменаГИСМ_ЗарегистрироватьДанныеКОбработкеДляПереходаНаНовуюВерсию");
	Методы.Вставить("НачальноеЗаполнение");
	Методы.Вставить("НастройкиОбменаГИСМ_ЗарегистрироватьДанныеКОбработкеДляПереходаНаНовуюВерсию");
