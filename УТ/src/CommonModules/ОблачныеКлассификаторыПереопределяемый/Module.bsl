...
Процедура ОпределитьЗагруженныеЭлементыОКЕИ(СсылкиПоКоду, ДополнительныеПараметры = Неопределено) Экспорт
	...
	//++ НЕ ГОСИС
	ОблачныеКлассификаторыУТ.ОпределитьЗагруженныеЭлементыОКЕИ(СсылкиПоКоду, ДополнительныеПараметры);
	//-- НЕ ГОСИС
...
Процедура ПроверитьЭлементОКЕИ(Строка, ДополнительныеПараметры = Неопределено, Отказ = Ложь) Экспорт
	...
	//++ НЕ ГОСИС
	ОблачныеКлассификаторыУТ.ПроверитьЭлементОКЕИ(Строка, ДополнительныеПараметры, Отказ);
	//-- НЕ ГОСИС
...
Процедура СоздатьОбновитьЭлементОКЕИ(ДанныеСервиса, Ссылка = Неопределено, ЭтоНовый = Ложь) Экспорт
	...
	//++ НЕ ГОСИС
	ОблачныеКлассификаторыУТ.СоздатьОбновитьЭлементОКЕИ(ДанныеСервиса, Ссылка, ЭтоНовый);
	//-- НЕ ГОСИС
