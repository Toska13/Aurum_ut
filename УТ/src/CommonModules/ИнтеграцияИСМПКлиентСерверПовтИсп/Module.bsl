...
// 
// Параметры:
//  ВидМаркируемойПродукции - ПеСправочникСсылка.ВидыПродукцииИС вид маркируемой продукции
//  НаДату - Дата - дата оборота маркируемой продукции
// Возвращаемое значение:
...
//
//Возвращаемое значение:
//   ФиксированныйМассив Из ПеСправочникСсылка.ВидыПродукцииИС виды маркируемой продукции, по которым установлен 
...
Функция ШаблоныКодовМаркировки() Экспорт
	...
	Возврат ИнтеграцияИСМПВызовСервера.ШаблоныКодовМаркировки();
