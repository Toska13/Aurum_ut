...
Функция НастройкиОтправки(КлючНастроекОтправки) Экспорт
	...
	ИзменитьСпособОбменаЭДОТакскомНаСервис1СЭДО = Ложь;
	...
	Если ЕстьНастройкаПоКлючу И ЕстьНастройкаПоВидуДокумента Тогда
		...
		ИзменитьСпособОбменаЭДОТакскомНаСервис1СЭДО = ПолучаемаяНастройка.СпособОбмена = Перечисления.СпособыОбменаЭД.ЧерезОператораЭДОТакском
			И (УчетныеЗаписиЭДО.УчетнаяЗаписьПереведенаИзТакском(ПолучаемаяНастройка.ИдентификаторОтправителя)
			Или УчетныеЗаписиЭДО.НаступилаДатаПереводаАбонентовИзТакском());
	...
	Если ТребуетсяОбновитьНастройку Или ИзменитьСпособОбменаЭДОТакскомНаСервис1СЭДО Тогда
		...
		ДополнитьНастройкиОтправкиНовымВидомДокумента(КлючНастроекОтправки, ОбновляемаяНастройка.Договор, ИзменитьСпособОбменаЭДОТакскомНаСервис1СЭДО);
	...
	Пока ВыборкаДетальныеЗаписи.Следующий() Цикл
		...
		Если ИзменитьСпособОбменаЭДОТакскомНаСервис1СЭДО Тогда
			Настройка.СпособОбмена = Перечисления.СпособыОбменаЭД.ЧерезСервис1СЭДО;
		КонецЕсли;
...
// 	ИзменитьСпособОбменаЭДОТакскомНаСервис1СЭДО - Булево - если взведена изменяет способ обмена на ЧерезСервис1СЭДО
//
Процедура ДополнитьНастройкиОтправкиНовымВидомДокумента(КлючНастроекОтправки, Договор, ИзменитьСпособОбменаЭДОТакскомНаСервис1СЭДО = Ложь)
	...
	Если ИзменитьСпособОбменаЭДОТакскомНаСервис1СЭДО Тогда
		МенеджерЗаписи.СпособОбменаЭД = Перечисления.СпособыОбменаЭД.ЧерезСервис1СЭДО;
	КонецЕсли;
...
// см. НастройкиОтправкиЭДО.НоваяНастройкаЗаполненияДополнительныхПолей
