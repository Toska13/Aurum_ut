...
Функция ЗагрузитьДифференциальнуюКопиюВОбласть(Знач ПолныйАрхив, Знач ДифференциальныйАрхив, ПараметрыЗагрузки) Экспорт
	...
	ПоместитьРезультатЗагрузкиВоВременноеХранилище(ПараметрыЗагрузки, РезультатЗагрузкиДифференциальногоАрхива);
...
Процедура ПриОпределенииМетодовРазрешенныхДляВызоваКакПроизвольныйКод(Методы) Экспорт
	...
	Методы.Вставить("ВыгрузитьТекущуюОбластьВАрхив", Истина);
	Методы.Вставить("ЗагрузитьОбластьИзАрхива", Истина);
