...
// * UnitedToken         - Булево - Признак возможности получения единого токена
// * ИНН                 - Строка - ИНН для подписания МЧД
Функция ПараметрыАвторизации() Экспорт
	...
	ПараметрыАвторизации.Вставить("UnitedToken",   Ложь);
	ПараметрыАвторизации.Вставить("ИНН",           "");
...
Функция ИспользоватьТокенФорматаUUID() Экспорт
	...
	Возврат Константы.ИспользоватьТокенФорматаUUIDИСМП.Получить();
