...
//  Структура - Описание:
// * Ссылка - ОпределяемыйТип.ДокументыСАТУРН, СправочникСсылка.ИмпортируемаяПартияСАТУРН, СправочникСсылка.КлассификаторОрганизацийСАТУРН, СправочникСсылка.КлассификаторПАТСАТУРН, СправочникСсылка.МестаПримененияСАТУРН, СправочникСсылка.МестаХраненияСАТУРН, СправочникСсылка.ПартииСАТУРН - Передаваемый документ, ссылка на классификатор САТУРН
...
// 
// Возвращаемое значение:
//  - Строка - имя реквизита организации
Функция ИменаРеквизитовОпределенияДоступностиДействий(Префикс = "") Экспорт
	
	Возврат Префикс + "ОрганизацияСАТУРН";
