...
Функция ПолучитьСтатусСостоянияИзXMLПакета(ДанныеXML) Экспорт
	...
	Возврат ОборудованиеЧекопечатающиеУстройстваКлиентСервер.ПолучитьСтатусСостоянияИзXMLПакета(ДанныеXML);
...
Функция ПолучитьСлужебнуюИнформациюИзXMLПакета(ДанныеXML) Экспорт
	...
	Возврат ОборудованиеЧекопечатающиеУстройстваКлиентСервер.ПолучитьСлужебнуюИнформациюИзXMLПакета(ДанныеXML);
...
Функция ПолучитьПараметрыРезультатаИзXMLПакета(ДанныеXML) Экспорт
	...
	Возврат ОборудованиеЧекопечатающиеУстройстваКлиентСервер.ПолучитьПараметрыРезультатаИзXMLПакета(ДанныеXML);
