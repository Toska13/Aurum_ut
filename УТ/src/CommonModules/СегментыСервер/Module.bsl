...
Функция ВключитьОтборПоСегментуНоменклатурыВСКД(ОбъектНастройки, ИспользоватьТолькоНастройки = Ложь) Экспорт
	...
	Если ИспользуетсяОтборПоСегменту Тогда
		...
		Поле = Новый ПолеКомпоновкиДанных("ОтборПоСегментуСлужебный");
		Если ОбъектНастройки.Настройки.Отбор.ДоступныеПоляОтбора.Элементы.Найти(Поле) <> Неопределено Тогда
			
			Если Не КомпоновкаДанныхКлиентСервер.ИспользуетсяОтбор(ОбъектНастройки.Настройки.Отбор.Элементы, Поле) Тогда
				ЭлементОтбора = КомпоновкаДанныхКлиентСервер.ДобавитьОтбор(
					ОбъектНастройки.Настройки.Отбор,
					Поле,
					Истина,
