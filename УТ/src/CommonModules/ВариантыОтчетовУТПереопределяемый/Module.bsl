...
Процедура НастроитьВариантыОтчетов(Настройки) Экспорт
	...
	ДоставкаТоваров.НастроитьВариантыОтчетов(Настройки);
	...
	Отчеты.АнализОтклоненийВСтоимостиТоваров.НастроитьВариантыОтчета(Настройки);
	//++ Локализация
	Отчеты.ДетализацияСебестоимостиТоваровОрганизаций.НастроитьВариантыОтчета(Настройки);
	Отчеты.АнализИзмененияВидаДеятельностиНДС.НастроитьВариантыОтчета(Настройки);
	//-- Локализация
	...
	Отчеты.АнализПрохожденияКонтроляКачестваТоваров.НастроитьВариантыОтчета(Настройки);
	...
	Отчеты.ВедомостьПоРаспоряжениямНаОтгрузкуИВозврат.НастроитьВариантыОтчета(Настройки);
	...
	//++ Локализация
	Отчеты.СервисПрогнозированияСлужебный.НастроитьВариантыОтчета(Настройки);
	Отчеты.СервисПрогнозированияВыгружаемыеДанные.НастроитьВариантыОтчета(Настройки);
	//-- Локализация
	
	
	Отчеты.ДокументыДвиженияПоОтгрузкам.НастроитьВариантыОтчета(Настройки);
	
	Отчеты.ОтчетПоДублямНСИ.НастроитьВариантыОтчета(Настройки);
