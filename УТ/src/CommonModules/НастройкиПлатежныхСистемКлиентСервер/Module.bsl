...
//  Строка - имя подсистемы.
//
Функция ИмяПодсистемыИнтернетЭквайринг() Экспорт
	
	Возврат "ИнтернетЭквайринг";
	
КонецФункции

// Возвращает имя подсистемы "ПлатежныеСистемы"
//
// Возвращаемое значение:
//  Строка - имя подсистемы.
//
Функция ИмяПодсистемыПлатежныеСистемы() Экспорт
...
// Возвращает имя подсистемы "ЯндексПэй"
//
// Возвращаемое значение:
//  Строка - имя подсистемы.
//
Функция ИмяПодсистемыЯндексПэй() Экспорт
