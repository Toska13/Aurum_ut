...
Процедура ПриЗаполненииРазделовДатЗапретаИзменения(Разделы) Экспорт
	...
	Раздел.Представление = НСтр("ru = 'Складские операции (на ордерных складах), доставка'");
	...
	Раздел = Разделы.Добавить();
	Раздел.Имя  = "РетроБонусыПоставщиков";
	Раздел.Идентификатор = Новый УникальныйИдентификатор("9a629851-6440-11ef-8435-005056be3dc8");
	Раздел.Представление = НСтр("ru = 'Ретро-бонусы поставщиков'");
	Раздел.ТипыОбъектов.Добавить(Тип("СправочникСсылка.Организации"));
