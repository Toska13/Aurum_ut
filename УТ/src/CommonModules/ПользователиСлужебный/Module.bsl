...
Процедура ОбновитьСоставыГруппПользователей(Знач ГруппаПользователей,
	...
	Попытка
		Если ГруппаПользователей = Справочники.ГруппыПользователей.ВсеПользователи Тогда
			...
			ОбновитьСоставГруппыВсеПользователиСтарая(
				Пользователь, , ТекущиеУчастникиИзменений, ТекущиеИзмененныеГруппы);
		Иначе
			ОбновитьСоставыИерархическихГруппПользователейСтарая(
				ГруппаПользователей,
				Пользователь,
...
Процедура ОбновитьСоставГруппыВсеПользователиСтарая(Пользователь,
...
Процедура ОбновитьСоставыИерархическихГруппПользователейСтарая(ГруппаПользователей,
                                                         Пользователь,
                                                         УчастникиИзменений = Неопределено,
                                                         ИзмененныеГруппы   = Неопределено)
