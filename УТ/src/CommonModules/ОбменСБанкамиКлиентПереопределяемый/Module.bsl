...
// Выполняет отправку оповещения пользователю.
// См. СтандартныеПодсистемыКлиент.ПриПолученииСерверногоОповещения.
//
// Параметры:
//  Результат - Соответствие из КлючИЗначение:
//   * Ключ - СправочникСсылка.Пользователи - получатель уведомлений;
//   * Значение - Структура - см. ОбменСБанкамиСлужебный.ДанныеДляУведомленийОбОтклоненныхДокументах.
//
Процедура УведомленияОбОтклоненныхДокументах(Результат) Экспорт

	//++ НЕ ГОСИС
	ОбменСБанкамиИнтеграцияКлиентСобытия.УведомленияОбОтклоненныхДокументах(Результат);
	//-- НЕ ГОСИС
