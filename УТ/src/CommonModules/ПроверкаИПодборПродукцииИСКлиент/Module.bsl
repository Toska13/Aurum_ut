...
//  * ИмяФормыПроверки                     - Строка - имя формы обработки ПроверкаИПодборПродукцииИС, по умолчанию ПроверкаИПодбор
Функция ПараметрыОткрытияФормыПроверкиИПодбора(Форма, Сценарий)
	...
	ПараметрыОткрытия.Вставить("ИмяФормыПроверки", "ПроверкаИПодбор");
...
Процедура ОткрытьФормуПроверкиИПодбораМаркируемойПродукции(Форма, Знач ПараметрыОткрытияФормыПроверки, Знач ПараметрыУказанияСерий)
	...
	ОткрытьФорму(СтрШаблон("Обработка.ПроверкаИПодборПродукцииИС.Форма.%1", ПараметрыОткрытияФормыПроверки.ИмяФормыПроверки),
		ПараметрыФормы,
		Форма,
