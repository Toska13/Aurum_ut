...
Процедура ДополнитьОписаниеЭтаповЗакрытияМесяца(ТаблицаЭтапов) Экспорт
	...
	ПодарочныеСертификатыЛокализация.ДобавитьЭтап_АннулированиеПодарочныхСертификатов(ТаблицаЭтапов,ТекущийРодитель);
...
// Определяет необходимость формирования заданий на следующий период.
// 
// Параметры:
//	ФормироватьЗадания - Булево - признак необходимости формирования заданий.
//	ПараметрыОбработчика - см. Обработки.ОперацииЗакрытияМесяца.ИнициализироватьПараметрыОбработчикаЭтапа 
//	
Процедура ПроверитьНеобходимостьФормированияЗаданийНаСледующийПериод(ФормироватьЗадания, ПараметрыОбработчика) Экспорт
...
Процедура ОбработчикиОбновленияНеВлияющиеНаЗакрытиеМесяца(Обработчики) Экспорт
	Обработчики = Обработчики +  "
	//++ Локализация
	|УчетНДСРФ.ОбработатьДанныеДляПереходаНаНовуюВерсиюОсновныеСтавкиНДС
	...
	|РегистрыСведений.НастройкиИнтеграцииСПлатежнымиСистемамиУТ.ОбработатьДанныеДляПереходаНаНовуюВерсию
	|Справочники.ГосударственныеКонтракты.ОбработатьДанныеДляПереходаНаНовуюВерсию
	|НаправленияДеятельностиЛокализация.ОбработатьДанныеДляПереходаНаНовуюВерсию
...
Функция ИсточникиДанныхДляЗаданийЗакрытияМесяца() Экспорт
	...
	ВходящиеДанные.Вставить(Метаданные.РегистрыНакопления.ПрочиеДоходы, Истина);
