...
Процедура ОпределитьОбъектыСКомандамиОтчетов(Объекты) Экспорт
	...
	ДоставкаТоваров.ОпределитьОбъектыСКомандамиОтчетов(Объекты);
	...
	Объекты.Добавить(Метаданные.Документы.АктКонтроляКачестваТоваров);
	...
	Объекты.Добавить(Метаданные.Документы.ЗаявкаНаЗакупку);
	...
	Объекты.Добавить(Метаданные.Документы.ЗаявкаНаКонтрольКачестваТоваров);
	Объекты.Добавить(Метаданные.Документы.ЗаявкаНаОбеспечение);
	...
	Объекты.Добавить(Метаданные.Документы.ОперацияСЭлектроннымБилетом);
	...
	Объекты.Добавить(Метаданные.ЖурналыДокументов.ЧекиККМ);
