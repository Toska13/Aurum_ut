...
// Параметры:
//	Форма - ДанныеФормыСтруктура, ФормаКлиентскогоПриложения - содержит данные формы, которая содержит:
// 	Корректировка - Булево - принимает значение Истина при вызове из документа КорректировкаПриобретения.
Процедура УстановитьУсловноеОформлениеВДокументеПриобретениеТоваровУслуг(Форма, Корректировка = Ложь) Экспорт
	...
	Если Корректировка Тогда
		ОтборЭлемента.ЛевоеЗначение = Новый ПолеКомпоновкиДанных("ХозяйственнаяОперацияДокументаОснования");
	Иначе
...
//
// Возвращаемое значение:
//  Соответствие Из КлючИЗначение- Количество распоряжений к оформлению по типу уведомления:
//   * Ключ - Тип - тип документа.
//   * Значение - Число - количество документов.
//
...
//
// Параметры:
// 	ПараметрыРегистрации - см. ПриобретениеТоваровУслугЛокализация.ПараметрыРегистрацииУведомленийОВвозеПрослеживаемыхТоваров
// 
// Возвращаемое значение:
...
//		* УведомленияОВвозе - Массив Из ДокументСсылка - ссылки на уведомление о ввозе товаров.
...
//		* КоличествоРаспоряженийКОформлению - Число - Количество требуемых к оформлению распоряжений.
...
Функция УведомленияОВвозеПрослеживаемыхТоваровПоДокументуПоступления(ПараметрыРегистрации) Экспорт
	...
	Если ПараметрыРегистрации.ВвозТоваровИзТаможенногоСоюза
		...
		ТаблицаРаспоряженийКОформлению = Документы.УведомлениеОВвозеПрослеживаемыхТоваров.РаспоряженияКОформлениюУведомленийОВвозеПоОснованию(ПараметрыРегистрации.Ссылка, ПараметрыРегистрации.КорректировочноеУведомление);
...
//		* УведомленияОПеремещении - Массив Из ДокументСсылка - ссылки на уведомление о перемещении товаров.
...
//		* КоличествоРаспоряженийКОформлению - Число - количество распоряжений к оформлению.
...
Функция УведомленияОПеремещенииПрослеживаемыхТоваровПоДокументуРеализации(ПараметрыРегистрации) Экспорт
	...
	Если ПараметрыРегистрации.ПродажаВСтраныТаможенногоСоюза
		И ПараметрыРегистрации.ВедетсяУчетПоРНПТ
		И Не ПараметрыРегистрации.ПереходПраваСобственности Тогда
...
// Заполняет в документе табличную часть Прослеживаемые товары по остаткам регистра  Прослеживаемые товары в составе ОС.
//
// Параметры:
//	Объект - ДокументОбъект - объект, в котором заполняется табличная часть
//	ДоступныеОсновныеСредства - Массив Из СправочникСсылка- массив основных средств, по которым отбираются остатки 
//	для заполнения табличной части.
//	ОчищатьОС - Булево - признак очистки ОС.
