...
//     * ПропускатьПроверкуНоменклатуры - Булево - указывает необходимость пропуска проверки заполнения номенклатуры;
//     		игнорируется, если включена возможность загрузки упаковочных листов.
...
Функция ПараметрыЗагрузкиНоменклатуры() Экспорт
	...
	ПараметрыЗагрузкиНоменклатуры.Вставить("ПропускатьПроверкуНоменклатуры", Ложь);
