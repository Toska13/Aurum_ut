...
Процедура ЗаполнитьМногооборотнуюТаруИзХранилища(Объект,
	...
	Для Каждого СтрокаТоваров Из ТараИзХранилища Цикл
		...
		ЗаполнитьКолонки(МассивКолонок, СтрокаТоваров, СтруктураПоиска);
		...
		ИначеЕсли МассивСтрокТЧТовары.Количество() = 0 Тогда
			...
			ЗаполнитьКолонки(МассивКолонок, СтрокаТоваров, СтрокаТЧТовары);
			
			ДобавленныеСтроки.Добавить(СтрокаТЧТовары);
		...
		ИначеЕсли МассивСтрокТЧТовары.Количество() > 0 Тогда
			...
			Если СтрокаТЧТовары.Количество <> СтрокаТоваров.Количество Тогда
				...
				ИзмененныеСтроки.Добавить(СтрокаТЧТовары);
...
Процедура ЗаполнитьКолонки(МассивКолонок, СтрокаИсточник, СтрокаПриемник)
	
	Если МассивКолонок.Количество() = 5 Тогда
		Если ЗначениеЗаполнено(МассивКолонок[4]) Тогда
			СтрокаПриемник[МассивКолонок[4]] = СтрокаИсточник.ДатаПоступления;
		КонецЕсли;
		Если ЗначениеЗаполнено(МассивКолонок[3]) Тогда
			СтрокаПриемник[МассивКолонок[3]] = СтрокаИсточник.Дата;
		КонецЕсли;
		Если ЗначениеЗаполнено(МассивКолонок[2]) Тогда
			СтрокаПриемник[МассивКолонок[2]] = СтрокаИсточник.Склад;
		КонецЕсли;
