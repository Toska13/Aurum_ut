...
Процедура НастроитьВариантыОтчета(Настройки, НастройкиОтчета) Экспорт
	...
	НастройкиОтчета = ВариантыОтчетов.ОписаниеОтчета(Настройки, Метаданные.Отчеты.СоставРетроБонусовКлиентов);
...
Функция ДобавитьКомандуОтчета(КомандыОтчетов, Параметры, КлючВарианта = "") Экспорт
	...
	Если ПравоДоступа("Просмотр", Метаданные.Отчеты.СоставРетроБонусовКлиентов)
	   И ПолучитьФункциональнуюОпцию("ИспользоватьРетроБонусыКлиентов") Тогда
		
		КомандаОтчет = КомандыОтчетов.Добавить();
		
		Если КлючВарианта = "СоставРетроБонусовКлиентовКонтекст" Тогда
			
			Представление = НСтр("ru = 'Состав документа (актуальные данные)'"); 
			
		ИначеЕсли КлючВарианта = "СоставРетроБонусовКлиентовПоДаннымДокументаКонтекст" Тогда
			
			Представление = НСтр("ru = 'Состав документа (по данным документа)'");
			
		Иначе
			
			Представление = НСтр("ru = 'Состав документа ретро-бонусов клиентов'");
			
		КонецЕсли;
		
		КомандаОтчет.Менеджер = Метаданные.Отчеты.СоставРетроБонусовКлиентов.ПолноеИмя();
