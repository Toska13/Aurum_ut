...
Функция ТекстЗапроса()
	...
	|	АналитикаУчета.Контрагент,
	|	АналитикаУчета.Договор,
	|	ВЫБОР КОГДА НЕ РасчетыПланОтгрузок.ОбъектРасчетов.РегистрыВзаиморасчетовНеДелятсяПоНаправлениямДеятельности
	|		ТОГДА АналитикаУчета.НаправлениеДеятельностиАналитики
	|		ИНАЧЕ РасчетыПланОтгрузок.ОбъектРасчетов.НаправлениеДеятельности
	|	КОНЕЦ,
	...
	|	СУММА(ТаблицаЗадолженностей.НашДолгНеКонтролируется)     КАК НашДолгНеКонтролируется,
	|	СУММА(ТаблицаЗадолженностей.ДолгКлиента)                 КАК ДолгКлиента,
	|	СУММА(ТаблицаЗадолженностей.ДолгКлиентаПросрочено)       КАК ДолгКлиентаПросрочено,
	|	СУММА(ТаблицаЗадолженностей.КОтгрузке)                   КАК КОтгрузке,
	|
	|	МАКСИМУМ(ВЫБОР
	|		КОГДА НЕ РазностиДат.КоличествоДней ЕСТЬ NULL
	|			ТОГДА ВЫБОР
	|					КОГДА РазностиДат.КоличествоДней > 0
	|						И ТаблицаЗадолженностей.НашДолг > 0
	...
	|	Таблица.НашДолгНеКонтролируется               КАК НашДолгНеКонтролируется,
	|	Таблица.ДолгКлиента                           КАК ДолгКлиента,
	|	Таблица.ДолгКлиентаПросрочено                 КАК ДолгКлиентаПросрочено,
	...
	|	НашДолгНеКонтролируется   КАК НашДолгНеКонтролируется,
	|	ДолгКлиента               КАК ДолгКлиента,
	|	ДолгКлиентаПросрочено     КАК ДолгКлиентаПросрочено,
