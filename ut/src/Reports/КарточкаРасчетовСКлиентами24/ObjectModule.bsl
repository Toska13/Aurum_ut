...
Функция ТекстЗапроса()
	...
	|		АналитикаУчета.Контрагент                         КАК Контрагент,
	|		АналитикаУчета.Договор                            КАК Договор,
	|		ВЫБОР КОГДА НЕ РасчетыПланОтгрузокОстатки.ОбъектРасчетов.РегистрыВзаиморасчетовНеДелятсяПоНаправлениямДеятельности
	|			ТОГДА АналитикаУчета.НаправлениеДеятельностиАналитики
	|			ИНАЧЕ РасчетыПланОтгрузокОстатки.ОбъектРасчетов.НаправлениеДеятельности
	|		КОНЕЦ                                             КАК НаправлениеДеятельности,
	...
	|	Расчеты.Отгружено                   КАК Отгружено,
	...
	ТекстЗапроса = СтрЗаменить(ТекстЗапроса,"&ОтгруженоКлиенту", ВзаиморасчетыОтчеты.ШаблонПоляОтгружено());
	ТекстЗапроса = СтрЗаменить(ТекстЗапроса,"&ЗачтеноКлиенту", ВзаиморасчетыОтчеты.ШаблонПоляЗачтено());
	ТекстЗапроса = СтрЗаменить(ТекстЗапроса,"&ОплаченоКлиентом", ВзаиморасчетыОтчеты.ШаблонПоляОплачено());
