...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	КорректировочноеУведомление = Параметры.КорректировочноеУведомление;
	...
	КОформлению.Параметры.УстановитьЗначениеПараметра("КорректировочноеУведомление", КорректировочноеУведомление);
...
Процедура СоздатьИОтправитьУведомленияНаКлиенте()  
	...
	Для Каждого ИдентификаторСтроки Из ВыделенныеСтроки Цикл
		...
		СтруктураДанныхКОформлению.КорректировочноеУведомление = КорректировочноеУведомление;
...
Функция СтруктураДанныхКОформлению()
	...
	СтруктураДанных.Вставить("КорректировочноеУведомление");
