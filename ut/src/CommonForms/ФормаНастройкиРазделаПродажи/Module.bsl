...
Процедура УстановитьДоступность(РеквизитПутьКДанным = "")
	...
	Если РеквизитПутьКДанным = "НаборКонстант.ИспользоватьРозничныеПродажи" 
		...
		Элементы.ПечататьОтдельныйСлипЧекЭквайринговойОперации.Доступность    = (ЗначениеКонстанты
			И НаборКонстант.ИспользоватьОплатуПлатежнымиКартами);
		Элементы.ДатаРозничнойПродажиТабачнойПродукцииТолькоПоМРЦ.Доступность = ЗначениеКонстанты;
	КонецЕсли;
