...
// * Успех - Булево
Функция ПроверитьНастройкиРегламентныхЗаданийЭДО(Операция = "ПоУмолчанию") Экспорт
	...
	ИначеЕсли РежимРаботы Тогда // остальные проверки актуальны только для клиент-серверной базы
		...
		Если Операция <> Операции.ПолучениеПоТокенам Тогда
...
Процедура ПриОпределенииМетодовРазрешенныхДляВызоваКакПроизвольныйКод(Методы) Экспорт
	...
	Методы.Вставить("ПроверитьНастройкиРегламентныхЗаданийЭДО", Истина);
