...
Функция ОбновитьКарточкуТорговогоПредложения(Отказ)
	...
	ПараметрыВыполнения.НаименованиеФоновогоЗадания = НСтр("ru = '1С:Бизнес-сеть. Чтение торгового предложения.'");
	ПараметрыВыполнения.ЗапуститьВФоне = Истина;
	ПараметрыВыполнения.ОжидатьЗавершение = 0;
	
	ДлительнаяОперация = ДлительныеОперации.ВыполнитьВФоне(
		"ТорговыеПредложенияСлужебный.СформироватьПредставлениеТорговогоПредложения",
		ПараметрыЗапроса,
		ПараметрыВыполнения);
