...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ОтображатьОбластьПредпросмотра = ОбщегоНазначения.ХранилищеОбщихНастроекЗагрузить(
...
Процедура ОтображатьУдаленныеСервер()
	...
	ОбщегоНазначения.ХранилищеОбщихНастроекСохранить(
		ИнтерфейсДокументовЭДОКлиентСервер.КлючОбъектаНастроекИнтерфейсаЭДО(),
		"ОтображатьУдаленные", ОтображатьУдаленные);	
...
Процедура ЗаполнитьРеквизитыФормыНаОснованииТекущихДанных(ТекущиеДанные)
	...
	Если Не ЗначениеЗаполнено(ТекущиеДанные.ЭлектронныйДокумент) Тогда
		...
		ТекущийДокументЦентраЭДО = Неопределено;
	...
	Если ТекущийРаздел = РазделыТекущихДелЭДО().Черновики Тогда
		РеквизитыДокумента = ЭлектронныеДокументыЭДО.СвойстваДокумента(ТекущиеДанные.ЭлектронныйДокумент,
			...
			|ИдентификаторДокумента, ИспользоватьЦентрЭДО, ПометкаУдаления");
	...
	ТекущийДокументЦентраЭДО = РеквизитыДокумента.ИспользоватьЦентрЭДО;
...
Процедура НастроитьВидимостьКомандТекущейСтроки(ТекущиеДанные)
	...
	Если СостояниеЭДО = ПредопределенноеЗначение("Перечисление.СостоянияДокументовЭДО.ТребуетсяПодписание") 
		...
		Элементы.ЗапроситьУточнениеВходящие.Видимость = ВыполненПереходНаУниверсальныеСообщения;
		Элементы.ЗапроситьУточнение.Видимость = ВыполненПереходНаУниверсальныеСообщения;
	...
	ТекстЗаголовкаОтказатьсяОтПодписания = ЛегкийИнтерфейсДокументовЭДОКлиентСервер.ПредставлениеКомандыОтказатьсяОтПодписания(ЭтоПакетДокументов);
	ТекстЗаголовкаЗапроситьУточнение = ЛегкийИнтерфейсДокументовЭДОКлиентСервер.ПредставлениеКомандыЗапроситьУточнение(ЭтоПакетДокументов);
	...
	Элементы.КомандаОтказатьсяОтПодписанияУтвердить.Видимость = ВыполненПереходНаУниверсальныеСообщения;
	Элементы.КомандаОтказатьсяОтПодписанияПодписать.Видимость = ВыполненПереходНаУниверсальныеСообщения;
	Элементы.КомандаОтказатьсяОтПодписанияНедоступная.Видимость =  ВыполненПереходНаУниверсальныеСообщения;
	Элементы.КомандаОтказатьсяОтПодписанияУтвердитьВходящие.Видимость = ВыполненПереходНаУниверсальныеСообщения;
	Элементы.КомандаОтказатьсяОтПодписанияПодписатьВходящие.Видимость =  ВыполненПереходНаУниверсальныеСообщения;
	Элементы.КомандаОтказатьсяОтПодписанияУтвердитьИсходящие.Видимость = ВыполненПереходНаУниверсальныеСообщения;
	Элементы.КомандаОтказатьсяОтПодписанияПодписатьИсходящие.Видимость = ВыполненПереходНаУниверсальныеСообщения;
	Элементы.КомандаОтказатьсяОтПодписанияУтвердитьВходящиеКонтекстноеМеню.Видимость = ВыполненПереходНаУниверсальныеСообщения;
	Элементы.КомандаОтказатьсяОтПодписанияПодписатьВходящиеКонтекстноеМеню.Видимость = ВыполненПереходНаУниверсальныеСообщения;
	Элементы.КомандаОтказатьсяОтПодписанияУтвердитьИсходящиеКонтекстноеМеню.Видимость = ВыполненПереходНаУниверсальныеСообщения;
	Элементы.КомандаОтказатьсяОтПодписанияПодписатьИсходящиеКонтекстноеМеню.Видимость = ВыполненПереходНаУниверсальныеСообщения;
	
	Элементы.КомандаОтказатьсяОтПодписанияУтвердить.Заголовок = ТекстЗаголовкаОтказатьсяОтПодписания;
	Элементы.КомандаОтказатьсяОтПодписанияПодписать.Заголовок = ТекстЗаголовкаОтказатьсяОтПодписания;
	Элементы.КомандаОтказатьсяОтПодписанияНедоступная.Заголовок = ТекстЗаголовкаОтказатьсяОтПодписания;
	Элементы.КомандаОтказатьсяОтПодписанияУтвердитьВходящие.Заголовок = ТекстЗаголовкаОтказатьсяОтПодписания;
	Элементы.КомандаОтказатьсяОтПодписанияПодписатьВходящие.Заголовок = ТекстЗаголовкаОтказатьсяОтПодписания;
	Элементы.КомандаОтказатьсяОтПодписанияУтвердитьИсходящие.Заголовок = ТекстЗаголовкаОтказатьсяОтПодписания;
	Элементы.КомандаОтказатьсяОтПодписанияПодписатьИсходящие.Заголовок = ТекстЗаголовкаОтказатьсяОтПодписания;
	Элементы.КомандаОтказатьсяОтПодписанияУтвердитьВходящиеКонтекстноеМеню.Заголовок = ТекстЗаголовкаОтказатьсяОтПодписания;
	Элементы.КомандаОтказатьсяОтПодписанияПодписатьВходящиеКонтекстноеМеню.Заголовок = ТекстЗаголовкаОтказатьсяОтПодписания;
	Элементы.КомандаОтказатьсяОтПодписанияУтвердитьИсходящиеКонтекстноеМеню.Заголовок = ТекстЗаголовкаОтказатьсяОтПодписания;
	Элементы.КомандаОтказатьсяОтПодписанияПодписатьИсходящиеКонтекстноеМеню.Заголовок = ТекстЗаголовкаОтказатьсяОтПодписания;
	
	Элементы.КомандаОтклонитьДокументУтвердить.Видимость = Не ВыполненПереходНаУниверсальныеСообщения;
	Элементы.КомандаОтклонитьДокументПодписать.Видимость = Не ВыполненПереходНаУниверсальныеСообщения;
	Элементы.КомандаОтклонитьДокументНедоступная.Видимость = Не ВыполненПереходНаУниверсальныеСообщения;
	Элементы.КомандаОтклонитьДокументУтвердитьВходящие.Видимость = Не ВыполненПереходНаУниверсальныеСообщения;
	Элементы.КомандаОтклонитьДокументПодписатьВходящие.Видимость = Не ВыполненПереходНаУниверсальныеСообщения;
	Элементы.КомандаОтклонитьДокументУтвердитьИсходящие.Видимость = Не ВыполненПереходНаУниверсальныеСообщения;
	Элементы.КомандаОтклонитьДокументПодписатьИсходящие.Видимость = Не ВыполненПереходНаУниверсальныеСообщения;
	Элементы.КомандаОтклонитьДокументУтвердитьВходящиеКонтекстноеМеню.Видимость = Не ВыполненПереходНаУниверсальныеСообщения;
	Элементы.КомандаОтклонитьДокументПодписатьВходящиеКонтекстноеМеню.Видимость = Не ВыполненПереходНаУниверсальныеСообщения;
	Элементы.КомандаОтклонитьДокументУтвердитьИсходящиеКонтекстноеМеню.Видимость = Не ВыполненПереходНаУниверсальныеСообщения;
	Элементы.КомандаОтклонитьДокументПодписатьИсходящиеКонтекстноеМеню.Видимость = Не ВыполненПереходНаУниверсальныеСообщения;
	
	Элементы.КомандаОтклонитьДокументУтвердить.Заголовок = ТекстЗаголовкаОтклонить;
	Элементы.КомандаОтклонитьДокументПодписать.Заголовок = ТекстЗаголовкаОтклонить;
	Элементы.КомандаОтклонитьДокументНедоступная.Заголовок = ТекстЗаголовкаОтклонить;
	Элементы.КомандаОтклонитьДокументУтвердитьВходящие.Заголовок = ТекстЗаголовкаОтклонить;
	Элементы.КомандаОтклонитьДокументПодписатьВходящие.Заголовок = ТекстЗаголовкаОтклонить;
	Элементы.КомандаОтклонитьДокументУтвердитьИсходящие.Заголовок = ТекстЗаголовкаОтклонить;
	Элементы.КомандаОтклонитьДокументПодписатьИсходящие.Заголовок = ТекстЗаголовкаОтклонить;
	Элементы.КомандаОтклонитьДокументУтвердитьВходящиеКонтекстноеМеню.Заголовок = ТекстЗаголовкаОтклонить;
	Элементы.КомандаОтклонитьДокументПодписатьВходящиеКонтекстноеМеню.Заголовок = ТекстЗаголовкаОтклонить;
	Элементы.КомандаОтклонитьДокументУтвердитьИсходящиеКонтекстноеМеню.Заголовок = ТекстЗаголовкаОтклонить;
	Элементы.КомандаОтклонитьДокументПодписатьИсходящиеКонтекстноеМеню.Заголовок = ТекстЗаголовкаОтклонить;
	...
	Элементы.ЗапроситьУточнение.Заголовок = ТекстЗаголовкаЗапроситьУточнение;
	Элементы.ЗапроситьУточнениеВходящие.Заголовок = ТекстЗаголовкаЗапроситьУточнение;
