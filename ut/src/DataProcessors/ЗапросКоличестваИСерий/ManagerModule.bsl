...
Процедура УпаковкаПриИзменении(Объект, КлючевыеПараметры) Экспорт
	...
	Если Не ЗначениеЗаполнено(Объект.ВидЦены)
		Или Не КлючевыеПараметры.РедактироватьВидЦены Тогда
		Объект.Цена = Объект.ИсходнаяЦена *
			Справочники.УпаковкиЕдиницыИзмерения.КоэффициентУпаковки(Объект.Упаковка, Объект.Номенклатура) /
			Справочники.УпаковкиЕдиницыИзмерения.КоэффициентУпаковки(Объект.ИсходнаяУпаковка, Объект.Номенклатура);
	КонецЕсли;
