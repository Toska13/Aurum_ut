...
Процедура ЗагрузитьПоставки(Команда)
	...
	ПараметрыФормы.ИмяФормыСопоставленияДанных =
		"Обработка.УправлениеПродажамиНаOzon.Форма.ПубликацияТоваров";
	ПараметрыФормы.ПодсказкаОткрытияФормыСопоставленияДанных =
		НСтр("ru = 'Открывает форму получения данных о товарах с торговой площадки и сопоставления с данными учетной системы'");
...
Процедура ЗагрузитьОтчетыОРеализациях(Команда)
	...
	ПараметрыФормы.ПроверитьДоступностьИнтеграционныхМетодов = Истина;
...
#Область РазделSellmonitor

&НаКлиенте
Процедура ПерейтиВСервисSellmonitor(Команда)
	ФайловаяСистемаКлиент.ОткрытьНавигационнуюСсылку("https://sellmonitor.com/business/sales/ozon");
КонецПроцедуры
...
Процедура УстановитьВидимостьДоступностьЭлементов()
	...
	ГруппаПоставкиДоступность = Не УчетнаяЗапись.Пустая()
		...
		И ИнтеграцияСМаркетплейсамиКлиентСервер.ЭтоСпособОтраженияКомиссия(ДанныеТорговойПлощадки.СпособОтраженияПродажFBO);
	...
	ГруппаПродажиДоступность = Не УчетнаяЗапись.Пустая()
		И (Не ИнтеграцияСМаркетплейсамиКлиентСервер.ЭтоСпособОтраженияПродажиНеИспользуются(ДанныеТорговойПлощадки.СпособОтраженияПродажFBO)
			Или Не ИнтеграцияСМаркетплейсамиКлиентСервер.ЭтоСпособОтраженияПродажиНеИспользуются(ДанныеТорговойПлощадки.СпособОтраженияПродажFBS));
	...
	Если ГруппаПродажиДоступность Тогда
		...
		Элементы.ОткрытьДокументыПродажССобственныхСкладовКОформлению.Доступность   = ДоступноИспользованиеЖурналаПродаж
			И Не ИнтеграцияСМаркетплейсамиКлиентСервер.ЭтоСпособОтраженияПродажиНеИспользуются(ДанныеТорговойПлощадки.СпособОтраженияПродажFBS);
		Элементы.ОткрытьДокументыПродажССобственныхСкладовВсеЗаказы.Доступность     = ДоступенПросмотрЗаказовКлиента
			И Не ИнтеграцияСМаркетплейсамиКлиентСервер.ЭтоСпособОтраженияПродажиНеИспользуются(ДанныеТорговойПлощадки.СпособОтраженияПродажFBS);
		Элементы.ОткрытьДокументыПродажССобственныхСкладовВсеЗаказыOzon.Доступность =
			ДоступенПросмотрЗаказовКлиента
			И Не ИнтеграцияСМаркетплейсамиКлиентСервер.ЭтоСпособОтраженияПродажиНеИспользуются(ДанныеТорговойПлощадки.СпособОтраженияПродажFBS);
		Элементы.ОткрытьДокументыПродажКОформлениюОтчетов.Доступность =
			(ИнтеграцияСМаркетплейсамиКлиентСервер.ЭтоСпособОтраженияКомиссия(ДанныеТорговойПлощадки.СпособОтраженияПродажFBO)
				Или ИнтеграцияСМаркетплейсамиКлиентСервер.ЭтоСпособОтраженияКомиссия(ДанныеТорговойПлощадки.СпособОтраженияПродажFBS));
		...
		Элементы.ЗагрузитьОтчетыОРеализациях.Доступность                            = ДоступноИспользованиеОтчетовКомиссионера
			И (ИнтеграцияСМаркетплейсамиКлиентСервер.ЭтоСпособОтраженияКомиссия(ДанныеТорговойПлощадки.СпособОтраженияПродажFBO)
				...
				Или ДоступноИспользованиеЖурналаПродаж
					И ИнтеграцияСМаркетплейсамиКлиентСервер.ЭтоСпособОтраженияРеализацияВПути(ДанныеТорговойПлощадки.СпособОтраженияПродажFBS);
		...
		Элементы.ГруппаДокументыПродажПередачаВДоставку.Видимость =
			ИнтеграцияСМаркетплейсамиКлиентСервер.ЭтоСпособОтраженияКомиссия(ДанныеТорговойПлощадки.СпособОтраженияПродажFBS);
	...
	Элементы.ГруппаСервисыАналитики.Видимость = ПолучитьФункциональнуюОпцию("ИспользоватьИнтеграциюСSellmonitor");
