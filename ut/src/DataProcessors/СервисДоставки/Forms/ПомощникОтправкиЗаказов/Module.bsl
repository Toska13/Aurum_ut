...
Процедура ОткрытьФормуВыбораВремениИДаты()
	...
	ПараметрыОткрытияФормы.Дата = Мультизаказ.ДатаОтгрузки;
	ПараметрыОткрытияФормы.ВремяРаботыС = Мультизаказ.ВремяОтгрузкиС;
	ПараметрыОткрытияФормы.ВремяРаботыПо = Мультизаказ.ВремяОтгрузкиПо;
	ПараметрыОткрытияФормы.ВремяОбедС = Мультизаказ.ВремяОтгрузкиОбедС;  
	ПараметрыОткрытияФормы.ВремяОбедПо = Мультизаказ.ВремяОтгрузкиОбедПо;
	ПараметрыОткрытияФормы.ФиксированноеВремя = Мультизаказ.ВремяОтгрузкиФиксированное;
	ПараметрыОткрытияФормы.ВариантВыбораВремени = 1;
	ПараметрыОткрытияФормы.ТипГрузоперевозки = ТипГрузоперевозки;
	ПараметрыОткрытияФормы.ТолькоПросмотр = Мультизаказ.КартинкаИдентификатор = 3;
...
Процедура ОбработатьВыборДатыВремени(Результат, ДополнительныеПараметры) Экспорт
	...
	Результат.Свойство("ФиксированноеВремя", Мультизаказ.ВремяОтгрузкиФиксированное);
