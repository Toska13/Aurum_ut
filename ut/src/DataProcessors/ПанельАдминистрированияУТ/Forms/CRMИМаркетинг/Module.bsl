...
&НаКлиенте
Процедура ВыводитьПолныеНаименованияРетроБонусовКлиентовПриИзменении(Элемент)
...
Процедура УстановитьДоступность(РеквизитПутьКДанным = "")
	...
	Если РеквизитПутьКДанным = "НаборКонстант.ИспользуетсяЦенообразование25" ИЛИ РеквизитПутьКДанным = "" Тогда
		...
		Если ЗначениеКонстанты Тогда
			Элементы.ГруппаНастройкиВерсииЦенообразования.Видимость = Ложь;
		Иначе
		...
		ЦенообразованиеВызовСервера.УстановитьСвойстваДекорацииИнформированиеОбУдаленииЦенообразованияВерсии20(Элементы, Ложь);
		
		
	КонецЕсли;
	
	Если РеквизитПутьКДанным = "НаборКонстант.ИспользоватьРетроБонусыКлиентов"
	 ИЛИ РеквизитПутьКДанным = "НаборКонстант.ВыводитьПолныеНаименованияРетроБонусовКлиентов"
	 ...
	 ИЛИ РеквизитПутьКДанным = "" Тогда
		...
		#Область Доступность_ВыводитьПолныеНаименованияРетроБонусовКлиентов
		Элементы.ВыводитьПолныеНаименованияРетроБонусовКлиентов.Доступность =
