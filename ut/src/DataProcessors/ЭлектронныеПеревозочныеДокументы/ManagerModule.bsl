...
Функция ЗапросПоДокументуОснования() Экспорт
	...
	ТекстЗапроса = 
		...
		|ГДЕ
		|	ЭлектронныйЗаказЗаявкаДокументыОснования.ДокументОснование В (&ДокументОснование)
		|СГРУППИРОВАТЬ ПО
		|	ЭлектронныйЗаказЗаявкаДокументыОснования.Ссылка
		|;
		|////////////////////////////////////////////////////////////////////////////////
...
Процедура ЗаполнитьОбязательныеПараметрыЗапроса(Параметры) Экспорт
	...
	МассивШаговДляПодключенияМП.Добавить(СоответствиеТитуловИШагов.Получить(Перечисления.ТипыЭлементовРегламентаЭДО.ЭПЛ_Титул2));
	...
	МассивШаговДляПодключенияМП.Добавить(СоответствиеТитуловИШагов.Получить(Перечисления.ТипыЭлементовРегламентаЭДО.ЭПЛ_Титул6));
