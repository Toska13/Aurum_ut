...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ИначеЕсли ЭтоИнтернетЭквайринг Тогда
	...
	ИначеЕсли ЭтоОзон Тогда
		...
		ПредопределенныеШаблоны = МодульПлатежныеСистемыСлужебный.НастройкиПодключения(
			ПредопределенноеЗначение(ИмяПлатежнойСистемы)).ШаблоныНазначений;
	
	ИначеЕсли ЭтоЯндекс Тогда
		
		ИмяПлатежнойСистемы = "Перечисление.ПлатежныеСервисы.ЯндексПэй";
		МодульПлатежныеСистемыСлужебный = ОбщегоНазначения.ОбщийМодуль("ПлатежныеСистемыСлужебный");
		ПредопределенныеШаблоны = МодульПлатежныеСистемыСлужебный.НастройкиПодключения(
			ПредопределенноеЗначение(ИмяПлатежнойСистемы)).ШаблоныНазначений;
	...
	Элементы.ДобавитьВШаблон.Доступность = Ложь;
...
Процедура ПриСменеНастройкиШаблонов(ИдентификаторСтроки)
	...
	Элементы.ДобавитьВШаблон.Доступность = Истина;
...
Процедура ОпределитьПодсистему(Отказ)
	...
	Если ОбщегоНазначения.ПодсистемаСуществует("ИнтернетПоддержкаПользователей.ПлатежныеСистемы.БазоваяФункциональностьПлатежныхСистем") Тогда
		...
		Если МодульПлатежныеСистемыСлужебный.ЭтоНастройкаПодключения(НастройкаПодключения) Тогда
			...
			ЭтоОзон = (ПлатежнаяСистема = ПредопределенноеЗначение("Перечисление.ПлатежныеСервисы.ОзонПэй"));
			ЭтоЯндекс = (ПлатежнаяСистема = ПредопределенноеЗначение("Перечисление.ПлатежныеСервисы.ЯндексПэй"));
...
Функция ИзменениеШаблоновДоступно()
	...
	Если ЭтоИнтернетЭквайринг Тогда
	...
	Если ЭтоОзон Или ЭтоЯндекс Тогда
		МодульПлатежныеСистемы = ОбщегоНазначения.ОбщийМодуль("ПлатежныеСистемы");
		Возврат МодульПлатежныеСистемы.НастройкаПодключенияДоступна();
	КонецЕсли;
