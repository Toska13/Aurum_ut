...
Процедура ПриНажатииКнопкиПанелиКнопокСообщенияСистемыВзаимодействия(Сообщение, Кнопка)
	#Если МобильныйКлиент Тогда
		Выполнить("ОповещенияПользователейОСобытияхКлиент.ПриНажатииКнопкиПанелиКнопокСообщенияСистемыВзаимодействия(Сообщение, Кнопка)");
	#Иначе
		ОповещенияПользователейОСобытияхКлиент.ПриНажатииКнопкиПанелиКнопокСообщенияСистемыВзаимодействия(Сообщение, Кнопка);
	#КонецЕсли
КонецПроцедуры
...
#Если МобильныйКлиент Тогда
	...
	Иначе
		Если Не ЗначениеЗаполнено(ПараметрыПриложения) Тогда
