...
// Допустимые потребительские свойства.
// 
// Параметры:
//  ОКПД2 - Строка - ОКПД2
//  Назначение - СправочникСсылка.КлассификаторНСИЗЕРНО - Назначение
//  Страна - Неопределено, СправочникСсылка.СтраныМира - Страна
// 
// Возвращаемое значение:
//  Неопределено, ТаблицаЗначений - Допустимые потребительские свойства
