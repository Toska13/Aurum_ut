...
// Очистить идентификаторы обучения.
//
Процедура ОчиститьИдентификаторыОбучения() Экспорт
	...
	Попытка
		...
		НаборЗаписей = РегистрыСведений.СервисПрогнозированияИдентификаторыОбучения.СоздатьНаборЗаписей();
	...
	Исключение
		...
		ЗаписьЖурналаРегистрации(СобытиеЖурналаРегистрации,
			УровеньЖурналаРегистрации.Ошибка,
			Метаданные.РегистрыСведений.СервисПрогнозированияИдентификаторыОбучения,
			,
