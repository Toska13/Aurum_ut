...
Процедура ПолучитьЦену(ДанныеУчетнойЗаписи)
	...
	Стр.УчетнаяЗапись = ДанныеУчетнойЗаписи.УчетнаяЗапись;
	Стр.Номенклатура = Запись.Номенклатура;
	Стр.Характеристика = Запись.Характеристика;
	Стр.Упаковка = Запись.Упаковка;
	  
	ЦеныТоваров = ИнтеграцияСЯндексМаркетСервер.ПолучитьЦены(ДанныеУчетнойЗаписи, ТаблицаТоваров, Истина, Ложь);
