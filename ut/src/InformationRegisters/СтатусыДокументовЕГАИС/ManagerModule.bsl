...
// 	Структура - Описание:
// * ДальнейшееДействие3 - См. РегистрСведений.СтатусыДокументовЕГАИС.ДальнейшееДействие3
// * ДальнейшееДействие2 - См. РегистрСведений.СтатусыДокументовЕГАИС.ДальнейшееДействие2
// * ДальнейшееДействие1 - См. РегистрСведений.СтатусыДокументовЕГАИС.ДальнейшееДействие1
...
// * Статус - ОпределяемыйТип.СтатусыОбработкиДокументовЕГАИС - Статус документа (СтатусПоУмолчанию).
...
Функция РассчитатьСтатусыПриПолученииКвитанции(ДокументСсылка, Имя, СтатусОбработки, Статусы, ВыполнитьРасчетТекущегоСостояния = Истина) Экспорт
	...
	Если СтатусОбработки = Перечисления.СтатусыОбработкиСообщенийЕГАИС.Ошибка 
		Или СтатусОбработки = Перечисления.СтатусыОбработкиУведомленияОПланируемомИмпортеЕГАИС.ОшибкаПроведенияЕГАИС Тогда
...
Процедура ОбработатьДанныеДляПереходаНаНовуюВерсию(Параметры) Экспорт
	...
	Если ОбщегоНазначенияЕГАИС.ЭтоРасширеннаяВерсияГосИС() Тогда
		МодульИнтеграцияЕГАИС = ОбщегоНазначенияИСПовтИсп.ОбщийМодуль("ИнтеграцияЕГАИС");
