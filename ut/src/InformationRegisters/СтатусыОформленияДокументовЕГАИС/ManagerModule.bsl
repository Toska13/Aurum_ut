...
// * Основание - ДокументСсылка - 
// * СтатусОформления - ПеречислениеСсылка.СтатусыОформленияДокументовЕГАИС - 
// * Архивный - Булево - 
// * Дата - Дата - 
// * Номер - Строка - 
// * Контрагент - - ОпределяемыйТип.ОрганизацияКонтрагентГосИС - 
// * ТорговыйОбъект - Неопределено, ОпределяемыйТип.ТорговыйОбъектЕГАИС - 
...
Функция ЗначенияПоУмолчанию(Основание, СсылкаНаОформляемыйДокумент) Экспорт
	...
	СтруктураЗначенияПоУмолчанию.Вставить("Контрагент", Метаданные.ОпределяемыеТипы.ОрганизацияКонтрагентГосИС.Тип.ПривестиЗначение());
	СтруктураЗначенияПоУмолчанию.Вставить("ТорговыйОбъект", Метаданные.ОпределяемыеТипы.ТорговыйОбъектЕГАИС.Тип.ПривестиЗначение());
	СтруктураЗначенияПоУмолчанию.Вставить("Ответственный", Метаданные.ОпределяемыеТипы.Пользователь.Тип.ПривестиЗначение());
