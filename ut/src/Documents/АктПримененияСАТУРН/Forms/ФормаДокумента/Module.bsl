...
&НаКлиенте
Процедура ПоПриказу420ПриИзменении(Элемент)
	НастроитьЗависимыеЭлементыФормы(ЭтотОбъект, "ВнесеноНаПлощадь");
КонецПроцедуры
...
Процедура УстановитьУсловноеОформление()
	...
	ЭлементУсловногоОформления.Оформление.УстановитьЗначениеПараметра("Текст",       Новый ПолеКомпоновкиДанных("Объект.МестаПрименения.ОписаниеМестаПрименения"));
...
Процедура НастроитьЗависимыеЭлементыФормы(Форма, СписокРеквизитов = "")
	...
	Если Инициализация Или СтруктураРеквизитов.Свойство("ВнесеноНаПлощадь") Тогда
		Элементы.ТоварыВнесеноНаПлощадь.Видимость = Объект.ПоПриказу420;
	КонецЕсли;
...
&НаКлиенте
Процедура ВопросОПерезаполненииПоОснованиюПриЗавершении(Результат, ПараметрыОповещения) Экспорт
