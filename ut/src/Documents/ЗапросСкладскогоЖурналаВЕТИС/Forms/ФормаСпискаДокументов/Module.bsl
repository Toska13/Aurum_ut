...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ИнтеграцияВЕТИС.УстановитьВидимостьОрганизацииВЕТИС(ЭтотОбъект, Ложь, "СтраницыОтборОрганизацияВЕТИС");
	ИнтеграцияИС.УстановитьВидимостьОтветственный(ЭтотОбъект, Ложь, "ОтветственныйОтбор");
