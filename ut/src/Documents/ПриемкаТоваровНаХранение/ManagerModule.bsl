...
// 
// Параметры:
//  ОбъектИлиСсылка - ДокументОбъект.ПриемкаТоваровНаХранение, ДокументСсылка.ПриемкаТоваровНаХранение - документ.
...
// 
// Параметры:
//  Объект - ДокументОбъект.ПриемкаТоваровНаХранение - объект.
// 
// Возвращаемое значение:
...
Функция ПорядокЗаполненияНазначенийВДокументе(Форма) Экспорт
	...
	ПорядокОбработкиДокумента.ИмяРеквизитаПоЗаказу = "ПоступлениеПоЗаказам";
...
Процедура ОтразитьРаспределениеЗапасовДвижения(Запрос, ТекстыЗапроса, Регистры)
	...
	ТекстЗапросаТабЧасть =
		...
		|	ТабЧасть.Ссылка.ПоступлениеПоЗаказам
...
//
// Параметры:
//	МассивДокументов - Массив Из ДокументСсылка.ПриемкаТоваровНаХранение - коллекция ссылок на документы, используемых
...
Функция ДанныеДляПечатиЭтикеток(МассивДокументов) Экспорт
	...
	|		ЛЕВОЕ СОЕДИНЕНИЕ Документ.ПриемкаТоваровНаХранение КАК ДанныеШапки
	...
	|ИЗ
	|	Документ.ПриемкаТоваровНаХранение.Серии КАК ТаблицаСерий
	|		ЛЕВОЕ СОЕДИНЕНИЕ Справочник.СерииНоменклатуры КАК ДанныеСерии
	...
	|ИЗ
	|	Документ.ПриемкаТоваровНаХранение КАК ДанныеШапки
	|ГДЕ
