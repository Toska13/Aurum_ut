...
Процедура ПередЗаписью(Отказ, ПараметрыЗаписи)
	...
	Если ПараметрыЗаписи.РежимЗаписи = РежимЗаписиДокумента.Проведение
		...
		Иначе
			...
			ЗаполнитьДокументыПоступленияВТЧ();
...
Процедура ОплатаВВалютеПриИзменении(Элемент)
	ОплатаВВалютеПриИзмененииНаСервере();
КонецПроцедуры
...
Процедура ПолучитьСтрокиИзБуфераОбмена()
	...
	Колонки = "Номенклатура,Характеристика,Упаковка,КоличествоУпаковок,Цена,ДокументПоступления,Склад";
...
Процедура ОбновитьТекстДокументыНаОсновании()
	...
	ПараметрыРегистрацииУведомленийОВвозе = ВозвратТоваровПоставщикуЛокализация.ПараметрыРегистрацииУведомленийОВвозеПрослеживаемыхТоваров(Объект);
...
Процедура ЗаполнитьСтавкуНДСНаСервере(СтавкаНДС, КэшированныеЗначения)
	...
	Для каждого СтрокаТабличнойЧасти Из ВыделенныеСтроки Цикл
		Если Объект.ВозвратПринятойМногооборотнойТары
...
&НаКлиенте
Процедура ЗаполнитьДокументыПоступленияВТЧ()
...
&НаСервере
Процедура ОплатаВВалютеПриИзмененииНаСервере()
...
Функция ПараметрыРегистрацииУведомленийОВвозеПрослеживаемыхТоваровСервер(Знач Объект)
	...
	Возврат ВозвратТоваровПоставщикуЛокализация.ПараметрыРегистрацииУведомленийОВвозеПрослеживаемыхТоваров(Объект);
