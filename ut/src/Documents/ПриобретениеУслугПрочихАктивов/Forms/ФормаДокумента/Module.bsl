...
Процедура СуммаДокументаПриИзмененииСервер(СуммаДокумента)
	...
	ПараметрыПересчета.ПересчитыватьРучныеСкидки         = Ложь;
...
Функция ПоместитьВыделенныеСтрокиВХранилище(Знач ВыделенныеСтроки)
	...
	ТаблицаСтрок.Колонки.Добавить("Количество", ОбщегоНазначенияУТ.ОписаниеТипаКоличественногоПоля());
...
Процедура УстановитьДоступностьЭлементовПоСтатусуСервер()
	...
	МассивЭлементов.Добавить("РасходыЗаполнитьСтавкуНДС");
