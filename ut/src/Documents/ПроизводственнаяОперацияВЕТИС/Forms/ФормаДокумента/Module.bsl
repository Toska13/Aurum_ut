...
Процедура СырьеНоменклатураСоздание(Элемент, СтандартнаяОбработка)
	...
	СобытияФормВЕТИСКлиент.ПриСозданииНоменклатуры(Элемент, Элементы.Сырье.ТекущиеДанные, СтандартнаяОбработка);
...
Процедура СырьеХарактеристикаСоздание(Элемент, СтандартнаяОбработка)
	...
	СобытияФормИСКлиентПереопределяемый.ПриСозданииХарактеристики(ЭтотОбъект, Элементы.Сырье.ТекущиеДанные, Элемент, СтандартнаяОбработка);
