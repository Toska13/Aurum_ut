...
Процедура ОбработкаЗаполнения(ДанныеЗаполнения, СтандартнаяОбработка)
	...
	Если ТипДанныхЗаполнения = Тип("Структура") Тогда
		...
		Если ДанныеЗаполнения.Свойство("ПервичныйДокумент") И ЗначениеЗаполнено(ДанныеЗаполнения.ПервичныйДокумент) Тогда  
			...
			Если ЭтотОбъект.Исправление Тогда
				Товары.Загрузить(Документы.УведомлениеОВвозеПрослеживаемыхТоваров.ДанныеТЧТоварыПоЗаявлению(
				ПервичныйДокумент,
				ИсправляемыйДокумент,
				КодТНВЭД,
				ЕдиницаИзмерения)); 
				СторнируемыйДокумент = ИсправляемыйДокумент;
			Иначе
	...
	ИначеЕсли ТипДанныхЗаполнения = Тип("ДокументСсылка.УведомлениеОВвозеПрослеживаемыхТоваров") Тогда
		
		ИсправлениеДокументов.ЗаполнитьИсправление(ЭтотОбъект, ДанныеЗаполнения);
		ИсправляемыйДокумент = СторнируемыйДокумент;
		Товары.Загрузить(Документы.УведомлениеОВвозеПрослеживаемыхТоваров.ДанныеТЧТоварыПоЗаявлению(
			ПервичныйДокумент,
			ИсправляемыйДокумент,
			КодТНВЭД,
