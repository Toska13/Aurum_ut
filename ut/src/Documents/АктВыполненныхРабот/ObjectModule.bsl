...
Процедура ОбработкаЗаполнения(ДанныеЗаполнения, СтандартнаяОбработка)
	...
	ОтветственныеЛицаСервер.УстановитьМенеджера(
		ЭтотОбъект, ПродажиСервер.ДокументОснование(ЭтотОбъект, "АктПоЗаказам, ЗаказКлиента, Услуги.ЗаказКлиента"));
...
Процедура ОбработкаПроверкиЗаполнения(Отказ, ПроверяемыеРеквизиты)
	...
	УчетНДСЛокализация.ПроверитьУслугиПоСтавкеНДСКомитента(ЭтотОбъект, Отказ, "Услуги");
...
Процедура ИнициализироватьДокумент(ДанныеЗаполнения = Неопределено)
	...
	СтруктураДействий.Вставить("СкорректироватьСтавкуНДС",
		ПакетнаяОбработкаТабличнойЧастиКлиентСервер.ПараметрыЗаполненияСтавкиНДС(ЭтотОбъект));
