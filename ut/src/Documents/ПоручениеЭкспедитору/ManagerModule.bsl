...
//
// Параметры:
//  Основания - Массив из ДокументСсылка - основания для ввода поручений экспедитору.
// 
// Возвращаемое значение:
//  Структура - со свойствами:
//  * Склады - Массив из СправочникСсылка.Склады -
//  * Пункты - Массив из СправочникСсылка.Партнеры, СправочникСсылка.Склады, СправочникСсылка.СтруктураПредприятия -
//  * Контакты - Массив из СправочникСсылка.КонтактныеЛицаПартнеров -
//  * СпособыДоставки - Массив из ПеречислениеСсылка.СпособыДоставки -
//
Функция ДанныеОснований(Основания) Экспорт
	...
	Для Каждого КлючИЗначение Из ОснованияПоТипам Цикл
		...
		МетаданныеОбъектаТабличныеЧасти = МетаданныеОбъекта.ТабличныеЧасти;
	...
	Склады = РезультатЗапроса[РезультатЗапроса.Количество()-3].Выгрузить().ВыгрузитьКолонку("Склад");
	Пункты = РезультатЗапроса[РезультатЗапроса.Количество()-2].Выгрузить().ВыгрузитьКолонку("Пункт");
	Контакты = РезультатЗапроса[РезультатЗапроса.Количество()-1].Выгрузить().ВыгрузитьКолонку("КонтактноеЛицо");
	
	СтруктураВозврата = Новый Структура;
	СтруктураВозврата.Вставить("Склады", Склады);
	СтруктураВозврата.Вставить("Пункты", Пункты);
	СтруктураВозврата.Вставить("Контакты", Контакты);
	СтруктураВозврата.Вставить("СпособыДоставки", СпособыДоставки);
...
Функция ДобавитьКомандуСоздатьНаОсновании(КомандыСозданияНаОсновании) Экспорт
	...
	Если ПравоДоступа("Добавление", Метаданные.Документы.ПоручениеЭкспедитору) Тогда
		...
		КомандаСоздатьНаОсновании.ФункциональныеОпции = "НеИспользоватьУправлениеДоставкой25";
