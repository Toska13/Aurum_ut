...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ЗаполнитьСписокВыбораОписаниямиВидовТранспорта(Элементы.ВидТранспорта.СписокВыбора);
...
&НаКлиентеНаСервереБезКонтекста
Процедура ЗаполнитьСписокВыбораОписаниямиВидовТранспорта(СписокЗначений)

	СписокЗначений.Очистить();
	СписокЗначений.Добавить(НСтр("ru = '10 - Морской/речной транспорт'"));
	СписокЗначений.Добавить(НСтр("ru = '20 - Железнодорожный транспорт'"));
	СписокЗначений.Добавить(НСтр(
	"ru = '30 - Автодорожный транспорт, за исключением транспортных средств, указанных под кодами 31, 32'"));
	СписокЗначений.Добавить(НСтр("ru = '31 - Состав транспортных средств (тягач с полуприцепом или прицепом)'"));
	СписокЗначений.Добавить(НСтр(
	"ru = '32 - Состав транспортных средств (тягач с полуприцепом(-ами) или прицепом(-ами))'"));
	СписокЗначений.Добавить(НСтр("ru = '40 - Воздушный транспорт'"));
	СписокЗначений.Добавить(НСтр("ru = '50 - Почтовое отправление'"));
	СписокЗначений.Добавить(НСтр("ru = '71 - Трубопроводный транспорт'"));
	СписокЗначений.Добавить(НСтр("ru = '72 - Линии электропередачи'"));
	СписокЗначений.Добавить(НСтр("ru = '80 - Внутренний водный транспорт'"));
	СписокЗначений.Добавить(НСтр("ru = '90 - Транспортное средство, перемещающееся в качестве товара своим ходом'"));
	СписокЗначений.Добавить(НСтр("ru = '99 - Прочее'"));
