...
Процедура ЗарегистрироватьДанныеКОбработкеДляПереходаНаНовуюВерсию(Параметры) Экспорт
	...
	ЗапросМаксимальнаяГраница.Текст = 
		"ВЫБРАТЬ
		|	МАКСИМУМ(ЗаявкаНаРасходованиеДенежныхСредств.Дата) КАК Дата
		|ИЗ
		|	Документ.ЗаявкаНаРасходованиеДенежныхСредств КАК ЗаявкаНаРасходованиеДенежныхСредств";
	...
	|	И ЗаявкаНаРасходованиеДенежныхСредств.Дата <= &ДатаПоследнейПорции
	|	И НЕ ЗаявкаНаРасходованиеДенежныхСредств.Ссылка В (&ИсключаемыеДокументы)
	|
	|УПОРЯДОЧИТЬ ПО
