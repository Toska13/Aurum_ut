...
Процедура СформироватьСтрокуРасчетноПлатежныхДокументов()
	...
	СтрокаНомеровИДата = Документы.СчетФактураВыданный.СтрокаРасчетноПлатежныхДокументов(Объект.ПлатежноРасчетныеДокументы);
...
Процедура СформироватьСтрокуАвансовыеСчетаФактуры()
	...
	СтрокаНомеровИДата = Документы.СчетФактураВыданный.СтрокаАвансовыеСчетаФактуры(Объект.ПлатежноРасчетныеДокументы);
	
	Если Объект.СтрокаАвансовыеСчетаФактуры <> СтрокаНомеровИДата Тогда
		Объект.СтрокаАвансовыеСчетаФактуры = СтрокаНомеровИДата;
	КонецЕсли;
...
Процедура УстановитьСвойстваКомментарияИспользованияУстаревшейКомиссии()
	...
	Элементы.КомментарийИспользованиеУстаревшейКомиссии.Видимость = (Объект.ХозяйственнаяОперация = Перечисления.ХозяйственныеОперации.ОтчетКомиссионера);
