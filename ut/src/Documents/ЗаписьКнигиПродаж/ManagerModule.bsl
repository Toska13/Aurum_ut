...
Функция ТекстЗапросаВтТаблицаТоваров(Запрос, ТекстыЗапроса)
	...
	|	ТаблицаЦенности.Событие КАК Событие,
	|	ТаблицаЦенности.НомерГТД КАК НомерГТД,
	|	ТаблицаЦенности.КодОперации КАК КодОперации0,
	|	НЕ ТаблицаЦенности.КодТНВЭД.СырьевойТовар КАК НесырьевыеТовары,
	...
	|	ТаблицаЦенности.КодОперации,
	|	ТаблицаЦенности.КодТНВЭД.СырьевойТовар";
...
Функция ТекстЗапросаТаблицаНДСЗаписиКнигиПродаж(Запрос, ТекстыЗапроса, Регистры)
	...
	|	ТаблицаДанных.КодОперации0 КАК КодОперации0,
	|	ТаблицаДанных.НесырьевыеТовары КАК НесырьевыеТовары,
	...
	|	ТаблицаДанных.КодОперации0,
	|	ТаблицаДанных.НесырьевыеТовары
	|
	|ИМЕЮЩИЕ
