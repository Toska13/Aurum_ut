...
Функция ВыполнитьЗаданиеВФоне(Знач Задание, УникальныйИдентификатор)
	...
	Если Задание.ИмяПроцедуры = ИнтеграцияСЭлектроннымиТорговымиПлощадкамиКлиентСервер.МетодПолучениеДанныхУчастниковПоЗапросуБидзаар() Тогда
		Возврат ДлительныеОперации.ВыполнитьВФоне(
			"ИнтеграцияСЭлектроннымиТорговымиПлощадками.ПолучениеДанныхУчастниковПоЗапросуБидзаар",
			Задание.ПараметрыПроцедуры, ПараметрыВыполнения);
	ИначеЕсли Задание.ИмяПроцедуры = ИнтеграцияСЭлектроннымиТорговымиПлощадкамиКлиентСервер.МетодПолучениеДанныхКоммерческихПредложенийПоЗапросуБидзаар() Тогда
		Возврат ДлительныеОперации.ВыполнитьВФоне(
			"ИнтеграцияСЭлектроннымиТорговымиПлощадками.ПолучениеДанныхКоммерческихПредложенийПоЗапросуБидзаар",
			Задание.ПараметрыПроцедуры, ПараметрыВыполнения);
	ИначеЕсли Задание.ИмяПроцедуры = "Документы.ЗапросКоммерческихПредложенийПоставщиков.СформироватьКоммерческиеПредложения" Тогда
		Возврат ДлительныеОперации.ВыполнитьВФоне(
			"Документы.ЗапросКоммерческихПредложенийПоставщиков.СформироватьКоммерческиеПредложения",
			Задание.ПараметрыПроцедуры, ПараметрыВыполнения);
	Иначе
...
Функция ВыполнитьПереносДанныхКоммерческихПредложенийВФоне(Знач Задание, УникальныйИдентификатор)
	...
	Возврат ДлительныеОперации.ВыполнитьВФоне(
		"Документы.ЗапросКоммерческихПредложенийПоставщиков.ВыбратьПредложения",
		Задание.ПараметрыПроцедуры, ПараметрыВыполнения);
...
Функция СозданиеАнкетВФоне(Знач Задание, ПараметрыФормы)
	...
	Возврат ДлительныеОперации.ВыполнитьВФоне(
		"Документы.ЗапросКоммерческихПредложенийПоставщиков.СформироватьАнкеты",
		Задание.ПараметрыПроцедуры, ПараметрыВыполнения);
...
Функция ВыполнитьПолучениеФайловКоммерческихПредложенийВФоне(Знач Задание, УникальныйИдентификатор)
	...
	Возврат ДлительныеОперации.ВыполнитьВФоне(
		"ИнтеграцияСЭлектроннымиТорговымиПлощадками.ПолучениеФайловКоммерческихПредложенийБидзаар",
		Задание.ПараметрыПроцедуры, ПараметрыВыполнения);
...
Функция ВыполнитьСозданиеЗаказовПоставщикуВФоне(Знач Задание, УникальныйИдентификатор)
	...
	Возврат ДлительныеОперации.ВыполнитьВФоне(
		"Обработки.ТорговыеПредложения.СформироватьЗаказы", Задание.ПараметрыПроцедуры, ПараметрыВыполнения);
