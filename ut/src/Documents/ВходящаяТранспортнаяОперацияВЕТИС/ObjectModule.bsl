...
Процедура ОбработкаЗаполнения(ДанныеЗаполнения, ТекстЗаполнения, СтандартнаяОбработка)
	...
	Если Не ЗначениеЗаполнено(ГрузополучательХозяйствующийСубъект) Тогда
		...
		Если ЗначениеЗаполнено(ЗначенияПоУмолчанию.ХозяйствующийСубъектВЕТИС) Тогда
			ГрузополучательХозяйствующийСубъект = ЗначенияПоУмолчанию.ХозяйствующийСубъектВЕТИС;
			ГрузополучательПредприятие          = ЗначенияПоУмолчанию.ПредприятиеВЕТИС;
		КонецЕсли;
...
Процедура ПриКопировании(ОбъектКопирования)
	...
	ПоляОчисткиТаблиц = ПоляОчисткиТаблиц();
...
Функция ПоляОчисткиТаблиц()
	Результат = Новый Структура;
	Результат.Вставить("РезультатПроверкиПравилРегионализации");
	Результат.Вставить("УсловияРегионализацииВыполнены");
	Результат.Вставить("ВетеринарноСопроводительныйДокументНаВозврат");
	Результат.Вставить("ЗаписьСкладскогоЖурнала");
	Результат.Вставить("ВетеринарноСопроводительныйДокумент");
	Возврат Результат;
КонецФункции
