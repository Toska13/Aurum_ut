...
&НаКлиенте
Процедура ПередатьУведомлениеОбОтгрузкеНаЭкспорт(Команда)
	
	ОбменДаннымиИСМПКлиент.ПодготовитьСообщенияКПередаче(
		Элементы.Список,
		ПредопределенноеЗначение("Перечисление.ДальнейшиеДействияПоВзаимодействиюИСМП.ПередайтеУведомлениеОбОтгрузкеНаЭкспорт"));
