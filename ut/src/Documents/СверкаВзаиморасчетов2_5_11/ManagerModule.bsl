...
Процедура ДобавитьКомандыОтчетов(КомандыОтчетов, Параметры) Экспорт
	...
	КомандаОтчет.Менеджер = Метаданные.Отчеты.СверкаРасчетовСКонтрагентами.ПолноеИмя();
	КомандаОтчет.Представление = Метаданные.Отчеты.СверкаРасчетовСКонтрагентами.Синоним;
	
	КомандаОтчет.МножественныйВыбор = Истина;
	КомандаОтчет.Важность = "Обычное";
	КомандаОтчет.ДополнительныеПараметры.Вставить("ИмяКоманды", "СверкаРасчетовСКонтрагентами");
...
Функция ТекстЗапросаДанныеДокумента(НастройкиПечати)
	...
	|
	|	ДетальныеЗаписи.СуммаДебетКонтрагент КАК СуммаДебетКонтрагент,
	|	ДетальныеЗаписи.СуммаКредитКонтрагент КАК СуммаКредитКонтрагент,
	|
	|	ДетальныеЗаписи.СуммаДебетКонтрагент КАК СуммаДолгКонтрагент,
	|	ДетальныеЗаписи.СуммаКредитКонтрагент КАК СуммаАвансКонтрагент
	|
