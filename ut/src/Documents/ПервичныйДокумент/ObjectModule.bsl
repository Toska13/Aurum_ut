...
Процедура ПередЗаписью(Отказ, РежимЗаписи, РежимПроведения)
	...
	Если Не ЭтоНовый() 
		...
		И ОбщегоНазначенияУТ.ИзмененияДокумента(ЭтотОбъект).Свойство("Реквизиты") Тогда
...
Процедура ИнициализироватьДокумент(ДанныеЗаполнения)
	...
	Если ДанныеЗаполненияЭтоСтруктура
		И ДанныеЗаполнения.Свойство("ДанныеАвансовогоОтчета") Тогда
		
		ДанныеАвансовогоОтчета = ДанныеЗаполнения.ДанныеАвансовогоОтчета;
		
		Организация = ДанныеАвансовогоОтчета.Организация;
		Подразделение = ДанныеАвансовогоОтчета.Подразделение;
		Дата = ДанныеАвансовогоОтчета.Дата;
		НалогообложениеНДС = ДанныеАвансовогоОтчета.НалогообложениеНДС;
		ТипПервичногоДокумента = ДанныеАвансовогоОтчета.ТипПервичногоДокумента;
		НомерВходящегоДокумента = ДанныеАвансовогоОтчета.НомерВходящегоДокумента;
		ДатаВходящегоДокумента = ДанныеАвансовогоОтчета.ДатаВходящегоДокумента;
		Контрагент = ДанныеАвансовогоОтчета.Контрагент;
		Валюта = ДанныеАвансовогоОтчета.Валюта;
		СуммаДокумента = ДанныеАвансовогоОтчета.СуммаДокумента;
		СуммаРегл = ДанныеАвансовогоОтчета.СуммаРегл;
