...
Процедура ОбработкаОповещения(ИмяСобытия, Параметр, Источник)
	...
	Если ИмяСобытия = ИнтерфейсДокументовЭДОКлиент.ИмяСобытияОбновленияСостоянияЭДО()
		...
		Если ОбработатьОповещение И ТребуетсяОднородностьОтвета Тогда
...
Процедура ОбновитьДанныеДляПросмотраДокумента()
	...
	ДанныеКомпонентов = ЛегкийИнтерфейсДокументовЭДО.НовыеДанныеКомпонентовПросмотраДокумента(
		...
		|ПанельКомандНастроекВизуализацииЛегкийКлиентЭДО, ПанельПредставленияФайла, ПанельПодписей,
		|ПанельСопроводительнойЗапискиВходящегоДокумента, ПанельРеквизитов, ПанельРеквизитовПакета,
		|ПанельСвязанныхДокументовЛегкийКлиентЭДО, ПанельСообщений");
...
Процедура ОбновитьВизуализациюДокументаНаСервере()
	...
	ДанныеКомпонентов = ЛегкийИнтерфейсДокументовЭДО.НовыеДанныеКомпонентовПросмотраДокумента(
		"ПанельКомандВходящегоДокументаЛегкийКлиентЭДО, ПанельВизуализации,
		|ПанельКомандНастроекВизуализацииЛегкийКлиентЭДО, ПанельПредставленияФайла");
...
Процедура ОбновитьДанныеПослеИзмененияПодписейДокументаНаСервере()
	...
	ДанныеКомпонентов = ЛегкийИнтерфейсДокументовЭДО.НовыеДанныеКомпонентовПросмотраДокумента(
		...
		|ПанельЗакладокВходящегоДокумента, ПанельВизуализации, ПанельКомандНастроекВизуализацииЛегкийКлиентЭДО,
