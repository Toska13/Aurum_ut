...
Процедура ЗаполнитьДокументПоОтбору(ДанныеЗаполнения)
	...
	Если ДанныеЗаполнения.Свойство("ФормаОплаты") Тогда
...
Процедура ЗаполнитьПоРеализацииТоваров(Знач Основание, ДанныеЗаполнения)
	...
	Если ВыборкаПоДокументу.Следующий() Тогда
		...
		БанковскийСчет = ВыборкаПоДокументу.БанковскийСчет;
		ФормаОплаты = ВыборкаПоДокументу.ФормаОплаты;
		Касса = ВыборкаПоДокументу.Касса;
