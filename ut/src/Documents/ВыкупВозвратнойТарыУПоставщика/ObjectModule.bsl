...
Процедура ЗаполнитьДокументНаОснованииПринятойТары(Знач РеквизитыЗаполнения)
	...
	Партнер = РеквизитыЗаполнения.РеквизитыШапки.Партнер;
	...
	ИсключаемыеСвойства = "";
	Если Не ЗначениеЗаполнено(РеквизитыЗаполнения.РеквизитыШапки.Организация) Тогда
		ИсключаемыеСвойства = "Организация, Контрагент, Соглашение";
	КонецЕсли;
	
	ЗаполнитьЗначенияСвойств(ЭтотОбъект, РеквизитыЗаполнения.РеквизитыШапки, , ИсключаемыеСвойства);
