...
Процедура ЗаполнитьТабличнуюЧастьТовары(ДокументОснование = Неопределено) Экспорт
	...
	Иначе
		...
		|	ТоварыПересчета.КонтролируемаяПартия КАК КонтролируемаяПартия,
		...
		|	ТоварыПересчета.КонтролируемаяПартия
		|
		|ИМЕЮЩИЕ
...
Процедура ЗаполнитьВидыЗапасовДокумента()
	...
	|		ЛЕВОЕ СОЕДИНЕНИЕ Документ.ОприходованиеИзлишковТоваров КАК СохраненныеДанные
