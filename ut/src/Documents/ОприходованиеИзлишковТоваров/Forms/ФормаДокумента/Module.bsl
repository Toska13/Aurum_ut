...
Процедура ДатаПриИзмененииСервер()
	...
	УстановитьВидимостьРеквизитовКонтроляКачества();
...
&НаСервере
Процедура УстановитьВидимостьРеквизитовКонтроляКачества()
	
	ЭлементыВидны = Не СкладыСервер.ИспользоватьОрдернуюСхемуПриОтраженииИзлишковНедостач(Объект.Склад, Объект.Дата);
	Элементы.ТоварыКонтролируемаяПартия.Видимость = ЭлементыВидны;
	Элементы.ТоварыДатаПодтвержденияКачества.Видимость = ЭлементыВидны;
