...
Процедура ПослеЗаписиНаСервере(ТекущийОбъект, ПараметрыЗаписи)
	...
	ПакетнаяОбработкаТабличнойЧастиКлиентСерверЛокализация.ДополнитьСтруктуруДействийПриИзмененииЭлемента(ЭтотОбъект, "Товары", СтруктураДействий);
...
Процедура КассаПриИзмененииНаСервере()
	...
	ЗаполнитьРеквизитыПриИзмененииЭлементаНаСервереЛокализация(Элементы.КассаККМ);
	
	ОбновитьВидимостьЭлементов(РеквизитыКассыККМ.ТипКассы = Перечисления.ТипыКассККМ.ФискальныйРегистратор);
	
	РассчитатьИтоговыеПоказателиОтчетаОРозничныхВозвратах(ЭтотОбъект);
...
Процедура СкладПриИзмененииНаСервере()
	...
	ЗаполнитьРеквизитыПриИзмененииЭлементаНаСервереЛокализация(Элементы.Склад);
...
Процедура ТоварыХарактеристикаПриИзменении(Элемент)
	...
	СтруктураДействий.Вставить("ХарактеристикаПриИзмененииПереопределяемый", Новый Структура("ИмяФормы, ИмяТабличнойЧасти", ИмяФормы, "Товары"));
...
Процедура ОбработатьШтрихкоды(ДанныеШтрихкодов)
	...
	ПакетнаяОбработкаТабличнойЧастиКлиентСерверЛокализация.ДополнитьСтруктуруДействийПриИзмененииЭлемента(ЭтотОбъект, "Товары", СтруктураДействийСДобавленнымиСтроками);
...
Процедура ОбработкаВыбораПодборНаСервере(ВыбранноеЗначение)
	...
	СписокСвойств = "НоменклатураНабора,
	...
	Для каждого СтрокаТовара Из ТаблицаТоваров Цикл
		...
		ТекущаяСтрока.СпособОпределенияСебестоимости = 
...
Процедура ПерезаполнитьНаСервере()
	...
	РозничныеПродажи.ПодготовитьДанныеПоЧекамКассовойСмены(СостояниеКассовойСмены, МенеджерВременныхТаблиц);
	
	// Заполним Отчет о розничных возвратах 
	РозничныеПродажи.ЗаполнитьОтчетОРозничныхВозвратах(
		Объект,
...
&НаСервере
Процедура ЗаполнитьРеквизитыПриИзмененииЭлементаНаСервереЛокализация(Элемент)
	
	//++ Локализация
	Если Элемент = Элементы.КассаККМ Или Элемент = Элементы.Склад Тогда
