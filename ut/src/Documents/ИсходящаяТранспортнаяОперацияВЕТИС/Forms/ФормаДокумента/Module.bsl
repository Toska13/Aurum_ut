...
Процедура ОбработкаВыбора(ВыбранноеЗначение, ИсточникВыбора)
	...
	Иначе
		...
		СобытияФормИСКлиентПереопределяемый.ОбработкаВыбораНоменклатуры(ОписаниеОповещения, ВыбранноеЗначение,ИсточникВыбора);
...
&НаКлиенте
Процедура ОтборСтрокТолькоСОшибками(Команда)
	
	ОтборСтрок = Не ОтборСтрок;
...
Процедура УстановитьОтборСтрок(Форма)
	...
	Форма.Элементы.ТоварыОтборСтрокТолькоСОшибками.Пометка = Форма.ОтборСтрок;
...
Процедура ОбновитьСтатусВЕТИС()
	...
	Исключения = "ТоварыНайти, ТоварыОтменитьПоиск, ТоварыСгенерироватьСерии, ТоварыКонтекстноеМенюКопированиеИВыделение, СвернутьПанель"
		+ ", РазвернутьПанель, ТоварыГруппаНоменклатура, ТоварыКоличество, Аннулировать, ТоварыОтборСтрокТолькоСОшибками";
