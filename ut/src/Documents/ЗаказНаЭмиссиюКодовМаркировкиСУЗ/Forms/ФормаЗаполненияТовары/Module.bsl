...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ДоступныеШаблоны = ИнтеграцияИСМПКлиентСервер.ШаблоныКодовПоВидуПродукции(ТоварнаяГруппа, 0);
...
Процедура КодТНВЭДНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	...
	ПараметрыФормы.Вставить("ВидПродукцииТоварнаяГруппа",              ТоварнаяГруппа);
...
&НаКлиенте
Процедура ПриИзмененииКодаТНВЭД()
	
	Если ЗначениеЗаполнено(КодТНВЭД) Тогда
	
		КодТНВЭДТребуетВозрастнуюКатегорию = МаркировкаТоваровКлиентСервер.ДоступноПолеВозрастнаяКатегорияДляМаркировкиОстатков(
			ТоварнаяГруппа, КодТНВЭД);
