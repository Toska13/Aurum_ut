...
Процедура ЗадатьОписаниеЗаполняемыхРеквизитовПоСтатистике(ОписаниеРеквизитов) Экспорт
	...
	Параметры.ПараметрыСбораСтатистики.ПриОтсутствииДанныхПолучатьЗначениеБезУчетаАвтора = Истина;
	ЗаполнениеОбъектовПоСтатистике.ДобавитьОписаниеЗаполняемыхРеквизитов(ОписаниеРеквизитов,
		"БанковскийСчетОрганизацииПолучателя", Параметры);
...
Функция ПредставлениеОбъектаНаОсновномЯзыке() Экспорт
	...
	СинонимДляЗаписиВИнформационнуюБазу = НСтр(
		"ru = 'Отчет по комиссии между организациями'",
		КодОсновногоЯзыка);
...
Функция ТекстЗапросаТаблицаВыручкаИСебестоимостьПродаж(Запрос, ТекстыЗапроса, Регистры)
	...
	|	0 КАК СтоимостьУпр,
	|	0 КАК Количество,
	|	ЕСТЬNULL(Суммы.СуммаСНДСУпр, ВЫРАЗИТЬ(ДанныеДокумента.СуммаВознаграждения
	|		* &КоэффициентПересчетаВВалютуУпр
	|		КАК ЧИСЛО(31,2))) КАК СуммаВыручки,
	|
	|	ЕСТЬNULL(Суммы.СуммаБезНДСУпр, ВЫРАЗИТЬ((ДанныеДокумента.СуммаВознаграждения
	|			- ДанныеДокумента.СуммаНДСВознаграждения)
	|		* &КоэффициентПересчетаВВалютуУпр
