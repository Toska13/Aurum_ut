...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ОбщегоНазначения.ПодсистемаСуществует("СтандартныеПодсистемы.ВерсионированиеОбъектов") Тогда
		МодульВерсионированиеОбъектов = ОбщегоНазначенияИСПовтИсп.ОбщийМодуль("ВерсионированиеОбъектов");
...
Процедура АдресПодключенияСтрокойПриИзменении(Элемент)
	...
	Объект.АдресПодключения = ОбщегоНазначенияИСВызовСервера.ЗначенияПолейКонтактнойИнформации(
...
Функция ЗначенияРеквизитовШтрихкодаУпаковки(КодМаркировки)
	...
	Если ОбщегоНазначенияИСМП.ЭтоРасширеннаяВерсияГосИС() Тогда
		...
		Результат.Вставить(
			"ВидПродукции",
			ОбщегоНазначенияИС.ОписаниеНоменклатуры(Результат.Номенклатура)[Результат.Номенклатура].КлючВидовПродукции);
	Иначе
