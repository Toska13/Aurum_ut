...
Функция ТекстЗапросаТаблицаПрочиеАктивыПассивы(Запрос, ТекстыЗапроса, Регистры)
	...
	Запрос.УстановитьПараметр("НДС_НалоговыйАгент", Справочники.ВидыНалоговВзносов.ПолучитьСсылкуПредопределенногоЭлемента("НДС_НалоговыйАгент"));
	...
	|	&НДС_НалоговыйАгент КАК Аналитика,
	|	СУММА(ДанныеДокумента.СуммаНДС * &КоэффициентПересчетаВВалютуУпр) КАК Сумма
	|ИЗ
	|	Документ.НачислениеРеверсивногоНДС КАК ДанныеДокумента
	|	
	|	ВНУТРЕННЕЕ СОЕДИНЕНИЕ
