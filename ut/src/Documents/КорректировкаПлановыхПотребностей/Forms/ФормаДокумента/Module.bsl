...
Процедура УвеличениеПотребностейНоменклатураПриИзменении(Элемент)
	...
	ДобавитьВСтруктуруДействияПриИзмененииНоменклатуры(СтруктураДействий, "УвеличениеПотребностей");
...
Процедура УменьшениеПотребностейНоменклатураПриИзменении(Элемент)
	...
	ДобавитьВСтруктуруДействияПриИзмененииНоменклатуры(СтруктураДействий, "УменьшениеПотребностей");
...
Процедура ЗаполнитьСлужебныеРеквизиты(Корректировка = Неопределено)
	...
	Если Корректировка = Неопределено Тогда
		...
		ПакетнаяОбработкаТабличнойЧастиСервер.ОбработатьТЧ(ТаблицаДанных, СтруктураДействий, Неопределено);
	...
	Иначе
		...
		ПакетнаяОбработкаТабличнойЧастиСервер.ОбработатьСтрокуТЧ(ТекущаяСтрокаСтруктура, СтруктураДействий, Неопределено);
...
&НаКлиентеНаСервереБезКонтекста
Процедура ДобавитьВСтруктуруДействияПриИзмененииНоменклатуры(СтруктураДействий, ИмяТЧ)
...
Процедура ПолучитьСтрокиИзБуфераОбменаНаСервере(ИмяТЧ)
	...
	СтруктураДействий = Новый Структура;
	ДобавитьВСтруктуруДействияПриИзмененииКоличестваУпаковок(СтруктураДействий);
	ДобавитьВСтруктуруДействияПриИзмененииНоменклатуры(СтруктураДействий, ИмяТЧ);
