...
Процедура РасхожденияНоменклатураПриИзменении(Элемент)
	...
	СтруктураДействий.Вставить("НоменклатураПриИзмененииПереопределяемый",
								Новый Структура("ИмяФормы, ИмяТабличнойЧасти",ИмяФормы, "Расхождения"));
...
Процедура УстановитьУсловноеОформление()
	...
	НоменклатураСервер.УстановитьУсловноеОформлениеХарактеристикНоменклатуры(ЭтотОбъект, "РасхожденияХарактеристика","Объект.Расхождения.ХарактеристикиИспользуются");

	//

	НоменклатураСервер.УстановитьУсловноеОформлениеНазначенияНоменклатуры(ЭтотОбъект, "РасхожденияНазначение", "Объект.Расхождения.Номенклатура.ТипНоменклатуры",Истина);
	...
	ПолеЭлемента = Элемент.Поля.Элементы.Добавить();
	ПолеЭлемента.Поле = Новый ПолеКомпоновкиДанных(Элементы.РасхожденияНазначение.Имя);
...
Функция ПараметрыУказанияСерий()
	...
	МенеджерОбъекта = Документы.СписаниеРасхожденийПоступлениеПриобретение;
...
//	Отказ - Булево -
//	Копирование - Булево -
//	Родитель - Неопределено, СправочникСсылка -
//	Группа - Булево -
//
&НаКлиенте
