...
Процедура ОбработкаПроверкиЗаполнения(Отказ, ПроверяемыеРеквизиты)
	...
	Если Предопределенный Тогда
		...
		Отбор.Вставить("Статья", Ссылка);
				
		ТребуемыеВариантыРаспределения = СоответствиеСтатейВариантамРаспределения.Получить(Ссылка);
		Если ТребуемыеВариантыРаспределения <> Неопределено Тогда
			...
			Для каждого ПроверяемыйВариантРаспределения Из ПроверяемыеВариантыРаспределения Цикл
				Если ТребуемыеВариантыРаспределения.НайтиПоЗначению(ЭтотОбъект[ПроверяемыйВариантРаспределения.Значение]) = Неопределено Тогда
					КоличествоВариантов = ТребуемыеВариантыРаспределения.Количество();
					Если КоличествоВариантов = 1 Тогда
						ТекстСообщения = СтрШаблон(ШаблонСообщения, ПроверяемыйВариантРаспределения.Представление, ТребуемыеВариантыРаспределения[0]);
					Иначе
						Счетчик = 0;
						ТекстВариант = "";
						Пока Счетчик < КоличествоВариантов Цикл
							Если Счетчик <> 0 Тогда
								ТекстВариант = ТекстВариант + """ или """;
							КонецЕсли;
							ТекстВариант = ТекстВариант + ТребуемыеВариантыРаспределения[Счетчик];
							Счетчик = Счетчик + 1;
						КонецЦикла;
						ТекстСообщения = СтрШаблон(ШаблонСообщения, ПроверяемыйВариантРаспределения.Представление, ТекстВариант);
					КонецЕсли;
