...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	РассчитатьИтоговыеПоказателиСоглашенияСПоставщиком(ЭтотОбъект);
	...
	Если ЭтоКомиссия ИЛИ ЭтоПриемНаХранение Или ЭтоРасчетыПоНакладным Тогда
		...
		Элементы.ВариантОтсчетаКредит.СписокВыбора.Добавить(Перечисления.ВариантыОтсчетаДатыПлатежа.ОтДатыПоступления);
	...
	УстановитьДоступностьКалендаря(ЭтотОбъект);
