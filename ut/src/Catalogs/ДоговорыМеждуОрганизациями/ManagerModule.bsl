...
//	БанковскийСчетОрганизации - СправочникСсылка.БанковскиеСчетаОрганизаций, Неопределено - Реквизит документа
//		"Банковский счет организации". Неопределено, если реквизит документа отсутствует или не требует заполнения.
//	БанковскийСчетОрганизацииПолучателя - СправочникСсылка.БанковскиеСчетаОрганизаций, Неопределено - Реквизит документа
//		"Банковский счет получателя". Неопределено, если реквизит документа отсутствует или не требует заполнения.
//
Процедура ЗаполнитьБанковскиеСчетаПоДоговору(Договор, БанковскийСчетОрганизации, БанковскийСчетОрганизацииПолучателя) Экспорт
	...
	КонецЕсли;
	Если БанковскийСчетОрганизацииПолучателя <> Неопределено
		И ЗначениеЗаполнено(ДанныеДоговора.БанковскийСчетПолучателя) Тогда
...
Процедура ЗадатьОписаниеЗаполняемыхРеквизитовПоСтатистике(ОписаниеРеквизитов) Экспорт
	...
	Параметры = ЗаполнениеОбъектовПоСтатистике.ПараметрыЗаполняемыхРеквизитов();
	Параметры.РазрезыСбораСтатистики.ИспользоватьВсегда = "ОрганизацияПолучатель, ОплатаВВалюте";
	Параметры.ЗаполнятьПриУсловии.ПоляОбъектаЗаполнены = "ОрганизацияПолучатель";
	Параметры.ПараметрыСбораСтатистики.РазмерВыборки = 2;
	Параметры.ПараметрыСбораСтатистики.ПриОтсутствииДанныхПолучатьЗначениеБезУчетаАвтора = Истина;
	ЗаполнениеОбъектовПоСтатистике.ДобавитьОписаниеЗаполняемыхРеквизитов(ОписаниеРеквизитов,
		"БанковскийСчетПолучателя", Параметры);
...
Функция ПараметрыЗаполненияНалогообложенияНДС(Объект) Экспорт
	...
	ПараметрыЗаполнения.Дата		= РеквизитыСправочника.ДатаНачалаДействия;
	ПараметрыЗаполнения.Организация	= РеквизитыСправочника.Организация;
...
Функция ПараметрыЗаполненияВидаДеятельностиНДС(Объект) Экспорт
	...
	ПриобретениеТоваров = РеквизитыСправочника.ТипДоговора = Перечисления.ТипыДоговоровМеждуОрганизациями.КупляПродажа;
	
	ПараметрыЗаполнения = УчетНДСУПКлиентСервер.ПараметрыЗаполненияВидаДеятельностиНДС();
	ПараметрыЗаполнения.Дата					= РеквизитыСправочника.ДатаНачалаДействия;
	ПараметрыЗаполнения.Организация				= РеквизитыСправочника.ОрганизацияПолучатель;
	ПараметрыЗаполнения.НаправлениеДеятельности	= РеквизитыСправочника.НаправлениеДеятельности;
...
Функция ПараметрыВзаиморасчеты(ДанныеЗаполнения = Неопределено) Экспорт
	...
	Если ОбщегоНазначения.ЗначениеСсылочногоТипа(ДанныеЗаполнения) Тогда
		ДанныеЗаполненияСтруктура = ОбщегоНазначения.ЗначенияРеквизитовОбъекта(ДанныеЗаполнения, "ТипДоговора, Сумма, ПорядокРасчетов");
		ТипДоговора     = ДанныеЗаполненияСтруктура.ТипДоговора;
		Сумма           = ДанныеЗаполненияСтруктура.Сумма;
		ПорядокРасчетов = ДанныеЗаполненияСтруктура.ПорядокРасчетов;
	...
	ВлияющиеРеквизиты = "ТипДоговора,ПорядокРасчетов";
