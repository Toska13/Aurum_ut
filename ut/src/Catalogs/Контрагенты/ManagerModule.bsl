...
Процедура ПриДобавленииОбработчиковОбновления(Обработчики) Экспорт
	...
	Обработчик.Идентификатор = Новый УникальныйИдентификатор("6283c4c0-b59c-4f96-8d9e-35b0b1f46557");
...
Процедура ЗарегистрироватьДанныеКОбработкеДляПереходаНаНовуюВерсию(Параметры) Экспорт
	...
	Если ИспользуютсяДопЯзыки Тогда
		...
		|	Справочник.Контрагенты КАК Контрагенты
		|ГДЕ
		|	НЕ Контрагенты.Наименование = """"
		|	И Контрагенты.НаименованиеЯзык1 = """"
		|	
		|ОБЪЕДИНИТЬ 
		|
		|ВЫБРАТЬ
		...
		|ГДЕ
		|	НЕ Контрагенты.Наименование = """"
		|	И Контрагенты.НаименованиеЯзык2 = """"");
