...
Процедура НадписьНастройкаПодключенияПлатежнойСистемыОбработкаНавигационнойСсылки(Элемент, НавигационнаяСсылкаФорматированнойСтроки, СтандартнаяОбработка)
	...
	ОчиститьСообщения();
	ДоговорыЭквайрингаКлиентЛокализация.НадписьНастройкаПодключенияПлатежнойСистемыОбработкаНавигационнойСсылки(
...
Процедура ПриЧтенииСозданииНаСервере()
	...
	ПравоИзменения = ПравоДоступа("Изменение", Метаданные.Справочники.ДоговорыЭквайринга);
	...
	ДоговорыЭквайрингаЛокализация.ПриЧтенииСозданииНаСервере(ЭтотОбъект);
...
Функция РеквизитыФормы(Форма)
	...
	РеквизитыФормы.Вставить("ПравоИзменения", Форма.ПравоИзменения);
...
Процедура УправлениеЭлементамиФормы()
	...
	Элементы.ГруппаСпособОтраженияКомиссии.Видимость = ПравоИзменения;
...
Процедура СформироватьНадписьНастройкаПодключенияПлатежнойСистемы()
	...
	ДоговорыЭквайрингаЛокализация.УстановитьЗаголовокНастройкиПодключенияПлатежнойСистемы(ЭтотОбъект);
