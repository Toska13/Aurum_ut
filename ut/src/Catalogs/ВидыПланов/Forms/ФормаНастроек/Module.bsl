...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Параметры.Свойство("СтруктураНастроек") Тогда
		...
		Если Параметры.СтруктураНастроек.Отбор.Свойство("ОтборТипНоменклатуры") Тогда
			ЭлементОтбора = КомпоновкаДанныхКлиентСервер.ДобавитьОтбор(ОтборНоменклатуры.Настройки,
				"Номенклатура.ТипНоменклатуры",
				Параметры.СтруктураНастроек.Отбор.ОтборТипНоменклатуры,
