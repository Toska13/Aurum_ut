...
Процедура ОбработкаПроверкиЗаполнения(Отказ, ПроверяемыеРеквизиты)
	...
	Для Каждого Элемент Из СтруктураШаблонов Цикл
		...
		Если ЗначениеЗаполнено(Шаблон) Тогда
			...
			ЗаполнитьЗначенияСвойств(НаборыСвойств, ЭтотОбъект);
			
			ДеревоОперандов = Справочники.ВидыНоменклатуры.ПодготовитьДеревоОперандов(НаборыСвойств, Элемент.Ключ);
			
			ТипыОперандов = Новый Соответствие;
			Справочники.ВидыНоменклатуры.ПолучитьТипыОперандов(ДеревоОперандов, ТипыОперандов);
			
			ПараметрыСообщенийПроверкиФормулы.Вставить("ТипыОперандов", Новый ФиксированноеСоответствие(ТипыОперандов));
