...
Процедура ЗагрузитьВсеМестаПрименения(Команда)
	...
	Иначе
		...
		ЗагрузитьМестаПримененияПоОрганизации_ДлительнаяОперация();
...
Процедура ЗагрузитьВсеМестаХранения(Команда)
	...
	Иначе
		...
		ЗагрузитьМестаХраненияПоОрганизации_ДлительнаяОперация();
...
&НаКлиенте
Процедура ЗагрузитьМестаХраненияПоОрганизации_ДлительнаяОперация()
	...
	ПараметрыОбработкиДокументов.ДополнительныеПараметры.Вставить("ИдентификаторОрганизации", Объект.Идентификатор);
...
&НаКлиенте
Процедура ЗагрузитьМестаПримененияПоОрганизации_ДлительнаяОперация()
	
	ПараметрыОбработкиДокументов = ИнтеграцияСАТУРНСлужебныйКлиентСервер.ПараметрыОбработкиДокументов();
	ПараметрыОбработкиДокументов.Ссылка             = ПредопределенноеЗначение("Справочник.МестаПримененияСАТУРН.ПустаяСсылка");
	ПараметрыОбработкиДокументов.ДальнейшееДействие = ПредопределенноеЗначение("Перечисление.ДальнейшиеДействияПоВзаимодействиюСАТУРН.ЗагрузитеКлассификатор");
