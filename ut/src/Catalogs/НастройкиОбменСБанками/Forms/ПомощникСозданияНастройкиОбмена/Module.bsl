...
Процедура СертификатПодключенияПарольНачалоВыбора(Элемент, ДанныеВыбора, ВыборДобавлением, СтандартнаяОбработка)
	...
	ОтобразитьСекретныеДанные(Элемент, "СертификатПодключенияПароль");
...
Процедура ПарольСертификатаСмешанныйУННачалоВыбора(Элемент, ДанныеВыбора, ВыборДобавлением, СтандартнаяОбработка)
	...
	ОтобразитьСекретныеДанные(Элемент, "ПарольСертификата");
...
Процедура ПарольСмешанныйУННачалоВыбора(Элемент, ДанныеВыбора, ВыборДобавлением, СтандартнаяОбработка)
	...
	ОтобразитьСекретныеДанные(Элемент, "Пароль");
...
#КонецОбласти
	...
	Если УпрощенныйРежимНастройки
		...
		ИЛИ СпособыАутентификацииБанка.Количество() > 1) Тогда
	...
	Если ЗначениеЗаполнено(Банк) Тогда
		БанкНаименование = ОбщегоНазначения.ЗначениеРеквизитаОбъекта(Банк, "Наименование");
	КонецЕсли;
...
&НаКлиенте
Процедура ОтобразитьСекретныеДанные(Элемент, ИмяРеквизита)
...
Функция СменитьСтраницуНаУпрощеннуюНастройку(НоваяСтраница)
	...
	Если УпрощенныйРежимНастройки
		...
		И НоваяСтраница <> Элементы.СтраницаФинал Тогда
