...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ИнтеграцияС1СДокументооборотБазоваяФункциональность.ПриСозданииНаСервере(ЭтотОбъект, ПанельКомандПечати);
...
Процедура ОбработкаОповещения(ИмяСобытия, Параметр, Источник)
	...
	Если ИмяСобытия = "Запись_Номенклатура" Тогда
		...
		Если ЗначениеЗаполнено(Источник) Тогда
			ТаблицаФормыНоменклатура = Элементы[ПодборТоваровКлиентСервер.ИмяСпискаНоменклатурыПоВариантуПоиска(ЭтотОбъект)]; // ТаблицаФормы
...
Процедура Подключаемый_ВыполнитьКомандуИнтеграции(Команда)
	...
	ИнтеграцияС1СДокументооборотБазоваяФункциональностьКлиент.ВыполнитьПодключаемуюКомандуИнтеграции(Команда, ЭтотОбъект, СписокКоманды);
...
&НаКлиенте
Процедура ОтметитьДублямиВыделенныеРасширенныйПоиск(Команда)
	ПоискИЗаменаДублейНСИКлиент.ОтметитьДублямиВыделенные(Элементы.СписокРасширенныйПоискНоменклатура);
КонецПроцедуры

&НаКлиенте
Процедура ОтметитьДублямиВыделенныеСтандартныйПоиск(Команда)
	ПоискИЗаменаДублейНСИКлиент.ОтметитьДублямиВыделенные(Элементы.СписокСтандартныйПоискНоменклатура);
КонецПроцедуры
...
Процедура ОбработатьШтрихкоды(ДанныеШтрихкода)
	...
	ПараметрыОбработки.ПереноситьВДокументУточненныеТовары	= Ложь;
	...
	Иначе
		ШтрихкодированиеНоменклатурыКлиент.ОбработатьНеизвестныеШтрихкоды(ПараметрыОбработки, КэшированныеЗначения, ЭтотОбъект);
	КонецЕсли;
