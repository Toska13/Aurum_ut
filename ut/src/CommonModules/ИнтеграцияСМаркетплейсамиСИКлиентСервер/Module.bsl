...
Функция ПредставлениеЗаданияСинхронизацияССервисомИнтеграции(ВидМаркетплейса) Экспорт
	Возврат СтрШаблон(НСтр("ru = '%1. Синхронизация'"), МаркетплейсПоВиду(ВидМаркетплейса));
КонецФункции
...
Функция ПредставлениеЗаданияРасчетОстатковТоваров(ВидМаркетплейса) Экспорт
	Возврат СтрШаблон(НСтр("ru = '%1. Расчет остатков товаров'"), МаркетплейсПоВиду(ВидМаркетплейса));
КонецФункции
...
Функция ПредставлениеЗаданияВыгрузкаЦенНаМаркетплейсы(ВидМаркетплейса) Экспорт
	Возврат СтрШаблон(НСтр("ru = '%1. Выгрузка цен товаров'"), МаркетплейсПоВиду(ВидМаркетплейса));
КонецФункции
