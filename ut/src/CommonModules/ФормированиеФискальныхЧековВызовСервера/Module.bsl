...
// Проверяет данные на корректность перед фискальной операцией
// 
// Параметры:
...
Функция ПроверкаДанныхПередФискальнойОперацией(Знач Объект, ПараметрыПроверки) Экспорт
	Возврат ФормированиеФискальныхЧековСервер.ПроверкаДанныхПередФискальнойОперацией(Объект, ПараметрыПроверки);
КонецФункции
