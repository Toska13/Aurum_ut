...
Процедура ПриУдаленииКомплектующих(Форма, ИмяТЧ, Параметры) Экспорт
	...
	ПараметрыНабора = Параметры.Наборы[0];
	ПараметрОповещения = Новый Структура;
	ПараметрОповещения.Вставить("НоменклатураНабора",   ПараметрыНабора.НоменклатураНабора);
	ПараметрОповещения.Вставить("ХарактеристикаНабора", ПараметрыНабора.ХарактеристикаНабора);
	Если ПараметрыНабора.Свойство("ДокументРеализации") Тогда
		ПараметрОповещения.Вставить("ДокументРеализации", ПараметрыНабора.ДокументРеализации);
	КонецЕсли;
	Если ПараметрыНабора.Свойство("ЗаказКлиента") Тогда
		ПараметрОповещения.Вставить("ЗаказКлиента", ПараметрыНабора.ЗаказКлиента);
	КонецЕсли;
