...
Процедура ДобавитьВТекстЗапросаИдентификациюАкцизныхМарок(Запрос, ТекстЗапроса, ЗагрузкаАкцизныхМарок, КлючиЕГАИС, ДобавитьРазделитель = Истина) Экспорт
	...
	Если ЗагрузкаАкцизныхМарок Тогда
		...
		|	ВЫБОР
		|		КОГДА ОписаниеНоменклатурыИС.Номенклатура ЕСТЬ NULL ТОГДА ЛОЖЬ
		|		КОГДА ОписаниеНоменклатурыИС.КлючВидовПродукции.ВидПродукцииГИСМТ В (&ВидыПродукцииРазливногоПива) ТОГДА ИСТИНА
		|		ИНАЧЕ ЛОЖЬ КОНЕЦ 																					КАК ЭтоРазливноеПиво,
