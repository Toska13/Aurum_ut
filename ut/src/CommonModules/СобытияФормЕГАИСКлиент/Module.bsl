...
// 
// Параметры:
//  Элемент - ФормаКлиентскогоПриложения, ПолеВвода - Источник вызова
//  ДанныеСтроки - Структура - Данные строки:
//   * АлкогольнаяПродукция - СправочникСсылка.КлассификаторАлкогольнойПродукцииЕГАИС - текущая алкогольная продукция
...
Процедура ПриСозданииНоменклатуры (Элемент, ДанныеСтроки, СтандартнаяОбработка) Экспорт
	...
	ДанныеЗаполнения = ИнтеграцияЕГАИСВызовСервера.РеквизитыАлкогольнойПродукцииДляСозданияНоменклатуры(ДанныеСтроки.АлкогольнаяПродукция);
