...
Функция СтавкаНДСПоНоменклатуреИНалогообложениюПакетно(Номенклатура, НалогообложениеНДС, Дата, КэшированныеЗначения, УказаннаяСтавкаНДС = Неопределено) Экспорт
	...
	УчетНДСЛокализация.ЗаполнитьСтавкуНДСПоНоменклатуреИНалогообложениюПакетно(
		Номенклатура, НалогообложениеНДС, Дата, СтавкаНДС, КэшированныеЗначения, УказаннаяСтавкаНДС);
