...
Процедура ПриОпределенииПодписокНаСобытияБСП(Подписки) Экспорт
	...
	Подписки.Вставить("ПриНастройкеПроверкиМетодовВызываемыхКакПроизвольныйКод", Истина);
...
Процедура ПриНастройкеПроверкиМетодовВызываемыхКакПроизвольныйКод(Настройки) Экспорт
	...
	НовоеИсключение.ПолноеИмяОбъекта = "ОбщийМодуль.HTTP";
	НовоеИсключение.ИмяПроцедуры = "ВыполнитьHTTPЗапрос";
	НовоеИсключение.ФрагментСодержания = "ДанныеВызова = ОбщегоНазначения.ВыполнитьМетодКонфигурации(
		|			НовыйПараметрыОбновленияТокена.ИмяМетода,
		|			ПараметрыВызова,
		|			Истина)";
	
	Если ОбщегоНазначения.ПодсистемаСуществует("ИнтернетПоддержкаПользователей.Новости") Тогда
		МодульОбработкаНовостейСлужебный = ОбщегоНазначения.ОбщийМодуль("ОбработкаНовостейСлужебный");
		МодульОбработкаНовостейСлужебный.ПриНастройкеПроверкиМетодовВызываемыхКакПроизвольныйКод(Настройки);
	КонецЕсли;
	
	Если ОбщегоНазначения.ПодсистемаСуществует("ИнтернетПоддержкаПользователей.СистемаБыстрыхПлатежей.БазоваяФункциональностьСБП") Тогда
		МодульСистемаБыстрыхПлатежейСлужебный = ОбщегоНазначения.ОбщийМодуль("СистемаБыстрыхПлатежейСлужебный");
		МодульСистемаБыстрыхПлатежейСлужебный.ПриНастройкеПроверкиМетодовВызываемыхКакПроизвольныйКод(Настройки);
	КонецЕсли;
...
Процедура ПриЗагрузкеСтатусаОперацииb2b(
	...
	Если ИнтеграцияПодсистемБИППовтИсп.ПодпискиБСП().ПриЗагрузкеСтатусаОперацииb2b Тогда
		МодульИнтеграцияПодсистемБСП = ОбщегоНазначения.ОбщийМодуль("ИнтеграцияПодсистемБСП");
		МодульИнтеграцияПодсистемБСП.ПриЗагрузкеСтатусаОперацииb2b(
			ДокументОперации,
			НастройкаПодключения,
			РезультатОбработки,
			Обработан);
...
// См. ОнлайнЗаказыПереопределяемый.ПриЗаписиДанныхФискализацииЗаказа.
//
Процедура ПриЗаписиДанныхФискализацииЗаказа(ПараметрыФискализации) Экспорт
	
	Если ИнтеграцияПодсистемБИППовтИсп.ПодпискиБСП().ПриЗаписиДанныхФискализацииЗаказа Тогда
		МодульИнтеграцияПодсистемБСП = ОбщегоНазначения.ОбщийМодуль("ИнтеграцияПодсистемБСП");
		МодульИнтеграцияПодсистемБСП.ПриЗаписиДанныхФискализацииЗаказа(ПараметрыФискализации);
	КонецЕсли;
...
// См. НастройкиПлатежныхСистемПереопределяемый.ПриОпределенииДанныхКассовыхСсылок
Процедура ПриОпределенииДанныхКассовыхСсылокПлатежныеСистемы(ДанныеКассовыхСсылок, НастройкаПодключения) Экспорт
	
	Если ИнтеграцияПодсистемБИППовтИсп.ПодпискиБСП().ПриОпределенииДанныхКассовыхСсылокПлатежныеСистемы Тогда
		МодульИнтеграцияПодсистемБСП = ОбщегоНазначения.ОбщийМодуль("ИнтеграцияПодсистемБСП");
		МодульИнтеграцияПодсистемБСП.ПриОпределенииДанныхКассовыхСсылокПлатежныеСистемы(ДанныеКассовыхСсылок, НастройкаПодключения);
	КонецЕсли;
...
// См. ПлатежныеСистемыПереопределяемый.ПриЗагрузкеСтатусаОперации
//
Процедура ПриЗагрузкеСтатусаОперацииПлатежныхСистем(
		ДокументОперации,
		НастройкаПодключения,
		ПлатежнаяСистема,
		РезультатОбработки,
	...
	Если ИнтеграцияПодсистемБИППовтИсп.ПодпискиБСП().ПриЗагрузкеСтатусаОперацииПлатежныхСистем Тогда
		МодульИнтеграцияПодсистемБСП = ОбщегоНазначения.ОбщийМодуль("ИнтеграцияПодсистемБСП");
		МодульИнтеграцияПодсистемБСП.ПриЗагрузкеСтатусаОперацииПлатежныхСистем(
			ДокументОперации,
			НастройкаПодключения,
			РезультатОбработки,
			Обработан);
...
// См. ЯндексПэйПереопределяемый.ПриФормированииЗаказаНаОплату
//
Процедура ПриФормированииЗаказаНаОплатуЯндексПэй(
		ДокументОперации,
		ЗаказНаОплату,
		НастройкаПодключения,
		ДополнительныеПараметры) Экспорт
	
	Если ИнтеграцияПодсистемБИППовтИсп.ПодпискиБСП().ПриФормированииЗаказаНаОплатуЯндексПэй Тогда
		МодульИнтеграцияПодсистемБСП = ОбщегоНазначения.ОбщийМодуль("ИнтеграцияПодсистемБСП");
		МодульИнтеграцияПодсистемБСП.ПриФормированииЗаказаНаОплатуЯндексПэй(
			ДокументОперации,
			ЗаказНаОплату,
			НастройкаПодключения,
			ДополнительныеПараметры);
...
// См. ЯндексПэйПереопределяемый.ПриФормированииЗаказаНаВозврат
//
Процедура ПриФормированииЗаказаНаВозвратЯндексПэй(
		ДокументОперации,
		ДокументОплаты,
		ЗаказНаВозврат,
		НастройкаПодключения,
	...
	Если ИнтеграцияПодсистемБИППовтИсп.ПодпискиБСП().ПриФормированииЗаказаНаВозвратЯндексПэй Тогда
		МодульИнтеграцияПодсистемБСП = ОбщегоНазначения.ОбщийМодуль("ИнтеграцияПодсистемБСП");
		МодульИнтеграцияПодсистемБСП.ПриФормированииЗаказаНаВозвратЯндексПэй(
			ДокументОперации,
			ДокументОплаты,
			ЗаказНаВозврат,
			НастройкаПодключения,
...
Функция СобытияБИП() Экспорт
	...
	События.Вставить("ПриЗаписиДанныхФискализацииЗаказа", Ложь);
	...
	События.Вставить("ПриОпределенииДанныхКассовыхСсылокПлатежныеСистемы", Ложь);
	...
	События.Вставить("ПриЗагрузкеСтатусаОперацииПлатежныхСистем", Ложь);
	
	// Платежная система Озон Пэй
	События.Вставить("ПриФормированииЗаказаНаВозвратОзонПэй", Ложь);

	// Платежная система Яндекс Пэй
	События.Вставить("ПриФормированииЗаказаНаОплатуЯндексПэй", Ложь);
	События.Вставить("ПриФормированииЗаказаНаВозвратЯндексПэй", Ложь);
