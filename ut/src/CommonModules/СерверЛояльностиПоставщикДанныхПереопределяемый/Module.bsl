...
// Параметры:
//  ДисконтнаяКарта	 - ОпределяемыйТип.КартаЛояльностиСерверЛояльности	 - карта лояльности, по которой будут заполнены данные о бонусах
//  СтруктураОтвета	 - см. СерверЛояльностиПоставщикДанных.ПолучитьПараметрыОтветаБонусыКлиента
//
...
//  СтруктураОтвета	 - см. СерверЛояльностиПоставщикДанных.ПолучитьПараметрыОтветаКартаКлиента.СтруктураОтвета
...
//   * ПолучатьСкидкиДокументаОснованияССервера - Булево
//
...
//  СтруктураОтвета	 - Структура - содержит данные о балансе сертификата,
//  								см. СерверЛояльностиПоставщикДанных.ПолучитьПараметрыОтветаОстатки
//
...
//  СтруктураОтвета	 - см. СерверЛояльностиПоставщикДанных.ПолучитьПараметрыОтветаСписокКартЛояльности
//
...
// Параметры:
//  ДисконтнаяКарта	 - ОпределяемыйТип.КартаЛояльностиСерверЛояльности	 - карта лояльности, по которой будут заполнены данные о бонусах
//  СтруктураОтвета	 - см. СерверЛояльностиПоставщикДанных.ПолучитьПараметрыОтветаОборотыПродаж
//
...
//
// Параметры:
//  МассивСертификаторв - Массив из ОпределяемыйТип.ПодарочныйСертификатСерверЛояльности - массив ссылок на подарочные сертификаты.
...
//
Процедура ВыделитьСертификатыСКонтролемОрганизации(МассивСертификаторв, Результат) Экспорт
