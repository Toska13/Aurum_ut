...
Процедура ЗаполнитьСоответствиеПолейДокументовОснованийИИсходящейТранспортнойОперации(СоответствиеПолей) Экспорт
	...
	СоответствиеПолей.Вставить("ОтгрузкаТоваровКлиенту", Новый Соответствие);
	СоответствиеПолей["ОтгрузкаТоваровКлиенту"].Вставить("ГрузоотправительХозяйствующийСубъект", "Организация");
	СоответствиеПолей["ОтгрузкаТоваровКлиенту"].Вставить("ГрузоотправительПредприятие", "Склад");
	СоответствиеПолей["ОтгрузкаТоваровКлиенту"].Вставить("ГрузополучательХозяйствующийСубъект", "Контрагент");
	СоответствиеПолей["ОтгрузкаТоваровКлиенту"].Вставить("ГрузополучательПредприятие", "Партнер");
