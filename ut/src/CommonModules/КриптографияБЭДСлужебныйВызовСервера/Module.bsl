...
// Параметры:
//  СвойстваПодписи - Структура - Свойства подписи, полученные в сервисе мобильной подписи с ключами:
...
//
Функция НайтиСоздатьСертификатПодписантаИзСвойствПодписи(Знач СвойстваПодписи,
	Знач Подписант,
	Знач ВидМобильнойПодписи) Экспорт
...
Функция ЗарегистрированныеВЭДОСертификаты(ПараметрыПодписанта, ВидМобильнойПодписи) Экспорт
	...
	Возврат ИнтеграцияБСПБЭД.ЗарегистрированныеВЭДОСертификаты(ПараметрыПодписанта, ВидМобильнойПодписи);
