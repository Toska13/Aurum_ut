...
Процедура ПриОпределенииНастроекПечати(Настройки) Экспорт
	...
	УправлениеПечатьюУТСервер.ПриОпределенииНастроекПечати(Настройки);
...
Процедура ПриОпределенииКлючевыхРеквизитовОсновныхПечатныхФорм(Ссылка, КлючевыеРеквизиты) Экспорт
	...
	УправлениеПечатьюУТСервер.ПриОпределенииКлючевыхРеквизитовОсновныхПечатныхФорм(Ссылка, КлючевыеРеквизиты);
...
Процедура ПриЗаполненииСпискаОбщихПолей(ТипОбъектаПечати, ТаблицаОбщихПолей) Экспорт
	...
	Если Не ПолучитьФункциональнуюОпцию("ИспользоватьНесколькоОрганизаций") Тогда
		...
		Если ОбщегоНазначения.ЕстьРеквизитОбъекта("Организация", Метаданные.НайтиПоТипу(ТипОбъектаПечати)) Тогда
			
			НоваяСтрока = ТаблицаОбщихПолей.Добавить();
			НоваяСтрока.Идентификатор = "Организация";
			НоваяСтрока.Представление = НСтр("ru = 'Организация'");
			НоваяСтрока.Значение = ЗначениеНастроекПовтИсп.ПолучитьОрганизациюПоУмолчанию();
