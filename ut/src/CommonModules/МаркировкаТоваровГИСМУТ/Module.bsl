...
Процедура ЗаполнитьМаркировкуТоваровПоВозвратуТоваровОтКлиента(ДанныеЗаполнения, ДокументОбъект)
	...
	|	ПО ВозвратТоваровОтКлиентаТовары.Номенклатура = ОписаниеНоменклатурыИС.Номенклатура
...
Процедура ЗаполнитьМаркировкуТоваровПоУведомлениюОбИмпортеМаркированныхТоваровГИСМ(ДанныеЗаполнения, ДокументОбъект)
	...
	|	ВНУТРЕННЕЕ СОЕДИНЕНИЕ РегистрСведений.ОписаниеНоменклатурыИС КАК ОписаниеНоменклатурыИС
	|	ПО УведомлениеОбИмпортеТовары.Номенклатура = ОписаниеНоменклатурыИС.Номенклатура
	|	И ОписаниеНоменклатурыИС.КлючВидовПродукции.ВидПродукцииГИСМТ В (&ВидыПродукцииМЕХ)
	|ГДЕ
