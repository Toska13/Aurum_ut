...
// интернет прокси или порт подключения могут быть пустыми
			...
			Иначе
				...
				КлючИЗначениеЗаполнены = ОбщегоНазначенияКлиентСервер.ЕстьРеквизитИлиСвойствоОбъекта(ПараметрыВыполненияЗапроса, Ключ)
...
//		*Variant - Структура
//		*Package - Структура
//		*DisplayNameVariantForPrinting - Структура
//
Функция СтруктураПараметровПолученияОстатков() Экспорт
	...
	РезультатВыполнения.Вставить("DisplayNameVariantForPrinting");
...
Функция СтруктураПараметровНайтиКартуКлиента() Экспорт
	...
	РезультатВыполнения.Вставить("ClientID");
...
Функция ПараметрыМетодовБонуснойПодсистемы() Экспорт
	...
	РезультатВыполнения.Вставить("Replacement");
...
//		*BonusesGUID - Строка
//		*GetPossibleBonusesToAccrual - Булево
//		*GetDiscountsFromParentDocument - Булево
//		*CheckToReturn - Строка - УИД чека-основания для возврата
//
Функция СтруктураПараметровРасчетаСкидок() Экспорт
	...
	СтруктураПараметров.Вставить("BonusesGUID");
	СтруктураПараметров.Вставить("GetPossibleBonusesToAccrual", Ложь);
	СтруктураПараметров.Вставить("GetDiscountsFromParentDocument");
	СтруктураПараметров.Вставить("CheckToReturn");
...
Функция СтруктураТоваровДляРасчетаСкидок() Экспорт
	...
	СтруктураСтроки.Вставить("Organization");
	СтруктураСтроки.Вставить("CheckToReturn");
...
//
Функция ПолучитьПараметрыСсылки(Ссылка) Экспорт
...
//
// Возвращаемое значение:
//  Структура - структура параметров запроса сотрудников:
//		*Store - Структура - структура ссылки магазина.
//
...
//  ЗначенияПараметровЗапроса - Структура - Структура для заполнения параметров запроса к серверу см. ПараметрыЗапросаКСерверу()
//  ЗначенияПараметровМетода - Структура - Структура для заполнения параметров метода запроса к серверу см. ПараметрыМетодовБонуснойПодсистемы()
//  ИмяРесурса - Строка - Наименование метода сервера лояльности.
//
// Возвращаемое значение:
//  см. ПараметрыЗапросаКСерверу
//
Функция ПараметрыЗапросаРазблокироватьБонусыКлиента(ЗначенияПараметровЗапроса, ЗначенияПараметровМетода, ИмяРесурса = "unlockclientbonuses") Экспорт
	
	ПараметрыЗапроса = ПараметрыЗапросаКСерверу();
	ПараметрыЗапроса.ТипЗапроса = "POST";
	ПараметрыЗапроса.Ресурс = ИмяРесурса;
...
//  см. ПараметрыЗапросаКСерверу
//
Функция ПараметрыЗапросаСписатьБонусыКлиента(ЗначенияПараметровЗапроса, ЗначенияПараметровМетода, ИмяРесурса = "writeoffclientbonuses") Экспорт
...
//  ЗначенияПараметровЗапроса - Структура - Структура для заполнения параметров запроса к серверу см. ПараметрыЗапросаКСерверу()
//  ЗначенияПараметровМетода - Структура - Структура для заполнения параметров метода запроса к серверу см. ПараметрыМетодовБонуснойПодсистемы()
//  ТипЗапроса - Строка - Тип запроса GET или POST. По-умолчанию тип запроса "GET".
//
// Возвращаемое значение:
//  см. ПараметрыЗапросаКСерверу
//
Функция ПараметрыЗапросаПолучитьДанныеПодарочногоСертификата(ЗначенияПараметровЗапроса, ЗначенияПараметровМетода, ТипЗапроса = "GET") Экспорт
	
	ПараметрыЗапроса = ПараметрыЗапросаКСерверу();
	ПараметрыЗапроса.ТипЗапроса = ТипЗапроса;
	ПараметрыЗапроса.Ресурс = "getgiftcardinfo";
	
	СерверЛояльностиПолучательДанныхКлиентСерверПереопределяемый.ЗаполнитьПараметрыСервераЛояльности(ПараметрыЗапроса, ЗначенияПараметровЗапроса);
	
	ПараметрыМетода = ПараметрыПодарочногоСертификата();
	...
	Если ТипЗапроса = "GET" Тогда
		ПараметрыЗапроса = ПараметрыЗапросаПолучитьДанныеПодарочногоСертификатаGET(ПараметрыМетода, ПараметрыЗапроса);
	Иначе
		ПараметрыЗапроса = ПараметрыЗапросаПолучитьДанныеПодарочногоСертификатаPOST(ПараметрыМетода, ПараметрыЗапроса);
	КонецЕсли;
...
//  см. ПараметрыЗапросаКСерверу
//
Функция ПараметрыЗапросаРазблокироватьПодарочныйСертификат(ЗначенияПараметровЗапроса, ЗначенияПараметровМетода, ИмяРесурса = "unlockgiftcard") Экспорт
...
//  см. ПараметрыЗапросаКСерверу
//
Функция ПараметрыЗапросаРазблокироватьПромокод(ЗначенияПараметровЗапроса, ЗначенияПараметровМетода, ИмяРесурса = "unlockpromocode") Экспорт
...
//  см. ПараметрыЗапросаКСерверу
//
Функция ПараметрыЗапросаСписатьПодарочныйСертификат(ЗначенияПараметровЗапроса, ЗначенияПараметровМетода, ИмяРесурса = "writeoffgiftcard") Экспорт
...
// Параметры:
//  ЗначенияПараметровЗапроса	 - Структура - Структура для заполнения параметров запроса к серверу см. ПараметрыЗапросаКСерверу()
//  ЗначенияПараметровМетода	 - Структура - Структура для заполнения параметров метода запроса к серверу см. СтруктураПараметровЗапросаЦены()
// 
// Возвращаемое значение:
//  см. ПараметрыЗапросаКСерверу
//
...
//  см. ПараметрыЗапросаКСерверу
//
Функция ПараметрыЗапросаПолучитьТаблицуСкидокЗависящихОтВидаОплаты(ЗначенияПараметровЗапроса, ЗначенияПараметровМетода) Экспорт
...
//  см. ПараметрыЗапросаКСерверу
//
Функция ПараметрыЗапросаОбъединитьБонусныеКарты(ЗначенияПараметровЗапроса, ЗначенияПараметровМетода) Экспорт
	
	ПараметрыЗапроса = ПараметрыЗапросаКСерверу();
	ПараметрыЗапроса.ТипЗапроса = "POST";
	ПараметрыЗапроса.Ресурс = "unitedbonuscards";
	
	СерверЛояльностиПолучательДанныхКлиентСерверПереопределяемый.ЗаполнитьПараметрыСервераЛояльности(ПараметрыЗапроса, ЗначенияПараметровЗапроса);
	
	ПараметрыМетода = СтруктураПараметровОбъединенияКарт();
	СерверЛояльностиПолучательДанныхКлиентСерверПереопределяемый.ЗаполнитьПараметрыЗапросаОбъединитьДисконтныеКарты(ПараметрыМетода, ЗначенияПараметровМетода);
	
	#Если ВебКлиент Тогда
		СериализованнаяСтруктураПараметров = СерверЛояльностиПолучательДанныхВызовСервера.СериализоватьСтруктуруПараметров(ПараметрыМетода);
	#Иначе
		СтруктураОтветаJSON = Новый ЗаписьJSON;
		СтруктураОтветаJSON.УстановитьСтроку();
		ЗаписатьJSON(СтруктураОтветаJSON, ПараметрыМетода);
		СериализованнаяСтруктураПараметров = СтруктураОтветаJSON.Закрыть();
	#КонецЕсли
...
// Возвращает структуру запроса НачислитьБонусыКлиента для сервера лояльности
//
// Параметры:
//  ЗначенияПараметровЗапроса - Структура - Структура для заполнения параметров запроса к серверу см. ПараметрыЗапросаКСерверу()
//  ЗначенияПараметровМетода - Структура - Структура для заполнения параметров метода запроса к серверу см. ПараметрыМетодовБонуснойПодсистемы()
...
//  см. ПараметрыЗапросаКСерверу
//
Функция ПараметрыЗапросаНачислитьБонусыКлиента(ЗначенияПараметровЗапроса, ЗначенияПараметровМетода) Экспорт
	
	ПараметрыЗапроса = ПараметрыЗапросаКСерверу();
	ПараметрыЗапроса.ТипЗапроса = "POST";
	ПараметрыЗапроса.Ресурс = "accrueclientbonuses";
	
	СерверЛояльностиПолучательДанныхКлиентСерверПереопределяемый.ЗаполнитьПараметрыСервераЛояльности(ПараметрыЗапроса, ЗначенияПараметровЗапроса);
	
	ПараметрыМетода = ПараметрыМетодовБонуснойПодсистемы();
	СерверЛояльностиПолучательДанныхКлиентСерверПереопределяемый.ЗаполнитьПараметрыЗапросаНачислитьБонусыКлиента(ПараметрыМетода, ЗначенияПараметровМетода);
	ПараметрыЗапроса.ПараметрыМетода = ПараметрыМетода;
...
// Возвращает структуру запроса НачислитьПодарочныйСертификат для сервера лояльности
//
// Параметры:
//  ЗначенияПараметровЗапроса - Структура - Структура для заполнения параметров запроса к серверу см. ПараметрыЗапросаКСерверу()
//  ЗначенияПараметровМетода - Структура - Структура для заполнения параметров метода запроса к серверу см. ПараметрыМетодовБонуснойПодсистемы()
...
//  см. ПараметрыЗапросаКСерверу
//
Функция ПараметрыЗапросаНачислитьПодарочныйСертификат(ЗначенияПараметровЗапроса, ЗначенияПараметровМетода) Экспорт
	
	ПараметрыЗапроса = ПараметрыЗапросаКСерверу();
	ПараметрыЗапроса.ТипЗапроса = "POST";
	ПараметрыЗапроса.Ресурс = "accruegiftcard";
	
	СерверЛояльностиПолучательДанныхКлиентСерверПереопределяемый.ЗаполнитьПараметрыСервераЛояльности(ПараметрыЗапроса, ЗначенияПараметровЗапроса);
	
	ПараметрыМетода = ПараметрыПодарочногоСертификата();
	ПараметрыМетода.Вставить("GiftCardAccrueOffAmount");
	СерверЛояльностиПолучательДанныхКлиентСерверПереопределяемый.ЗаполнитьПараметрыЗапросаНачислитьПодарочныйСертификат(ПараметрыМетода, ЗначенияПараметровМетода);
	ПараметрыЗапроса.ПараметрыМетода = ПараметрыМетода;
...
//
Функция ПараметрыМетодаЗаполненияВидовКарт() Экспорт
...
//		*DiscountsAllowed - Булево - Допускается применение ручных скидок.
//
Функция ПараметрыМетодаЗаполненияУправляемыхСкидок() Экспорт
	...
	РезультатВыполнения.Вставить("DiscountsAllowed");
	
	Возврат РезультатВыполнения;

КонецФункции

// Возвращает структуру обязательных параметров для объединения дисконтных карт.
//
// Возвращаемое значение:
//  Структура:
//		*BonusCards - Массив
//		*BonusProgramm - Строка
//
Функция СтруктураПараметровОбъединенияКарт() Экспорт
	
	СтруктураПараметров = Новый Структура;
	СтруктураПараметров.Вставить("BonusCards");
	СтруктураПараметров.Вставить("BonusCardGUID");
	СтруктураПараметров.Вставить("BonusCardNumber");
	СтруктураПараметров.Вставить("BonusProgramm");
	
	Возврат СтруктураПараметров;
	
КонецФункции

// Возвращает структуру бонусных карт для для объединения дисконтных карт.
//
// Возвращаемое значение:
//  Структура:
//		*CardGUID - Строка
...
//		*BonusesCount - Число
//
Функция СтруктураСтрокиБонуснойКарты() Экспорт
	
	СтруктураСтроки = Новый Структура;
	СтруктураСтроки.Вставить("CardGUID");
	СтруктураСтроки.Вставить("CardNumber");
	СтруктураСтроки.Вставить("BonusesCount");
	
	Возврат СтруктураСтроки;
	
КонецФункции

// Возвращает структуру обязательных параметров для запроса к подарочным сертификатам
//
// Возвращаемое значение:
//  Структура:
//		*GiftCardNumber - Строка - Номер подарочного сертификата
//		*GiftCardUID - Строка - Уникальный идентификатор
//		*Organization - Строка - Уникальный идентификатор
//		*Goods - Массив - Список товаров см.СтруктураТоваровДляПодарочногоСертификата()
//
Функция ПараметрыПодарочногоСертификата() Экспорт

	СтруктураПараметров = Новый Структура();
	СтруктураПараметров.Вставить("GiftCardNumber");
	СтруктураПараметров.Вставить("GiftCardUID");
	СтруктураПараметров.Вставить("Organization");
	СтруктураПараметров.Вставить("Goods");
...
// Возвращаемое значение:
//  Структура:
//		*Item - Структура - Номенклатура строки товаров см. ПолучитьСтруктуруСсылки
//		*Variant - Структура - Характеристика строки товаров см. ПолучитьСтруктуруСсылки
//		*Amount - Число - Сумма с учетом скидки
//
Функция СтруктураТоваровДляПодарочногоСертификата() Экспорт
...
Функция ПараметрыЗапросаПолучитьДанныеПодарочногоСертификатаGET(ПараметрыМетода, ПараметрыЗапроса)
...
Функция ПараметрыЗапросаПолучитьДанныеПодарочногоСертификатаPOST(ПараметрыМетода, ПараметрыЗапроса)
