...
Функция ПредметыРасчетовПоДокументу(ДокументСсылка, ЧекКоррекцииИсправленииОшибки = Ложь) Экспорт
	...
	Запрос.Текст = "
	|" + УчетПодакцизныхТоваров.ТекстЗапросаВтПодакцизныеТовары("ВыкупТоваровХранителемТаблицаТоваров")
	...
	|	ПО ВыкупТоваровХранителемТаблицаТоваров.Номенклатура = ВтПодакцизныеТовары.Номенклатура
	|
	|УПОРЯДОЧИТЬ ПО
	|	ВыкупТоваровХранителемТаблицаТоваров.НомерСтроки
	|";
