...
Процедура ПриОпределенииМетодовРазрешенныхДляВызоваКакПроизвольныйКод(Методы) Экспорт
	...
	Методы.Вставить("ОчисткаИсторииОперацийСОборудованием", Истина);
	Методы.Вставить("ОчисткаИсторииОперацийПроверкиКМ", Истина);
	Методы.Вставить("ОчисткаИсторииОперацийОчередиЧеков", Истина);
	Методы.Вставить("ОчисткаИсторииФискальныхОпераций", Истина);
	Методы.Вставить("ОчисткаИсторииПлатежныхОпераций", Истина);
	Методы.Вставить("ЗаписатьЛогОперацииНаСервере", Истина);
...
Процедура ЗаписатьЛогОперацииНаСервереВФоне(Записи) Экспорт
