...
Процедура ЗаполнитьПараметрыСканированияОтгрузкаТоваровСХранения(ПараметрыСканирования, Контекст, ВидПродукции)
	...
	Если ИсточникДанных.ХозяйственнаяОперация = ПредопределенноеЗначение("Перечисление.ХозяйственныеОперации.ОтгрузкаПринятыхСПравомПродажиТоваровСХранения") Тогда
		Реквизиты.Вставить("Владелец", ИсточникДанных.Контрагент);
	КонецЕсли;
...
Процедура ЗаполнитьПараметрыСканированияМобильноеРабочееМестоКладовщика(ПараметрыСканирования, Контекст, ВидПродукции)
	...
	Если ШтрихкодированиеОбщегоНазначенияЕГАИСКлиентСервер.ВключитьПоддержкуАлкогольнойПродукции(ПараметрыСканирования, ВидПродукции) Тогда
		...
		ШтрихкодированиеОбщегоНазначенияЕГАИСКлиентСервер.ЗаполнитьБазовыеПараметрыСканирования(
			ПараметрыСканирования, Контекст);
...
Процедура ЗаполнитьПараметрыСканированияПриобретениеТоваровУслуг(ПараметрыСканирования, Контекст, ВидПродукции)
	...
	Реквизиты = Новый Структура("ДатаДокумента, Владелец", ИсточникДанных.Дата, ИсточникДанных.Контрагент);
	ЗаполнитьЗначенияСвойств(ПараметрыСканирования, Реквизиты);
...
Процедура ЗаполнитьПараметрыСканированияПоступлениеТоваровОтХранителя(ПараметрыСканирования, Контекст, ВидПродукции)
	...
	Если ИсточникДанных.ХозяйственнаяОперация <> ПредопределенноеЗначение("Перечисление.ХозяйственныеОперации.ВозвратОтХранителя") Тогда
		Реквизиты.Вставить("Владелец", ИсточникДанных.Контрагент);
	КонецЕсли;
