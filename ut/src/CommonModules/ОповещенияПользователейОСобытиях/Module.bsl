...
Процедура ПриЗаписиИсточникаОповещенийПользователей(Источник, Отказ) Экспорт
	...
	Для каждого РеквизитИсточник Из ВидыОповещенийПоРеквизитамИсточника Цикл
		...
		Исключение
			ЗаписьЖурналаРегистрации(НСтр("ru = 'Оповещения пользователей.Формирование оповещений'", ОбщегоНазначения.КодОсновногоЯзыка()),
...
Процедура ОповещениеПользователейПоНеоперативнымВидамОповещений() Экспорт
	...
	Исключение
		...
		ЗаписьЖурналаРегистрации(НСтр("ru = 'Оповещения пользователей.Выполнение заданий'", ОбщегоНазначения.КодОсновногоЯзыка()),
			УровеньЖурналаРегистрации.Ошибка,,,
			ОписаниеОшибки);
	КонецПопытки;
...
Функция ИнициализироватьКомпоновщикНастроек(СхемаИНастройкиДляИнициализации, Настройки = Неопределено) Экспорт
	...
	Исключение
		ЗаписьЖурналаРегистрации(НСтр("ru = 'Оповещения пользователей.Загрузка СКД'", ОбщегоНазначения.КодОсновногоЯзыка()),
			УровеньЖурналаРегистрации.Ошибка,,,
			ОбработкаОшибок.ПодробноеПредставлениеОшибки(ИнформацияОбОшибке()));
	КонецПопытки;
...
Процедура УстановитьРежимОтображенияСообщений(Обсуждение, НеБеспокоить, РежимНаблюдения = Неопределено, Пользователь = Неопределено) Экспорт
	...
	Попытка
		...
		КонецЕсли;
	Исключение
		ЗаписьЖурналаРегистрации(НСтр("ru = 'Оповещения пользователей.Система взаимодействия'", ОбщегоНазначения.КодОсновногоЯзыка()),
			УровеньЖурналаРегистрации.Ошибка,,,
			ОбработкаОшибок.ПодробноеПредставлениеОшибки(ИнформацияОбОшибке()));
	КонецПопытки;
	УстановитьПривилегированныйРежим(Ложь);
...
Функция ИсточникиОповещенийИсключения() Экспорт
	...
	Исключения.Добавить(Метаданные.Справочники.КлючиДоступа.ПолноеИмя());
	Исключения.Добавить(Метаданные.Справочники.НаборыГруппДоступа.ПолноеИмя());
	
	Исключения.Добавить(Метаданные.РегистрыСведений.ГруппыЗначенийДоступа.ПолноеИмя());
	Исключения.Добавить(Метаданные.РегистрыСведений.ЗависимостиПравДоступа.ПолноеИмя());
	Исключения.Добавить(Метаданные.РегистрыСведений.ЗначенияГруппДоступа.ПолноеИмя());
	Исключения.Добавить(Метаданные.РегистрыСведений.ЗначенияГруппДоступаПоУмолчанию.ПолноеИмя());
	Исключения.Добавить(Метаданные.РегистрыСведений.ИдентификаторыОбъектовВерсийРасширений.ПолноеИмя());
	Исключения.Добавить(Метаданные.РегистрыСведений.ИерархияГруппПользователей.ПолноеИмя());
	Исключения.Добавить(Метаданные.РегистрыСведений.ИспользуемыеВидыДоступа.ПолноеИмя());
	Исключения.Добавить(Метаданные.РегистрыСведений.ИспользуемыеВидыДоступаПоТаблицам.ПолноеИмя());
	Исключения.Добавить(Метаданные.РегистрыСведений.КлючиДоступаВнешнихПользователей.ПолноеИмя());
	Исключения.Добавить(Метаданные.РегистрыСведений.КлючиДоступаГруппДоступа.ПолноеИмя());
	Исключения.Добавить(Метаданные.РегистрыСведений.КлючиДоступаКОбъектам.ПолноеИмя());
	Исключения.Добавить(Метаданные.РегистрыСведений.КлючиДоступаКРегистрам.ПолноеИмя());
	Исключения.Добавить(Метаданные.РегистрыСведений.КлючиДоступаНаборовГруппДоступа.ПолноеИмя());
	Исключения.Добавить(Метаданные.РегистрыСведений.КлючиДоступаПользователей.ПолноеИмя());
	Исключения.Добавить(Метаданные.РегистрыСведений.НаборыЗначенийДоступа.ПолноеИмя());
	...
	Исключения.Добавить(Метаданные.РегистрыСведений.ОтправленныеСерверныеОповещения.ПолноеИмя());
	Исключения.Добавить(Метаданные.РегистрыСведений.ПараметрыОграниченияДоступа.ПолноеИмя());
	...
	Исключения.Добавить(Метаданные.РегистрыСведений.ПредопределенныеВариантыОтчетовВерсийРасширений.ПолноеИмя());
	Исключения.Добавить(Метаданные.РегистрыСведений.СведенияОПользователях.ПолноеИмя());
	Исключения.Добавить(Метаданные.РегистрыСведений.СоставыГруппПользователей.ПолноеИмя());
	Исключения.Добавить(Метаданные.РегистрыСведений.ТаблицыГруппДоступа.ПолноеИмя());
...
Процедура ЗаполнитьВидыОповещенийПользователей(Перезаполнить=Ложь) Экспорт
	...
	Для каждого ОписаниеВидаОповещения Из ОписаниеВидовОповещений Цикл
		...
		Исключение
			...
			ИнформацияОбОшибке = ИнформацияОбОшибке();
			ОписаниеОшибки = ОбработкаОшибок.ПодробноеПредставлениеОшибки(ИнформацияОбОшибке);
			ЗаписьЖурналаРегистрации(НСтр("ru = 'Оповещения пользователей.Заполнение видов оповещений'", ОбщегоНазначения.КодОсновногоЯзыка()),
				УровеньЖурналаРегистрации.Ошибка,,,
				ОписаниеОшибки);
		КонецПопытки;
	КонецЦикла;
...
Процедура ОбработкаСообщенияСистемыВзаимодействия(Сообщение, ДополнительныеПараметры) Экспорт
	...
	Исключение
		ИнформацияОбОшибке = ИнформацияОбОшибке();
		ОписаниеОшибки = ОбработкаОшибок.ПодробноеПредставлениеОшибки(ИнформацияОбОшибке);
		ЗаписьЖурналаРегистрации(НСтр("ru = 'Оповещения пользователей.Обработка сообщения системы взаимодействия'", ОбщегоНазначения.КодОсновногоЯзыка()),
			УровеньЖурналаРегистрации.Ошибка,,,
			ОписаниеОшибки);
		Возврат;
	КонецПопытки;
	...
	Если ЭтоНовоеОбсуждение Тогда
		...
		Иначе
			...
			Попытка
				ТекстОповещенияПодключены = НСтр("ru = 'Оповещения в Telegram успешно подключены.'", ОбщегоНазначения.КодОсновногоЯзыка());
	...
	Если НайденныеБоты.Количество() = 0 Тогда
		...
		Исключение
			...
			Уточнение = ОбщегоНазначенияКлиентСервер.УточнениеИсключения(ИнформацияОбОшибке, 
				НСтр("ru='Не удалось создать бота системы взаимодействия по причине:'"), Истина);
...
Процедура УдалитьБотовСистемыВзаимодействия() Экспорт
	...
	Для Каждого Бот Из НайденныеБоты Цикл
		...
		Исключение
			ИнформацияОбОшибке = ИнформацияОбОшибке();
			Уточнение = ОбщегоНазначенияКлиентСервер.УточнениеИсключения(ИнформацияОбОшибке, 
				НСтр("ru='Не удалось удалить бота системы взаимодействия по причине:'"), Истина);
			ВызватьИсключение(Уточнение.Текст, Уточнение.Категория,,, ИнформацияОбОшибке);
		КонецПопытки;
	КонецЦикла;
...
Функция НайтиСуществующуюИнтеграцию(Ключ) Экспорт
	...
	Исключение
		ИнформацияОбОшибке = ИнформацияОбОшибке();
		Уточнение = ОбщегоНазначенияКлиентСервер.УточнениеИсключения(ИнформацияОбОшибке, 
			НСтр("ru='Не удалось получить существующую интеграцию по причине:'"), Истина);
		ВызватьИсключение(Уточнение.Текст, Уточнение.Категория,,, ИнформацияОбОшибке);
	КонецПопытки;
...
Процедура СохранитьНастройкиОповещенийПользователей(Знач Пользователи, Знач СпособыОповещения, Использовать) Экспорт
	...
	Исключение
		...
		ИнформацияОбОшибке = ИнформацияОбОшибке();
		Уточнение = ОбщегоНазначенияКлиентСервер.УточнениеИсключения(ИнформацияОбОшибке, 
			НСтр("ru='Не удалось записать настройки оповещений по причине:'"), Истина);
		ВызватьИсключение(Уточнение.Текст, Уточнение.Категория,,, ИнформацияОбОшибке);
	КонецПопытки;
	УстановитьПривилегированныйРежим(Ложь);
КонецПроцедуры
	...
	Для каждого СтрокаИтог Из ДеревоРезультат.Строки Цикл
		...
		Если ЗначениеЗаполнено(СтрокаИтог.КонтекстОповещения)
			...
			Если КоличествоСсылок > 0 Тогда
				...
				ПредставлениеПерейти = "ru = 'Перейти (%1)'"; // @Nstr-1
...
Процедура ОтправитьОповещениеПоАдресуИнтеграции(Автор, СтрокаРезультат)
	...
	Для Каждого АдресИнтеграции Из СтрокаРезультат.АдресаИнтеграции Цикл
		...
		Исключение
			ИнформацияОбОшибке = ИнформацияОбОшибке();
			ОписаниеОшибки = ОбработкаОшибок.ПодробноеПредставлениеОшибки(ИнформацияОбОшибке);
			ЗаписьЖурналаРегистрации(НСтр("ru = 'Оповещения пользователей.Отправка во внешнюю систему'", ОбщегоНазначения.КодОсновногоЯзыка()),
				УровеньЖурналаРегистрации.Ошибка,,,
				ОписаниеОшибки);
		КонецПопытки;
	КонецЦикла;
...
Процедура ОтправитьОповещениеПоАдресуЭлектроннойПочты(ПараметрыПубликации, СтрокаРезультат)
	...
	ЗаголовокПисьма = НСтр("ru = 'Оповещение:'", СтрокаРезультат.КодЯзыкаПользователя) + " " + СтрокаРезультат.ТекстОповещения;
	ЗаголовокСистемы = НСтр("ru = 'Конфигурация:'", СтрокаРезультат.КодЯзыкаПользователя) + Символы.ПС + ПараметрыПубликации.ЗаголовокСистемы;
	ТекстОповещения = НСтр("ru = 'Текст оповещения:'", СтрокаРезультат.КодЯзыкаПользователя) + Символы.ПС + СтрокаРезультат.ТекстОповещения;
	
	ТекстСсылки = "";
	Если ЗначениеЗаполнено(СтрокаРезультат.КонтекстОповещения) Тогда
		ТекстСсылки = НСтр("ru = 'Ссылка:'", СтрокаРезультат.КодЯзыкаПользователя);
	...
	ИначеЕсли ЗначениеЗаполнено(СтрокаРезультат.КомандаПерехода) Тогда
		ТекстСсылки = НСтр("ru = 'Ссылки (%1):'", СтрокаРезультат.КодЯзыкаПользователя);
...
Функция ПредставлениеДокумента(ДокументСсылка, КодЯзыка)
	...
	Возврат НСтр("ru = 'Перейти к документу'", КодЯзыка);
...
Функция ТекстПустоеЗначение(КодЯзыка)
	...
	Текст = НСтр("ru = '<Пустое значение>'", КодЯзыка);
...
Функция ИмяСлужебногоПользователя()
	Возврат НСтр("ru='Оповещения системы'", ОбщегоНазначения.КодОсновногоЯзыка());
КонецФункции
...
Функция ПолучитьСоздатьСлужебногоПользователя(Имя, Идентификатор)
	...
	Исключение
		...
		ЗаписьЖурналаРегистрации(
			НСтр("ru = 'Оповещения пользователей.Создание/получение служебного пользователя'", ОбщегоНазначения.КодОсновногоЯзыка()),
			УровеньЖурналаРегистрации.Ошибка,
	...
	Если ПользовательИБ = Неопределено 
		...
		ВызватьИсключение СтрШаблон(НСтр("ru = 'Не удалось создать служебного пользователя %1'"), Имя);
	КонецЕсли;
