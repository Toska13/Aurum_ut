...
// Возможность использования долговременного токена.
// 
// Возвращаемое значение: 
//  Булево
...
//
Функция СвойстваРасшифровыванияПодписанияСертификата(Сертификат) Экспорт
	
	Результат = ЭлектроннаяПодписьВМоделиСервисаСлужебный.СвойстваРасшифровыванияПодписанияСертификата(Сертификат);
...
//
Процедура УдалитьСвойстваРасшифровыванияПодписания(Сертификат) Экспорт
	
	ЭлектроннаяПодписьВМоделиСервисаСлужебный.УдалитьСвойстваРасшифровыванияПодписания(Сертификат);
...
//	 		   - Строка - содержит свойства сертификата, наличие свойства "Идентификатор" обязательно.
//
Процедура УстановитьСвойстваРасшифровыванияПодписания(Сертификат) Экспорт
	
	ЭлектроннаяПодписьВМоделиСервисаСлужебный.УстановитьСвойстваРасшифровыванияПодписания(Сертификат);
...
// Устарела: следует использовать ЭлектроннаяПодписьВМоделиСервиса.СвойстваРасшифровыванияПодписанияСертификата
// Возвращает настройки сертификата: использование долговременного токена и его значение
//
// Параметры:
//   Сертификат - Структура, Строка - содержит свойства сертификата, наличие свойства "Идентификатор" обязательно.
...
//   * Отпечаток - Произвольный -
//
Функция СвойстваРасшифрованияПодписанияСертификата(Сертификат) Экспорт // cSpell:ignore Расшифрования - совместимость
	
	Возврат СвойстваРасшифровыванияПодписанияСертификата(Сертификат);
	
КонецФункции

// Устарела: следует использовать ЭлектроннаяПодписьВМоделиСервиса.УдалитьСвойстваРасшифровыванияПодписания
// Удаляет настройки для использования долговременного токена
//
// Параметры:
//   Сертификат - Структура - поля:
...
//	 		    - Строка - содержит свойства сертификата, наличие свойства "Идентификатор" обязательно.
//
Процедура УдалитьСвойстваРасшифрованияПодписания(Сертификат) Экспорт // cSpell:ignore Расшифрования - совместимость
	
	УдалитьСвойстваРасшифровыванияПодписания(Сертификат);
	
КонецПроцедуры

// Устарела: следует использовать ЭлектроннаяПодписьВМоделиСервиса.УстановитьСвойстваРасшифровыванияПодписания
// Сохраняет настройки для использования долговременного токена
//
// Параметры:
//	Сертификат - Структура - поля:
...
//	 		   - Строка - содержит свойства сертификата, наличие свойства "Идентификатор" обязательно.
//
Процедура УстановитьСвойстваРасшифрованияПодписания(Сертификат) Экспорт // cSpell:ignore Расшифрования - совместимость
	
	УстановитьСвойстваРасшифровыванияПодписания(Сертификат);
