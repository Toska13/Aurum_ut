...
// Дополняет коллекцию сведений о штрихкоде номенклатуры дополнительными свойствами.
// 
// Параметры:
//	 ДанныеПоШтрихкодам - Структура Из КлючИЗначение - коллекция, содержащая сведения о штрихкоде номенклатуры.
//
Процедура ПоискНоменклатурыПоШтрихкодуДанныеПоШтрихкодам(ДанныеПоШтрихкодам) Экспорт
	
	//++ НЕ ГОСИС
	РаботаСНоменклатуройУТ.ПоискНоменклатурыПоШтрихкодуДанныеПоШтрихкодам(ДанныеПоШтрихкодам);
	//-- НЕ ГОСИС
...
Процедура ИнициализацияЗапросаОтбораНоменклатурыСХарактеристиками(ТекстЗапроса) Экспорт
	...
	//++ НЕ ГОСИС
	РаботаСНоменклатуройУТ.ИнициализацияЗапросаОтбораНоменклатурыСХарактеристиками(ТекстЗапроса);
	//-- НЕ ГОСИС
