...
Процедура ПриДобавленииОбработчиковОбновления(Обработчики) Экспорт
	...
	ДоставкаТоваров.ПриДобавленииОбработчиковОбновления(Обработчики);
	ЗакрытиеМесяцаСервер.ПриДобавленииОбработчиковОбновления(Обработчики);

	ОповещенияПользователейОСобытиях.ПриДобавленииОбработчиковОбновления(Обработчики);
	ОперативныеВзаиморасчетыСервер.ПриДобавленииОбработчикаПереходаНаНовуюАрхитектуруВзаиморасчетов(Обработчики);
	ПроведениеДокументов.ПриДобавленииОбработчиковОбновления(Обработчики);
	
	Документы.АктКонтроляКачестваТоваров.ПриДобавленииОбработчиковОбновления(Обработчики);
	Документы.АктОРасхожденияхПослеПриемки.ПриДобавленииОбработчиковОбновления(Обработчики);
	Документы.ЗаявкаНаКомандировку.ПриДобавленииОбработчиковОбновления(Обработчики);
	...
	Документы.ПриходныйОрдерНаТовары.ПриДобавленииОбработчиковОбновления(Обработчики);
	Документы.СписаниеОтгруженныхТоваров.ПриДобавленииОбработчиковОбновления(Обработчики);
	...
	Документы.ОтгрузкаТоваровКлиенту.ПриДобавленииОбработчиковОбновления(Обработчики);
	...
	Константы.ИспользоватьОтгрузкуБезПереходаПраваСобственности.ПриДобавленииОбработчиковОбновления(Обработчики);
	Константы.НастройкиЗакрытияМесяца.ПриДобавленииОбработчиковОбновления(Обработчики);
	
	Документы.ОперацияСЭлектроннымБилетом.ПриДобавленииОбработчиковОбновления(Обработчики);
	...
	РегистрыСведений.КатегорииПодакцизныхТоваров.ПриДобавленииОбработчиковОбновления(Обработчики);
	
	РегистрыСведений.РеестрДокументов.ПриДобавленииОбработчиковОбновления(Обработчики);
	РегистрыНакопления.ЗаказыПоставщикам.ПриДобавленииОбработчиковОбновления(Обработчики);
	РегистрыНакопления.ПланыОплатКлиентов.ПриДобавленииОбработчиковОбновления(Обработчики);
	РегистрыНакопления.ПланыОплатПоставщикам.ПриДобавленииОбработчиковОбновления(Обработчики);
	...
	РегистрыСведений.ДоступныеОстаткиТоваров.ПриДобавленииОбработчиковОбновления(Обработчики);
	РегистрыСведений.СостоянияЗаказовПоставщикам.ПриДобавленииОбработчиковОбновления(Обработчики);
	...
	РегистрыНакопления.РаспоряженияНаОтгрузкуИВозврат.ПриДобавленииОбработчиковОбновления(Обработчики);
	...
	РегистрыСведений.РаспоряженияНаОтгрузкуИВозвратКВыполнению.ПриДобавленииОбработчиковОбновления(Обработчики);
	РегистрыСведений.ЗаданияКРаспределениюРасчетов.ПриДобавленииОбработчиковОбновления(Обработчики);
	РегистрыСведений.ЗаданияНеоперативногоДопроведенияДокументов.ПриДобавленииОбработчиковОбновления(Обработчики);
	РегистрыСведений.ВыполнениеОперацийЗакрытияМесяца.ПриДобавленииОбработчиковОбновления(Обработчики);
	РегистрыНакопления.ПрочиеДоходы.ПриДобавленииОбработчиковОбновления(Обработчики);
	...
	РегистрыСведений.ШтрихкодыНоменклатуры.ПриДобавленииОбработчиковОбновления(Обработчики);
	РегистрыСведений.ОчередьПереоформленияРасходныхОрдеров.ПриДобавленииОбработчиковОбновления(Обработчики);
	РегистрыСведений.ГрафикПлатежей.ПриДобавленииОбработчиковОбновления(Обработчики);
	
	Справочники.ВидыНеоперативныхЗаданий.ПриДобавленииОбработчиковОбновления(Обработчики);
	...
	РегистрыНакопления.ДвиженияПоАкцизам.ПриДобавленииОбработчиковОбновления(Обработчики);
	//++ Локализация
	...
	Справочники.ВидыЗапасов.ПриДобавленииОбработчиковОбновления(Обработчики);
	...
	Справочники.КонтролируемыеПартии.ПриДобавленииОбработчиковОбновления(Обработчики);
	...
	Справочники.ГруппыФинансовогоУчетаНоменклатуры.ПриДобавленииОбработчиковОбновления(Обработчики);
	...
	Справочники.ГруппыАналитическогоУчетаНоменклатуры.ПриДобавленииОбработчиковОбновления(Обработчики);
	Справочники.Проекты.ПриДобавленииОбработчиковОбновления(Обработчики);
	...
	Справочники.ОперацииЗакрытияМесяца.ПриДобавленииОбработчиковОбновления(Обработчики);
	Справочники.ПричиныБлокировкиТоваров.ПриДобавленииОбработчиковОбновления(Обработчики);
	...
	Справочники.ПравилаПоискаДублейНСИ.ПриДобавленииОбработчиковОбновления(Обработчики);
	
	Планирование.ПриДобавленииОбработчиковОбновления(Обработчики);
	
	//++ Локализация
	РегистрыСведений.НастройкиИнтеграцииСПлатежнымиСистемамиУТ.ПриДобавленииОбработчиковОбновления(Обработчики);
	//-- Локализация
	
	РегистрыСведений.НастройкаРаспределенияПоНаправлениямДеятельности.ПриДобавленииОбработчиковОбновления(Обработчики);
...
Процедура ПослеОбновленияИнформационнойБазы(Знач ПредыдущаяВерсия, Знач ТекущаяВерсия,
	...
	// После завершения монопольного обновления уведомляем пользователя, в случае использования устаревшего функционала.
	Если МонопольныйРежим Тогда
		Обработки.ГотовностьКПереходу26.УстановитьКонстантуУведомленияОбУстаревшейФункциональности(Истина);
	КонецЕсли;
...
Процедура ОтметитьВыполнениеОбработкиИнтерактивно(Данные, ДополнительныеПараметры = Неопределено) Экспорт
	...
	МассивОчередей = ТаблицаСсылок.ВыгрузитьКолонку("Ссылка");
	...
	Если ДополнительныеПараметры.ЭтоДвижения Тогда
		...
		Если ТипЗнч(Данные) = Тип("Массив") Тогда
			Для Каждого СтрокаМассива Из Данные Цикл
				...
				ПланыОбмена.УдалитьРегистрациюИзменений(МассивОчередей, Набор);
			КонецЦикла;
		Иначе
	...
	Иначе
		...
		Иначе
			Для Каждого ЭлементМассива Из Данные Цикл
				ПланыОбмена.УдалитьРегистрациюИзменений(МассивОчередей, ЭлементМассива);
			КонецЦикла;
		КонецЕсли;
...
#Область КоличествоПотоковНеоперативнойОчередиЗаданий

	Обработчик = Обработчики.Добавить();
	Обработчик.Процедура = "ОбновлениеИнформационнойБазыУТ.УстановитьКоличествоПотоковНеоперативнойОчередиЗаданий";
	Обработчик.Версия = "11.5.23.17";
	Обработчик.РежимВыполнения = "Оперативно";
	Обработчик.Идентификатор = Новый УникальныйИдентификатор("f040a124-3d63-11ea-81fa-c7cc1f049a75");
	Обработчик.ПроцедураЗаполненияДанныхОбновления = "ОбновлениеИнформационнойБазыУТ.КоличествоПотоковНеоперативнойОчередиЗаданий_ЗарегистрироватьДанныеКОбработкеДляПереходаНаНовуюВерсию";
	Обработчик.ПроцедураПроверки = "ОбновлениеИнформационнойБазы.ДанныеОбновленыНаНовуюВерсиюПрограммы";
	Обработчик.Комментарий = НСтр("ru = 'Устанавливает количество потоков неоперативной очереди заданий'");
	Обработчик.ОбщиеДанные = Истина;
	
	Читаемые = Новый Массив;
	Читаемые.Добавить(Метаданные.Константы.КоличествоПотоковНеоперативнойОчередиЗаданий.ПолноеИмя());
	Обработчик.ЧитаемыеОбъекты = СтрСоединить(Читаемые, ",");
	
	Изменяемые = Новый Массив;
	Изменяемые.Добавить(Метаданные.Константы.КоличествоПотоковНеоперативнойОчередиЗаданий.ПолноеИмя());
	Обработчик.ИзменяемыеОбъекты = СтрСоединить(Изменяемые, ",");

#КонецОбласти

#Область УстановитьКонстантуПорядокРаботыПриВыполненииЗаданияВМРМК
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Процедура = "ОбновлениеИнформационнойБазыУТ.УстановитьКонстантуПорядокРаботыПриВыполненииЗаданияВМРМК";
	Обработчик.Версия = "11.5.26.53";
	Обработчик.РежимВыполнения = "Отложенно";
	Обработчик.Идентификатор = Новый УникальныйИдентификатор("9f48fee9-15ad-486b-8b8b-21b56fd73e24");
	Обработчик.ПроцедураЗаполненияДанныхОбновления = "ОбновлениеИнформационнойБазыУТ.ПорядокРаботыПриВыполненииЗаданияВМРМК_ЗарегистрироватьДанныеКОбработкеДляПереходаНаНовуюВерсию";
	Обработчик.ПроцедураПроверки = "ОбновлениеИнформационнойБазы.ДанныеОбновленыНаНовуюВерсиюПрограммы";
	Обработчик.Комментарий = НСтр("ru = 'Устанавливает значение константы ""Порядок работы при выполнении задания в МРМК"".'");
	
	Читаемые = Новый Массив;
	Читаемые.Добавить(Метаданные.Константы.ПорядокРаботыПриВыполненииЗаданияВМРМК.ПолноеИмя());
	Обработчик.ЧитаемыеОбъекты = СтрСоединить(Читаемые, ",");
		
	Изменяемые = Новый Массив;
	Изменяемые.Добавить(Метаданные.Константы.ПорядокРаботыПриВыполненииЗаданияВМРМК.ПолноеИмя());
	Обработчик.ИзменяемыеОбъекты = СтрСоединить(Изменяемые, ",");
...
Процедура КоличествоПотоковНеоперативнойОчередиЗаданий_ЗарегистрироватьДанныеКОбработкеДляПереходаНаНовуюВерсию(Параметры) Экспорт
...
Процедура УстановитьКоличествоПотоковНеоперативнойОчередиЗаданий(Параметры = Неопределено) Экспорт
	...
	Константы.КоличествоПотоковНеоперативнойОчередиЗаданий.Установить(КоличествоПотоков);

КонецПроцедуры

#КонецОбласти

#Область УстановкаКонстанты_ПорядокРаботыПриВыполненииЗаданияВМРМК

Процедура ПорядокРаботыПриВыполненииЗаданияВМРМК_ЗарегистрироватьДанныеКОбработкеДляПереходаНаНовуюВерсию(Параметры) Экспорт
...
Процедура УстановитьКонстантуПорядокРаботыПриВыполненииЗаданияВМРМК(ПараметрыОбновления) Экспорт
	
	Если НЕ ЗначениеЗаполнено(Константы.ПорядокРаботыПриВыполненииЗаданияВМРМК.Получить()) Тогда
		Константы.ПорядокРаботыПриВыполненииЗаданияВМРМК.Установить(Перечисления.ПорядокРаботыПриВыполненииЗаданияВМРМК.СначалаСканированиеЯчейки);
	КонецЕсли;
