...
Процедура ДобавитьЭтапДействия(Форма, ФункцияЭтапа) Экспорт
	...
	ПараметрыОповещения = НовыеПараметрыОповещенияИзмененияУчастников();
	ПараметрыОповещения.ТекущиеДанные = ТекущиеДанные;
	ПараметрыОповещения.ВидИзменения = ВидыИзмененийУчастниковДействия().ДобавлениеЭтапа;
...
Процедура ПереместитьУчастникаДействияВверх(Форма, МожноМенятьПорядокЭтапов = Истина, ПоПунктам = Ложь) Экспорт
	...
	ПараметрыОповещения = НовыеПараметрыОповещенияИзмененияУчастников();
	ПараметрыОповещения.ТекущиеДанные = ТекущиеДанные;
	ПараметрыОповещения.ВидИзменения = ВидыИзмененийУчастниковДействия().ПеремещениеВверх;
...
Процедура ПереместитьУчастникаДействияВниз(Форма, МожноМенятьПорядокЭтапов = Истина, ПоПунктам = Ложь) Экспорт
	...
	ПараметрыОповещения = НовыеПараметрыОповещенияИзмененияУчастников();
	ПараметрыОповещения.ТекущиеДанные = ТекущиеДанные;
	ПараметрыОповещения.ВидИзменения = ВидыИзмененийУчастниковДействия().ПеремещениеВниз;
...
Процедура ПредставлениеУчастникаДействияНачалоВыбораЗавершение(Результат, ПараметрыОповещения) Экспорт
	...
	ПараметрыОповещения = НовыеПараметрыОповещенияИзмененияУчастников();
	ПараметрыОповещения.ТекущиеДанные = ТекущиеДанные;
	ПараметрыОповещения.ВидИзменения = ВидыИзмененийУчастниковДействия().ИзменениеИсполнителя;
	
	Оповестить("ОбновитьПредставленияВДеревеУчастников", ПараметрыОповещения, ПараметрыОповещения.Форма.УникальныйИдентификатор);
