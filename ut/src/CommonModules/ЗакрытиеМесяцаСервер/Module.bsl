...
Процедура ЗаполнитьОписаниеГруппЭтаповЗакрытияМесяца(ТаблицаГруппЭтапов) Экспорт
	...
	НоваяСтрока.МеждународноеНаименование = "ru='Данные операции требуется выполнить вручную'";
	
	НоваяСтрока = ТаблицаГруппЭтапов.Добавить();
	НоваяСтрока.Код = ИдентификаторГруппыНеоперативнаяОчередьЗаданий();
	НоваяСтрока.Наименование = НСтр("ru='Допроведение документов'");
	НоваяСтрока.МеждународноеНаименование = "ru='Допроведение документов'";
	...
	НоваяСтрока.МеждународноеНаименование = "ru='Взаиморасчеты и переоценка валютных средств'";
	
	НоваяСтрока = ТаблицаГруппЭтапов.Добавить();
	НоваяСтрока.Код = ИдентификаторГруппыФормированиеЗатрат();
	НоваяСтрока.Наименование = НСтр("ru='Формирование затрат'");
	НоваяСтрока.МеждународноеНаименование = "ru='Формирование затрат'";
	...
	НоваяСтрока.МеждународноеНаименование = "ru='Распределение производственных затрат'";
	
	НоваяСтрока = ТаблицаГруппЭтапов.Добавить();
	НоваяСтрока.Код = ИдентификаторГруппыСебестоимость();
	НоваяСтрока.Наименование = НСтр("ru='Расчет себестоимости'");
	НоваяСтрока.МеждународноеНаименование = "ru='Расчет себестоимости'";
	...
	НоваяСтрока.МеждународноеНаименование = "ru='Формирование финансового результата'";
	
	НоваяСтрока = ТаблицаГруппЭтапов.Добавить();
	НоваяСтрока.Код = ИдентификаторГруппыРегламентированныйУчет();
	НоваяСтрока.Наименование = НСтр("ru='Регламентированный учет'");
	НоваяСтрока.МеждународноеНаименование = "ru='Регламентированный учет'";
	
	
	НоваяСтрока = ТаблицаГруппЭтапов.Добавить();
	НоваяСтрока.Код = ИдентификаторГруппыОтражениеДвиженийПоУпрБалансу();
	НоваяСтрока.Наименование = НСтр("ru='Управленческий баланс'");
	НоваяСтрока.МеждународноеНаименование = "ru='Управленческий баланс'";
	
	НоваяСтрока = ТаблицаГруппЭтапов.Добавить();
	НоваяСтрока.Код = ИдентификаторГруппыБлокировкаОтИзменений();
	НоваяСтрока.Наименование = НСтр("ru='Блокировка от изменений'");
	НоваяСтрока.МеждународноеНаименование = "ru='Блокировка от изменений'";
...
Функция ИдентификаторГруппыФормированиеФинансовогоРезультата() Экспорт
	Возврат "ФормированиеФинансовогоРезультатаГруппа";
КонецФункции
...
// Идентификатор группы неоперативного допроведения документов.
// 
// Возвращаемое значение:
//  Строка - Идентификатор группы неоперативного допроведения документов
Функция ИдентификаторГруппыНеоперативнаяОчередьЗаданий() Экспорт
	Возврат "НеоперативнаяОчередьЗаданий";
КонецФункции

// Идентификатор группы неоперативного допроведения документов (отражение движений документов по Упр.балансу)
// 
// Возвращаемое значение:
//  Строка - Идентификатор группы отражения движений документов по управленческому балансу
Функция ИдентификаторГруппыОтражениеДвиженийПоУпрБалансу() Экспорт
	Возврат "ОтражениеДвиженийПоУправленческомуБалансу";
КонецФункции
#КонецОбласти
...
Процедура ЗаполнитьОписаниеЭтаповЗакрытияМесяца(ТаблицаЭтапов) Экспорт
	...
	#Область Группа_НеоперативнаяОчередьЗаданий
	ТекущийРодитель = ИдентификаторГруппыНеоперативнаяОчередьЗаданий();
	НеоперативнаяОчередьЗаданий.ДобавитьЭтап_РасчетСуммДокументовВВалютахУчетаИПерепроведениеПоФинансовымРегистрам(ТаблицаЭтапов,ТекущийРодитель);
	#КонецОбласти
	...
	//++ Локализация
	Документы.КорректировкаНалогообложенияНДСПартийТоваров.ДобавитьЭтап_ПереносОстатковПодНовыйВидДеятельности(ТаблицаЭтапов, ТекущийРодитель);
	//-- Локализация
	...
	#Область Группа_ОтражениеДвиженийДокументовПоУправленческомуБалансу
	ТекущийРодитель = ИдентификаторГруппыОтражениеДвиженийПоУпрБалансу();
	НеоперативнаяОчередьЗаданий.ДобавитьЭтап_ОтражениеДвиженийДокументовПоУправленческомуБалансу(ТаблицаЭтапов,ТекущийРодитель);
	#КонецОбласти
...
Процедура ДобавитьЭтап_ПереходНаНовыеРежимыРаботы(ТаблицаЭтапов, ТекущийРодитель) Экспорт
	...
	НоваяСтрока = ДобавитьЭтапВТаблицу(ТаблицаЭтапов, ТекущийРодитель,
		Справочники.ОперацииЗакрытияМесяца.ПереходНаНовыеРежимыУчета);
	
	НоваяСтрока.МультиязычноеНаименование = "ru = 'Требуется осуществить переход на новые режимы учета'"; // @НСтр-1
...
// Использование информирования о переъоже на новые режимы учета.
// 
// Параметры:
...
Процедура Использование_ПереходНаНовыеРежимыРаботы(ПараметрыОбработчика) Экспорт
	...
	// При закрытии текущего и предыдущего месяца повышаем важность проблемы.
	Если НачалоМесяца(ПараметрыОбработчика.ПараметрыРасчета.Период) >= ДобавитьМесяц(НачалоМесяца(ТекущаяДатаСеанса()), -1) Тогда
		СтатусПоУмолчанию = Перечисления.ВажностьПроблемыУчета.ВажнаяИнформация;
	Иначе
		СтатусПоУмолчанию = Перечисления.ВажностьПроблемыУчета.Предупреждение;
		ПараметрыОбработчика.ДанныеЭтапа.Наименование = НСтр("ru='Рекомендуется осуществить переход на новые режимы учета'");
	КонецЕсли;
...
Процедура ДобавитьЭтап_ИсправлениеОшибокВИсходныхДанных(ТаблицаЭтапов, ТекущийРодитель) Экспорт
	...
	НоваяСтрока = ДобавитьЭтапВТаблицу(ТаблицаЭтапов, ТекущийРодитель,
		Справочники.ОперацииЗакрытияМесяца.ИсправлениеОшибокВИсходныхДанных);
		
	НоваяСтрока.МультиязычноеНаименование = "ru = 'Исправление ошибок в исходных данных'"; // @НСтр-1
	НоваяСтрока.ВыполняетсяВручную = Истина;
	НоваяСтрока.ТекстПодробнее     = ТекстПодробнееПоУмолчанию();
...
Процедура ДобавитьЭтап_ЗаблокироватьОтИзменений(ТаблицаЭтапов, ТекущийРодитель) Экспорт
	...
	НоваяСтрока = ДобавитьЭтапВТаблицу(ТаблицаЭтапов, ТекущийРодитель,
		Справочники.ОперацииЗакрытияМесяца.ЗаблокироватьОтИзменений);
		
	НоваяСтрока.МультиязычноеНаименование = "ru = 'Заблокировать от изменений'"; // @НСтр-1
	НоваяСтрока.ВыполняетсяВручную = Истина;
	НоваяСтрока.Информационный = Истина;
...
Функция ДобавитьОписаниеНовойПроверки(ТаблицаПроверок, Идентификатор, КонтекстПроверокВеденияУчета,
	...
	ОписаниеПроверки.ИдентификаторРодителя 		 = "Группа" + "_" + Справочники.ОперацииЗакрытияМесяца.ПолучитьИмяПредопределенного(КонтекстПроверокВеденияУчета);
...
//	Этап - СправочникСсылка.ОперацииЗакрытияМесяца - добавляемый этап закрытия месяца
...
//	ПредшествующийЭтап - СправочникСсылка.ОперацииЗакрытияМесяца - предыдущий этап закрытия месяца для целей упорядочивания.
//
// Возвращаемое значение:
...
//	КонтекстПроверокВеденияУчета - СправочникСсылка.ОперацииЗакрытияМесяца - этап закрытия месяца (владелец), к которому относится проверки.
//
// Возвращаемое значение:
// см. ЗакрытиеМесяцаСервер.СтруктураОписанияДействия
//
...
Функция ОписаниеДействия_ОткрытьФорму(ИмяФормы, ПараметрыВСтруктуреОтбор = Ложь, ОткрыватьФормуСБлокированием = Ложь) Экспорт
	...
	Описание.ПараметрыФормы.Вставить(ЗакрытиеМесяцаКлиентСервер.ИмяСлужебногоСвойстваОткрываемыхФорм(), Истина);
...
//
// Параметры:
//	РассчитываемыйЭтап - СправочникСсылка.ОперацииЗакрытияМесяца - этап закрытия месяца.
//
// Возвращаемое значение:
// см. ЗакрытиеМесяцаСервер.СтруктураОписанияДействия
//
Функция ОписаниеДействия_ОткрытьЖурналРегистрации(РассчитываемыйЭтап) Экспорт
	...
	СобытияЖурнала.Добавить(ИмяСобытияЖурналаРегистрации(Справочники.ОперацииЗакрытияМесяца.ПолучитьИмяПредопределенного(РассчитываемыйЭтап)));
...
Функция ПроверитьНаличиеРегламентногоДокументаЭтапаЗакрытияМесяца(ПараметрыОбработчика, ИмяДокумента, ИмяТаблицыОтбораОрганизаций = "") Экспорт
	...
	КоличествоДокументов = КоличествоРегламентныхДокументовЭтапаЗакрытияМесяца(
		ПараметрыОбработчика, ИмяДокумента, ИмяТаблицыОтбораОрганизаций);
	
	УвеличитьКоличествоОбработанныхДанныхДляЗамера(ПараметрыОбработчика, КоличествоДокументов);
...
// Определяет количество регламентных документов указанного вида.
//
// Параметры:
//	ПараметрыОбработчика 		- Структура - параметры обработчика события этапа
//	ИмяДокумента 				- Строка - имя регламентного документа, как оно указано в метаданных
...
//
Функция КоличествоРегламентныхДокументовЭтапаЗакрытияМесяца(ПараметрыОбработчика, ИмяДокумента, ИмяТаблицыОтбораОрганизаций = "") Экспорт
	...
	Если ИмяДокумента = "РаспределениеНДС" Тогда 
		Запрос.Текст = СтрЗаменить(Запрос.Текст, "&ДопУсловие", "НЕ Т.Исправление");
	Иначе 
...
//
// Параметры:
//  Этапы 							  - СправочникСсылка.ОперацииЗакрытияМесяца, Массив - операции закрытия месяца
...
//	ОбновитьТолькоОдинЭтап			  - СправочникСсылка.ОперацииЗакрытияМесяца - экспресс-проверка состояния только указанного этапа
//										 при этом не проверяется определение состояния предшествующих этапов, влияющих на указанный этап
//
// Возвращаемое значение:
//	Соответствие
//		Ключ - СправочникСсылка.ОперацииЗакрытияМесяца - этап
...
//
// Параметры:
//  ЭтапРасчета	- СправочникСсылка.ОперацииЗакрытияМесяца - этап закрытия месяца.
...
Процедура ЗарегистрироватьПроблемуВыполненияРасчета(ПараметрыРегистрации, ТекстКратко,
	...
	Если ОбъектМетаданных <> Неопределено
		И ОбщегоНазначения.ЭтоДокумент(ОбъектМетаданных) Тогда 
		...
		|ГДЕ
		|	РеестрДокументов.Ссылка = &Объект";
		
		ОрганизацияОбъекта = Запрос.Выполнить().Выгрузить().ВыгрузитьКолонку("Организация");
	...
	Для Каждого ТекущаяОрганизация Из МассивОрганизаций Цикл
		...
		Если ЗначениеЗаполнено(ОрганизацияОбъекта)
			И ОрганизацияОбъекта.Найти(ТекущаяОрганизация) = Неопределено Тогда
			Продолжить;
		КонецЕсли;
...
// 
// Параметры:
//  ЭтапРасчета - СправочникСсылка.ОперацииЗакрытияМесяца - Этап расчета
...
Функция ДублироватьНайденныеПроблемыВЖурналеРегистрации()
	...
	ЗначенияПараметров = РасчетСебестоимостиПовтИсп.ЗначенияТехнологическихПараметров(
		Справочники.ОперацииЗакрытияМесяца.ПустаяСсылка());
...
Процедура ПродублироватьВЖурналРегистрации(ЭтапРасчета, ИсточникОпределенияВажностиПроблемы, ТекстОшибки) Экспорт
	...
	ЗаписьЖурналаРегистрации(
		ИмяСобытияЖурналаРегистрации(Справочники.ОперацииЗакрытияМесяца.ПолучитьИмяПредопределенного(ЭтапРасчета)),
		УровеньЖР,
		,
		,
		ТекстОшибки);
...
//
// Параметры:
//	ОперацияРасчета   - СправочникСсылка.ОперацииЗакрытияМесяца - этап закрытия месяца
...
//	ОперацияРасчета - СправочникСсылка.ОперацииЗакрытияМесяца - операция для которой производился расчет;
...
//	Организации 		  - СправочникСсылка.Организации, Массив из СправочникСсылка.Организации - Перечень организаций к блокировке.
//	Операция 			  - СправочникСсылка.ОперацииЗакрытияМесяца - Операция, по которой блокируется регистр заданий.
//  Документ              - ДокументСсылка - Документ, по которому была сделана запись в РС ЗаданияКЗакрытиюМесяца. Если 
//								параметр не передается, то блокировка устанавливается по Операции в целом. 
Процедура ЗаблокироватьРегистрЗаданий(НомерЗаданияДоРасчета, Организации, Операция, Документ = Неопределено) Экспорт
...
//	Операция 	  - СправочникСсылка.ОперацииЗакрытияМесяца - Фильтр по типу операции.
...
//
Функция ЗаданияКРасчетуЗаМесяц(НачалоПериода, КонецПериода, НомерЗадания, Организации, Операция, Документ = Неопределено) Экспорт
	...
	|	И (Задания.Документ В (&Документ) ИЛИ &ПоВсемДокументам)
	|;
	|//////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ РАЗЛИЧНЫЕ
	...
	Запрос.УстановитьПараметр("ПоВсемДокументам", 	НЕ ЗначениеЗаполнено(Документ));
...
// 
// Параметры:
// 	Операция - СправочникСсылка.ОперацииЗакрытияМесяца - операция закрытия месяца.
...
// Параметры:
//	ПараметрыОбработчика - см. Обработки.ОперацииЗакрытияМесяца.ИнициализироватьПараметрыОбработчикаЭтапа 
//	ДанныеКРасчету - см. ЗаданияКРасчетуЗаМесяц.
//	Документ - ДокументСсылка - если значение заполнено, задания будут очищаться только по переданному значению
//	
Процедура УдалитьЗаданияКРасчетуЗаТекущийПериод(ПараметрыОбработчика, ДанныеКРасчету = Неопределено, Документ = Неопределено) Экспорт
	...
	Попытка
		...
		ФормироватьЗаданияНаСледующийПериод = Истина;
		ЗакрытиеМесяцаЛокализация.ПроверитьНеобходимостьФормированияЗаданийНаСледующийПериод(ФормироватьЗаданияНаСледующийПериод, ПараметрыОбработчика);
		Если ФормироватьЗаданияНаСледующийПериод Тогда
...
// Получает данные к расчету, вместе с блокировкой регистра заданий, в транзакции и использованием попытки
//
//	Параметры:
//		Параметры - Структура - см. ИнициализироватьСвойстваРаботыСЗаданиями()
//
//	Возвращаемое значение:
//		Структура:
//		* Организация - Массив из СправочникСсылка.Организации - Массив организаций, который неактуальны в указанном периоде.
...
//		* ПериодРасчета - Дата - Начало периода за который формируем задания.
//
Функция ДанныеКРасчету(Параметры) Экспорт
	
	НачатьТранзакцию();
	Попытка
		ЗаблокироватьРегистрЗаданий(Параметры.НомерЗадания, Параметры.Организации, Параметры.Операция);
		Результат = ЗаданияКРасчетуЗаМесяц(Параметры.НачалоПериода, Параметры.КонецПериода, Параметры.НомерЗадания,
			Параметры.Организации, Параметры.Операция);
		ЗафиксироватьТранзакцию();
	Исключение
		ОтменитьТранзакцию();
		ТекстСообщения = НСтр("ru = 'Не удалось заблокировать регистр заданий по причине: %ПричинаОшибки%'");
		ТекстСообщения = СтрЗаменить(ТекстСообщения, "%ПричинаОшибки%", ОбработкаОшибок.ПодробноеПредставлениеОшибки(ИнформацияОбОшибке()));
		ЗаписьЖурналаРегистрации(Строка(Параметры.Операция), ОбщегоНазначения.КодОсновногоЯзыка(),
...
// Фиксирует расчет, вместе с блокировкой регистра заданий, в транзакции и использованием попытки
//
//	Параметры:
//		Параметры - Структура - см. ИнициализироватьСвойстваРаботыСЗаданиями()
//		ДанныеКРасчету - Структура - см. ЗаданияКРасчетуЗаМесяц()
//
Процедура ЗафиксироватьРасчетТранзакция(Параметры, ДанныеКРасчету) Экспорт
	...
	Попытка
		ЗаблокироватьРегистрЗаданий(Параметры.НомерЗадания, Параметры.Организации, Параметры.Операция);
		СледующийПериод = ДатаЗаданияНаСледующийПериод(Параметры.Операция, Параметры.Организации.Получить(0), Неопределено, Параметры.КонецПериода + 1);
		ЗафиксироватьРасчет(СледующийПериод, Параметры.Операция, ДанныеКРасчету.ВременныеТаблицы);
		ЗафиксироватьТранзакцию();
	Исключение
		ОтменитьТранзакцию();
...
//	Возвращает набор свойств для работы с заданиями закрытия месяца (получение данных к расчету, фиксирование расчета),
//	при вызове сразу увеличивает номер задания.
//	
//	Параметры:
//		УвеличитьНомер - Булево - если истина, то сразу задается номер задания (вызывается метод "УвеличитьНомер"), значение по умолчанию Ложь.
//
//	Возвращаемое значение:
//		Структура:
//		* НомерЗадания - Число - Номер задания из константы "Номер задания к закрытию месяца"
//		* Операция - СправочникСсылка.ОперацииЗакрытияМесяца - операция по которой производится расчет
//		* Организации - Массив из СправочникСсылка.Организации - массив организаций по которым проводится расчет
//		* НачалоПериода - Дата - начало периода расчета
//		* КонецПериода - Дата - конец периода расчета
//		* Отказ - Булево - признак наличия ошибок.
//
Функция ИнициализироватьСвойстваРаботыСЗаданиями(УвеличитьНомер = Ложь) Экспорт
	
	СтруктураВозврата = Новый Структура;
	СтруктураВозврата.Вставить("НомерЗадания", 0);
	СтруктураВозврата.Вставить("Операция", Справочники.ОперацииЗакрытияМесяца.ПустаяСсылка());
	СтруктураВозврата.Вставить("Организации", Новый Массив);
	СтруктураВозврата.Вставить("НачалоПериода", '00010101');
	СтруктураВозврата.Вставить("КонецПериода", '00010101');
	СтруктураВозврата.Вставить("Отказ", Ложь);
	
	Если УвеличитьНомер Тогда
		СтруктураВозврата.НомерЗадания = УвеличитьНомерЗадания();
	КонецЕсли;
...
Функция ЭтаФормаОткрытаИзФормыЗакрытияМесяца(Форма) Экспорт
	...
	Возврат Форма.Параметры.Свойство(ЗакрытиеМесяцаКлиентСервер.ИмяСлужебногоСвойстваОткрываемыхФорм());
...
Функция БлокировкаЗакрытияМесяцаОбработчикамиОбновления() Экспорт
	...
	Пока Выборка.Следующий() Цикл
		...
		БлокируетЗакрытиеМесяца = ?(БлокируетЗакрытиеМесяца = Неопределено, Ложь, БлокируетЗакрытиеМесяца);
...
Функция ОбработчикиОбновленияБлокирующиеЗакрытиеМесяца() Экспорт
	...
	|РегистрыСведений.ЗаданияНеоперативногоДопроведенияДокументов.ОбработатьДанныеДляПереходаНаНовуюВерсию
	|РегистрыНакопления.РасчетыПоФинансовымИнструментам.ОбработатьДанныеДляПереходаНаНовуюВерсию
	|РегистрыСведений.ВыполнениеОперацийЗакрытияМесяца.ОбработатьДанныеДляПереходаНаНовуюВерсию
	|РегистрыСведений.ЗаданияКЗакрытиюМесяца.ОбработатьДанныеДляПереходаНаНовуюВерсию
	|РегистрыСведений.УчетнаяПолитикаФинансовогоУчета.ОбработатьДанныеДляПереходаНаНовуюВерсию
	|РегистрыНакопления.ПрочиеДоходы.ОбработатьДанныеДляПереходаНаНовуюВерсию
	|РегистрыНакопления.ПрочиеДоходы.ОбработатьДанныеДляПереходаНаНовуюВерсию_ЗаданияКЗакрытиюМесяца
	|Справочники.ОперацииЗакрытияМесяца.ОбработатьДанныеДляПереходаНаНовуюВерсию";
...
Функция ОбработчикиОбновленияНеВлияющиеНаЗакрытиеМесяца() Экспорт
	...
	// Каждый обработчик обновления указывается на новой строке, запятые в конце строки не нужны	
	Обработчики = "
	|ЗакрытиеМесяцаСервер.ОбработатьДанныеДляПереходаНаНовуюВерсию
	|Справочники.ДоговорыКонтрагентов.ОбработатьДанныеДляПереходаНаНовуюВерсию
	|Документы.АктОРасхожденияхПослеПриемки.ПриДобавленииОбработчиковОбновления
	|Документы.ЗаказПоставщику.ОбработатьДанныеДляПереходаНаНовуюВерсию
	|Документы.АктОРасхожденияхПослеОтгрузки.ОбработатьДанныеДляПереходаНаНовуюВерсию
	|Документы.КорректировкаПриобретения.ОбработатьДанныеДляПереходаНаНовуюВерсию
	|Документы.КорректировкаРеализации.ОбработатьДанныеДляПереходаНаНовуюВерсию
	|Справочники.ОбъектыРасчетов.ОбработатьДанныеДляПереходаНаНовуюВерсию
	|Справочники.ВидыЦен.ОбработатьДанныеДляПереходаНаНовуюВерсию
	|Справочники.ВидыЗапасов.ОбработатьДанныеДляПереходаНаНовуюВерсию
	|Документы.ПриходныйОрдерНаТовары.ОбработатьДанныеДляПереходаНаНовуюВерсию
	|Документы.ПриобретениеТоваровУслуг.ОбработатьДанныеДляПереходаНаНовуюВерсию
	|Документы.СписаниеРасхожденийПоступлениеПриобретение.ОбработатьДанныеДляПереходаНаНовуюВерсию
	|Документы.СчетФактураПолученныйАванс.ОбработатьДанныеДляПереходаНаНовуюВерсию
	|Документы.ВзаимозачетЗадолженности.ОбработатьДанныеДляПереходаНаНовуюВерсию
	|Документы.ОтгрузкаТоваровКлиенту.ОбработатьДанныеДляПереходаНаНовуюВерсию
	|Документы.ЗаказНаПеремещение.ОбработатьДанныеДляПереходаНаНовуюВерсию
	|РегистрыНакопления.ВыручкаИСебестоимостьПродаж.ОбработатьДанныеДляПереходаНаНовуюВерсию
	|РегистрыНакопления.ЗапасыИПотребности.ОбработатьДанныеДляПереходаНаНовуюВерсию
	|РегистрыСведений.ДатыПоступленияТоваровОрганизаций.ОбработатьДанныеДляПереходаНаНовуюВерсию
	|
	|РегистрыСведений.РаспределениеЗапасов.ОбработатьДанныеДляПереходаНаНовуюВерсию
	|РегистрыСведений.СостоянияЗаказовПоставщикам.ОбработатьДанныеДляПереходаНаНовуюВерсию
	|РегистрыНакопления.ПланыОплатКлиентов.ОбработатьДанныеДляПереходаНаНовуюВерсию
	|РегистрыНакопления.ПланыОплатПоставщикам.ОбработатьДанныеДляПереходаНаНовуюВерсию
	|РегистрыНакопления.ВыручкаИСебестоимостьПродаж.ОбработатьДанныеДляПереходаНаНовуюВерсию
	...
	|УчетНДСЛокализация.СоздатьЭлементыСтавкиНДС
	|РегистрыСведений.ОчередьПереоформленияРасходныхОрдеров.ОбработатьДанныеДляПереходаНаНовуюВерсию
	|Справочники.НомераГТД.ОбработатьДанныеДляПереходаНаНовуюВерсию
	|РегистрыСведений.РаспоряженияНаОтгрузкуИВозвратКВыполнению.ОбработатьДанныеДляПереходаНаНовуюВерсию
	|";
...
Процедура ПриЗаполненииТиповОбщихДанныхПоддерживающихСопоставлениеСсылокПриЗагрузке(Типы) Экспорт
	...
	Типы.Добавить(Метаданные.Справочники.ОперацииЗакрытияМесяца);
...
// Выполняет заполнение состояния этапов в фоновом задании.
//
// Параметры:
//   ПараметрыЗапуска см.  Обработки.ОперацииЗакрытияМесяца.ИнициализироватьПараметрыЗапускаДляЗаполненияСостоянияЭтапов
//   ДополнительныеПараметры - Произвольный - дополнительные параметры фонового задания
//
Процедура ЗаполнитьСостоянияЭтаповВФоновомЗадании(ПараметрыЗапуска, ДополнительныеПараметры = Неопределено) Экспорт
...
Процедура ОбновитьСостояниеЗакрытияМесяца() Экспорт
	
	ОбщегоНазначения.ПриНачалеВыполненияРегламентногоЗадания(
		Метаданные.РегламентныеЗадания.ОбновлениеСостоянияЗакрытияМесяца);
	
	ПрошлыйМесяц = НачалоМесяца(ДобавитьМесяц(ТекущаяДатаСеанса(), -1));
	ЗапуститьОбновлениеСостоянияЗакрытияМесяца(ПрошлыйМесяц);
	
	ТекущийМесяц = НачалоМесяца(ТекущаяДатаСеанса());
	ЗапуститьОбновлениеСостоянияЗакрытияМесяца(ТекущийМесяц);
	
КонецПроцедуры

Процедура ЗапуститьОбновлениеСостоянияЗакрытияМесяца(Период)
	
	ОписаниеОрганизаций
		= Обработки.ОперацииЗакрытияМесяца.ОписаниеОрганизацийДляРасчета(Период, Истина);
		
	ДоступныеОрганизации = ОписаниеОрганизаций.ДоступныеОрганизации;
	
	СтруктураДанных = Обработки.ОперацииЗакрытияМесяца.ИнициализироватьСтруктуруДанныхДляЗаполненияСостоянияЭтапов(
		Период, Новый Массив(ДоступныеОрганизации),, Перечисления.РежимыЗакрытияМесяца.ОкончательноеЗакрытие);
	...
	ПараметрыЗапускаОбновленияСостояния.ОбновитьКэшСтатусовОпераций = Истина;
	
	НаименованиеЗадания = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
		НСтр("ru = 'Обновление состояния операций закрытия месяца %1'"),
...
Процедура ПроверитьНеобходимостьПереоценки(ОтносительныеКурсыВалют, Движения, Отказ) Экспорт
	...
	|	Т.Месяц КАК Месяц,
	|	Т.Организация КАК Организация,
	|	ЗНАЧЕНИЕ(Справочник.ОперацииЗакрытияМесяца.ПереоценкаДенежныхСредствИФинансовыхИнструментов) КАК Операция
	|ИЗ
	|	ВТИзменения КАК Т
	|
	|УПОРЯДОЧИТЬ ПО
...
Процедура ЗаполнитьГруппыПроверокДляРегистрации(ТаблицаГруппПроверок) Экспорт
	...
	ОписаниеГруппыПроверок.КонтекстПроверокВеденияУчета = Справочники.ОперацииЗакрытияМесяца.ПустаяСсылка();
	...
	Выборка = Справочники.ОперацииЗакрытияМесяца.Выбрать();
	
	Пока Выборка.Следующий() Цикл
		Если ЗначениеЗаполнено(Выборка.ИмяПредопределенныхДанных) Тогда
			ВсеЭтапы.Вставить(Выборка.Ссылка, Истина);
		КонецЕсли;
	КонецЦикла;
	...
	Для Каждого ТекущаяСтрока Из ТаблицаЭтапов Цикл
		...
		ОписаниеГруппыПроверок.Идентификатор = "Группа" + "_"
			+ Справочники.ОперацииЗакрытияМесяца.ПолучитьИмяПредопределенного(ТекущаяСтрока.Код);
	...
	Для Каждого КлючИЗначение Из ВсеЭтапы Цикл
		...
		ОписаниеГруппыПроверок.Идентификатор = "Группа" + "_" + Справочники.ОперацииЗакрытияМесяца.ПолучитьИмяПредопределенного(КлючИЗначение.Ключ);
...
Процедура ЗаполнитьПроверкиДляРегистрации(ТаблицаПроверок) Экспорт
	...
	НеоперативнаяОчередьЗаданий.ОписаниеПроверок_РасчетСуммДокументовВВалютахУчетаИПерепроведениеПоФинансовымРегистрам(ТаблицаПроверок);
	...
	ОперацииЗакрытияМесяца = Справочники.ОперацииЗакрытияМесяца.Выбрать();
	
	Пока ОперацииЗакрытияМесяца.Следующий() Цикл
		
		СинонимОперации = Строка(ОперацииЗакрытияМесяца.Ссылка);
		
		Если ЗначениеЗаполнено(ОперацииЗакрытияМесяца.ИмяПредопределенныхДанных) Тогда
			ОписаниеПроверки = ДобавитьОписаниеНовойПроверки(ТаблицаПроверок,
				ИдентификаторСлужебнойПроверкиЭтапа(ОперацииЗакрытияМесяца.Ссылка),
...
Функция ИдентификаторСлужебнойПроверкиЭтапа(ЭтапРасчета) Экспорт
	...
	Идентификатор =
		...
		+ Справочники.ОперацииЗакрытияМесяца.ПолучитьИмяПредопределенного(ЭтапРасчета);
...
Функция ОписаниеТехнологическихПараметровЗакрытияМесяца() Экспорт
	...
	ДополнитьОписаниеТехнологическихПараметровЗакрытияМесяца(ОписаниеПараметров);
	
	Возврат ОписаниеПараметров;
	
КонецФункции

Процедура ДополнитьОписаниеТехнологическихПараметровЗакрытияМесяца(ОписаниеПараметров)
	
	// В процедуре можно добавить новые технологические параметры закрытия месяца.
	// Это используется в расширениях для отладки расчета себестоимости.
	// Примеры описания параметров см. в функции ОписаниеТехнологическихПараметровЗакрытияМесяца().  
...
Функция РежимОтладкиРасчета() Экспорт
	...
	Возврат РасчетСебестоимостиПовтИсп.ЗначенияТехнологическихПараметров(Справочники.ОперацииЗакрытияМесяца.ПустаяСсылка()).РежимОтладки;
...
Функция ОбщиеПараметрыЗакрытияМесяца() Экспорт
	...
	Возврат РасчетСебестоимостиПовтИсп.ЗначенияТехнологическихПараметров(Справочники.ОперацииЗакрытияМесяца.ПустаяСсылка());
...
// Заполняет колонку "Этап" именем значения Справочники.ОперацииЗакрытияМесяца.
// 
// Параметры:
...
Процедура ЗаполнитьКолонкуИмениЭтапаДляТестирования(Таблица, КолонкаЭтапа)
	...
	Для Каждого Строка Из Таблица Цикл
		Строка.Этап = Справочники.ОперацииЗакрытияМесяца.ПолучитьИмяПредопределенного(Строка[КолонкаЭтапа]);
	КонецЦикла;
...
Функция ТекстОшибкиЗаписиЗаданияВЗаблокированномПериоде(Организация, ПериодЗадания, ПериодБлокировки, ИмяРегистраЗаданий = Неопределено, ИзменяемыйДокумент = Неопределено) Экспорт
	...
	Иначе
		ТекстОшибки = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			...
			Метаданные.РегистрыСведений[ИмяРегистраЗаданий].Представление(),
			Организация,
			ЗакрытиеМесяцаКлиентСервер.ПредставлениеПериодаМесяцГод(ПериодЗадания),
			ЗакрытиеМесяцаКлиентСервер.ПредставлениеПериодаМесяцГод(КонецМесяца(ПериодБлокировки) + 1));
	КонецЕсли;
...
Процедура ЗарегистрироватьДанныеКОбработке(Параметры) Экспорт
	...
	Запрос = Новый Запрос;
	Запрос.УстановитьПараметр("НеиспользуемыеОперации", Справочники.ОперацииЗакрытияМесяца.НеиспользуемыеОперации());
...
// Используется при автотестировании - позволяет отключить проверки закрытия месяца, что позволяет значительно ускорить тестирование.
// 
// Возвращаемое значение:
//  Булево - Упрощенное автотестирование
Функция УпрощенноеАвтотестирование() Экспорт
	Возврат Ложь;
КонецФункции
