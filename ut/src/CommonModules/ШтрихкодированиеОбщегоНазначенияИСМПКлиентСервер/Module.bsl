...
//  ВидПродукции - СправочникСсылка.ВидыПродукцииИС - по данному параметру будет проходить отбор заполнения
...
Процедура ДополнитьПараметрамиСканированияИСМП(ПараметрыСканирования) Экспорт
	...
	ПараметрыСканирования.Вставить("ИспользуетсяРаспределениеКодовПоТоварамСУчетомМРЦ",                  Ложь);
	...
	ПараметрыСканирования.Вставить("ИмяКолонкиМРЦ",                                          Неопределено);
...
#Область ПроверкаКодовМаркировкиСредствамиККТ
...
// * Сумма - Число - сумма для проверки МРЦ
...
Функция ГруппаСтатусаРазрешительнойДокументацииРазрешенаДляОборота(ГруппаСтатуса) Экспорт
	...
	Если Не ГруппаСтатуса = ПредопределенноеЗначение("Перечисление.ГруппыСтатусовРазрешительныхДокументовИСМП.КрасныйСтатус")
		И Не ГруппаСтатуса = ПредопределенноеЗначение("Перечисление.ГруппыСтатусовРазрешительныхДокументовИСМП.ПустаяСсылка") Тогда
		Возврат Истина;
	КонецЕсли;
...
Функция ВыполняемыеОперацииПроверкиСредствамиККТ() Экспорт
	...
	ВозвращаемоеЗначение.Вставить("ПроверкаМРЦ",                 "ПроверкаМРЦ");
...
// * СтрокаНазначения     - см. ШтрихкодированиеИСКлиентСервер.НовыйРезультатРаспределенияШтрихкодовПоТоварам
//                        - см. ШтрихкодированиеОбщегоНазначенияИСМПКлиентСервер.НовыйЭлементДанныхПроверкиСредствамиККТ - Коллекция свойств, в составе которых присутствует свойство: КодЕдиницыИзмерения.
