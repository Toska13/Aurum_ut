...
Процедура ПриОпределенииМетодовРазрешенныхДляВызоваКакПроизвольныйКод(Методы) Экспорт
	...
	Методы.Вставить("НайтиВариантыСопоставленияНоменклатуры", Истина);
...
Функция ЗапуститьПерезаполнениеСловаряСопоставленияНоменклатурыВФоне(Знач УникальныйИдентификатор = Неопределено) Экспорт
	...
	Возврат ДлительныеОперации.ВыполнитьФункцию(ПараметрыВыполнения, 
		"СопоставлениеНоменклатурыКонтрагентовСлужебный.ПерезаполнениеСловаряСопоставленияНоменклатуры");
