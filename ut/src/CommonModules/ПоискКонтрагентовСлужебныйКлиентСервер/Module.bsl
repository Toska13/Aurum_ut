...
//    * Ключ - Строка - строковое представление вида сравнения. Может принимать следующие значения: Равно, Больше,
...
//    * РеквизитПометка - Строка - имя реквизита формы, отвечающего за пометку использования критерия отбора.
...
//    * ВыборИзСправочника - Булево - Истина, если критерий отбора необходимо заполнять значением из веб-справочника.
...
//    * ПредставлениеЗначения - Произвольный - представление значения для отображения пользователю.
//        Используется для критериев, значение которых необходимо выбирать из веб-справочников.
//    * ПредставлениеЗначенияСписка - Произвольный - представление значения, для отображения пользователю,
//        если оно задано списком. Используется для критериев, значение которых необходимо выбирать из веб-справочников.
...
Функция НовыйОписаниеБыстрогоОтбора() Экспорт
	...
	Результат.Вставить("РеквизитПометка",             "");
