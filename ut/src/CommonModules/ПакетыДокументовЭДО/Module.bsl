...
Процедура ПриОпределенииМетодовРазрешенныхДляВызоваКакПроизвольныйКод(Методы) Экспорт
	...
	Методы.Вставить("ДобавитьДокументыВПакет", Истина);
	Методы.Вставить("СоздатьПакетДокументов", Истина);
	Методы.Вставить("УдалитьДокументИзПакета", Истина);
...
Процедура ЗагрузитьДокументыПакета(СвойстваДокументовДляОписанияПакета, ЗакрытыйПакет) Экспорт
	ПакетыДокументовЭДОСлужебный.ЗагрузитьДокументыПакета(СвойстваДокументовДляОписанияПакета, ЗакрытыйПакет);
КонецПроцедуры

// Параметры:
//  ИдентификаторПакета - УникальныйИдентификатор
//  ЭлектронныеДокументы - Массив из ДокументСсылка.ЭлектронныйДокументВходящийЭДО,ДокументСсылка.ЭлектронныйДокументИсходящийЭДО
Процедура ОбъединитьДокументыВПакет(ИдентификаторПакета, ЭлектронныеДокументы) Экспорт
	...
	ТекущиеДокументыПакета = ДокументыПакета(ИдентификаторПакета);
...
// Возвращает признак того, что пакет имеет признак ЗакрытыйПакет
//
// Параметры:
//  ИдентификаторПакета - УникальныйИдентификатор
// 
...
Функция ЭтоЗакрытыйПакет(ИдентификаторПакета) Экспорт
	...
	Запрос.Текст = 
	"ВЫБРАТЬ
	|	ПакетыДокументовЭДО.ЗакрытыйПакет КАК ЗакрытыйПакет
	|ИЗ
