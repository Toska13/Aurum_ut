...
// Определяет возможность использования онлайн-подбора из классификатора ТНВЭД.
//
// Возвращаемое значение:
//   Булево - доступность онлайн-подбора.
//
Функция ДоступенОнлайнПодборИзКлассификатораТНВЭД() Экспорт
	...
	РаботаСНоменклатуройСлужебный.ВыполнитьКомандуСервиса(ПараметрыКоманды, Отказ);
...
Функция ПолучитьРазделыТНВЭДВФоне(УникальныйИдентификатор, ИдентификаторЗадания) Экспорт
	...
	Возврат ДлительныеОперации.ВыполнитьВФоне("ОблачныеКлассификаторы.ПолучитьРазделыТНВЭД", 
		Неопределено, 
		ПараметрыВыполнения);
...
Функция ПолучитьПодчиненныеЭлементыТНВЭДВФоне(Код, УникальныйИдентификатор, ИдентификаторЗадания) Экспорт
	...
	Возврат ДлительныеОперации.ВыполнитьВФоне("ОблачныеКлассификаторы.ПолучитьПодчиненныеЭлементыТНВЭД", 
		ПараметрыПроцедуры, 
		ПараметрыВыполнения);
...
//   НомерСтраницы           - Число - номер страницы для страничной загрузки.
//   УникальныйИдентификатор - УникальныйИдентификатор - уникальный идентификатор формы.
//   ИдентификаторЗадания    - УникальныйИдентификатор - идентификатор задания.
// 
// Возвращаемое значение:
...
Функция ОбработатьПоисковыйЗапросТНВЭДВФоне(СтрокаПоиска, НомерСтраницы, УникальныйИдентификатор,
	...
	Возврат ДлительныеОперации.ВыполнитьВФоне("ОблачныеКлассификаторы.ОбработатьПоисковыйЗапросТНВЭД", 
		ПараметрыПроцедуры, 
		ПараметрыВыполнения);
...
Функция ПолучитьВеткуТНВЭДВФоне(Код, АдресКэша, РежимВыбораЭлемента, УникальныйИдентификатор,
	...
	Возврат ДлительныеОперации.ВыполнитьВФоне("ОблачныеКлассификаторы.ПолучитьВеткуТНВЭД", 
		ПараметрыПроцедуры, 
		ПараметрыВыполнения);
...
//
// Параметры: 
//   АдресКэша               - Строка - если загрузка вызвана из режима поиска, то адрес кэша результата поискового 
//                               запроса, иначе - адрес временного хранилища формы.
//   ВыбранныеЭлементы       - Массив из Число - идентификаторы элементов классификатора, отмеченных к загрузке.
//   УникальныйИдентификатор - УникальныйИдентификатор - уникальный идентификатор формы.
//   ИдентификаторЗадания    - УникальныйИдентификатор - идентификатор задания.
//   ОбновитьКэш             - Булево - обновлять ли кэш результата поискового запроса.
// 
// Возвращаемое значение:
//   См. ДлительныеОперации.ВыполнитьВФоне.
//
Функция ЗагрузитьВБазуДанныеТНВЭДВФоне(АдресКэша, ВыбранныеЭлементы, УникальныйИдентификатор, ИдентификаторЗадания, 
			ОбновитьКэш) Экспорт
	...
	Возврат ДлительныеОперации.ВыполнитьВФоне("ОблачныеКлассификаторы.ЗагрузитьВБазуДанныеТНВЭД", 
		ПараметрыПроцедуры, 
		ПараметрыВыполнения);
...
Функция ДоступенОнлайнПодборИзОКПД2() Экспорт
	...
	ПоддержкаПодключена = МодульИнтернетПоддержкаПользователей.ЗаполненыДанныеАутентификацииПользователяИнтернетПоддержки();
...
Функция ПолучитьРазделыОКПД2ВФоне(УникальныйИдентификатор, ИдентификаторЗадания) Экспорт
	...
	Возврат ДлительныеОперации.ВыполнитьВФоне("ОблачныеКлассификаторы.ПолучитьРазделыОКПД2", 
		Неопределено, 
		ПараметрыВыполнения);
...
Функция ПолучитьПодчиненныеЭлементыОКПД2ВФоне(Код, УникальныйИдентификатор, ИдентификаторЗадания) Экспорт
	...
	Возврат ДлительныеОперации.ВыполнитьВФоне("ОблачныеКлассификаторы.ПолучитьПодчиненныеЭлементыОКПД2", 
		ПараметрыПроцедуры, 
		ПараметрыВыполнения);
...
Функция ОбработатьПоисковыйЗапросОКПД2ВФоне(СтрокаПоиска, НомерСтраницы, УникальныйИдентификатор,
	...
	Возврат ДлительныеОперации.ВыполнитьВФоне("ОблачныеКлассификаторы.ОбработатьПоисковыйЗапросОКПД2", 
		ПараметрыПроцедуры, 
		ПараметрыВыполнения);
...
Функция ПолучитьВеткуОКПД2ВФоне(Код, АдресКэша, РежимВыбораЭлемента, УникальныйИдентификатор,
	...
	Возврат ДлительныеОперации.ВыполнитьВФоне("ОблачныеКлассификаторы.ПолучитьВеткуОКПД2", 
		ПараметрыПроцедуры, 
		ПараметрыВыполнения);
...
//    * АдресКэша                - Строка - если загрузка вызвана из режима поиска, то адрес кэша результата поискового 
//                                   запроса, иначе - адрес временного хранилища формы.
//    * АдресДополнительногоКэша - Строка - адрес временного хранилища формы. 
//    * ВыбранныеЭлементы        - Массив из Число - идентификаторы элементов классификатора, отмеченных к загрузке.
//    * ЗагружатьСИерархией      - Булево - признак того, что помимо элементов, помеченных к загрузке, в базу будут 
//                                   перенесены и все их предки.
//    * ПереноситьПодчиненные    - Булево - признак того, что помимо элементов, помеченных к загрузке, в базу будут 
//                                   перенесены все их потомки.
//   УникальныйИдентификатор - УникальныйИдентификатор - уникальный идентификатор формы.
//   ИдентификаторЗадания    - УникальныйИдентификатор - идентификатор задания.
//   ОбновитьКэш             - Булево - обновлять ли кэш результата поискового запроса.
// 
...
//   См. ДлительныеОперации.ВыполнитьВФоне.
//
Функция ЗагрузитьВБазуДанныеОКПД2ВФоне(ПараметрыЗагрузки, УникальныйИдентификатор, ИдентификаторЗадания, 
			ОбновитьКэш) Экспорт
	...
	Возврат ДлительныеОперации.ВыполнитьВФоне("ОблачныеКлассификаторы.ЗагрузитьВБазуДанныеОКПД2", 
		ПараметрыПроцедуры, 
		ПараметрыВыполнения);
...
// Проверяет возможность использования онлайн-подбора из ОКЕИ.
//
// Возвращаемое значение:
//   Булево - возможность использования онлайн-подбора.
//
Функция ДоступенОнлайнПодборИзОКЕИ() Экспорт
	...
	ПараметровЗапроса = ОблачныеКлассификаторыСлужебный.ОписаниеПараметровЗапросаЭлементовОКЕИ();
	ПараметровЗапроса.Коды              = ОбщегоНазначенияКлиентСервер.ЗначениеВМассиве("796");
	ПараметровЗапроса.НаборПолей        = РаботаСНоменклатуройСлужебный.НаборПолейСтандартный();
	ПараметровЗапроса.КоличествоЗаписей = 1;
	
	ПараметрыКоманды = ОблачныеКлассификаторыСлужебный.ПараметрыЗапросаЭлементовОКЕИ(ПараметровЗапроса);
	...
	Возврат Не Отказ И ДанныеСервиса.Количество() > 0;
...
//
Функция ПолучитьИерархиюЭлементовОКЕИВФоне(УникальныйИдентификатор, ИдентификаторЗадания, 
			ДополнительныеПараметры = Неопределено) Экспорт
	
	ОтменитьВыполнениеЗадания(ИдентификаторЗадания);
	
	ПараметрыВыполнения = ДлительныеОперации.ПараметрыВыполненияВФоне(УникальныйИдентификатор);
	ПараметрыВыполнения.НаименованиеФоновогоЗадания  = НСтр("ru = 'Получение данных облачного классификатора единиц измерения.'");
	ПараметрыВыполнения.ОжидатьЗавершение            = 0;
	ПараметрыВыполнения.ЗапуститьВФоне               = Истина;
	ПараметрыВыполнения.ПрерватьВыполнениеЕслиОшибка = Истина;
	
	Возврат ДлительныеОперации.ВыполнитьФункцию(ПараметрыВыполнения, 
		"ОблачныеКлассификаторы.ПолучитьИерархиюЭлементовОКЕИ", 
...
//   См. ДлительныеОперации.ВыполнитьФункцию.
//
Функция ЗагрузитьВБазуДанныеОКЕИВФоне(УникальныйИдентификатор, ИдентификаторЗадания, АдресВременногоХранилища,
			ДополнительныеПараметры = Неопределено) Экспорт
	
	ОтменитьВыполнениеЗадания(ИдентификаторЗадания);
	
	ПараметрыВыполнения = ДлительныеОперации.ПараметрыВыполненияВФоне(УникальныйИдентификатор);
	ПараметрыВыполнения.НаименованиеФоновогоЗадания  = НСтр("ru = 'Загрузка данных облачного классификатора единиц измерения.'");
	ПараметрыВыполнения.ОжидатьЗавершение            = 0;
	ПараметрыВыполнения.ЗапуститьВФоне               = Истина;
	ПараметрыВыполнения.ПрерватьВыполнениеЕслиОшибка = Истина;
	
	Возврат ДлительныеОперации.ВыполнитьФункцию(ПараметрыВыполнения, 
		"ОблачныеКлассификаторы.ЗагрузитьВБазуДанныеОКЕИ",
...
// Отменяет выполнения регламентного задания.
//
// Параметры:
//   ИдентификаторЗадания - УникальныйИдентификатор - идентификатор задания.
//
