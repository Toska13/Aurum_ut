...
//
// Параметры:
// 	СоответствиеИмен - Соответствие Из КлючИЗначение- ключом выступает имя реквизита, используемое в настройке счетов учета,
...
//
// Параметры:
// 	СписокТипов - СписокЗначений Из Строка - Список типов аналитик:
...
Процедура УправлениеЭлементамиФормы(Форма) Экспорт
	...
	НаПродажиРегл = (ВариантРаспределенияРегл = Перечисления.ВариантыРаспределенияРасходов.НаСебестоимостьПродаж);
