...
// * ДопустимыеВидыПродукции - Массив Из СправочникСсылка.ВидыПродукцииИС - Допустимые виды продукции, которые поддерживает контекст
...
// * ЭтоСканированиеВФормеПроверкиИПодбора - Булево - Истина, если это сканирование в форме фПиП
...
Функция БазовыеПараметрыСканирования() Экспорт
	...
	БазовыеПараметры.Вставить("ЭтоСканированиеВФормеПроверкиИПодбора",           Ложь);
	...
	БазовыеПараметры.Вставить("ВыполняетсяЗагрузкаДанныхВФормуПроверкиИПодбора", Ложь);
	БазовыеПараметры.Вставить("ПоддерживаетсяОбъемноСортовойУчет",               Ложь);
	
	БазовыеПараметры.Вставить("Сценарий", 0);
	БазовыеПараметры.Вставить("ЕГАИС", Ложь);
	БазовыеПараметры.Вставить("ИСМП", Ложь);
	БазовыеПараметры.Вставить("Прочее", Ложь);
...
Процедура ЗаполнитьБазовыеПараметрыСканирования(ПараметрыСканирования, Контекст) Экспорт
	...
	Если ЭтоФормаПроверкиИПодбора(Контекст) Тогда
		...
		ПараметрыСканирования.Сценарий = Контекст.ФормаПроверкиИПодбора.Сценарий;
	...
	ИначеЕсли ЭтоФормаСУказаниемСценария(Контекст) Тогда
	...
	ИначеЕсли ТипЗнч(Контекст) = Тип("Структура")
		И ОбщегоНазначенияКлиентСервер.ЕстьРеквизитИлиСвойствоОбъекта(Контекст, "Ссылка") Тогда
			
		ПараметрыСканирования.СсылкаНаОбъект = Контекст.Ссылка;
...
// Условно существующий параметр Заполнять МРЦ.
// 
// Параметры:
//  ПараметрыСканирования - См. БазовыеПараметрыСканирования
// 
// Возвращаемое значение:
//  Булево - Заполнять МРЦ
Функция ЗаполнятьМРЦ(ПараметрыСканирования) Экспорт
	
	Возврат ПараметрыСканирования.ИСМП
		И ОбщегоНазначенияИСКлиентСервер.ПересечениеМассивов(
			ПараметрыСканирования.ДопустимыеВидыПродукции, КонструкторИСОбщегоНазначенияКлиентСервер.ВидыПродукцииМОТП()
		).Количество() > 0;
	
КонецФункции

// Условно существующий параметр Заполнять срок годности.
// 
// Параметры:
//  ПараметрыСканирования - См. БазовыеПараметрыСканирования
// 
// Возвращаемое значение:
//  Булево - Заполнять срок годности
Функция ЗаполнятьСрокГодности(ПараметрыСканирования) Экспорт
...
// Условно существующий параметр Заполнять данные ВетИС
// 
// Параметры:
//  ПараметрыСканирования - См. БазовыеПараметрыСканирования
// 
// Возвращаемое значение:
//  Булево - Заполнять данные ВетИС
Функция ЗаполнятьДанныеВЕТИС(ПараметрыСканирования) Экспорт
...
// Условно существующий параметр Это маркировка товаров ИСМП
// 
// Параметры:
//  ПараметрыСканирования - См. БазовыеПараметрыСканирования
// 
// Возвращаемое значение:
//  Булево - это маркировка товаров ИС МП
Функция ЭтоМаркировкаТоваровИСМП(ПараметрыСканирования) Экспорт
	
	Возврат ПараметрыСканирования.ИСМП
		И ПараметрыСканирования.ЭтоМаркировкаТоваровИСМП;
	
КонецФункции

// Условно существующий параметр Запрашивать алкогольную продукцию
// 
// Параметры:
//  ПараметрыСканирования - См. БазовыеПараметрыСканирования
// 
// Возвращаемое значение:
//  Булево - запрашивать алкогольную продукцию
Функция ЗапрашиватьАлкогольнуюПродукцию(ПараметрыСканирования) Экспорт
	
	Возврат ПараметрыСканирования.ЕГАИС
		И ПараметрыСканирования.ЗапрашиватьАлкогольнуюПродукцию;
	
КонецФункции

// Условно существующий параметр Запрашивать справку 2
// 
// Параметры:
//  ПараметрыСканирования - См. БазовыеПараметрыСканирования
// 
// Возвращаемое значение:
//  Булево - запрашивать справку 2
Функция ЗапрашиватьСправку2(ПараметрыСканирования) Экспорт
	
	Возврат ПараметрыСканирования.ЕГАИС
		И ПараметрыСканирования.ЗапрашиватьСправку2;
	
КонецФункции

// Условно существующий параметр Вид операции ИСМП
// 
// Параметры:
//  ПараметрыСканирования - См. БазовыеПараметрыСканирования
// 
// Возвращаемое значение:
//  ПеречислениеСсылка.ВидыОперацийИСМП, Неопределено - вид операции ИСМП
Функция ВидОперацииИСМП(ПараметрыСканирования) Экспорт
	
	Возврат ?(ПараметрыСканирования.ИСМП, ПараметрыСканирования.ВидОперацииИСМП, Неопределено);
	
КонецФункции

// Условно существующий параметр Это проверка кодов маркировки ИСМП
// 
// Параметры:
//  ПараметрыСканирования - См. БазовыеПараметрыСканирования
// 
// Возвращаемое значение:
//  Булево - это проверка кодов маркировки
Функция ЭтоПроверкаКодовМаркировкиИСМП(ПараметрыСканирования) Экспорт
...
// Условно существующий параметр Это отчет производственной линии
// 
// Параметры:
//  ПараметрыСканирования - См. БазовыеПараметрыСканирования
// 
// Возвращаемое значение:
//  Булево - это отчет производственной линии
Функция ЭтоОтчетПроизводственнойЛинии(ПараметрыСканирования) Экспорт
	
	Возврат ПараметрыСканирования.ИСМП
		И ПараметрыСканирования.ЭтоОтчетПроизводственнойЛинии;
...
// Дополняет штрихкод (EAN) лидирующими нулями до формата GTIN (14 цифр).
//    Не дополняет пустой штрихкод. Возвращает пустую строку для длинных штрихкодов.
//
// Параметры:
//  Штрихкод - Строка - Значение штрихкода EAN.
// Возвращаемое значение:
//  Строка - GTIN.
Функция GTINПоШтрихкодуEAN(Знач Штрихкод) Экспорт
	
	ДлинаШтрихкода = СтрДлина(Штрихкод);
	Если ДлинаШтрихкода > 14 Или ДлинаШтрихкода = 0 Тогда
		Возврат "";
	ИначеЕсли ДлинаШтрихкода = 14 Тогда 
		Возврат Штрихкод;
	КонецЕсли;
	
	Возврат Лев("0000000000000", 14 - ДлинаШтрихкода) + Штрихкод;
	
КонецФункции

// Дополняет штрихкод EAN до кода ОСУ.
// 
// Параметры:
//  ШтрихкодEAN - Строка - Значение штрихкода EAN.
//  Количество - Число   - Количество кодов маркировки.
//  Скобки - Булево      - Формат кода со скобками.
// 
// Возвращаемое значение:
//  Строка - сформированный код ОСУ.
Функция ОСУПоШтрихкодуEAN(Знач ШтрихкодEAN, Знач Количество = 1, Знач Скобки = Истина) Экспорт
	
	GTIN = GTINПоШтрихкодуEAN(ШтрихкодEAN);
	КоличествоСтрокой = Формат(Количество, "ЧДЦ=0; ЧН=0; ЧГ=0");
	Если Скобки Тогда
		Возврат СтрШаблон("(02)%1(37)%2", GTIN, КоличествоСтрокой);
	Иначе
		ЭлементыКМ = Новый Массив;
		ЭлементыКМ.Добавить("02");
		ЭлементыКМ.Добавить(GTIN);
		ЭлементыКМ.Добавить("37");
		ЭлементыКМ.Добавить(КоличествоСтрокой);
...
// Полный код маркировки должен быть обернут в base64
// Параметры:
//  СтрокаДанных - Структура, СтрокаТаблицыЗначений - Строка данных
Процедура ЗаменитьПроверитьПолныйКодМаркировки(СтрокаДанных) Экспорт
	
	Если СтрНачинаетсяС(СтрокаДанных.ПолныйКодМаркировки, "01") Тогда
		СтрокаДанных.ПолныйКодМаркировки = ШтрихкодВBase64(СтрокаДанных.ПолныйКодМаркировки);
	КонецЕсли;
...
// Параметры:
//  ПараметрыСканирования - (См. ШтрихкодированиеОбщегоНазначенияИСКлиент.ПараметрыСканирования)
//  ВидПродукцииИС - СправочникСсылка.ВидыПродукцииИС - Вид продукции
...
Функция ДопустимВидПродукции(ПараметрыСканирования, ВидПродукцииИС) Экспорт
	...
	Если ТипЗнч(ВидПродукцииИС) = Тип("Массив") Тогда
		Для каждого ВидПродукции Из ВидПродукцииИС Цикл
...
Функция ДопустимаПродукцияИСМП(ПараметрыСканирования, ВключаяТабачнуюПродукцию = Ложь) Экспорт
	...
	Для Каждого ВидПродукции Из ПараметрыСканирования.ДопустимыеВидыПродукции Цикл
		Если КонструкторИСОбщегоНазначенияКлиентСервер.ЭтоПродукцияИСМП(ВидПродукции, ВключаяТабачнуюПродукцию) Тогда
			Возврат Истина;
		КонецЕсли;
	КонецЦикла;
...
Функция ТипШтрихкодаПоСтроке(ТипШтрихкодаСтрокой) Экспорт
	...
	ИначеЕсли ТипШтрихкодаСтрокой = "SSCC18" Тогда
		ЗначениеВозврата = ПредопределенноеЗначение("Перечисление.ТипыШтрихкодов.SSCC18");
	ИначеЕсли ТипШтрихкодаСтрокой = "SSCC20" Тогда
		ЗначениеВозврата = ПредопределенноеЗначение("Перечисление.ТипыШтрихкодов.SSCC20");
...
Функция ЭтоСтрокаДанныхЧастичногоВыбытия(СтрокаДанных, ПараметрыСканирования, ПроверятьФлагВыбытия = Ложь) Экспорт
...
//  ВидПродукции - СправочникСсылка.ВидыПродукцииИС, СправочникСсылка.КлючиВидовПродукцииИС - вид продукции
// 
// Возвращаемое значение:
//  Неопределено - Операция ИС
...
Функция ПараметрыОткрытияФормыУточненияДанных() Экспорт
	...
	// Реквизиты ЕГАИС
	ПараметрыОткрытия.Вставить("АлкогольнаяПродукция", Неопределено);
	ПараметрыОткрытия.Вставить("Справка2",             Неопределено);
...
// Элемент уточнения неуникального штрихкода.
// 
// Возвращаемое значение:
//  Структура - Элемент уточнения неуникального штрихкода:
// * Номенклатура - Произвольный - 
// * Характеристика - Произвольный - 
// * Серия - Произвольный -
// * Упаковка - Произвольный -
// * ПредставлениеНоменклатуры - Произвольный -
// * ВидПродукции - Произвольный -
// * ОбработатьБезМаркировки - Произвольный -
Функция ЭлементУточненияНеуникальногоШтрихкода() Экспорт
	...
	Результат.Вставить("ОбработатьБезМаркировки");
	Возврат Результат;
...
Функция ЭтоФормаСУказаниемСценария(Контекст) Экспорт
	
	Если ТипЗнч(Контекст) <> Тип("Структура") Тогда
		Возврат Ложь;
	ИначеЕсли Не Контекст.Свойство("Сценарий") Тогда
		Возврат Ложь;
	ИначеЕсли Не Контекст.Свойство("Контекст") Тогда
		Возврат Ложь;
	КонецЕсли;
...
Функция КонтекстФормыСУказаниемСценария(Форма, Сценарий) Экспорт
	
	Результат = Новый Структура;
	Результат.Вставить("Сценарий", Сценарий);
	Результат.Вставить("Контекст", Форма);
	Возврат Результат;
	
КонецФункции

Процедура ЗаполнитьОрганизациюПараметровСканированияПриНеобходимостиПоДаннымФормыПроверкиИПодбора(ПараметрыСканирования, ФормаПроверкиИПодбора) Экспорт
	
	Если ЗначениеЗаполнено(ПараметрыСканирования.Организация) Тогда
		Возврат;
	КонецЕсли;
	
	Если Не ОбщегоНазначенияКлиентСервер.ЕстьРеквизитИлиСвойствоОбъекта(ФормаПроверкиИПодбора, "Организация") Тогда
		Возврат;
	КонецЕсли;
	
	Если Не ЗначениеЗаполнено(ФормаПроверкиИПодбора.Организация) Тогда
		Возврат;
	КонецЕсли;
	
	ПараметрыСканирования.Организация = ФормаПроверкиИПодбора.Организация;
	
КонецПроцедуры

Функция ТекстОшибкиНеЗагруженКлассификаторПоВидуПродукции(ВидПродукции) Экспорт
	
	Если ТипЗнч(ВидПродукции) = Тип("Массив") Тогда
		
		СписокВидовПродукции = СтрСоединить(ВидПродукции, ", ");
		Возврат
			СтрШаблон(НСтр("ru = 'Не загружены данные классификатора по товарным группам: ""%1"".'"), СписокВидовПродукции);
		
	Иначе
		
		Возврат
			СтрШаблон(НСтр("ru = 'Не загружены данные классификатора по товарной группе: ""%1"".'"), ВидПродукции);
