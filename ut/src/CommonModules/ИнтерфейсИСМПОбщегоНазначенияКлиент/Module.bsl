...
Процедура МестаОсуществленияДеятельности(ПараметрыЗапроса) Экспорт
	...
	ПараметрыОбработки.ТоварнаяГруппа = ПараметрыЗапроса.Параметры.ТоварнаяГруппа;
...
Процедура ВыполнитьАвторизациюГИСМТ(ПараметрыЗапроса) Экспорт
	...
	ПараметрыОбработки.ТоварнаяГруппа = ПараметрыЗапроса.Параметры;
...
// Получает включенные товарные группы по организации.
// 
// Параметры:
//  ПараметрыЗапроса - см. ИнтерфейсИСМПОбщегоНазначенияКлиент.ПараметрыЗапросаДанных.
Процедура ТоварныеГруппыОрганизации(ПараметрыЗапроса) Экспорт
	
	ПараметрыОбработки                                     = ПараметрыОбработкиЗапросаДанных(ПараметрыЗапроса);
	ДоступныеМетодыИнтерфейса                              = ИнтерфейсИСМПОбщегоНазначенияКлиентСервер.ДоступныеМетодыИнтерфейса();
	ПараметрыОбработки.ИмяОбработчика                      = ДоступныеМетодыИнтерфейса.ТоварныеГруппыПоОрганизации;
	ПараметрыОбработки.УникальныйИдентификатор             = ПараметрыЗапроса.УникальныйИдентификатор;
	ПараметрыОбработки.ВыполнениеВФоне                     = Истина;
...
// Регистрирует места осуществления деятельности в ГИС МТ (метод добавления).
// Результат выполнения операции будет передан в ОписаниеОповещения в переданном параметре.
// 
// Параметры:
//  ПараметрыЗапроса - (см. ИнтерфейсИСМПОбщегоНазначенияКлиент.ПараметрыЗапросаДанных).
Процедура РегистрацияМестОсуществленияДеятельностиГИСМТ(ПараметрыЗапроса) Экспорт
	
	ПараметрыОбработки                = ПараметрыОбработкиЗапросаДанных(ПараметрыЗапроса);
	ДоступныеМетодыИнтерфейса         = ИнтерфейсИСМПОбщегоНазначенияКлиентСервер.ДоступныеМетодыИнтерфейса();
	ПараметрыОбработки.ИмяОбработчика = ДоступныеМетодыИнтерфейса.РегистрацияМестОсуществленияДеятельностиГИСМТ;
	
	ОбработкаМетодаИнтерфейсаСАвторизацией(ПараметрыЗапроса, ПараметрыОбработки);
	
КонецПроцедуры

// Удаляет место осуществления деятельности в ГИС МТ (метод удаления).
// Результат выполнения операции будет передан в ОписаниеОповещения в переданном параметре.
// 
// Параметры:
//  ПараметрыЗапроса - (см. ИнтерфейсИСМПОбщегоНазначенияКлиент.ПараметрыЗапросаДанных).
Процедура УдалениеМестОсуществленияДеятельностиГИСМТ(ПараметрыЗапроса) Экспорт
	
	ПараметрыОбработки                = ПараметрыОбработкиЗапросаДанных(ПараметрыЗапроса);
	ДоступныеМетодыИнтерфейса         = ИнтерфейсИСМПОбщегоНазначенияКлиентСервер.ДоступныеМетодыИнтерфейса();
	ПараметрыОбработки.ИмяОбработчика = ДоступныеМетодыИнтерфейса.УдалениеМестаОсуществленияДеятельностиГИСМТ;
	
	ОбработкаМетодаИнтерфейсаСАвторизацией(ПараметрыЗапроса, ПараметрыОбработки);
	
КонецПроцедуры

// Получает места осуществления деятельности из ГИС МТ (метод получения списка) и для сырья.
// Результат выполнения операции будет передан в ОписаниеОповещения в переданном параметре.
// 
// Параметры:
//  ПараметрыЗапроса - (см. ИнтерфейсИСМПОбщегоНазначенияКлиент.ПараметрыЗапросаДанных).
Процедура АктуализацияСпискаМестОсуществленияДеятельности(ПараметрыЗапроса) Экспорт
	
	ПараметрыОбработки                = ПараметрыОбработкиЗапросаДанных(ПараметрыЗапроса);
	ДоступныеМетодыИнтерфейса         = ИнтерфейсИСМПОбщегоНазначенияКлиентСервер.ДоступныеМетодыИнтерфейса();
	ПараметрыОбработки.ИмяОбработчика = ДоступныеМетодыИнтерфейса.АктуализацияСпискаМестОсуществленияДеятельности;
	ПараметрыОбработки.ТоварнаяГруппа = ПараметрыЗапроса.Параметры.ТоварнаяГруппа;
...
Процедура ОбработкаМетодаИнтерфейсаСАвторизацией(ПараметрыЗапроса, ПараметрыОбработки)
	...
	ИначеЕсли Не ПараметрыЗапроса.ВыполнениеНаКлиенте Тогда
		Если Не (ПараметрыОбработки.ВызовПослеАвторизации И ЗначениеЗаполнено(ПараметрыОбработки.ТекстОшибки)) Тогда
...
Асинх Процедура ЗапросМетодаИнтерфейсаСОбработкой(ПараметрыОбработки, ПараметрыЗапроса, АсинхронныйЗапуск) Экспорт
	...
	ИначеЕсли ПараметрыОбработки.ИмяОбработчика = ДоступныеМетодыИнтерфейса.АктуализацияСпискаМестОсуществленияДеятельности Тогда
...
Процедура ОжидатьВыполненияМетодаИнтерфейсаСАвторизацией(ПараметрыЗапроса, ПараметрыОбработки)
	...
	Если ПараметрыОбработки.ДлительнаяОперация <> Неопределено Тогда
		...
		ДоступныеМетодыИнтерфейса              = ИнтерфейсИСМПОбщегоНазначенияКлиентСервер.ДоступныеМетодыИнтерфейса();
		Если ПараметрыОбработки.ИмяОбработчика = ДоступныеМетодыИнтерфейса.ТоварныеГруппыПоОрганизации Тогда
			ФормаВладелец = ПараметрыЗапроса.ОповещениеОЗавершении.Модуль;
		КонецЕсли;
		...
		ИначеЕсли ПараметрыОбработки.ИмяОбработчика = ДоступныеМетодыИнтерфейса.ТоварныеГруппыПоОрганизации Тогда
			ПараметрыОжидания.ТекстСообщения             = НСтр("ru='Выполняется синхронизация товарных групп с ФГИС ""Честный Знак""'");
		ИначеЕсли ПараметрыОбработки.ИмяОбработчика = ДоступныеМетодыИнтерфейса.ПолучениеДанныхНастройкиТСПИоТ Тогда
...
Процедура ОбработатьРезультатОбменаСлужебный(РезультатОбмена, ДополнительныеПараметрыДлительнойОперации)
	...
	СписокПолейЗаполнения.Добавить("ТребуетсяОбновлениеКлючаСессии");
