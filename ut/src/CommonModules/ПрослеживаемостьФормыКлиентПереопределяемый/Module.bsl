...
//++ Локализация
	...
	ИначеЕсли НавигационнаяСсылка = "ОткрытьФормированиеУведомленийОВвозеПеремещении" Тогда
		...
		ПараметрыФормы.Вставить("Организация", ПараметрыРегистрации.Организация);
		ПараметрыФормы.Вставить("ТипУведомления", Тип("ДокументСсылка.УведомлениеОВвозеПрослеживаемыхТоваров"));
		ПараметрыФормы.Вставить("КорректировочноеУведомление", ПараметрыРегистрации.КорректировочноеУведомление);
	...
	ИначеЕсли НавигационнаяСсылка = "ВвестиНовыйУведомлениеОВвозеПрослеживаемыхТоваров" Тогда
		...
		Ключ = ПрослеживаемостьВызовСервераПереопределяемый.РаспоряжениеКОформлениюУведомленияОВвозеПрослеживаемыхТоваровПоОснованию(ПараметрыРегистрации.Ссылка, ПараметрыРегистрации.КорректировочноеУведомление);
		Если ЗначениеЗаполнено(Ключ) Тогда
			...
			ДанныеЗаполнения.Вставить("ИсправляемыйДокумент", Ключ.ИсправляемыйДокумент);
			ДанныеЗаполнения.Вставить("Исправление",          Ключ.КорректировочноеУведомление);
			ДанныеЗаполнения.Вставить("НомерКорректировки",   Ключ.НомерКорректировки);
