...
Процедура ПолучитьДанныеКатегорийВФоне(ПараметрыМетода, ДлительнаяОперация, УникальныйИдентификаторФормы) Экспорт 
	...
	ДлительнаяОперация = ДлительныеОперации.ВыполнитьВФоне("РаботаСНоменклатуройСлужебный.ПолучитьДанныеКатегорий", 
		ПараметрыМетода, 
		ПараметрыВыполнения);
...
Процедура ПриОпределенииМетодовРазрешенныхДляВызоваКакПроизвольныйКод(Методы) Экспорт
	...
	Методы.Вставить("ВыгрузитьДанныеНоменклатуры", Истина);
	Методы.Вставить("ДоступныеКатегорииСервиса", Истина);
	Методы.Вставить("ЕстьПроблемыБыстро", Истина);
	Методы.Вставить("КэшПутейКатегорийСервиса", Истина);
	Методы.Вставить("ОбновленнаяСтатистикаРезультатов", Истина);
	Методы.Вставить("ОбязательныеРеквизитыНациональногоКаталога", Истина);
	Методы.Вставить("ПартнерАктивен", Истина);
	Методы.Вставить("Пауза", Истина);
	Методы.Вставить("ПолучитьДанныеКатегорий", Истина);
	Методы.Вставить("ПолучитьКэшКатегорийСервиса", Истина);
	Методы.Вставить("ПроверитьГотовностьНоменклатурнойПозиции", Истина);
	Методы.Вставить("ПроверитьГотовностьНоменклатурыКВыгрузке", Истина);
	Методы.Вставить("СопоставитьЗначенияРеквизитовАвтоматически", Истина);
	Методы.Вставить("СтатистикаРезультатовВыгрузки", Истина);
	Методы.Вставить("УдалитьПроблемы", Истина);
...
Функция ПолучитьСтатистикуРезультатов(УникальныйИдентификатор, Организация) Экспорт
	...
	ПараметрыВыполнения.НаименованиеФоновогоЗадания = 
		НСтр("ru = 'Работа с номенклатурой. Получение статистики результатов выгрузки.'");
	
	Возврат ДлительныеОперации.ВыполнитьФункцию(ПараметрыВыполнения, 
		"РаботаСНоменклатуройСлужебный.СтатистикаРезультатовВыгрузки", 
		Организация);
...
Функция ОтправитьДанныеНоменклатурыНаСервер(ПараметрыТелаЗапроса, ЗаголовкиЗапроса, Пакеты)
	...
	Для каждого Пакет Из Пакеты Цикл
		...
		Иначе
			...
			Иначе
				СообщениеОбОшибке = СтрШаблон(НСтр("ru = 'Код состояния: %1.
					|Ответ сервиса: %2'"), КодСостояния, СтрокаОтвета);
