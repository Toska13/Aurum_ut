...
Функция ПолучитьСопоставлениеРеквизитовИСвойствJSON(ТипДокумента) Экспорт
	...
	Если ТипДокумента = ПредопределенноеЗначение("Перечисление.ТипыДокументовРаспознаваниеДокументов.УПД") Тогда
		...
		РаспознаваниеДокументов.ДобавитьСоответствиеРеквизита(РеквизитыДокумента, "Партнер", "Партнер", Типы.Партнер, , Истина);
		РаспознаваниеДокументов.ДобавитьСоответствиеРеквизита(РеквизитыДокумента, "СоглашениеСКлиентом", "СоглашениеСКлиентом", Типы.СоглашениеСКлиентом, , Истина);
		РаспознаваниеДокументов.ДобавитьСоответствиеРеквизита(РеквизитыДокумента, "СоглашениеСПоставщиком", "СоглашениеСПоставщиком", Типы.СоглашениеСПоставщиком, , Истина);
		РаспознаваниеДокументов.ДобавитьСоответствиеРеквизита(РеквизитыДокумента, "Подразделение", "Подразделение", Типы.Подразделение, , Истина);
		РаспознаваниеДокументов.ДобавитьСоответствиеРеквизита(РеквизитыДокумента, "ВидДокумента", "ВидДокумента", Типы.ВидДокумента, , Истина);
		...
		РаспознаваниеДокументов.ДобавитьСоответствиеРеквизита(РеквизитыДокумента, "Таблица_1.Строка.ТПодразделение", "ТПодразделение", Типы.Подразделение);
        РаспознаваниеДокументов.ДобавитьСоответствиеРеквизита(РеквизитыДокумента, "Таблица_1.Строка.Серия", "Серия", Типы.Серия, Истина);
        РаспознаваниеДокументов.ДобавитьСоответствиеРеквизита(РеквизитыДокумента, "Таблица_1.Строка.ТСклад", "ТСклад", Типы.Склад);
        РаспознаваниеДокументов.ДобавитьСоответствиеРеквизита(РеквизитыДокумента, "Таблица_1.Строка.СтатьяДоходов", "СтатьяДоходов", Типы.СтатьяДоходов);
        РаспознаваниеДокументов.ДобавитьСоответствиеРеквизита(РеквизитыДокумента, "Таблица_1.Строка.СтатьяРасходов", "СтатьяРасходов", Типы.СтатьяРасходов);
        РаспознаваниеДокументов.ДобавитьСоответствиеРеквизита(РеквизитыДокумента, "Таблица_1.Строка.Статья", "Статья", Типы.Статья);
        РаспознаваниеДокументов.ДобавитьСоответствиеРеквизита(РеквизитыДокумента, "Таблица_1.Строка.СписатьНаРасходы", "СписатьНаРасходы", Типы.СписатьНаРасходы);
	...
	ИначеЕсли ТипДокумента = ПредопределенноеЗначение("Перечисление.ТипыДокументовРаспознаваниеДокументов.ТОРГ12") Тогда
		...
		РаспознаваниеДокументов.ДобавитьСоответствиеРеквизита(РеквизитыДокумента, "Таблица1.Строка.ТПодразделение", "ТПодразделение", Типы.Подразделение);
        РаспознаваниеДокументов.ДобавитьСоответствиеРеквизита(РеквизитыДокумента, "Таблица1.Строка.Серия", "Серия", Типы.Серия, Истина);
        РаспознаваниеДокументов.ДобавитьСоответствиеРеквизита(РеквизитыДокумента, "Таблица1.Строка.ТСклад", "ТСклад", Типы.Склад);
        РаспознаваниеДокументов.ДобавитьСоответствиеРеквизита(РеквизитыДокумента, "Таблица1.Строка.СтатьяДоходов", "СтатьяДоходов", Типы.СтатьяДоходов);
        РаспознаваниеДокументов.ДобавитьСоответствиеРеквизита(РеквизитыДокумента, "Таблица1.Строка.СтатьяРасходов", "СтатьяРасходов", Типы.СтатьяРасходов);
        РаспознаваниеДокументов.ДобавитьСоответствиеРеквизита(РеквизитыДокумента, "Таблица1.Строка.Статья", "Статья", Типы.Статья);
        РаспознаваниеДокументов.ДобавитьСоответствиеРеквизита(РеквизитыДокумента, "Таблица1.Строка.СписатьНаРасходы", "СписатьНаРасходы", Типы.СписатьНаРасходы);
	...
	ИначеЕсли ТипДокумента = ПредопределенноеЗначение("Перечисление.ТипыДокументовРаспознаваниеДокументов.СчетНаОплату") Тогда
		...
		РаспознаваниеДокументов.ДобавитьСоответствиеРеквизита(РеквизитыДокумента, "БанковскиеРеквизиты.Получатель.Счет.Номер", "БанковскийСчетКонтрагента", Типы.БанковскиеСчетаКонтрагентов);
		РаспознаваниеДокументов.ДобавитьСоответствиеРеквизита(РеквизитыДокумента, "БанковскиеРеквизиты.Получатель.Счет.Номер", "БанковскийСчетОрганизации", Типы.БанковскиеСчетаОрганизаций);
	...
	Если ИспользоватьНовыйФормат Тогда 
		...
		// "Р_?"
		Правило = РеквизитыДокумента.Добавить();
		Правило.ИмяРеквизита = "Партнер";
		Правило.ОписаниеТипа = Типы.Партнер;
		
		// "Р_?"
		Правило = РеквизитыДокумента.Добавить();
		Правило.ИмяРеквизита = "СоглашениеСКлиентом";
		Правило.ОписаниеТипа = Типы.СоглашениеСКлиентом;

		// "Р_?"
		Правило = РеквизитыДокумента.Добавить();
		Правило.ИмяРеквизита = "СоглашениеСПоставщиком";
		Правило.ОписаниеТипа = Типы.СоглашениеСПоставщиком;

		// "Р_?"
		Правило = РеквизитыДокумента.Добавить();
		Правило.ИмяРеквизита = "Подразделение";
		Правило.ОписаниеТипа = Типы.Подразделение;
		
		// "Р_?"
		Правило = РеквизитыДокумента.Добавить();
		Правило.ИмяРеквизита = "ВидДокумента";
		Правило.ОписаниеТипа = Типы.ВидДокумента;
		...
		Правило.ОписаниеТипа = Типы.БанковскиеСчетаКонтрагентов;
		Правило.КлассСущности = "Поставщик";
		Правило.ПодклассСущности = "Свойства";
		...
		Правило.ОписаниеТипа = Типы.БанковскиеСчетаОрганизаций;
		Правило.КлассСущности = "Поставщик";
		Правило.ПодклассСущности = "Свойства";
		Правило.Путь = "Компания.БанковскийСчет.НомерСчета";
		...
		Если Не ТипДокумента = ПредопределенноеЗначение(
		...
		Правило = РеквизитыДокумента.Добавить();
		Правило.ЭтоРеквизитТабличнойЧасти = Истина;
		Правило.ИмяРеквизита = "ТПодразделение";
		Правило.ОписаниеТипа = Типы.Подразделение;
		Правило.КлассСущности = "ТаблицаНоменклатур";
		Правило.ПодклассСущности = "Строки";
		...
		Правило = РеквизитыДокумента.Добавить();
		Правило.ЭтоРеквизитТабличнойЧасти = Истина;
		Правило.ИмяРеквизита = "Серия";
		Правило.ОписаниеТипа = Типы.Серия;
		Правило.КлассСущности = "ТаблицаНоменклатур";
		Правило.ПодклассСущности = "Строки";
		
		Правило = РеквизитыДокумента.Добавить();
		Правило.ЭтоРеквизитТабличнойЧасти = Истина;
		Правило.ИмяРеквизита = "ТСклад";
		Правило.ОписаниеТипа = Типы.Склад;
		Правило.КлассСущности = "ТаблицаНоменклатур";
		Правило.ПодклассСущности = "Строки";
		...
		Правило = РеквизитыДокумента.Добавить();
		Правило.ЭтоРеквизитТабличнойЧасти = Истина;
		Правило.ИмяРеквизита = "СтатьяДоходов";
		Правило.ОписаниеТипа = Типы.СтатьяДоходов;
		Правило.КлассСущности = "ТаблицаНоменклатур";
		Правило.ПодклассСущности = "Строки";

		Правило = РеквизитыДокумента.Добавить();
		Правило.ЭтоРеквизитТабличнойЧасти = Истина;
		Правило.ИмяРеквизита = "СтатьяРасходов";
		Правило.ОписаниеТипа = Типы.СтатьяРасходов;
		Правило.КлассСущности = "ТаблицаНоменклатур";
		Правило.ПодклассСущности = "Строки";
		
		Правило = РеквизитыДокумента.Добавить();
		Правило.ЭтоРеквизитТабличнойЧасти = Истина;
		Правило.ИмяРеквизита = "Статья";
		Правило.ОписаниеТипа = Типы.Статья;
		Правило.КлассСущности = "ТаблицаНоменклатур";
		Правило.ПодклассСущности = "Строки";  
		
		Правило = РеквизитыДокумента.Добавить();
		Правило.ЭтоРеквизитТабличнойЧасти = Истина;
		Правило.ИмяРеквизита = "СписатьНаРасходы";
		Правило.ОписаниеТипа = Типы.СписатьНаРасходы;
		Правило.КлассСущности = "ТаблицаНоменклатур";
		Правило.ПодклассСущности = "Строки"; 
		
		//РаспознаваниеДокументов.ДобавитьСоответствиеРеквизита(РеквизитыДокумента, "Р_0", "НомерДокумента", Типы.Строка);
		//РаспознаваниеДокументов.ДобавитьСоответствиеРеквизита(РеквизитыДокумента, "Р_1", "ДатаДокумента", Типы.Дата);
		//
		//РаспознаваниеДокументов.ДобавитьСоответствиеРеквизита(РеквизитыДокумента, "Р_2", "Продавец", Типы.Контрагент);
		//РаспознаваниеДокументов.ДобавитьСоответствиеРеквизита(РеквизитыДокумента, "Р_3", "Покупатель", Типы.Контрагент);
		//РаспознаваниеДокументов.ДобавитьСоответствиеРеквизита(РеквизитыДокумента, "Р_4", "Грузоотправитель", Типы.Контрагент);
		//РаспознаваниеДокументов.ДобавитьСоответствиеРеквизита(РеквизитыДокумента, "Р_5", "Грузополучатель", Типы.Контрагент);
		//
		//РаспознаваниеДокументов.ДобавитьСоответствиеРеквизита(РеквизитыДокумента, "Р_6", "Договор", Типы.Договор);
		//РаспознаваниеДокументов.ДобавитьСоответствиеРеквизита(РеквизитыДокумента, "Р_7", "Склад", Типы.Склад, , Истина);
		//РаспознаваниеДокументов.ДобавитьСоответствиеРеквизита(РеквизитыДокумента, "Р_8", "ПродавецОрганизация", Типы.Организация);
		//РаспознаваниеДокументов.ДобавитьСоответствиеРеквизита(РеквизитыДокумента, "Р_9", "ПокупательОрганизация", Типы.Организация);
		//
		//РаспознаваниеДокументов.ДобавитьСоответствиеРеквизита(РеквизитыДокумента, "Р_10", "ИтогоСумма", Типы.ДенежнаяСумма);
		//РаспознаваниеДокументов.ДобавитьСоответствиеРеквизита(РеквизитыДокумента, "Р_11", "ИтогоСуммаНДС", Типы.ДенежнаяСумма);
		//РаспознаваниеДокументов.ДобавитьСоответствиеРеквизита(РеквизитыДокумента, "Р_12", "ИтогоВсего", Типы.ДенежнаяСумма);
		//
		//РаспознаваниеДокументов.ДобавитьСоответствиеРеквизита(РеквизитыДокумента, "Р_13", "ИННПродавца", Типы.Строка, Истина);
		//РаспознаваниеДокументов.ДобавитьСоответствиеРеквизита(РеквизитыДокумента, "Р_14", "ИННПокупателя", Типы.Строка, Истина);
		//РаспознаваниеДокументов.ДобавитьСоответствиеРеквизита(РеквизитыДокумента, "Партнер", "Партнер", Типы.Партнер, , Истина);
		//РаспознаваниеДокументов.ДобавитьСоответствиеРеквизита(РеквизитыДокумента, "СоглашениеСКлиентом", "СоглашениеСКлиентом", Типы.СоглашениеСКлиентом, ,Истина);
		//РаспознаваниеДокументов.ДобавитьСоответствиеРеквизита(РеквизитыДокумента, "СоглашениеСПоставщиком", "СоглашениеСПоставщиком", Типы.СоглашениеСПоставщиком, ,Истина);
		//РаспознаваниеДокументов.ДобавитьСоответствиеРеквизита(РеквизитыДокумента, "Подразделение", "Подразделение", Типы.Подразделение, , Истина);
		//РаспознаваниеДокументов.ДобавитьСоответствиеРеквизита(РеквизитыДокумента, "ВидДокумента", "ВидДокумента", Типы.ВидДокумента, , Истина);
		//РаспознаваниеДокументов.ДобавитьСоответствиеРеквизита(РеквизитыДокумента, "Р_15", "НомерДоговора", Типы.Строка, Истина);
		//РаспознаваниеДокументов.ДобавитьСоответствиеРеквизита(РеквизитыДокумента, "Р_16", "ДатаДоговора", Типы.Дата, Истина);
		//
		//РаспознаваниеДокументов.ДобавитьСоответствиеРеквизита(РеквизитыДокумента, "Р_17", "Исполнитель", Типы.Организация);
		//РаспознаваниеДокументов.ДобавитьСоответствиеРеквизита(РеквизитыДокумента, "Р_18", "ИННИсполнителя", Типы.Строка, Истина);
		//РаспознаваниеДокументов.ДобавитьСоответствиеРеквизита(РеквизитыДокумента, "Р_19", "КППИсполнителя", Типы.Строка, Истина);
		//
		//РаспознаваниеДокументов.ДобавитьСоответствиеРеквизита(РеквизитыДокумента, "Р_20", "ИтогоСуммаСкидки", Типы.ДенежнаяСуммаЛюбогоЗнака, Истина);
		//РаспознаваниеДокументов.ДобавитьСоответствиеРеквизита(РеквизитыДокумента, "Р_21", "БанковскийСчетКонтрагента", Типы.БанковскийСчетКонтрагента);
		//РаспознаваниеДокументов.ДобавитьСоответствиеРеквизита(РеквизитыДокумента, "Р_22", "БанковскийСчетОрганизации", Типы.БанковскийСчетОрганизации);
		//РаспознаваниеДокументов.ДобавитьСоответствиеРеквизита(РеквизитыДокумента, "Р_23", "БанкСчет", Типы.Строка, Истина);
		//РаспознаваниеДокументов.ДобавитьСоответствиеРеквизита(РеквизитыДокумента, "Р_24", "Банк", Типы.Банк, Истина);
		//
		//РаспознаваниеДокументов.ДобавитьСоответствиеРеквизита(РеквизитыДокумента, "Р_25", "СуммаВключаетНДС", Типы.Булево);
		//РаспознаваниеДокументов.ДобавитьСоответствиеРеквизита(РеквизитыДокумента, "Р_26", "ВидСкидки", Типы.ВидСкидки);
		//
		//// Таблица
		//РаспознаваниеДокументов.ДобавитьСоответствиеРеквизита(РеквизитыДокумента, "Т_1.Строка.Р_0", "Номенклатура", Типы.Номенклатура);
		//РаспознаваниеДокументов.ДобавитьСоответствиеРеквизита(РеквизитыДокумента, "Т_1.Строка.Р_1", "Количество", Типы.Число);
		//РаспознаваниеДокументов.ДобавитьСоответствиеРеквизита(РеквизитыДокумента, "Т_1.Строка.Р_2", "ЕдиницаИзмерения", Типы.ЕдиницаИзмерения, Истина);
		//РаспознаваниеДокументов.ДобавитьСоответствиеРеквизита(РеквизитыДокумента, "Т_1.Строка.Р_3", "Цена", Типы.ДенежнаяСумма);
		//РаспознаваниеДокументов.ДобавитьСоответствиеРеквизита(РеквизитыДокумента, "Т_1.Строка.Р_4", "Сумма", Типы.ДенежнаяСумма);
		//РаспознаваниеДокументов.ДобавитьСоответствиеРеквизита(РеквизитыДокумента, "Т_1.Строка.Р_5", "СтавкаНДС", Типы.СтавкаНДС);
		//РаспознаваниеДокументов.ДобавитьСоответствиеРеквизита(РеквизитыДокумента, "Т_1.Строка.Р_6", "СуммаНДС", Типы.ДенежнаяСумма);
		//РаспознаваниеДокументов.ДобавитьСоответствиеРеквизита(РеквизитыДокумента, "Т_1.Строка.Р_7", "Всего", Типы.ДенежнаяСумма);
		//РаспознаваниеДокументов.ДобавитьСоответствиеРеквизита(РеквизитыДокумента, "Т_1.Строка.Р_8", "СтранаПроисхождения", Типы.СтраныМира);
		//РаспознаваниеДокументов.ДобавитьСоответствиеРеквизита(РеквизитыДокумента, "Т_1.Строка.Р_9", "НомерГТД", Типы.НомераГТД);
		//РаспознаваниеДокументов.ДобавитьСоответствиеРеквизита(РеквизитыДокумента, "Т_1.Строка.Р_10", "Артикул", Типы.Строка, Истина);
		//РаспознаваниеДокументов.ДобавитьСоответствиеРеквизита(РеквизитыДокумента, "Т_1.Строка.Р_11", "КодЕдиницыИзмерения", Типы.Строка, Истина);
		//РаспознаваниеДокументов.ДобавитьСоответствиеРеквизита(РеквизитыДокумента, "Т_1.Строка.Р_12", "КодСтраныПроисхождения", Типы.Строка, Истина);
		//РаспознаваниеДокументов.ДобавитьСоответствиеРеквизита(РеквизитыДокумента, "Т_1.Строка.Р_13", "Содержание", Типы.Строка);
		//РаспознаваниеДокументов.ДобавитьСоответствиеРеквизита(РеквизитыДокумента, "Т_1.Строка.Р_14", "Характеристика", Типы.ХарактеристикаНоменклатуры);
		//РаспознаваниеДокументов.ДобавитьСоответствиеРеквизита(РеквизитыДокумента, "Т_1.Строка.Р_15", "ТПодразделение", Типы.Подразделение);
		//РаспознаваниеДокументов.ДобавитьСоответствиеРеквизита(РеквизитыДокумента, "Т_1.Строка.Р_16", "Серия", Типы.Серия, Истина);	
		//РаспознаваниеДокументов.ДобавитьСоответствиеРеквизита(РеквизитыДокумента, "Т_1.Строка.Р_17", "ТСклад", Типы.Склад);
		//РаспознаваниеДокументов.ДобавитьСоответствиеРеквизита(РеквизитыДокумента, "Т_1.Строка.Р_18", "СтатьяДоходов", Типы.СтатьяДоходов);
		//РаспознаваниеДокументов.ДобавитьСоответствиеРеквизита(РеквизитыДокумента, "Т_1.Строка.Р_19", "СтатьяРасходов", Типы.СтатьяРасходов);
		//РаспознаваниеДокументов.ДобавитьСоответствиеРеквизита(РеквизитыДокумента, "Т_1.Строка.Р_20", "Статья", Типы.Статья);
		//РаспознаваниеДокументов.ДобавитьСоответствиеРеквизита(РеквизитыДокумента, "Т_1.Строка.Р_21", "СписатьНаРасходы", Типы.СписатьНаРасходы);
...
Функция ЗаполненнаяТаблицаДокумента(ДокументОбъект) Экспорт
	...
	Для Каждого Запись Из ДокументОбъект.РеквизитыТабличныхЧастей Цикл
		Если ТаблицаРезультат.Колонки.Найти(Запись.ИмяРеквизита) = Неопределено Тогда
			Если Запись.ИмяРеквизита = "Номенклатура" И ТипЗнч(Запись.Значение) = Тип("Строка") Тогда
				Запись.Значение = Справочники.Номенклатура.ПустаяСсылка();
			КонецЕсли;
	...
	ИмяКолонкиУслуга = "ЭтоУслуга";
	РаспознаваниеДокументовПереопределяемый.ИмяКолонкиУслугиТаблицыДокумента(ИмяКолонкиУслуга);
	
	// Читаемое из Базы
	ТаблицаРезультат.Колонки.Добавить(ИмяКолонкиУслуга, Новый ОписаниеТипов("Булево"));
	
	СписокНоменклатур = ТаблицаРезультат.ВыгрузитьКолонку("Номенклатура");
	СписокУслугиПоНоменклатурам = Новый Соответствие;
	
	РаспознаваниеДокументовПереопределяемый.ЗаполнитьСписокУслугиПоНоменклатурам(СписокНоменклатур,
		СписокУслугиПоНоменклатурам);
	...
	Для Каждого СтрокаТаблицы Из ТаблицаРезультат Цикл
		...
		Если ЭтоУслуга = Неопределено Тогда
			ЭтоУслуга = Ложь;
		КонецЕсли;
		СтрокаТаблицы[ИмяКолонкиУслуга] = ЭтоУслуга;
	КонецЦикла;
...
Процедура ФоновоеСозданиеНоменклатуры(Параметры, АдресРезультата) Экспорт
	...
	ТаблицаНоменклатуры = СоздаваемаяНоменклатура(ПараметрыСозданияНоменклатуры);
	...
	Для Каждого ПараметрыСоздания Из ПараметрыСозданияНоменклатуры Цикл
		...
		ИмеющийсяДубль = НайтиДубльНоменклатуры(ПараметрыСоздания, ПараметрыСозданияНоменклатуры, ТаблицаНоменклатуры);
...
Функция ОсновныеРеквизиты(ДокументОбъект) Экспорт
	...
	Если ДокументОбъект.ТипДокумента = Перечисления.ТипыДокументовРаспознаваниеДокументов.УПД
		...
		Или ДокументОбъект.ТипДокумента = Перечисления.ТипыДокументовРаспознаваниеДокументов.КассовыйЧек Тогда
...
// Функция - Получить склад по умолчанию
// 
// Возвращаемое значение:
...
Функция ПолучитьСкладПоУмолчанию() Экспорт
	...
	РаспознаваниеДокументовПереопределяемый.ОпределитьСкладПоУмолчанию(СкладПоУмолчанию);
		
	Возврат СкладПоУмолчанию;
	
КонецФункции // ПолучитьСкладПоУмолчанию()
...
Процедура ПриЗаписиДокументаСоздаваемогоИзРаспознанногоДокумента(Источник, Отказ) Экспорт
	...
	ТипЗначенияИсточника = ТипЗнч(Источник.Ссылка);
	Если РаспознаваниеДокументовТипы.ЭтоПоступлениеТоваровУслуг(ТипЗначенияИсточника) Тогда
		РаспознаваниеДокументовПереопределяемый.ПриЗаписиПриобретенияТоваровИУслуг(Источник);
	ИначеЕсли РаспознаваниеДокументовТипы.ЭтоАвансовыйОтчет(ТипЗначенияИсточника) Тогда
...
Процедура ДобавитьВариантыНайденныеПоискомПоНесколькимРеквизитам(ДокументОбъект, ДокументСсылка) Экспорт
	...
	Для Каждого СтрокаТаблицы Из НайденныеСтроки Цикл
		...
		Если РеквизитыПоискаКонтрагентОрганизация.Количество() Тогда
			...
			Кандидаты = КандидатыДляСтавокНДС(РеквизитыПоискаКонтрагентОрганизация.Наименование);
			Если Не ЗначениеЗаполнено(Кандидаты) Тогда
				Кандидаты = РаспознаваниеДокументов.ПолучитьКандидатов(РеквизитыПоискаКонтрагентОрганизация, Тип,
					ПараметрыОбъединенияРеквизитов, , ИдентификаторРезультата);
			КонецЕсли;
			ДобавитьКандидатовВСписокВыбора(ДокументОбъект, ДокументСсылка, "СтавкаНДС", Кандидаты,
				СтрокаТаблицы.НомерСтрокиТЧ);
		КонецЕсли;
...
Функция КандидатыДляСтавокНДС(ПредставлениеСтавки)
	
	Кандидаты = Новый ТаблицаЗначений;
	Кандидаты.Колонки.Добавить("Ссылка", Новый ОписаниеТипов("СправочникСсылка.СтавкиНДС"));
	Кандидаты.Колонки.Добавить("ДополнительнаяСсылка", Новый ОписаниеТипов("СправочникСсылка.СтавкиНДС"));
	Кандидаты.Колонки.Добавить("Коэффициент", ОбщегоНазначения.ОписаниеТипаЧисло(1));
	
	РаспознаваниеДокументовПереопределяемый.КандидатыДляСтавокНДС(Кандидаты, ПредставлениеСтавки);
...
Процедура ДобавитьСтрануПоКлассификатору(РеквизитыПоиска, Кандидаты)
	...
	Если МаксимальнаяСхожесть > 0.9 Тогда
		СтранаМира = УправлениеКонтактнойИнформацией.СтранаМираПоКодуИлиНаименованию(НайденнаяСтрока.Наименование);
...
Функция СоздатьДокументНаОснованииРаспознанного(РаспознанныйДокумент, ТипСоздаваемогоДокумента, ПараметрыЗаполнения, РежимЗаписи = Неопределено) Экспорт
	...
	Если ПараметрыЗаполнения.Свойство("ТоварыУслуги") Тогда
		Для Каждого СтрокаТаблицы Из ПараметрыЗаполнения.ТоварыУслуги Цикл
			Если Не СтрокаТаблицы.Услуга И Не ЗначениеЗаполнено(СтрокаТаблицы.Номенклатура) Тогда
				ЕстьПустаяНоменклатура = Истина;
	...
	РаспознаваниеДокументовПереопределяемый.ПриСозданииДокументаНаОснованииРаспознанного(СоздаваемыйДокумент,
		РаспознанныйДокумент, ПараметрыЗаполнения);
...
Функция НайтиПотенциальныеСвязанныеДокументы(Объект) Экспорт
	...
	Если Объект.ТипДокумента = Перечисления.ТипыДокументовРаспознаваниеДокументов.УПД
		...
		Если Объект.Направление = Перечисления.НаправленияРаспознанногоДокумента.Входящий Тогда
			ИмяТипа = "Документ.СчетФактураПолученный";
			ТипНовогоДокумента = "Поступление";
		Иначе
			ИмяТипа = "Документ.СчетФактураВыданный";
			ИмяТипаАкт = "Документ.АктВыполненныхРабот";
		...
		Если Объект.Направление = Перечисления.НаправленияРаспознанногоДокумента.Исходящий Тогда 
			...
			Запрос = Новый Запрос;
			РаспознаваниеДокументовПереопределяемый.ТекстЗапросаПоПервичнымДокументам(ИмяТипаАкт, Запрос.Текст, Ложь);
		...
		Иначе
			...
			Если Объект.Направление = Перечисления.НаправленияРаспознанногоДокумента.Входящий Тогда
				ИмяТипа = "Документ.ПриобретениеТоваровУслуг";
			Иначе
				ИмяТипа = "Документ.РеализацияТоваровУслуг";
			КонецЕсли; 
			
			РаспознаваниеДокументовПереопределяемый.ИмяТипаДокументаПоступленияРеализации(ИмяТипа, Объект);
			РаспознаваниеДокументовПереопределяемый.ТекстЗапросаПоПервичнымДокументам(ИмяТипа, Запрос.Текст, Ложь);
			...
			УстановитьПривилегированныйРежим(Истина);
			Выборка = Запрос.Выполнить().Выбрать();
			РаспознаваниеДокументовПереопределяемый.ПодобратьДокументыПоНоменклатуре(Объект.Ссылка, Выборка, ИмяТипа);
			...
			Если Выборка.Следующий() Тогда
				...
				Если Объект.Направление = Перечисления.НаправленияРаспознанногоДокумента.Входящий Тогда
					СчетФактура = РаспознаваниеДокументовПереопределяемый.НайтиПодчиненныйСчетФактуруПолученный(Выборка.Документ);
				Иначе
					СчетФактура = РаспознаваниеДокументовПереопределяемый.НайтиПодчиненныйСчетФактуруВыданныйНаРеализацию(Выборка.Документ);
				КонецЕсли;
	...
	ИначеЕсли Объект.ТипДокумента = Перечисления.ТипыДокументовРаспознаваниеДокументов.СчетНаОплату Тогда
		...
		Если Объект.Направление = Перечисления.НаправленияРаспознанногоДокумента.Входящий Тогда
			ИмяТипа = "Документ.ЗаказПоставщику";
			ТипНовогоДокумента = "ДокументВходящий"; 
		Иначе
			ИмяТипа = "Документ.ЗаказКлиента";
			ИмяТипаСчет = "Документ.СчетНаОплатуКлиенту";
		...
		Если Объект.Направление = Перечисления.НаправленияРаспознанногоДокумента.Исходящий Тогда 
			...
			Запрос = Новый Запрос;
			РаспознаваниеДокументовПереопределяемый.ТекстЗапросаПоПервичнымДокументам(ИмяТипаСчет, Запрос.Текст, Ложь);
			ЗаполнитьПараметрыПоУмолчанию(Объект, Запрос, ТипНовогоДокумента);
...
Процедура СкорректироватьКомплектДокументовПоПравуДоступаДобавление(КомплектныеДокументы, ОбязательныйДокумент) Экспорт
	...
	РаспознаваниеДокументовПереопределяемый.СкорректироватьКомплектДокументовПоПравуДоступаДобавление(
		КомплектныеДокументы, ОбязательныйДокумент);
	...
	Для Каждого Реквизит Из ДокументОбъект.РеквизитыДокумента Цикл
		...
		Иначе
			...
			ИначеЕсли ИмяРеквизита = "Склад" Тогда
				...
				РаспознаваниеДокументовПереопределяемый.ПроверитьНеобходимостьЗаполненияСклада(ДокументОбъект, ЗаполнятьСклад);
				Если Не ЗаполнятьСклад Тогда
					Продолжить;
				КонецЕсли;
...
Процедура ПересчитатьПроблемныеЭлементы(Форма, РаспознанныйДокумент = Неопределено, ИмяТаблицы = "ТаблицаДокумента") Экспорт
	...
	Если ОбщегоНазначенияКлиентСервер.ЕстьРеквизитИлиСвойствоОбъекта(Форма, "ЕстьТовары") Тогда
...
Процедура ЗаполнитьБанковскийСчет(ДокументОбъект) Экспорт
	...
	Если ДокументОбъект.Направление = Перечисления.НаправленияРаспознанногоДокумента.Исходящий Тогда
		...
		КонецЕсли; 
	Иначе
		// Банковский счет Организации (для Направление = Входящий)
		Отбор = Новый Структура("ИмяРеквизита", "БанковскийСчетОрганизации");
		НайденныеСтроки = ДокументОбъект.РеквизитыДокумента.НайтиСтроки(Отбор);
		Если НайденныеСтроки.Количество() <> 0 Тогда
			Счет = НайденныеСтроки[0].Значение;
...
Процедура ДобавитьРеквизитыДляСозданияНоменклатуры(Форма, СвойстваОбработки) Экспорт
	...
	Для Каждого ДобавляемыйРеквизит Из Параметры Цикл
		...
		ГруппаЭлемента.Видимость = ОписаниеРеквизита.ОтображатьСвязанныеЭлементы;
...
Функция СоздаваемаяНоменклатура(ДанныеНоменклатуры)
	
	МетаданныеНоменклатуры = Метаданные.Справочники.Номенклатура;
	
	ТаблицаНоменклатуры = Новый ТаблицаЗначений;
	ТаблицаНоменклатуры.Колонки.Добавить("Наименование", МетаданныеНоменклатуры.СтандартныеРеквизиты.Наименование.Тип);
	ТаблицаНоменклатуры.Колонки.Добавить("Артикул", МетаданныеНоменклатуры.Реквизиты.Артикул.Тип);
	
	Для Каждого Запись Из ДанныеНоменклатуры Цикл
	...
	|		ПО втНоменклатура.Наименование = Номенклатура.Наименование
	|			И (втНоменклатура.Артикул = Номенклатура.Артикул
	|				ИЛИ втНоменклатура.Артикул = """"
...
КонецФункции // СоздаваемаяНоменклатура()


Функция НайтиДубльНоменклатуры(ИскомаяЗапись, НаборЗаписей, ТаблицаНоменклатуры)
	
	НайденныйЭлемент = Неопределено;
	
	Отбор = Новый Структура("Наименование, Артикул", ИскомаяЗапись.Наименование, ИскомаяЗапись.Артикул);
	НайденныеСтроки = ТаблицаНоменклатуры.НайтиСтроки(Отбор);
	Если НайденныеСтроки.Количество() Тогда
		НайденныйЭлемент = НайденныеСтроки[0].Ссылка;
	КонецЕсли;
	...
	Если НайденныйЭлемент = Неопределено Тогда
		...
		Для Каждого Запись Из НаборЗаписей Цикл
			...
			Если Идентичны И ЗначениеЗаполнено(Запись.Ссылка) Тогда
				НайденныйЭлемент = Запись.Ссылка;
				Прервать;
			КонецЕсли;
...
Процедура ЗаполнитьСпискиВыбораСтавокНДС(Форма) Экспорт
	...
	Если ДоступныеСтавки.Количество() Тогда
		...
		ЭлементФормы.СписокВыбора.ЗагрузитьЗначения(ДоступныеСтавки.ВыгрузитьЗначения());
		ЭлементБыстрогоРедактирования.РежимВыбораИзСписка = Истина;
		ЭлементБыстрогоРедактирования.СписокВыбора.ЗагрузитьЗначения(ДоступныеСтавки.ВыгрузитьЗначения());
	КонецЕсли;
...
Процедура УстановитьУсловноеОформлениеДопРеквизитовГрупповаяОбработка(Форма, НаборЦветов) Экспорт
	...
	РаспознаваниеДокументовПереопределяемый.УстановитьУсловноеОформлениеДопРеквизитовГрупповаяОбработка(
		Форма, НаборЦветов);
...
Процедура УстановитьУсловноеОформлениеШагСуммыГрупповаяОбработка(Форма, НаборЦветов) Экспорт
	...
	РаспознаваниеДокументовПереопределяемый.УстановитьУсловноеОформлениеШагСуммыГрупповаяОбработка(
		Форма, НаборЦветов);
