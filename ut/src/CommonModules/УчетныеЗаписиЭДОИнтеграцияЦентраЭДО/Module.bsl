...
Функция ДанныеДляПодписанияНаРегистрациюВЭДО(РезультатПодготовкиДанных, ДоступныеСертификаты, КонтекстДиагностики)
	...
	ДанныеДляПодписания.СертификатыДляВыбора = ОбщегоНазначенияБЭДКлиентСервер.ПересечениеМассивов(
...
Функция ДанныеСинхронизацииУчетныхЗаписейЭДОИзФорматаСервиса(НаборДанныхВФорматеСервиса,
	...
	Для Каждого ДанныеСинхронизацииВФорматеСервиса Из НаборДанныхВФорматеСервиса Цикл
		...
		ТекущиеСертификаты = УчетныеЗаписиЭДО.СертификатыУчетнойЗаписи(ОписаниеВФорматеСервиса.Идентификатор);
		...
		Для Каждого СертификатУчетнойЗаписи Из ОписаниеВФорматеСервиса.Сертификаты Цикл
			...
			ТекущийСертификат = ТекущиеСертификаты.Найти(СсылкаНаСертификат, "Сертификат");
...
Процедура ПриОпределенииМетодовРазрешенныхДляВызоваКакПроизвольныйКод(Методы) Экспорт
	...
	Методы.Вставить("НастройкиУведомленийУчетнойЗаписиЭДО", Истина);
	Методы.Вставить("ОбновитьИнформациюОбУчетнойЗаписиЭДО", Истина);
	Методы.Вставить("ОбновитьНастройкиУведомленийУчетнойЗаписиЭДО", Истина);
	Методы.Вставить("ОтправитьРегистрационныйПакетЭДО", Истина);
	Методы.Вставить("ПодготовитьДанныеДляПодписанияНаРегистрациюВЭДО", Истина);
	Методы.Вставить("ПолучитьВсеИдентификаторыУчетныхЗаписейЭДО", Истина);
	Методы.Вставить("ПроверитьОбработкуРегистрационныхПакетовЭДО", Истина);
