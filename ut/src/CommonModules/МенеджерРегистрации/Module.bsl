// Регистрация Правила регистрации для ERP 2.5.26 (ED 1.22) от 26.05.2026 14:53:46
...
Функция ПараметрыРегистрации() Экспорт
	...
	Наименование = НСтр("ru = 'Правила регистрации для ERP 2.5.26 (ED 1.22)'");
	Результат.Вставить("Наименование", Наименование);
	Результат.Вставить("ДатаВремяСоздания", Дата(2026,5,26,14,53,0));
	...
	СинонимКонфигурации = "1С:ERP Управление предприятием 2";
	...
	Результат.Вставить("ВерсияКонфигурации", "2.5.25.51");
...
Процедура ИнициализацияПравилРегистрации(ПравилаРегистрацииОбъектов, ИмяМенеджераРегистрации) Экспорт
	...
	ДобавитьПРО_Документ_ОперацияСЭлектроннымБилетом(ПравилаРегистрацииОбъектов, ИмяМенеджераРегистрации);
	...
	ДобавитьПРО_Документ_Сторно(ПравилаРегистрацииОбъектов, ИмяМенеджераРегистрации);
	ДобавитьПРО_Документ_ОтгрузкаТоваровКлиенту(ПравилаРегистрацииОбъектов, ИмяМенеджераРегистрации);
	...
	ДобавитьПРО_РегистрСведений_УточненияПринадлежностиЗапасовТорговыхТочек(ПравилаРегистрацииОбъектов, ИмяМенеджераРегистрации);
	...
	//-- Локализация
	ДобавитьПРО_РегистрСведений_НоменклатураСегмента(ПравилаРегистрацииОбъектов, ИмяМенеджераРегистрации);
	//++ Локализация
	ДобавитьПРО_РегистрСведений_НастройкиУчетаНДСПриУСН(ПравилаРегистрацииОбъектов, ИмяМенеджераРегистрации);
	//-- Локализация
	...
	//++ Локализация
	ДобавитьПРО_Справочник_ДоговорыЭквайринга2(ПравилаРегистрацииОбъектов, ИмяМенеджераРегистрации);
	//-- Локализация
	ДобавитьПРО_Справочник_СегментыНоменклатуры(ПравилаРегистрацииОбъектов, ИмяМенеджераРегистрации);
	//++ Локализация
...
Процедура ПередОбработкой(ПРО, Отказ, Объект, ОбъектМетаданных, Выгрузка) Экспорт
	...
	ИначеЕсли ПРО.Идентификатор = "Документ_ВозвратТоваровОтКлиента" Тогда 
		ПРО_Документ_ВозвратТоваровОтКлиента_ПередОбработкой(ПРО, Отказ, Объект, ОбъектМетаданных, Выгрузка);
	...
	ИначеЕсли ПРО.Идентификатор = "Документ_СборкаТоваров" Тогда 
		ПРО_Документ_СборкаТоваров_ПередОбработкой(ПРО, Отказ, Объект, ОбъектМетаданных, Выгрузка);
	...
	//-- Локализация
	ИначеЕсли ПРО.Идентификатор = "Документ_Сторно" Тогда 
		ПРО_Документ_Сторно_ПередОбработкой(ПРО, Отказ, Объект, ОбъектМетаданных, Выгрузка);
	...
	ИначеЕсли ПРО.Идентификатор = "РегистрСведений_ДоступностьТоваровДляВнешнихПользователей" Тогда 
		ПРО_РегистрСведений_ДоступностьТоваровДляВнешнихПользователей_ПередОбработкой(ПРО, Отказ, Объект, ОбъектМетаданных, Выгрузка);
	//++ Локализация
	...
	//++ Локализация
	ИначеЕсли ПРО.Идентификатор = "Справочник_ШтрихкодыУпаковокТоваров" Тогда 
		ПРО_Справочник_ШтрихкодыУпаковокТоваров_ПередОбработкой(ПРО, Отказ, Объект, ОбъектМетаданных, Выгрузка);
	//-- Локализация
	КонецЕсли;
КонецПроцедуры
...
Процедура ПриОбработке(Отказ, ПРО, Объект, ТекстЗапроса, ПараметрыЗапроса, ИспользоватьКэш, Выгрузка, ДополнительныеСвойства) Экспорт
	...
	ИначеЕсли ПРО.Идентификатор = "Документ_ПриемкаТоваровНаХранение" Тогда 
	...
	ИначеЕсли ПРО.Идентификатор = "Документ_ВыкупПринятыхНаХранениеТоваров" Тогда 
	...
	ИначеЕсли ПРО.Идентификатор = "Документ_Сторно" Тогда 
		ПРО_Документ_Сторно_ПриОбработке(Отказ, ПРО, Объект, ТекстЗапроса, ПараметрыЗапроса, ИспользоватьКэш, Выгрузка, ДополнительныеСвойства);
	ИначеЕсли ПРО.Идентификатор = "Документ_ОтгрузкаТоваровКлиенту" Тогда 
		ПРО_Документ_ОтгрузкаТоваровКлиенту_ПриОбработке(Отказ, ПРО, Объект, ТекстЗапроса, ПараметрыЗапроса, ИспользоватьКэш, Выгрузка, ДополнительныеСвойства);
	ИначеЕсли ПРО.Идентификатор = "РегистрСведений_УточненияПринадлежностиЗапасовТорговыхТочек" Тогда 
		ПРО_РегистрСведений_УточненияПринадлежностиЗапасовТорговыхТочек_ПриОбработке(Отказ, ПРО, Объект, ТекстЗапроса, ПараметрыЗапроса, ИспользоватьКэш, Выгрузка, ДополнительныеСвойства);
	ИначеЕсли ПРО.Идентификатор = "РегистрСведений_ДоступностьТоваровДляВнешнихПользователей" Тогда 
...
Процедура ПриОбработкеДополнительный(Отказ, ПРО, Объект, ТекстЗапроса, ПараметрыЗапроса, ИспользоватьКэш, ДополнительныеСвойства) Экспорт
	...
	ИначеЕсли ПРО.Идентификатор = "Документ_Сторно" Тогда 
		ПРО_Документ_Сторно_ПриОбработкеДополнительный(Отказ, ПРО, Объект, ТекстЗапроса, ПараметрыЗапроса, ИспользоватьКэш, ДополнительныеСвойства);
	ИначеЕсли ПРО.Идентификатор = "Документ_ОтгрузкаТоваровКлиенту" Тогда 
		ПРО_Документ_ОтгрузкаТоваровКлиенту_ПриОбработкеДополнительный(Отказ, ПРО, Объект, ТекстЗапроса, ПараметрыЗапроса, ИспользоватьКэш, ДополнительныеСвойства);
	ИначеЕсли ПРО.Идентификатор = "РегистрСведений_УточненияПринадлежностиЗапасовТорговыхТочек" Тогда 
		ПРО_РегистрСведений_УточненияПринадлежностиЗапасовТорговыхТочек_ПриОбработкеДополнительный(Отказ, ПРО, Объект, ТекстЗапроса, ПараметрыЗапроса, ИспользоватьКэш, ДополнительныеСвойства);
	ИначеЕсли ПРО.Идентификатор = "РегистрСведений_ДоступностьТоваровДляВнешнихПользователей" Тогда 
...
Процедура ПослеОбработки(ПРО, Отказ, Объект, ОбъектМетаданных, Получатели, Выгрузка) Экспорт
	...
	ИначеЕсли ПРО.Идентификатор = "Документ_Сторно" Тогда 
		ПРО_Документ_Сторно_ПослеОбработки(ПРО, Отказ, Объект, ОбъектМетаданных, Получатели, Выгрузка);
	ИначеЕсли ПРО.Идентификатор = "Документ_ОтгрузкаТоваровКлиенту" Тогда 
		ПРО_Документ_ОтгрузкаТоваровКлиенту_ПослеОбработки(ПРО, Отказ, Объект, ОбъектМетаданных, Получатели, Выгрузка);
...
Процедура ПРО_Документ_ЗаказПоставщику_ПередОбработкой(ПРО, Отказ, Объект, ОбъектМетаданных, Выгрузка)
	...
	Если Объект.Проведен И (Не ФО Или Объект.Статус <> Перечисления.СтатусыЗаказовПоставщикам.НеСогласован) Тогда
		...
		КонецЕсли;	
	КонецЕсли;
	Если Объект.ЗакупкаПодДеятельность = ПредопределенноеЗначение("Перечисление.ТипыНалогообложенияНДС.Космос") Тогда
		Отказ = Истина;
	КонецЕсли;
КонецПроцедуры
...
Процедура ПРО_Документ_ВозвратТоваровОтКлиента_ПередОбработкой(ПРО, Отказ, Объект, ОбъектМетаданных, Выгрузка)
	ДокументОснование = Объект.ДокументРеализации;
	Если ЗначениеЗаполнено(ДокументОснование) И ТипЗнч(ДокументОснование) = Тип("ДокументСсылка.РеализацияТоваровУслуг") Тогда
		СтруктураРеквизитов = ОбщегоНазначения.ЗначенияРеквизитовОбъекта(ДокументОснование, "Проведен,ХозяйственнаяОперация");
...
Процедура ПРО_Документ_КорректировкаРеализации_ПередОбработкой(ПРО, Отказ, Объект, ОбъектМетаданных, Выгрузка)
	...
	ДокументОснование = ОбщегоНазначения.ЗначениеРеквизитаОбъекта(Объект.Ссылка, "ДокументОснование");
	Если ЗначениеЗаполнено(ДокументОснование) И ТипЗнч(ДокументОснование) = Тип("ДокументСсылка.РеализацияТоваровУслуг") Тогда
		СтруктураРеквизитов = ОбщегоНазначения.ЗначенияРеквизитовОбъекта(ДокументОснование, "Проведен,ХозяйственнаяОперация");
		Если НЕ СтруктураРеквизитов.Проведен Тогда 
			Отказ = Истина;
...
Процедура ДобавитьПРО_Документ_ПоступлениеТоваровОтХранителя(ПравилаРегистрацииОбъектов, ИмяМенеджераРегистрации)
	...
	УстановитьОтборы(НовоеПравило, 
		ОтборПоСвойствамПланаОбмена_23(),
...
Процедура ДобавитьПРО_Документ_ПриемкаТоваровНаХранение(ПравилаРегистрацииОбъектов, ИмяМенеджераРегистрации)
	...
	НовоеПравило.ИмяМенеджераРегистрации = ИмяМенеджераРегистрации; 
	НовоеПравило.Идентификатор = "Документ_ПриемкаТоваровНаХранение";
...
Процедура ПРО_Документ_ПриемкаТоваровНаХранение_ПриОбработкеДополнительный(Отказ, ПРО, Объект, ТекстЗапроса, ПараметрыЗапроса, ИспользоватьКэш, ДополнительныеСвойства)
	...
	ПараметрыОбработкиПРО.Отказ               = Отказ;
	ПараметрыОбработкиПРО.Объект              = Объект;
	ПараметрыОбработкиПРО.РазделыУчетаСтрокой = "Производство, Склад";
...
Процедура ДобавитьПРО_Документ_ВыкупПринятыхНаХранениеТоваров(ПравилаРегистрацииОбъектов, ИмяМенеджераРегистрации)
	...
	НовоеПравило.ИмяМенеджераРегистрации = ИмяМенеджераРегистрации; 
	НовоеПравило.Идентификатор = "Документ_ВыкупПринятыхНаХранениеТоваров";
...
Процедура ПРО_Документ_СборкаТоваров_ПередОбработкой(ПРО, Отказ, Объект, ОбъектМетаданных, Выгрузка)
	Если Объект.СборкаПодДеятельность = ПредопределенноеЗначение("Перечисление.ТипыНалогообложенияНДС.Космос") Тогда
		Отказ = Истина;
	КонецЕсли;
КонецПроцедуры
...
Процедура ПРО_Документ_СчетФактураВыданныйАванс_ПередОбработкой(ПРО, Отказ, Объект, ОбъектМетаданных, Выгрузка)
	...
	ИсключаемыеТипыДокументовОснований.Добавить(Тип("ДокументСсылка.ОтгрузкаТоваровКлиенту"));
	Если ЗначениеЗаполнено(Объект.Ссылка)Тогда
    Основание = ОбщегоНазначения.ЗначениеРеквизитаОбъекта(Объект.Ссылка, "ДокументОснование");
	Иначе	
	...
	Если НЕ ЗначениеЗаполнено(Основание) 
		...
		Отказ = Истина;
	КонецЕсли;
	Если НЕ Основание = Неопределено И ОбщегоНазначенияКлиентСервер.ЕстьРеквизитИлиСвойствоОбъекта(Основание.Ссылка, "ДокументОснование")
		И ИсключаемыеТипыДокументовОснований.Найти(ТипЗнч(Основание.ДокументОснование)) <> Неопределено Тогда
	    Отказ = Истина;
	КонецЕсли;
КонецПроцедуры
...
Процедура ДобавитьПРО_Документ_ОперацияСЭлектроннымБилетом(ПравилаРегистрацииОбъектов, ИмяМенеджераРегистрации)
	НовоеПравило = ПравилаРегистрацииОбъектов.Добавить();
	
	НовоеПравило.ИмяМенеджераРегистрации = ИмяМенеджераРегистрации; 
	НовоеПравило.Идентификатор = "Документ_ОперацияСЭлектроннымБилетом";
	
	НовоеПравило.ОбъектМетаданныхИмя = "Документ.ОперацияСЭлектроннымБилетом";
	НовоеПравило.ИмяПланаОбмена = "СинхронизацияДанныхЧерезУниверсальныйФормат";
	НовоеПравило.ИмяРеквизитаФлага = "РежимВыгрузкиДокументов";	
	НовоеПравило.ПравилоПоСвойствамОбъектаПустое = Ложь; 
	НовоеПравило.ПакетноеВыполнениеОбработчиков = Ложь;
...
#Область Документ_Сторно
Процедура ДобавитьПРО_Документ_Сторно(ПравилаРегистрацииОбъектов, ИмяМенеджераРегистрации)
	НовоеПравило = ПравилаРегистрацииОбъектов.Добавить();
	
	НовоеПравило.ИмяМенеджераРегистрации = ИмяМенеджераРегистрации; 
	НовоеПравило.Идентификатор = "Документ_Сторно";
	
	НовоеПравило.ОбъектМетаданныхИмя = "Документ.Сторно";
	НовоеПравило.ИмяПланаОбмена = "СинхронизацияДанныхЧерезУниверсальныйФормат";
	НовоеПравило.ИмяРеквизитаФлага = "РежимВыгрузкиДокументов";	
	НовоеПравило.ПравилоПоСвойствамОбъектаПустое = Ложь; 
	НовоеПравило.ПакетноеВыполнениеОбработчиков = Ложь;
...
Процедура ПРО_Документ_Сторно_ПередОбработкой(ПРО, Отказ, Объект, ОбъектМетаданных, Выгрузка)
	ОбменДаннымиСобытияУТ.ДокументСторноПередОбработкойПРО(Объект, Отказ);
КонецПроцедуры

Процедура ПРО_Документ_Сторно_ПриОбработкеДополнительный(Отказ, ПРО, Объект, ТекстЗапроса, ПараметрыЗапроса, ИспользоватьКэш, ДополнительныеСвойства)
	ПараметрыОбработкиПРО = ОбменДаннымиСобытияУТ.ИнициализироватьПараметрыОбработкиПРО();
...
Процедура ПРО_Документ_Сторно_ПриОбработке(Отказ, ПРО, Объект, ТекстЗапроса, ПараметрыЗапроса, ИспользоватьКэш, Выгрузка, ДополнительныеСвойства)
	ПараметрыОбработкиПРО = ОбменДаннымиСобытияУТ.ИнициализироватьПараметрыОбработкиПРО();
...
Процедура ПРО_Документ_Сторно_ПослеОбработки(ПРО, Отказ, Объект, ОбъектМетаданных, Получатели, Выгрузка)
	Если Не Отказ И Получатели.Количество() > 0 Тогда
		
		ДокументОбъект = Объект.СторнируемыйДокумент.ПолучитьОбъект();
		
		Получатели = ОпределитьПолучателей(ДокументОбъект, ПРО.ИмяПланаОбмена);
		
		Если Не Выгрузка Тогда
			
			ОбщегоНазначенияКлиентСервер.УдалитьЗначениеИзМассива(Получатели, Объект.ОбменДанными.Отправитель);
			
			Если Получатели.Количество() > 0 Тогда
				
				ПланыОбмена.ЗарегистрироватьИзменения(Получатели, ДокументОбъект);
...
КонецПроцедуры
#КонецОбласти
#Область Документ_ОтгрузкаТоваровКлиенту
Процедура ДобавитьПРО_Документ_ОтгрузкаТоваровКлиенту(ПравилаРегистрацииОбъектов, ИмяМенеджераРегистрации)
	НовоеПравило = ПравилаРегистрацииОбъектов.Добавить();
	
	НовоеПравило.ИмяМенеджераРегистрации = ИмяМенеджераРегистрации; 
	НовоеПравило.Идентификатор = "Документ_ОтгрузкаТоваровКлиенту";
	
	НовоеПравило.ОбъектМетаданныхИмя = "Документ.ОтгрузкаТоваровКлиенту";
	НовоеПравило.ИмяПланаОбмена = "СинхронизацияДанныхЧерезУниверсальныйФормат";
	НовоеПравило.ИмяРеквизитаФлага = "РежимВыгрузкиДокументов";	
	НовоеПравило.ПравилоПоСвойствамОбъектаПустое = Ложь; 
	НовоеПравило.ПакетноеВыполнениеОбработчиков = Ложь;
	...
	УстановитьОтборы(НовоеПравило, 
		ОтборПоСвойствамПланаОбмена_16(),
		Документ_ОтгрузкаТоваровКлиенту_ОтборПоСвойствамОбъекта());
КонецПроцедуры

Функция Документ_ОтгрузкаТоваровКлиенту_ОтборПоСвойствамОбъекта()
	Возврат "<ОтборПоСвойствамОбъекта>
			|	<ЭлементОтбора>
			|		<ТипСвойстваОбъекта>Булево</ТипСвойстваОбъекта>
			|		<ВидСравнения>Равно</ВидСравнения>
...
Процедура ПРО_Документ_ОтгрузкаТоваровКлиенту_ПриОбработкеДополнительный(Отказ, ПРО, Объект, ТекстЗапроса, ПараметрыЗапроса, ИспользоватьКэш, ДополнительныеСвойства)
	ПараметрыОбработкиПРО = ОбменДаннымиСобытияУТ.ИнициализироватьПараметрыОбработкиПРО();
...
Процедура ПРО_Документ_ОтгрузкаТоваровКлиенту_ПриОбработке(Отказ, ПРО, Объект, ТекстЗапроса, ПараметрыЗапроса, ИспользоватьКэш, Выгрузка, ДополнительныеСвойства)
	ПараметрыОбработкиПРО = ОбменДаннымиСобытияУТ.ИнициализироватьПараметрыОбработкиПРО();
...
Процедура ПРО_Документ_ОтгрузкаТоваровКлиенту_ПослеОбработки(ПРО, Отказ, Объект, ОбъектМетаданных, Получатели, Выгрузка)
	//++ Локализация
	Если Не Выгрузка И Получатели.Количество() > 0 Тогда
		Если НЕ ОбщегоНазначения.СсылкаСуществует(Объект.Ссылка) Тогда
			Возврат
...
#КонецОбласти
#Область РегистрСведений_УточненияПринадлежностиЗапасовТорговыхТочек
Процедура ДобавитьПРО_РегистрСведений_УточненияПринадлежностиЗапасовТорговыхТочек(ПравилаРегистрацииОбъектов, ИмяМенеджераРегистрации)
	НовоеПравило = ПравилаРегистрацииОбъектов.Добавить();
	
	НовоеПравило.ИмяМенеджераРегистрации = ИмяМенеджераРегистрации; 
	НовоеПравило.Идентификатор = "РегистрСведений_УточненияПринадлежностиЗапасовТорговыхТочек";
	
	НовоеПравило.ОбъектМетаданныхИмя = "РегистрСведений.УточненияПринадлежностиЗапасовТорговыхТочек";
	НовоеПравило.ИмяПланаОбмена = "СинхронизацияДанныхЧерезУниверсальныйФормат";
	...
	УстановитьОтборы(НовоеПравило, 
		РегистрСведений_УточненияПринадлежностиЗапасовТорговыхТочек_ОтборПоСвойствамПланаОбмена(),
		РегистрСведений_УточненияПринадлежностиЗапасовТорговыхТочек_ОтборПоСвойствамОбъекта());
КонецПроцедуры

Функция РегистрСведений_УточненияПринадлежностиЗапасовТорговыхТочек_ОтборПоСвойствамПланаОбмена()
	Возврат "<ОтборПоСвойствамПланаОбмена>
			|	<Группа>
			|		<БулевоЗначениеГруппы>ИЛИ</БулевоЗначениеГруппы>
			|		<ЭлементОтбора>
			...
			|			<СвойствоПланаОбмена>Организации.Организация</СвойствоПланаОбмена>
			|			<ВидСравнения>Равно</ВидСравнения>
			|			<СвойствоОбъекта>ОрганизацияПродавец</СвойствоОбъекта>
			|			<ТаблицаСвойствОбъекта>
			|				<Свойство>
			|					<Наименование>ОрганизацияПродавец</Наименование>
			|					<Тип>СправочникСсылка.Организации</Тип>
			|					<Вид>Измерение</Вид>
			|				</Свойство>
			|			</ТаблицаСвойствОбъекта>
			...
			|			<СвойствоПланаОбмена>ВидыЦенНоменклатуры.ВидЦенНоменклатуры</СвойствоПланаОбмена>
			|			<ВидСравнения>Равно</ВидСравнения>
			|			<СвойствоОбъекта>Склад.РозничныйВидЦены</СвойствоОбъекта>
			|			<ТаблицаСвойствОбъекта>
			|				<Свойство>
			|					<Наименование>Склад</Наименование>
			|					<Тип>СправочникСсылка.Склады</Тип>
			...
			|				</Свойство>
			|				<Свойство>
			|					<Наименование>РозничныйВидЦены</Наименование>
			...
			|			<ТаблицаСвойствПланаОбмена>
			|				<Свойство>
			|					<Наименование>[ВидыЦенНоменклатуры]</Наименование>
			|					<Вид>ТабличнаяЧасть</Вид>
			|				</Свойство>
			|				<Свойство>
			|					<Наименование>ВидЦенНоменклатуры</Наименование>
			|					<Тип>СправочникСсылка.ВидыЦен</Тип>
			|					<Вид>Реквизит</Вид>
			|				</Свойство>
			|			</ТаблицаСвойствПланаОбмена>
...
Функция РегистрСведений_УточненияПринадлежностиЗапасовТорговыхТочек_ОтборПоСвойствамОбъекта()
	Возврат "<ОтборПоСвойствамОбъекта>
			|	<ЭлементОтбора>
			|		<ТипСвойстваОбъекта>ПеречислениеСсылка.ТипыСкладов</ТипСвойстваОбъекта>
			|		<ВидСравнения>Равно</ВидСравнения>
			|		<СвойствоОбъекта>Склад.ТипСклада</СвойствоОбъекта>
			|		<Вид>АлгоритмЗначения</Вид>
			|		<ЗначениеКонстанты>Значение = Перечисления.ТипыСкладов.РозничныйМагазин;</ЗначениеКонстанты>
			|		<ТаблицаСвойствОбъекта>
			|			<Свойство>
			|				<Наименование>Склад</Наименование>
			|				<Тип>СправочникСсылка.Склады</Тип>
			...
			|				<Тип>ПеречислениеСсылка.ТипыСкладов</Тип>
			|				<Вид>Реквизит</Вид>
			|			</Свойство>
			|		</ТаблицаСвойствОбъекта>
			|	</ЭлементОтбора>
			...
			|		<ТипСвойстваОбъекта>Булево</ТипСвойстваОбъекта>
			|		<ВидСравнения>Равно</ВидСравнения>
			|		<СвойствоОбъекта>Склад.ПометкаУдаления</СвойствоОбъекта>
			|		<Вид>ЗначениеКонстанты</Вид>
			|		<ЗначениеКонстанты>false</ЗначениеКонстанты>
			|		<ТаблицаСвойствОбъекта>
			|			<Свойство>
			...
			|		<ТипСвойстваОбъекта>Булево</ТипСвойстваОбъекта>
			|		<ВидСравнения>Равно</ВидСравнения>
			|		<СвойствоОбъекта>ОрганизацияПродавец.ПометкаУдаления</СвойствоОбъекта>
			|		<Вид>ЗначениеКонстанты</Вид>
			|		<ЗначениеКонстанты>false</ЗначениеКонстанты>
			|		<ТаблицаСвойствОбъекта>
			|			<Свойство>
...
Процедура ПРО_РегистрСведений_УточненияПринадлежностиЗапасовТорговыхТочек_ПриОбработкеДополнительный(Отказ, ПРО, Объект, ТекстЗапроса, ПараметрыЗапроса, ИспользоватьКэш, ДополнительныеСвойства)
	ПараметрыОбработкиПРО = ОбменДаннымиСобытияУТ.ИнициализироватьПараметрыОбработкиПРО();
...
Процедура ПРО_РегистрСведений_УточненияПринадлежностиЗапасовТорговыхТочек_ПриОбработке(Отказ, ПРО, Объект, ТекстЗапроса, ПараметрыЗапроса, ИспользоватьКэш, Выгрузка, ДополнительныеСвойства)
	ПараметрыОбработкиПРО = ОбменДаннымиСобытияУТ.ИнициализироватьПараметрыОбработкиПРО();
...
Процедура ПРО_РегистрСведений_ДоступностьТоваровДляВнешнихПользователей_ПередОбработкой(ПРО, Отказ, Объект, ОбъектМетаданных, Выгрузка)
	// Необходимо почистить таблицу с получателями, так как возможны ситуации, когда перед обработкой правил регистрации, уже заполнены узлы-получатели.  
...
#КонецОбласти
//-- Локализация
#Область РегистрСведений_НоменклатураСегмента
Процедура ДобавитьПРО_РегистрСведений_НоменклатураСегмента(ПравилаРегистрацииОбъектов, ИмяМенеджераРегистрации)
	НовоеПравило = ПравилаРегистрацииОбъектов.Добавить();
	
	НовоеПравило.ИмяМенеджераРегистрации = ИмяМенеджераРегистрации; 
	НовоеПравило.Идентификатор = "РегистрСведений_НоменклатураСегмента";
	
	НовоеПравило.ОбъектМетаданныхИмя = "РегистрСведений.НоменклатураСегмента";
	НовоеПравило.ИмяПланаОбмена = "СинхронизацияДанныхЧерезУниверсальныйФормат";
	НовоеПравило.ИмяРеквизитаФлага = "РежимВыгрузкиСправочников";	
	НовоеПравило.ПравилоПоСвойствамОбъектаПустое = Ложь; 
	НовоеПравило.ПакетноеВыполнениеОбработчиков = Ложь;
	...
	УстановитьОтборы(НовоеПравило, 
		...
		РегистрСведений_НоменклатураСегмента_ОтборПоСвойствамОбъекта());
КонецПроцедуры

Функция РегистрСведений_НоменклатураСегмента_ОтборПоСвойствамОбъекта()
	Возврат "<ОтборПоСвойствамОбъекта>
			|	<ЭлементОтбора>
			|		<ТипСвойстваОбъекта>Булево</ТипСвойстваОбъекта>
			|		<ВидСравнения>Равно</ВидСравнения>
			...
			|		<ТипСвойстваОбъекта>Булево</ТипСвойстваОбъекта>
			|		<ВидСравнения>Равно</ВидСравнения>
			|		<СвойствоОбъекта>Сегмент.ПометкаУдаления</СвойствоОбъекта>
			|		<Вид>ЗначениеКонстанты</Вид>
			|		<ЗначениеКонстанты>false</ЗначениеКонстанты>
			|		<ТаблицаСвойствОбъекта>
			|			<Свойство>
			|				<Наименование>Сегмент</Наименование>
			|				<Тип>СправочникСсылка.СегментыНоменклатуры</Тип>
			|				<Вид>Измерение</Вид>
			|			</Свойство>
			|			<Свойство>
			|				<Наименование>ПометкаУдаления</Наименование>
...
#КонецОбласти
//++ Локализация
#Область РегистрСведений_НастройкиУчетаНДСПриУСН
Процедура ДобавитьПРО_РегистрСведений_НастройкиУчетаНДСПриУСН(ПравилаРегистрацииОбъектов, ИмяМенеджераРегистрации)
	НовоеПравило = ПравилаРегистрацииОбъектов.Добавить();
	
	НовоеПравило.ИмяМенеджераРегистрации = ИмяМенеджераРегистрации; 
	НовоеПравило.Идентификатор = "РегистрСведений_НастройкиУчетаНДСПриУСН";
	
	НовоеПравило.ОбъектМетаданныхИмя = "РегистрСведений.НастройкиУчетаНДСПриУСН";
	НовоеПравило.ИмяПланаОбмена = "СинхронизацияДанныхЧерезУниверсальныйФормат";
	НовоеПравило.ИмяРеквизитаФлага = "РежимВыгрузкиСправочников";	
	НовоеПравило.ПравилоПоСвойствамОбъектаПустое = Ложь; 
	НовоеПравило.ПакетноеВыполнениеОбработчиков = Ложь;
	...
	УстановитьОтборы(НовоеПравило, 
		РегистрСведений_НастройкиУчетаНДСПриУСН_ОтборПоСвойствамПланаОбмена(),
		ПустойОтборПоСвойствамОбъекта());
КонецПроцедуры

Функция РегистрСведений_НастройкиУчетаНДСПриУСН_ОтборПоСвойствамПланаОбмена()
	Возврат "<ОтборПоСвойствамПланаОбмена>
			|	<ЭлементОтбора>
			|		<ЭтоСтрокаКонстанты>true</ЭтоСтрокаКонстанты>
			|		<ТипСвойстваОбъекта>Строка</ТипСвойстваОбъекта>
...
Функция Справочник_ШтрихкодыУпаковокТоваров_ОтборПоСвойствамПланаОбмена()
	Возврат "<ОтборПоСвойствамПланаОбмена>
			...
			|		<ЭтоСтрокаКонстанты>true</ЭтоСтрокаКонстанты>
			|		<ТипСвойстваОбъекта>Булево</ТипСвойстваОбъекта>
			|		<СвойствоПланаОбмена>ВыгружатьДанныеМаркировки</СвойствоПланаОбмена>
			|		<ВидСравнения>Равно</ВидСравнения>
			|		<СвойствоОбъекта>true</СвойствоОбъекта>
			|		<ТаблицаСвойствПланаОбмена>
			|			<Свойство>
			|				<Наименование>ВыгружатьДанныеМаркировки</Наименование>
			|				<Тип>Булево</Тип>
			|				<Вид>Реквизит</Вид>
			|			</Свойство>
			|		</ТаблицаСвойствПланаОбмена>
...
Процедура ПРО_Справочник_ШтрихкодыУпаковокТоваров_ПередОбработкой(ПРО, Отказ, Объект, ОбъектМетаданных, Выгрузка)
	Если ЗначениеЗаполнено(Объект.Упаковка)
		И ОбщегоНазначения.СсылкаСуществует(Объект.Упаковка) Тогда
		
		Владелец = ОбщегоНазначения.ЗначениеРеквизитаОбъекта(Объект.Упаковка, "Владелец");
	
		Если НЕ Владелец = Справочники.НаборыУпаковок.БазовыеЕдиницыИзмерения
			И НЕ (ЗначениеЗаполнено(Владелец) И ТипЗнч(Владелец) = Тип("СправочникСсылка.Номенклатура")) Тогда
			Отказ = Истина;
		КонецЕсли;
...
#КонецОбласти
//++ Локализация
#Область Справочник_ДоговорыЭквайринга2
Процедура ДобавитьПРО_Справочник_ДоговорыЭквайринга2(ПравилаРегистрацииОбъектов, ИмяМенеджераРегистрации)
	НовоеПравило = ПравилаРегистрацииОбъектов.Добавить();
	
	НовоеПравило.ИмяМенеджераРегистрации = ИмяМенеджераРегистрации; 
	НовоеПравило.Идентификатор = "Справочник_ДоговорыЭквайринга2";
	...
	УстановитьОтборы(НовоеПравило, 
		Справочник_ДоговорыЭквайринга2_ОтборПоСвойствамПланаОбмена(),
		Справочник_ДоговорыЭквайринга2_ОтборПоСвойствамОбъекта());
КонецПроцедуры

Функция Справочник_ДоговорыЭквайринга2_ОтборПоСвойствамПланаОбмена()
	Возврат "<ОтборПоСвойствамПланаОбмена>
			|	<ЭлементОтбора>
			|		<ЭтоСтрокаКонстанты>true</ЭтоСтрокаКонстанты>
			|		<ТипСвойстваОбъекта>Строка</ТипСвойстваОбъекта>
			...
			|			<ЭтоСтрокаКонстанты>true</ЭтоСтрокаКонстанты>
			|			<ТипСвойстваОбъекта>Булево</ТипСвойстваОбъекта>
			|			<СвойствоПланаОбмена>ИспользоватьОтборПоДоговорамЭквайринга</СвойствоПланаОбмена>
			|			<ВидСравнения>Равно</ВидСравнения>
			|			<СвойствоОбъекта>false</СвойствоОбъекта>
			|			<ТаблицаСвойствПланаОбмена>
			|				<Свойство>
			|					<Наименование>ИспользоватьОтборПоДоговорамЭквайринга</Наименование>
			|					<Тип>Булево</Тип>
			|					<Вид>Реквизит</Вид>
			|				</Свойство>
			|			</ТаблицаСвойствПланаОбмена>
			...
			|			<ЭлементОтбора>
			|				<ЭтоСтрокаКонстанты>false</ЭтоСтрокаКонстанты>
			|				<ТипСвойстваОбъекта>СправочникСсылка.ДоговорыЭквайринга</ТипСвойстваОбъекта>
			|				<СвойствоПланаОбмена>ДоговорыПодключенияКПлатежнымСистемам.ДоговорПодключения</СвойствоПланаОбмена>
			|				<ВидСравнения>Равно</ВидСравнения>
			|				<СвойствоОбъекта>Ссылка</СвойствоОбъекта>
			|				<ТаблицаСвойствОбъекта>
			|					<Свойство>
			...
			|				<ТаблицаСвойствПланаОбмена>
			|					<Свойство>
			|						<Наименование>[ДоговорыПодключенияКПлатежнымСистемам]</Наименование>
			|						<Вид>ТабличнаяЧасть</Вид>
			|					</Свойство>
			|					<Свойство>
			|						<Наименование>ДоговорПодключения</Наименование>
			|						<Тип>СправочникСсылка.ДоговорыЭквайринга</Тип>
			|						<Вид>Реквизит</Вид>
			|					</Свойство>
			|				</ТаблицаСвойствПланаОбмена>
...
Функция Справочник_ДоговорыЭквайринга2_ОтборПоСвойствамОбъекта()
	Возврат "<ОтборПоСвойствамОбъекта>
			|	<ЭлементОтбора>
			|		<ТипСвойстваОбъекта>Булево</ТипСвойстваОбъекта>
			|		<ВидСравнения>Равно</ВидСравнения>
			...
			|	</ЭлементОтбора>
			|	<ЭлементОтбора>
			|		<ТипСвойстваОбъекта>ПеречислениеСсылка.СпособыПроведенияПлатежей</ТипСвойстваОбъекта>
			|		<ВидСравнения>Равно</ВидСравнения>
			|		<СвойствоОбъекта>СпособПроведенияПлатежа</СвойствоОбъекта>
			|		<Вид>АлгоритмЗначения</Вид>
			|		<ЗначениеКонстанты>Значение = Перечисления.СпособыПроведенияПлатежей.СистемаБыстрыхПлатежей;</ЗначениеКонстанты>
			|		<ТаблицаСвойствОбъекта>
			|			<Свойство>
			|				<Наименование>СпособПроведенияПлатежа</Наименование>
			|				<Тип>ПеречислениеСсылка.СпособыПроведенияПлатежей</Тип>
			|				<Вид>Реквизит</Вид>
			|			</Свойство>
			|		</ТаблицаСвойствОбъекта>
			|	</ЭлементОтбора>
...
#КонецОбласти
//-- Локализация
#Область Справочник_СегментыНоменклатуры
Процедура ДобавитьПРО_Справочник_СегментыНоменклатуры(ПравилаРегистрацииОбъектов, ИмяМенеджераРегистрации)
	НовоеПравило = ПравилаРегистрацииОбъектов.Добавить();
	
	НовоеПравило.ИмяМенеджераРегистрации = ИмяМенеджераРегистрации; 
	НовоеПравило.Идентификатор = "Справочник_СегментыНоменклатуры";
	
	НовоеПравило.ОбъектМетаданныхИмя = "Справочник.СегментыНоменклатуры";
	НовоеПравило.ИмяПланаОбмена = "СинхронизацияДанныхЧерезУниверсальныйФормат";
	НовоеПравило.ИмяРеквизитаФлага = "РежимВыгрузкиСправочников";	
	НовоеПравило.ПравилоПоСвойствамОбъектаПустое = Ложь; 
	НовоеПравило.ПакетноеВыполнениеОбработчиков = Ложь;
...
Функция ОтборПоСвойствамОбъекта_10()
	Возврат "<ОтборПоСвойствамОбъекта>
			|	<ЭлементОтбора>
			|		<ТипСвойстваОбъекта>Булево</ТипСвойстваОбъекта>
			|		<ВидСравнения>Равно</ВидСравнения>
...
Функция ОтборПоСвойствамПланаОбмена_23()
	Возврат "<ОтборПоСвойствамПланаОбмена>
			|	<ЭлементОтбора>
			|		<ЭтоСтрокаКонстанты>false</ЭтоСтрокаКонстанты>
			|		<ТипСвойстваОбъекта>Дата</ТипСвойстваОбъекта>
