...
Процедура ПриСозданииНоменклатуры(Владелец, ДанныеЗаполнения, СтандартнаяОбработка) Экспорт
	...
	Если ДанныеЗаполнения <> Неопределено Тогда
		ДополнительныеПараметры = ОбщегоНазначенияКлиент.СкопироватьРекурсивно(ДанныеЗаполнения);
	КонецЕсли;
	...
	Если ДополнительныеПараметры.Свойство("ПредставлениеНоменклатуры") Тогда
		ДополнительныеПараметры.Вставить("Наименование", ДанныеЗаполнения.ПредставлениеНоменклатуры);
	КонецЕсли;
	
	Если ДополнительныеПараметры.Свойство("GTIN") И Не РазборКодаМаркировкиИССлужебныйКлиентСервер.ЭтоШтрихкодВводаОстатков(ДополнительныеПараметры.GTIN) Тогда
		ДополнительныеПараметры.Вставить("Штрихкод", РазборКодаМаркировкиИССлужебныйКлиентСервер.ШтрихкодEANИзGTIN(ДанныеЗаполнения.GTIN));
