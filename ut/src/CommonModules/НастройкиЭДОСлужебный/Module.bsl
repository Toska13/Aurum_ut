...
Процедура ПриОпределенииМетодовРазрешенныхДляВызоваКакПроизвольныйКод(Методы) Экспорт
	...
	Методы.Вставить("ВключитьИспользованиеОзнакомленийСЭД");
	Методы.Вставить("НастроитьАвтоПереходНаНовыеВерсииФорматовЭД");
	Методы.Вставить("УстановкаЗначенияКонстантыСоздаватьКонтрагентовАвтоматическиБЭД");
	
	Методы.Вставить("ВыполнитьДействияПередИзменениемИспользованияУтверждения", Истина);
	Методы.Вставить("ДанныеДляНастройкиСвязиСКонтрагентом", Истина);
