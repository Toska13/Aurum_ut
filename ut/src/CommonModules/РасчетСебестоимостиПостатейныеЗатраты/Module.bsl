...
Функция ТекстЗапросаБазаРаспределенияРасходовНаЗаказы()
	...
	|		 ИЛИ ВтОтборПоЗаказуКлиентаДетально.АналитикаРасходов ЕСТЬ NULL
	...
	|		
	|	ЛЕВОЕ СОЕДИНЕНИЕ ВтОтборПоЗаказуКлиентаДетально КАК ВтОтборПоЗаказуКлиентаДетально
	|	ПО ВтОтборПоЗаказуКлиентаДетально.АналитикаРасходов = ДД.ЗаказКлиента
	|		И ВтОтборПоЗаказуКлиентаДетально.Организация = ДД.АналитикаУчетаПоПартнерам.Организация
	|		И ВтОтборПоЗаказуКлиентаДетально.Номенклатура = КлючиАналитикиУчетаНоменклатуры.Номенклатура
	|		И ВтОтборПоЗаказуКлиентаДетально.Характеристика = КлючиАналитикиУчетаНоменклатуры.Характеристика
	|		И ВтОтборПоЗаказуКлиентаДетально.Склад = КлючиАналитикиУчетаНоменклатуры.МестоХранения
	|		И (ВтОтборПоЗаказуКлиентаДетально.Серия = КлючиАналитикиУчетаНоменклатуры.Серия
	|			ИЛИ НЕ ВтОтборПоЗаказуКлиентаДетально.СерияУказывается)
	|
	|	ВНУТРЕННЕЕ СОЕДИНЕНИЕ Справочник.Номенклатура КАК СпрНоменклатура
