...
// Возвращает значение свойства из структуры или вложенного объекта по имени,
// содержащему точки. При отсутствии промежуточного свойства возвращает
// значение по умолчанию без генерации исключения.
//
// Параметры:
//  Структура           - Структура - исходный объект, из которого извлекается значение.
//  ИмяСвойства         - Строка - путь к свойству, где уровни вложенности разделяются точкой.
//                        Например: "Реквизит", "Контрагент.Наименование", 
//                                  "data.verification_details.raw_data.sign".
//  ЗначениеПоУмолчанию - Произвольный - значение, возвращаемое, если свойство не найдено.
//                        По умолчанию = "" (пустая строка).
//
// Возвращаемое значение:
//  Произвольный - значение запрошенного свойства, если оно существует по указанному пути,
//                 или ЗначениеПоУмолчанию в противном случае.
//
// Пример:
//  Данные = Новый Структура("Контрагент", Новый Структура("Наименование, ИНН", "ООО Ромашка", "7701234567"));
//  Результат = ПолучитьСвойствоБезопасно(Данные, "Контрагент.Наименование", "Не указано");
//  // Результат = "ООО Ромашка"
//
Функция СвойствоСтруктурыБезопасно(Структура, ИмяСвойства, ЗначениеПоУмолчанию = "") Экспорт
	
	Значение = Структура;
	Свойства = СтрРазделить(ИмяСвойства, ".");
