...
Процедура ПриОпределенииМетодовРазрешенныхДляВызоваКакПроизвольныйКод(Методы) Экспорт
	...
	Методы.Вставить("ОбработкаОчередиЗаданийБТС", Истина);
	Методы.Вставить("ЗапускОбработкиЗаданий", Истина);
	Методы.Вставить("ПланированиеОбработкиЗаданий", Истина);
	Методы.Вставить("РегламентнаяОбработкаОчередиЗаданий", Истина);
